"""This module contains the meta information of ApeUpdateServerAbsence ExternalMethod."""

from ..ucscoremeta import MethodMeta, MethodPropertyMeta

method_meta = MethodMeta("ApeUpdateServerAbsence", "apeUpdateServerAbsence", "Version142b")
