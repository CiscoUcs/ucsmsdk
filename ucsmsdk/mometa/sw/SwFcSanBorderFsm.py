...
class SwFcSanBorderFsm(ManagedObject):
    """This is SwFcSanBorderFsm class."""

    consts = SwFcSanBorderFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("SwFcSanBorderFsm", "swFcSanBorderFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'swFcSanBorder'], [u'swFcSanBorderFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["ActivateZoneSet", "Deploy", "nop"], []), 
