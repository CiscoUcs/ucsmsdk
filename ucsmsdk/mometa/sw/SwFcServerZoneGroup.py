...
class SwFcServerZoneGroup(ManagedObject):
    ...
    mo_meta = MoMeta("SwFcServerZoneGroup", "swFcServerZoneGroup", "zone-group-[id]", VersionMeta.Version211a, "InputOutput", 0x7fL, [], ["read-only"], [u'swFcZoneSet'], [u'swZoneInitiatorMember'], [None])
