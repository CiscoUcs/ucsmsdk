...
class SwPortDiscover(ManagedObject):
    ...
    mo_meta = MoMeta("SwPortDiscover", "swPortDiscover", "discover", VersionMeta.Version321d, "InputOutput", 0x1f, [], ["read-only"], ['networkElement'], ['eventInst', 'faultInst', 'swEtherPort', 'swPortDiscoverFsm', 'swPortDiscoverFsmTask'], [None])
