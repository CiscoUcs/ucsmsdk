"""This module contains the general information for SwPortDiscover ManagedObject."""
...
class SwPortDiscoverConsts:
    ...
    FSM_STATUS_DEPLOY_ENABLE_PORT = "DeployEnablePort"
...
class SwPortDiscover(ManagedObject):
    """This is SwPortDiscover class."""

    consts = SwPortDiscoverConsts()
    naming_props = set([])

    mo_meta = MoMeta("SwPortDiscover", "swPortDiscover", "discover", VersionMeta.Version321d, "InputOutput", 0x1f, [], ["read-only"], [u'networkElement'], [u'eventInst', u'faultInst', u'swEtherPort', u'swPortDiscoverFsm', u'swPortDiscoverFsmTask'], [None])

    prop_meta = {
        "child_action": MoPropertyMeta("child_action", "childAction", "string", VersionMeta.Version321d, MoPropertyMeta.INTERNAL, 0x2, None, None, r"""((deleteAll|ignore|deleteNonPresent),){0,2}(deleteAll|ignore|deleteNonPresent){0,1}""", [], []), 
        "conf_mode": MoPropertyMeta("conf_mode", "confMode", "string", VersionMeta.Version321d, MoPropertyMeta.READ_ONLY, None, None, None, None, ["failed", "in-progress", "none", "verifying"], []), 
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version321d, MoPropertyMeta.INTERNAL, None, None, None, None, ["DeployBegin", "DeployEnablePort", "DeployFail", "DeploySuccess", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version321d, MoPropertyMeta.INTERNAL, None, None, None, None, ["DeployBegin", "DeployEnablePort", "DeployFail", "DeploySuccess", "nop"], []), 
        ...
        "switch_id": MoPropertyMeta("switch_id", "switchId", "string", VersionMeta.Version321d, MoPropertyMeta.READ_ONLY, None, None, None, None, ["A", "B", "NONE"], []), 
    }
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "SwPortDiscover", parent_mo_or_dn, **kwargs)
