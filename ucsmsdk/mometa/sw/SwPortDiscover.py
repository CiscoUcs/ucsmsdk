...
class SwPortDiscover(ManagedObject):
    ...
    mo_meta = MoMeta("SwPortDiscover", "swPortDiscover", "discover", None, "InputOutput", 0x1f, [], ["read-only"], [u'networkElement'], [u'eventInst', u'faultInst', u'swEtherPort', u'swPortDiscoverFsm', u'swPortDiscoverFsmTask'], [None])
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", None, MoPropertyMeta.INTERNAL, None, None, None, None, ["DeployBegin", "DeployEnablePort", "DeployFail", "DeploySuccess", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", None, MoPropertyMeta.INTERNAL, None, None, None, None, ["DeployBegin", "DeployEnablePort", "DeployFail", "DeploySuccess", "nop"], []), 
        ...
        "switch_id": MoPropertyMeta("switch_id", "switchId", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["A", "B", "NONE"], []), 
    }
