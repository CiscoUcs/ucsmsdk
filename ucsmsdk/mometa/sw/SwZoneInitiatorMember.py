...
class SwZoneInitiatorMember(ManagedObject):
    ...
    mo_meta = MoMeta("SwZoneInitiatorMember", "swZoneInitiatorMember", "initiator-[name]", VersionMeta.Version211a, "InputOutput", 0x1fL, [], ["read-only"], [u'swFcServerZoneGroup'], [u'swFcZone'], [None])
