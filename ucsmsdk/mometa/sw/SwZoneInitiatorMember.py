...
class SwZoneInitiatorMember(ManagedObject):
    ...
    mo_meta = MoMeta("SwZoneInitiatorMember", "swZoneInitiatorMember", "initiator-[name]", VersionMeta.Version211a, "InputOutput", 0x3fL, [], ["read-only"], [u'swFcServerZoneGroup'], [u'swFcZone'], [None])
