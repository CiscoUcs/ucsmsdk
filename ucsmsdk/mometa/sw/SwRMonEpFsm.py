"""This module contains the general information for SwRMonEpFsm ManagedObject."""
...
class SwRMonEpFsmConsts:
    COMPLETION_TIME_ = ""
    CURRENT_FSM_DEPLOY_RMON_EP = "DeployRMonEp"
    CURRENT_FSM_NOP = "nop"
...
class SwRMonEpFsm(ManagedObject):
    """This is SwRMonEpFsm class."""

    consts = SwRMonEpFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("SwRMonEpFsm", "swRMonEpFsm", "fsm", VersionMeta.Version434a, "OutputOnly", 0xf, [], [""], ['swRMonEp'], ['swRMonEpFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "SwRMonEpFsm", parent_mo_or_dn, **kwargs)
