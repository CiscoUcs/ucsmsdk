...
class SwEthMonSrcEp(ManagedObject):
    ...
    mo_meta = MoMeta("SwEthMonSrcEp", "swEthMonSrcEp", "mon-src-[chassis_id]-[slot_id]-[port_id]", VersionMeta.Version141i, "InputOutput", 0x1ffL, [], ["read-only"], [u'swEthMon', u'swSubGroup'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "chassis_id": MoPropertyMeta("chassis_id", "chassisId", "string", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x2L, None, None, None, ["N/A"], ["0-255"]), 
