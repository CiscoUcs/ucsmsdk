"""This module contains the general information for SwEthMonSrcEp ManagedObject."""
import sys, os
...
class SwEthMonSrcEp(ManagedObject):
    ...
    mo_meta = MoMeta("SwEthMonSrcEp", "swEthMonSrcEp", "mon-src-[chassis_id]-[slot_id]-[port_id]", VersionMeta.Version141i, "InputOutput", 0x3ffL, [], ["read-only"], [u'swEthMon', u'swSubGroup'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "chassis_id": MoPropertyMeta("chassis_id", "chassisId", "string", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x4L, None, None, None, ["N/A"], ["0-255"]), 
        ...
        "port_id": MoPropertyMeta("port_id", "portId", "uint", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x40L, None, None, None, [], []), 
        ...
        "slot_id": MoPropertyMeta("slot_id", "slotId", "uint", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x100L, None, None, None, [], []), 
    ...
    def __init__(self, parent_mo_or_dn, chassis_id, slot_id, port_id, **kwargs):
        ...
        ManagedObject.__init__(self, "SwEthMonSrcEp", parent_mo_or_dn, **kwargs)
