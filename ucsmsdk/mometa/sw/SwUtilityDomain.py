"""This module contains the general information for SwUtilityDomain ManagedObject."""
import sys, os
...
class SwUtilityDomain(ManagedObject):
    """This is SwUtilityDomain class."""

    consts = SwUtilityDomainConsts()
    naming_props = set([])

    mo_meta = MoMeta("SwUtilityDomain", "swUtilityDomain", "utility-eth", VersionMeta.Version101e, "InputOutput", 0x7fL, [], ["read-only"], [u'networkElement'], [u'eventInst', u'faultInst', u'swUlan', u'swUtilityDomainFsm', u'swUtilityDomainFsmTask'], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "SwUtilityDomain", parent_mo_or_dn, **kwargs)
