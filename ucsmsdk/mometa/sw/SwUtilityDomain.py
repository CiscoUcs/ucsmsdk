...
class SwUtilityDomain(ManagedObject):
    ...
    mo_meta = MoMeta("SwUtilityDomain", "swUtilityDomain", "utility-eth", VersionMeta.Version101e, "InputOutput", 0x3fL, [], ["read-only"], [u'networkElement'], [u'eventInst', u'faultInst', u'swUlan', u'swUtilityDomainFsm', u'swUtilityDomainFsmTask'], ["Get"])
