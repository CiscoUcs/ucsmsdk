"""This module contains the general information for SwEthMonFsmStage ManagedObject."""
import sys, os
...
class SwEthMonFsmStage(ManagedObject):
    """This is SwEthMonFsmStage class."""

    consts = SwEthMonFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("SwEthMonFsmStage", "swEthMonFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'swEthMonFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["DeployBegin", "DeployFail", "DeploySuccess", "DeployUpdateEthMon", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "SwEthMonFsmStage", parent_mo_or_dn, **kwargs)
