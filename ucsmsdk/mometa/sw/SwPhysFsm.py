...
class SwPhysFsm(ManagedObject):
    """This is SwPhysFsm class."""

    consts = SwPhysFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("SwPhysFsm", "swPhysFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'swPhys'], [u'swPhysFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["ConfPhysical", "nop"], []), 
