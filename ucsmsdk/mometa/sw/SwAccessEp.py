...
class SwAccessEp(ManagedObject):
    ...
    prop_meta = {
        "speed": MoPropertyMeta("speed", "Speed", "string", VersionMeta.Version423b, MoPropertyMeta.READ_ONLY, None, None, None, None, ["100gbps", "10gbps", "1gbps", "20gbps", "25gbps", "40gbps", "auto", "indeterminate"], []),
        ...
        "auto_neg": MoPropertyMeta("auto_neg", "autoNeg", "string", VersionMeta.Version423b, MoPropertyMeta.READ_ONLY, None, None, None, None, ["disabled", "enabled"], []),
