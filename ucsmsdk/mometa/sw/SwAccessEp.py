...
class SwAccessEp(ManagedObject):
    ...
    mo_meta = MoMeta("SwAccessEp", "swAccessEp", "ep-slot-[slot_id]port-[port_id]", VersionMeta.Version101e, "InputOutput", 0x1ffL, [], ["read-only"], [u'swAccessDomain', u'swSubGroup'], [u'portTrustMode', u'swUlan'], ["Get"])
    ...
    prop_meta = {
        ...
        "encap": MoPropertyMeta("encap", "encap", "string", VersionMeta.Version141i, MoPropertyMeta.READ_ONLY, None, None, None, None, ["consolidated", "virtual", "virtual-ce"], ["0-4294967295"]), 
