...
class SwAccessEp(ManagedObject):
    ...
    mo_meta = MoMeta("SwAccessEp", "swAccessEp", "ep-slot-[slot_id]port-[port_id]", VersionMeta.Version101e, "InputOutput", 0xffL, [], ["read-only"], [u'swAccessDomain', u'swSubGroup'], [u'portTrustMode', u'swUlan'], ["Get"])
