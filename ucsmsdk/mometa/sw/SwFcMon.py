...
class SwFcMon(ManagedObject):
    ...
    mo_meta = MoMeta("SwFcMon", "swFcMon", "mon-[name]", VersionMeta.Version141i, "InputOutput", 0x3ff, [], ["read-only"], ['swFcSanMon'], ['dcxVc', 'eventInst', 'faultInst', 'swEthMonDestEp', 'swFcMonDestEp', 'swFcMonFsm', 'swFcMonFsmTask', 'swFcMonSrcEp', 'swFcSanPc', 'swFcoeSanPc', 'swRemoteConfig', 'swSubGroup', 'swVlan', 'swVsan'], ["Get"])
