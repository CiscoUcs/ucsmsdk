"""This module contains the general information for SwFcMonFsmStage ManagedObject."""
import sys, os
...
class SwFcMonFsmStage(ManagedObject):
    """This is SwFcMonFsmStage class."""

    consts = SwFcMonFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("SwFcMonFsmStage", "swFcMonFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'swFcMonFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["DeployBegin", "DeployFail", "DeploySuccess", "DeployUpdateFcMon", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "SwFcMonFsmStage", parent_mo_or_dn, **kwargs)
