...
class SwEthMon(ManagedObject):
    ...
    mo_meta = MoMeta("SwEthMon", "swEthMon", "mon-[name]", VersionMeta.Version141i, "InputOutput", 0xff, [], ["read-only"], [u'swEthLanMon'], [u'dcxVc', u'eventInst', u'faultInst', u'swEthEstcPc', u'swEthLanPc', u'swEthMonDestEp', u'swEthMonFsm', u'swEthMonFsmTask', u'swEthMonSrcEp', u'swSubGroup', u'swVlan'], ["Get"])
