...
class SwExtUtilityFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("SwExtUtilityFsmTask", "swExtUtilityFsmTask", "task-[item]", None, "OutputOnly", 0xfL, [], [""], [u'swExtUtility'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", None, MoPropertyMeta.NAMING, None, None, None, None, ["ConfPortBreakout", "nop"], []), 
