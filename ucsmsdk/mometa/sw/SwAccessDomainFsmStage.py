"""This module contains the general information for SwAccessDomainFsmStage ManagedObject."""
import sys, os
...
class SwAccessDomainFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
...
class SwAccessDomainFsmStage(ManagedObject):
    """This is SwAccessDomainFsmStage class."""

    consts = SwAccessDomainFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("SwAccessDomainFsmStage", "swAccessDomainFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'swAccessDomainFsm'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "SwAccessDomainFsmStage", parent_mo_or_dn, **kwargs)
