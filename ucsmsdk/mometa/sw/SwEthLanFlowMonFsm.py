"""This module contains the general information for SwEthLanFlowMonFsm ManagedObject."""
import sys, os
...
class SwEthLanFlowMonFsmConsts():
    COMPLETION_TIME_ = ""
...
class SwEthLanFlowMonFsm(ManagedObject):
    """This is SwEthLanFlowMonFsm class."""

    consts = SwEthLanFlowMonFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("SwEthLanFlowMonFsm", "swEthLanFlowMonFsm", "fsm", VersionMeta.Version221b, "OutputOnly", 0x7L, [], [""], [u'swEthLanFlowMon'], [u'swEthLanFlowMonFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "SwEthLanFlowMonFsm", parent_mo_or_dn, **kwargs)
