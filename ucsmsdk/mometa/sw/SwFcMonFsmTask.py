"""This module contains the general information for SwFcMonFsmTask ManagedObject."""
import sys, os
...
class SwFcMonFsmTask(ManagedObject):
    """This is SwFcMonFsmTask class."""

    consts = SwFcMonFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("SwFcMonFsmTask", "swFcMonFsmTask", "task-[item]", VersionMeta.Version141i, "OutputOnly", 0xfL, [], [""], [u'swFcMon'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "SwFcMonFsmTask", parent_mo_or_dn, **kwargs)
