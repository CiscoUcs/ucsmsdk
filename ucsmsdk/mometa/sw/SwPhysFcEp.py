"""This module contains the general information for SwPhysFcEp ManagedObject."""
import sys, os
...
class SwPhysFcEp(ManagedObject):
    """This is SwPhysFcEp class."""

    consts = SwPhysFcEpConsts()
    naming_props = set([u'slotId', u'portId'])

    mo_meta = MoMeta("SwPhysFcEp", "swPhysFcEp", "phys-fc-slot-[slot_id]port-[port_id]", VersionMeta.Version201m, "InputOutput", 0xffL, [], ["read-only"], [u'swPhys', u'swSubGroup'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "port_id": MoPropertyMeta("port_id", "portId", "uint", VersionMeta.Version201m, MoPropertyMeta.NAMING, 0x10L, None, None, None, [], []), 
    ...
    def __init__(self, parent_mo_or_dn, slot_id, port_id, **kwargs):
        ...
        ManagedObject.__init__(self, "SwPhysFcEp", parent_mo_or_dn, **kwargs)
