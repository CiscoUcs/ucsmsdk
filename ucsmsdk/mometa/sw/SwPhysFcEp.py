...
class SwPhysFcEp(ManagedObject):
    ...
    mo_meta = MoMeta("SwPhysFcEp", "swPhysFcEp", "phys-fc-slot-[slot_id]port-[port_id]", VersionMeta.Version201m, "InputOutput", 0x1ffL, [], ["read-only"], [u'swPhys', u'swSubGroup'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "port_id": MoPropertyMeta("port_id", "portId", "uint", VersionMeta.Version201m, MoPropertyMeta.NAMING, 0x20L, None, None, None, [], []), 
