...
class SwPortDiscoverFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("SwPortDiscoverFsmStage", "swPortDiscoverFsmStage", "stage-[name]", None, "OutputOnly", 0xf, [], [""], [u'swPortDiscoverFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", None, MoPropertyMeta.NAMING, None, None, None, None, ["DeployBegin", "DeployEnablePort", "DeployFail", "DeploySuccess", "nop"], []), 
