"""This module contains the general information for SwEthLanBorderFsmTask ManagedObject."""
import sys, os
...
class SwEthLanBorderFsmTaskConsts():
...
class SwEthLanBorderFsmTask(ManagedObject):
    """This is SwEthLanBorderFsmTask class."""

    consts = SwEthLanBorderFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("SwEthLanBorderFsmTask", "swEthLanBorderFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], [""], [u'swEthLanBorder'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "SwEthLanBorderFsmTask", parent_mo_or_dn, **kwargs)
