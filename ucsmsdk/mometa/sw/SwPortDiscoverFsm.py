"""This module contains the general information for SwPortDiscoverFsm ManagedObject."""
...
class SwPortDiscoverFsm(ManagedObject):
    ...
    mo_meta = MoMeta("SwPortDiscoverFsm", "swPortDiscoverFsm", "fsm", None, "OutputOnly", 0xf, [], [""], [u'swPortDiscover'], [u'swPortDiscoverFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Deploy", "nop"], []), 
