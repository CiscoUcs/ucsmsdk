...
class SwPhysEtherEp(ManagedObject):
    ...
    mo_meta = MoMeta("SwPhysEtherEp", "swPhysEtherEp", "phys-eth-slot-[slot_id]port-[port_id]", VersionMeta.Version201m, "InputOutput", 0x1ffL, [], ["read-only"], [u'swPhys', u'swSubGroup'], [], ["Get"])
