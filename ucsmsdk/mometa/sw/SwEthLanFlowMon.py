...
class SwEthLanFlowMonConsts():
    ...
    FSM_PREV_DEPLOY_UPDATE_ETH_FLOW_MON = "DeployUpdateEthFlowMon"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_DEPLOY_UPDATE_ETH_FLOW_MON = "DeployUpdateEthFlowMon"
    FSM_STATUS_NOP = "nop"
    SWITCH_ID_A = "A"
    SWITCH_ID_B = "B"
    SWITCH_ID_NONE = "NONE"
...
class SwEthLanFlowMon(ManagedObject):
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version221b, MoPropertyMeta.INTERNAL, None, None, None, None, ["DeployBegin", "DeployFail", "DeploySuccess", "DeployUpdateEthFlowMon", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version221b, MoPropertyMeta.INTERNAL, None, None, None, None, ["DeployBegin", "DeployFail", "DeploySuccess", "DeployUpdateEthFlowMon", "nop"], []), 
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version221b, MoPropertyMeta.CREATE_ONLY, 0x4L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        "netflow_active_timeout": MoPropertyMeta("netflow_active_timeout", "netflowActiveTimeout", "uint", VersionMeta.Version221b, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        "netflow_inactive_timeout": MoPropertyMeta("netflow_inactive_timeout", "netflowInactiveTimeout", "uint", VersionMeta.Version221b, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        ...
        "switch_id": MoPropertyMeta("switch_id", "switchId", "string", VersionMeta.Version221b, MoPropertyMeta.READ_WRITE, 0x20L, None, None, None, ["A", "B", "NONE"], []), 
    ...
    prop_map = {
        ...
        "locale": "locale", 
        "name": "name", 
        "netflowActiveTimeout": "netflow_active_timeout", 
        "netflowInactiveTimeout": "netflow_inactive_timeout", 
        "rn": "rn", 
        "sacl": "sacl", 
        "status": "status", 
        "switchId": "switch_id", 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        self.locale = None
        self.name = None
        self.netflow_active_timeout = None
        self.netflow_inactive_timeout = None
        self.sacl = None
        self.status = None
        self.switch_id = None
        self.transport = None
