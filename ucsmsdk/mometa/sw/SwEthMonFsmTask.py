"""This module contains the general information for SwEthMonFsmTask ManagedObject."""
import sys, os
...
class SwEthMonFsmTask(ManagedObject):
    """This is SwEthMonFsmTask class."""

    consts = SwEthMonFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("SwEthMonFsmTask", "swEthMonFsmTask", "task-[item]", VersionMeta.Version141i, "OutputOnly", 0xfL, [], [""], [u'swEthMon'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version141i, MoPropertyMeta.NAMING, None, None, None, None, ["Deploy", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "SwEthMonFsmTask", parent_mo_or_dn, **kwargs)
