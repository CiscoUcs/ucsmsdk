...
class SwFcSanBorderConsts:
    ...
    FSM_PREV_ACTIVATE_ZONE_SET_VERIFY_USER_ZONE_CONFIG = "ActivateZoneSetVerifyUserZoneConfig"
    ...
    FSM_STATUS_ACTIVATE_ZONE_SET_VERIFY_USER_ZONE_CONFIG = "ActivateZoneSetVerifyUserZoneConfig"
...
class SwFcSanBorder(ManagedObject):
    ...
    mo_meta = MoMeta("SwFcSanBorder", "swFcSanBorder", "border-fc", VersionMeta.Version101e, "InputOutput", 0xff, [], ["read-only"], ['networkElement'], ['eventInst', 'faultInst', 'swFcEstcEp', 'swFcSanBorderFsm', 'swFcSanBorderFsmTask', 'swFcSanEp', 'swFcSanPc', 'swFcoeEstcEp', 'swFcoeSanEp', 'swFcoeSanPc', 'swSubGroup', 'swVlan', 'swVsan'], ["Get"])
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version101e, MoPropertyMeta.INTERNAL, None, None, None, None, ["ActivateZoneSetBegin", "ActivateZoneSetFail", "ActivateZoneSetSuccess", "ActivateZoneSetUpdateZones", "ActivateZoneSetVerifyUserZoneConfig", "DeployBegin", "DeployFail", "DeploySuccess", "DeployUpdateConnectivity", "nop"], []),
