...
class SwFcSanBorderConsts():
    ...
    FSM_PREV_ACTIVATE_ZONE_SET_UPDATE_ZONES = "ActivateZoneSetUpdateZones"
    ...
    FSM_STATUS_ACTIVATE_ZONE_SET_BEGIN = "ActivateZoneSetBegin"
    FSM_STATUS_ACTIVATE_ZONE_SET_FAIL = "ActivateZoneSetFail"
    FSM_STATUS_ACTIVATE_ZONE_SET_SUCCESS = "ActivateZoneSetSuccess"
    FSM_STATUS_ACTIVATE_ZONE_SET_UPDATE_ZONES = "ActivateZoneSetUpdateZones"
...
class SwFcSanBorder(ManagedObject):
    """This is SwFcSanBorder class."""

    consts = SwFcSanBorderConsts()
    naming_props = set([])

    mo_meta = MoMeta("SwFcSanBorder", "swFcSanBorder", "border-fc", VersionMeta.Version101e, "InputOutput", 0xffL, [], ["read-only"], [u'networkElement'], [u'eventInst', u'faultInst', u'swFcEstcEp', u'swFcSanBorderFsm', u'swFcSanBorderFsmTask', u'swFcSanEp', u'swFcSanPc', u'swFcoeEstcEp', u'swFcoeSanEp', u'swFcoeSanPc', u'swSubGroup', u'swVlan', u'swVsan'], ["Get"])
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version101e, MoPropertyMeta.INTERNAL, None, None, None, None, ["ActivateZoneSetBegin", "ActivateZoneSetFail", "ActivateZoneSetSuccess", "ActivateZoneSetUpdateZones", "DeployBegin", "DeployFail", "DeploySuccess", "DeployUpdateConnectivity", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version101e, MoPropertyMeta.INTERNAL, None, None, None, None, ["ActivateZoneSetBegin", "ActivateZoneSetFail", "ActivateZoneSetSuccess", "ActivateZoneSetUpdateZones", "DeployBegin", "DeployFail", "DeploySuccess", "DeployUpdateConnectivity", "nop"], []), 
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version101e, MoPropertyMeta.CREATE_ONLY, 0x8L, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        ...
        "switch_id": MoPropertyMeta("switch_id", "switchId", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x40L, None, None, None, ["A", "B", "NONE"], []), 
        ...
        "uplink_trunking": MoPropertyMeta("uplink_trunking", "uplinkTrunking", "string", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x80L, None, None, None, ["disabled", "enabled"], []), 
    }
