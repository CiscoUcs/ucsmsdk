...
class SwFabricZoneNsOverride(ManagedObject):
    ...
    mo_meta = MoMeta("SwFabricZoneNsOverride", "swFabricZoneNsOverride", "fabric-zone-override", VersionMeta.Version211a, "InputOutput", 0x3fL, [], ["admin"], [u'topSysDefaults'], [], [None])
    ...
    prop_meta = {
        ...
        "limit": MoPropertyMeta("limit", "limit", "uint", VersionMeta.Version211a, MoPropertyMeta.READ_WRITE, 0x8L, None, None, None, [], []), 
