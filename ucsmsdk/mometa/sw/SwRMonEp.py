"""This module contains the general information for SwRMonEp ManagedObject."""
...
class SwRMonEpConsts:
    FSM_PREV_DEPLOY_RMON_EP_BEGIN = "DeployRMonEpBegin"
    FSM_PREV_DEPLOY_RMON_EP_FAIL = "DeployRMonEpFail"
    FSM_PREV_DEPLOY_RMON_EP_SUCCESS = "DeployRMonEpSuccess"
    FSM_PREV_DEPLOY_RMON_EP_UPDATE_SVI = "DeployRMonEpUpdateSVI"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_DEPLOY_RMON_EP_BEGIN = "DeployRMonEpBegin"
    FSM_STATUS_DEPLOY_RMON_EP_FAIL = "DeployRMonEpFail"
    FSM_STATUS_DEPLOY_RMON_EP_SUCCESS = "DeployRMonEpSuccess"
    FSM_STATUS_DEPLOY_RMON_EP_UPDATE_SVI = "DeployRMonEpUpdateSVI"
    FSM_STATUS_NOP = "nop"
...
class SwRMonEp(ManagedObject):
    """This is SwRMonEp class."""

    consts = SwRMonEpConsts()
    naming_props = set([])

    mo_meta = MoMeta("SwRMonEp", "swRMonEp", "remote-traffic-mon", VersionMeta.Version434a, "InputOutput", 0x3f, [], ["admin", "ext-lan-config", "ext-lan-policy"], ['networkElement'], ['eventInst', 'faultInst', 'swRMonEpFsm', 'swRMonEpFsmTask', 'swRMonSVI'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "SwRMonEp", parent_mo_or_dn, **kwargs)
