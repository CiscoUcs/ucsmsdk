"""This module contains the general information for SwExtUtilityFsm ManagedObject."""
...
class SwExtUtilityFsmConsts:
    COMPLETION_TIME_ = ""
    CURRENT_FSM_CONF_PORT_BREAKOUT = "ConfPortBreakout"
    CURRENT_FSM_NOP = "nop"
...
class SwExtUtilityFsm(ManagedObject):
    """This is SwExtUtilityFsm class."""

    consts = SwExtUtilityFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("SwExtUtilityFsm", "swExtUtilityFsm", "fsm", VersionMeta.Version311e, "OutputOnly", 0xf, [], [""], [u'swExtUtility'], [u'swExtUtilityFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "SwExtUtilityFsm", parent_mo_or_dn, **kwargs)
