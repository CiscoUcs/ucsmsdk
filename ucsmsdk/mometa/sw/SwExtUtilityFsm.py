...
class SwExtUtilityFsm(ManagedObject):
    ...
    mo_meta = MoMeta("SwExtUtilityFsm", "swExtUtilityFsm", "fsm", None, "OutputOnly", 0xfL, [], [""], [u'swExtUtility'], [u'swExtUtilityFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["ConfPortBreakout", "nop"], []), 
