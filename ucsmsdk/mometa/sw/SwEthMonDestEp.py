...
class SwEthMonDestEp(ManagedObject):
    ...
    mo_meta = MoMeta("SwEthMonDestEp", "swEthMonDestEp", "mon-dest-[slot_id]-port-[port_id]", VersionMeta.Version141i, "InputOutput", 0x3ffL, [], ["read-only"], [u'swEthMon', u'swFcMon', u'swSubGroup'], [], ["Get"])
