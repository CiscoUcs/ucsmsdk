...
class SwEthMonDestEp(ManagedObject):
    ...
    mo_meta = MoMeta("SwEthMonDestEp", "swEthMonDestEp", "mon-dest-[slot_id]-port-[port_id]", VersionMeta.Version141i, "InputOutput", 0x1ffL, [], ["read-only"], [u'swEthMon', u'swSubGroup'], [], ["Get"])
