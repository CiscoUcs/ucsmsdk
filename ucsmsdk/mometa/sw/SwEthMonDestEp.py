"""This module contains the general information for SwEthMonDestEp ManagedObject."""
...
class SwEthMonDestEp(ManagedObject):
    """This is SwEthMonDestEp class."""

    consts = SwEthMonDestEpConsts()
    naming_props = set(['slotId', 'portId'])

    mo_meta = MoMeta("SwEthMonDestEp", "swEthMonDestEp", "mon-dest-[slot_id]-port-[port_id]", VersionMeta.Version141i, "InputOutput", 0x3ff, [], ["read-only"], ['swEthMon', 'swFcMon', 'swSubGroup'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "ep_dn": MoPropertyMeta("ep_dn", "epDn", "string", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x10, 0, 256, None, [], []),
        ...
        "port_id": MoPropertyMeta("port_id", "portId", "uint", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x40, None, None, None, [], []),
        ...
        "slot_id": MoPropertyMeta("slot_id", "slotId", "uint", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x100, None, None, None, [], []),
    ...
    def __init__(self, parent_mo_or_dn, slot_id, port_id, **kwargs):
        ...
        ManagedObject.__init__(self, "SwEthMonDestEp", parent_mo_or_dn, **kwargs)
