...
class SwEthLanBorderFsm(ManagedObject):
    """This is SwEthLanBorderFsm class."""

    consts = SwEthLanBorderFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("SwEthLanBorderFsm", "swEthLanBorderFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'swEthLanBorder'], [u'swEthLanBorderFsmStage'], [None])
