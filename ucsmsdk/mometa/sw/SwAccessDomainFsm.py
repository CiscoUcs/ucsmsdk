...
class SwAccessDomainFsm(ManagedObject):
    """This is SwAccessDomainFsm class."""

    consts = SwAccessDomainFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("SwAccessDomainFsm", "swAccessDomainFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'swAccessDomain'], [u'swAccessDomainFsmStage'], [None])
