...
class SwEthLanBorderConsts:
    ...
    FSM_PREV_DEPLOY_UPDATE_MACSEC = "DeployUpdateMacsec"
    FSM_PREV_DEPLOY_UPDATE_VLAN_GROUPS = "DeployUpdateVlanGroups"
    FSM_PREV_DEPLOY_WAIT_FOR_UPDATE_ENCRYPTION_FSM = "DeployWaitForUpdateEncryptionFsm"
    ...
    FSM_STATUS_DEPLOY_UPDATE_MACSEC = "DeployUpdateMacsec"
    FSM_STATUS_DEPLOY_UPDATE_VLAN_GROUPS = "DeployUpdateVlanGroups"
    FSM_STATUS_DEPLOY_WAIT_FOR_UPDATE_ENCRYPTION_FSM = "DeployWaitForUpdateEncryptionFsm"
...
class SwEthLanBorder(ManagedObject):
    ...
    mo_meta = MoMeta("SwEthLanBorder", "swEthLanBorder", "border-eth", VersionMeta.Version101e, "InputOutput", 0x7f, [], ["read-only"], ['networkElement'], ['eventInst', 'fabricMacSec', 'faultInst', 'swEthEstcEp', 'swEthEstcPc', 'swEthLanBorderFsm', 'swEthLanBorderFsmTask', 'swEthLanEp', 'swEthLanPc', 'swSubGroup', 'swVlan', 'swVlanGroup'], ["Get"])
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version101e, MoPropertyMeta.INTERNAL, None, None, None, None, ["DeployBegin", "DeployFail", "DeploySuccess", "DeployUpdateConnectivity", "DeployUpdateMacsec", "DeployUpdateVlanGroups", "DeployWaitForUpdateEncryptionFsm", "DeployWaitOnSwConfigHost", "nop"], []),
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version101e, MoPropertyMeta.INTERNAL, None, None, None, None, ["DeployBegin", "DeployFail", "DeploySuccess", "DeployUpdateConnectivity", "DeployUpdateMacsec", "DeployUpdateVlanGroups", "DeployWaitForUpdateEncryptionFsm", "DeployWaitOnSwConfigHost", "nop"], []),
