"""This module contains the general information for SwFcSanEp ManagedObject."""
import sys, os
...
class SwFcSanEp(ManagedObject):
    """This is SwFcSanEp class."""

    consts = SwFcSanEpConsts()
    naming_props = set([u'slotId', u'portId'])

    mo_meta = MoMeta("SwFcSanEp", "swFcSanEp", "ep-slot-[slot_id]port-[port_id]", VersionMeta.Version101e, "InputOutput", 0xffL, [], ["read-only"], [u'swFcSanBorder'], [], ["Get"])

    prop_meta = {
        "admin_speed": MoPropertyMeta("admin_speed", "adminSpeed", "string", VersionMeta.Version141i, MoPropertyMeta.READ_ONLY, None, None, None, None, ["1gbps", "2gbps", "4gbps", "8gbps", "auto", "indeterminate"], []), 
        ...
        "fill_pattern": MoPropertyMeta("fill_pattern", "fillPattern", "string", VersionMeta.Version212a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["arbff", "idle"], []), 
        ...
        "slot_id": MoPropertyMeta("slot_id", "slotId", "uint", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x40L, None, None, None, [], []), 
    ...
    def __init__(self, parent_mo_or_dn, slot_id, port_id, **kwargs):
        ...
        ManagedObject.__init__(self, "SwFcSanEp", parent_mo_or_dn, **kwargs)
