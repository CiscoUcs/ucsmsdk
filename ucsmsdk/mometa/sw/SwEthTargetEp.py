...
class SwEthTargetEp(ManagedObject):
    ...
    mo_meta = MoMeta("SwEthTargetEp", "swEthTargetEp", "eth-target-[name]", VersionMeta.Version141i, "InputOutput", 0x1fL, [], ["read-only"], [u'swEthEstcEp', u'swEthEstcPc'], [u'faultInst'], ["Get"])
    ...
    prop_meta = {
        ...
        "mac_address": MoPropertyMeta("mac_address", "macAddress", "string", VersionMeta.Version141i, MoPropertyMeta.READ_ONLY, None, None, None, """(([0-9a-fA-F][0-9a-fA-F]:){5}([0-9a-fA-F][0-9a-fA-F]))|0""", [], []), 
