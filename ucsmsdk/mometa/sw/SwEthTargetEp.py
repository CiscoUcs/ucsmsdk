...
class SwEthTargetEp(ManagedObject):
    ...
    mo_meta = MoMeta("SwEthTargetEp", "swEthTargetEp", "eth-target-[name]", VersionMeta.Version141i, "InputOutput", 0x7fL, [], ["read-only"], [u'swEthEstcEp', u'swEthEstcPc'], [u'faultInst'], ["Get"])
    ...
    prop_meta = {
        ...
        "auto_negotiate": MoPropertyMeta("auto_negotiate", "autoNegotiate", "string", None, MoPropertyMeta.READ_WRITE, 0x2L, None, None, None, ["false", "no", "true", "yes"], []), 
