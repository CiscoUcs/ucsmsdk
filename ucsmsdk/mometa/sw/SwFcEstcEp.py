...
class SwFcEstcEp(ManagedObject):
    """This is SwFcEstcEp class."""

    consts = SwFcEstcEpConsts()
    naming_props = set([u'slotId', u'portId'])

    mo_meta = MoMeta("SwFcEstcEp", "swFcEstcEp", "fcestc-ep-slot-[slot_id]port-[port_id]", VersionMeta.Version141i, "InputOutput", 0x1ffL, [], ["read-only"], [u'swFcSanBorder'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "port_id": MoPropertyMeta("port_id", "portId", "uint", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x10L, None, None, None, [], []), 
        "port_vsan_id": MoPropertyMeta("port_vsan_id", "portVsanId", "uint", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x20L, None, None, None, [], ["1-4093"]), 
