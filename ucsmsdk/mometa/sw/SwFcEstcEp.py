...
class SwFcEstcEp(ManagedObject):
    ...
    mo_meta = MoMeta("SwFcEstcEp", "swFcEstcEp", "fcestc-ep-slot-[slot_id]port-[port_id]", VersionMeta.Version141i, "InputOutput", 0x3ffL, [], ["read-only"], [u'swFcSanBorder'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "port_vsan_id": MoPropertyMeta("port_vsan_id", "portVsanId", "uint", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x40L, None, None, None, [], ["1-4093"]), 
