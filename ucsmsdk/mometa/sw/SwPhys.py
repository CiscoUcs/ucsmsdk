...
class SwPhysConsts():
    ...
    FSM_PREV_CONF_PHYSICAL_BEGIN = "ConfPhysicalBegin"
    FSM_PREV_CONF_PHYSICAL_CONFIG_SW_A = "ConfPhysicalConfigSwA"
    FSM_PREV_CONF_PHYSICAL_CONFIG_SW_B = "ConfPhysicalConfigSwB"
    FSM_PREV_CONF_PHYSICAL_FAIL = "ConfPhysicalFail"
    FSM_PREV_CONF_PHYSICAL_PORT_INVENTORY_SW_A = "ConfPhysicalPortInventorySwA"
    FSM_PREV_CONF_PHYSICAL_PORT_INVENTORY_SW_B = "ConfPhysicalPortInventorySwB"
    FSM_PREV_CONF_PHYSICAL_SUCCESS = "ConfPhysicalSuccess"
    FSM_PREV_CONF_PHYSICAL_VERIFY_PHYS_CONFIG = "ConfPhysicalVerifyPhysConfig"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_CONF_PHYSICAL_BEGIN = "ConfPhysicalBegin"
    FSM_STATUS_CONF_PHYSICAL_CONFIG_SW_A = "ConfPhysicalConfigSwA"
    FSM_STATUS_CONF_PHYSICAL_CONFIG_SW_B = "ConfPhysicalConfigSwB"
    FSM_STATUS_CONF_PHYSICAL_FAIL = "ConfPhysicalFail"
    FSM_STATUS_CONF_PHYSICAL_PORT_INVENTORY_SW_A = "ConfPhysicalPortInventorySwA"
    FSM_STATUS_CONF_PHYSICAL_PORT_INVENTORY_SW_B = "ConfPhysicalPortInventorySwB"
    FSM_STATUS_CONF_PHYSICAL_SUCCESS = "ConfPhysicalSuccess"
    FSM_STATUS_CONF_PHYSICAL_VERIFY_PHYS_CONFIG = "ConfPhysicalVerifyPhysConfig"
    FSM_STATUS_NOP = "nop"


class SwPhys(ManagedObject):
    """This is SwPhys class."""

    consts = SwPhysConsts()
    naming_props = set([])

    mo_meta = MoMeta("SwPhys", "swPhys", "phys", VersionMeta.Version201m, "InputOutput", 0xfL, [], ["read-only"], [u'networkElement'], [u'eventInst', u'faultInst', u'swPhysEtherEp', u'swPhysFcEp', u'swPhysFsm', u'swPhysFsmTask', u'swSubGroup'], ["Get"])
    ...
    prop_meta = {
        ...
        "conf_mode": MoPropertyMeta("conf_mode", "confMode", "string", VersionMeta.Version201m, MoPropertyMeta.READ_ONLY, None, None, None, None, ["failed", "in-progress", "none", "verifying"], []), 
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version201m, MoPropertyMeta.INTERNAL, None, None, None, None, ["ConfPhysicalBegin", "ConfPhysicalConfigSwA", "ConfPhysicalConfigSwB", "ConfPhysicalFail", "ConfPhysicalPortInventorySwA", "ConfPhysicalPortInventorySwB", "ConfPhysicalSuccess", "ConfPhysicalVerifyPhysConfig", "nop"], []), 
        ...
        "status": MoPropertyMeta("status", "status", "string", VersionMeta.Version201m, MoPropertyMeta.READ_WRITE, 0x8L, None, None, """((removed|created|modified|deleted),){0,3}(removed|created|modified|deleted){0,1}""", [], []), 
    }
