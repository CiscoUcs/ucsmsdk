"""This module contains the general information for SwFcMonFsm ManagedObject."""
import sys, os
...
class SwFcMonFsm(ManagedObject):
    """This is SwFcMonFsm class."""

    consts = SwFcMonFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("SwFcMonFsm", "swFcMonFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'swFcMon'], [u'swFcMonFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "SwFcMonFsm", parent_mo_or_dn, **kwargs)
