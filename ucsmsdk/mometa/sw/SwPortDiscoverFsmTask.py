...
class SwPortDiscoverFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("SwPortDiscoverFsmTask", "swPortDiscoverFsmTask", "task-[item]", None, "OutputOnly", 0xf, [], [""], [u'swPortDiscover'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", None, MoPropertyMeta.NAMING, None, None, None, None, ["Deploy", "nop"], []), 
