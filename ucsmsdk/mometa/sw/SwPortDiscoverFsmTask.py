"""This module contains the general information for SwPortDiscoverFsmTask ManagedObject."""
...
class SwPortDiscoverFsmTaskConsts:
...
class SwPortDiscoverFsmTask(ManagedObject):
    """This is SwPortDiscoverFsmTask class."""

    consts = SwPortDiscoverFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("SwPortDiscoverFsmTask", "swPortDiscoverFsmTask", "task-[item]", VersionMeta.Version321d, "OutputOnly", 0xf, [], [""], [u'swPortDiscover'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version321d, MoPropertyMeta.NAMING, None, None, None, None, ["Deploy", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "SwPortDiscoverFsmTask", parent_mo_or_dn, **kwargs)
