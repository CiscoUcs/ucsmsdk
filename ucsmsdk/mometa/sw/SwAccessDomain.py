"""This module contains the general information for SwAccessDomain ManagedObject."""
import sys, os
...
class SwAccessDomain(ManagedObject):
    ...
    mo_meta = MoMeta("SwAccessDomain", "swAccessDomain", "access-eth", VersionMeta.Version101e, "InputOutput", 0x7fL, [], ["read-only"], [u'networkElement'], [u'eventInst', u'faultInst', u'swAccessDomainFsm', u'swAccessDomainFsmTask', u'swAccessEp', u'swSubGroup'], ["Get"])
