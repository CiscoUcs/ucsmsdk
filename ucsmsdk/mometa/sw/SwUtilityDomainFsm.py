"""This module contains the general information for SwUtilityDomainFsm ManagedObject."""
import sys, os
...
class SwUtilityDomainFsmConsts():
    COMPLETION_TIME_ = ""
...
class SwUtilityDomainFsm(ManagedObject):
    """This is SwUtilityDomainFsm class."""

    consts = SwUtilityDomainFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("SwUtilityDomainFsm", "swUtilityDomainFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'swUtilityDomain'], [u'swUtilityDomainFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "SwUtilityDomainFsm", parent_mo_or_dn, **kwargs)
