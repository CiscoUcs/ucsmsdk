...
class SwExtUtility(ManagedObject):
    ...
    mo_meta = MoMeta("SwExtUtility", "swExtUtility", "ext", None, "InputOutput", 0x3fL, [], ["read-only"], [u'networkElement'], [u'eventInst', u'faultInst', u'swExtUtilityFsm', u'swExtUtilityFsmTask', u'swPortBreakout'], [None])
    ...
    prop_meta = {
        ...
        "switch_id": MoPropertyMeta("switch_id", "switchId", "string", None, MoPropertyMeta.READ_WRITE, 0x20L, None, None, None, ["A", "B", "NONE"], []), 
    }
