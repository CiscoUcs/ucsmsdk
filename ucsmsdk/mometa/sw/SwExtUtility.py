...
class SwExtUtilityConsts:
    ...
    CONF_MODE_NONE = "none"
    CONF_MODE_VERIFYING = "verifying"
    FSM_PREV_CONF_PORT_BREAKOUT_BEGIN = "ConfPortBreakoutBegin"
    FSM_PREV_CONF_PORT_BREAKOUT_CONFIG_SW_A = "ConfPortBreakoutConfigSwA"
    FSM_PREV_CONF_PORT_BREAKOUT_CONFIG_SW_B = "ConfPortBreakoutConfigSwB"
    FSM_PREV_CONF_PORT_BREAKOUT_FAIL = "ConfPortBreakoutFail"
    FSM_PREV_CONF_PORT_BREAKOUT_PORT_INVENTORY_SW_A = "ConfPortBreakoutPortInventorySwA"
    FSM_PREV_CONF_PORT_BREAKOUT_PORT_INVENTORY_SW_B = "ConfPortBreakoutPortInventorySwB"
    FSM_PREV_CONF_PORT_BREAKOUT_SUCCESS = "ConfPortBreakoutSuccess"
    FSM_PREV_CONF_PORT_BREAKOUT_VERIFY_BREAKOUT_CONFIG = "ConfPortBreakoutVerifyBreakoutConfig"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_CONF_PORT_BREAKOUT_BEGIN = "ConfPortBreakoutBegin"
    FSM_STATUS_CONF_PORT_BREAKOUT_CONFIG_SW_A = "ConfPortBreakoutConfigSwA"
    FSM_STATUS_CONF_PORT_BREAKOUT_CONFIG_SW_B = "ConfPortBreakoutConfigSwB"
    FSM_STATUS_CONF_PORT_BREAKOUT_FAIL = "ConfPortBreakoutFail"
    FSM_STATUS_CONF_PORT_BREAKOUT_PORT_INVENTORY_SW_A = "ConfPortBreakoutPortInventorySwA"
    FSM_STATUS_CONF_PORT_BREAKOUT_PORT_INVENTORY_SW_B = "ConfPortBreakoutPortInventorySwB"
    FSM_STATUS_CONF_PORT_BREAKOUT_SUCCESS = "ConfPortBreakoutSuccess"
    FSM_STATUS_CONF_PORT_BREAKOUT_VERIFY_BREAKOUT_CONFIG = "ConfPortBreakoutVerifyBreakoutConfig"
    FSM_STATUS_NOP = "nop"
    SWITCH_ID_A = "A"
    SWITCH_ID_B = "B"
    SWITCH_ID_NONE = "NONE"
...
class SwExtUtility(ManagedObject):
    """This is SwExtUtility class."""
    ...
    prop_meta = {
        ...
        "switch_id": MoPropertyMeta("switch_id", "switchId", "string", VersionMeta.Version311e, MoPropertyMeta.READ_WRITE, 0x20, None, None, None, ["A", "B", "NONE"], []),
    }
