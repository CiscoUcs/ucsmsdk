...
class SwNetflowExporter(ManagedObject):
    ...
    mo_meta = MoMeta("SwNetflowExporter", "swNetflowExporter", "flowexporter-netflow-[name]", VersionMeta.Version221b, "InputOutput", 0x3fL, [], ["read-only"], [u'swEthLanFlowMon'], [u'swVlan'], [None])
