...
class SwNetflowExporter(ManagedObject):
    ...
    mo_meta = MoMeta("SwNetflowExporter", "swNetflowExporter", "flowexporter-netflow-[name]", VersionMeta.Version221b, "InputOutput", 0x1fL, [], ["read-only"], [u'swEthLanFlowMon'], [u'swVlan'], [None])
    ...
    prop_meta = {
        ...
        "destination_ip_address": MoPropertyMeta("destination_ip_address", "destinationIpAddress", "string", VersionMeta.Version221b, MoPropertyMeta.READ_ONLY, None, 0, 256, """((([0-9]){1,3}\.){3}[0-9]{1,3})""", [], []), 
