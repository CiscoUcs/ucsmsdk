...
class SwFcSanBorderFsmStage(ManagedObject):
    """This is SwFcSanBorderFsmStage class."""

    consts = SwFcSanBorderFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("SwFcSanBorderFsmStage", "swFcSanBorderFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'swFcSanBorderFsm'], [], [None])
