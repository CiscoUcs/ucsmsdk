...
class SwPhysFsmStageConsts():
    ...
    NAME_CONF_PHYSICAL_CONFIG_SW_B = "ConfPhysicalConfigSwB"
    NAME_CONF_PHYSICAL_FAIL = "ConfPhysicalFail"
    NAME_CONF_PHYSICAL_PORT_INVENTORY_SW_A = "ConfPhysicalPortInventorySwA"
    NAME_CONF_PHYSICAL_PORT_INVENTORY_SW_B = "ConfPhysicalPortInventorySwB"
    NAME_CONF_PHYSICAL_SUCCESS = "ConfPhysicalSuccess"
    NAME_CONF_PHYSICAL_VERIFY_PHYS_CONFIG = "ConfPhysicalVerifyPhysConfig"
    NAME_NOP = "nop"
...
class SwPhysFsmStage(ManagedObject):
    """This is SwPhysFsmStage class."""

    consts = SwPhysFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("SwPhysFsmStage", "swPhysFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'swPhysFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["ConfPhysicalBegin", "ConfPhysicalConfigSwA", "ConfPhysicalConfigSwB", "ConfPhysicalFail", "ConfPhysicalPortInventorySwA", "ConfPhysicalPortInventorySwB", "ConfPhysicalSuccess", "ConfPhysicalVerifyPhysConfig", "nop"], []), 
