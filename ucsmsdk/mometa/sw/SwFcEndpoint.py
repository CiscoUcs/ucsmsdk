...
class SwFcEndpoint(ManagedObject):
    ...
    mo_meta = MoMeta("SwFcEndpoint", "swFcEndpoint", "wwpn-[wwpn]", VersionMeta.Version911z, "InputOutput", 0x7f, [], ["read-only"], [u'swFcUserZone'], [], [None])
    ...
    prop_meta = {
        ...
        "ep_dn": MoPropertyMeta("ep_dn", "epDn", "string", VersionMeta.Version911z, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version911z, MoPropertyMeta.READ_WRITE, 0x8, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        ...
        "wwpn": MoPropertyMeta("wwpn", "wwpn", "string", VersionMeta.Version911z, MoPropertyMeta.NAMING, 0x40, 0, 256, r"""(([A-Fa-f0-9][A-Fa-f0-9]:){7}[A-Fa-f0-9][A-Fa-f0-9])|0""", [], []), 
    }
