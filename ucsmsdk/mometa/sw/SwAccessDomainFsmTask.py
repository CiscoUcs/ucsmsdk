"""This module contains the general information for SwAccessDomainFsmTask ManagedObject."""
import sys, os
...
class SwAccessDomainFsmTaskConsts():
...
class SwAccessDomainFsmTask(ManagedObject):
    """This is SwAccessDomainFsmTask class."""

    consts = SwAccessDomainFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("SwAccessDomainFsmTask", "swAccessDomainFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], [""], [u'swAccessDomain'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "SwAccessDomainFsmTask", parent_mo_or_dn, **kwargs)
