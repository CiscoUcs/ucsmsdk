...
class SwEthLanBorderFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("SwEthLanBorderFsmStage", "swEthLanBorderFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'swEthLanBorderFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["DeployBegin", "DeployFail", "DeploySuccess", "DeployUpdateConnectivity", "DeployUpdateVlanGroups", "nop"], []), 
