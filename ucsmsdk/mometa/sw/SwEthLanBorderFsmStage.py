"""This module contains the general information for SwEthLanBorderFsmStage ManagedObject."""
...
class SwEthLanBorderFsmStageConsts:
    LAST_UPDATE_TIME_ = ""
    ...
    NAME_DEPLOY_WAIT_FOR_UPDATE_ENCRYPTION_FSM = "DeployWaitForUpdateEncryptionFsm"
...
class SwEthLanBorderFsmStage(ManagedObject):
    """This is SwEthLanBorderFsmStage class."""

    consts = SwEthLanBorderFsmStageConsts()
    naming_props = set(['name'])

    mo_meta = MoMeta("SwEthLanBorderFsmStage", "swEthLanBorderFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xf, [], [""], ['swEthLanBorderFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["DeployBegin", "DeployFail", "DeploySuccess", "DeployUpdateConnectivity", "DeployUpdateMacsec", "DeployUpdateVlanGroups", "DeployWaitForUpdateEncryptionFsm", "DeployWaitOnSwConfigHost", "nop"], []),
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "SwEthLanBorderFsmStage", parent_mo_or_dn, **kwargs)
