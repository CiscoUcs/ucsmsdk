"""This module contains the general information for SwFcSanBorderFsmTask ManagedObject."""
import sys, os
...
class SwFcSanBorderFsmTaskConsts():
    COMPLETION_CANCELLED = "cancelled"
    COMPLETION_COMPLETED = "completed"
    COMPLETION_PROCESSING = "processing"
    COMPLETION_SCHEDULED = "scheduled"
    ITEM_ACTIVATE_ZONE_SET = "ActivateZoneSet"
    ITEM_DEPLOY = "Deploy"
    ITEM_NOP = "nop"


class SwFcSanBorderFsmTask(ManagedObject):
    """This is SwFcSanBorderFsmTask class."""

    consts = SwFcSanBorderFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("SwFcSanBorderFsmTask", "swFcSanBorderFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], [""], [u'swFcSanBorder'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, None, None, None, None, ["ActivateZoneSet", "Deploy", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "SwFcSanBorderFsmTask", parent_mo_or_dn, **kwargs)
