"""This module contains the general information for SwFcMonSrcEp ManagedObject."""
import sys, os
...
class SwFcMonSrcEp(ManagedObject):
    """This is SwFcMonSrcEp class."""

    consts = SwFcMonSrcEpConsts()
    naming_props = set([u'chassisId', u'slotId', u'portId'])

    mo_meta = MoMeta("SwFcMonSrcEp", "swFcMonSrcEp", "mon-src-[chassis_id]-[slot_id]-[port_id]", VersionMeta.Version141i, "InputOutput", 0x3ffL, [], ["read-only"], [u'swFcMon'], [], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, chassis_id, slot_id, port_id, **kwargs):
        ...
        ManagedObject.__init__(self, "SwFcMonSrcEp", parent_mo_or_dn, **kwargs)
