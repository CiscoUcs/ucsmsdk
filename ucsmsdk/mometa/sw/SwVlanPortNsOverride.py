...
class SwVlanPortNsOverride(ManagedObject):
    ...
    mo_meta = MoMeta("SwVlanPortNsOverride", "swVlanPortNsOverride", "vlan-port-override", VersionMeta.Version142b, "InputOutput", 0x1fL, [], ["admin"], [u'topSysDefaults'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "limit": MoPropertyMeta("limit", "limit", "uint", VersionMeta.Version142b, MoPropertyMeta.READ_WRITE, 0x4L, None, None, None, [], []), 
