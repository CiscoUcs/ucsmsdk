...
class SwEthMonFsm(ManagedObject):
    """This is SwEthMonFsm class."""

    consts = SwEthMonFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("SwEthMonFsm", "swEthMonFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'swEthMon'], [u'swEthMonFsmStage'], [None])
