...
class CommSnmp(ManagedObject):
    ...
    prop_meta = {
        ...
        "snmp_oper_state": MoPropertyMeta("snmp_oper_state", "snmpOperState", "string", VersionMeta.Version311e, MoPropertyMeta.READ_ONLY, None, None, None, None, ["disabled", "enabled"], []), 
