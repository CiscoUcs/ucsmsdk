"""This module contains the general information for CommTelnet ManagedObject."""
...
class CommTelnet(ManagedObject):
    """This is CommTelnet class."""

    consts = CommTelnetConsts()
    naming_props = set([])

    mo_meta = MoMeta("CommTelnet", "commTelnet", "telnet-svc", VersionMeta.Version101e, "InputOutput", 0x7ff, [], ["aaa", "admin"], ['commSvcEp'], ['faultInst'], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version101e, MoPropertyMeta.CREATE_ONLY, 0x40, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []),
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "CommTelnet", parent_mo_or_dn, **kwargs)
