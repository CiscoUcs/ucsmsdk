...
class CommXmlClConnPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("CommXmlClConnPolicy", "commXmlClConnPolicy", "xmlclconnpolicy-[client_type]", VersionMeta.Version131c, "InputOutput", 0x3ffL, [], ["aaa", "admin"], [u'commSvcEp'], [], ["Get"])

    prop_meta = {
        "admin_state": MoPropertyMeta("admin_state", "adminState", "string", VersionMeta.Version131c, MoPropertyMeta.READ_WRITE, 0x1L, None, None, None, ["disabled", "enabled"], []), 
        ...
        "client_type": MoPropertyMeta("client_type", "clientType", "string", VersionMeta.Version131c, MoPropertyMeta.NAMING, 0x4L, None, None, None, ["extrenal-api-client", "flex-ui", "java-ui"], []), 
        "descr": MoPropertyMeta("descr", "descr", "string", VersionMeta.Version131c, MoPropertyMeta.READ_WRITE, 0x8L, None, None, """[ !#$%&\(\)\*\+,\-\./:;\?@\[\]_\{\|\}~a-zA-Z0-9]{0,256}""", [], []), 
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version131c, MoPropertyMeta.CREATE_ONLY, 0x20L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        ...
        "port": MoPropertyMeta("port", "port", "uint", VersionMeta.Version131c, MoPropertyMeta.READ_WRITE, 0x80L, None, None, None, [], ["0-65535"]), 
