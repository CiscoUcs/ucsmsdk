...
class CommWebSvcLimits(ManagedObject):
    ...
    mo_meta = MoMeta("CommWebSvcLimits", "commWebSvcLimits", "web-svc-limits", VersionMeta.Version141i, "InputOutput", 0x3ffL, [], ["aaa", "admin"], [u'commSvcEp'], [], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "sessions_per_user": MoPropertyMeta("sessions_per_user", "sessionsPerUser", "ushort", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x80L, None, None, None, [], ["1-256"]), 
        ...
        "total_sessions": MoPropertyMeta("total_sessions", "totalSessions", "ushort", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x200L, None, None, None, [], ["1-256"]), 
    }
