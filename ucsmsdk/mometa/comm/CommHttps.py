...
class CommHttps(ManagedObject):
    ...
    mo_meta = MoMeta("CommHttps", "commHttps", "https-svc", VersionMeta.Version101e, "InputOutput", 0x7fff, [], ["aaa", "admin"], ['commSvcEp'], ['faultInst'], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "allowed_ssl_protocols": MoPropertyMeta("allowed_ssl_protocols", "allowedSSLProtocols", "string", VersionMeta.Version321d, MoPropertyMeta.READ_WRITE, 0x8, None, None, None, ["all", "tlsv1_2", "tlsv1_3"], []),
        ...
        "cipher_suite": MoPropertyMeta("cipher_suite", "cipherSuite", "string", VersionMeta.Version203a, MoPropertyMeta.READ_WRITE, 0x20, None, None, r"""[!\+\-:\\a-zA-Z0-9]{0,256}""", [], []),
        "cipher_suite_mode": MoPropertyMeta("cipher_suite_mode", "cipherSuiteMode", "string", VersionMeta.Version203a, MoPropertyMeta.READ_WRITE, 0x40, None, None, None, ["custom", "high-strength", "low-strength", "medium-strength"], []),
        "descr": MoPropertyMeta("descr", "descr", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x80, None, None, r"""[ !#$%&\(\)\*\+,\-\./:;\?@\[\]_\{\|\}~a-zA-Z0-9]{0,256}""", [], []),
        ...
        "key_ring": MoPropertyMeta("key_ring", "keyRing", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x200, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []),
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version101e, MoPropertyMeta.CREATE_ONLY, 0x400, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []),
