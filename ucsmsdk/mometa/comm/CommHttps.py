...
class CommHttps(ManagedObject):
    ...
    mo_meta = MoMeta("CommHttps", "commHttps", "https-svc", VersionMeta.Version101e, "InputOutput", 0xfffL, [], ["aaa", "admin"], [u'commSvcEp'], [], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "cipher_suite": MoPropertyMeta("cipher_suite", "cipherSuite", "string", VersionMeta.Version203a, MoPropertyMeta.READ_WRITE, 0x4L, None, None, """[!\+,\-\./:;<=>\?@\[\\a-zA-Z0-9]{0,256}""", [], []), 
        "cipher_suite_mode": MoPropertyMeta("cipher_suite_mode", "cipherSuiteMode", "string", VersionMeta.Version203a, MoPropertyMeta.READ_WRITE, 0x8L, None, None, None, ["custom", "high-strength", "low-strength", "medium-strength"], []), 
        ...
        "key_ring": MoPropertyMeta("key_ring", "keyRing", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x40L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version101e, MoPropertyMeta.CREATE_ONLY, 0x80L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        ...
        "port": MoPropertyMeta("port", "port", "uint", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x200L, None, None, None, [], ["1-65535"]), 
