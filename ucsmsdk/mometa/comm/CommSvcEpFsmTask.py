"""This module contains the general information for CommSvcEpFsmTask ManagedObject."""
import sys, os
...
class CommSvcEpFsmTaskConsts():
    COMPLETION_CANCELLED = "cancelled"
    COMPLETION_COMPLETED = "completed"
    COMPLETION_PROCESSING = "processing"
    COMPLETION_SCHEDULED = "scheduled"
    ITEM_NOP = "nop"
    ITEM_RESTART_WEB_SVC = "restartWebSvc"
    ITEM_UPDATE_SVC_EP = "updateSvcEp"


class CommSvcEpFsmTask(ManagedObject):
    """This is CommSvcEpFsmTask class."""

    consts = CommSvcEpFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("CommSvcEpFsmTask", "commSvcEpFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], [""], [u'commSvcEp'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, None, None, None, None, ["nop", "restartWebSvc", "updateSvcEp"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "CommSvcEpFsmTask", parent_mo_or_dn, **kwargs)
