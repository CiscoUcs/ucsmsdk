...
class CommDns(ManagedObject):
    ...
    mo_meta = MoMeta("CommDns", "commDns", "dns-svc", VersionMeta.Version101e, "InputOutput", 0x3ffL, [], ["aaa", "admin", "ext-lan-config"], [u'commLocale', u'commSvcEp', u'commSvcPolicy'], [u'commDnsProvider'], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "domain": MoPropertyMeta("domain", "domain", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x10L, None, None, None, [], []), 
