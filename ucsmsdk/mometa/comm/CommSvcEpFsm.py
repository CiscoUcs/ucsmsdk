"""This module contains the general information for CommSvcEpFsm ManagedObject."""
import sys, os
...
class CommSvcEpFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_NOP = "nop"
    CURRENT_FSM_RESTART_WEB_SVC = "restartWebSvc"
    CURRENT_FSM_UPDATE_SVC_EP = "updateSvcEp"
...
class CommSvcEpFsm(ManagedObject):
    """This is CommSvcEpFsm class."""

    consts = CommSvcEpFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("CommSvcEpFsm", "commSvcEpFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'commSvcEp'], [u'commSvcEpFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["nop", "restartWebSvc", "updateSvcEp"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "CommSvcEpFsm", parent_mo_or_dn, **kwargs)
