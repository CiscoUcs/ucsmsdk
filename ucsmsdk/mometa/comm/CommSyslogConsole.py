...
class CommSyslogConsole(ManagedObject):
    ...
    mo_meta = MoMeta("CommSyslogConsole", "commSyslogConsole", "console", VersionMeta.Version101e, "InputOutput", 0x1ffL, [], ["admin", "operations"], [u'commSyslog'], [], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "severity": MoPropertyMeta("severity", "severity", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x80L, None, None, None, ["alerts", "critical", "emergencies"], []), 
