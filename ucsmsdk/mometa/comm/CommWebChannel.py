...
class CommWebChannel(ManagedObject):
    """This is CommWebChannel class."""

    consts = CommWebChannelConsts()
    naming_props = set([])

    mo_meta = MoMeta("CommWebChannel", "commWebChannel", "svc-web-channel", VersionMeta.Version101e, "InputOutput", 0x1ffL, [], ["aaa", "admin"], [u'commSvcEp'], [], ["Get"])

    prop_meta = {
        "channel_state": MoPropertyMeta("channel_state", "channelState", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x2L, None, None, None, ["fullssl", "noencssl", "plain"], []), 
