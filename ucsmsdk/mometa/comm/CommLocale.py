...
class CommLocale(ManagedObject):
    ...
    mo_meta = MoMeta("CommLocale", "commLocale", "locale-[name]", VersionMeta.Version302c, "InputOutput", 0x7fL, [], ["read-only"], [u'storageProcessor'], [u'commDateTime', u'commDns', u'commSyslog'], [None])
