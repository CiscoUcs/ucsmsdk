...
class CommCimcWebService(ManagedObject):
    ...
    mo_meta = MoMeta("CommCimcWebService", "commCimcWebService", "cimc-web-svc", VersionMeta.Version221b, "InputOutput", 0x1ffL, [], ["aaa", "admin"], [u'commSvcEp'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version221b, MoPropertyMeta.CREATE_ONLY, 0x10L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        ...
        "port": MoPropertyMeta("port", "port", "uint", VersionMeta.Version221b, MoPropertyMeta.READ_WRITE, 0x40L, None, None, None, [], ["0-65535"]), 
