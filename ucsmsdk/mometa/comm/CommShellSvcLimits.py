...
class CommShellSvcLimits(ManagedObject):
    ...
    prop_meta = {
        ...
        "sessions_per_user": MoPropertyMeta("sessions_per_user", "sessionsPerUser", "ushort", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x80, None, None, None, [], ["1-32"]),
        ...
        "total_sessions": MoPropertyMeta("total_sessions", "totalSessions", "ushort", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x200, None, None, None, [], ["1-32"]),
    }
