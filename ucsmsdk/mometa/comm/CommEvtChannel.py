"""This module contains the general information for CommEvtChannel ManagedObject."""
import sys, os
...
class CommEvtChannel(ManagedObject):
    """This is CommEvtChannel class."""

    consts = CommEvtChannelConsts()
    naming_props = set([])

    mo_meta = MoMeta("CommEvtChannel", "commEvtChannel", "svc-evt-channel", VersionMeta.Version101e, "InputOutput", 0xffL, [], ["aaa", "admin"], [u'commSvcEp'], [], ["Get"])

    prop_meta = {
        "channel_state": MoPropertyMeta("channel_state", "channelState", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x1L, None, None, None, ["fullssl", "noencssl", "plain"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "CommEvtChannel", parent_mo_or_dn, **kwargs)
