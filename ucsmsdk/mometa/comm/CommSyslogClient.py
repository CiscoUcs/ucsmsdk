...
class CommSyslogClient(ManagedObject):
    ...
    mo_meta = MoMeta("CommSyslogClient", "commSyslogClient", "client-[name]", VersionMeta.Version101e, "InputOutput", 0x1ffL, [], ["admin", "operations"], [u'commSyslog'], [], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "forwarding_facility": MoPropertyMeta("forwarding_facility", "forwardingFacility", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x8L, None, None, None, ["local0", "local1", "local2", "local3", "local4", "local5", "local6", "local7"], []), 
        "hostname": MoPropertyMeta("hostname", "hostname", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x10L, None, None, None, [], []), 
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x20L, None, None, None, ["primary", "secondary", "tertiary"], []), 
