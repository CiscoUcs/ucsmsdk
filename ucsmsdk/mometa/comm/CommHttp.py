...
class CommHttp(ManagedObject):
    ...
    mo_meta = MoMeta("CommHttp", "commHttp", "http-svc", VersionMeta.Version101e, "InputOutput", 0x3ffL, [], ["aaa", "admin"], [u'commSvcEp'], [], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "redirect_state": MoPropertyMeta("redirect_state", "redirectState", "string", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x80L, None, None, None, ["disabled", "enabled"], []), 
