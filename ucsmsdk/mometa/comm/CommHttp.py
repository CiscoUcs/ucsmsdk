...
class CommHttp(ManagedObject):
    ...
    mo_meta = MoMeta("CommHttp", "commHttp", "http-svc", VersionMeta.Version101e, "InputOutput", 0x1fff, [], ["aaa", "admin"], ['commSvcEp'], ['faultInst'], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "redirect_state": MoPropertyMeta("redirect_state", "redirectState", "string", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x200, None, None, None, ["disabled", "enabled"], []),
        "request_timeout": MoPropertyMeta("request_timeout", "requestTimeout", "uint", VersionMeta.Version312b, MoPropertyMeta.READ_WRITE, 0x400, None, None, None, [], ["90-300"]),
