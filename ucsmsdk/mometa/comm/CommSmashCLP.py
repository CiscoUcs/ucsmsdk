...
class CommSmashCLP(ManagedObject):
    ...
    mo_meta = MoMeta("CommSmashCLP", "commSmashCLP", "smashclp-svc", VersionMeta.Version101e, "InputOutput", 0x1ff, [], ["aaa", "admin"], [u'commSvcEp'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "port": MoPropertyMeta("port", "port", "uint", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x40, None, None, None, [], ["0-65535"]), 
