...
class CommSvcEpConsts:
    ...
    CONFIG_STATE_OK = "ok"
    FSM_PREV_NOP = "nop"
    FSM_PREV_RESTART_WEB_SVC_BEGIN = "restartWebSvcBegin"
    FSM_PREV_RESTART_WEB_SVC_FAIL = "restartWebSvcFail"
    FSM_PREV_RESTART_WEB_SVC_LOCAL = "restartWebSvcLocal"
    FSM_PREV_RESTART_WEB_SVC_PEER = "restartWebSvcPeer"
    FSM_PREV_RESTART_WEB_SVC_SUCCESS = "restartWebSvcSuccess"
    FSM_PREV_UPDATE_SVC_EP_BEGIN = "updateSvcEpBegin"
    FSM_PREV_UPDATE_SVC_EP_FAIL = "updateSvcEpFail"
    FSM_PREV_UPDATE_SVC_EP_INIT_IPTABLES_LOCAL = "updateSvcEpInitIptablesLocal"
    FSM_PREV_UPDATE_SVC_EP_INIT_IPTABLES_PEER = "updateSvcEpInitIptablesPeer"
    FSM_PREV_UPDATE_SVC_EP_PROPOGATE_EP_SETTINGS = "updateSvcEpPropogateEpSettings"
    FSM_PREV_UPDATE_SVC_EP_PROPOGATE_EP_TIME_ZONE_SETTINGS_LOCAL = "updateSvcEpPropogateEpTimeZoneSettingsLocal"
    FSM_PREV_UPDATE_SVC_EP_PROPOGATE_EP_TIME_ZONE_SETTINGS_PEER = "updateSvcEpPropogateEpTimeZoneSettingsPeer"
    FSM_PREV_UPDATE_SVC_EP_PROPOGATE_EP_TIME_ZONE_SETTINGS_TO_ADAPTORS_LOCAL = "updateSvcEpPropogateEpTimeZoneSettingsToAdaptorsLocal"
    FSM_PREV_UPDATE_SVC_EP_PROPOGATE_EP_TIME_ZONE_SETTINGS_TO_ADAPTORS_PEER = "updateSvcEpPropogateEpTimeZoneSettingsToAdaptorsPeer"
    FSM_PREV_UPDATE_SVC_EP_PROPOGATE_EP_TIME_ZONE_SETTINGS_TO_FEX_IOM_LOCAL = "updateSvcEpPropogateEpTimeZoneSettingsToFexIomLocal"
    FSM_PREV_UPDATE_SVC_EP_PROPOGATE_EP_TIME_ZONE_SETTINGS_TO_FEX_IOM_PEER = "updateSvcEpPropogateEpTimeZoneSettingsToFexIomPeer"
    FSM_PREV_UPDATE_SVC_EP_SET_EP_LOCAL = "updateSvcEpSetEpLocal"
    FSM_PREV_UPDATE_SVC_EP_SET_EP_PEER = "updateSvcEpSetEpPeer"
    FSM_PREV_UPDATE_SVC_EP_SUCCESS = "updateSvcEpSuccess"
    ...
    FSM_STATUS_NOP = "nop"
    FSM_STATUS_RESTART_WEB_SVC_BEGIN = "restartWebSvcBegin"
    FSM_STATUS_RESTART_WEB_SVC_FAIL = "restartWebSvcFail"
    FSM_STATUS_RESTART_WEB_SVC_LOCAL = "restartWebSvcLocal"
    FSM_STATUS_RESTART_WEB_SVC_PEER = "restartWebSvcPeer"
    FSM_STATUS_RESTART_WEB_SVC_SUCCESS = "restartWebSvcSuccess"
    FSM_STATUS_UPDATE_SVC_EP_BEGIN = "updateSvcEpBegin"
    FSM_STATUS_UPDATE_SVC_EP_FAIL = "updateSvcEpFail"
    FSM_STATUS_UPDATE_SVC_EP_INIT_IPTABLES_LOCAL = "updateSvcEpInitIptablesLocal"
    FSM_STATUS_UPDATE_SVC_EP_INIT_IPTABLES_PEER = "updateSvcEpInitIptablesPeer"
    FSM_STATUS_UPDATE_SVC_EP_PROPOGATE_EP_SETTINGS = "updateSvcEpPropogateEpSettings"
    FSM_STATUS_UPDATE_SVC_EP_PROPOGATE_EP_TIME_ZONE_SETTINGS_LOCAL = "updateSvcEpPropogateEpTimeZoneSettingsLocal"
    FSM_STATUS_UPDATE_SVC_EP_PROPOGATE_EP_TIME_ZONE_SETTINGS_PEER = "updateSvcEpPropogateEpTimeZoneSettingsPeer"
    FSM_STATUS_UPDATE_SVC_EP_PROPOGATE_EP_TIME_ZONE_SETTINGS_TO_ADAPTORS_LOCAL = "updateSvcEpPropogateEpTimeZoneSettingsToAdaptorsLocal"
    FSM_STATUS_UPDATE_SVC_EP_PROPOGATE_EP_TIME_ZONE_SETTINGS_TO_ADAPTORS_PEER = "updateSvcEpPropogateEpTimeZoneSettingsToAdaptorsPeer"
    FSM_STATUS_UPDATE_SVC_EP_PROPOGATE_EP_TIME_ZONE_SETTINGS_TO_FEX_IOM_LOCAL = "updateSvcEpPropogateEpTimeZoneSettingsToFexIomLocal"
    FSM_STATUS_UPDATE_SVC_EP_PROPOGATE_EP_TIME_ZONE_SETTINGS_TO_FEX_IOM_PEER = "updateSvcEpPropogateEpTimeZoneSettingsToFexIomPeer"
    FSM_STATUS_UPDATE_SVC_EP_SET_EP_LOCAL = "updateSvcEpSetEpLocal"
    FSM_STATUS_UPDATE_SVC_EP_SET_EP_PEER = "updateSvcEpSetEpPeer"
    FSM_STATUS_UPDATE_SVC_EP_SUCCESS = "updateSvcEpSuccess"
    INT_ID_NONE = "none"
