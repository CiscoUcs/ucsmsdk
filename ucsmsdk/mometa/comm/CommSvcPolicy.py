...
class CommSvcPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("CommSvcPolicy", "commSvcPolicy", "comm-pol-[name]", VersionMeta.Version302a, "InputOutput", 0x7fL, [], ["read-only"], [u'orgOrg'], [u'commDateTime', u'commDns', u'commSyslog'], [None])
