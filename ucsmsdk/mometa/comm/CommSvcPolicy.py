...
class CommSvcPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("CommSvcPolicy", "commSvcPolicy", "comm-pol-[name]", VersionMeta.Version302c, "InputOutput", 0xffL, [], ["read-only"], [u'orgOrg'], [u'commDateTime', u'commDns', u'commSyslog'], [None])
