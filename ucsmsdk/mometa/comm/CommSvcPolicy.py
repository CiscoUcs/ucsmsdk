...
class CommSvcPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("CommSvcPolicy", "commSvcPolicy", "comm-pol-[name]", VersionMeta.Version302a, "InputOutput", 0xff, [], ["read-only"], [u'orgOrg'], [u'commDateTime', u'commDns', u'commSyslog'], [None])
