"""This module contains the general information for CommCimxml ManagedObject."""
import sys, os
...
class CommCimxml(ManagedObject):
    """This is CommCimxml class."""

    consts = CommCimxmlConsts()
    naming_props = set([])

    mo_meta = MoMeta("CommCimxml", "commCimxml", "cimxml-svc", VersionMeta.Version101e, "InputOutput", 0x1ffL, [], ["aaa", "admin"], [u'commSvcEp'], [], ["Get", "Set"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "CommCimxml", parent_mo_or_dn, **kwargs)
