"""This module contains the general information for CommWsman ManagedObject."""
import sys, os
...
class CommWsman(ManagedObject):
    """This is CommWsman class."""

    consts = CommWsmanConsts()
    naming_props = set([])

    mo_meta = MoMeta("CommWsman", "commWsman", "wsman-svc", VersionMeta.Version101e, "InputOutput", 0x3ffL, [], ["aaa", "admin"], [u'commSvcEp'], [], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "CommWsman", parent_mo_or_dn, **kwargs)
