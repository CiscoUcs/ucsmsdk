"""This module contains the general information for FcpoolOuisFsm ManagedObject."""
...
class FcpoolOuisFsm(ManagedObject):
    """This is FcpoolOuisFsm class."""

    consts = FcpoolOuisFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("FcpoolOuisFsm", "fcpoolOuisFsm", "fsm", VersionMeta.Version413a, "OutputOnly", 0xf, [], [""], ['fcpoolOuis'], ['fcpoolOuisFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version413a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Deploy", "nop"], []),
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FcpoolOuisFsm", parent_mo_or_dn, **kwargs)
