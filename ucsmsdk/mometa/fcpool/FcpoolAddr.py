...
class FcpoolAddr(ManagedObject):
    ...
    mo_meta = MoMeta("FcpoolAddr", "fcpoolAddr", "[id]", VersionMeta.Version101e, "InputOutput", 0x3fL, [], ["read-only"], [u'fcpoolUniverse'], [u'faultInst', u'fcpoolPoolable'], ["Get"])
    ...
    prop_meta = {
        ...
        "id": MoPropertyMeta("id", "id", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x8L, 0, 256, r"""(([A-Fa-f0-9][A-Fa-f0-9]:){7}[A-Fa-f0-9][A-Fa-f0-9])|0""", [], []), 
