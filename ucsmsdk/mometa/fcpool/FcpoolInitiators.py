...
class FcpoolInitiators(ManagedObject):
    ...
    mo_meta = MoMeta("FcpoolInitiators", "fcpoolInitiators", "wwn-pool-[name]", VersionMeta.Version101e, "InputOutput", 0x3ffL, [], ["admin", "ls-storage-policy"], [u'orgOrg'], [u'faultInst', u'fcpoolBlock', u'fcpoolInitiator'], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "max_ports_per_node": MoPropertyMeta("max_ports_per_node", "maxPortsPerNode", "string", VersionMeta.Version211a, MoPropertyMeta.CREATE_ONLY, 0x10L, None, None, None, ["upto15", "upto3", "upto31", "upto63", "upto7"], []), 
        ...
        "purpose": MoPropertyMeta("purpose", "purpose", "string", VersionMeta.Version101e, MoPropertyMeta.CREATE_ONLY, 0x80L, None, None, None, ["node-and-port-wwn-assignment", "node-wwn-assignment", "port-wwn-assignment"], []), 
