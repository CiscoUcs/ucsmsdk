"""This module contains the general information for FcpoolOuis ManagedObject."""
...
class FcpoolOuisConsts:
    ...
    FSM_STATUS_DEPLOY_REMOTE = "DeployRemote"
    FSM_STATUS_DEPLOY_SUCCESS = "DeploySuccess"
    FSM_STATUS_NOP = "nop"


class FcpoolOuis(ManagedObject):
    """This is FcpoolOuis class."""

    consts = FcpoolOuisConsts()
    naming_props = set(['name'])

    mo_meta = MoMeta("FcpoolOuis", "fcpoolOuis", "oui-pool-[name]", VersionMeta.Version413a, "InputOutput", 0x3f, [], ["admin"], ['networkElement'], ['eventInst', 'faultInst', 'fcpoolOui', 'fcpoolOuisFsm', 'fcpoolOuisFsmTask'], [None])
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version413a, MoPropertyMeta.INTERNAL, None, None, None, None, ["DeployBegin", "DeployFail", "DeployLocal", "DeployRemote", "DeploySuccess", "nop"], []),
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version413a, MoPropertyMeta.INTERNAL, None, None, None, None, ["DeployBegin", "DeployFail", "DeployLocal", "DeployRemote", "DeploySuccess", "nop"], []),
        "fsm_try": MoPropertyMeta("fsm_try", "fsmTry", "byte", VersionMeta.Version413a, MoPropertyMeta.INTERNAL, None, None, None, None, [], []),
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version413a, MoPropertyMeta.NAMING, 0x8, None, None, r"""[\-\.:_a-zA-Z0-9]{1,16}""", [], []),
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "FcpoolOuis", parent_mo_or_dn, **kwargs)
