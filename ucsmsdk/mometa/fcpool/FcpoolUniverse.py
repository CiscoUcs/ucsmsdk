"""This module contains the general information for FcpoolUniverse ManagedObject."""
import sys, os
...
class FcpoolUniverseConsts():
    pass


class FcpoolUniverse(ManagedObject):
    """This is FcpoolUniverse class."""

    consts = FcpoolUniverseConsts()
    naming_props = set([])

    mo_meta = MoMeta("FcpoolUniverse", "fcpoolUniverse", "wwn", VersionMeta.Version101e, "InputOutput", 0x1fL, [], ["read-only"], [u'topRoot'], [u'fcpoolAddr', u'fcpoolFormat'], ["Get"])
    ...
    def __init__(self, **kwargs):
        ...
        ManagedObject.__init__(self, "FcpoolUniverse", **kwargs)
