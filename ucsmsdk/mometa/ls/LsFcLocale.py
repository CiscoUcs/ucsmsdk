...
class LsFcLocale(ManagedObject):
    ...
    mo_meta = MoMeta("LsFcLocale", "lsFcLocale", "fc-local-[switch_id]", VersionMeta.Version211a, "InputOutput", 0x3fL, [], ["admin", "ls-storage"], [u'lsServer'], [u'lsFcZoneGroup'], [None])
    ...
    prop_meta = {
        ...
        "switch_id": MoPropertyMeta("switch_id", "switchId", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, 0x20L, None, None, None, ["A", "B", "NONE"], []), 
    }
