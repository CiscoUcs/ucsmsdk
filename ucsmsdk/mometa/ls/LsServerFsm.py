...
class LsServerFsm(ManagedObject):
    """This is LsServerFsm class."""

    consts = LsServerFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("LsServerFsm", "lsServerFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'lsServer'], [u'lsServerFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "LsServerFsm", parent_mo_or_dn, **kwargs)
