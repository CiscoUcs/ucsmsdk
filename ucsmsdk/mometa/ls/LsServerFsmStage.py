...
class LsServerFsmStageConsts():
    ...
    NAME_CONFIGURE_RESOLVE_VOLUMES = "ConfigureResolveVolumes"
...
class LsServerFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("LsServerFsmStage", "lsServerFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'lsServerFsm'], [], [None])
