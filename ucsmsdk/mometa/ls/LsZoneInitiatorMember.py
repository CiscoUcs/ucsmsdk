...
class LsZoneInitiatorMember(ManagedObject):
    ...
    mo_meta = MoMeta("LsZoneInitiatorMember", "lsZoneInitiatorMember", "initiator-[name]", VersionMeta.Version211a, "InputOutput", 0x7fL, [], ["admin", "ls-storage"], [u'lsFcZoneGroup'], [u'lsFcZone'], [None])
