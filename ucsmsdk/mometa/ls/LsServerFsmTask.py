"""This module contains the general information for LsServerFsmTask ManagedObject."""
import sys, os
...
class LsServerFsmTask(ManagedObject):
    """This is LsServerFsmTask class."""

    consts = LsServerFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("LsServerFsmTask", "lsServerFsmTask", "task-[item]", VersionMeta.Version141i, "OutputOnly", 0xfL, [], [""], [u'lsServer'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version141i, MoPropertyMeta.NAMING, None, None, None, None, ["Configure", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "LsServerFsmTask", parent_mo_or_dn, **kwargs)
