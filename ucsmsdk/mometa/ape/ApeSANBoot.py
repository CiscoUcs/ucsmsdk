...
class ApeSANBoot(ManagedObject):
    ...
    mo_meta = MoMeta("ApeSANBoot", "apeSANBoot", "sanboot-[target_wwn]", VersionMeta.Version101e, "InputOutput", 0x7fL, [], ["admin"], [u'apeManager'], [], [None])
    ...
    prop_meta = {
        ...
        "target_lun": MoPropertyMeta("target_lun", "targetLun", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x20L, None, None, None, ["unspecified"], ["0-4294967295"]), 
        "target_wwn": MoPropertyMeta("target_wwn", "targetWWN", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x40L, 0, 256, r"""(([A-Fa-f0-9][A-Fa-f0-9]:){7}[A-Fa-f0-9][A-Fa-f0-9])|0""", [], []), 
