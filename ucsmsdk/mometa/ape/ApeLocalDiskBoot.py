...
class ApeLocalDiskBoot(ManagedObject):
    ...
    mo_meta = MoMeta("ApeLocalDiskBoot", "apeLocalDiskBoot", "localdiskboot-[chassis_id]-[slot_id]", VersionMeta.Version101e, "InputOutput", 0xffL, [], ["admin"], [u'apeManager'], [], [None])
    ...
    prop_meta = {
        ...
        "target_lun": MoPropertyMeta("target_lun", "targetLun", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x80L, None, None, None, ["unspecified"], ["0-4294967295"]), 
