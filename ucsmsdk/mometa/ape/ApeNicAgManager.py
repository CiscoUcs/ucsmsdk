...
class ApeNicAgManager(ManagedObject):
    ...
    mo_meta = MoMeta("ApeNicAgManager", "apeNicAgManager", "NicAgManager", VersionMeta.Version101e, "InputOutput", 0x1fL, [], ["read-only"], [u'apeManager'], [u'apeMenlo', u'apePalo'], [None])
