...
class ApeParam(ManagedObject):
    ...
    mo_meta = MoMeta("ApeParam", "apeParam", "param-[key]", VersionMeta.Version101e, "InputOutput", 0x3fL, [], ["read-only"], [u'apeMcTable'], [], [None])
    ...
    prop_meta = {
        ...
        "value": MoPropertyMeta("value", "value", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x20L, 0, 510, None, [], []), 
    }
