...
class ApeMc(ManagedObject):
    ...
    mo_meta = MoMeta("ApeMc", "apeMc", "mc-[ip]", VersionMeta.Version101e, "InputOutput", 0x7fL, [], ["read-only"], [u'apeManager'], [u'apeMcTable'], [None])
    ...
    prop_meta = {
        ...
        "ip": MoPropertyMeta("ip", "ip", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x4L, 0, 256, """((([0-9]){1,3}\.){3}[0-9]{1,3})""", [], []), 
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x20L, 0, 510, None, [], []), 
        "update_type": MoPropertyMeta("update_type", "updateType", "string", VersionMeta.Version211a, MoPropertyMeta.READ_WRITE, 0x40L, None, None, None, ["delta", "periodic", "sync"], []), 
    }
