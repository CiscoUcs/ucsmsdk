...
class ApeHostAgent(ManagedObject):
    ...
    mo_meta = MoMeta("ApeHostAgent", "apeHostAgent", "hostagent-[chassis_id]-[slot_id]", VersionMeta.Version101e, "InputOutput", 0x7fL, [], ["admin"], [u'apeManager'], [], [None])
    ...
    prop_meta = {
        ...
        "server_id": MoPropertyMeta("server_id", "serverId", "uint", VersionMeta.Version211a, MoPropertyMeta.READ_WRITE, 0x10L, None, None, None, [], []), 
