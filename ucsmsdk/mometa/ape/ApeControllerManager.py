"""This module contains the general information for ApeControllerManager ManagedObject."""
import sys, os
...
class ApeControllerManagerConsts():
    pass


class ApeControllerManager(ManagedObject):
    """This is ApeControllerManager class."""

    consts = ApeControllerManagerConsts()
    naming_props = set([])

    mo_meta = MoMeta("ApeControllerManager", "apeControllerManager", "Controller", VersionMeta.Version101e, "InputOutput", 0x1fL, [], ["read-only"], [u'apeManager'], [u'apeControllerChassis'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "ApeControllerManager", parent_mo_or_dn, **kwargs)
