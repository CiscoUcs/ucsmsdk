...
class ApeControllerManager(ManagedObject):
    ...
    mo_meta = MoMeta("ApeControllerManager", "apeControllerManager", "Controller", VersionMeta.Version101e, "InputOutput", 0xfL, [], ["read-only"], [u'apeManager'], [u'apeControllerChassis'], [None])
