...
class ApeDcosAgManager(ManagedObject):
    ...
    mo_meta = MoMeta("ApeDcosAgManager", "apeDcosAgManager", "DcosAgManager", VersionMeta.Version131c, "InputOutput", 0x1fL, [], ["read-only"], [u'apeManager'], [u'apeSwitchFirmwareInv'], [None])
