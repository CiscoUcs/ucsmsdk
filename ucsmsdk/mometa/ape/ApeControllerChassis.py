...
class ApeControllerChassis(ManagedObject):
    ...
    mo_meta = MoMeta("ApeControllerChassis", "apeControllerChassis", "Chassis-[index]", VersionMeta.Version101e, "InputOutput", 0x3fL, [], ["read-only"], [u'apeControllerManager'], [u'apeControllerEeprom'], [None])
    ...
    prop_meta = {
        ...
        "index": MoPropertyMeta("index", "index", "uint", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x8L, None, None, None, [], []), 
