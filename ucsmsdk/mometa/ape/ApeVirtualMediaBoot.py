...
class ApeVirtualMediaBoot(ManagedObject):
    ...
    mo_meta = MoMeta("ApeVirtualMediaBoot", "apeVirtualMediaBoot", "virtualmediaboot-[chassis_id]-[slot_id]", VersionMeta.Version101e, "InputOutput", 0x3fL, [], ["admin"], [u'apeManager'], [], [None])
