...
class ApeLANBoot(ManagedObject):
    ...
    mo_meta = MoMeta("ApeLANBoot", "apeLANBoot", "lanboot-[vnic_name]", VersionMeta.Version101e, "InputOutput", 0x1fL, [], ["admin"], [u'apeManager'], [], [None])
    ...
    prop_meta = {
        ...
        "vnic_name": MoPropertyMeta("vnic_name", "vnicName", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x10L, None, None, """[\-\.:_a-zA-Z0-9]{1,16}""", [], []), 
    }
