...
class MoIpV6AddrKv(ManagedObject):
    ...
    mo_meta = MoMeta("MoIpV6AddrKv", "moIpV6AddrKv", "kv-[key]", None, "InputOutput", 0x3ff, [], ["admin", "read-only"], [u'moKvCfgHolder'], [u'faultInst'], [None])

    prop_meta = {
        "addr": MoPropertyMeta("addr", "addr", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        ...
        "def_gw": MoPropertyMeta("def_gw", "defGw", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        ...
        "prefix": MoPropertyMeta("prefix", "prefix", "byte", None, MoPropertyMeta.READ_ONLY, None, None, None, None, [], ["1-127"]), 
        "prim_dns": MoPropertyMeta("prim_dns", "primDns", "string", None, MoPropertyMeta.READ_WRITE, 0x20, 0, 256, None, [], []), 
        ...
        "sec_dns": MoPropertyMeta("sec_dns", "secDns", "string", None, MoPropertyMeta.READ_WRITE, 0x80, 0, 256, None, [], []), 
