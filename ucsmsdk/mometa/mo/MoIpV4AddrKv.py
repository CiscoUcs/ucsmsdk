...
class MoIpV4AddrKv(ManagedObject):
    ...
    mo_meta = MoMeta("MoIpV4AddrKv", "moIpV4AddrKv", "kv-[key]", None, "InputOutput", 0x3ff, [], ["admin", "read-only"], [u'moKvCfgHolder'], [u'faultInst'], [None])

    prop_meta = {
        "addr": MoPropertyMeta("addr", "addr", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 256, r"""((([0-9]){1,3}\.){3}[0-9]{1,3})""", [], []), 
        ...
        "def_gw": MoPropertyMeta("def_gw", "defGw", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 256, r"""((([0-9]){1,3}\.){3}[0-9]{1,3})""", [], []), 
        ...
        "oper_pool_name": MoPropertyMeta("oper_pool_name", "operPoolName", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        "owner": MoPropertyMeta("owner", "owner", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["inventory", "mgmt"], []), 
        "pool_name": MoPropertyMeta("pool_name", "poolName", "string", None, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, [], []), 
        "prim_dns": MoPropertyMeta("prim_dns", "primDns", "string", None, MoPropertyMeta.READ_WRITE, 0x20, 0, 256, r"""((([0-9]){1,3}\.){3}[0-9]{1,3})""", [], []), 
        ...
        "sec_dns": MoPropertyMeta("sec_dns", "secDns", "string", None, MoPropertyMeta.READ_WRITE, 0x80, 0, 256, r"""((([0-9]){1,3}\.){3}[0-9]{1,3})""", [], []), 
        ...
        "subnet": MoPropertyMeta("subnet", "subnet", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 256, r"""((([0-9]){1,3}\.){3}[0-9]{1,3})""", [], []), 
        "target": MoPropertyMeta("target", "target", "string", None, MoPropertyMeta.READ_WRITE, 0x200, None, None, r"""((defaultValue|host|mgmt),){0,2}(defaultValue|host|mgmt){0,1}""", [], []), 
