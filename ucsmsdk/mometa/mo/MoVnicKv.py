...
class MoVnicKv(ManagedObject):
    ...
    mo_meta = MoMeta("MoVnicKv", "moVnicKv", "kv-[key]", None, "InputOutput", 0xff, [], ["admin", "read-only"], [u'moKvCfgHolder'], [], [None])
    ...
    prop_meta = {
        ...
        "target": MoPropertyMeta("target", "target", "string", None, MoPropertyMeta.READ_WRITE, 0x40, None, None, r"""((defaultValue|host|mgmt),){0,2}(defaultValue|host|mgmt){0,1}""", [], []), 
        ...
        "vnic_ether_dn": MoPropertyMeta("vnic_ether_dn", "vnicEtherDn", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        "vnic_name": MoPropertyMeta("vnic_name", "vnicName", "string", None, MoPropertyMeta.READ_WRITE, 0x80, None, None, r"""[\-\.:_a-zA-Z0-9]{0,32}""", [], []), 
    }
