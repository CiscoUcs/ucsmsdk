...
class SecurityEncryptionEp(ManagedObject):
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version435a, MoPropertyMeta.INTERNAL, None, None, None, None, ["nop", "updateEncryptionEpBegin", "updateEncryptionEpConfigureLocal", "updateEncryptionEpConfigurePeer", "updateEncryptionEpFail", "updateEncryptionEpSuccess"], []),
