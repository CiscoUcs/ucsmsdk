"""This module contains the general information for SecurityEncryptionEp ManagedObject."""
...
class SecurityEncryptionEpConsts:
    FSM_PREV_NOP = "nop"
    FSM_PREV_UPDATE_ENCRYPTION_EP_BEGIN = "updateEncryptionEpBegin"
    FSM_PREV_UPDATE_ENCRYPTION_EP_CONFIGURE_LOCAL = "updateEncryptionEpConfigureLocal"
    FSM_PREV_UPDATE_ENCRYPTION_EP_CONFIGURE_PEER = "updateEncryptionEpConfigurePeer"
    FSM_PREV_UPDATE_ENCRYPTION_EP_DELETE_AFTER_CONFIG_LOCAL = "updateEncryptionEpDeleteAfterConfigLocal"
    FSM_PREV_UPDATE_ENCRYPTION_EP_DELETE_AFTER_CONFIG_PEER = "updateEncryptionEpDeleteAfterConfigPeer"
    FSM_PREV_UPDATE_ENCRYPTION_EP_FAIL = "updateEncryptionEpFail"
    FSM_PREV_UPDATE_ENCRYPTION_EP_SUCCESS = "updateEncryptionEpSuccess"
    ...
    FSM_STATUS_NOP = "nop"
    FSM_STATUS_UPDATE_ENCRYPTION_EP_BEGIN = "updateEncryptionEpBegin"
    FSM_STATUS_UPDATE_ENCRYPTION_EP_CONFIGURE_LOCAL = "updateEncryptionEpConfigureLocal"
    FSM_STATUS_UPDATE_ENCRYPTION_EP_CONFIGURE_PEER = "updateEncryptionEpConfigurePeer"
    FSM_STATUS_UPDATE_ENCRYPTION_EP_DELETE_AFTER_CONFIG_LOCAL = "updateEncryptionEpDeleteAfterConfigLocal"
    FSM_STATUS_UPDATE_ENCRYPTION_EP_DELETE_AFTER_CONFIG_PEER = "updateEncryptionEpDeleteAfterConfigPeer"
...
class SecurityEncryptionEp(ManagedObject):
    """This is SecurityEncryptionEp class."""
    ...
    prop_meta = {
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version435a, MoPropertyMeta.INTERNAL, None, None, None, None, ["nop", "updateEncryptionEpBegin", "updateEncryptionEpConfigureLocal", "updateEncryptionEpConfigurePeer", "updateEncryptionEpDeleteAfterConfigLocal", "updateEncryptionEpDeleteAfterConfigPeer", "updateEncryptionEpFail", "updateEncryptionEpSuccess"], []),
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "SecurityEncryptionEp", parent_mo_or_dn, **kwargs)
