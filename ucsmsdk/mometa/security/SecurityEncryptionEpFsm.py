"""This module contains the general information for SecurityEncryptionEpFsm ManagedObject."""
...
class SecurityEncryptionEpFsmConsts:
    COMPLETION_TIME_ = ""
    CURRENT_FSM_NOP = "nop"
    CURRENT_FSM_UPDATE_ENCRYPTION_EP = "updateEncryptionEp"
...
class SecurityEncryptionEpFsm(ManagedObject):
    """This is SecurityEncryptionEpFsm class."""

    consts = SecurityEncryptionEpFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("SecurityEncryptionEpFsm", "securityEncryptionEpFsm", "fsm", VersionMeta.Version435a, "OutputOnly", 0xf, [], [""], ['securityEncryptionEp'], ['securityEncryptionEpFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "completion_time": MoPropertyMeta("completion_time", "completionTime", "string", VersionMeta.Version435a, MoPropertyMeta.READ_ONLY, None, None, None, r"""([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", [""], []),
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version435a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["nop", "updateEncryptionEp"], []),
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "SecurityEncryptionEpFsm", parent_mo_or_dn, **kwargs)
