...
class BiosRef(ManagedObject):
    ...
    mo_meta = MoMeta("BiosRef", "biosRef", "bios-ref", VersionMeta.Version131c, "InputOutput", 0x1f, [], [""], [u'equipmentBladeBiosCapProvider'], [u'biosFeatureRef', u'biosTokenParam'], ["Get"])
