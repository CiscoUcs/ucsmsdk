...
class BiosVfIOENVMe1OptionROMConsts:
    ...
    VP_IOENVME1_OPTION_ROM_PLATFORM_RECOMMENDED = "platform-recommended"
    VP_IOENVME1_OPTION_ROM_UEFI_ONLY = "uefi-only"


class BiosVfIOENVMe1OptionROM(ManagedObject):
    """This is BiosVfIOENVMe1OptionROM class."""

    consts = BiosVfIOENVMe1OptionROMConsts()
    naming_props = set([])

    mo_meta = MoMeta("BiosVfIOENVMe1OptionROM", "biosVfIOENVMe1OptionROM", "IOENVMe1-OptionROM", VersionMeta.Version312b, "InputOutput", 0x3f, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "vp_ioenv_me1_option_rom": MoPropertyMeta("vp_ioenv_me1_option_rom", "vpIOENVMe1OptionROM", "string", VersionMeta.Version312b, MoPropertyMeta.READ_WRITE, 0x20, None, None, None, ["disabled", "enabled", "legacy-only", "platform-default", "platform-recommended", "uefi-only"], []), 
    }
    ...
    prop_map = {
        ...
        "vpIOENVMe1OptionROM": "vp_ioenv_me1_option_rom", 
    }
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        self.vp_ioenv_me1_option_rom = None

        ManagedObject.__init__(self, "BiosVfIOENVMe1OptionROM", parent_mo_or_dn, **kwargs)
