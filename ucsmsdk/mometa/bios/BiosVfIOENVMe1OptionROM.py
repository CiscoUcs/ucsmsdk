...
class BiosVfIOENVMe1OptionROM(ManagedObject):
    ...
    mo_meta = MoMeta("BiosVfIOENVMe1OptionROM", "biosVfIOENVMe1OptionROM", "IOENVMe1-OptionROM", VersionMeta.Version911z, "InputOutput", 0x3f, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], [None])
    ...
    prop_meta = {
        ...
        "vp_ioenv_me1_option_rom": MoPropertyMeta("vp_ioenv_me1_option_rom", "vpIOENVMe1OptionROM", "string", VersionMeta.Version911z, MoPropertyMeta.READ_WRITE, 0x20, None, None, None, ["disabled", "enabled", "legacy-only", "platform-default", "platform-recommended", "uefi-only"], []), 
    }
