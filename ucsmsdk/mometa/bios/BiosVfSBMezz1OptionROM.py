...
class BiosVfSBMezz1OptionROM(ManagedObject):
    ...
    mo_meta = MoMeta("BiosVfSBMezz1OptionROM", "biosVfSBMezz1OptionROM", "SBMezz1-OptionROM", VersionMeta.Version911z, "InputOutput", 0x3f, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], [None])
    ...
    prop_meta = {
        ...
        "vp_sb_mezz1_option_rom": MoPropertyMeta("vp_sb_mezz1_option_rom", "vpSBMezz1OptionROM", "string", VersionMeta.Version911z, MoPropertyMeta.READ_WRITE, 0x20, None, None, None, ["disabled", "enabled", "legacy-only", "platform-default", "platform-recommended", "uefi-only"], []), 
    }
