...
class BiosVfCPUHardwarePowerManagement(ManagedObject):
    ...
    mo_meta = MoMeta("BiosVfCPUHardwarePowerManagement", "biosVfCPUHardwarePowerManagement", "CPU-Hardware-Power-Management", VersionMeta.Version311e, "InputOutput", 0x3f, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "vp_cpu_hardware_power_management": MoPropertyMeta("vp_cpu_hardware_power_management", "vpCPUHardwarePowerManagement", "string", VersionMeta.Version311e, MoPropertyMeta.READ_WRITE, 0x20, None, None, None, ["disabled", "hwpm-native-mode", "hwpm-oob-mode", "platform-default", "platform-recommended"], []), 
    }
