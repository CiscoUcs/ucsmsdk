...
class BiosSettingRef(ManagedObject):
    ...
    mo_meta = MoMeta("BiosSettingRef", "biosSettingRef", "setting-ref-[name]", VersionMeta.Version131c, "InputOutput", 0x1fL, [], [""], [u'biosParameterRef'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "constant_name": MoPropertyMeta("constant_name", "constantName", "string", VersionMeta.Version141i, MoPropertyMeta.READ_ONLY, None, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
