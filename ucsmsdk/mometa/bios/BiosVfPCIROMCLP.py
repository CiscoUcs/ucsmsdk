...
class BiosVfPCIROMCLP(ManagedObject):
    ...
    mo_meta = MoMeta("BiosVfPCIROMCLP", "biosVfPCIROMCLP", "PCI-ROM-CLP", VersionMeta.Version911z, "InputOutput", 0x3f, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], [None])
    ...
    prop_meta = {
        ...
        "vp_pciromclp": MoPropertyMeta("vp_pciromclp", "vpPCIROMCLP", "string", VersionMeta.Version911z, MoPropertyMeta.READ_WRITE, 0x20, None, None, None, ["disabled", "enabled", "platform-default", "platform-recommended"], []), 
    }
