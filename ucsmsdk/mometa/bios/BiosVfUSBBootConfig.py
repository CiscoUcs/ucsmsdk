...
class BiosVfUSBBootConfig(ManagedObject):
    ...
    mo_meta = MoMeta("BiosVfUSBBootConfig", "biosVfUSBBootConfig", "USB-Boot-Config", VersionMeta.Version111j, "InputOutput", 0x7fL, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "vp_legacy_usb_support": MoPropertyMeta("vp_legacy_usb_support", "vpLegacyUSBSupport", "string", VersionMeta.Version202m, MoPropertyMeta.READ_WRITE, 0x20L, None, None, None, ["auto", "disabled", "enabled", "platform-default", "platform-recommended"], []), 
        "vp_make_device_non_bootable": MoPropertyMeta("vp_make_device_non_bootable", "vpMakeDeviceNonBootable", "string", VersionMeta.Version111j, MoPropertyMeta.READ_WRITE, 0x40L, None, None, None, ["disabled", "enabled", "platform-default", "platform-recommended"], []), 
    }
