...
class BiosVfMaximumMemoryBelow4GBConsts():
    ...
    VP_MAXIMUM_MEMORY_BELOW4_GB_PLATFORM_RECOMMENDED = "platform-recommended"
...
class BiosVfMaximumMemoryBelow4GB(ManagedObject):
    ...
    mo_meta = MoMeta("BiosVfMaximumMemoryBelow4GB", "biosVfMaximumMemoryBelow4GB", "Maximum-memory-below-4GB", VersionMeta.Version111j, "InputOutput", 0x3fL, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "vp_maximum_memory_below4_gb": MoPropertyMeta("vp_maximum_memory_below4_gb", "vpMaximumMemoryBelow4GB", "string", VersionMeta.Version111j, MoPropertyMeta.READ_WRITE, 0x20L, None, None, None, ["disabled", "enabled", "platform-default", "platform-recommended"], []), 
    }
    ...
    prop_map = {
        ...
        "vpMaximumMemoryBelow4GB": "vp_maximum_memory_below4_gb", 
    }
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        self.vp_maximum_memory_below4_gb = None

        ManagedObject.__init__(self, "BiosVfMaximumMemoryBelow4GB", parent_mo_or_dn, **kwargs)
