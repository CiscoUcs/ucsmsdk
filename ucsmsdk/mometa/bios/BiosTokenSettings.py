...
class BiosTokenSettings(ManagedObject):
    ...
    prop_meta = {
        ...
        "is_assigned": MoPropertyMeta("is_assigned", "isAssigned", "string", VersionMeta.Version321d, MoPropertyMeta.READ_WRITE, 0x8, None, None, None, ["false", "no", "true", "yes"], []), 
        ...
        "settings_mo_rn": MoPropertyMeta("settings_mo_rn", "settingsMoRn", "string", VersionMeta.Version321d, MoPropertyMeta.NAMING, 0x20, 1, 510, None, [], []), 
