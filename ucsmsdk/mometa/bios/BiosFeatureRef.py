...
class BiosFeatureRef(ManagedObject):
    ...
    mo_meta = MoMeta("BiosFeatureRef", "biosFeatureRef", "feature-ref-[name]", VersionMeta.Version131c, "InputOutput", 0x1fL, [], [""], [u'biosRef'], [u'biosParameterRef'], ["Get"])
    ...
    prop_meta = {
        ...
        "ftr_mo_class_name": MoPropertyMeta("ftr_mo_class_name", "ftrMoClassName", "string", VersionMeta.Version141i, MoPropertyMeta.READ_ONLY, None, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
