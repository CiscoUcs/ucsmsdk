...
class BiosVfProcessorC7Report(ManagedObject):
    ...
    mo_meta = MoMeta("BiosVfProcessorC7Report", "biosVfProcessorC7Report", "Processor-C7-Report", VersionMeta.Version202m, "InputOutput", 0x3fL, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "vp_processor_c7_report": MoPropertyMeta("vp_processor_c7_report", "vpProcessorC7Report", "string", VersionMeta.Version202m, MoPropertyMeta.READ_WRITE, 0x20L, None, None, None, ["c7", "c7s", "disabled", "enabled", "platform-default", "platform-recommended"], []), 
    }
