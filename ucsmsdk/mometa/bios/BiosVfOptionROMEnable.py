...
class BiosVfOptionROMEnable(ManagedObject):
    ...
    prop_meta = {
        ...
        "vp_state": MoPropertyMeta("vp_state", "vpState", "string", VersionMeta.Version202m, MoPropertyMeta.READ_ONLY, None, None, None, None, ["disabled", "enabled", "legacy-only", "platform-default", "platform-recommended", "uefi-only"], []), 
    }
