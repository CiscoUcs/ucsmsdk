...
class BiosVfOptionROMEnable(ManagedObject):
    ...
    mo_meta = MoMeta("BiosVfOptionROMEnable", "biosVfOptionROMEnable", "OptionROM-Enable", VersionMeta.Version202m, "InputOutput", 0x1fL, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "vp_state": MoPropertyMeta("vp_state", "vpState", "string", VersionMeta.Version202m, MoPropertyMeta.READ_ONLY, 0x10L, None, None, None, ["disabled", "enabled", "legacy-only", "platform-default", "platform-recommended", "uefi-only"], []), 
    }
