...
class BiosVfWorkloadConfiguration(ManagedObject):
    ...
    mo_meta = MoMeta("BiosVfWorkloadConfiguration", "biosVfWorkloadConfiguration", "Workload-Configuration", VersionMeta.Version312b, "InputOutput", 0x3f, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "vp_workload_configuration": MoPropertyMeta("vp_workload_configuration", "vpWorkloadConfiguration", "string", VersionMeta.Version312b, MoPropertyMeta.READ_WRITE, 0x20, None, None, None, ["balanced", "io-sensitive", "platform-default", "platform-recommended"], []), 
    }
