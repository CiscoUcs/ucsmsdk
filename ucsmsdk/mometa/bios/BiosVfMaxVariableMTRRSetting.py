...
class BiosVfMaxVariableMTRRSetting(ManagedObject):
    ...
    mo_meta = MoMeta("BiosVfMaxVariableMTRRSetting", "biosVfMaxVariableMTRRSetting", "Max-Variable-MTRR-Setting", VersionMeta.Version142b, "InputOutput", 0x3fL, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "vp_processor_mtrr": MoPropertyMeta("vp_processor_mtrr", "vpProcessorMtrr", "string", VersionMeta.Version142b, MoPropertyMeta.READ_WRITE, 0x20L, None, None, None, ["8", "auto-max", "platform-default", "platform-recommended"], []), 
    }
