...
class BiosVfMirroringMode(ManagedObject):
    ...
    mo_meta = MoMeta("BiosVfMirroringMode", "biosVfMirroringMode", "Mirroring-Mode", VersionMeta.Version131c, "InputOutput", 0x3fL, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "vp_mirroring_mode": MoPropertyMeta("vp_mirroring_mode", "vpMirroringMode", "string", VersionMeta.Version131c, MoPropertyMeta.READ_WRITE, 0x20L, None, None, None, ["inter-socket", "intra-socket", "platform-default", "platform-recommended"], []), 
    }
