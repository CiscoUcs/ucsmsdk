...
class BiosVfVGAPriority(ManagedObject):
    ...
    mo_meta = MoMeta("BiosVfVGAPriority", "biosVfVGAPriority", "VGA-Priority", VersionMeta.Version222c, "InputOutput", 0x3fL, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "vp_vga_priority": MoPropertyMeta("vp_vga_priority", "vpVGAPriority", "string", VersionMeta.Version222c, MoPropertyMeta.READ_WRITE, 0x20L, None, None, None, ["offboard", "onboard", "onboard-vga-disabled", "platform-default", "platform-recommended"], []), 
    }
