...
class BiosVfPCISlotOptionROMEnable(ManagedObject):
    ...
    mo_meta = MoMeta("BiosVfPCISlotOptionROMEnable", "biosVfPCISlotOptionROMEnable", "PCI-Slot-OptionROM-Enable", VersionMeta.Version202m, "InputOutput", 0xfffffL, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "vp_pc_ie_slot_hba_option_rom": MoPropertyMeta("vp_pc_ie_slot_hba_option_rom", "vpPCIeSlotHBAOptionROM", "string", VersionMeta.Version223a, MoPropertyMeta.READ_WRITE, 0x10L, None, None, None, ["disabled", "enabled", "legacy-only", "platform-default", "platform-recommended", "uefi-only"], []), 
        "vp_pc_ie_slot_mlom_option_rom": MoPropertyMeta("vp_pc_ie_slot_mlom_option_rom", "vpPCIeSlotMLOMOptionROM", "string", VersionMeta.Version223a, MoPropertyMeta.READ_WRITE, 0x20L, None, None, None, ["disabled", "enabled", "legacy-only", "platform-default", "platform-recommended", "uefi-only"], []), 
        "vp_pc_ie_slot_n1_option_rom": MoPropertyMeta("vp_pc_ie_slot_n1_option_rom", "vpPCIeSlotN1OptionROM", "string", VersionMeta.Version223a, MoPropertyMeta.READ_WRITE, 0x40L, None, None, None, ["disabled", "enabled", "legacy-only", "platform-default", "platform-recommended", "uefi-only"], []), 
        "vp_pc_ie_slot_n2_option_rom": MoPropertyMeta("vp_pc_ie_slot_n2_option_rom", "vpPCIeSlotN2OptionROM", "string", VersionMeta.Version223a, MoPropertyMeta.READ_WRITE, 0x80L, None, None, None, ["disabled", "enabled", "legacy-only", "platform-default", "platform-recommended", "uefi-only"], []), 
        "vp_pc_ie_slot_sas_option_rom": MoPropertyMeta("vp_pc_ie_slot_sas_option_rom", "vpPCIeSlotSASOptionROM", "string", VersionMeta.Version222c, MoPropertyMeta.READ_WRITE, 0x100L, None, None, None, ["disabled", "enabled", "legacy-only", "platform-default", "platform-recommended", "uefi-only"], []), 
        "vp_slot10_state": MoPropertyMeta("vp_slot10_state", "vpSlot10State", "string", VersionMeta.Version222c, MoPropertyMeta.READ_WRITE, 0x200L, None, None, None, ["disabled", "enabled", "legacy-only", "platform-default", "platform-recommended", "uefi-only"], []), 
        "vp_slot1_state": MoPropertyMeta("vp_slot1_state", "vpSlot1State", "string", VersionMeta.Version202m, MoPropertyMeta.READ_WRITE, 0x400L, None, None, None, ["disabled", "enabled", "legacy-only", "platform-default", "platform-recommended", "uefi-only"], []), 
        "vp_slot2_state": MoPropertyMeta("vp_slot2_state", "vpSlot2State", "string", VersionMeta.Version202m, MoPropertyMeta.READ_WRITE, 0x800L, None, None, None, ["disabled", "enabled", "legacy-only", "platform-default", "platform-recommended", "uefi-only"], []), 
        "vp_slot3_state": MoPropertyMeta("vp_slot3_state", "vpSlot3State", "string", VersionMeta.Version202m, MoPropertyMeta.READ_WRITE, 0x1000L, None, None, None, ["disabled", "enabled", "legacy-only", "platform-default", "platform-recommended", "uefi-only"], []), 
        "vp_slot4_state": MoPropertyMeta("vp_slot4_state", "vpSlot4State", "string", VersionMeta.Version202m, MoPropertyMeta.READ_WRITE, 0x2000L, None, None, None, ["disabled", "enabled", "legacy-only", "platform-default", "platform-recommended", "uefi-only"], []), 
        "vp_slot5_state": MoPropertyMeta("vp_slot5_state", "vpSlot5State", "string", VersionMeta.Version202m, MoPropertyMeta.READ_WRITE, 0x4000L, None, None, None, ["disabled", "enabled", "legacy-only", "platform-default", "platform-recommended", "uefi-only"], []), 
        "vp_slot6_state": MoPropertyMeta("vp_slot6_state", "vpSlot6State", "string", VersionMeta.Version212a, MoPropertyMeta.READ_WRITE, 0x8000L, None, None, None, ["disabled", "enabled", "legacy-only", "platform-default", "platform-recommended", "uefi-only"], []), 
        "vp_slot7_state": MoPropertyMeta("vp_slot7_state", "vpSlot7State", "string", VersionMeta.Version212a, MoPropertyMeta.READ_WRITE, 0x10000L, None, None, None, ["disabled", "enabled", "legacy-only", "platform-default", "platform-recommended", "uefi-only"], []), 
        "vp_slot8_state": MoPropertyMeta("vp_slot8_state", "vpSlot8State", "string", VersionMeta.Version222c, MoPropertyMeta.READ_WRITE, 0x20000L, None, None, None, ["disabled", "enabled", "legacy-only", "platform-default", "platform-recommended", "uefi-only"], []), 
        "vp_slot9_state": MoPropertyMeta("vp_slot9_state", "vpSlot9State", "string", VersionMeta.Version222c, MoPropertyMeta.READ_WRITE, 0x40000L, None, None, None, ["disabled", "enabled", "legacy-only", "platform-default", "platform-recommended", "uefi-only"], []), 
        "vp_slot_mezz_state": MoPropertyMeta("vp_slot_mezz_state", "vpSlotMezzState", "string", VersionMeta.Version202m, MoPropertyMeta.READ_ONLY, 0x80000L, None, None, None, ["disabled", "enabled", "platform-default", "platform-recommended"], []), 
    }
