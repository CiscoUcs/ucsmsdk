...
class BiosBOT(ManagedObject):
    ...
    mo_meta = MoMeta("BiosBOT", "biosBOT", "bdgep", VersionMeta.Version101e, "InputOutput", 0xfL, [], ["read-only"], [u'biosUnit'], [u'biosBootDevGrp'], ["Get"])
    ...
    prop_meta = {
        ...
        "last_update": MoPropertyMeta("last_update", "lastUpdate", "string", VersionMeta.Version101e, MoPropertyMeta.READ_ONLY, None, None, None, """([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", ["never"], []), 
