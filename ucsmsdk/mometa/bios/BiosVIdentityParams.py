...
class BiosVIdentityParams(ManagedObject):
    ...
    mo_meta = MoMeta("BiosVIdentityParams", "biosVIdentityParams", "bios-videntity-params", VersionMeta.Version201m, "InputOutput", 0x1f, [], [""], [u'computeBlade', u'computeRackUnit', u'computeServerUnit'], [], ["Get"])
