...
class BiosVfProcessorCStateConsts():
    ...
    VP_PROCESSOR_CSTATE_PLATFORM_RECOMMENDED = "platform-recommended"
...
class BiosVfProcessorCState(ManagedObject):
    ...
    mo_meta = MoMeta("BiosVfProcessorCState", "biosVfProcessorCState", "Processor-C-State", VersionMeta.Version201m, "InputOutput", 0x1fL, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "vp_processor_c_state": MoPropertyMeta("vp_processor_c_state", "vpProcessorCState", "string", VersionMeta.Version201m, MoPropertyMeta.READ_WRITE, 0x10L, None, None, None, ["disabled", "enabled", "platform-default", "platform-recommended"], []), 
    }
