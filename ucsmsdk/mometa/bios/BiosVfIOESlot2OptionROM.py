...
class BiosVfIOESlot2OptionROM(ManagedObject):
    ...
    mo_meta = MoMeta("BiosVfIOESlot2OptionROM", "biosVfIOESlot2OptionROM", "IOESlot2-OptionROM", VersionMeta.Version911z, "InputOutput", 0x3f, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], [None])
    ...
    prop_meta = {
        ...
        "vp_ioe_slot2_option_rom": MoPropertyMeta("vp_ioe_slot2_option_rom", "vpIOESlot2OptionROM", "string", VersionMeta.Version911z, MoPropertyMeta.READ_WRITE, 0x20, None, None, None, ["disabled", "enabled", "legacy-only", "platform-default", "platform-recommended", "uefi-only"], []), 
    }
