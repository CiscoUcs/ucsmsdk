...
class BiosVfASPMSupport(ManagedObject):
    ...
    mo_meta = MoMeta("BiosVfASPMSupport", "biosVfASPMSupport", "ASPM-Support", VersionMeta.Version251a, "InputOutput", 0x3fL, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "vp_aspm_support": MoPropertyMeta("vp_aspm_support", "vpASPMSupport", "string", VersionMeta.Version251a, MoPropertyMeta.READ_WRITE, 0x20L, None, None, None, ["auto", "disabled", "forcel0", "platform-default", "platform-recommended"], []), 
    }
