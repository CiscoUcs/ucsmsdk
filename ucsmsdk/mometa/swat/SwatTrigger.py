...
class SwatTrigger(ManagedObject):
    ...
    mo_meta = MoMeta("SwatTrigger", "swatTrigger", "trigger-[name]", VersionMeta.Version101e, "InputOutput", 0x7fL, [], ["admin"], [u'swatAction', u'swatTrigger'], [u'swatCondition', u'swatTrigger'], ["Get"])
    ...
    prop_meta = {
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x40L, None, None, None, ["AND", "OR"], []), 
    }
