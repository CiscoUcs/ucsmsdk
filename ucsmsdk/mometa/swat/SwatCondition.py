...
class SwatCondition(ManagedObject):
    ...
    mo_meta = MoMeta("SwatCondition", "swatCondition", "cond-[var_name]-[operation]-[var_value]", VersionMeta.Version101e, "InputOutput", 0x7fL, [], ["admin"], [u'swatAction', u'swatTrigger'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "operation": MoPropertyMeta("operation", "operation", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x4L, None, None, None, ["EQ", "GE", "GT", "LE", "LT", "NE"], []), 
        ...
        "var_name": MoPropertyMeta("var_name", "varName", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x20L, None, None, """[\-\.:_a-zA-Z0-9]{1,16}""", [], []), 
        "var_value": MoPropertyMeta("var_value", "varValue", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x40L, None, None, """[\-\.:_a-zA-Z0-9]{1,16}""", [], []), 
    }
