...
class ClitestTypeTestChild(ManagedObject):
    ...
    mo_meta = MoMeta("ClitestTypeTestChild", "clitestTypeTestChild", "tt-child", VersionMeta.Version101e, "InputOutput", 0xffL, [], ["admin"], [], [], ["Get"])

    prop_meta = {
        "astring": MoPropertyMeta("astring", "astring", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x1L, None, None, """[\-\.:_a-zA-Z0-9]{6,93}""", [], []), 
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x10L, None, None, """[abcdefghijklmnoprstuvwyA-Z0-9]{1,20}""", [], []), 
