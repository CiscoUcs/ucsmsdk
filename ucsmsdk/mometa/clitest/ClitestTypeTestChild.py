...
class ClitestTypeTestChild(ManagedObject):
    ...
    mo_meta = MoMeta("ClitestTypeTestChild", "clitestTypeTestChild", "tt-child", VersionMeta.Version101e, "InputOutput", 0x1ff, [], ["admin"], [], [], ["Get"])

    prop_meta = {
        "astring": MoPropertyMeta("astring", "astring", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x2, None, None, r"""[\-\.:_a-zA-Z0-9]{6,93}""", [], []),
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x20, None, None, r"""[abcdefghijklmnoprstuvwyA-Z0-9]{1,20}""", [], []),
