...
class LsbootLan(ManagedObject):
    ...
    mo_meta = MoMeta("LsbootLan", "lsbootLan", "lan", VersionMeta.Version101e, "InputOutput", 0x3fL, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"], [u'lsbootDef', u'lsbootPolicy'], [u'lsbootLanImagePath'], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "order": MoPropertyMeta("order", "order", "ushort", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x4L, None, None, None, [], ["1-16"]), 
        "prot": MoPropertyMeta("prot", "prot", "string", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x8L, None, None, None, ["gpxe", "iSCSI", "pxe"], []), 
