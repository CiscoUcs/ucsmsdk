...
class LsbootLocalLunImagePath(ManagedObject):
    ...
    mo_meta = MoMeta("LsbootLocalLunImagePath", "lsbootLocalLunImagePath", "lunimgpath-[type]", VersionMeta.Version224a, "InputOutput", 0x7f, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"], [u'lsbootLocalHddImage'], [u'lsbootUEFIBootParam'], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "lun_name": MoPropertyMeta("lun_name", "lunName", "string", VersionMeta.Version224a, MoPropertyMeta.READ_WRITE, 0x8, None, None, r"""[\-\.:_a-zA-Z0-9]{0,10}""", [], []), 
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version224a, MoPropertyMeta.NAMING, 0x40, None, None, None, ["primary", "secondary"], []), 
    }
