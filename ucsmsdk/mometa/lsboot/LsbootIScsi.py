...
class LsbootIScsi(ManagedObject):
    ...
    mo_meta = MoMeta("LsbootIScsi", "lsbootIScsi", "iscsi", VersionMeta.Version201m, "InputOutput", 0x1fL, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"], [u'lsbootDef', u'lsbootPolicy'], [u'lsbootIScsiImagePath'], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "order": MoPropertyMeta("order", "order", "ushort", VersionMeta.Version201m, MoPropertyMeta.READ_WRITE, 0x4L, None, None, None, [], ["1-16"]), 
