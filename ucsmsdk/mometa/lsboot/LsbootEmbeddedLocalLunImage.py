"""This module contains the general information for LsbootEmbeddedLocalLunImage ManagedObject."""
...
class LsbootEmbeddedLocalLunImage(ManagedObject):
    """This is LsbootEmbeddedLocalLunImage class."""

    consts = LsbootEmbeddedLocalLunImageConsts()
    naming_props = set([])

    mo_meta = MoMeta("LsbootEmbeddedLocalLunImage", "lsbootEmbeddedLocalLunImage", "embedded-local-lun", VersionMeta.Version311e, "InputOutput", 0x3f, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"], [u'lsbootLocalStorage'], [], [None])
    ...
    prop_meta = {
        ...
        "order": MoPropertyMeta("order", "order", "ushort", VersionMeta.Version311e, MoPropertyMeta.READ_WRITE, 0x8, None, None, None, [], ["1-16"]), 
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version311e, MoPropertyMeta.READ_ONLY, None, None, None, None, ["embedded-local-jbod", "embedded-local-lun", "local-any", "local-jbod", "local-lun", "sd-card", "usb-extern", "usb-intern"], []), 
    }
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "LsbootEmbeddedLocalLunImage", parent_mo_or_dn, **kwargs)
