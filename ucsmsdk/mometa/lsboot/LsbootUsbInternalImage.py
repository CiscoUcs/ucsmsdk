"""This module contains the general information for LsbootUsbInternalImage ManagedObject."""
...
class LsbootUsbInternalImageConsts:
...
class LsbootUsbInternalImage(ManagedObject):
    ...
    consts = LsbootUsbInternalImageConsts()
    naming_props = set([])

    mo_meta = MoMeta("LsbootUsbInternalImage", "lsbootUsbInternalImage", "usb-intern", VersionMeta.Version221b, "InputOutput", 0x3f, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"], [u'lsbootLocalStorage'], [u'lsbootUEFIBootParam'], ["Add", "Get", "Remove", "Set"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "LsbootUsbInternalImage", parent_mo_or_dn, **kwargs)
