...
class LsbootLocalDiskImage(ManagedObject):
    ...
    mo_meta = MoMeta("LsbootLocalDiskImage", "lsbootLocalDiskImage", "local-jbod", VersionMeta.Version224a, "InputOutput", 0x1fL, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"], [u'lsbootLocalStorage'], [u'lsbootLocalDiskImagePath'], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "order": MoPropertyMeta("order", "order", "ushort", VersionMeta.Version224a, MoPropertyMeta.READ_WRITE, 0x4L, None, None, None, [], ["1-16"]), 
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version224a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["local-any", "local-jbod", "local-lun", "sd-card", "usb-extern", "usb-intern"], []), 
    }
