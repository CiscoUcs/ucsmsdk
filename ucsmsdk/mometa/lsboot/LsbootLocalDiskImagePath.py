...
class LsbootLocalDiskImagePath(ManagedObject):
    ...
    mo_meta = MoMeta("LsbootLocalDiskImagePath", "lsbootLocalDiskImagePath", "diskimgpath-[type]", VersionMeta.Version224a, "InputOutput", 0x3fL, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"], [u'lsbootLocalDiskImage'], [], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "slot_number": MoPropertyMeta("slot_number", "slotNumber", "ushort", VersionMeta.Version224a, MoPropertyMeta.READ_WRITE, 0x8L, None, None, None, [], ["1-24", "1-4"]), 
