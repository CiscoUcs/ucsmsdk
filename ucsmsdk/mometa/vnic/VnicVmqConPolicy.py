...
class VnicVmqConPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("VnicVmqConPolicy", "vnicVmqConPolicy", "vmq-con-[name]", VersionMeta.Version221b, "InputOutput", 0x1ffL, [], ["admin", "ls-compute", "ls-network", "ls-network-policy", "ls-server"], [u'orgOrg'], [], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "intr_count": MoPropertyMeta("intr_count", "intrCount", "ushort", VersionMeta.Version221b, MoPropertyMeta.READ_WRITE, 0x8L, None, None, None, [], ["1-128"]), 
        ...
        "vmq_count": MoPropertyMeta("vmq_count", "vmqCount", "ushort", VersionMeta.Version221b, MoPropertyMeta.READ_WRITE, 0x100L, None, None, None, [], ["1-128"]), 
    }
