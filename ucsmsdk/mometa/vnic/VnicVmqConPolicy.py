...
class VnicVmqConPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("VnicVmqConPolicy", "vnicVmqConPolicy", "vmq-con-[name]", VersionMeta.Version221b, "InputOutput", 0x1fff, [], ["admin", "ls-compute", "ls-network", "ls-network-policy", "ls-server"], [u'orgOrg'], [], ["Add", "Get", "Remove", "Set"])

    prop_meta = {
        "adaptor_profile_name": MoPropertyMeta("adaptor_profile_name", "adaptorProfileName", "string", None, MoPropertyMeta.READ_WRITE, 0x2, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        ...
        "multi_queue": MoPropertyMeta("multi_queue", "multiQueue", "string", None, MoPropertyMeta.READ_WRITE, 0x40, None, None, None, ["disabled", "enabled"], []), 
        ...
        "vmmq_sub_vnics": MoPropertyMeta("vmmq_sub_vnics", "vmmqSubVnics", "ushort", None, MoPropertyMeta.READ_WRITE, 0x800, None, None, None, [], ["1-256"]), 
