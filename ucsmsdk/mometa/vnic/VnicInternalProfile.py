...
class VnicInternalProfile(ManagedObject):
    ...
    mo_meta = MoMeta("VnicInternalProfile", "vnicInternalProfile", "vnic-[name]", VersionMeta.Version201m, "InputOutput", 0x1ffL, [], ["read-only"], [u'vnicProfileSet'], [u'swVlan'], ["Get"])
    ...
    prop_meta = {
        ...
        "max_ports": MoPropertyMeta("max_ports", "maxPorts", "ushort", VersionMeta.Version201m, MoPropertyMeta.READ_WRITE, 0x10L, None, None, None, [], ["1-4096"]), 
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version201m, MoPropertyMeta.NAMING, 0x20L, None, None, r"""[\-\.:_a-zA-Z0-9]{1,31}""", [], []), 
