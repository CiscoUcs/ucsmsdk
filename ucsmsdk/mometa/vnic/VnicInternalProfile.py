...
class VnicInternalProfile(ManagedObject):
    ...
    mo_meta = MoMeta("VnicInternalProfile", "vnicInternalProfile", "vnic-[name]", VersionMeta.Version201m, "InputOutput", 0xffL, [], ["read-only"], [u'vnicProfileSet'], [u'swVlan'], ["Get"])
    ...
    prop_meta = {
        ...
        "max_ports": MoPropertyMeta("max_ports", "maxPorts", "ushort", VersionMeta.Version201m, MoPropertyMeta.READ_WRITE, 0x8L, None, None, None, [], ["1-4096"]), 
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version201m, MoPropertyMeta.NAMING, 0x10L, None, None, """[\-\.:_a-zA-Z0-9]{1,31}""", [], []), 
