...
class VnicVlan(ManagedObject):
    ...
    mo_meta = MoMeta("VnicVlan", "vnicVlan", "vlan", VersionMeta.Version201m, "InputOutput", 0x3fL, [], ["admin", "ls-config", "ls-network", "ls-server", "ls-storage"], [u'vnicIScsi', u'vnicIScsiLCP'], [u'vnicIPv4If', u'vnicIScsiAutoTargetIf', u'vnicIScsiStaticTargetIf'], ["Add", "Get", "Set"])
    ...
    prop_meta = {
        ...
        "vlan_name": MoPropertyMeta("vlan_name", "vlanName", "string", VersionMeta.Version201m, MoPropertyMeta.READ_WRITE, 0x20L, None, None, """[\-\.:_a-zA-Z0-9]{1,32}""", [], []), 
