...
class VnicProfileSetFsmStageConsts():
    ...
    NAME_DEPLOY_ALIAS_LOCAL = "DeployAliasLocal"
    NAME_DEPLOY_ALIAS_PEER = "DeployAliasPeer"
    NAME_DEPLOY_ALIAS_SUCCESS = "DeployAliasSuccess"
...
class VnicProfileSetFsmStage(ManagedObject):
    """This is VnicProfileSetFsmStage class."""

    consts = VnicProfileSetFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("VnicProfileSetFsmStage", "vnicProfileSetFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'vnicProfileSetFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["DeployAliasBegin", "DeployAliasFail", "DeployAliasLocal", "DeployAliasPeer", "DeployAliasSuccess", "DeployBegin", "DeployFail", "DeployLocal", "DeployPeer", "DeploySuccess", "nop"], []), 
