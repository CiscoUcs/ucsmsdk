...
class VnicDynamicIdUniverse(ManagedObject):
    ...
    mo_meta = MoMeta("VnicDynamicIdUniverse", "vnicDynamicIdUniverse", "dynamic-id-universe-[name]", VersionMeta.Version101e, "InputOutput", 0x7fL, [], ["admin", "ls-network", "ls-network-policy"], [], [], ["Get"])
