"""This module contains the general information for VnicDynamicIdUniverse ManagedObject."""
import sys, os
...
class VnicDynamicIdUniverseConsts():
    INT_ID_NONE = "none"
...
class VnicDynamicIdUniverse(ManagedObject):
    ...
    mo_meta = MoMeta("VnicDynamicIdUniverse", "vnicDynamicIdUniverse", "dynamic-id-universe-[name]", VersionMeta.Version101e, "InputOutput", 0xffL, [], ["admin", "ls-network", "ls-network-policy"], [], [], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "VnicDynamicIdUniverse", parent_mo_or_dn, **kwargs)
