...
class VnicLifVsan(ManagedObject):
    ...
    mo_meta = MoMeta("VnicLifVsan", "vnicLifVsan", "vsan-[vnet]", VersionMeta.Version101e, "InputOutput", 0x7fL, [], ["read-only"], [u'vnicFcLif'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "vnet": MoPropertyMeta("vnet", "vnet", "uint", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x40L, None, None, None, [], ["1-4093"]), 
    }
