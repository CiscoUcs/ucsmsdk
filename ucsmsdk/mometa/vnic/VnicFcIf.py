...
class VnicFcIf(ManagedObject):
    ...
    mo_meta = MoMeta("VnicFcIf", "vnicFcIf", "if-default", VersionMeta.Version101e, "InputOutput", 0x1fL, [], ["admin", "ls-config", "ls-server", "ls-storage"], [u'vnicFc', u'vnicSanConnTempl'], [u'faultInst'], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "initiator": MoPropertyMeta("initiator", "initiator", "string", VersionMeta.Version101e, MoPropertyMeta.READ_ONLY, None, 0, 256, """(([A-Fa-f0-9][A-Fa-f0-9]:){7}[A-Fa-f0-9][A-Fa-f0-9])|0""", [], []), 
