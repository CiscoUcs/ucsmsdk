"""This module contains the general information for VnicScsiIf ManagedObject."""
...
class VnicScsiIf(ManagedObject):
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "VnicScsiIf", parent_mo_or_dn, **kwargs)
