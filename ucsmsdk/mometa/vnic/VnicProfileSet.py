...
class VnicProfileSetConsts():
    ...
    FSM_PREV_DEPLOY_ALIAS_PEER = "DeployAliasPeer"
    FSM_PREV_DEPLOY_ALIAS_SUCCESS = "DeployAliasSuccess"
    ...
    FSM_STATUS_DEPLOY_ALIAS_BEGIN = "DeployAliasBegin"
    FSM_STATUS_DEPLOY_ALIAS_FAIL = "DeployAliasFail"
    FSM_STATUS_DEPLOY_ALIAS_LOCAL = "DeployAliasLocal"
    FSM_STATUS_DEPLOY_ALIAS_PEER = "DeployAliasPeer"
    FSM_STATUS_DEPLOY_ALIAS_SUCCESS = "DeployAliasSuccess"
    ...
    FSM_STATUS_NOP = "nop"
    VLAN_GROUP_UPDATE_NA = "na"
    VLAN_GROUP_UPDATE_VLAN_GROUP_UPDATE = "vlan-group-update"
...
class VnicProfileSet(ManagedObject):
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version101e, MoPropertyMeta.INTERNAL, None, None, None, None, ["DeployAliasBegin", "DeployAliasFail", "DeployAliasLocal", "DeployAliasPeer", "DeployAliasSuccess", "DeployBegin", "DeployFail", "DeployLocal", "DeployPeer", "DeploySuccess", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version101e, MoPropertyMeta.INTERNAL, None, None, None, None, ["DeployAliasBegin", "DeployAliasFail", "DeployAliasLocal", "DeployAliasPeer", "DeployAliasSuccess", "DeployBegin", "DeployFail", "DeployLocal", "DeployPeer", "DeploySuccess", "nop"], []), 
    ...
    prop_map = {
        ...
        "sacl": "sacl", 
        "status": "status", 
        "vlanGroupUpdate": "vlan_group_update", 
    }
