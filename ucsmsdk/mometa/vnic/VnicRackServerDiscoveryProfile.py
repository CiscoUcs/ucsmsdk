...
class VnicRackServerDiscoveryProfile(ManagedObject):
    ...
    mo_meta = MoMeta("VnicRackServerDiscoveryProfile", "vnicRackServerDiscoveryProfile", "vnic-[name]", VersionMeta.Version211a, "InputOutput", 0xffL, [], ["read-only"], [u'equipmentChassis', u'vnicProfileSet'], [u'swVlan'], [None])
    ...
    prop_meta = {
        ...
        "max_ports": MoPropertyMeta("max_ports", "maxPorts", "ushort", VersionMeta.Version211a, MoPropertyMeta.READ_WRITE, 0x8L, None, None, None, [], ["1-4096"]), 
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, 0x10L, None, None, """[\-\.:_a-zA-Z0-9]{1,80}""", [], []), 
