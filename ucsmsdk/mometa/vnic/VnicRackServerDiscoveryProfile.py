...
class VnicRackServerDiscoveryProfile(ManagedObject):
    ...
    prop_meta = {
        ...
        "max_ports": MoPropertyMeta("max_ports", "maxPorts", "ushort", VersionMeta.Version211a, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, [], ["1-4096"]),
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, 0x20, None, None, r"""[\-\.:_a-zA-Z0-9]{1,80}""", [], []),
