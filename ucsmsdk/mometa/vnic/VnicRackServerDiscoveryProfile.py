"""This module contains the general information for VnicRackServerDiscoveryProfile ManagedObject."""
import sys, os
...
class VnicRackServerDiscoveryProfileConsts():
    INT_ID_NONE = "none"
...
class VnicRackServerDiscoveryProfile(ManagedObject):
    ...
    mo_meta = MoMeta("VnicRackServerDiscoveryProfile", "vnicRackServerDiscoveryProfile", "vnic-[name]", VersionMeta.Version211a, "InputOutput", 0x1ffL, [], ["read-only"], [u'equipmentChassis', u'vnicProfileSet'], [u'swVlan'], [None])
    ...
    prop_meta = {
        ...
        "max_ports": MoPropertyMeta("max_ports", "maxPorts", "ushort", VersionMeta.Version211a, MoPropertyMeta.READ_WRITE, 0x10L, None, None, None, [], ["1-4096"]), 
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, 0x20L, None, None, r"""[\-\.:_a-zA-Z0-9]{1,80}""", [], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "VnicRackServerDiscoveryProfile", parent_mo_or_dn, **kwargs)
