...
class VnicDynamicProvider(ManagedObject):
    ...
    mo_meta = MoMeta("VnicDynamicProvider", "vnicDynamicProvider", "dynamic-provider-[name]", VersionMeta.Version101e, "InputOutput", 0x1fL, [], ["read-only"], [u'vnicProfileSet'], [u'vnicDynamicProviderEp'], ["Get"])
