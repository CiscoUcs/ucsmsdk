"""This module contains the general information for VnicDynamicProvider ManagedObject."""
import sys, os
...
class VnicDynamicProvider(ManagedObject):
    """This is VnicDynamicProvider class."""

    consts = VnicDynamicProviderConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("VnicDynamicProvider", "vnicDynamicProvider", "dynamic-provider-[name]", VersionMeta.Version101e, "InputOutput", 0x3fL, [], ["read-only"], [u'vnicProfileSet'], [u'vnicDynamicProviderEp'], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "VnicDynamicProvider", parent_mo_or_dn, **kwargs)
