...
class VnicIScsi(ManagedObject):
    ...
    prop_meta = {
        ...
        "cdn_prop_in_sync": MoPropertyMeta("cdn_prop_in_sync", "cdnPropInSync", "string", VersionMeta.Version311e, MoPropertyMeta.READ_WRITE, 0x80, None, None, None, ["false", "no", "true", "yes"], []), 
        "cdn_source": MoPropertyMeta("cdn_source", "cdnSource", "string", VersionMeta.Version311e, MoPropertyMeta.READ_WRITE, 0x100, None, None, None, ["user-defined", "vnic-name"], []), 
