...
class VnicEtherIf(ManagedObject):
    ...
    mo_meta = MoMeta("VnicEtherIf", "vnicEtherIf", "if-[name]", VersionMeta.Version101e, "InputOutput", 0x7fL, [], ["admin", "ls-config", "ls-network", "ls-server"], [u'extvmmVMNetworkDefinition', u'fabricFlowMonExporterProfile', u'vnicEther', u'vnicIpc', u'vnicLanConnTempl', u'vnicProfile'], [u'fabricNetflowIPv4Addr', u'faultInst', u'vnicIPv4If'], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x10L, None, None, r"""[\-\.:_a-zA-Z0-9]{1,32}""", [], []), 
