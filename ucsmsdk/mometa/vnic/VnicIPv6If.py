...
class VnicIPv6If(ManagedObject):
    ...
    mo_meta = MoMeta("VnicIPv6If", "vnicIPv6If", "ipv6", VersionMeta.Version302c, "InputOutput", 0x3f, [], ["admin", "ls-compute", "ls-config", "ls-network", "ls-server", "ls-storage"], ['vnicIScsiBootVnic', 'vnicVlan'], ['vnicIPv6Dhcp', 'vnicIPv6IscsiAddr', 'vnicIPv6PooledIscsiAddr', 'vnicIpV6MgmtPooledAddr', 'vnicIpV6StaticAddr'], [None])
