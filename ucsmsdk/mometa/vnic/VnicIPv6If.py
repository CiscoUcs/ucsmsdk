...
class VnicIPv6If(ManagedObject):
    ...
    mo_meta = MoMeta("VnicIPv6If", "vnicIPv6If", "", VersionMeta.Version302a, "InputOutput", 0x3f, [], ["admin", "ls-compute", "ls-config", "ls-network", "ls-server", "ls-storage"], [], [u'vnicIpV6StaticAddr'], [None])

    prop_meta = {
        "addr": MoPropertyMeta("addr", "addr", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
