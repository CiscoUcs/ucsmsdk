...
class VnicIpV4ProfDerivedAddr(ManagedObject):
    ...
    mo_meta = MoMeta("VnicIpV4ProfDerivedAddr", "vnicIpV4ProfDerivedAddr", "ipv4-prof-addr", VersionMeta.Version141i, "InputOutput", 0x7fL, [], ["admin"], [u'adaptorHostIscsiIf', u'adaptorVlan', u'mgmtController', u'vnicIPv4If'], [], ["Get"])

    prop_meta = {
        "addr": MoPropertyMeta("addr", "addr", "string", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x1L, 0, 256, """((([0-9]){1,3}\.){3}[0-9]{1,3})""", [], []), 
        ...
        "def_gw": MoPropertyMeta("def_gw", "defGw", "string", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x4L, 0, 256, """((([0-9]){1,3}\.){3}[0-9]{1,3})""", [], []), 
        ...
        "subnet": MoPropertyMeta("subnet", "subnet", "string", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x40L, 0, 256, """((([0-9]){1,3}\.){3}[0-9]{1,3})""", [], []), 
    }
