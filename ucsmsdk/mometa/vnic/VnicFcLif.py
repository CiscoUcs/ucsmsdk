...
class VnicFcLif(ManagedObject):
    ...
    mo_meta = MoMeta("VnicFcLif", "vnicFcLif", "eth-lif-[name]", VersionMeta.Version101e, "InputOutput", 0xffL, [], ["read-only"], [], [u'vnicLifVsan'], ["Get"])
    ...
    prop_meta = {
        ...
        "vnic_dn": MoPropertyMeta("vnic_dn", "vnicDn", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x80L, 0, 256, None, [], []), 
    }
