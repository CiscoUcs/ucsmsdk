...
class VnicProfileSetFsm(ManagedObject):
    """This is VnicProfileSetFsm class."""

    consts = VnicProfileSetFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("VnicProfileSetFsm", "vnicProfileSetFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'vnicProfileSet'], [u'vnicProfileSetFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Deploy", "DeployAlias", "nop"], []), 
