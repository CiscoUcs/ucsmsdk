...
class VnicIpV6History(ManagedObject):
    ...
    mo_meta = MoMeta("VnicIpV6History", "vnicIpV6History", "ipv6-history", VersionMeta.Version221b, "InputOutput", 0x1f, [], ["read-only"], ['vnicIPv6PooledIscsiAddr', 'vnicIpV6MgmtPooledAddr'], [], [None])
