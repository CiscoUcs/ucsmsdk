...
class VnicWwnnHistory(ManagedObject):
    ...
    mo_meta = MoMeta("VnicWwnnHistory", "vnicWwnnHistory", "wwnn-history", VersionMeta.Version212a, "InputOutput", 0xfL, [], ["read-only"], [u'vnicFcNode'], [], [None])
    ...
    prop_meta = {
        ...
        "oldwwnn": MoPropertyMeta("oldwwnn", "oldwwnn", "string", VersionMeta.Version212a, MoPropertyMeta.READ_ONLY, None, 0, 256, """(([A-Fa-f0-9][A-Fa-f0-9]:){7}[A-Fa-f0-9][A-Fa-f0-9])|0""", [], []), 
