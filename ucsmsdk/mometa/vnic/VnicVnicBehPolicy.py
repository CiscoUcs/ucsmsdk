...
class VnicVnicBehPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("VnicVnicBehPolicy", "vnicVnicBehPolicy", "beh-vnic", VersionMeta.Version211a, "InputOutput", 0xffL, [], ["admin", "ls-config", "ls-network", "ls-server"], [u'orgOrg'], [], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, """vnic-default""", [], []), 
