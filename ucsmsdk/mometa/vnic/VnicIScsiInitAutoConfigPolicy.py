...
class VnicIScsiInitAutoConfigPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("VnicIScsiInitAutoConfigPolicy", "vnicIScsiInitAutoConfigPolicy", "iscsi-init-autoconf-[name]", VersionMeta.Version302a, "InputOutput", 0xffL, [], ["admin", "ls-config", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"], [u'orgOrg'], [u'vnicEthConfig', u'vnicIScsiConfig'], [None])
    ...
    prop_meta = {
        ...
        "fabric_path": MoPropertyMeta("fabric_path", "fabricPath", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x8L, None, None, None, ["A", "B", "NONE", "dual"], []), 
