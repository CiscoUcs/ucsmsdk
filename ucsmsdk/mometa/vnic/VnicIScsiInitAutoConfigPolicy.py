...
class VnicIScsiInitAutoConfigPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("VnicIScsiInitAutoConfigPolicy", "vnicIScsiInitAutoConfigPolicy", "iscsi-init-autoconf-[name]", VersionMeta.Version302c, "InputOutput", 0x1ffL, [], ["admin", "ls-config", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"], [u'orgOrg'], [u'vnicEthConfig', u'vnicIScsiConfig'], [None])
    ...
    prop_meta = {
        ...
        "fabric_path": MoPropertyMeta("fabric_path", "fabricPath", "string", VersionMeta.Version302c, MoPropertyMeta.READ_WRITE, 0x10L, None, None, None, ["A", "B", "NONE", "dual"], []), 
