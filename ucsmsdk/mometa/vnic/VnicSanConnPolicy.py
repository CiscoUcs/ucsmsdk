"""This module contains the general information for VnicSanConnPolicy ManagedObject."""
import sys, os
...
class VnicSanConnPolicy(ManagedObject):
    """This is VnicSanConnPolicy class."""

    consts = VnicSanConnPolicyConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("VnicSanConnPolicy", "vnicSanConnPolicy", "san-conn-pol-[name]", VersionMeta.Version211a, "InputOutput", 0xffL, [], ["admin", "ls-config", "ls-server", "ls-storage"], [u'orgOrg'], [u'storageIniGroup', u'vnicFc', u'vnicFcNode'], ["Add", "Get", "Remove", "Set"])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "VnicSanConnPolicy", parent_mo_or_dn, **kwargs)
