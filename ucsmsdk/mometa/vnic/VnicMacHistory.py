...
class VnicMacHistory(ManagedObject):
    ...
    mo_meta = MoMeta("VnicMacHistory", "vnicMacHistory", "mac-history", VersionMeta.Version212a, "InputOutput", 0xfL, [], ["read-only"], [u'vnicEther', u'vnicIScsi'], [], [None])
    ...
    prop_meta = {
        ...
        "oldaddr": MoPropertyMeta("oldaddr", "oldaddr", "string", VersionMeta.Version212a, MoPropertyMeta.READ_ONLY, None, None, None, """(([0-9a-fA-F][0-9a-fA-F]:){5}([0-9a-fA-F][0-9a-fA-F]))|0""", [], []), 
