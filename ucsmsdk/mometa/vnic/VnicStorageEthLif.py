...
class VnicStorageEthLif(ManagedObject):
    ...
    mo_meta = MoMeta("VnicStorageEthLif", "vnicStorageEthLif", "eth-lif-[name]", VersionMeta.Version302a, "InputOutput", 0xffL, [], ["admin", "ls-storage"], [u'lstorageArray', u'lstorageProcessor'], [u'faultInst', u'vnicIPv4If'], [None])
    ...
    prop_meta = {
        ...
        "oper_vlan_name": MoPropertyMeta("oper_vlan_name", "operVlanName", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        ...
        "role": MoPropertyMeta("role", "role", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x10L, None, None, """((defaultValue|none|nfs|node-mgmt|node-ha-state|cifs|data-protection|iscsi),){0,7}(defaultValue|none|nfs|node-mgmt|node-ha-state|cifs|data-protection|iscsi){0,1}""", [], []), 
        ...
        "switch_id": MoPropertyMeta("switch_id", "switchId", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x40L, None, None, None, ["A", "AB", "B", "NONE"], []), 
        ...
        "vlan_name": MoPropertyMeta("vlan_name", "vlanName", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x80L, None, None, None, [], []), 
