...
class VnicIpV4History(ManagedObject):
    ...
    mo_meta = MoMeta("VnicIpV4History", "vnicIpV4History", "ipv4-history", VersionMeta.Version212a, "InputOutput", 0xfL, [], ["read-only"], [u'storageIpV4PooledAddr', u'vnicIPv4PooledIscsiAddr', u'vnicIpV4MgmtPooledAddr', u'vnicIpV4PooledAddr'], [], [None])
    ...
    prop_meta = {
        ...
        "old_ip_v4_addr": MoPropertyMeta("old_ip_v4_addr", "oldIpV4Addr", "string", VersionMeta.Version212a, MoPropertyMeta.READ_ONLY, None, 0, 256, """((([0-9]){1,3}\.){3}[0-9]{1,3})""", [], []), 
