...
class VnicIScsiNode(ManagedObject):
    ...
    mo_meta = MoMeta("VnicIScsiNode", "vnicIScsiNode", "iscsi-node", VersionMeta.Version201m, "InputOutput", 0xffL, [], ["admin", "ls-config", "ls-network", "ls-server"], [u'lsServer', u'lstorageTargetIdentity', u'vnicLanConnPolicy'], [u'faultInst', u'vnicIqnHistory'], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "initiator_name": MoPropertyMeta("initiator_name", "initiatorName", "string", VersionMeta.Version201m, MoPropertyMeta.READ_WRITE, 0x8L, None, None, r"""[0-9a-zA-Z\.:-]{0,223}""", [], []), 
        "initiator_policy_name": MoPropertyMeta("initiator_policy_name", "initiatorPolicyName", "string", VersionMeta.Version302c, MoPropertyMeta.READ_WRITE, 0x10L, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        "iqn_ident_pool_name": MoPropertyMeta("iqn_ident_pool_name", "iqnIdentPoolName", "string", VersionMeta.Version212a, MoPropertyMeta.READ_WRITE, 0x20L, None, None, None, [], []), 
