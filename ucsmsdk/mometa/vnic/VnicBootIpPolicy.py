...
class VnicBootIpPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("VnicBootIpPolicy", "vnicBootIpPolicy", "", VersionMeta.Version141i, "InputOutput", 0x1ff, [], ["admin", "ls-config", "ls-network", "ls-server"], [], [], ["Get"])
    ...
    prop_meta = {
        ...
        "pool_name": MoPropertyMeta("pool_name", "poolName", "string", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x40, None, None, None, [], []),
