...
class VnicIpV6MgmtPooledAddr(ManagedObject):
    ...
    mo_meta = MoMeta("VnicIpV6MgmtPooledAddr", "vnicIpV6MgmtPooledAddr", "ipv6-pooled-addr", VersionMeta.Version221b, "InputOutput", 0x3f, [], ["admin", "ls-compute", "ls-config", "ls-network", "ls-server"], ['adaptorVlan', 'mgmtVnet', 'vnicIPv6If'], ['faultInst', 'vnicIpV6History'], ["Add", "Get", "Remove", "Set"])
