...
class VnicFcOEIf(ManagedObject):
    ...
    mo_meta = MoMeta("VnicFcOEIf", "vnicFcOEIf", "fcoe", VersionMeta.Version101e, "InputOutput", 0x3fL, [], ["admin", "ext-lan-config", "ext-lan-policy", "ext-san-config", "ext-san-policy", "ls-config", "ls-server", "ls-storage"], [u'vnicEther', u'vnicIpc', u'vnicLanConnTempl'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "initiator": MoPropertyMeta("initiator", "initiator", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x4L, 0, 256, """(([A-Fa-f0-9][A-Fa-f0-9]:){7}[A-Fa-f0-9][A-Fa-f0-9])|0""", [], []), 
