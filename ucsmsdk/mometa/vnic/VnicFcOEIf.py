...
class VnicFcOEIf(ManagedObject):
    ...
    prop_meta = {
        ...
        "initiator": MoPropertyMeta("initiator", "initiator", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x8, 0, 256, r"""(([A-Fa-f0-9][A-Fa-f0-9]:){7}[A-Fa-f0-9][A-Fa-f0-9])|0""", [], []), 
