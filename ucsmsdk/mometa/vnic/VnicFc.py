...
class VnicFc(ManagedObject):
    ...
    prop_meta = {
        ...
        "is_supported": MoPropertyMeta("is_supported", "isSupported", "string", VersionMeta.Version401a, MoPropertyMeta.READ_WRITE, 0x800, None, None, None, ["false", "no", "true", "yes"], []),
        "max_data_field_size": MoPropertyMeta("max_data_field_size", "maxDataFieldSize", "uint", VersionMeta.Version111j, MoPropertyMeta.READ_WRITE, 0x1000, None, None, None, [], ["256-2112"]),
        ...
        "pers_bind": MoPropertyMeta("pers_bind", "persBind", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x10000, None, None, None, ["disabled", "enabled"], []),
        "pers_bind_clear": MoPropertyMeta("pers_bind_clear", "persBindClear", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x20000, None, None, None, ["false", "no", "true", "yes"], []),
        "pin_to_group_name": MoPropertyMeta("pin_to_group_name", "pinToGroupName", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x40000, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []),
        "qos_policy_name": MoPropertyMeta("qos_policy_name", "qosPolicyName", "string", VersionMeta.Version111j, MoPropertyMeta.READ_WRITE, 0x80000, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []),
        ...
        "switch_id": MoPropertyMeta("switch_id", "switchId", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x800000, None, None, None, ["A", "B", "NONE"], []),
