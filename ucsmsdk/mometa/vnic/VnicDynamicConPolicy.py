...
class VnicDynamicConPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("VnicDynamicConPolicy", "vnicDynamicConPolicy", "dynamic-con-[name]", VersionMeta.Version101e, "InputOutput", 0x7ff, [], ["admin", "ls-network", "ls-network-policy"], ['orgOrg'], [], ["Add", "Get", "Remove", "Set"])
