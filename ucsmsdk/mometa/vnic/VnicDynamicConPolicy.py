...
class VnicDynamicConPolicy(ManagedObject):
    """This is VnicDynamicConPolicy class."""

    consts = VnicDynamicConPolicyConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("VnicDynamicConPolicy", "vnicDynamicConPolicy", "dynamic-con-[name]", VersionMeta.Version101e, "InputOutput", 0x7ffL, [], ["admin", "ls-network", "ls-network-policy"], [u'orgOrg'], [], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "dynamic_eth": MoPropertyMeta("dynamic_eth", "dynamicEth", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x20L, None, None, None, ["off"], ["0-256"]), 
        ...
        "protection": MoPropertyMeta("protection", "protection", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x100L, None, None, None, ["none", "protected", "protected-pref-a", "protected-pref-b"], []), 
