...
class VnicIpV4MgmtPooledAddr(ManagedObject):
    ...
    mo_meta = MoMeta("VnicIpV4MgmtPooledAddr", "vnicIpV4MgmtPooledAddr", "ipv4-pooled-addr", VersionMeta.Version221b, "InputOutput", 0x3f, [], ["admin", "ls-compute", "ls-config", "ls-network", "ls-server"], ['adaptorHostIscsiIf', 'adaptorVlan', 'lsServer', 'mgmtVnet', 'vnicIPv4If'], ['faultInst', 'vnicIpV4History'], ["Add", "Get", "Remove", "Set"])
