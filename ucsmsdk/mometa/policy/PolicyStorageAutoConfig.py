...
class PolicyStorageAutoConfig(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyStorageAutoConfig", "policyStorageAutoConfig", "storage-autoconfig-ctrl", VersionMeta.Version302a, "InputOutput", 0x1fL, [], ["admin", "ls-storage", "pn-policy"], [u'policyControlEp'], [u'policyControlledInstance', u'policyControlledType'], [None])
    ...
    prop_meta = {
        ...
        "source": MoPropertyMeta("source", "source", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x8L, None, None, None, ["local", "pending-policy", "policy"], []), 
