...
class PolicyPolicyRequestor(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyPolicyRequestor", "policyPolicyRequestor", "requestor-[name]", VersionMeta.Version211a, "InputOutput", 0x7fL, [], ["admin"], [u'policyPolicyScope'], [], [None])
    ...
    prop_meta = {
        ...
        "on_behalf_of_ident": MoPropertyMeta("on_behalf_of_ident", "onBehalfOfIdent", "string", VersionMeta.Version211a, MoPropertyMeta.CREATE_ONLY, 0x10L, 0, 510, None, [], []), 
