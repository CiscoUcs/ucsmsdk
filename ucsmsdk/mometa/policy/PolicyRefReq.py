...
class PolicyRefReq(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyRefReq", "policyRefReq", "refreq-[ref_converted_dn]", VersionMeta.Version212a, "InputOutput", 0x3fL, [], ["admin"], [u'policyElement'], [], [None])
    ...
    prop_meta = {
        ...
        "ref_converted_dn": MoPropertyMeta("ref_converted_dn", "refConvertedDn", "string", VersionMeta.Version212a, MoPropertyMeta.NAMING, 0x8L, 1, 510, None, [], []), 
