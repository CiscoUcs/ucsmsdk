...
class PolicyDiscovery(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyDiscovery", "policyDiscovery", "discovery-ctrl", VersionMeta.Version211a, "InputOutput", 0x3f, [], ["admin", "pn-policy"], ['policyControlEp'], ['policyControlledInstance', 'policyControlledType'], [None])
