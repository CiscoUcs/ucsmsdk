...
class PolicyPolicyScopeContConsts:
    FSM_PREV_REPORT_POLICY_FAIL_FSM_BEGIN = "ReportPolicyFailFsmBegin"
    FSM_PREV_REPORT_POLICY_FAIL_FSM_FAIL = "ReportPolicyFailFsmFail"
    FSM_PREV_REPORT_POLICY_FAIL_FSM_REPORT_ERROR = "ReportPolicyFailFsmReportError"
    FSM_PREV_REPORT_POLICY_FAIL_FSM_SUCCESS = "ReportPolicyFailFsmSuccess"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_REPORT_POLICY_FAIL_FSM_BEGIN = "ReportPolicyFailFsmBegin"
    FSM_STATUS_REPORT_POLICY_FAIL_FSM_FAIL = "ReportPolicyFailFsmFail"
    FSM_STATUS_REPORT_POLICY_FAIL_FSM_REPORT_ERROR = "ReportPolicyFailFsmReportError"
    FSM_STATUS_REPORT_POLICY_FAIL_FSM_SUCCESS = "ReportPolicyFailFsmSuccess"
    FSM_STATUS_NOP = "nop"
...
class PolicyPolicyScopeCont(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyPolicyScopeCont", "policyPolicyScopeCont", "scope-cont-[app_type]", VersionMeta.Version211a, "InputOutput", 0x3f, [], ["admin"], [u'extpolClient', u'extpolController', u'extpolProvider', u'extpolRegistry', u'policyPolicyEp'], [u'eventInst', u'faultInst', u'policyConfigError', u'policyPolicyScopeContFsm', u'policyPolicyScopeContFsmTask', u'policyPolicyScopeContext'], [None])
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version321d, MoPropertyMeta.INTERNAL, None, None, None, None, ["ReportPolicyFailFsmBegin", "ReportPolicyFailFsmFail", "ReportPolicyFailFsmReportError", "ReportPolicyFailFsmSuccess", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version321d, MoPropertyMeta.INTERNAL, None, None, None, None, ["ReportPolicyFailFsmBegin", "ReportPolicyFailFsmFail", "ReportPolicyFailFsmReportError", "ReportPolicyFailFsmSuccess", "nop"], []), 
