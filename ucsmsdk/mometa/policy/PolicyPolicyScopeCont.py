...
class PolicyPolicyScopeCont(ManagedObject):
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", None, MoPropertyMeta.INTERNAL, None, None, None, None, ["ReportPolicyFailFsmBegin", "ReportPolicyFailFsmFail", "ReportPolicyFailFsmReportError", "ReportPolicyFailFsmSuccess", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", None, MoPropertyMeta.INTERNAL, None, None, None, None, ["ReportPolicyFailFsmBegin", "ReportPolicyFailFsmFail", "ReportPolicyFailFsmReportError", "ReportPolicyFailFsmSuccess", "nop"], []), 
