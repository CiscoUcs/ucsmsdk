...
class PolicyPolicyScope(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyPolicyScope", "policyPolicyScope", "scope-[policy_type]-[resolve_type]-[policy_name]", VersionMeta.Version211a, "InputOutput", 0xffL, [], ["admin"], [u'policyPolicyScopeContext'], [u'eventInst', u'faultInst', u'policyPolicyRequestor', u'policyPolicyScopeFsm', u'policyPolicyScopeFsmTask'], [None])
    ...
    prop_meta = {
        ...
        "default_policy_name": MoPropertyMeta("default_policy_name", "defaultPolicyName", "string", VersionMeta.Version211a, MoPropertyMeta.CREATE_ONLY, 0x2L, 0, 510, None, [], []), 
        ...
        "policy_name": MoPropertyMeta("policy_name", "policyName", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, 0x8L, 1, 510, None, [], []), 
        "policy_type": MoPropertyMeta("policy_type", "policyType", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, 0x10L, 1, 510, None, [], []), 
        ...
        "resolve_type": MoPropertyMeta("resolve_type", "resolveType", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, 0x20L, None, None, None, ["name", "rn"], []), 
