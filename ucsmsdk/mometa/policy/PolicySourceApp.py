...
class PolicySourceApp(ManagedObject):
    ...
    mo_meta = MoMeta("PolicySourceApp", "policySourceApp", "source-[source_dme]", None, "InputOutput", 0x3f, [], ["read-only"], [u'policyControlEp'], [u'policyContext'], [None])
    ...
    prop_meta = {
        ...
        "source_dme": MoPropertyMeta("source_dme", "sourceDme", "string", None, MoPropertyMeta.NAMING, 0x10, 1, 510, None, [], []), 
