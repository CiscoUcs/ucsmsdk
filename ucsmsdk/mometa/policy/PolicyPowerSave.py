"""This module contains the general information for PolicyPowerSave ManagedObject."""
...
class PolicyPowerSaveConsts:
    SOURCE_LOCAL = "local"
    SOURCE_PENDING_POLICY = "pending-policy"
    SOURCE_POLICY = "policy"


class PolicyPowerSave(ManagedObject):
    """This is PolicyPowerSave class."""

    consts = PolicyPowerSaveConsts()
    naming_props = set([])

    mo_meta = MoMeta("PolicyPowerSave", "policyPowerSave", "powersave-ctrl", VersionMeta.Version433a, "InputOutput", 0x3f, [], ["admin", "pn-equipment", "pn-policy"], ['policyControlEp'], ['policyControlledInstance', 'policyControlledType'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "PolicyPowerSave", parent_mo_or_dn, **kwargs)
