...
class PolicySystemEp(ManagedObject):
    ...
    mo_meta = MoMeta("PolicySystemEp", "policySystemEp", "system-policies", VersionMeta.Version302a, "InputOutput", 0xfL, [], ["read-only"], [u'policyPolicyEp'], [u'lsbootPolicy', u'nwctrlDefinition', u'powerPolicy', u'solPolicy'], [None])
