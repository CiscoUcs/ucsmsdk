...
class PolicySystemEpConsts():
    pass


class PolicySystemEp(ManagedObject):
    """This is PolicySystemEp class."""

    consts = PolicySystemEpConsts()
    naming_props = set([])

    mo_meta = MoMeta("PolicySystemEp", "policySystemEp", "system-policies", VersionMeta.Version302c, "InputOutput", 0x1fL, [], ["read-only"], [u'policyPolicyEp'], [u'adaptorHostEthIfProfile', u'lsbootPolicy', u'nwctrlDefinition', u'powerPolicy', u'solPolicy'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "PolicySystemEp", parent_mo_or_dn, **kwargs)
