...
class PolicySystemEp(ManagedObject):
    ...
    mo_meta = MoMeta("PolicySystemEp", "policySystemEp", "system-policies", VersionMeta.Version302a, "InputOutput", 0x1f, [], ["read-only"], [u'policyPolicyEp'], [u'adaptorHostEthIfProfile', u'lsbootPolicy', u'nwctrlDefinition', u'powerPolicy', u'solPolicy'], [None])
