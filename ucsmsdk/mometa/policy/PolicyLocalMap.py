...
class PolicyLocalMap(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyLocalMap", "policyLocalMap", "localmap", VersionMeta.Version212a, "InputOutput", 0x1fL, [], ["admin"], [u'policyPolicyEp'], [u'policyElement'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "PolicyLocalMap", parent_mo_or_dn, **kwargs)
