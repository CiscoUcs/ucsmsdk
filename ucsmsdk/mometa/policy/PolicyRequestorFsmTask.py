...
class PolicyRequestorFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyRequestorFsmTask", "policyRequestorFsmTask", "task-[item]", None, "OutputOnly", 0xf, [], [""], [u'policyRequestor'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", None, MoPropertyMeta.NAMING, None, None, None, None, ["ResolveFromCentral", "nop"], []), 
