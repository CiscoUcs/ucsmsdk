...
class PolicyRequestorConsts:
    FSM_PREV_RESOLVE_FROM_CENTRAL_BEGIN = "ResolveFromCentralBegin"
    FSM_PREV_RESOLVE_FROM_CENTRAL_FAIL = "ResolveFromCentralFail"
    FSM_PREV_RESOLVE_FROM_CENTRAL_RESOLVE_FROM_OPS_MGR = "ResolveFromCentralResolveFromOpsMgr"
    FSM_PREV_RESOLVE_FROM_CENTRAL_RESOLVE_FROM_POLICY_MGR = "ResolveFromCentralResolveFromPolicyMgr"
    FSM_PREV_RESOLVE_FROM_CENTRAL_SUCCESS = "ResolveFromCentralSuccess"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_RESOLVE_FROM_CENTRAL_BEGIN = "ResolveFromCentralBegin"
    FSM_STATUS_RESOLVE_FROM_CENTRAL_FAIL = "ResolveFromCentralFail"
    FSM_STATUS_RESOLVE_FROM_CENTRAL_RESOLVE_FROM_OPS_MGR = "ResolveFromCentralResolveFromOpsMgr"
    FSM_STATUS_RESOLVE_FROM_CENTRAL_RESOLVE_FROM_POLICY_MGR = "ResolveFromCentralResolveFromPolicyMgr"
    FSM_STATUS_RESOLVE_FROM_CENTRAL_SUCCESS = "ResolveFromCentralSuccess"
    FSM_STATUS_NOP = "nop"
...
class PolicyRequestor(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyRequestor", "policyRequestor", "requestor-[name]", VersionMeta.Version321d, "InputOutput", 0x3f, [], ["read-only"], [u'policyScope'], [u'eventInst', u'faultInst', u'policyRequestorFsm', u'policyRequestorFsmTask'], [None])
