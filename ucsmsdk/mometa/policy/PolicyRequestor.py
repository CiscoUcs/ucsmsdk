...
class PolicyRequestor(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyRequestor", "policyRequestor", "requestor-[name]", None, "InputOutput", 0x3f, [], ["read-only"], [u'policyScope'], [u'eventInst', u'faultInst', u'policyRequestorFsm', u'policyRequestorFsmTask'], [None])
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", None, MoPropertyMeta.INTERNAL, None, None, None, None, ["ResolveFromCentralBegin", "ResolveFromCentralFail", "ResolveFromCentralResolveFromOpsMgr", "ResolveFromCentralResolveFromPolicyMgr", "ResolveFromCentralSuccess", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", None, MoPropertyMeta.INTERNAL, None, None, None, None, ["ResolveFromCentralBegin", "ResolveFromCentralFail", "ResolveFromCentralResolveFromOpsMgr", "ResolveFromCentralResolveFromPolicyMgr", "ResolveFromCentralSuccess", "nop"], []), 
        "fsm_try": MoPropertyMeta("fsm_try", "fsmTry", "byte", None, MoPropertyMeta.INTERNAL, None, None, None, None, [], []), 
        "name": MoPropertyMeta("name", "name", "string", None, MoPropertyMeta.NAMING, 0x8, 1, 510, None, [], []), 
        "on_behalf_of_ident": MoPropertyMeta("on_behalf_of_ident", "onBehalfOfIdent", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        "on_behalf_of_type": MoPropertyMeta("on_behalf_of_type", "onBehalfOfType", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
