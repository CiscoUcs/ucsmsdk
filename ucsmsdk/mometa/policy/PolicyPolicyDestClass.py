...
class PolicyPolicyDestClass(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyPolicyDestClass", "policyPolicyDestClass", "destclass", None, "InputOutput", 0x1f, [], ["read-only"], [u'policyScope'], [u'policyDestClass'], [None])

    prop_meta = {
        "action": MoPropertyMeta("action", "action", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["delete", "localize", "no-action"], []), 
        ...
        "mo_dn": MoPropertyMeta("mo_dn", "moDn", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        "name": MoPropertyMeta("name", "name", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        "overwrite": MoPropertyMeta("overwrite", "overwrite", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["false", "no", "true", "yes"], []), 
