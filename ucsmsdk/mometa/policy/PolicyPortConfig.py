...
class PolicyPortConfig(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyPortConfig", "policyPortConfig", "portconfig-ctrl", None, "InputOutput", 0x3fL, [], ["admin", "pn-equipment", "pn-policy"], [u'policyControlEp'], [u'policyControlledInstance', u'policyControlledType'], [None])
