...
class PolicyPortConfig(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyPortConfig", "policyPortConfig", "portconfig-ctrl", VersionMeta.Version311e, "InputOutput", 0x3f, [], ["admin", "pn-equipment", "pn-policy"], [u'policyControlEp'], [u'policyControlledInstance', u'policyControlledType'], [None])
    ...
    prop_meta = {
        ...
        "source": MoPropertyMeta("source", "source", "string", VersionMeta.Version311e, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["local", "pending-policy", "policy"], []), 
