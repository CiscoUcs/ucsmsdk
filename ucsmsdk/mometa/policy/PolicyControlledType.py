...
class PolicyControlledType(ManagedObject):
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version212a, MoPropertyMeta.INTERNAL, None, None, None, None, ["OperateBegin", "OperateFail", "OperateResolveAll", "OperateSuccess", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version212a, MoPropertyMeta.INTERNAL, None, None, None, None, ["OperateBegin", "OperateFail", "OperateResolveAll", "OperateSuccess", "nop"], []), 
        "fsm_try": MoPropertyMeta("fsm_try", "fsmTry", "byte", VersionMeta.Version212a, MoPropertyMeta.INTERNAL, None, None, None, None, [], []), 
        "parent_context": MoPropertyMeta("parent_context", "parentContext", "string", VersionMeta.Version211a, MoPropertyMeta.CREATE_ONLY, 0x4L, 0, 256, None, [], []), 
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, 0x20L, 1, 510, None, [], []), 
    }
