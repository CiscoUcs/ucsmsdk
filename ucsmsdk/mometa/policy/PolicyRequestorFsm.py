...
class PolicyRequestorFsm(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyRequestorFsm", "policyRequestorFsm", "fsm", VersionMeta.Version321d, "OutputOnly", 0xf, [], [""], [u'policyRequestor'], [u'policyRequestorFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version321d, MoPropertyMeta.READ_ONLY, None, None, None, None, ["ResolveFromCentral", "nop"], []), 
