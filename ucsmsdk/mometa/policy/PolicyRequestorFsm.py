"""This module contains the general information for PolicyRequestorFsm ManagedObject."""
...
class PolicyRequestorFsmConsts:
    COMPLETION_TIME_ = ""
    CURRENT_FSM_RESOLVE_FROM_CENTRAL = "ResolveFromCentral"
    CURRENT_FSM_NOP = "nop"
...
class PolicyRequestorFsm(ManagedObject):
    """This is PolicyRequestorFsm class."""

    consts = PolicyRequestorFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("PolicyRequestorFsm", "policyRequestorFsm", "fsm", None, "OutputOnly", 0xf, [], [""], [u'policyRequestor'], [u'policyRequestorFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["ResolveFromCentral", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "PolicyRequestorFsm", parent_mo_or_dn, **kwargs)
