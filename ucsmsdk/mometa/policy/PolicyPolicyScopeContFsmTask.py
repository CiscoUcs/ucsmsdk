"""This module contains the general information for PolicyPolicyScopeContFsmTask ManagedObject."""
...
class PolicyPolicyScopeContFsmTaskConsts:
    COMPLETION_CANCELLED = "cancelled"
    COMPLETION_COMPLETED = "completed"
    COMPLETION_PROCESSING = "processing"
    COMPLETION_SCHEDULED = "scheduled"
    ITEM_REPORT_POLICY_FAIL_FSM = "ReportPolicyFailFsm"
    ITEM_NOP = "nop"


class PolicyPolicyScopeContFsmTask(ManagedObject):
    """This is PolicyPolicyScopeContFsmTask class."""

    consts = PolicyPolicyScopeContFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("PolicyPolicyScopeContFsmTask", "policyPolicyScopeContFsmTask", "task-[item]", VersionMeta.Version321d, "OutputOnly", 0xf, [], [""], [u'policyPolicyScopeCont'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version321d, MoPropertyMeta.NAMING, None, None, None, None, ["ReportPolicyFailFsm", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "PolicyPolicyScopeContFsmTask", parent_mo_or_dn, **kwargs)
