...
class PolicyPolicyScopeContFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyPolicyScopeContFsmTask", "policyPolicyScopeContFsmTask", "task-[item]", None, "OutputOnly", 0xf, [], [""], [u'policyPolicyScopeCont'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", None, MoPropertyMeta.NAMING, None, None, None, None, ["ReportPolicyFailFsm", "nop"], []), 
