...
class PolicyPolicyScopeContFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyPolicyScopeContFsmStage", "policyPolicyScopeContFsmStage", "stage-[name]", None, "OutputOnly", 0xf, [], [""], [u'policyPolicyScopeContFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", None, MoPropertyMeta.NAMING, None, None, None, None, ["ReportPolicyFailFsmBegin", "ReportPolicyFailFsmFail", "ReportPolicyFailFsmReportError", "ReportPolicyFailFsmSuccess", "nop"], []), 
