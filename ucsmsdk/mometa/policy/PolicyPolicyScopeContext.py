...
class PolicyPolicyScopeContext(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyPolicyScopeContext", "policyPolicyScopeContext", "context-[name]", VersionMeta.Version211a, "InputOutput", 0x7f, [], ["admin"], [u'policyPolicyScopeCont'], [u'policyPolicyScope'], [None])
