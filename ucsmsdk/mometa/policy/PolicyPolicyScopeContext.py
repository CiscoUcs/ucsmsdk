...
class PolicyPolicyScopeContext(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyPolicyScopeContext", "policyPolicyScopeContext", "context-[name]", VersionMeta.Version211a, "InputOutput", 0x7fL, [], ["admin"], [u'policyPolicyScopeCont'], [u'policyPolicyScope'], [None])
    ...
    prop_meta = {
        ...
        "context": MoPropertyMeta("context", "context", "string", VersionMeta.Version211a, MoPropertyMeta.CREATE_ONLY, 0x4L, 0, 256, None, [], []), 
