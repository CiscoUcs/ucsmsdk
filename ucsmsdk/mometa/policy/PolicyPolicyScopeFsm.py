...
class PolicyPolicyScopeFsmConsts():
    COMPLETION_TIME_ = ""
...
class PolicyPolicyScopeFsm(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyPolicyScopeFsm", "policyPolicyScopeFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'policyPolicyScope'], [u'policyPolicyScopeFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "PolicyPolicyScopeFsm", parent_mo_or_dn, **kwargs)
