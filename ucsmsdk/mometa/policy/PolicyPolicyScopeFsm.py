...
class PolicyPolicyScopeFsm(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyPolicyScopeFsm", "policyPolicyScopeFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'policyPolicyScope'], [u'policyPolicyScopeFsmStage'], [None])
