...
class PolicyRequestorFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyRequestorFsmStage", "policyRequestorFsmStage", "stage-[name]", None, "OutputOnly", 0xf, [], [""], [u'policyRequestorFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", None, MoPropertyMeta.NAMING, None, None, None, None, ["ResolveFromCentralBegin", "ResolveFromCentralFail", "ResolveFromCentralResolveFromOpsMgr", "ResolveFromCentralResolveFromPolicyMgr", "ResolveFromCentralSuccess", "nop"], []), 
