"""This module contains the general information for PolicyChildClass ManagedObject."""
...
class PolicyChildClassConsts:
    pass


class PolicyChildClass(ManagedObject):
    """This is PolicyChildClass class."""

    consts = PolicyChildClassConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("PolicyChildClass", "policyChildClass", "child-[name]", None, "InputOutput", 0x3f, [], ["read-only"], [u'policyDestClass'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", None, MoPropertyMeta.NAMING, 0x8, 1, 128, None, [], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "PolicyChildClass", parent_mo_or_dn, **kwargs)
