...
class PolicyIdResolvePolicy(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyIdResolvePolicy", "policyIdResolvePolicy", "id-policy", VersionMeta.Version223a, "InputOutput", 0x3fL, [], ["admin", "operations"], [u'policyControlEp'], [], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "id_assignment_mode": MoPropertyMeta("id_assignment_mode", "idAssignmentMode", "string", VersionMeta.Version223a, MoPropertyMeta.READ_WRITE, 0x8L, None, None, None, ["loose-duplicate-check", "no-duplicate-check", "strict-duplicate-check"], []), 
