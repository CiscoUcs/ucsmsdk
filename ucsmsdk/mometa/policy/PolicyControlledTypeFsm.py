...
class PolicyControlledTypeFsm(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyControlledTypeFsm", "policyControlledTypeFsm", "fsm", VersionMeta.Version212a, "OutputOnly", 0xfL, [], [""], [u'policyControlledType'], [u'policyControlledTypeFsmStage'], [None])
