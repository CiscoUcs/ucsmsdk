...
class PolicyControlledTypeFsmConsts():
    COMPLETION_TIME_ = ""
...
class PolicyControlledTypeFsm(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyControlledTypeFsm", "policyControlledTypeFsm", "fsm", VersionMeta.Version212a, "OutputOnly", 0x7L, [], [""], [u'policyControlledType'], [u'policyControlledTypeFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version212a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Operate", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "PolicyControlledTypeFsm", parent_mo_or_dn, **kwargs)
