...
class PolicyDateTime(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyDateTime", "policyDateTime", "datetime-ctrl", VersionMeta.Version211a, "InputOutput", 0x1fL, [], ["admin", "ext-lan-config", "ext-lan-security", "operations"], [u'policyControlEp'], [u'policyControlledInstance', u'policyControlledType'], ["Add", "Get", "Set"])
