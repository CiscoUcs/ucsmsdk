...
class PolicyControlledTypeFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyControlledTypeFsmStage", "policyControlledTypeFsmStage", "stage-[name]", VersionMeta.Version212a, "OutputOnly", 0xfL, [], [""], [u'policyControlledTypeFsm'], [], [None])
