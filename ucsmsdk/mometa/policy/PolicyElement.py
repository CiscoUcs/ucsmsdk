...
class PolicyElement(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyElement", "policyElement", "element-[converted_dn]", VersionMeta.Version212a, "InputOutput", 0x3fL, [], ["admin"], [u'policyLocalMap'], [u'policyRefReq'], [None])
    ...
    prop_meta = {
        ...
        "converted_dn": MoPropertyMeta("converted_dn", "convertedDn", "string", VersionMeta.Version212a, MoPropertyMeta.NAMING, 0x4L, 1, 510, None, [], []), 
