...
class PolicyMEp(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyMEp", "policyMEp", "mep-ctrl", VersionMeta.Version211a, "InputOutput", 0x3f, [], ["admin", "operations"], ['policyControlEp'], ['policyControlledInstance', 'policyControlledType'], ["Add", "Get", "Set"])
