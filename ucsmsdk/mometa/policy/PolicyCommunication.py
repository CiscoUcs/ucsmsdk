...
class PolicyCommunicationConsts():
    SOURCE_LOCAL = "local"
...
class PolicyCommunication(ManagedObject):
    ...
    consts = PolicyCommunicationConsts()
    naming_props = set([])

    mo_meta = MoMeta("PolicyCommunication", "policyCommunication", "comm-ctrl", VersionMeta.Version211a, "InputOutput", 0x3fL, [], ["aaa", "admin"], [u'policyControlEp'], [u'policyControlledInstance', u'policyControlledType'], ["Add", "Get", "Set"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "PolicyCommunication", parent_mo_or_dn, **kwargs)
