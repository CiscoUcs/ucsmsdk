...
class PolicyCommunication(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyCommunication", "policyCommunication", "comm-ctrl", VersionMeta.Version211a, "InputOutput", 0x1fL, [], ["aaa", "admin"], [u'policyControlEp'], [u'policyControlledInstance', u'policyControlledType'], ["Add", "Get", "Set"])
