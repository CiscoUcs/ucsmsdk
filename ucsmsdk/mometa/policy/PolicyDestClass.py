...
class PolicyDestClass(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyDestClass", "policyDestClass", "dest-[name]", None, "InputOutput", 0x3f, [], ["read-only"], [u'policyDestEp', u'policyPolicyDestClass'], [u'policyChildClass'], [None])
