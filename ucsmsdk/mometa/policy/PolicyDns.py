...
class PolicyDns(ManagedObject):
    ...
    consts = PolicyDnsConsts()
    naming_props = set([])

    mo_meta = MoMeta("PolicyDns", "policyDns", "dns-ctrl", VersionMeta.Version211a, "InputOutput", 0x3fL, [], ["aaa", "admin", "ext-lan-config"], [u'policyControlEp'], [u'policyControlledInstance', u'policyControlledType'], ["Add", "Get", "Set"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "PolicyDns", parent_mo_or_dn, **kwargs)
