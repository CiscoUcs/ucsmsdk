"""This module contains the general information for PolicyModularChassisFan ManagedObject."""
...
class PolicyModularChassisFanConsts:
    SOURCE_LOCAL = "local"
    SOURCE_PENDING_POLICY = "pending-policy"
    SOURCE_POLICY = "policy"


class PolicyModularChassisFan(ManagedObject):
    """This is PolicyModularChassisFan class."""

    consts = PolicyModularChassisFanConsts()
    naming_props = set([])

    mo_meta = MoMeta("PolicyModularChassisFan", "policyModularChassisFan", "modularchassisfan-ctrl", VersionMeta.Version433a, "InputOutput", 0x3f, [], ["admin", "pn-equipment", "pn-policy"], ['policyControlEp'], ['policyControlledInstance', 'policyControlledType'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "PolicyModularChassisFan", parent_mo_or_dn, **kwargs)
