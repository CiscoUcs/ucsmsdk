...
class PolicyFault(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyFault", "policyFault", "fault-ctrl", VersionMeta.Version211a, "InputOutput", 0x3f, [], ["admin", "fault"], ['policyControlEp'], ['policyControlledInstance', 'policyControlledType'], ["Add", "Get", "Set"])
