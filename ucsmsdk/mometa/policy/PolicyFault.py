...
class PolicyFault(ManagedObject):
    ...
    consts = PolicyFaultConsts()
    naming_props = set([])

    mo_meta = MoMeta("PolicyFault", "policyFault", "fault-ctrl", VersionMeta.Version211a, "InputOutput", 0x3fL, [], ["admin", "fault"], [u'policyControlEp'], [u'policyControlledInstance', u'policyControlledType'], ["Add", "Get", "Set"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "PolicyFault", parent_mo_or_dn, **kwargs)
