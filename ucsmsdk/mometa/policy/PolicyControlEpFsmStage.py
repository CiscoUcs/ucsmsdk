...
class PolicyControlEpFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
...
class PolicyControlEpFsmStage(ManagedObject):
    ...
    consts = PolicyControlEpFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("PolicyControlEpFsmStage", "policyControlEpFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'policyControlEpFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["OperateBegin", "OperateFail", "OperateResolve", "OperateSuccess", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "PolicyControlEpFsmStage", parent_mo_or_dn, **kwargs)
