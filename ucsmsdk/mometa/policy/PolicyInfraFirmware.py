...
class PolicyInfraFirmwareConsts():
    SOURCE_LOCAL = "local"
...
class PolicyInfraFirmware(ManagedObject):
    ...
    consts = PolicyInfraFirmwareConsts()
    naming_props = set([])

    mo_meta = MoMeta("PolicyInfraFirmware", "policyInfraFirmware", "fabric-fw-ctrl", VersionMeta.Version211a, "InputOutput", 0x3fL, [], ["admin", "operations"], [u'policyControlEp'], [u'policyControlledInstance', u'policyControlledType'], ["Add", "Get", "Set"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "PolicyInfraFirmware", parent_mo_or_dn, **kwargs)
