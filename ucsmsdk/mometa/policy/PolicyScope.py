...
class PolicyScope(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyScope", "policyScope", "scope-[policy_type]-[resolve_type]-[policy_name]", None, "InputOutput", 0xff, [], ["read-only"], [u'policyContext'], [u'policyPolicyDestClass', u'policyRequestor'], [None])
    ...
    prop_meta = {
        ...
        "policy_name": MoPropertyMeta("policy_name", "policyName", "string", None, MoPropertyMeta.NAMING, 0x8, 1, 510, None, [], []), 
        "policy_type": MoPropertyMeta("policy_type", "policyType", "string", None, MoPropertyMeta.NAMING, 0x10, 1, 510, None, [], []), 
        "resolve_type": MoPropertyMeta("resolve_type", "resolveType", "string", None, MoPropertyMeta.NAMING, 0x20, None, None, None, ["name", "rn"], []), 
