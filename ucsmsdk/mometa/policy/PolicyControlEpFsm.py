...
class PolicyControlEpFsmConsts():
    COMPLETION_TIME_ = ""
...
class PolicyControlEpFsm(ManagedObject):
    ...
    consts = PolicyControlEpFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("PolicyControlEpFsm", "policyControlEpFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'policyControlEp'], [u'policyControlEpFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Operate", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "PolicyControlEpFsm", parent_mo_or_dn, **kwargs)
