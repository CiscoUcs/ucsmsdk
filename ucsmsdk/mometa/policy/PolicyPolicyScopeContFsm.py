...
class PolicyPolicyScopeContFsm(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyPolicyScopeContFsm", "policyPolicyScopeContFsm", "fsm", VersionMeta.Version321d, "OutputOnly", 0xf, [], [""], ['policyPolicyScopeCont'], ['policyPolicyScopeContFsmStage'], [None])
