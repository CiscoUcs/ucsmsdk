"""This module contains the general information for PolicyPolicyScopeContFsm ManagedObject."""
...
class PolicyPolicyScopeContFsmConsts:
    COMPLETION_TIME_ = ""
    CURRENT_FSM_REPORT_POLICY_FAIL_FSM = "ReportPolicyFailFsm"
    CURRENT_FSM_NOP = "nop"
...
class PolicyPolicyScopeContFsm(ManagedObject):
    """This is PolicyPolicyScopeContFsm class."""

    consts = PolicyPolicyScopeContFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("PolicyPolicyScopeContFsm", "policyPolicyScopeContFsm", "fsm", None, "OutputOnly", 0xf, [], [""], [u'policyPolicyScopeCont'], [u'policyPolicyScopeContFsmStage'], [None])

    prop_meta = {
        "child_action": MoPropertyMeta("child_action", "childAction", "string", None, MoPropertyMeta.INTERNAL, None, None, None, r"""((deleteAll|ignore|deleteNonPresent),){0,2}(deleteAll|ignore|deleteNonPresent){0,1}""", [], []), 
        "completion_time": MoPropertyMeta("completion_time", "completionTime", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, r"""([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", [""], []), 
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["ReportPolicyFailFsm", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "PolicyPolicyScopeContFsm", parent_mo_or_dn, **kwargs)
