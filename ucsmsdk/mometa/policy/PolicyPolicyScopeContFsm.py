...
class PolicyPolicyScopeContFsm(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyPolicyScopeContFsm", "policyPolicyScopeContFsm", "fsm", VersionMeta.Version321d, "OutputOnly", 0xf, [], [""], [u'policyPolicyScopeCont'], [u'policyPolicyScopeContFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version321d, MoPropertyMeta.READ_ONLY, None, None, None, None, ["ReportPolicyFailFsm", "nop"], []), 
