...
class TrigMeta(ManagedObject):
    ...
    mo_meta = MoMeta("TrigMeta", "trigMeta", "meta-trig-[sched_name]", VersionMeta.Version141i, "InputOutput", 0x1ffL, [], ["read-only"], [u'topSystem'], [u'trigTriggered'], ["Get"])
    ...
    prop_meta = {
        ...
        "sched_name": MoPropertyMeta("sched_name", "schedName", "string", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x80L, None, None, """[\-\.:_a-zA-Z0-9]{1,256}""", [], []), 
        ...
        "trig_time": MoPropertyMeta("trig_time", "trigTime", "string", VersionMeta.Version141i, MoPropertyMeta.READ_ONLY, None, None, None, """([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", [], []), 
