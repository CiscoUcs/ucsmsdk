...
class TrigMeta(ManagedObject):
    ...
    mo_meta = MoMeta("TrigMeta", "trigMeta", "meta-trig-[sched_name]", VersionMeta.Version141i, "InputOutput", 0x3ffL, [], ["read-only"], [u'topSystem'], [u'trigTriggered'], ["Get"])
    ...
    prop_meta = {
        ...
        "sched_name": MoPropertyMeta("sched_name", "schedName", "string", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x100L, None, None, r"""[\-\.:_a-zA-Z0-9]{1,256}""", [], []), 
