"""This module contains the general information for FcNicIfConfig ManagedObject."""
import sys, os
...
class FcNicIfConfigConsts():
    pass


class FcNicIfConfig(ManagedObject):
    """This is FcNicIfConfig class."""

    consts = FcNicIfConfigConsts()
    naming_props = set([])

    mo_meta = MoMeta("FcNicIfConfig", "fcNicIfConfig", "if-config", VersionMeta.Version101e, "InputOutput", 0x1fL, [], ["read-only"], [], [], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FcNicIfConfig", parent_mo_or_dn, **kwargs)
