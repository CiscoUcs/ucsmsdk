"""This module contains the general information for FcPIoFsmStage ManagedObject."""
import sys, os
...
class FcPIoFsmStage(ManagedObject):
    """This is FcPIoFsmStage class."""

    consts = FcPIoFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("FcPIoFsmStage", "fcPIoFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'fcPIoFsm'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "FcPIoFsmStage", parent_mo_or_dn, **kwargs)
