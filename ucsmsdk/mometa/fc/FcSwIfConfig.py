"""This module contains the general information for FcSwIfConfig ManagedObject."""
import sys, os
...
class FcSwIfConfigConsts():
    pass


class FcSwIfConfig(ManagedObject):
    """This is FcSwIfConfig class."""

    consts = FcSwIfConfigConsts()
    naming_props = set([])

    mo_meta = MoMeta("FcSwIfConfig", "fcSwIfConfig", "if-config", VersionMeta.Version101e, "InputOutput", 0x1fL, [], ["read-only"], [], [], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FcSwIfConfig", parent_mo_or_dn, **kwargs)
