...
class HostimgPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("HostimgPolicy", "hostimgPolicy", "img-policy-[name]", VersionMeta.Version141i, "InputOutput", 0x7ffL, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server"], [u'orgOrg'], [u'hostimgTarget'], ["Get"])
    ...
    prop_meta = {
        ...
        "comp": MoPropertyMeta("comp", "comp", "string", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x2L, None, None, None, ["complete", "componentized"], []), 
        "conf": MoPropertyMeta("conf", "conf", "string", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x4L, None, None, None, [], []), 
        ...
        "distro": MoPropertyMeta("distro", "distro", "string", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x10L, None, None, None, ["fedora", "unknown"], []), 
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x400L, None, None, None, ["esxi", "gpxe-script", "kvm", "linux", "unknown", "windows", "xen"], []), 
    }
