"""This module contains the general information for DomainEnvironmentFeature ManagedObject."""
import sys, os
...
class DomainEnvironmentFeatureConsts():
...
class DomainEnvironmentFeature(ManagedObject):
    """This is DomainEnvironmentFeature class."""

    consts = DomainEnvironmentFeatureConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("DomainEnvironmentFeature", "domainEnvironmentFeature", "env-feature-[name]", VersionMeta.Version221b, "InputOutput", 0x3fL, [], ["admin"], [u'domainEnvironmentFeatureCont', u'domainNetworkFeatureCont', u'domainServerFeatureCont', u'domainStorageFeatureCont'], [u'domainEnvironmentParam', u'domainNetworkParam', u'domainServerParam', u'domainStorageParam'], [None])
    ...
    prop_meta = {
        ...
        "functional_state": MoPropertyMeta("functional_state", "functionalState", "string", VersionMeta.Version221b, MoPropertyMeta.READ_WRITE, 0x4L, None, None, None, ["disabled", "enabled"], []), 
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version221b, MoPropertyMeta.NAMING, 0x8L, None, None, """[\-\.:_a-zA-Z0-9]{1,64}""", [], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "DomainEnvironmentFeature", parent_mo_or_dn, **kwargs)
