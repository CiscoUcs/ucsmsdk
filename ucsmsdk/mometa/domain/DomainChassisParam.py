...
class DomainChassisParam(ManagedObject):
    ...
    mo_meta = MoMeta("DomainChassisParam", "domainChassisParam", "chassis-param-[name]", None, "InputOutput", 0x7f, [], ["admin"], [u'domainChassisFeature', u'domainEnvironmentFeature', u'domainNetworkFeature', u'domainServerFeature', u'domainStorageFeature'], [], [None])
    ...
    prop_meta = {
        ...
        "value": MoPropertyMeta("value", "value", "string", None, MoPropertyMeta.READ_WRITE, 0x40, 0, 510, None, [], []), 
    }
