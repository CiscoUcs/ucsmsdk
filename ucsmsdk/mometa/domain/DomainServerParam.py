...
class DomainServerParam(ManagedObject):
    """This is DomainServerParam class."""

    consts = DomainServerParamConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("DomainServerParam", "domainServerParam", "server-param-[name]", VersionMeta.Version221b, "InputOutput", 0x3fL, [], ["admin"], [u'domainEnvironmentFeature', u'domainNetworkFeature', u'domainServerFeature', u'domainStorageFeature'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version221b, MoPropertyMeta.NAMING, 0x4L, 1, 510, None, [], []), 
        ...
        "value": MoPropertyMeta("value", "value", "string", VersionMeta.Version221b, MoPropertyMeta.READ_WRITE, 0x20L, 0, 510, None, [], []), 
    }
