...
class DomainServerFeatureCont(ManagedObject):
    ...
    mo_meta = MoMeta("DomainServerFeatureCont", "domainServerFeatureCont", "server-feature-cont", VersionMeta.Version221b, "InputOutput", 0x1f, [], ["admin"], [u'topSystem'], [u'domainEnvironmentFeature', u'domainNetworkFeature', u'domainServerFeature', u'domainStorageFeature'], [None])
