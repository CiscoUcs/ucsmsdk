...
class CimcvmediaConfigMountEntry(ManagedObject):
    ...
    prop_meta = {
        ...
        "image_name_variable": MoPropertyMeta("image_name_variable", "imageNameVariable", "string", VersionMeta.Version224a, MoPropertyMeta.READ_WRITE, 0x80, None, None, None, ["none", "service-profile-name"], []), 
