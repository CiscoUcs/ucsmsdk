...
class SolPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("SolPolicy", "solPolicy", "sol-[name]", VersionMeta.Version101e, "InputOutput", 0x3ffL, [], ["admin", "ls-config-policy"], [u'orgOrg', u'policySystemEp'], [], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "speed": MoPropertyMeta("speed", "speed", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x100L, None, None, None, ["115200", "19200", "38400", "57600", "9600"], []), 
