"""This module contains the general information for SolConfig ManagedObject."""
import sys, os
...
class SolConfig(ManagedObject):
    """This is SolConfig class."""

    consts = SolConfigConsts()
    naming_props = set([])

    mo_meta = MoMeta("SolConfig", "solConfig", "sol", VersionMeta.Version101e, "InputOutput", 0x1ffL, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server"], [u'lsServer'], [], ["Add", "Get", "Remove", "Set"])

    prop_meta = {
        "admin_state": MoPropertyMeta("admin_state", "adminState", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x2L, None, None, None, ["disable", "enable"], []), 
        ...
        "speed": MoPropertyMeta("speed", "speed", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x80L, None, None, None, ["115200", "19200", "38400", "57600", "9600"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "SolConfig", parent_mo_or_dn, **kwargs)
