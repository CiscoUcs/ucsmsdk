...
class StorageSystemFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
...
class StorageSystemFsmStage(ManagedObject):
    ...
    consts = StorageSystemFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("StorageSystemFsmStage", "storageSystemFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'storageSystemFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["SyncBegin", "SyncExecute", "SyncFail", "SyncSuccess", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "StorageSystemFsmStage", parent_mo_or_dn, **kwargs)
