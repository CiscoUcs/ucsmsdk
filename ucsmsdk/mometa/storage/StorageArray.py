...
class StorageArray(ManagedObject):
    ...
    mo_meta = MoMeta("StorageArray", "storageArray", "array-[name]", VersionMeta.Version302a, "InputOutput", 0x3fL, [], ["read-only"], [u'storageCloud'], [u'storageDiskGroup', u'storagePartition', u'storageProcessor'], [None])
    ...
    prop_meta = {
        ...
        "id": MoPropertyMeta("id", "id", "uint", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], ["0-254"]), 
