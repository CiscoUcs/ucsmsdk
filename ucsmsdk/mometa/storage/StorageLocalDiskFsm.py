...
class StorageLocalDiskFsmConsts:
    COMPLETION_TIME_ = ""
...
class StorageLocalDiskFsm(ManagedObject):
    """This is StorageLocalDiskFsm class."""

    consts = StorageLocalDiskFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("StorageLocalDiskFsm", "storageLocalDiskFsm", "fsm", VersionMeta.Version911z, "OutputOnly", 0xf, [], [""], [u'storageLocalDisk'], [u'storageLocalDiskFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version911z, MoPropertyMeta.READ_ONLY, None, None, None, None, ["UpdateLocalDisk", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "StorageLocalDiskFsm", parent_mo_or_dn, **kwargs)
