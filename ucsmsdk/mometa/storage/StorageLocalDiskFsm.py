...
class StorageLocalDiskFsm(ManagedObject):
    ...
    mo_meta = MoMeta("StorageLocalDiskFsm", "storageLocalDiskFsm", "fsm", VersionMeta.Version312b, "OutputOnly", 0xf, [], [""], [u'storageLocalDisk'], [u'storageLocalDiskFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version312b, MoPropertyMeta.READ_ONLY, None, None, None, None, ["UpdateLocalDisk", "nop"], []), 
