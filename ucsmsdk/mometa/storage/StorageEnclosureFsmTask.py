...
class StorageEnclosureFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("StorageEnclosureFsmTask", "storageEnclosureFsmTask", "task-[item]", VersionMeta.Version911z, "OutputOnly", 0xf, [], [""], [u'storageEnclosure'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version911z, MoPropertyMeta.NAMING, None, None, None, None, ["RemoveEnclosure", "nop"], []), 
