...
class StorageEnclosureFsmTaskConsts:
...
class StorageEnclosureFsmTask(ManagedObject):
    """This is StorageEnclosureFsmTask class."""

    consts = StorageEnclosureFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("StorageEnclosureFsmTask", "storageEnclosureFsmTask", "task-[item]", VersionMeta.Version312b, "OutputOnly", 0xf, [], [""], [u'storageEnclosure'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version312b, MoPropertyMeta.NAMING, None, None, None, None, ["RemoveEnclosure", "nop"], []), 
