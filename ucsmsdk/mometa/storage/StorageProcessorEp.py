...
class StorageProcessorEp(ManagedObject):
    ...
    mo_meta = MoMeta("StorageProcessorEp", "storageProcessorEp", "proc-ep-[name]", VersionMeta.Version302a, "InputOutput", 0x1fL, [], ["read-only"], [], [], [None])
    ...
    prop_meta = {
        ...
        "processor_dn": MoPropertyMeta("processor_dn", "processorDn", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
