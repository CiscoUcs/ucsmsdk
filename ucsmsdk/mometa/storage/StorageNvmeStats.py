...
class StorageNvmeStats(ManagedObject):
    ...
    mo_meta = MoMeta("StorageNvmeStats", "storageNvmeStats", "nvme-stats", VersionMeta.Version911z, "OutputOnly", 0xf, [], ["admin", "operations", "read-only"], [u'storageController'], [u'storageNvmeStatsHist'], [None])
