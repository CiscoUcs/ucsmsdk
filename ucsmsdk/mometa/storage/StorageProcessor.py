...
class StorageProcessor(ManagedObject):
    ...
    mo_meta = MoMeta("StorageProcessor", "storageProcessor", "processor-[name]", VersionMeta.Version302a, "InputOutput", 0x1fL, [], ["read-only"], [u'storageArray'], [u'commLocale', u'eventInst', u'faultInst', u'lstorageLunReplicationService', u'osController', u'pkiLocale', u'storageEthLif', u'storageProcessorFsm', u'storageProcessorFsmTask', u'storageProcessorRuntime', u'storageTargetIdentity'], [None])

    prop_meta = {
        "admin_leadership": MoPropertyMeta("admin_leadership", "adminLeadership", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["active", "passive", "unknown"], []), 
        "admin_state": MoPropertyMeta("admin_state", "adminState", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["in-maintenance", "in-service"], []), 
        ...
        "cimc_backup_trigger_status": MoPropertyMeta("cimc_backup_trigger_status", "cimcBackupTriggerStatus", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["disabled", "enabled", "unknown"], []), 
        "cimc_heartbeat_status": MoPropertyMeta("cimc_heartbeat_status", "cimcHeartbeatStatus", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["disabled", "running", "timed-out", "unknown"], []), 
        "cluster_state": MoPropertyMeta("cluster_state", "clusterState", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["degraded", "ok", "unknown"], []), 
        "config_state": MoPropertyMeta("config_state", "configState", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["disruptive", "ok", "unknown"], []), 
        "conn_path": MoPropertyMeta("conn_path", "connPath", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, """((defaultValue|unknown|A|B),){0,3}(defaultValue|unknown|A|B){0,1}""", [], []), 
        "conn_status": MoPropertyMeta("conn_status", "connStatus", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, """((defaultValue|unknown|A|B),){0,3}(defaultValue|unknown|A|B){0,1}""", [], []), 
        ...
        "ha_peer_dn": MoPropertyMeta("ha_peer_dn", "haPeerDn", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        "ha_state": MoPropertyMeta("ha_state", "haState", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["degraded", "election-failed", "failover-in-progress", "not-ready", "ready", "unknown"], []), 
        "id": MoPropertyMeta("id", "id", "uint", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        "leadership": MoPropertyMeta("leadership", "leadership", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["active", "passive", "unknown"], []), 
        "ls_dn": MoPropertyMeta("ls_dn", "lsDn", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        "managing_inst": MoPropertyMeta("managing_inst", "managingInst", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["A", "B", "NONE"], []), 
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version302a, MoPropertyMeta.NAMING, 0x4L, None, None, """[\-\.:_a-zA-Z0-9]{1,16}""", [], []), 
        "oper_config_issues": MoPropertyMeta("oper_config_issues", "operConfigIssues", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, """((defaultValue|not-applicable|invalid-config|invicta-uptime-out-of-sync),){0,3}(defaultValue|not-applicable|invalid-config|invicta-uptime-out-of-sync){0,1}""", [], []), 
        ...
        "oper_state": MoPropertyMeta("oper_state", "operState", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["cluster-degraded", "compute-degraded", "compute-inoperable", "in-maintenance", "offline", "online", "undefined"], []), 
        ...
        "orig_iqn": MoPropertyMeta("orig_iqn", "origIqn", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
