...
class StorageEthLif(ManagedObject):
    ...
    mo_meta = MoMeta("StorageEthLif", "storageEthLif", "eth-lif-[name]", VersionMeta.Version302c, "InputOutput", 0x3fL, [], ["read-only"], [u'osInstance', u'storageProcessor'], [u'osEthBondIntf', u'osEthIntf', u'vnicIPv4If'], [None])
    ...
    prop_meta = {
        ...
        "default_net": MoPropertyMeta("default_net", "defaultNet", "string", VersionMeta.Version302c, MoPropertyMeta.READ_ONLY, None, None, None, None, ["false", "no", "true", "yes"], []), 
        ...
        "role": MoPropertyMeta("role", "role", "string", VersionMeta.Version302c, MoPropertyMeta.READ_ONLY, None, None, None, r"""((defaultValue|none|nfs|node-mgmt|node-ha-state|cifs|data-protection|iscsi),){0,7}(defaultValue|none|nfs|node-mgmt|node-ha-state|cifs|data-protection|iscsi){0,1}""", [], []), 
