...
class StorageSystemFsmTaskConsts():
...
class StorageSystemFsmTask(ManagedObject):
    ...
    consts = StorageSystemFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("StorageSystemFsmTask", "storageSystemFsmTask", "task-[item]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'storageSystem'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["Sync", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "StorageSystemFsmTask", parent_mo_or_dn, **kwargs)
