...
class StorageScsiLunMask(ManagedObject):
    ...
    mo_meta = MoMeta("StorageScsiLunMask", "storageScsiLunMask", "lunmask-[name]", VersionMeta.Version302c, "InputOutput", 0x3fL, [], ["read-only"], [u'storageLunMaskGroup'], [], [None])
    ...
    prop_meta = {
        ...
        "id": MoPropertyMeta("id", "id", "ushort", VersionMeta.Version302c, MoPropertyMeta.READ_ONLY, None, None, None, None, [], ["0-255"]), 
