...
class StorageConnectionDef(ManagedObject):
    ...
    mo_meta = MoMeta("StorageConnectionDef", "storageConnectionDef", "storage-conndef", VersionMeta.Version211a, "InputOutput", 0x1ff, [], ["admin", "ext-san-config", "ext-san-policy", "ls-config", "ls-server", "ls-storage", "ls-storage-policy"], [u'vnicFcGroupDef'], [u'faultInst', u'storageFcTargetEp'], ["Add", "Get", "Remove", "Set"])
