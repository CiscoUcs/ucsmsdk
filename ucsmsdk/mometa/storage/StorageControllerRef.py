...
class StorageControllerRef(ManagedObject):
    ...
    mo_meta = MoMeta("StorageControllerRef", "storageControllerRef", "server-[server_id]-controller-[controller_type]-[controller_id]", VersionMeta.Version911z, "InputOutput", 0xff, [], ["read-only"], [u'storageEnclosureDiskSlotEp'], [], [None])
    ...
    prop_meta = {
        ...
        "server_id": MoPropertyMeta("server_id", "serverId", "uint", VersionMeta.Version911z, MoPropertyMeta.NAMING, 0x40, None, None, None, [], []), 
