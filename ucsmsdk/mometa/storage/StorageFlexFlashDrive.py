...
class StorageFlexFlashDrive(ManagedObject):
    ...
    mo_meta = MoMeta("StorageFlexFlashDrive", "storageFlexFlashDrive", "drive-[name]", VersionMeta.Version221b, "InputOutput", 0x7fL, [], ["read-only"], [u'storageFlexFlashCard'], [u'faultInst'], ["Get"])
