"""This module contains the general information for StoragePartitionFsmStage ManagedObject."""
import sys, os
...
class StoragePartitionFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_DEPLOY_STORAGE_BEGIN = "DeployStorageBegin"
    NAME_DEPLOY_STORAGE_CONFIG_DISK = "DeployStorageConfigDisk"
    NAME_DEPLOY_STORAGE_CONFIG_LUN = "DeployStorageConfigLun"
    NAME_DEPLOY_STORAGE_FAIL = "DeployStorageFail"
    NAME_DEPLOY_STORAGE_SUCCESS = "DeployStorageSuccess"
    NAME_DEPLOY_STORAGE_VERIFY_CONFIG = "DeployStorageVerifyConfig"
    NAME_DEPLOY_STORAGE_VERIFY_REPLICATION_CONFIG = "DeployStorageVerifyReplicationConfig"
    NAME_DEPLOY_STORAGE_VERIFY_SNAPSHOT_CONFIG = "DeployStorageVerifySnapshotConfig"
    NAME_SCRUB_RAIDGROUP_BEGIN = "ScrubRAIDGroupBegin"
    NAME_SCRUB_RAIDGROUP_FAIL = "ScrubRAIDGroupFail"
    NAME_SCRUB_RAIDGROUP_PERFORM_ERASE = "ScrubRAIDGroupPerformErase"
    NAME_SCRUB_RAIDGROUP_SUCCESS = "ScrubRAIDGroupSuccess"
    NAME_SCRUB_RAIDGROUP_WAIT_FOR_ERASE_COMPLETION = "ScrubRAIDGroupWaitForEraseCompletion"
    NAME_NOP = "nop"
...
class StoragePartitionFsmStage(ManagedObject):
    """This is StoragePartitionFsmStage class."""

    consts = StoragePartitionFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("StoragePartitionFsmStage", "storagePartitionFsmStage", "stage-[name]", VersionMeta.Version302a, "OutputOnly", 0x7L, [], [""], [u'storagePartitionFsm'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "StoragePartitionFsmStage", parent_mo_or_dn, **kwargs)
