...
class StorageSasPortDescriptor(ManagedObject):
    ...
    mo_meta = MoMeta("StorageSasPortDescriptor", "storageSasPortDescriptor", "sas-port-desc-[id]", VersionMeta.Version911z, "InputOutput", 0x3f, [], [""], [u'equipmentChassisCapProvider'], [], [None])
