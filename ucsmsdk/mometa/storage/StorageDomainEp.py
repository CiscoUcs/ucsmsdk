...
class StorageDomainEp(ManagedObject):
    ...
    consts = StorageDomainEpConsts()
    naming_props = set([])

    mo_meta = MoMeta("StorageDomainEp", "storageDomainEp", "storage-ep", VersionMeta.Version211a, "InputOutput", 0x1fL, [], ["read-only"], [u'topRoot'], [u'storageSystem'], [None])
    ...
    def __init__(self, **kwargs):
        ...
        ManagedObject.__init__(self, "StorageDomainEp", **kwargs)
