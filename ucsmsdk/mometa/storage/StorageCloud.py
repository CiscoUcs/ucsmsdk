...
class StorageCloud(ManagedObject):
    ...
    mo_meta = MoMeta("StorageCloud", "storageCloud", "storage", VersionMeta.Version302a, "InputOutput", 0xfL, [], ["read-only"], [u'topRoot'], [u'storageArray', u'storageClusterIdUniverse', u'trigSched'], [None])
