"""This module contains the general information for StorageCloud ManagedObject."""
import sys, os
...
class StorageCloudConsts():
    pass


class StorageCloud(ManagedObject):
    """This is StorageCloud class."""

    consts = StorageCloudConsts()
    naming_props = set([])

    mo_meta = MoMeta("StorageCloud", "storageCloud", "storage", VersionMeta.Version302c, "InputOutput", 0x1fL, [], ["read-only"], [u'topRoot'], [u'storageArray', u'storageClusterIdUniverse', u'trigSched'], [None])
    ...
    def __init__(self, **kwargs):
        ...
        ManagedObject.__init__(self, "StorageCloud", **kwargs)
