...
class StorageController(ManagedObject):
    ...
    prop_meta = {
        ...
        "display_type": MoPropertyMeta("display_type", "displayType", "string", VersionMeta.Version423b, MoPropertyMeta.READ_ONLY, None, None, None, None, ["FCH", "FLASH", "HBA", "M2", "NVME", "PCH", "PT", "SAS", "SATA", "SD", "external", "unknown"], []),
