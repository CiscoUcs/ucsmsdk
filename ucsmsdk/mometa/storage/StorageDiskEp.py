...
class StorageDiskEp(ManagedObject):
    ...
    mo_meta = MoMeta("StorageDiskEp", "storageDiskEp", "disk-[id]", VersionMeta.Version302a, "InputOutput", 0x1fL, [], ["read-only"], [u'storageDiskGroup'], [], [None])
    ...
    prop_meta = {
        ...
        "membership": MoPropertyMeta("membership", "membership", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["down", "hot-standby", "unknown", "up"], []), 
