...
class StorageSystemFsm(ManagedObject):
    ...
    consts = StorageSystemFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("StorageSystemFsm", "storageSystemFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'storageSystem'], [u'storageSystemFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Sync", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "StorageSystemFsm", parent_mo_or_dn, **kwargs)
