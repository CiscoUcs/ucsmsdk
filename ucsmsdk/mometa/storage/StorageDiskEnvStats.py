...
class StorageDiskEnvStats(ManagedObject):
    ...
    mo_meta = MoMeta("StorageDiskEnvStats", "storageDiskEnvStats", "disk-env-stats", VersionMeta.Version302a, "OutputOnly", 0x7L, [], ["admin", "operations", "read-only"], [u'storageLocalDisk'], [u'faultInst', u'storageDiskEnvStatsHist'], [None])
