...
class StorageEtherIf(ManagedObject):
    ...
    mo_meta = MoMeta("StorageEtherIf", "storageEtherIf", "ether-[name]", VersionMeta.Version211a, "InputOutput", 0x3fL, [], ["admin"], [u'storageIScsiTargetIf'], [u'ipServiceIf'], [None])
    ...
    prop_meta = {
        ...
        "vlan_type": MoPropertyMeta("vlan_type", "vlanType", "string", VersionMeta.Version211a, MoPropertyMeta.READ_WRITE, 0x20L, None, None, None, ["default", "native", "regular"], []), 
    }
