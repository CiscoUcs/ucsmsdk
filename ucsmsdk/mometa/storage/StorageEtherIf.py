...
class StorageEtherIf(ManagedObject):
    ...
    mo_meta = MoMeta("StorageEtherIf", "storageEtherIf", "ether-[name]", VersionMeta.Version211a, "InputOutput", 0x7fL, [], ["admin"], [u'storageIScsiTargetIf'], [u'ipServiceIf'], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, 0x8L, None, None, r"""[\-\.:_a-zA-Z0-9]{1,16}""", [], []), 
        ...
        "vlan_type": MoPropertyMeta("vlan_type", "vlanType", "string", VersionMeta.Version211a, MoPropertyMeta.READ_WRITE, 0x40L, None, None, None, ["default", "native", "regular"], []), 
    }
