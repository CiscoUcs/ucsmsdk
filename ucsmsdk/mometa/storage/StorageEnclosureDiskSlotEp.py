...
class StorageEnclosureDiskSlotEp(ManagedObject):
    ...
    mo_meta = MoMeta("StorageEnclosureDiskSlotEp", "storageEnclosureDiskSlotEp", "disk-slot-[id]", VersionMeta.Version302a, "InputOutput", 0x3f, [], ["read-only"], [u'storageEnclosure'], [u'faultInst', u'storageControllerRef'], [None])

    prop_meta = {
        "auto_zone_cause": MoPropertyMeta("auto_zone_cause", "autoZoneCause", "string", VersionMeta.Version911z, MoPropertyMeta.READ_ONLY, None, None, None, None, ["hdd-tray-in-lieu-of-server2", "hddslot-unassigned", "hotspare-unsupported", "mezz-controller-in-ioexpander", "none", "sharing-unsupported"], []), 
        ...
        "configuration": MoPropertyMeta("configuration", "configuration", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["not-supported", "supported", "unknown"], []), 
        ...
        "ownership": MoPropertyMeta("ownership", "ownership", "string", VersionMeta.Version911z, MoPropertyMeta.READ_ONLY, None, None, None, None, ["chassis-dedicated-spare", "chassis-global-spare", "dedicated", "shared", "unassigned", "unknown"], []), 
