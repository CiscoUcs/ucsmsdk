...
class StorageEnclosure(ManagedObject):
    ...
    prop_meta = {
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version312b, MoPropertyMeta.READ_ONLY, None, None, None, None, ["dedicated-rear-ssd-enclosure", "hdd-expansion-tray", "hdd-mother-board", "ioe-nvme-enclosure", "sb-nvme-enclosure", "server-front-load", "server-nvme", "server-pch", "server-rear", "sioc-nvme-enclosure", "unknown"], []),
