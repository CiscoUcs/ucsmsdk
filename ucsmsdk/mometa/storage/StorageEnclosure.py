...
class StorageEnclosure(ManagedObject):
    ...
    mo_meta = MoMeta("StorageEnclosure", "storageEnclosure", "enc-[id]", VersionMeta.Version141i, "InputOutput", 0x3fL, [], ["read-only"], [u'storageBlade', u'storageController'], [u'faultInst', u'storageDeviceBridge', u'storageEnclosureDiskSlotEp', u'storageLocalDisk'], ["Get"])
    ...
    prop_meta = {
        ...
        "drawer_state": MoPropertyMeta("drawer_state", "drawerState", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["closed", "not-applicable", "open"], []), 
        "id": MoPropertyMeta("id", "id", "uint", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x8L, None, None, None, [], []), 
