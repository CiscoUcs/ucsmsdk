...
class StorageProcessorFsm(ManagedObject):
    ...
    mo_meta = MoMeta("StorageProcessorFsm", "storageProcessorFsm", "fsm", VersionMeta.Version302c, "OutputOnly", 0xfL, [], [""], [u'storageProcessor'], [u'storageProcessorFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version302c, MoPropertyMeta.READ_ONLY, None, None, None, None, ["DeploySystem", "DiscoverSystem", "EnterMaintenance", "ExitMaintenance", "HaTakeOver", "UndeploySystem", "nop"], []), 
