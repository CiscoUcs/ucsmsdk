"""This module contains the general information for StorageProcessorFsm ManagedObject."""
import sys, os
...
class StorageProcessorFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_DEPLOY_SYSTEM = "DeploySystem"
    CURRENT_FSM_DISCOVER_SYSTEM = "DiscoverSystem"
    CURRENT_FSM_ENTER_MAINTENANCE = "EnterMaintenance"
    CURRENT_FSM_EXIT_MAINTENANCE = "ExitMaintenance"
    CURRENT_FSM_HA_TAKE_OVER = "HaTakeOver"
    CURRENT_FSM_UNDEPLOY_SYSTEM = "UndeploySystem"
    CURRENT_FSM_NOP = "nop"
...
class StorageProcessorFsm(ManagedObject):
    """This is StorageProcessorFsm class."""

    consts = StorageProcessorFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("StorageProcessorFsm", "storageProcessorFsm", "fsm", VersionMeta.Version302a, "OutputOnly", 0x7L, [], [""], [u'storageProcessor'], [u'storageProcessorFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "completion_time": MoPropertyMeta("completion_time", "completionTime", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, """([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", [""], []), 
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["DeploySystem", "DiscoverSystem", "EnterMaintenance", "ExitMaintenance", "HaTakeOver", "UndeploySystem", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "StorageProcessorFsm", parent_mo_or_dn, **kwargs)
