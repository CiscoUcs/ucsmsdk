...
class StorageFlexFlashControllerFsm(ManagedObject):
    ...
    mo_meta = MoMeta("StorageFlexFlashControllerFsm", "storageFlexFlashControllerFsm", "fsm", VersionMeta.Version223a, "OutputOnly", 0xfL, [], [""], [u'storageFlexFlashController'], [u'storageFlexFlashControllerFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "completion_time": MoPropertyMeta("completion_time", "completionTime", "string", VersionMeta.Version223a, MoPropertyMeta.READ_ONLY, None, None, None, r"""([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", [""], []), 
