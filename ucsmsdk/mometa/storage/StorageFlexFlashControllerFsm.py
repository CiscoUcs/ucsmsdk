...
class StorageFlexFlashControllerFsm(ManagedObject):
    """This is StorageFlexFlashControllerFsm class."""

    consts = StorageFlexFlashControllerFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("StorageFlexFlashControllerFsm", "storageFlexFlashControllerFsm", "fsm", VersionMeta.Version223a, "OutputOnly", 0x7L, [], [""], [u'storageFlexFlashController'], [u'storageFlexFlashControllerFsmStage'], [None])
