...
class StorageSasExpander(ManagedObject):
    ...
    mo_meta = MoMeta("StorageSasExpander", "storageSasExpander", "sas-expander", VersionMeta.Version226a, "InputOutput", 0x1fL, [], ["read-only"], [u'computeBlade', u'computeBoard', u'computeRackUnit'], [u'firmwareBootDefinition', u'firmwareRunning', u'mgmtController'], [None])
    ...
    prop_meta = {
        ...
        "id": MoPropertyMeta("id", "id", "uint", VersionMeta.Version226a, MoPropertyMeta.READ_WRITE, 0x4L, None, None, None, [], []), 
        ...
        "oper_qualifier_reason": MoPropertyMeta("oper_qualifier_reason", "operQualifierReason", "string", VersionMeta.Version226a, MoPropertyMeta.READ_ONLY, None, None, None, """[ !#$%&\(\)\*\+,\-\./:;\?@\[\]_\{\|\}~a-zA-Z0-9]{0,256}""", [], []), 
        ...
        "presence": MoPropertyMeta("presence", "presence", "string", VersionMeta.Version226a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["empty", "equipped", "equipped-identity-unestablishable", "equipped-not-primary", "equipped-slave", "equipped-unsupported", "equipped-with-malformed-fru", "inaccessible", "mismatch", "mismatch-identity-unestablishable", "mismatch-slave", "missing", "missing-slave", "not-supported", "unauthorized", "unknown"], []), 
        "revision": MoPropertyMeta("revision", "revision", "string", VersionMeta.Version226a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        "rn": MoPropertyMeta("rn", "rn", "string", VersionMeta.Version226a, MoPropertyMeta.READ_ONLY, 0x8L, 0, 256, None, [], []), 
        ...
        "status": MoPropertyMeta("status", "status", "string", VersionMeta.Version226a, MoPropertyMeta.READ_WRITE, 0x10L, None, None, """((removed|created|modified|deleted),){0,3}(removed|created|modified|deleted){0,1}""", [], []), 
