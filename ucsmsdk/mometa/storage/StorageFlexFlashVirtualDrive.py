...
class StorageFlexFlashVirtualDrive(ManagedObject):
    ...
    mo_meta = MoMeta("StorageFlexFlashVirtualDrive", "storageFlexFlashVirtualDrive", "vd-[id]", VersionMeta.Version221b, "InputOutput", 0x7fL, [], ["read-only"], [u'storageFlexFlashController'], [u'faultInst'], ["Get"])
    ...
    prop_meta = {
        ...
        "id": MoPropertyMeta("id", "id", "string", VersionMeta.Version221b, MoPropertyMeta.NAMING, 0x8L, None, None, None, ["unspecified"], ["0-4294967295"]), 
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version221b, MoPropertyMeta.READ_WRITE, 0x40L, None, None, None, ["mirror", "mirror-stripe", "raid", "simple", "stripe", "stripe-dual-parity", "stripe-dual-parity-stripe", "stripe-parity", "stripe-parity-stripe", "unspecified"], []), 
