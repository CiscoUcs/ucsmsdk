...
class StorageNvmeStorage(ManagedObject):
    ...
    mo_meta = MoMeta("StorageNvmeStorage", "storageNvmeStorage", "nvme-storage", None, "InputOutput", 0x1f, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-storage"], [u'storageController'], [], [None])
    ...
    prop_meta = {
        ...
        "performance_level": MoPropertyMeta("performance_level", "performanceLevel", "uint", None, MoPropertyMeta.READ_ONLY, None, None, None, None, [], ["0-100"]), 
