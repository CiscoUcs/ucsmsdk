...
class StoragePartitionFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("StoragePartitionFsmTask", "storagePartitionFsmTask", "task-[item]", VersionMeta.Version302c, "OutputOnly", 0xfL, [], [""], [u'storagePartition'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version302c, MoPropertyMeta.NAMING, None, None, None, None, ["DeployStorage", "ScrubRAIDGroup", "nop"], []), 
