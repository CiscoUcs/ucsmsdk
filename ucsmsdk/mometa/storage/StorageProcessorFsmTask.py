...
class StorageProcessorFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("StorageProcessorFsmTask", "storageProcessorFsmTask", "task-[item]", VersionMeta.Version302a, "OutputOnly", 0x7L, [], [""], [u'storageProcessor'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version302a, MoPropertyMeta.NAMING, None, None, None, None, ["DeploySystem", "DiscoverSystem", "EnterMaintenance", "ExitMaintenance", "HaTakeOver", "UndeploySystem", "nop"], []), 
