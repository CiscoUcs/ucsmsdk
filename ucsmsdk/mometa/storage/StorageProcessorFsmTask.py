"""This module contains the general information for StorageProcessorFsmTask ManagedObject."""
import sys, os
...
class StorageProcessorFsmTaskConsts():
    COMPLETION_CANCELLED = "cancelled"
    COMPLETION_COMPLETED = "completed"
    COMPLETION_PROCESSING = "processing"
    COMPLETION_SCHEDULED = "scheduled"
    ITEM_DEPLOY_SYSTEM = "DeploySystem"
    ITEM_DISCOVER_SYSTEM = "DiscoverSystem"
    ITEM_ENTER_MAINTENANCE = "EnterMaintenance"
    ITEM_EXIT_MAINTENANCE = "ExitMaintenance"
    ITEM_HA_TAKE_OVER = "HaTakeOver"
    ITEM_UNDEPLOY_SYSTEM = "UndeploySystem"
    ITEM_NOP = "nop"


class StorageProcessorFsmTask(ManagedObject):
    """This is StorageProcessorFsmTask class."""

    consts = StorageProcessorFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("StorageProcessorFsmTask", "storageProcessorFsmTask", "task-[item]", VersionMeta.Version302c, "OutputOnly", 0xfL, [], [""], [u'storageProcessor'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version302c, MoPropertyMeta.NAMING, None, None, None, None, ["DeploySystem", "DiscoverSystem", "EnterMaintenance", "ExitMaintenance", "HaTakeOver", "UndeploySystem", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "StorageProcessorFsmTask", parent_mo_or_dn, **kwargs)
