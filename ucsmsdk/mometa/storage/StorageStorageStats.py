...
class StorageStorageStats(ManagedObject):
    ...
    mo_meta = MoMeta("StorageStorageStats", "storageStorageStats", "storage-stats", VersionMeta.Version302c, "OutputOnly", 0xfL, [], ["admin", "operations", "read-only"], [], [u'storageStorageStatsHist'], [None])
