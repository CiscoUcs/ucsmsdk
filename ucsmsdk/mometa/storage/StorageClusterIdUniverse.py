"""This module contains the general information for StorageClusterIdUniverse ManagedObject."""
import sys, os
...
class StorageClusterIdUniverseConsts():
    pass


class StorageClusterIdUniverse(ManagedObject):
    """This is StorageClusterIdUniverse class."""

    consts = StorageClusterIdUniverseConsts()
    naming_props = set([])

    mo_meta = MoMeta("StorageClusterIdUniverse", "storageClusterIdUniverse", "cluster-id-universe", VersionMeta.Version302c, "InputOutput", 0x1fL, [], ["read-only"], [u'storageCloud'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "StorageClusterIdUniverse", parent_mo_or_dn, **kwargs)
