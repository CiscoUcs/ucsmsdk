...
class StorageClusterIdUniverse(ManagedObject):
    ...
    mo_meta = MoMeta("StorageClusterIdUniverse", "storageClusterIdUniverse", "cluster-id-universe", VersionMeta.Version302a, "InputOutput", 0xfL, [], ["read-only"], [u'storageCloud'], [], [None])
