...
class StorageLunResourceSelectionLog(ManagedObject):
    ...
    mo_meta = MoMeta("StorageLunResourceSelectionLog", "storageLunResourceSelectionLog", "selection-log-[order]", VersionMeta.Version224a, "InputOutput", 0x1fL, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-storage"], [u'storageVirtualDriveRef'], [], [None])
    ...
    prop_meta = {
        ...
        "order": MoPropertyMeta("order", "order", "ushort", VersionMeta.Version224a, MoPropertyMeta.NAMING, 0x4L, None, None, None, [], []), 
        "result": MoPropertyMeta("result", "result", "string", VersionMeta.Version224a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["failed", "succeeded", "unspecified"], []), 
        ...
        "time_stamp": MoPropertyMeta("time_stamp", "timeStamp", "string", VersionMeta.Version224a, MoPropertyMeta.READ_ONLY, None, None, None, """([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", [], []), 
    }
