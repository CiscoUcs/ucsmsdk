...
class StorageEnclosureFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("StorageEnclosureFsmStage", "storageEnclosureFsmStage", "stage-[name]", VersionMeta.Version911z, "OutputOnly", 0xf, [], [""], [u'storageEnclosureFsm'], [], [None])
