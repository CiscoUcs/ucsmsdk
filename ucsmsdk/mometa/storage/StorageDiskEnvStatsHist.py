...
class StorageDiskEnvStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("StorageDiskEnvStatsHist", "storageDiskEnvStatsHist", "[id]", VersionMeta.Version302a, "OutputOnly", 0x7L, [], ["read-only"], [u'storageDiskEnvStats'], [], [None])
    ...
    prop_meta = {
        ...
        "wear_percentage": MoPropertyMeta("wear_percentage", "wearPercentage", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["unknown"], ["0-100"]), 
        "wear_percentage_avg": MoPropertyMeta("wear_percentage_avg", "wearPercentageAvg", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["unknown"], ["0-100"]), 
        "wear_percentage_max": MoPropertyMeta("wear_percentage_max", "wearPercentageMax", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["unknown"], ["0-100"]), 
        "wear_percentage_min": MoPropertyMeta("wear_percentage_min", "wearPercentageMin", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["unknown"], ["0-100"]), 
    }
