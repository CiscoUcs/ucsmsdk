...
class StorageFlexFlashControllerFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("StorageFlexFlashControllerFsmStage", "storageFlexFlashControllerFsmStage", "stage-[name]", VersionMeta.Version223a, "OutputOnly", 0xfL, [], [""], [u'storageFlexFlashControllerFsm'], [], [None])
