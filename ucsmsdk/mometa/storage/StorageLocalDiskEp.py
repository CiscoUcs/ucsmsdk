...
class StorageLocalDiskEp(ManagedObject):
    ...
    mo_meta = MoMeta("StorageLocalDiskEp", "storageLocalDiskEp", "disk-ep-[enc_id]-id-[id]", VersionMeta.Version302a, "InputOutput", 0x3fL, [], ["read-only"], [u'storageController'], [], [None])
    ...
    prop_meta = {
        ...
        "enc_id": MoPropertyMeta("enc_id", "encId", "uint", VersionMeta.Version302a, MoPropertyMeta.NAMING, 0x4L, None, None, None, [], []), 
        "id": MoPropertyMeta("id", "id", "uint", VersionMeta.Version302a, MoPropertyMeta.NAMING, 0x8L, None, None, None, [], []), 
