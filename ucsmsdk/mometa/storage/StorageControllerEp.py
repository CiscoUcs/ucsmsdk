...
class StorageControllerEp(ManagedObject):
    ...
    mo_meta = MoMeta("StorageControllerEp", "storageControllerEp", "controller-ep-[id]", VersionMeta.Version911z, "InputOutput", 0x3f, [], ["read-only"], [u'storageLocalDisk', u'storageVirtualDrive'], [], [None])
    ...
    prop_meta = {
        ...
        "controller_dn": MoPropertyMeta("controller_dn", "controllerDn", "string", VersionMeta.Version911z, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        "dn": MoPropertyMeta("dn", "dn", "string", VersionMeta.Version911z, MoPropertyMeta.READ_ONLY, 0x4, 0, 256, None, [], []), 
        "id": MoPropertyMeta("id", "id", "string", VersionMeta.Version911z, MoPropertyMeta.NAMING, 0x8, None, None, None, ["unspecified"], ["0-4294967295"]), 
