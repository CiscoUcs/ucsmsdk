"""This module contains the general information for StorageSsdHealthStatsHist ManagedObject."""
...
class StorageSsdHealthStatsHistConsts:
...
class StorageSsdHealthStatsHist(ManagedObject):
    ...
    prop_meta = {
        ...
        "id": MoPropertyMeta("id", "id", "ulong", VersionMeta.Version321d, MoPropertyMeta.NAMING, None, None, None, None, [], []),
        "most_recent": MoPropertyMeta("most_recent", "mostRecent", "string", VersionMeta.Version321d, MoPropertyMeta.READ_ONLY, None, None, None, None, ["false", "no", "true", "yes"], []),
    ...
    def __init__(self, parent_mo_or_dn, id, **kwargs):
        ...
        ManagedObject.__init__(self, "StorageSsdHealthStatsHist", parent_mo_or_dn, **kwargs)
