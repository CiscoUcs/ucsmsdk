...
class StorageEnclosureFsm(ManagedObject):
    ...
    mo_meta = MoMeta("StorageEnclosureFsm", "storageEnclosureFsm", "fsm", VersionMeta.Version312b, "OutputOnly", 0xf, [], [""], [u'storageEnclosure'], [u'storageEnclosureFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version312b, MoPropertyMeta.READ_ONLY, None, None, None, None, ["RemoveEnclosure", "nop"], []), 
