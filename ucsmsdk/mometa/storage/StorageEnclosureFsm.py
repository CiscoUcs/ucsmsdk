...
class StorageEnclosureFsmConsts:
    COMPLETION_TIME_ = ""
...
class StorageEnclosureFsm(ManagedObject):
    """This is StorageEnclosureFsm class."""

    consts = StorageEnclosureFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("StorageEnclosureFsm", "storageEnclosureFsm", "fsm", VersionMeta.Version911z, "OutputOnly", 0xf, [], [""], [u'storageEnclosure'], [u'storageEnclosureFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version911z, MoPropertyMeta.READ_ONLY, None, None, None, None, ["RemoveEnclosure", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "StorageEnclosureFsm", parent_mo_or_dn, **kwargs)
