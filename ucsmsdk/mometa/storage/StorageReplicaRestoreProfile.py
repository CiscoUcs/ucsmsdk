...
class StorageReplicaRestoreProfile(ManagedObject):
    ...
    mo_meta = MoMeta("StorageReplicaRestoreProfile", "storageReplicaRestoreProfile", "repl-restore-profile", VersionMeta.Version302a, "InputOutput", 0x3fL, [], ["admin", "ls-storage", "ls-storage-policy"], [u'storageLunReplica', u'storageScsiLun'], [], [None])
    ...
    prop_meta = {
        ...
        "remote_addr": MoPropertyMeta("remote_addr", "remoteAddr", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x4L, None, None, """^[A-Za-z]([A-Za-z0-9-]*[A-Za-z0-9])?$|^[A-Za-z0-9]([A-Za-z0-9-]*[A-Za-z0-9])?(\.[A-Za-z0-9]([A-Za-z0-9-]*[A-Za-z0-9])?)*(\.[A-Za-z]([A-Za-z0-9-]*[A-Za-z0-9])?)$|^([1-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\.([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\.([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\.([1-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])$""", [], []), 
        "remote_path": MoPropertyMeta("remote_path", "remotePath", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x8L, 1, 32, None, [], []), 
