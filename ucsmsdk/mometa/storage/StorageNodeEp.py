...
class StorageNodeEp(ManagedObject):
    ...
    mo_meta = MoMeta("StorageNodeEp", "storageNodeEp", "node-[id]", VersionMeta.Version211a, "InputOutput", 0x3fL, [], ["read-only"], [u'initiatorGroupEp'], [u'storageIScsiTargetIf'], [None])
    ...
    prop_meta = {
        ...
        "id": MoPropertyMeta("id", "id", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, 0x8L, None, None, None, ["unspecified"], ["0-4294967295"]), 
