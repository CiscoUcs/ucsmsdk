...
class StoragePartition(ManagedObject):
    ...
    prop_meta = {
        ...
        "managing_dn": MoPropertyMeta("managing_dn", "managingDn", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
