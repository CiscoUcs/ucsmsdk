...
class StorageLocalDiskSlotEp(ManagedObject):
    ...
    mo_meta = MoMeta("StorageLocalDiskSlotEp", "storageLocalDiskSlotEp", "disk-[id]", VersionMeta.Version141i, "InputOutput", 0x1fL, [], ["read-only"], [u'computeBoard'], [u'faultInst'], ["Get"])
