...
class StorageLocalDiskSlotEp(ManagedObject):
    ...
    mo_meta = MoMeta("StorageLocalDiskSlotEp", "storageLocalDiskSlotEp", "disk-[id]", VersionMeta.Version141i, "InputOutput", 0x3fL, [], ["read-only"], [u'computeBoard'], [u'faultInst'], ["Get"])
    ...
    prop_meta = {
        ...
        "configuration": MoPropertyMeta("configuration", "configuration", "string", VersionMeta.Version141i, MoPropertyMeta.READ_ONLY, None, None, None, None, ["not-supported", "supported", "unknown"], []), 
