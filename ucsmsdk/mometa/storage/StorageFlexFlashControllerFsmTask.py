...
class StorageFlexFlashControllerFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("StorageFlexFlashControllerFsmTask", "storageFlexFlashControllerFsmTask", "task-[item]", VersionMeta.Version223a, "OutputOnly", 0xfL, [], [""], [u'storageFlexFlashController'], [], [None])
