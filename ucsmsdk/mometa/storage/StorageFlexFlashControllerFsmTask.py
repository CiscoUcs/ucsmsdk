...
class StorageFlexFlashControllerFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("StorageFlexFlashControllerFsmTask", "storageFlexFlashControllerFsmTask", "task-[item]", VersionMeta.Version223a, "OutputOnly", 0x7L, [], [""], [u'storageFlexFlashController'], [], [None])
    ...
    prop_meta = {
        ...
        "flags": MoPropertyMeta("flags", "flags", "string", VersionMeta.Version223a, MoPropertyMeta.READ_ONLY, None, None, None, """(defaultValue){0,1}""", [], []), 
