...
class StorageIpV4StaticAddr(ManagedObject):
    ...
    mo_meta = MoMeta("StorageIpV4StaticAddr", "storageIpV4StaticAddr", "storage-ipv4-addr", VersionMeta.Version302a, "InputOutput", 0x1ffL, [], ["admin", "ls-storage"], [u'adaptorHostIscsiIf', u'adaptorVlan', u'lsServer', u'lstorageProcessor', u'mgmtVnet', u'vnicIPv4If'], [], [None])
    ...
    prop_meta = {
        ...
        "def_gw": MoPropertyMeta("def_gw", "defGw", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x4L, 0, 256, """((([0-9]){1,3}\.){3}[0-9]{1,3})""", [], []), 
        ...
        "subnet": MoPropertyMeta("subnet", "subnet", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x100L, 0, 256, """((([0-9]){1,3}\.){3}[0-9]{1,3})""", [], []), 
    }
