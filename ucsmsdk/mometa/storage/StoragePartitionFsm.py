"""This module contains the general information for StoragePartitionFsm ManagedObject."""
import sys, os
...
class StoragePartitionFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_DEPLOY_STORAGE = "DeployStorage"
    CURRENT_FSM_SCRUB_RAIDGROUP = "ScrubRAIDGroup"
    CURRENT_FSM_NOP = "nop"
...
class StoragePartitionFsm(ManagedObject):
    """This is StoragePartitionFsm class."""

    consts = StoragePartitionFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("StoragePartitionFsm", "storagePartitionFsm", "fsm", VersionMeta.Version302a, "OutputOnly", 0x7L, [], [""], [u'storagePartition'], [u'storagePartitionFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["DeployStorage", "ScrubRAIDGroup", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "StoragePartitionFsm", parent_mo_or_dn, **kwargs)
