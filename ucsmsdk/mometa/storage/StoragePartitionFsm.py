...
class StoragePartitionFsm(ManagedObject):
    ...
    mo_meta = MoMeta("StoragePartitionFsm", "storagePartitionFsm", "fsm", VersionMeta.Version302c, "OutputOnly", 0xfL, [], [""], [u'storagePartition'], [u'storagePartitionFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version302c, MoPropertyMeta.READ_ONLY, None, None, None, None, ["DeployStorage", "ScrubRAIDGroup", "nop"], []), 
