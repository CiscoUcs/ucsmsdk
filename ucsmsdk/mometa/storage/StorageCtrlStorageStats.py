...
class StorageCtrlStorageStats(ManagedObject):
    ...
    mo_meta = MoMeta("StorageCtrlStorageStats", "storageCtrlStorageStats", "ctrl-storage-stats", VersionMeta.Version302a, "OutputOnly", 0x7L, [], ["admin", "operations", "read-only"], [], [u'storageCtrlStorageStatsHist'], [None])
