...
class StorageAuthKey(ManagedObject):
    ...
    mo_meta = MoMeta("StorageAuthKey", "storageAuthKey", "key-[type]", VersionMeta.Version211a, "InputOutput", 0x3ffL, [], ["admin"], [u'storageIScsiTargetIf'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.READ_WRITE, 0x8L, 0, 32, None, [], []), 
        "password": MoPropertyMeta("password", "password", "string", VersionMeta.Version211a, MoPropertyMeta.READ_WRITE, 0x10L, None, None, """[\-\.:_a-zA-Z0-9]{12,16}""", [], []), 
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, 0x100L, None, None, None, ["initiator", "target"], []), 
        "user_id": MoPropertyMeta("user_id", "userId", "string", VersionMeta.Version211a, MoPropertyMeta.READ_WRITE, 0x200L, 0, 128, None, [], []), 
    }
