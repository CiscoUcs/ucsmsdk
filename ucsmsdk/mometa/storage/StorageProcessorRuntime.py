...
class StorageProcessorRuntime(ManagedObject):
    ...
    mo_meta = MoMeta("StorageProcessorRuntime", "storageProcessorRuntime", "proc-runtime", VersionMeta.Version302a, "InputOutput", 0xfL, [], ["read-only"], [u'storageProcessor'], [], [None])
    ...
    prop_meta = {
        ...
        "unplanned_shutdown": MoPropertyMeta("unplanned_shutdown", "unplannedShutdown", "uint", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
    }
