...
class StorageBlade(ManagedObject):
    ...
    mo_meta = MoMeta("StorageBlade", "storageBlade", "storage-blade-[slot_id]", VersionMeta.Version302a, "InputOutput", 0xffL, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'equipmentChassis'], [u'computeBladeEp', u'powerBudget', u'storageEnclosure'], [None])
    ...
    prop_meta = {
        ...
        "availability": MoPropertyMeta("availability", "availability", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["available", "unavailable"], []), 
        ...
        "id": MoPropertyMeta("id", "id", "uint", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x4L, None, None, None, [], []), 
        "lc": MoPropertyMeta("lc", "lc", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x8L, None, None, None, ["decommission", "discovered", "migrate", "rediscover", "remove", "resetToFactory", "undiscovered", "upgrade-firmware"], []), 
        ...
        "shared_fw_managing_inst": MoPropertyMeta("shared_fw_managing_inst", "sharedFwManagingInst", "uint", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        "slot_id": MoPropertyMeta("slot_id", "slotId", "uint", VersionMeta.Version302a, MoPropertyMeta.NAMING, 0x20L, None, None, None, [], ["1-8"]), 
        ...
        "usr_lbl": MoPropertyMeta("usr_lbl", "usrLbl", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x80L, None, None, """[ !#$%&\(\)\*\+,\-\./:;\?@\[\]_\{\|\}~a-zA-Z0-9]{0,32}""", [], []), 
