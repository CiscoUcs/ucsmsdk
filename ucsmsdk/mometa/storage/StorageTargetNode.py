"""This module contains the general information for StorageTargetNode ManagedObject."""
import sys, os
...
class StorageTargetNodeConsts():
    pass


class StorageTargetNode(ManagedObject):
    """This is StorageTargetNode class."""

    consts = StorageTargetNodeConsts()
    naming_props = set([])

    mo_meta = MoMeta("StorageTargetNode", "storageTargetNode", "target-node", VersionMeta.Version302c, "InputOutput", 0x3fL, [], ["read-only"], [u'storageTargetIdentity'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version302c, MoPropertyMeta.READ_WRITE, 0x8L, 0, 510, None, [], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "StorageTargetNode", parent_mo_or_dn, **kwargs)
