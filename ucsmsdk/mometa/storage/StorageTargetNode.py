...
class StorageTargetNode(ManagedObject):
    ...
    mo_meta = MoMeta("StorageTargetNode", "storageTargetNode", "target-node", VersionMeta.Version302a, "InputOutput", 0x1fL, [], ["read-only"], [u'storageTargetIdentity'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x4L, 0, 510, None, [], []), 
