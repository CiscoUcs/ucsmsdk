...
class FaultInstConsts:
    ...
    RULE_ETHER_SERVER_INTFIO_INVALID_SFP = "ether-server-intfio-invalid-sfp"
...
class FaultInst(ManagedObject):
    ...
    prop_meta = {
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version111j, MoPropertyMeta.CREATE_ONLY, None, None, None, None, ["any", "chassis-profile", "configuration", "connectivity", "environmental", "equipment", "forward", "fsm", "generic", "management", "network", "operational", "security", "server", "sysdebug"], []),
    }
