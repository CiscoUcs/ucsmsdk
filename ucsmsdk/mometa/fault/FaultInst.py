...
class FaultInst(ManagedObject):
    ...
    prop_meta = {
        ...
        "last_transition": MoPropertyMeta("last_transition", "lastTransition", "string", VersionMeta.Version111j, MoPropertyMeta.READ_ONLY, None, None, None, """([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", [], []), 
        "lc": MoPropertyMeta("lc", "lc", "string", VersionMeta.Version111j, MoPropertyMeta.READ_ONLY, None, None, None, """((defaultValue|none|flapping|soaking-clear|soaking-raise|suppressed),){0,5}(defaultValue|none|flapping|soaking-clear|soaking-raise|suppressed){0,1}""", [], []), 
        ...
        "tags": MoPropertyMeta("tags", "tags", "string", VersionMeta.Version111j, MoPropertyMeta.CREATE_ONLY, None, None, None, """((defaultValue|generic|server|network|storage|pod|security|operations|fsmstagefail|fsmstageretry|fsmstageremoteinv),){0,10}(defaultValue|generic|server|network|storage|pod|security|operations|fsmstagefail|fsmstageretry|fsmstageremoteinv){0,1}""", [], []), 
