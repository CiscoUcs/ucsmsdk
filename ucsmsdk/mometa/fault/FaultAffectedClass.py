...
class FaultAffectedClass(ManagedObject):
    ...
    mo_meta = MoMeta("FaultAffectedClass", "faultAffectedClass", "fault-[mo_class_id]", VersionMeta.Version211a, "InputOutput", 0x1fL, [], ["admin", "fault"], [u'faultSuppressPolicy'], [], [None])
