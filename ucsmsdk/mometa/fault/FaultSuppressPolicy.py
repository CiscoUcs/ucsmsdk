...
class FaultSuppressPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("FaultSuppressPolicy", "faultSuppressPolicy", "fault-suppress-policy-[name]", VersionMeta.Version211a, "InputOutput", 0xffL, [], ["admin", "fault"], [u'faultHolder'], [u'faultAffectedClass', u'faultSuppressPolicyItem'], [None])
