...
class FaultSuppressTask(ManagedObject):
    ...
    prop_meta = {
        ...
        "suppress_policy_name": MoPropertyMeta("suppress_policy_name", "suppressPolicyName", "string", VersionMeta.Version211a, MoPropertyMeta.READ_WRITE, 0x400L, 0, 510, None, [], []), 
    }
