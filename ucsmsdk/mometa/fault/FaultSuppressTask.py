...
class FaultSuppressTask(ManagedObject):
    ...
    prop_meta = {
        ...
        "scheduler": MoPropertyMeta("scheduler", "scheduler", "string", VersionMeta.Version211a, MoPropertyMeta.READ_WRITE, 0x200L, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        ...
        "suppress_policy_name": MoPropertyMeta("suppress_policy_name", "suppressPolicyName", "string", VersionMeta.Version211a, MoPropertyMeta.READ_WRITE, 0x800L, 0, 510, None, [], []), 
    }
