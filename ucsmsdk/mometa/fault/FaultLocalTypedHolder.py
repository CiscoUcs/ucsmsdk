...
class FaultLocalTypedHolder(ManagedObject):
    ...
    mo_meta = MoMeta("FaultLocalTypedHolder", "faultLocalTypedHolder", "type-[type]", VersionMeta.Version211a, "InputOutput", 0x3fL, [], ["admin", "fault"], [u'faultHolder'], [], [None])
    ...
    prop_meta = {
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, 0x20L, None, None, None, ["any", "configuration", "connectivity", "environmental", "equipment", "forward", "fsm", "generic", "management", "network", "operational", "security", "server", "storage", "sysdebug"], []), 
    }
