"""This module contains the general information for CallhomeEpFsmTask ManagedObject."""
import sys, os
...
class CallhomeEpFsmTaskConsts():
    COMPLETION_CANCELLED = "cancelled"
    COMPLETION_COMPLETED = "completed"
    COMPLETION_PROCESSING = "processing"
    COMPLETION_SCHEDULED = "scheduled"
    ITEM_CONFIG_CALLHOME = "configCallhome"
    ITEM_NOP = "nop"


class CallhomeEpFsmTask(ManagedObject):
    """This is CallhomeEpFsmTask class."""

    consts = CallhomeEpFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("CallhomeEpFsmTask", "callhomeEpFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], [""], [u'callhomeEp'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, None, None, None, None, ["configCallhome", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "CallhomeEpFsmTask", parent_mo_or_dn, **kwargs)
