...
class CallhomeDest(ManagedObject):
    ...
    mo_meta = MoMeta("CallhomeDest", "callhomeDest", "email-[email]", VersionMeta.Version101e, "InputOutput", 0x1fL, [], ["admin", "operations"], [u'callhomeProfile'], [], ["Add", "Get", "Remove"])
    ...
    prop_meta = {
        ...
        "email": MoPropertyMeta("email", "email", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x4L, None, None, None, [], []), 
