...
class CallhomeSmtp(ManagedObject):
    ...
    mo_meta = MoMeta("CallhomeSmtp", "callhomeSmtp", "smtp", VersionMeta.Version101e, "InputOutput", 0x7f, [], ["admin", "operations"], [u'callhomeEp'], [], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "port": MoPropertyMeta("port", "port", "uint", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, [], ["1-65535"]), 
