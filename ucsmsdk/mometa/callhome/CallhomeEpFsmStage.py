"""This module contains the general information for CallhomeEpFsmStage ManagedObject."""
import sys, os
...
class CallhomeEpFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_CONFIG_CALLHOME_BEGIN = "configCallhomeBegin"
    NAME_CONFIG_CALLHOME_FAIL = "configCallhomeFail"
    NAME_CONFIG_CALLHOME_SET_LOCAL = "configCallhomeSetLocal"
    NAME_CONFIG_CALLHOME_SET_PEER = "configCallhomeSetPeer"
    NAME_CONFIG_CALLHOME_SUCCESS = "configCallhomeSuccess"
    NAME_NOP = "nop"
...
class CallhomeEpFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("CallhomeEpFsmStage", "callhomeEpFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'callhomeEpFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["configCallhomeBegin", "configCallhomeFail", "configCallhomeSetLocal", "configCallhomeSetPeer", "configCallhomeSuccess", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "CallhomeEpFsmStage", parent_mo_or_dn, **kwargs)
