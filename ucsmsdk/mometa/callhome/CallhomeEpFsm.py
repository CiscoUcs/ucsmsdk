...
class CallhomeEpFsm(ManagedObject):
    """This is CallhomeEpFsm class."""

    consts = CallhomeEpFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("CallhomeEpFsm", "callhomeEpFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'callhomeEp'], [u'callhomeEpFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["configCallhome", "nop"], []), 
