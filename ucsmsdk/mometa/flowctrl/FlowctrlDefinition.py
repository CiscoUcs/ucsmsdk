"""This module contains the general information for FlowctrlDefinition ManagedObject."""
import sys, os
...
class FlowctrlDefinitionConsts():
    INT_ID_NONE = "none"
...
class FlowctrlDefinition(ManagedObject):
    """This is FlowctrlDefinition class."""

    consts = FlowctrlDefinitionConsts()
    naming_props = set([])

    mo_meta = MoMeta("FlowctrlDefinition", "flowctrlDefinition", "flowctrl", VersionMeta.Version101e, "InputOutput", 0x3fL, [], ["admin", "ls-network", "ls-network-policy", "ls-qos-policy"], [u'fabricLanCloud'], [u'flowctrlItem'], ["Get", "Set"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FlowctrlDefinition", parent_mo_or_dn, **kwargs)
