"""This module contains the general information for PfcWatchDog ManagedObject."""
...
class PfcWatchDogConsts:
    FSM_PREV_CONFIG_PFC_WATCH_DOG_BEGIN = "configPfcWatchDogBegin"
    FSM_PREV_CONFIG_PFC_WATCH_DOG_FAIL = "configPfcWatchDogFail"
    FSM_PREV_CONFIG_PFC_WATCH_DOG_SET_LOCAL = "configPfcWatchDogSetLocal"
    FSM_PREV_CONFIG_PFC_WATCH_DOG_SET_PEER = "configPfcWatchDogSetPeer"
    FSM_PREV_CONFIG_PFC_WATCH_DOG_SUCCESS = "configPfcWatchDogSuccess"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_CONFIG_PFC_WATCH_DOG_BEGIN = "configPfcWatchDogBegin"
    FSM_STATUS_CONFIG_PFC_WATCH_DOG_FAIL = "configPfcWatchDogFail"
    FSM_STATUS_CONFIG_PFC_WATCH_DOG_SET_LOCAL = "configPfcWatchDogSetLocal"
    FSM_STATUS_CONFIG_PFC_WATCH_DOG_SET_PEER = "configPfcWatchDogSetPeer"
    FSM_STATUS_CONFIG_PFC_WATCH_DOG_SUCCESS = "configPfcWatchDogSuccess"
    FSM_STATUS_NOP = "nop"
    WD_ADMIN_STATE_OFF = "off"
    WD_ADMIN_STATE_ON = "on"


class PfcWatchDog(ManagedObject):
    """This is PfcWatchDog class."""

    consts = PfcWatchDogConsts()
    naming_props = set([])

    mo_meta = MoMeta("PfcWatchDog", "pfcWatchDog", "watch-dog", VersionMeta.Version413a, "InputOutput", 0xff, [], ["admin"], ['fabricLanCloud'], ['eventInst', 'faultInst', 'pfcWatchDogFsm', 'pfcWatchDogFsmTask'], [None])
    ...
    prop_meta = {
        ...
        "fsm_descr": MoPropertyMeta("fsm_descr", "fsmDescr", "string", VersionMeta.Version413a, MoPropertyMeta.INTERNAL, None, None, None, None, [], []),
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version413a, MoPropertyMeta.INTERNAL, None, None, None, None, ["configPfcWatchDogBegin", "configPfcWatchDogFail", "configPfcWatchDogSetLocal", "configPfcWatchDogSetPeer", "configPfcWatchDogSuccess", "nop"], []),
        "fsm_progr": MoPropertyMeta("fsm_progr", "fsmProgr", "byte", VersionMeta.Version413a, MoPropertyMeta.INTERNAL, None, None, None, None, [], ["0-100"]),
        ...
        "fsm_rmt_inv_err_descr": MoPropertyMeta("fsm_rmt_inv_err_descr", "fsmRmtInvErrDescr", "string", VersionMeta.Version413a, MoPropertyMeta.INTERNAL, None, 0, 510, None, [], []),
        "fsm_rmt_inv_rslt": MoPropertyMeta("fsm_rmt_inv_rslt", "fsmRmtInvRslt", "string", VersionMeta.Version413a, MoPropertyMeta.INTERNAL, None, None, None, r"""((defaultValue|not-applicable|resource-unavailable|service-unavailable|intermittent-error|sw-defect|service-not-implemented-ignore|extend-timeout|capability-not-implemented-failure|illegal-fru|end-point-unavailable|failure|resource-capacity-exceeded|service-protocol-error|fw-defect|service-not-implemented-fail|task-reset|unidentified-fail|capability-not-supported|end-point-failed|fru-state-indeterminate|resource-dependency|fru-identity-indeterminate|internal-error|hw-defect|service-not-supported|fru-not-supported|end-point-protocol-error|capability-unavailable|fru-not-ready|capability-not-implemented-ignore|fru-info-malformed|timeout),){0,32}(defaultValue|not-applicable|resource-unavailable|service-unavailable|intermittent-error|sw-defect|service-not-implemented-ignore|extend-timeout|capability-not-implemented-failure|illegal-fru|end-point-unavailable|failure|resource-capacity-exceeded|service-protocol-error|fw-defect|service-not-implemented-fail|task-reset|unidentified-fail|capability-not-supported|end-point-failed|fru-state-indeterminate|resource-dependency|fru-identity-indeterminate|internal-error|hw-defect|service-not-supported|fru-not-supported|end-point-protocol-error|capability-unavailable|fru-not-ready|capability-not-implemented-ignore|fru-info-malformed|timeout){0,1}""", [], []),
        "fsm_stage_descr": MoPropertyMeta("fsm_stage_descr", "fsmStageDescr", "string", VersionMeta.Version413a, MoPropertyMeta.INTERNAL, None, None, None, None, [], []),
        "fsm_stamp": MoPropertyMeta("fsm_stamp", "fsmStamp", "string", VersionMeta.Version413a, MoPropertyMeta.INTERNAL, None, None, None, r"""([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", ["never"], []),
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version413a, MoPropertyMeta.INTERNAL, None, None, None, None, ["configPfcWatchDogBegin", "configPfcWatchDogFail", "configPfcWatchDogSetLocal", "configPfcWatchDogSetPeer", "configPfcWatchDogSuccess", "nop"], []),
        "fsm_try": MoPropertyMeta("fsm_try", "fsmTry", "byte", VersionMeta.Version413a, MoPropertyMeta.INTERNAL, None, None, None, None, [], []),
        "rn": MoPropertyMeta("rn", "rn", "string", VersionMeta.Version413a, MoPropertyMeta.READ_ONLY, 0x8, 0, 256, None, [], []),
        ...
        "status": MoPropertyMeta("status", "status", "string", VersionMeta.Version413a, MoPropertyMeta.READ_WRITE, 0x10, None, None, r"""((removed|created|modified|deleted),){0,3}(removed|created|modified|deleted){0,1}""", [], []),
        "wd_admin_state": MoPropertyMeta("wd_admin_state", "wdAdminState", "string", VersionMeta.Version413a, MoPropertyMeta.READ_WRITE, 0x20, None, None, None, ["off", "on"], []),
        "wd_interval": MoPropertyMeta("wd_interval", "wdInterval", "uint", VersionMeta.Version413a, MoPropertyMeta.READ_WRITE, 0x40, None, None, None, [], ["100-1000"]),
        "wd_shutdown_multiplier": MoPropertyMeta("wd_shutdown_multiplier", "wdShutdownMultiplier", "uint", VersionMeta.Version413a, MoPropertyMeta.READ_WRITE, 0x80, None, None, None, [], ["1-10"]),
    }
    ...
    prop_map = {
        ...
        "sacl": "sacl", 
        "status": "status", 
        "wdAdminState": "wd_admin_state", 
        "wdInterval": "wd_interval", 
        "wdShutdownMultiplier": "wd_shutdown_multiplier", 
    }
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        self.sacl = None
        self.status = None
        self.wd_admin_state = None
        self.wd_interval = None
        self.wd_shutdown_multiplier = None

        ManagedObject.__init__(self, "PfcWatchDog", parent_mo_or_dn, **kwargs)
