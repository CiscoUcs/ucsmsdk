"""This module contains the general information for PfcWatchDogFsm ManagedObject."""
...
class PfcWatchDogFsmConsts:
    COMPLETION_TIME_ = ""
    CURRENT_FSM_CONFIG_PFC_WATCH_DOG = "configPfcWatchDog"
    CURRENT_FSM_NOP = "nop"
...
class PfcWatchDogFsm(ManagedObject):
    """This is PfcWatchDogFsm class."""

    consts = PfcWatchDogFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("PfcWatchDogFsm", "pfcWatchDogFsm", "fsm", VersionMeta.Version413a, "OutputOnly", 0xf, [], [""], ['pfcWatchDog'], ['pfcWatchDogFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "PfcWatchDogFsm", parent_mo_or_dn, **kwargs)
