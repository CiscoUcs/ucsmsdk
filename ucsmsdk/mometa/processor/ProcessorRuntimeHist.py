"""This module contains the general information for ProcessorRuntimeHist ManagedObject."""
import sys, os
...
class ProcessorRuntimeHistConsts():
...
class ProcessorRuntimeHist(ManagedObject):
    """This is ProcessorRuntimeHist class."""

    consts = ProcessorRuntimeHistConsts()
    naming_props = set([u'id'])

    mo_meta = MoMeta("ProcessorRuntimeHist", "processorRuntimeHist", "[id]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], ["read-only"], [u'processorRuntime'], [], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, id, **kwargs):
        ...
        ManagedObject.__init__(self, "ProcessorRuntimeHist", parent_mo_or_dn, **kwargs)
