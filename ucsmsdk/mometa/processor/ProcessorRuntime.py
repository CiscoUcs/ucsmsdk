...
class ProcessorRuntime(ManagedObject):
    ...
    mo_meta = MoMeta("ProcessorRuntime", "processorRuntime", "cpu-rt", VersionMeta.Version111j, "OutputOnly", 0x7L, [], ["admin", "operations", "read-only"], [u'computeBlade'], [u'processorRuntimeHist'], ["Get"])
    ...
    prop_meta = {
        ...
        "uptime": MoPropertyMeta("uptime", "uptime", "string", VersionMeta.Version111j, MoPropertyMeta.READ_ONLY, None, None, None, """(([1-9]*[0-9]{2}:)|)([0-1][0-9]||[2][0-3]):([0-5][0-9]):([0-5][0-9])||(([0-5][0-9]):|)([0-5][0-9])""", [], []), 
    }
