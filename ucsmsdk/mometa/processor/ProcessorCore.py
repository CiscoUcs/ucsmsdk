"""This module contains the general information for ProcessorCore ManagedObject."""
import sys, os
...
class ProcessorCoreConsts():
    pass


class ProcessorCore(ManagedObject):
    """This is ProcessorCore class."""

    consts = ProcessorCoreConsts()
    naming_props = set([u'id'])

    mo_meta = MoMeta("ProcessorCore", "processorCore", "core-[id]", VersionMeta.Version101e, "InputOutput", 0x3fL, [], ["read-only"], [u'processorUnit'], [u'processorThread'], [None])
    ...
    def __init__(self, parent_mo_or_dn, id, **kwargs):
        ...
        ManagedObject.__init__(self, "ProcessorCore", parent_mo_or_dn, **kwargs)
