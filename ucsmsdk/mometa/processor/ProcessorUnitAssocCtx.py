...
class ProcessorUnitAssocCtx(ManagedObject):
    ...
    mo_meta = MoMeta("ProcessorUnitAssocCtx", "processorUnitAssocCtx", "procunit-assoc-ctx", VersionMeta.Version141i, "InputOutput", 0xfL, [], ["read-only"], [u'lsServerAssocCtx'], [], ["Get"])
