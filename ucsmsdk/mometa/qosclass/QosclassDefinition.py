...
class QosclassDefinition(ManagedObject):
    ...
    prop_meta = {
        ...
        "mmu_percent": MoPropertyMeta("mmu_percent", "mmuPercent", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["not-applicable"], ["0-100"]), 
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version101e, MoPropertyMeta.READ_ONLY, None, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        "num_breakout_port": MoPropertyMeta("num_breakout_port", "numBreakoutPort", "ushort", None, MoPropertyMeta.READ_ONLY, None, None, None, None, [], ["0-48"]), 
