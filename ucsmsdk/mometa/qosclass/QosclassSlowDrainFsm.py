"""This module contains the general information for QosclassSlowDrainFsm ManagedObject."""
...
class QosclassSlowDrainFsmConsts:
    COMPLETION_TIME_ = ""
    CURRENT_FSM_CONFIG_QO_SSLOW_DRAIN = "configQoSSlowDrain"
    CURRENT_FSM_CONFIG_QO_SSLOW_DRAIN_FEX = "configQoSSlowDrainFex"
    CURRENT_FSM_NOP = "nop"
...
class QosclassSlowDrainFsm(ManagedObject):
    """This is QosclassSlowDrainFsm class."""

    consts = QosclassSlowDrainFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("QosclassSlowDrainFsm", "qosclassSlowDrainFsm", "fsm", VersionMeta.Version402a, "OutputOnly", 0xf, [], [""], [u'qosclassSlowDrain'], [u'qosclassSlowDrainFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "status": MoPropertyMeta("status", "status", "string", VersionMeta.Version402a, MoPropertyMeta.READ_WRITE, 0x8, None, None, r"""((removed|created|modified|deleted),){0,3}(removed|created|modified|deleted){0,1}""", [], []), 
    }
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "QosclassSlowDrainFsm", parent_mo_or_dn, **kwargs)
