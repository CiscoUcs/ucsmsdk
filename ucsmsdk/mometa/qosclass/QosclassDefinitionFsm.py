"""This module contains the general information for QosclassDefinitionFsm ManagedObject."""
import sys, os
...
class QosclassDefinitionFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_CONFIG_GLOBAL_QO_S = "configGlobalQoS"
    CURRENT_FSM_NOP = "nop"
...
class QosclassDefinitionFsm(ManagedObject):
    """This is QosclassDefinitionFsm class."""

    consts = QosclassDefinitionFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("QosclassDefinitionFsm", "qosclassDefinitionFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'qosclassDefinition'], [u'qosclassDefinitionFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["configGlobalQoS", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "QosclassDefinitionFsm", parent_mo_or_dn, **kwargs)
