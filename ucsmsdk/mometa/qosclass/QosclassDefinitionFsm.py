...
class QosclassDefinitionFsm(ManagedObject):
    ...
    mo_meta = MoMeta("QosclassDefinitionFsm", "qosclassDefinitionFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xf, [], [""], [u'qosclassDefinition'], [u'qosclassDefinitionFsmStage'], [None])
