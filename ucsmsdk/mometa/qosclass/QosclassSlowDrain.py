"""This module contains the general information for QosclassSlowDrain ManagedObject."""
...
class QosclassSlowDrainConsts:
    BACKPLANE_PORT_TIMER_1000 = "1000"
    BACKPLANE_PORT_TIMER_200 = "200"
    BACKPLANE_PORT_TIMER_300 = "300"
    BACKPLANE_PORT_TIMER_400 = "400"
    BACKPLANE_PORT_TIMER_500 = "500"
    BACKPLANE_PORT_TIMER_600 = "600"
    BACKPLANE_PORT_TIMER_700 = "700"
    BACKPLANE_PORT_TIMER_800 = "800"
    BACKPLANE_PORT_TIMER_900 = "900"
    CORE_PORT_TIMER_100 = "100"
    CORE_PORT_TIMER_1000 = "1000"
    CORE_PORT_TIMER_200 = "200"
    CORE_PORT_TIMER_300 = "300"
    CORE_PORT_TIMER_400 = "400"
    CORE_PORT_TIMER_500 = "500"
    CORE_PORT_TIMER_600 = "600"
    CORE_PORT_TIMER_700 = "700"
    CORE_PORT_TIMER_800 = "800"
    CORE_PORT_TIMER_900 = "900"
    EDGE_PORT_TIMER_100 = "100"
    EDGE_PORT_TIMER_1000 = "1000"
    EDGE_PORT_TIMER_200 = "200"
    EDGE_PORT_TIMER_300 = "300"
    EDGE_PORT_TIMER_400 = "400"
    EDGE_PORT_TIMER_500 = "500"
    EDGE_PORT_TIMER_600 = "600"
    EDGE_PORT_TIMER_700 = "700"
    EDGE_PORT_TIMER_800 = "800"
    EDGE_PORT_TIMER_900 = "900"
    ETH_ADMIN_STATE_DISABLED = "disabled"
    ETH_ADMIN_STATE_ENABLED = "enabled"
    FC_ADMIN_STATE_DISABLED = "disabled"
    FC_ADMIN_STATE_ENABLED = "enabled"
    FC_PORT_TIMER_100 = "100"
    FC_PORT_TIMER_1000 = "1000"
    FC_PORT_TIMER_200 = "200"
    FC_PORT_TIMER_300 = "300"
    FC_PORT_TIMER_400 = "400"
    FC_PORT_TIMER_500 = "500"
    FC_PORT_TIMER_600 = "600"
    FC_PORT_TIMER_700 = "700"
    FC_PORT_TIMER_800 = "800"
    FC_PORT_TIMER_900 = "900"
    FSM_PREV_CONFIG_QO_SSLOW_DRAIN_BEGIN = "configQoSSlowDrainBegin"
    FSM_PREV_CONFIG_QO_SSLOW_DRAIN_FAIL = "configQoSSlowDrainFail"
    FSM_PREV_CONFIG_QO_SSLOW_DRAIN_FEX_BEGIN = "configQoSSlowDrainFexBegin"
    FSM_PREV_CONFIG_QO_SSLOW_DRAIN_FEX_FAIL = "configQoSSlowDrainFexFail"
    FSM_PREV_CONFIG_QO_SSLOW_DRAIN_FEX_SET_LOCAL = "configQoSSlowDrainFexSetLocal"
    FSM_PREV_CONFIG_QO_SSLOW_DRAIN_FEX_SET_PEER = "configQoSSlowDrainFexSetPeer"
    FSM_PREV_CONFIG_QO_SSLOW_DRAIN_FEX_SUCCESS = "configQoSSlowDrainFexSuccess"
    FSM_PREV_CONFIG_QO_SSLOW_DRAIN_SET_LOCAL = "configQoSSlowDrainSetLocal"
    FSM_PREV_CONFIG_QO_SSLOW_DRAIN_SET_PEER = "configQoSSlowDrainSetPeer"
    FSM_PREV_CONFIG_QO_SSLOW_DRAIN_SUCCESS = "configQoSSlowDrainSuccess"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_CONFIG_QO_SSLOW_DRAIN_BEGIN = "configQoSSlowDrainBegin"
    FSM_STATUS_CONFIG_QO_SSLOW_DRAIN_FAIL = "configQoSSlowDrainFail"
    FSM_STATUS_CONFIG_QO_SSLOW_DRAIN_FEX_BEGIN = "configQoSSlowDrainFexBegin"
    FSM_STATUS_CONFIG_QO_SSLOW_DRAIN_FEX_FAIL = "configQoSSlowDrainFexFail"
    FSM_STATUS_CONFIG_QO_SSLOW_DRAIN_FEX_SET_LOCAL = "configQoSSlowDrainFexSetLocal"
    FSM_STATUS_CONFIG_QO_SSLOW_DRAIN_FEX_SET_PEER = "configQoSSlowDrainFexSetPeer"
    FSM_STATUS_CONFIG_QO_SSLOW_DRAIN_FEX_SUCCESS = "configQoSSlowDrainFexSuccess"
    FSM_STATUS_CONFIG_QO_SSLOW_DRAIN_SET_LOCAL = "configQoSSlowDrainSetLocal"
    FSM_STATUS_CONFIG_QO_SSLOW_DRAIN_SET_PEER = "configQoSSlowDrainSetPeer"
    FSM_STATUS_CONFIG_QO_SSLOW_DRAIN_SUCCESS = "configQoSSlowDrainSuccess"
    FSM_STATUS_NOP = "nop"


class QosclassSlowDrain(ManagedObject):
    """This is QosclassSlowDrain class."""
    ...
    prop_map = {
        "backplanePortTimer": "backplane_port_timer", 
        "childAction": "child_action", 
        "corePortTimer": "core_port_timer", 
        "dn": "dn", 
        "edgePortTimer": "edge_port_timer", 
        "ethAdminState": "eth_admin_state", 
        "fcAdminState": "fc_admin_state", 
        "fcPortTimer": "fc_port_timer", 
        "fsmDescr": "fsm_descr", 
        "fsmPrev": "fsm_prev", 
        "fsmProgr": "fsm_progr", 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        self._dirty_mask = 0
        self.backplane_port_timer = None
        self.child_action = None
        self.core_port_timer = None
        self.edge_port_timer = None
        self.eth_admin_state = None
        self.fc_admin_state = None
        self.fc_port_timer = None
        self.fsm_descr = None
        self.fsm_prev = None
        self.fsm_progr = None
        ...
        ManagedObject.__init__(self, "QosclassSlowDrain", parent_mo_or_dn, **kwargs)
