...
class QosclassDefinitionFsmStage(ManagedObject):
    """This is QosclassDefinitionFsmStage class."""

    consts = QosclassDefinitionFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("QosclassDefinitionFsmStage", "qosclassDefinitionFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'qosclassDefinitionFsm'], [], [None])
