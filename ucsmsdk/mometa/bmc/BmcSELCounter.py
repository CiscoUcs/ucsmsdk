...
class BmcSELCounter(ManagedObject):
    ...
    mo_meta = MoMeta("BmcSELCounter", "bmcSELCounter", "Counter-[local_id]", VersionMeta.Version111j, "InputOutput", 0x3fL, [], ["read-only"], [u'equipmentPOSTCodeReporter'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "local_id": MoPropertyMeta("local_id", "localId", "uint", VersionMeta.Version111j, MoPropertyMeta.NAMING, 0x8L, None, None, None, [], []), 
