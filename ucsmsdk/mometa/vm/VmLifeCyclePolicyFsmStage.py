...
class VmLifeCyclePolicyFsmStageConsts():
    ...
    NAME_CONFIG_LOCAL = "configLocal"
    NAME_CONFIG_PEER = "configPeer"
...
class VmLifeCyclePolicyFsmStage(ManagedObject):
    ...
    consts = VmLifeCyclePolicyFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("VmLifeCyclePolicyFsmStage", "vmLifeCyclePolicyFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'vmLifeCyclePolicyFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["configBegin", "configFail", "configLocal", "configPeer", "configSuccess", "nop"], []), 
