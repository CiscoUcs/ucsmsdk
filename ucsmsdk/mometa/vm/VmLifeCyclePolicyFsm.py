...
class VmLifeCyclePolicyFsm(ManagedObject):
    ...
    mo_meta = MoMeta("VmLifeCyclePolicyFsm", "vmLifeCyclePolicyFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xf, [], [""], [u'vmLifeCyclePolicy'], [u'vmLifeCyclePolicyFsmStage'], [None])
