...
class VmLifeCyclePolicyFsmConsts():
    COMPLETION_TIME_ = ""
...
class VmLifeCyclePolicyFsm(ManagedObject):
    ...
    consts = VmLifeCyclePolicyFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("VmLifeCyclePolicyFsm", "vmLifeCyclePolicyFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'vmLifeCyclePolicy'], [u'vmLifeCyclePolicyFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "VmLifeCyclePolicyFsm", parent_mo_or_dn, **kwargs)
