...
class VmVsan(ManagedObject):
    ...
    mo_meta = MoMeta("VmVsan", "vmVsan", "net-[name]", VersionMeta.Version101e, "InputOutput", 0x1ff, [], ["read-only"], [u'vmHba'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "id": MoPropertyMeta("id", "id", "uint", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x8, None, None, None, [], ["1-4093"]), 
