...
class VmVsan(ManagedObject):
    ...
    mo_meta = MoMeta("VmVsan", "vmVsan", "net-[name]", VersionMeta.Version101e, "InputOutput", 0xffL, [], ["read-only"], [u'vmHba'], [], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "VmVsan", parent_mo_or_dn, **kwargs)
