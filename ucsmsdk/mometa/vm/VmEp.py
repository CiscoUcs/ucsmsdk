...
class VmEp(ManagedObject):
    ...
    mo_meta = MoMeta("VmEp", "vmEp", "vmm", VersionMeta.Version101e, "InputOutput", 0x1fL, [], ["read-only"], [u'topRoot'], [u'vmComputeEp', u'vmHv', u'vmInstance'], ["Get"])
    ...
    def __init__(self, **kwargs):
        ...
        ManagedObject.__init__(self, "VmEp", **kwargs)
