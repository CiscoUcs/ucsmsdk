...
class VmVif(ManagedObject):
    ...
    mo_meta = MoMeta("VmVif", "vmVif", "sw-[ph_switch_id]vif-[vif_id]", VersionMeta.Version111j, "InputOutput", 0x7fL, [], ["admin"], [u'vmNic'], [u'faultInst'], ["Get"])
    ...
    prop_meta = {
        ...
        "ph_switch_id": MoPropertyMeta("ph_switch_id", "phSwitchId", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, 0x8L, None, None, None, ["A", "B", "NONE"], []), 
        "phs_access_aggr_port_id": MoPropertyMeta("phs_access_aggr_port_id", "phsAccessAggrPortId", "uint", VersionMeta.Version302c, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        ...
        "phs_border_aggr_port_id": MoPropertyMeta("phs_border_aggr_port_id", "phsBorderAggrPortId", "uint", VersionMeta.Version302c, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        ...
        "vif_id": MoPropertyMeta("vif_id", "vifId", "uint", VersionMeta.Version111j, MoPropertyMeta.NAMING, 0x40L, None, None, None, [], []), 
    }
