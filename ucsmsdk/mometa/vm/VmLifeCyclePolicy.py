...
class VmLifeCyclePolicy(ManagedObject):
    ...
    mo_meta = MoMeta("VmLifeCyclePolicy", "vmLifeCyclePolicy", "vm-lc-policy", VersionMeta.Version111j, "InputOutput", 0x3ff, [], ["admin", "pn-policy"], [u'orgOrg'], [u'eventInst', u'faultInst', u'vmLifeCyclePolicyFsm', u'vmLifeCyclePolicyFsmTask'], ["Get", "Set"])
