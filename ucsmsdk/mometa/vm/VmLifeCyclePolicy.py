...
class VmLifeCyclePolicy(ManagedObject):
    ...
    mo_meta = MoMeta("VmLifeCyclePolicy", "vmLifeCyclePolicy", "vm-lc-policy", VersionMeta.Version111j, "InputOutput", 0x3ffL, [], ["admin", "pn-policy"], [u'orgOrg'], [u'eventInst', u'faultInst', u'vmLifeCyclePolicyFsm', u'vmLifeCyclePolicyFsmTask'], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "vm_retention": MoPropertyMeta("vm_retention", "vmRetention", "string", VersionMeta.Version111j, MoPropertyMeta.READ_WRITE, 0x100L, None, None, None, ["1-day", "1-hour", "1-min"], ["1-7200"]), 
        "vnic_retention": MoPropertyMeta("vnic_retention", "vnicRetention", "string", VersionMeta.Version111j, MoPropertyMeta.READ_WRITE, 0x200L, None, None, None, ["1-day", "1-hour", "1-min"], ["1-7200"]), 
    }
