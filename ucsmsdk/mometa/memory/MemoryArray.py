...
class MemoryArray(ManagedObject):
    ...
    mo_meta = MoMeta("MemoryArray", "memoryArray", "memarray-[id]", VersionMeta.Version101e, "InputOutput", 0x1fL, [], ["read-only"], [u'computeBoard'], [u'faultInst', u'memoryArrayEnvStats', u'memoryNvDimmBattery', u'memoryNvDimmController', u'memoryUnit'], ["Get"])
