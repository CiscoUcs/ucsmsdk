...
class MemoryArray(ManagedObject):
    ...
    mo_meta = MoMeta("MemoryArray", "memoryArray", "memarray-[id]", VersionMeta.Version101e, "InputOutput", 0x3fL, [], ["read-only"], [u'computeBoard'], [u'faultInst', u'memoryArrayEnvStats', u'memoryNvDimmBattery', u'memoryNvDimmController', u'memoryUnit'], ["Get"])
    ...
    prop_meta = {
        ...
        "max_devices": MoPropertyMeta("max_devices", "maxDevices", "string", VersionMeta.Version101e, MoPropertyMeta.READ_ONLY, None, None, None, None, ["unspecified"], ["0-4294967295"]), 
        ...
        "populated": MoPropertyMeta("populated", "populated", "string", VersionMeta.Version101e, MoPropertyMeta.READ_ONLY, None, None, None, None, ["unspecified"], ["0-4294967295"]), 
