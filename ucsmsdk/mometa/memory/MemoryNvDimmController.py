...
class MemoryNvDimmController(ManagedObject):
    ...
    mo_meta = MoMeta("MemoryNvDimmController", "memoryNvDimmController", "mem-controller-[id]", VersionMeta.Version302c, "InputOutput", 0x3fL, [], ["read-only"], [u'memoryArray'], [u'faultInst', u'memoryNvDimm'], [None])

    prop_meta = {
        "backup_ability": MoPropertyMeta("backup_ability", "backupAbility", "string", VersionMeta.Version302c, MoPropertyMeta.READ_ONLY, None, None, None, None, ["not-ready", "ready", "unknown"], []), 
        "backup_status": MoPropertyMeta("backup_status", "backupStatus", "string", VersionMeta.Version302c, MoPropertyMeta.READ_ONLY, None, None, None, None, ["no-backup", "unknown", "valid"], []), 
        "backup_trigger_status": MoPropertyMeta("backup_trigger_status", "backupTriggerStatus", "string", VersionMeta.Version302c, MoPropertyMeta.READ_ONLY, None, None, None, None, ["disabled", "enabled", "unknown"], []), 
        ...
        "heartbeat_status": MoPropertyMeta("heartbeat_status", "heartbeatStatus", "string", VersionMeta.Version302c, MoPropertyMeta.READ_ONLY, None, None, None, None, ["disabled", "running", "timed-out", "unknown"], []), 
        ...
        "nv_dimm_health": MoPropertyMeta("nv_dimm_health", "nvDimmHealth", "string", VersionMeta.Version302c, MoPropertyMeta.READ_ONLY, None, None, None, None, ["battery-fault", "hardware-fault", "healthy", "not-present", "software-fault", "unknown"], []), 
        ...
        "operation_status": MoPropertyMeta("operation_status", "operationStatus", "string", VersionMeta.Version302c, MoPropertyMeta.READ_ONLY, None, None, None, None, ["backup", "backup-failed", "erase", "erase-failed", "idle", "restore", "restore-failed", "unknown"], []), 
