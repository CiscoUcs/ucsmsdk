...
class MemoryNvDimmControllerConsts():
    ...
    BACKUP_STATUS_NO_BACKUP = "no-backup"
    ...
    NV_DIMM_HEALTH_BATTERY_FAULT = "battery-fault"
...
class MemoryNvDimmController(ManagedObject):
    ...
    mo_meta = MoMeta("MemoryNvDimmController", "memoryNvDimmController", "mem-controller-[id]", VersionMeta.Version302a, "InputOutput", 0x1fL, [], ["read-only"], [u'memoryArray'], [u'faultInst', u'memoryNvDimm'], [None])

    prop_meta = {
        "backup_ability": MoPropertyMeta("backup_ability", "backupAbility", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["not-ready", "ready", "unknown"], []), 
        "backup_status": MoPropertyMeta("backup_status", "backupStatus", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["no-backup", "unknown", "valid"], []), 
        "backup_trigger_status": MoPropertyMeta("backup_trigger_status", "backupTriggerStatus", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["disabled", "enabled", "unknown"], []), 
        ...
        "heartbeat_status": MoPropertyMeta("heartbeat_status", "heartbeatStatus", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["disabled", "running", "timed-out", "unknown"], []), 
        "id": MoPropertyMeta("id", "id", "uint", VersionMeta.Version302a, MoPropertyMeta.NAMING, 0x4L, None, None, None, [], ["1-8"]), 
        "location_dn": MoPropertyMeta("location_dn", "locationDn", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        "model": MoPropertyMeta("model", "model", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        "nv_dimm_health": MoPropertyMeta("nv_dimm_health", "nvDimmHealth", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["battery-fault", "hardware-fault", "healthy", "not-present", "software-fault", "unknown"], []), 
        ...
        "operation_status": MoPropertyMeta("operation_status", "operationStatus", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["backup", "backup-failed", "erase", "erase-failed", "idle", "restore", "restore-failed", "unknown"], []), 
