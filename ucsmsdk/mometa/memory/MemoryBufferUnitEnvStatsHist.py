...
class MemoryBufferUnitEnvStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("MemoryBufferUnitEnvStatsHist", "memoryBufferUnitEnvStatsHist", "[id]", VersionMeta.Version131c, "OutputOnly", 0xfL, [], ["read-only"], [u'memoryBufferUnitEnvStats'], [], ["Get"])
