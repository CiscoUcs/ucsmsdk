...
class MemoryBufferUnitEnvStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("MemoryBufferUnitEnvStatsHist", "memoryBufferUnitEnvStatsHist", "[id]", VersionMeta.Version131c, "OutputOnly", 0x7L, [], ["read-only"], [u'memoryBufferUnitEnvStats'], [], ["Get"])
