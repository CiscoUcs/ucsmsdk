...
class MemoryNvDimmBattery(ManagedObject):
    ...
    mo_meta = MoMeta("MemoryNvDimmBattery", "memoryNvDimmBattery", "nvdimm-batt-[id]", VersionMeta.Version302a, "InputOutput", 0x1fL, [], ["read-only"], [u'memoryArray'], [u'faultInst', u'memoryNvDimmEnvStats'], [None])

    prop_meta = {
        "capacity": MoPropertyMeta("capacity", "capacity", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["identify", "insufficient-charge", "ready", "unknown"], []), 
