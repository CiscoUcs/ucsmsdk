...
class MemoryNvDimmEnvStats(ManagedObject):
    ...
    mo_meta = MoMeta("MemoryNvDimmEnvStats", "memoryNvDimmEnvStats", "nvdimm-env-stats", VersionMeta.Version302c, "OutputOnly", 0xfL, [], ["admin", "operations", "read-only"], [u'memoryNvDimmBattery'], [u'memoryNvDimmEnvStatsHist'], [None])
