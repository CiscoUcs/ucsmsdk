...
class MemoryNvDimm(ManagedObject):
    ...
    mo_meta = MoMeta("MemoryNvDimm", "memoryNvDimm", "nvdimm-[id]", VersionMeta.Version302c, "InputOutput", 0x3fL, [], ["read-only"], [u'memoryNvDimmController'], [], [None])
    ...
    prop_meta = {
        ...
        "health": MoPropertyMeta("health", "health", "string", VersionMeta.Version302c, MoPropertyMeta.READ_ONLY, None, None, None, None, ["battery-fault", "hardware-fault", "healthy", "not-present", "software-fault", "unknown"], []), 
        "id": MoPropertyMeta("id", "id", "uint", VersionMeta.Version302c, MoPropertyMeta.NAMING, 0x8L, None, None, None, [], ["1-16"]), 
