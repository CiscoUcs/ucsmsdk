...
class LicenseContents(ManagedObject):
    ...
    mo_meta = MoMeta("LicenseContents", "licenseContents", "contents-[feature_name]", VersionMeta.Version141i, "InputOutput", 0x3fL, [], ["read-only"], [u'licenseFile'], [u'licenseFeatureLine'], ["Get"])
