"""This module contains the general information for LicenseInstanceFsmStage ManagedObject."""
import sys, os
...
class LicenseInstanceFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_UPDATE_FLEXLM_BEGIN = "UpdateFlexlmBegin"
    NAME_UPDATE_FLEXLM_FAIL = "UpdateFlexlmFail"
    NAME_UPDATE_FLEXLM_LOCAL = "UpdateFlexlmLocal"
    NAME_UPDATE_FLEXLM_REMOTE = "UpdateFlexlmRemote"
    NAME_UPDATE_FLEXLM_SUCCESS = "UpdateFlexlmSuccess"
    NAME_NOP = "nop"
...
class LicenseInstanceFsmStage(ManagedObject):
    """This is LicenseInstanceFsmStage class."""

    consts = LicenseInstanceFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("LicenseInstanceFsmStage", "licenseInstanceFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'licenseInstanceFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["UpdateFlexlmBegin", "UpdateFlexlmFail", "UpdateFlexlmLocal", "UpdateFlexlmRemote", "UpdateFlexlmSuccess", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "LicenseInstanceFsmStage", parent_mo_or_dn, **kwargs)
