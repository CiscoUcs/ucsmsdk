...
class LicenseFileFsmStageConsts():
    ...
    NAME_CLEAR_LOCAL = "ClearLocal"
    NAME_CLEAR_REMOTE = "ClearRemote"
    NAME_CLEAR_SUCCESS = "ClearSuccess"
    NAME_INSTALL_BEGIN = "InstallBegin"
    NAME_INSTALL_FAIL = "InstallFail"
    NAME_INSTALL_LOCAL = "InstallLocal"
    NAME_INSTALL_REMOTE = "InstallRemote"
    NAME_INSTALL_SUCCESS = "InstallSuccess"
    NAME_NOP = "nop"
...
class LicenseFileFsmStage(ManagedObject):
    """This is LicenseFileFsmStage class."""

    consts = LicenseFileFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("LicenseFileFsmStage", "licenseFileFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'licenseFileFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["ClearBegin", "ClearFail", "ClearLocal", "ClearRemote", "ClearSuccess", "InstallBegin", "InstallFail", "InstallLocal", "InstallRemote", "InstallSuccess", "nop"], []), 
