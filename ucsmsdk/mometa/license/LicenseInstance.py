...
class LicenseInstanceConsts():
    FSM_PREV_UPDATE_FLEXLM_BEGIN = "UpdateFlexlmBegin"
    FSM_PREV_UPDATE_FLEXLM_FAIL = "UpdateFlexlmFail"
    FSM_PREV_UPDATE_FLEXLM_LOCAL = "UpdateFlexlmLocal"
    FSM_PREV_UPDATE_FLEXLM_REMOTE = "UpdateFlexlmRemote"
    FSM_PREV_UPDATE_FLEXLM_SUCCESS = "UpdateFlexlmSuccess"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_UPDATE_FLEXLM_BEGIN = "UpdateFlexlmBegin"
    FSM_STATUS_UPDATE_FLEXLM_FAIL = "UpdateFlexlmFail"
    FSM_STATUS_UPDATE_FLEXLM_LOCAL = "UpdateFlexlmLocal"
    FSM_STATUS_UPDATE_FLEXLM_REMOTE = "UpdateFlexlmRemote"
    FSM_STATUS_UPDATE_FLEXLM_SUCCESS = "UpdateFlexlmSuccess"
    FSM_STATUS_NOP = "nop"
    IS_PRESENT_FALSE = "false"
    IS_PRESENT_NO = "no"
    IS_PRESENT_TRUE = "true"
    IS_PRESENT_YES = "yes"
    OPER_STATE_LICENSE_EXPIRED = "license-expired"
    OPER_STATE_LICENSE_GRACEPERIOD = "license-graceperiod"
    OPER_STATE_LICENSE_INSUFFICIENT = "license-insufficient"
    OPER_STATE_LICENSE_OK = "license-ok"
    OPER_STATE_NOT_APPLICABLE = "not-applicable"
    OPER_STATE_UNKNOWN = "unknown"
    PEER_STATUS_EXCEEDS = "exceeds"
    PEER_STATUS_LACKS = "lacks"
    PEER_STATUS_MATCHING = "matching"
    PEER_STATUS_NO_PEER = "no-peer"
...
class LicenseInstance(ManagedObject):
    ...
    mo_meta = MoMeta("LicenseInstance", "licenseInstance", "inst-[scope]", VersionMeta.Version141i, "InputOutput", 0x1fL, [], ["admin"], [u'licenseFeature'], [u'eventInst', u'faultInst', u'licenseInstanceFsm', u'licenseInstanceFsmTask', u'licenseProp', u'licenseSourceFile', u'licenseTarget'], ["Get"])
    ...
    prop_meta = {
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version141i, MoPropertyMeta.INTERNAL, None, None, None, None, ["UpdateFlexlmBegin", "UpdateFlexlmFail", "UpdateFlexlmLocal", "UpdateFlexlmRemote", "UpdateFlexlmSuccess", "nop"], []), 
        "fsm_try": MoPropertyMeta("fsm_try", "fsmTry", "byte", VersionMeta.Version141i, MoPropertyMeta.INTERNAL, None, None, None, None, [], []), 
        "grace_period_used": MoPropertyMeta("grace_period_used", "gracePeriodUsed", "ulong", VersionMeta.Version141i, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        ...
        "scope": MoPropertyMeta("scope", "scope", "string", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x8L, None, None, None, ["A", "B", "server", "unknown"], []), 
    ...
    prop_map = {
        ...
        "sku": "sku", 
        "status": "status", 
        "subordinateUsedQuant": "subordinate_used_quant", 
        "usedQuant": "used_quant", 
    }
    ...
    def __init__(self, parent_mo_or_dn, scope, **kwargs):
        ...
        self.sku = None
        self.status = None
        self.subordinate_used_quant = None
        self.used_quant = None

        ManagedObject.__init__(self, "LicenseInstance", parent_mo_or_dn, **kwargs)
