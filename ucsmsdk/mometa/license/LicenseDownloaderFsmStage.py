...
class LicenseDownloaderFsmStageConsts():
    ...
    NAME_DOWNLOAD_DELETE_LOCAL = "DownloadDeleteLocal"
    NAME_DOWNLOAD_DELETE_REMOTE = "DownloadDeleteRemote"
    NAME_DOWNLOAD_FAIL = "DownloadFail"
    NAME_DOWNLOAD_LOCAL = "DownloadLocal"
    NAME_DOWNLOAD_SUCCESS = "DownloadSuccess"
    NAME_DOWNLOAD_VALIDATE_LOCAL = "DownloadValidateLocal"
    NAME_DOWNLOAD_VALIDATE_REMOTE = "DownloadValidateRemote"
    NAME_NOP = "nop"
...
class LicenseDownloaderFsmStage(ManagedObject):
    """This is LicenseDownloaderFsmStage class."""

    consts = LicenseDownloaderFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("LicenseDownloaderFsmStage", "licenseDownloaderFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'licenseDownloaderFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["DownloadBegin", "DownloadCopyRemote", "DownloadDeleteLocal", "DownloadDeleteRemote", "DownloadFail", "DownloadLocal", "DownloadSuccess", "DownloadValidateLocal", "DownloadValidateRemote", "nop"], []), 
