"""This module contains the general information for LicenseInstanceFsmTask ManagedObject."""
import sys, os
...
class LicenseInstanceFsmTaskConsts():
    COMPLETION_CANCELLED = "cancelled"
    COMPLETION_COMPLETED = "completed"
    COMPLETION_PROCESSING = "processing"
    COMPLETION_SCHEDULED = "scheduled"
    ITEM_UPDATE_FLEXLM = "UpdateFlexlm"
    ITEM_NOP = "nop"


class LicenseInstanceFsmTask(ManagedObject):
    """This is LicenseInstanceFsmTask class."""

    consts = LicenseInstanceFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("LicenseInstanceFsmTask", "licenseInstanceFsmTask", "task-[item]", VersionMeta.Version141i, "OutputOnly", 0xfL, [], [""], [u'licenseInstance'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version141i, MoPropertyMeta.NAMING, None, None, None, None, ["UpdateFlexlm", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "LicenseInstanceFsmTask", parent_mo_or_dn, **kwargs)
