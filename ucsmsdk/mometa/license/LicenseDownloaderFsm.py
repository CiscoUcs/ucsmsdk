...
class LicenseDownloaderFsm(ManagedObject):
    ...
    mo_meta = MoMeta("LicenseDownloaderFsm", "licenseDownloaderFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xf, [], [""], [u'licenseDownloader'], [u'licenseDownloaderFsmStage'], [None])
