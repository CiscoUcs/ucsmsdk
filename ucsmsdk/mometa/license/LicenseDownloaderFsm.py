"""This module contains the general information for LicenseDownloaderFsm ManagedObject."""
import sys, os
...
class LicenseDownloaderFsmConsts():
    COMPLETION_TIME_ = ""
...
class LicenseDownloaderFsm(ManagedObject):
    """This is LicenseDownloaderFsm class."""

    consts = LicenseDownloaderFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("LicenseDownloaderFsm", "licenseDownloaderFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'licenseDownloader'], [u'licenseDownloaderFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "LicenseDownloaderFsm", parent_mo_or_dn, **kwargs)
