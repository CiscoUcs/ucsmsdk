...
class LicenseDownloaderConsts():
    ...
    FSM_PREV_DOWNLOAD_DELETE_REMOTE = "DownloadDeleteRemote"
    ...
    FSM_PREV_DOWNLOAD_VALIDATE_REMOTE = "DownloadValidateRemote"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_DOWNLOAD_DELETE_REMOTE = "DownloadDeleteRemote"
    ...
    FSM_STATUS_DOWNLOAD_VALIDATE_REMOTE = "DownloadValidateRemote"
    FSM_STATUS_NOP = "nop"
    PROT_FTP = "ftp"
    PROT_LOCAL = "local"
    PROT_SCP = "scp"
...
class LicenseDownloader(ManagedObject):
    ...
    mo_meta = MoMeta("LicenseDownloader", "licenseDownloader", "dnld-[file_name]", VersionMeta.Version141i, "InputOutput", 0x7ffL, [], ["admin"], [u'licenseEp'], [u'eventInst', u'faultInst', u'licenseDownloaderFsm', u'licenseDownloaderFsmTask', u'licenseProp'], ["Get"])

    prop_meta = {
        "admin_state": MoPropertyMeta("admin_state", "adminState", "string", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x1L, None, None, None, ["idle", "restart"], []), 
        ...
        "file_name": MoPropertyMeta("file_name", "fileName", "string", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x8L, 1, 64, None, [], []), 
        ...
        "prot": MoPropertyMeta("prot", "prot", "string", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x10L, None, None, None, ["ftp", "local", "scp", "sftp", "tftp"], []), 
        "pwd": MoPropertyMeta("pwd", "pwd", "string", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x20L, None, None, None, [], []), 
        "remote_path": MoPropertyMeta("remote_path", "remotePath", "string", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x40L, None, None, None, [], []), 
        ...
        "server": MoPropertyMeta("server", "server", "string", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x100L, 1, 64, None, [], []), 
        ...
        "user": MoPropertyMeta("user", "user", "string", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x400L, 0, 510, None, [], []), 
    }
