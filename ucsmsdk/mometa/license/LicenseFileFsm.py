...
class LicenseFileFsm(ManagedObject):
    """This is LicenseFileFsm class."""

    consts = LicenseFileFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("LicenseFileFsm", "licenseFileFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'licenseFile'], [u'licenseFileFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Clear", "Install", "nop"], []), 
