"""This module contains the general information for LicenseInstanceFsm ManagedObject."""
import sys, os
...
class LicenseInstanceFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_UPDATE_FLEXLM = "UpdateFlexlm"
    CURRENT_FSM_NOP = "nop"
...
class LicenseInstanceFsm(ManagedObject):
    """This is LicenseInstanceFsm class."""

    consts = LicenseInstanceFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("LicenseInstanceFsm", "licenseInstanceFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'licenseInstance'], [u'licenseInstanceFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["UpdateFlexlm", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "LicenseInstanceFsm", parent_mo_or_dn, **kwargs)
