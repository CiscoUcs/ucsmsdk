...
class LicenseFeature(ManagedObject):
    ...
    mo_meta = MoMeta("LicenseFeature", "licenseFeature", "feature-[name]-[vendor]-[version]", VersionMeta.Version141i, "InputOutput", 0x3ffL, [], ["admin"], [u'licenseEp'], [u'licenseInstance'], ["Get"])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x10L, None, None, r"""[\-\.:_a-zA-Z0-9]{1,64}""", [], []), 
        ...
        "vendor": MoPropertyMeta("vendor", "vendor", "string", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x100L, None, None, None, [], []), 
        "version": MoPropertyMeta("version", "version", "string", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x200L, 1, 510, None, [], []), 
    }
