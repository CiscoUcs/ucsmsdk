...
class LicenseFileConsts():
    ...
    FSM_PREV_CLEAR_REMOTE = "ClearRemote"
    ...
    FSM_PREV_INSTALL_REMOTE = "InstallRemote"
    ...
    FSM_STATUS_CLEAR_REMOTE = "ClearRemote"
    ...
    FSM_STATUS_INSTALL_REMOTE = "InstallRemote"
...
class LicenseFile(ManagedObject):
    ...
    mo_meta = MoMeta("LicenseFile", "licenseFile", "file-[scope]:[id]", VersionMeta.Version141i, "InputOutput", 0xffL, [], ["admin"], [u'licenseEp'], [u'eventInst', u'faultInst', u'licenseContents', u'licenseFileFsm', u'licenseFileFsmTask', u'licenseSource'], ["Get"])

    prop_meta = {
        "admin_state": MoPropertyMeta("admin_state", "adminState", "string", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x1L, None, None, None, ["delete-failed", "delete-pending", "deleted", "deleting", "install-failed", "install-pending", "installed", "installing", "stale", "unknown", "validated"], []), 
        ...
        "id": MoPropertyMeta("id", "id", "string", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x8L, 1, 32, None, [], []), 
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141i, MoPropertyMeta.CREATE_ONLY, 0x10L, None, None, """[\-\.:_a-zA-Z0-9]{1,64}""", [], []), 
        ...
        "scope": MoPropertyMeta("scope", "scope", "string", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x40L, None, None, None, ["A", "B", "server", "unknown"], []), 
