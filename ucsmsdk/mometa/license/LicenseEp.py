...
class LicenseEp(ManagedObject):
    ...
    mo_meta = MoMeta("LicenseEp", "licenseEp", "license", VersionMeta.Version141i, "InputOutput", 0x1f, [], ["admin"], ['topSystem'], ['licenseDownloader', 'licenseFeature', 'licenseFile', 'licenseServerHostId'], ["Get"])
