...
class LicenseEp(ManagedObject):
    ...
    mo_meta = MoMeta("LicenseEp", "licenseEp", "license", VersionMeta.Version141i, "InputOutput", 0xfL, [], ["admin"], [u'topSystem'], [u'licenseDownloader', u'licenseFeature', u'licenseFile', u'licenseServerHostId'], ["Get"])
