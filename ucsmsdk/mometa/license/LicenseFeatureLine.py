...
class LicenseFeatureLine(ManagedObject):
    ...
    mo_meta = MoMeta("LicenseFeatureLine", "licenseFeatureLine", "FeatureLine-[id]:[type]", VersionMeta.Version141i, "InputOutput", 0x7fL, [], ["read-only"], [u'licenseContents'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x40L, None, None, None, ["feature", "increment", "upgrade"], []), 
    }
