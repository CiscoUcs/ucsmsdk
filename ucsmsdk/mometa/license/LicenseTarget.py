...
class LicenseTarget(ManagedObject):
    ...
    mo_meta = MoMeta("LicenseTarget", "licenseTarget", "slot-[slot_id]port-[port_id]", VersionMeta.Version223a, "InputOutput", 0x3fL, [], ["admin"], [u'licenseInstance'], [], [None])
    ...
    prop_meta = {
        ...
        "port_id": MoPropertyMeta("port_id", "portId", "uint", VersionMeta.Version223a, MoPropertyMeta.NAMING, 0x4L, None, None, None, [], []), 
        ...
        "slot_id": MoPropertyMeta("slot_id", "slotId", "uint", VersionMeta.Version223a, MoPropertyMeta.NAMING, 0x10L, None, None, None, [], []), 
        "status": MoPropertyMeta("status", "status", "string", VersionMeta.Version223a, MoPropertyMeta.READ_WRITE, 0x20L, None, None, """((removed|created|modified|deleted),){0,3}(removed|created|modified|deleted){0,1}""", [], []), 
    }
