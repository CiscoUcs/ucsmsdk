"""This module contains the general information for CapabilityMgmtExtensionFsm ManagedObject."""
import sys, os
...
class CapabilityMgmtExtensionFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_ACTIVATE_MGMT_EXT = "ActivateMgmtExt"
    CURRENT_FSM_NOP = "nop"
...
class CapabilityMgmtExtensionFsm(ManagedObject):
    """This is CapabilityMgmtExtensionFsm class."""

    consts = CapabilityMgmtExtensionFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("CapabilityMgmtExtensionFsm", "capabilityMgmtExtensionFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'capabilityMgmtExtension'], [u'capabilityMgmtExtensionFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["ActivateMgmtExt", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "CapabilityMgmtExtensionFsm", parent_mo_or_dn, **kwargs)
