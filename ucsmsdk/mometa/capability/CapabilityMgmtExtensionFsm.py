...
class CapabilityMgmtExtensionFsm(ManagedObject):
    ...
    mo_meta = MoMeta("CapabilityMgmtExtensionFsm", "capabilityMgmtExtensionFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xf, [], [""], [u'capabilityMgmtExtension'], [u'capabilityMgmtExtensionFsmStage'], [None])
