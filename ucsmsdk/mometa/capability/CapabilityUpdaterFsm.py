...
class CapabilityUpdaterFsm(ManagedObject):
    ...
    mo_meta = MoMeta("CapabilityUpdaterFsm", "capabilityUpdaterFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'capabilityUpdater'], [u'capabilityUpdaterFsmStage'], [None])
