"""This module contains the general information for CapabilityUpdaterFsm ManagedObject."""
import sys, os
...
class CapabilityUpdaterFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_UPDATER = "Updater"
    CURRENT_FSM_NOP = "nop"
...
class CapabilityUpdaterFsm(ManagedObject):
    """This is CapabilityUpdaterFsm class."""

    consts = CapabilityUpdaterFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("CapabilityUpdaterFsm", "capabilityUpdaterFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'capabilityUpdater'], [u'capabilityUpdaterFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Updater", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "CapabilityUpdaterFsm", parent_mo_or_dn, **kwargs)
