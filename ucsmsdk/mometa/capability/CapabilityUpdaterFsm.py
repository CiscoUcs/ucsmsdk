...
class CapabilityUpdaterFsm(ManagedObject):
    ...
    mo_meta = MoMeta("CapabilityUpdaterFsm", "capabilityUpdaterFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xf, [], [""], [u'capabilityUpdater'], [u'capabilityUpdaterFsmStage'], [None])
