"""This module contains the general information for CapabilityMgmtExtensionFsmStage ManagedObject."""
import sys, os
...
class CapabilityMgmtExtensionFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_ACTIVATE_MGMT_EXT_APPLY_CATALOG = "ActivateMgmtExtApplyCatalog"
    NAME_ACTIVATE_MGMT_EXT_BEGIN = "ActivateMgmtExtBegin"
    NAME_ACTIVATE_MGMT_EXT_COPY_REMOTE = "ActivateMgmtExtCopyRemote"
    NAME_ACTIVATE_MGMT_EXT_EVALUATE_STATUS = "ActivateMgmtExtEvaluateStatus"
    NAME_ACTIVATE_MGMT_EXT_FAIL = "ActivateMgmtExtFail"
    NAME_ACTIVATE_MGMT_EXT_RESCAN_IMAGES = "ActivateMgmtExtRescanImages"
    NAME_ACTIVATE_MGMT_EXT_SUCCESS = "ActivateMgmtExtSuccess"
    NAME_ACTIVATE_MGMT_EXT_UNPACK_LOCAL = "ActivateMgmtExtUnpackLocal"
    NAME_NOP = "nop"
...
class CapabilityMgmtExtensionFsmStage(ManagedObject):
    """This is CapabilityMgmtExtensionFsmStage class."""

    consts = CapabilityMgmtExtensionFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("CapabilityMgmtExtensionFsmStage", "capabilityMgmtExtensionFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'capabilityMgmtExtensionFsm'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "CapabilityMgmtExtensionFsmStage", parent_mo_or_dn, **kwargs)
