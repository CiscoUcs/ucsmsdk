...
class CapabilityMgmtExtensionFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("CapabilityMgmtExtensionFsmStage", "capabilityMgmtExtensionFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'capabilityMgmtExtensionFsm'], [], [None])
