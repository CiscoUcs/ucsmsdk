...
class CapabilityMgmtExtensionFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("CapabilityMgmtExtensionFsmStage", "capabilityMgmtExtensionFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xf, [], [""], ['capabilityMgmtExtensionFsm'], [], [None])
