...
class CapabilityMgmtExtensionConsts():
    ...
    FSM_PREV_ACTIVATE_MGMT_EXT_EVALUATE_STATUS = "ActivateMgmtExtEvaluateStatus"
    FSM_PREV_ACTIVATE_MGMT_EXT_FAIL = "ActivateMgmtExtFail"
    FSM_PREV_ACTIVATE_MGMT_EXT_RESCAN_IMAGES = "ActivateMgmtExtRescanImages"
    FSM_PREV_ACTIVATE_MGMT_EXT_SUCCESS = "ActivateMgmtExtSuccess"
    FSM_PREV_ACTIVATE_MGMT_EXT_UNPACK_LOCAL = "ActivateMgmtExtUnpackLocal"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_ACTIVATE_MGMT_EXT_APPLY_CATALOG = "ActivateMgmtExtApplyCatalog"
    FSM_STATUS_ACTIVATE_MGMT_EXT_BEGIN = "ActivateMgmtExtBegin"
    FSM_STATUS_ACTIVATE_MGMT_EXT_COPY_REMOTE = "ActivateMgmtExtCopyRemote"
    FSM_STATUS_ACTIVATE_MGMT_EXT_EVALUATE_STATUS = "ActivateMgmtExtEvaluateStatus"
    FSM_STATUS_ACTIVATE_MGMT_EXT_FAIL = "ActivateMgmtExtFail"
    FSM_STATUS_ACTIVATE_MGMT_EXT_RESCAN_IMAGES = "ActivateMgmtExtRescanImages"
    FSM_STATUS_ACTIVATE_MGMT_EXT_SUCCESS = "ActivateMgmtExtSuccess"
    FSM_STATUS_ACTIVATE_MGMT_EXT_UNPACK_LOCAL = "ActivateMgmtExtUnpackLocal"
    FSM_STATUS_NOP = "nop"


class CapabilityMgmtExtension(ManagedObject):
    """This is CapabilityMgmtExtension class."""

    consts = CapabilityMgmtExtensionConsts()
    naming_props = set([])

    mo_meta = MoMeta("CapabilityMgmtExtension", "capabilityMgmtExtension", "mgmt-ext", VersionMeta.Version141i, "InputOutput", 0x1fL, [], ["read-only"], [u'capabilityEp'], [u'capabilityMgmtExtensionFsm', u'capabilityMgmtExtensionFsmTask', u'eventInst', u'faultInst', u'firmwareBootDefinition', u'firmwareRunning'], ["Get"])
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version141i, MoPropertyMeta.INTERNAL, None, None, None, None, ["ActivateMgmtExtApplyCatalog", "ActivateMgmtExtBegin", "ActivateMgmtExtCopyRemote", "ActivateMgmtExtEvaluateStatus", "ActivateMgmtExtFail", "ActivateMgmtExtRescanImages", "ActivateMgmtExtSuccess", "ActivateMgmtExtUnpackLocal", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version141i, MoPropertyMeta.INTERNAL, None, None, None, None, ["ActivateMgmtExtApplyCatalog", "ActivateMgmtExtBegin", "ActivateMgmtExtCopyRemote", "ActivateMgmtExtEvaluateStatus", "ActivateMgmtExtFail", "ActivateMgmtExtRescanImages", "ActivateMgmtExtSuccess", "ActivateMgmtExtUnpackLocal", "nop"], []), 
