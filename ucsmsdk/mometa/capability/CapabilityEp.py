"""This module contains the general information for CapabilityEp ManagedObject."""
import sys, os
...
class CapabilityEpConsts():
    pass


class CapabilityEp(ManagedObject):
    """This is CapabilityEp class."""

    consts = CapabilityEpConsts()
    naming_props = set([])

    mo_meta = MoMeta("CapabilityEp", "capabilityEp", "ep", VersionMeta.Version131c, "InputOutput", 0x1fL, [], ["read-only"], [u'capabilityCatalogue'], [u'capabilityMgmtExtension', u'capabilityUpdate', u'capabilityUpdater'], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "CapabilityEp", parent_mo_or_dn, **kwargs)
