"""This module contains the general information for CapabilityMgmtExtensionFsmTask ManagedObject."""
import sys, os
...
class CapabilityMgmtExtensionFsmTaskConsts():
    COMPLETION_CANCELLED = "cancelled"
    COMPLETION_COMPLETED = "completed"
    COMPLETION_PROCESSING = "processing"
    COMPLETION_SCHEDULED = "scheduled"
    ITEM_ACTIVATE_MGMT_EXT = "ActivateMgmtExt"
    ITEM_NOP = "nop"


class CapabilityMgmtExtensionFsmTask(ManagedObject):
    """This is CapabilityMgmtExtensionFsmTask class."""

    consts = CapabilityMgmtExtensionFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("CapabilityMgmtExtensionFsmTask", "capabilityMgmtExtensionFsmTask", "task-[item]", VersionMeta.Version141i, "OutputOnly", 0xfL, [], [""], [u'capabilityMgmtExtension'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version141i, MoPropertyMeta.NAMING, None, None, None, None, ["ActivateMgmtExt", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "CapabilityMgmtExtensionFsmTask", parent_mo_or_dn, **kwargs)
