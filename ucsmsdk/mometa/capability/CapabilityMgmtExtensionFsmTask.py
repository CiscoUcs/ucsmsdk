...
class CapabilityMgmtExtensionFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("CapabilityMgmtExtensionFsmTask", "capabilityMgmtExtensionFsmTask", "task-[item]", VersionMeta.Version141i, "OutputOnly", 0xf, [], [""], ['capabilityMgmtExtension'], [], [None])
