...
class CapabilityUpdater(ManagedObject):
    ...
    mo_meta = MoMeta("CapabilityUpdater", "capabilityUpdater", "updater-[file_name]", VersionMeta.Version131c, "InputOutput", 0x7ffL, [], ["admin"], [u'capabilityEp'], [u'capabilityUpdaterFsm', u'capabilityUpdaterFsmTask', u'eventInst', u'faultInst'], ["Get"])

    prop_meta = {
        "admin_state": MoPropertyMeta("admin_state", "adminState", "string", VersionMeta.Version131c, MoPropertyMeta.READ_WRITE, 0x1L, None, None, None, ["idle", "restart"], []), 
        ...
        "file_name": MoPropertyMeta("file_name", "fileName", "string", VersionMeta.Version131c, MoPropertyMeta.NAMING, 0x8L, 1, 64, None, [], []), 
        ...
        "protocol": MoPropertyMeta("protocol", "protocol", "string", VersionMeta.Version131c, MoPropertyMeta.READ_WRITE, 0x10L, None, None, None, ["ftp", "local", "scp", "sftp", "tftp", "usbA", "usbB"], []), 
        "pwd": MoPropertyMeta("pwd", "pwd", "string", VersionMeta.Version131c, MoPropertyMeta.READ_WRITE, 0x20L, None, None, None, [], []), 
        "remote_path": MoPropertyMeta("remote_path", "remotePath", "string", VersionMeta.Version131c, MoPropertyMeta.READ_WRITE, 0x40L, None, None, None, [], []), 
        ...
        "server": MoPropertyMeta("server", "server", "string", VersionMeta.Version131c, MoPropertyMeta.READ_WRITE, 0x100L, 1, 64, None, [], []), 
        "status": MoPropertyMeta("status", "status", "string", VersionMeta.Version131c, MoPropertyMeta.READ_WRITE, 0x200L, None, None, """((removed|created|modified|deleted),){0,3}(removed|created|modified|deleted){0,1}""", [], []), 
        "user": MoPropertyMeta("user", "user", "string", VersionMeta.Version131c, MoPropertyMeta.READ_WRITE, 0x400L, 0, 510, None, [], []), 
