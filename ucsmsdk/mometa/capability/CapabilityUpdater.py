...
class CapabilityUpdaterConsts():
    ...
    FSM_PREV_UPDATER_BEGIN = "UpdaterBegin"
    FSM_PREV_UPDATER_COPY_REMOTE = "UpdaterCopyRemote"
    FSM_PREV_UPDATER_DELETE_LOCAL = "UpdaterDeleteLocal"
    FSM_PREV_UPDATER_EVALUATE_STATUS = "UpdaterEvaluateStatus"
    FSM_PREV_UPDATER_FAIL = "UpdaterFail"
    FSM_PREV_UPDATER_LOCAL = "UpdaterLocal"
    FSM_PREV_UPDATER_RESCAN_IMAGES = "UpdaterRescanImages"
    FSM_PREV_UPDATER_SUCCESS = "UpdaterSuccess"
    FSM_PREV_UPDATER_UNPACK_LOCAL = "UpdaterUnpackLocal"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_UPDATER_APPLY = "UpdaterApply"
    FSM_STATUS_UPDATER_BEGIN = "UpdaterBegin"
    FSM_STATUS_UPDATER_COPY_REMOTE = "UpdaterCopyRemote"
    FSM_STATUS_UPDATER_DELETE_LOCAL = "UpdaterDeleteLocal"
    FSM_STATUS_UPDATER_EVALUATE_STATUS = "UpdaterEvaluateStatus"
    FSM_STATUS_UPDATER_FAIL = "UpdaterFail"
    FSM_STATUS_UPDATER_LOCAL = "UpdaterLocal"
    FSM_STATUS_UPDATER_RESCAN_IMAGES = "UpdaterRescanImages"
    FSM_STATUS_UPDATER_SUCCESS = "UpdaterSuccess"
    FSM_STATUS_UPDATER_UNPACK_LOCAL = "UpdaterUnpackLocal"
    FSM_STATUS_NOP = "nop"
    OPER_STATE_APPLIED = "applied"
    OPER_STATE_DOWNLOADED = "downloaded"
    OPER_STATE_DOWNLOADING = "downloading"
    OPER_STATE_FAILED = "failed"
    OPER_STATE_INIT = "init"
    PROTOCOL_FTP = "ftp"
...
class CapabilityUpdater(ManagedObject):
    ...
    mo_meta = MoMeta("CapabilityUpdater", "capabilityUpdater", "updater-[file_name]", VersionMeta.Version131c, "InputOutput", 0xfffL, [], ["admin"], [u'capabilityEp'], [u'capabilityUpdaterFsm', u'capabilityUpdaterFsmTask', u'eventInst', u'faultInst'], ["Get"])

    prop_meta = {
        "admin_state": MoPropertyMeta("admin_state", "adminState", "string", VersionMeta.Version131c, MoPropertyMeta.READ_WRITE, 0x2L, None, None, None, ["idle", "restart"], []), 
        ...
        "file_name": MoPropertyMeta("file_name", "fileName", "string", VersionMeta.Version131c, MoPropertyMeta.NAMING, 0x10L, 1, 64, None, [], []), 
        "fsm_descr": MoPropertyMeta("fsm_descr", "fsmDescr", "string", VersionMeta.Version131c, MoPropertyMeta.INTERNAL, None, None, None, None, [], []), 
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version131c, MoPropertyMeta.INTERNAL, None, None, None, None, ["UpdaterApply", "UpdaterBegin", "UpdaterCopyRemote", "UpdaterDeleteLocal", "UpdaterEvaluateStatus", "UpdaterFail", "UpdaterLocal", "UpdaterRescanImages", "UpdaterSuccess", "UpdaterUnpackLocal", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version131c, MoPropertyMeta.INTERNAL, None, None, None, None, ["UpdaterApply", "UpdaterBegin", "UpdaterCopyRemote", "UpdaterDeleteLocal", "UpdaterEvaluateStatus", "UpdaterFail", "UpdaterLocal", "UpdaterRescanImages", "UpdaterSuccess", "UpdaterUnpackLocal", "nop"], []), 
        ...
        "oper_state": MoPropertyMeta("oper_state", "operState", "string", VersionMeta.Version131c, MoPropertyMeta.READ_ONLY, None, None, None, None, ["applied", "downloaded", "downloading", "failed", "init"], []), 
        "protocol": MoPropertyMeta("protocol", "protocol", "string", VersionMeta.Version131c, MoPropertyMeta.READ_WRITE, 0x20L, None, None, None, ["ftp", "local", "scp", "sftp", "tftp", "usbA", "usbB"], []), 
        "pwd": MoPropertyMeta("pwd", "pwd", "string", VersionMeta.Version131c, MoPropertyMeta.READ_WRITE, 0x40L, None, None, None, [], []), 
        "remote_path": MoPropertyMeta("remote_path", "remotePath", "string", VersionMeta.Version131c, MoPropertyMeta.READ_WRITE, 0x80L, None, None, None, [], []), 
        ...
        "server": MoPropertyMeta("server", "server", "string", VersionMeta.Version131c, MoPropertyMeta.READ_WRITE, 0x200L, 1, 64, None, [], []), 
        "status": MoPropertyMeta("status", "status", "string", VersionMeta.Version131c, MoPropertyMeta.READ_WRITE, 0x400L, None, None, r"""((removed|created|modified|deleted),){0,3}(removed|created|modified|deleted){0,1}""", [], []), 
        "user": MoPropertyMeta("user", "user", "string", VersionMeta.Version131c, MoPropertyMeta.READ_WRITE, 0x800L, 0, 510, None, [], []), 
