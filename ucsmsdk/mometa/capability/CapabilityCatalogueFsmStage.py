...
class CapabilityCatalogueFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("CapabilityCatalogueFsmStage", "capabilityCatalogueFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'capabilityCatalogueFsm'], [], [None])
