"""This module contains the general information for CapabilityStorageLimits ManagedObject."""
import sys, os
...
class CapabilityStorageLimitsConsts():
    pass


class CapabilityStorageLimits(ManagedObject):
    """This is CapabilityStorageLimits class."""

    consts = CapabilityStorageLimitsConsts()
    naming_props = set([])

    mo_meta = MoMeta("CapabilityStorageLimits", "capabilityStorageLimits", "storage-limits", VersionMeta.Version211a, "InputOutput", 0x1fL, [], ["read-only"], [u'topSysDefaults'], [u'capabilityFeatureLimits'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "CapabilityStorageLimits", parent_mo_or_dn, **kwargs)
