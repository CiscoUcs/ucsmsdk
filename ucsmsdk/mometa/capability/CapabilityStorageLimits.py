...
class CapabilityStorageLimits(ManagedObject):
    ...
    mo_meta = MoMeta("CapabilityStorageLimits", "capabilityStorageLimits", "storage-limits", VersionMeta.Version211a, "InputOutput", 0xfL, [], ["read-only"], [u'topSysDefaults'], [u'capabilityFeatureLimits'], [None])
