...
class CapabilityUpdaterFsmStageConsts():
    ...
    NAME_UPDATER_COPY_REMOTE = "UpdaterCopyRemote"
    NAME_UPDATER_DELETE_LOCAL = "UpdaterDeleteLocal"
    NAME_UPDATER_EVALUATE_STATUS = "UpdaterEvaluateStatus"
    NAME_UPDATER_FAIL = "UpdaterFail"
    NAME_UPDATER_LOCAL = "UpdaterLocal"
    NAME_UPDATER_RESCAN_IMAGES = "UpdaterRescanImages"
    NAME_UPDATER_SUCCESS = "UpdaterSuccess"
    NAME_UPDATER_UNPACK_LOCAL = "UpdaterUnpackLocal"
    NAME_NOP = "nop"
...
class CapabilityUpdaterFsmStage(ManagedObject):
    """This is CapabilityUpdaterFsmStage class."""

    consts = CapabilityUpdaterFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("CapabilityUpdaterFsmStage", "capabilityUpdaterFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'capabilityUpdaterFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["UpdaterApply", "UpdaterBegin", "UpdaterCopyRemote", "UpdaterDeleteLocal", "UpdaterEvaluateStatus", "UpdaterFail", "UpdaterLocal", "UpdaterRescanImages", "UpdaterSuccess", "UpdaterUnpackLocal", "nop"], []), 
