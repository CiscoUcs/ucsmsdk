...
class CapabilityCatalogueFsm(ManagedObject):
    ...
    mo_meta = MoMeta("CapabilityCatalogueFsm", "capabilityCatalogueFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'capabilityCatalogue'], [u'capabilityCatalogueFsmStage'], [None])
