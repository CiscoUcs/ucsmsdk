"""This module contains the general information for CapabilityCatalogueFsm ManagedObject."""
import sys, os
...
class CapabilityCatalogueFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_ACTIVATE_CATALOG = "ActivateCatalog"
    CURRENT_FSM_DEPLOY_CATALOGUE = "DeployCatalogue"
    CURRENT_FSM_NOP = "nop"
...
class CapabilityCatalogueFsm(ManagedObject):
    """This is CapabilityCatalogueFsm class."""

    consts = CapabilityCatalogueFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("CapabilityCatalogueFsm", "capabilityCatalogueFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'capabilityCatalogue'], [u'capabilityCatalogueFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["ActivateCatalog", "DeployCatalogue", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "CapabilityCatalogueFsm", parent_mo_or_dn, **kwargs)
