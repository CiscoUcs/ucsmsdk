"""This module contains the general information for CapabilityNetworkLimits ManagedObject."""
import sys, os
...
class CapabilityNetworkLimitsConsts():
    pass
...
class CapabilityNetworkLimits(ManagedObject):
    ...
    consts = CapabilityNetworkLimitsConsts()
    naming_props = set([])

    mo_meta = MoMeta("CapabilityNetworkLimits", "capabilityNetworkLimits", "network-limits", VersionMeta.Version211a, "InputOutput", 0x1fL, [], ["read-only"], [u'topSysDefaults'], [u'capabilityFeatureLimits'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "CapabilityNetworkLimits", parent_mo_or_dn, **kwargs)
