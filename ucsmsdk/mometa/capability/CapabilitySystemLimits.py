"""This module contains the general information for CapabilitySystemLimits ManagedObject."""
import sys, os
...
class CapabilitySystemLimitsConsts():
    pass


class CapabilitySystemLimits(ManagedObject):
    """This is CapabilitySystemLimits class."""

    consts = CapabilitySystemLimitsConsts()
    naming_props = set([])

    mo_meta = MoMeta("CapabilitySystemLimits", "capabilitySystemLimits", "system-limits", VersionMeta.Version211a, "InputOutput", 0x1fL, [], ["read-only"], [u'topSysDefaults'], [u'capabilityFeatureLimits'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "CapabilitySystemLimits", parent_mo_or_dn, **kwargs)
