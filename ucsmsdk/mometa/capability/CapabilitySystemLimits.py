...
class CapabilitySystemLimits(ManagedObject):
    ...
    mo_meta = MoMeta("CapabilitySystemLimits", "capabilitySystemLimits", "system-limits", VersionMeta.Version211a, "InputOutput", 0xfL, [], ["read-only"], [u'topSysDefaults'], [u'capabilityFeatureLimits'], [None])
