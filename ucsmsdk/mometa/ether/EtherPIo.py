...
class EtherPIo(ManagedObject):
    ...
    prop_meta = {
        ...
        "non_c_r4": MoPropertyMeta("non_c_r4", "nonCR4", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["false", "no", "true", "yes"], []), 
