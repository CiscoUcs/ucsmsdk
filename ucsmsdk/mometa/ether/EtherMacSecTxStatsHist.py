"""This module contains the general information for EtherMacSecTxStatsHist ManagedObject."""
...
class EtherMacSecTxStatsHistConsts:
...
class EtherMacSecTxStatsHist(ManagedObject):
    """This is EtherMacSecTxStatsHist class."""

    consts = EtherMacSecTxStatsHistConsts()
    naming_props = set(['id'])

    mo_meta = MoMeta("EtherMacSecTxStatsHist", "etherMacSecTxStatsHist", "[id]", VersionMeta.Version434a, "OutputOnly", 0xf, [], ["read-only"], ['etherMacSecTxStats'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, id, **kwargs):
        ...
        ManagedObject.__init__(self, "EtherMacSecTxStatsHist", parent_mo_or_dn, **kwargs)
