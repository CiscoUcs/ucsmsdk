...
class EtherServerIntFIoConsts:
    XCVR_SUPPORTED_FALSE = "false"
    XCVR_SUPPORTED_NO = "no"
    XCVR_SUPPORTED_TRUE = "true"
    XCVR_SUPPORTED_YES = "yes"
...
class EtherServerIntFIo(ManagedObject):
    ...
    prop_meta = {
        "xcvr_supported": MoPropertyMeta("xcvr_supported", "XcvrSupported", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["false", "no", "true", "yes"], []),
