...
class EtherServerIntFIoConsts:
    ...
    CHASSIS_ID_N_A = "N/A"
    CONNECTED_ADAPTOR_TYPE_BODEGA = "bodega"
    CONNECTED_ADAPTOR_TYPE_CRUZ = "cruz"
    CONNECTED_ADAPTOR_TYPE_WINDSOR = "windsor"
    ENCAP_DOT1Q = "dot1q"
    ENCAP_ISL = "isl"
    ...
    FSM_PREV_CONFIG_CONFIGURE = "ConfigConfigure"
    FSM_PREV_CONFIG_FAIL = "ConfigFail"
    FSM_PREV_CONFIG_SPEED_BEGIN = "ConfigSpeedBegin"
    FSM_PREV_CONFIG_SPEED_CONFIGURE = "ConfigSpeedConfigure"
    FSM_PREV_CONFIG_SPEED_FAIL = "ConfigSpeedFail"
    FSM_PREV_CONFIG_SPEED_SUCCESS = "ConfigSpeedSuccess"
    ...
    FSM_STATUS_CONFIG_CONFIGURE = "ConfigConfigure"
    FSM_STATUS_CONFIG_FAIL = "ConfigFail"
    FSM_STATUS_CONFIG_SPEED_BEGIN = "ConfigSpeedBegin"
    FSM_STATUS_CONFIG_SPEED_CONFIGURE = "ConfigSpeedConfigure"
    FSM_STATUS_CONFIG_SPEED_FAIL = "ConfigSpeedFail"
    FSM_STATUS_CONFIG_SPEED_SUCCESS = "ConfigSpeedSuccess"
    ...
    XCVR_TYPE_QDD2X100GCWDM4S = "qdd2x100gcwdm4s"
    XCVR_TYPE_QDD2X100GLR4S = "qdd2x100glr4s"
    ...
    XCVR_TYPE_QSFP100GERLS = "qsfp100gerls"
    ...
    XCVR_TYPE_QSFP100GZR4S = "qsfp100gzr4s"
    ...
    XCVR_TYPE_QSFPDD400GAOC1M = "qsfpdd400gaoc1m"
    XCVR_TYPE_QSFPDD400GAOC2M = "qsfpdd400gaoc2m"
    XCVR_TYPE_QSFPDD400GAOC3M = "qsfpdd400gaoc3m"
    XCVR_TYPE_QSFPDD400GCU1M = "qsfpdd400gcu1m"
    XCVR_TYPE_QSFPDD400GCU2M = "qsfpdd400gcu2m"
    XCVR_TYPE_QSFPDD400GCU3M = "qsfpdd400gcu3m"
    XCVR_TYPE_QSFPDD400GDR4 = "qsfpdd400gdr4"
    XCVR_TYPE_QSFPDD400GFR4 = "qsfpdd400gfr4"
    XCVR_TYPE_QSFPDD400GLR4 = "qsfpdd400glr4"
    XCVR_TYPE_QSFPDD400GLR8 = "qsfpdd400glr8"
    XCVR_TYPE_QSFPDD400GZRPS = "qsfpdd400gzrps"
    XCVR_TYPE_QSFPDD400GZRS = "qsfpdd400gzrs"
    XCVR_TYPE_QSFPDD4X100GFR = "qsfpdd4x100gfr"
    XCVR_TYPE_QSFPDD4X100GLRS = "qsfpdd4x100glrs"
    ...
    XCVR_TYPE_QSFPH40GAOC25M = "qsfph40gaoc25m"
    ...
    XCVR_TYPE_QSFPH40GCU4M = "qsfph40gcu4m"
    XCVR_TYPE_QSFPH40GCU5M = "qsfph40gcu5m"
    XCVR_TYPE_QSFPLOOP = "qsfploop"
    XCVR_TYPE_QSFPONSQC4X32GLW = "qsfponsqc4x32glw"
    XCVR_TYPE_QSFPQSA = "qsfpqsa"
    XCVR_TYPE_QSFPUNKNOWN = "qsfpunknown"
    XCVR_TYPE_SFP = "sfp"
    XCVR_TYPE_SFP25GSL = "sfp25gsl"
    XCVR_TYPE_SFP50GCU3M = "sfp50gcu3m"
    XCVR_TYPE_SFP50GCU5M = "sfp50gcu5m"
    XCVR_TYPE_SFP50GSL = "sfp50gsl"
    XCVR_TYPE_SFP50GSRS = "sfp50gsrs"
    XCVR_TYPE_SFPH10GBCU4M = "sfph10gbcu4m"
...
class EtherServerIntFIo(ManagedObject):
    ...
    mo_meta = MoMeta("EtherServerIntFIo", "etherServerIntFIo", "port-[port_id]", VersionMeta.Version101e, "InputOutput", 0x1ff, [], ["admin"], ['diagSrvCtrl', 'portGroup', 'portSubGroup'], ['equipmentXcvr', 'etherErrStats', 'etherLossStats', 'etherPauseStats', 'etherRxStats', 'etherServerIntFIoFsm', 'etherServerIntFIoFsmTask', 'etherTxStats', 'eventInst', 'faultInst', 'lldpAcquired', 'portDomainEp', 'portTrustMode', 'swUlan'], ["Get"])

    prop_meta = {
        "admin_speed": MoPropertyMeta("admin_speed", "adminSpeed", "string", VersionMeta.Version202m, MoPropertyMeta.READ_ONLY, None, None, None, None, ["100gbps", "10gbps", "1gbps", "200gbps", "20gbps", "25gbps", "400gbps", "40gbps", "50gbps", "auto", "indeterminate"], []),
        ...
        "connected_adaptor_type": MoPropertyMeta("connected_adaptor_type", "connectedAdaptorType", "string", VersionMeta.Version411a, MoPropertyMeta.READ_WRITE, 0x4, None, None, None, ["bodega", "cruz", "windsor"], []),
        ...
        "mac": MoPropertyMeta("mac", "mac", "string", VersionMeta.Version131c, MoPropertyMeta.READ_ONLY, None, None, None, r"""(([0-9a-fA-F][0-9a-fA-F]:){5}([0-9a-fA-F][0-9a-fA-F]))|0""", [], []),
        ...
        "ns_size": MoPropertyMeta("ns_size", "nsSize", "ushort", VersionMeta.Version202m, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []),
        ...
        "user_recovery_operation": MoPropertyMeta("user_recovery_operation", "userRecoveryOperation", "string", VersionMeta.Version321d, MoPropertyMeta.READ_WRITE, 0x100, None, None, None, ["none", "reset"], []),
    ...
    prop_map = {
        ...
        "connectedAdaptorType": "connected_adaptor_type", 
        "dn": "dn", 
        "encap": "encap", 
        "epDn": "ep_dn", 
        "fltAggr": "flt_aggr", 
    ...
    def __init__(self, parent_mo_or_dn, port_id, **kwargs):
        ...
        self.connected_adaptor_type = None
        self.encap = None
        self.ep_dn = None
        self.flt_aggr = None
        self.fsm_descr = None
