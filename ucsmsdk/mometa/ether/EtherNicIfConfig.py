"""This module contains the general information for EtherNicIfConfig ManagedObject."""
import sys, os
...
class EtherNicIfConfigConsts():
    pass


class EtherNicIfConfig(ManagedObject):
    """This is EtherNicIfConfig class."""

    consts = EtherNicIfConfigConsts()
    naming_props = set([])

    mo_meta = MoMeta("EtherNicIfConfig", "etherNicIfConfig", "if-config", VersionMeta.Version101e, "InputOutput", 0x1fL, [], ["read-only"], [], [], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "EtherNicIfConfig", parent_mo_or_dn, **kwargs)
