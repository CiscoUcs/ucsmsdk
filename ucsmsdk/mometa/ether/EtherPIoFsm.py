...
class EtherPIoFsm(ManagedObject):
    """This is EtherPIoFsm class."""

    consts = EtherPIoFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("EtherPIoFsm", "etherPIoFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'etherPIo'], [u'etherPIoFsmStage'], [None])
