...
class EtherPortChanIdElem(ManagedObject):
    ...
    mo_meta = MoMeta("EtherPortChanIdElem", "etherPortChanIdElem", "pchanid-[id]", VersionMeta.Version201m, "InputOutput", 0x3fL, [], ["read-only"], [u'etherPortChanIdUniverse'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "id": MoPropertyMeta("id", "id", "uint", VersionMeta.Version201m, MoPropertyMeta.NAMING, 0x8L, None, None, None, [], []), 
