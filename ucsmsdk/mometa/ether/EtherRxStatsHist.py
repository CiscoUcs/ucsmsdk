"""This module contains the general information for EtherRxStatsHist ManagedObject."""
import sys, os
...
class EtherRxStatsHist(ManagedObject):
    """This is EtherRxStatsHist class."""

    consts = EtherRxStatsHistConsts()
    naming_props = set([u'id'])

    mo_meta = MoMeta("EtherRxStatsHist", "etherRxStatsHist", "[id]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], ["read-only"], [u'etherRxStats'], [], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, id, **kwargs):
        ...
        ManagedObject.__init__(self, "EtherRxStatsHist", parent_mo_or_dn, **kwargs)
