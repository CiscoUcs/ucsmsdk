"""This module contains the general information for EtherServerIntFIoFsm ManagedObject."""
import sys, os
...
class EtherServerIntFIoFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_CONFIG_SPEED = "ConfigSpeed"
    CURRENT_FSM_NOP = "nop"
...
class EtherServerIntFIoFsm(ManagedObject):
    """This is EtherServerIntFIoFsm class."""

    consts = EtherServerIntFIoFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("EtherServerIntFIoFsm", "etherServerIntFIoFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'etherServerIntFIo'], [u'etherServerIntFIoFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["ConfigSpeed", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "EtherServerIntFIoFsm", parent_mo_or_dn, **kwargs)
