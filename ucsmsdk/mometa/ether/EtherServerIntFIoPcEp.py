"""This module contains the general information for EtherServerIntFIoPcEp ManagedObject."""
import sys, os
...
class EtherServerIntFIoPcEpConsts():
...
class EtherServerIntFIoPcEp(ManagedObject):
    """This is EtherServerIntFIoPcEp class."""

    consts = EtherServerIntFIoPcEpConsts()
    naming_props = set([u'slotId', u'portId'])

    mo_meta = MoMeta("EtherServerIntFIoPcEp", "etherServerIntFIoPcEp", "ep-slot-[slot_id]-port-[port_id]", VersionMeta.Version201m, "InputOutput", 0xffL, [], ["admin", "ext-lan-config", "ext-lan-policy", "pn-equipment", "pn-maintenance"], [u'etherServerIntFIoPc'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "port_id": MoPropertyMeta("port_id", "portId", "uint", VersionMeta.Version201m, MoPropertyMeta.NAMING, 0x10L, None, None, None, [], ["1-33"]), 
        ...
        "slot_id": MoPropertyMeta("slot_id", "slotId", "uint", VersionMeta.Version201m, MoPropertyMeta.NAMING, 0x40L, None, None, None, [], []), 
    ...
    def __init__(self, parent_mo_or_dn, slot_id, port_id, **kwargs):
        ...
        ManagedObject.__init__(self, "EtherServerIntFIoPcEp", parent_mo_or_dn, **kwargs)
