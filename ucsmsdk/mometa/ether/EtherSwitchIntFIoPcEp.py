...
class EtherSwitchIntFIoPcEp(ManagedObject):
    ...
    mo_meta = MoMeta("EtherSwitchIntFIoPcEp", "etherSwitchIntFIoPcEp", "ep-slot-[slot_id]-port-[port_id]", VersionMeta.Version201m, "InputOutput", 0x1ffL, [], ["admin", "ext-lan-config", "ext-lan-policy", "pn-equipment", "pn-maintenance"], [u'etherSwitchIntFIoPc'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "port_id": MoPropertyMeta("port_id", "portId", "uint", VersionMeta.Version201m, MoPropertyMeta.NAMING, 0x20L, None, None, None, [], ["1-32", "1-8"]), 
