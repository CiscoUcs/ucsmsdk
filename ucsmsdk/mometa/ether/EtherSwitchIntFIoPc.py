...
class EtherSwitchIntFIoPc(ManagedObject):
    ...
    mo_meta = MoMeta("EtherSwitchIntFIoPc", "etherSwitchIntFIoPc", "pc-[port_id]", VersionMeta.Version201m, "InputOutput", 0x1ffL, [], ["admin", "ext-lan-config", "ext-lan-policy", "pn-equipment", "pn-maintenance"], [u'portGroup'], [u'etherNiErrStats', u'etherSwitchIntFIoPcEp', u'faultInst'], ["Get"])
    ...
    prop_meta = {
        ...
        "multicast_hw_hash": MoPropertyMeta("multicast_hw_hash", "multicastHwHash", "string", None, MoPropertyMeta.READ_WRITE, 0x10L, None, None, None, ["disabled", "enabled"], []), 
        ...
        "port_id": MoPropertyMeta("port_id", "portId", "uint", VersionMeta.Version201m, MoPropertyMeta.NAMING, 0x40L, None, None, None, [], ["1024-4096"]), 
