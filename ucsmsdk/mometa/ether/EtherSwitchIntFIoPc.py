...
class EtherSwitchIntFIoPc(ManagedObject):
    ...
    prop_meta = {
        ...
        "multicast_hw_hash": MoPropertyMeta("multicast_hw_hash", "multicastHwHash", "string", VersionMeta.Version311e, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["disabled", "enabled"], []), 
