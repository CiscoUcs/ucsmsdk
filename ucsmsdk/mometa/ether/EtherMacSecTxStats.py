"""This module contains the general information for EtherMacSecTxStats ManagedObject."""
...
class EtherMacSecTxStatsConsts:
    SUSPECT_FALSE = "false"
    SUSPECT_NO = "no"
    SUSPECT_TRUE = "true"
    SUSPECT_YES = "yes"
...
class EtherMacSecTxStats(ManagedObject):
    """This is EtherMacSecTxStats class."""

    consts = EtherMacSecTxStatsConsts()
    naming_props = set([])

    mo_meta = MoMeta("EtherMacSecTxStats", "etherMacSecTxStats", "macsec-tx-stats", VersionMeta.Version434a, "OutputOnly", 0xf, [], ["admin", "operations", "read-only"], ['etherPIo'], ['etherMacSecTxStatsHist'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "EtherMacSecTxStats", parent_mo_or_dn, **kwargs)
