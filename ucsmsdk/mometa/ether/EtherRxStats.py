...
class EtherRxStats(ManagedObject):
    """This is EtherRxStats class."""

    consts = EtherRxStatsConsts()
    naming_props = set([])

    mo_meta = MoMeta("EtherRxStats", "etherRxStats", "rx-stats", VersionMeta.Version111j, "OutputOnly", 0xfL, [], ["admin", "operations", "read-only"], [u'etherPIo', u'etherServerIntFIo', u'fabricEthEstcPc', u'fabricEthLanPc'], [u'etherRxStatsHist'], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "EtherRxStats", parent_mo_or_dn, **kwargs)
