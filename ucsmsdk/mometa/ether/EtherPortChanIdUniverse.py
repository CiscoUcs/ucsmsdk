...
class EtherPortChanIdUniverse(ManagedObject):
    ...
    mo_meta = MoMeta("EtherPortChanIdUniverse", "etherPortChanIdUniverse", "pchanid-universe", VersionMeta.Version201m, "InputOutput", 0x1fL, [], ["read-only"], [u'fabricEp'], [u'etherPortChanIdElem'], ["Get"])
