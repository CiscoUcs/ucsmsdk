...
class EtherPIoEndPoint(ManagedObject):
    ...
    mo_meta = MoMeta("EtherPIoEndPoint", "etherPIoEndPoint", "EndPointDn-cloud-[ep_cloud_type]", VersionMeta.Version211a, "InputOutput", 0x3fL, [], ["read-only"], [u'etherPIo'], [], [None])
    ...
    prop_meta = {
        ...
        "ep_cloud_type": MoPropertyMeta("ep_cloud_type", "epCloudType", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, 0x4L, None, None, None, ["lan", "san", "unclassified"], []), 
