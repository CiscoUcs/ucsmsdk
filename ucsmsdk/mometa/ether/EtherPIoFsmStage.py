"""This module contains the general information for EtherPIoFsmStage ManagedObject."""
import sys, os
...
class EtherPIoFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_IN_COMPAT_SFP_PRESENCE_BEGIN = "InCompatSfpPresenceBegin"
    NAME_IN_COMPAT_SFP_PRESENCE_FAIL = "InCompatSfpPresenceFail"
    NAME_IN_COMPAT_SFP_PRESENCE_SHUTDOWN = "InCompatSfpPresenceShutdown"
    NAME_IN_COMPAT_SFP_PRESENCE_SUCCESS = "InCompatSfpPresenceSuccess"
    NAME_IN_COMPAT_SFP_REPLACED_BEGIN = "InCompatSfpReplacedBegin"
    NAME_IN_COMPAT_SFP_REPLACED_ENABLE_PORT = "InCompatSfpReplacedEnablePort"
    NAME_IN_COMPAT_SFP_REPLACED_FAIL = "InCompatSfpReplacedFail"
    NAME_IN_COMPAT_SFP_REPLACED_SUCCESS = "InCompatSfpReplacedSuccess"
    NAME_NOP = "nop"
...
class EtherPIoFsmStage(ManagedObject):
    """This is EtherPIoFsmStage class."""

    consts = EtherPIoFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("EtherPIoFsmStage", "etherPIoFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'etherPIoFsm'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "EtherPIoFsmStage", parent_mo_or_dn, **kwargs)
