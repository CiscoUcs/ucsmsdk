"""This module contains the general information for EtherSwIfConfig ManagedObject."""
import sys, os
...
class EtherSwIfConfigConsts():
    pass


class EtherSwIfConfig(ManagedObject):
    """This is EtherSwIfConfig class."""

    consts = EtherSwIfConfigConsts()
    naming_props = set([])

    mo_meta = MoMeta("EtherSwIfConfig", "etherSwIfConfig", "if-config", VersionMeta.Version101e, "InputOutput", 0x1fL, [], ["read-only"], [u'fabricDceSrv', u'fabricEthLan'], [], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "EtherSwIfConfig", parent_mo_or_dn, **kwargs)
