"""This module contains the general information for EtherMacSecRxStatsHist ManagedObject."""
...
class EtherMacSecRxStatsHistConsts:
...
class EtherMacSecRxStatsHist(ManagedObject):
    """This is EtherMacSecRxStatsHist class."""

    consts = EtherMacSecRxStatsHistConsts()
    naming_props = set(['id'])

    mo_meta = MoMeta("EtherMacSecRxStatsHist", "etherMacSecRxStatsHist", "[id]", VersionMeta.Version434a, "OutputOnly", 0xf, [], ["read-only"], ['etherMacSecRxStats'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, id, **kwargs):
        ...
        ManagedObject.__init__(self, "EtherMacSecRxStatsHist", parent_mo_or_dn, **kwargs)
