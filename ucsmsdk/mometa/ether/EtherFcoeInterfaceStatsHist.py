...
class EtherFcoeInterfaceStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("EtherFcoeInterfaceStatsHist", "etherFcoeInterfaceStatsHist", "[id]", VersionMeta.Version211a, "OutputOnly", 0xf, [], ["read-only"], ['etherFcoeInterfaceStats'], [], ["Get"])
