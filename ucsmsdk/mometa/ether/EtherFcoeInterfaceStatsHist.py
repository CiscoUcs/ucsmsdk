...
class EtherFcoeInterfaceStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("EtherFcoeInterfaceStatsHist", "etherFcoeInterfaceStatsHist", "[id]", VersionMeta.Version211a, "OutputOnly", 0x7L, [], ["read-only"], [u'etherFcoeInterfaceStats'], [], ["Get"])
