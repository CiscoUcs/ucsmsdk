"""This module contains the general information for NfsMountInstFsmTask ManagedObject."""
import sys, os
...
class NfsMountInstFsmTaskConsts():
    COMPLETION_CANCELLED = "cancelled"
    COMPLETION_COMPLETED = "completed"
    COMPLETION_PROCESSING = "processing"
    COMPLETION_SCHEDULED = "scheduled"
    ITEM_MOUNT = "Mount"
    ITEM_UNMOUNT = "Unmount"
    ITEM_NOP = "nop"


class NfsMountInstFsmTask(ManagedObject):
    """This is NfsMountInstFsmTask class."""

    consts = NfsMountInstFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("NfsMountInstFsmTask", "nfsMountInstFsmTask", "task-[item]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'nfsMountInst'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["Mount", "Unmount", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "NfsMountInstFsmTask", parent_mo_or_dn, **kwargs)
