"""This module contains the general information for NfsMountDefFsmStage ManagedObject."""
import sys, os
...
class NfsMountDefFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_REPORT_NFS_MOUNT_SUSPEND_BEGIN = "ReportNfsMountSuspendBegin"
    NAME_REPORT_NFS_MOUNT_SUSPEND_FAIL = "ReportNfsMountSuspendFail"
    NAME_REPORT_NFS_MOUNT_SUSPEND_REPORT = "ReportNfsMountSuspendReport"
    NAME_REPORT_NFS_MOUNT_SUSPEND_SUCCESS = "ReportNfsMountSuspendSuccess"
    NAME_NOP = "nop"
...
class NfsMountDefFsmStage(ManagedObject):
    """This is NfsMountDefFsmStage class."""

    consts = NfsMountDefFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("NfsMountDefFsmStage", "nfsMountDefFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'nfsMountDefFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["ReportNfsMountSuspendBegin", "ReportNfsMountSuspendFail", "ReportNfsMountSuspendReport", "ReportNfsMountSuspendSuccess", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "NfsMountDefFsmStage", parent_mo_or_dn, **kwargs)
