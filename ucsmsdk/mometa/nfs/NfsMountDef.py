...
class NfsMountDef(ManagedObject):
    ...
    mo_meta = MoMeta("NfsMountDef", "nfsMountDef", "nfs-mount-def-[name]", VersionMeta.Version211a, "InputOutput", 0xff, [], ["admin"], ['nfsEp'], ['eventInst', 'faultInst', 'nfsMountDefFsm', 'nfsMountDefFsmTask'], ["Get"])
