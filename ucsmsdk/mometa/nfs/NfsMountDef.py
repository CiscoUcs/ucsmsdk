...
class NfsMountDefConsts():
    ...
    FSM_PREV_REPORT_NFS_MOUNT_SUSPEND_BEGIN = "ReportNfsMountSuspendBegin"
    FSM_PREV_REPORT_NFS_MOUNT_SUSPEND_FAIL = "ReportNfsMountSuspendFail"
    FSM_PREV_REPORT_NFS_MOUNT_SUSPEND_REPORT = "ReportNfsMountSuspendReport"
    FSM_PREV_REPORT_NFS_MOUNT_SUSPEND_SUCCESS = "ReportNfsMountSuspendSuccess"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_REPORT_NFS_MOUNT_SUSPEND_BEGIN = "ReportNfsMountSuspendBegin"
    FSM_STATUS_REPORT_NFS_MOUNT_SUSPEND_FAIL = "ReportNfsMountSuspendFail"
    FSM_STATUS_REPORT_NFS_MOUNT_SUSPEND_REPORT = "ReportNfsMountSuspendReport"
    FSM_STATUS_REPORT_NFS_MOUNT_SUSPEND_SUCCESS = "ReportNfsMountSuspendSuccess"
    FSM_STATUS_NOP = "nop"
    INT_ID_NONE = "none"
...
class NfsMountDef(ManagedObject):
    ...
    mo_meta = MoMeta("NfsMountDef", "nfsMountDef", "nfs-mount-def-[name]", VersionMeta.Version211a, "InputOutput", 0x7fL, [], ["admin"], [u'nfsEp'], [u'eventInst', u'faultInst', u'nfsMountDefFsm', u'nfsMountDefFsmTask'], ["Get"])

    prop_meta = {
        "admin_state": MoPropertyMeta("admin_state", "adminState", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["disabled", "enabled", "suspended"], []), 
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version211a, MoPropertyMeta.INTERNAL, None, None, None, None, ["ReportNfsMountSuspendBegin", "ReportNfsMountSuspendFail", "ReportNfsMountSuspendReport", "ReportNfsMountSuspendSuccess", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version211a, MoPropertyMeta.INTERNAL, None, None, None, None, ["ReportNfsMountSuspendBegin", "ReportNfsMountSuspendFail", "ReportNfsMountSuspendReport", "ReportNfsMountSuspendSuccess", "nop"], []), 
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, 0x8L, 1, 128, None, [], []), 
