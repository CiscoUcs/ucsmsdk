...
class NfsMountInstFsmStageConsts():
    ...
    NAME_MOUNT_MOUNT_LOCAL = "MountMountLocal"
    NAME_MOUNT_MOUNT_PEER = "MountMountPeer"
    NAME_MOUNT_REGISTER_CLIENT = "MountRegisterClient"
    NAME_MOUNT_SUCCESS = "MountSuccess"
    NAME_MOUNT_VERIFY_REGISTRATION = "MountVerifyRegistration"
    NAME_UNMOUNT_BEGIN = "UnmountBegin"
    NAME_UNMOUNT_FAIL = "UnmountFail"
    NAME_UNMOUNT_SUCCESS = "UnmountSuccess"
    NAME_UNMOUNT_UNMOUNT_LOCAL = "UnmountUnmountLocal"
    NAME_UNMOUNT_UNMOUNT_PEER = "UnmountUnmountPeer"
    NAME_NOP = "nop"
...
class NfsMountInstFsmStage(ManagedObject):
    """This is NfsMountInstFsmStage class."""

    consts = NfsMountInstFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("NfsMountInstFsmStage", "nfsMountInstFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'nfsMountInstFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["MountBegin", "MountFail", "MountMountLocal", "MountMountPeer", "MountRegisterClient", "MountSuccess", "MountVerifyRegistration", "UnmountBegin", "UnmountFail", "UnmountSuccess", "UnmountUnmountLocal", "UnmountUnmountPeer", "nop"], []), 
