"""This module contains the general information for NfsMountDefFsm ManagedObject."""
import sys, os
...
class NfsMountDefFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_REPORT_NFS_MOUNT_SUSPEND = "ReportNfsMountSuspend"
    CURRENT_FSM_NOP = "nop"
...
class NfsMountDefFsm(ManagedObject):
    """This is NfsMountDefFsm class."""

    consts = NfsMountDefFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("NfsMountDefFsm", "nfsMountDefFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'nfsMountDef'], [u'nfsMountDefFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["ReportNfsMountSuspend", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "NfsMountDefFsm", parent_mo_or_dn, **kwargs)
