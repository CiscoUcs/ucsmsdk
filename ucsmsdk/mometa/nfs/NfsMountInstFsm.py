"""This module contains the general information for NfsMountInstFsm ManagedObject."""
import sys, os
...
class NfsMountInstFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_MOUNT = "Mount"
    CURRENT_FSM_UNMOUNT = "Unmount"
    CURRENT_FSM_NOP = "nop"
...
class NfsMountInstFsm(ManagedObject):
    """This is NfsMountInstFsm class."""

    consts = NfsMountInstFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("NfsMountInstFsm", "nfsMountInstFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'nfsMountInst'], [u'nfsMountInstFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Mount", "Unmount", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "NfsMountInstFsm", parent_mo_or_dn, **kwargs)
