...
class LstorageIssues(ManagedObject):
    ...
    mo_meta = MoMeta("LstorageIssues", "lstorageIssues", "sa-config-issue", VersionMeta.Version302a, "InputOutput", 0xfL, [], ["admin", "ls-storage"], [u'lstorageProcessor'], [], [None])
    ...
    prop_meta = {
        ...
        "network_config_issues": MoPropertyMeta("network_config_issues", "networkConfigIssues", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, """((defaultValue|not-applicable|invalid-config|invalid-iscsi-vlan|unsupported-vlan-capability|invalid-ip-address),){0,5}(defaultValue|not-applicable|invalid-config|invalid-iscsi-vlan|unsupported-vlan-capability|invalid-ip-address){0,1}""", [], []), 
