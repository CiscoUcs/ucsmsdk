"""This module contains the general information for LstorageMaintPolicy ManagedObject."""
import sys, os
...
class LstorageMaintPolicyConsts():
    INT_ID_NONE = "none"
...
class LstorageMaintPolicy(ManagedObject):
    """This is LstorageMaintPolicy class."""

    consts = LstorageMaintPolicyConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("LstorageMaintPolicy", "lstorageMaintPolicy", "storage-maint-[name]", VersionMeta.Version302a, "InputOutput", 0x1ffL, [], ["admin", "ls-storage"], [u'orgOrg'], [], [None])
    ...
    prop_meta = {
        ...
        "oper_sched_name": MoPropertyMeta("oper_sched_name", "operSchedName", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        ...
        "sched_name": MoPropertyMeta("sched_name", "schedName", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x40L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        ...
        "uptime_disr": MoPropertyMeta("uptime_disr", "uptimeDisr", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x100L, None, None, None, ["immediate", "timer-automatic", "user-ack"], []), 
    }
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "LstorageMaintPolicy", parent_mo_or_dn, **kwargs)
