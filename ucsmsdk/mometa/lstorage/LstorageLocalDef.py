...
class LstorageLocalDef(ManagedObject):
    ...
    mo_meta = MoMeta("LstorageLocalDef", "lstorageLocalDef", "local-def", None, "InputOutput", 0x1f, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'computeBoard'], [], [None])
    ...
    prop_meta = {
        ...
        "security_key": MoPropertyMeta("security_key", "securityKey", "string", None, MoPropertyMeta.READ_ONLY, None, 32, 32, None, [], []), 
