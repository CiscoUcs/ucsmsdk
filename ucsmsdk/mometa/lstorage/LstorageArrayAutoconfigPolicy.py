...
class LstorageArrayAutoconfigPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("LstorageArrayAutoconfigPolicy", "lstorageArrayAutoconfigPolicy", "storage-autoconfig-[name]", VersionMeta.Version302a, "InputOutput", 0x3ffL, [], ["admin", "ls-storage", "pn-policy"], [u'orgOrg'], [u'faultInst'], [None])
    ...
    prop_meta = {
        ...
        "dst_dn": MoPropertyMeta("dst_dn", "dstDn", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x8L, 0, 256, None, [], []), 
        ...
        "qualifier": MoPropertyMeta("qualifier", "qualifier", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x40L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        ...
        "src_templ_name": MoPropertyMeta("src_templ_name", "srcTemplName", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x100L, None, None, None, [], []), 
