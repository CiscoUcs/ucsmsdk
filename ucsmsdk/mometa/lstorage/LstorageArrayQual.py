"""This module contains the general information for LstorageArrayQual ManagedObject."""
import sys, os
...
class LstorageArrayQual(ManagedObject):
    """This is LstorageArrayQual class."""

    consts = LstorageArrayQualConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("LstorageArrayQual", "lstorageArrayQual", "array-qualifier-[name]", VersionMeta.Version302c, "InputOutput", 0xffL, [], ["admin", "ls-storage", "pn-policy"], [u'orgOrg'], [u'computeChassisQual', u'computePhysicalQual'], [None])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "LstorageArrayQual", parent_mo_or_dn, **kwargs)
