...
class LstorageArrayQual(ManagedObject):
    ...
    mo_meta = MoMeta("LstorageArrayQual", "lstorageArrayQual", "array-qualifier-[name]", VersionMeta.Version302a, "InputOutput", 0x7fL, [], ["admin", "ls-storage", "pn-policy"], [u'orgOrg'], [u'computeChassisQual', u'computePhysicalQual'], [None])
