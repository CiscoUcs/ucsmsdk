...
class LstorageArrayBinding(ManagedObject):
    ...
    mo_meta = MoMeta("LstorageArrayBinding", "lstorageArrayBinding", "pn", VersionMeta.Version302c, "InputOutput", 0x3fL, [], ["admin", "ls-storage", "read-only"], [u'lstorageArray', u'lstorageProcessor'], [], [None])
    ...
    prop_meta = {
        ...
        "pn_dn": MoPropertyMeta("pn_dn", "pnDn", "string", VersionMeta.Version302c, MoPropertyMeta.READ_WRITE, 0x8L, 0, 256, None, [], []), 
