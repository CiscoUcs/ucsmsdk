"""This module contains the general information for LstorageArrayBinding ManagedObject."""
import sys, os
...
class LstorageArrayBindingConsts():
    pass


class LstorageArrayBinding(ManagedObject):
    """This is LstorageArrayBinding class."""

    consts = LstorageArrayBindingConsts()
    naming_props = set([])

    mo_meta = MoMeta("LstorageArrayBinding", "lstorageArrayBinding", "pn", VersionMeta.Version302a, "InputOutput", 0x1fL, [], ["admin", "ls-storage", "read-only"], [u'lstorageArray', u'lstorageProcessor'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, """[\-\.:_a-zA-Z0-9]{1,32}""", [], []), 
        "pn_dn": MoPropertyMeta("pn_dn", "pnDn", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x4L, 0, 256, None, [], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "LstorageArrayBinding", parent_mo_or_dn, **kwargs)
