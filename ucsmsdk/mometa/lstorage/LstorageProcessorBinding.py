...
class LstorageProcessorBinding(ManagedObject):
    ...
    mo_meta = MoMeta("LstorageProcessorBinding", "lstorageProcessorBinding", "pn", VersionMeta.Version302a, "InputOutput", 0xfL, [], ["admin", "ls-storage", "read-only"], [u'lstorageArray', u'lstorageProcessor'], [], [None])
