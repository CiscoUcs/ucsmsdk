...
class LstorageSharedCredential(ManagedObject):
    ...
    mo_meta = MoMeta("LstorageSharedCredential", "lstorageSharedCredential", "shared-credential", VersionMeta.Version302a, "InputOutput", 0x7fL, [], ["admin", "ls-storage", "ls-storage-policy"], [u'lstorageLunReplicationService'], [], [None])
    ...
    prop_meta = {
        ...
        "enc_secret": MoPropertyMeta("enc_secret", "encSecret", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x4L, 1, 256, None, [], []), 
        ...
        "secret": MoPropertyMeta("secret", "secret", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x10L, None, None, """[!""#%&'\(\)\*\+,\-\./:;<>@\[\\\]\^_`\{\|\}~a-zA-Z0-9]{0,64}""", [], []), 
        ...
        "str_secret": MoPropertyMeta("str_secret", "strSecret", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x40L, 0, 510, None, [], []), 
    }
