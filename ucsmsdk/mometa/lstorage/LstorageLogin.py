...
class LstorageLogin(ManagedObject):
    ...
    mo_meta = MoMeta("LstorageLogin", "lstorageLogin", "login", None, "InputOutput", 0x7f, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'lstorageRemote', u'lstorageRemoteDef'], [], [None])
    ...
    prop_meta = {
        ...
        "password": MoPropertyMeta("password", "password", "string", None, MoPropertyMeta.READ_WRITE, 0x8, None, None, r"""[!""#%&'\(\)\*\+,\-\./:;<>@\[\\\]\^_`\{\|\}~a-zA-Z0-9]{0,80}""", [], []), 
        "pwd_set": MoPropertyMeta("pwd_set", "pwdSet", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["false", "no", "true", "yes"], []), 
        ...
        "user_name": MoPropertyMeta("user_name", "userName", "string", None, MoPropertyMeta.READ_WRITE, 0x40, None, None, r"""[a-zA-Z][a-zA-Z0-9_.-]{0,31}""", [], []), 
    }
