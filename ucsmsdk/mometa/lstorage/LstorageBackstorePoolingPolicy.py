...
class LstorageBackstorePoolingPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("LstorageBackstorePoolingPolicy", "lstorageBackstorePoolingPolicy", "backstore-pooling-policy-[name]", VersionMeta.Version302a, "InputOutput", 0x1ffL, [], ["admin", "ls-storage"], [u'orgOrg'], [u'faultInst'], [None])
    ...
    prop_meta = {
        ...
        "pool_dn": MoPropertyMeta("pool_dn", "poolDn", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x20L, 0, 256, None, [], []), 
