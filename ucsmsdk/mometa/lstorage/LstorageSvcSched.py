...
class LstorageSvcSched(ManagedObject):
    ...
    mo_meta = MoMeta("LstorageSvcSched", "lstorageSvcSched", "svc-sched-[name]", VersionMeta.Version302a, "InputOutput", 0xffL, [], ["admin", "read-only"], [u'lstorageLunReplicationPolicy', u'topSystem'], [u'lstorageAbsWindow', u'lstorageRecurrWindow', u'trigAbsWindow', u'trigLocalAbsWindow', u'trigRecurrWindow'], [None])
    ...
    prop_meta = {
        ...
        "descr": MoPropertyMeta("descr", "descr", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x4L, None, None, """[ !#$%&\(\)\*\+,\-\./:;\?@\[\]_\{\|\}~a-zA-Z0-9]{0,256}""", [], []), 
        "dn": MoPropertyMeta("dn", "dn", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, 0x8L, 0, 256, None, [], []), 
        "flg_initial_active": MoPropertyMeta("flg_initial_active", "flgInitialActive", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["false", "no", "true", "yes"], []), 
        ...
        "oper_state": MoPropertyMeta("oper_state", "operState", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["cap-reached", "failed", "in-progress", "pending", "triggered"], []), 
