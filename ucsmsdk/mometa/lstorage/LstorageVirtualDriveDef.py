...
class LstorageVirtualDriveDef(ManagedObject):
    ...
    prop_meta = {
        ...
        "io_policy": MoPropertyMeta("io_policy", "ioPolicy", "string", VersionMeta.Version224a, MoPropertyMeta.READ_WRITE, 0x20, None, None, None, ["cached", "direct", "platform-default", "unknown"], []), 
        "read_policy": MoPropertyMeta("read_policy", "readPolicy", "string", VersionMeta.Version224a, MoPropertyMeta.READ_WRITE, 0x40, None, None, None, ["normal", "platform-default", "read-ahead", "unknown"], []), 
        ...
        "strip_size": MoPropertyMeta("strip_size", "stripSize", "string", VersionMeta.Version224a, MoPropertyMeta.READ_WRITE, 0x200, None, None, None, ["1024KB", "128KB", "16KB", "256KB", "32KB", "512KB", "64KB", "8KB", "platform-default", "unspecified"], []), 
        "write_cache_policy": MoPropertyMeta("write_cache_policy", "writeCachePolicy", "string", VersionMeta.Version224a, MoPropertyMeta.READ_WRITE, 0x400, None, None, None, ["always-write-back", "platform-default", "unknown", "write-back-good-bbu", "write-through"], []), 
    }
