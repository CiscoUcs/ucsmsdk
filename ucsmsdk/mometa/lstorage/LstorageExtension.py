...
class LstorageExtension(ManagedObject):
    ...
    mo_meta = MoMeta("LstorageExtension", "lstorageExtension", "extension", VersionMeta.Version302c, "InputOutput", 0x7fL, [], ["admin", "ls-storage"], [u'lstorageArray'], [], [None])
    ...
    prop_meta = {
        ...
        "guid": MoPropertyMeta("guid", "guid", "string", VersionMeta.Version302c, MoPropertyMeta.READ_WRITE, 0x8L, 0, 510, None, [], []), 
        ...
        "version": MoPropertyMeta("version", "version", "uint", VersionMeta.Version302c, MoPropertyMeta.READ_WRITE, 0x40L, None, None, None, [], []), 
    }
