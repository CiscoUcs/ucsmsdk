...
class LstorageExtension(ManagedObject):
    ...
    mo_meta = MoMeta("LstorageExtension", "lstorageExtension", "extension", VersionMeta.Version302a, "InputOutput", 0x3fL, [], ["admin", "ls-storage"], [u'lstorageArray'], [], [None])
    ...
    prop_meta = {
        ...
        "guid": MoPropertyMeta("guid", "guid", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x4L, 0, 510, None, [], []), 
        ...
        "version": MoPropertyMeta("version", "version", "uint", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x20L, None, None, None, [], []), 
    }
