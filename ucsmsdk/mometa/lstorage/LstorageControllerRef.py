...
class LstorageControllerRef(ManagedObject):
    ...
    mo_meta = MoMeta("LstorageControllerRef", "lstorageControllerRef", "server-[server_id]-controller-[controller_type]-[controller_id]", VersionMeta.Version911z, "InputOutput", 0xff, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'lstorageDiskSlot'], [], [None])
    ...
    prop_meta = {
        ...
        "controller_id": MoPropertyMeta("controller_id", "controllerId", "uint", VersionMeta.Version911z, MoPropertyMeta.NAMING, 0x4, None, None, None, [], ["1-1"]), 
        ...
        "server_id": MoPropertyMeta("server_id", "serverId", "uint", VersionMeta.Version911z, MoPropertyMeta.NAMING, 0x40, None, None, None, [], ["1-2"]), 
