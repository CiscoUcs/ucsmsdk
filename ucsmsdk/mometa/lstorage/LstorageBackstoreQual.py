"""This module contains the general information for LstorageBackstoreQual ManagedObject."""
import sys, os
...
class LstorageBackstoreQualConsts():
    INT_ID_NONE = "none"
...
class LstorageBackstoreQual(ManagedObject):
    """This is LstorageBackstoreQual class."""

    consts = LstorageBackstoreQualConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("LstorageBackstoreQual", "lstorageBackstoreQual", "backstore-qualifier-[name]", VersionMeta.Version302c, "InputOutput", 0xffL, [], ["admin", "ls-storage"], [u'orgOrg'], [u'computeChassisQual', u'computePhysicalQual'], [None])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "LstorageBackstoreQual", parent_mo_or_dn, **kwargs)
