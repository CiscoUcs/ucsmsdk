...
class LstorageLunReplicationService(ManagedObject):
    ...
    mo_meta = MoMeta("LstorageLunReplicationService", "lstorageLunReplicationService", "lun-repl-svc", VersionMeta.Version302a, "InputOutput", 0x7fL, [], ["admin", "ls-storage", "ls-storage-policy"], [u'lstorageArray', u'storageProcessor'], [u'lstorageReplicationSources', u'lstorageSharedCredential'], [None])
