"""This module contains the general information for LstorageLunReplicationService ManagedObject."""
import sys, os
...
class LstorageLunReplicationServiceConsts():
    INT_ID_NONE = "none"
...
class LstorageLunReplicationService(ManagedObject):
    """This is LstorageLunReplicationService class."""

    consts = LstorageLunReplicationServiceConsts()
    naming_props = set([])

    mo_meta = MoMeta("LstorageLunReplicationService", "lstorageLunReplicationService", "lun-repl-svc", VersionMeta.Version302c, "InputOutput", 0xffL, [], ["admin", "ls-storage", "ls-storage-policy"], [u'lstorageArray', u'storageProcessor'], [u'lstorageReplicationSources', u'lstorageSharedCredential'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "LstorageLunReplicationService", parent_mo_or_dn, **kwargs)
