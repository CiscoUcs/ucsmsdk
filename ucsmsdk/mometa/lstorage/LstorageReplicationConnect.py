...
class LstorageReplicationConnect(ManagedObject):
    ...
    mo_meta = MoMeta("LstorageReplicationConnect", "lstorageReplicationConnect", "repl-connect-[hostname]", VersionMeta.Version302a, "InputOutput", 0x7ffL, [], ["admin", "ls-storage", "ls-storage-policy"], [u'lstorageLunReplicationPolicy'], [], [None])
    ...
    prop_meta = {
        ...
        "hostname": MoPropertyMeta("hostname", "hostname", "string", VersionMeta.Version302a, MoPropertyMeta.NAMING, 0x10L, None, None, None, [], []), 
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version302a, MoPropertyMeta.CREATE_ONLY, 0x20L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        "owner_policy": MoPropertyMeta("owner_policy", "ownerPolicy", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        ...
        "pwd": MoPropertyMeta("pwd", "pwd", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x80L, 0, 64, None, [], []), 
        ...
        "user": MoPropertyMeta("user", "user", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x400L, 0, 510, None, [], []), 
    }
