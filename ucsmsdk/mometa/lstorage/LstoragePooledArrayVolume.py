...
class LstoragePooledArrayVolume(ManagedObject):
    ...
    mo_meta = MoMeta("LstoragePooledArrayVolume", "lstoragePooledArrayVolume", "array-[array_name]-part-[partition_name]-vol-[volume_name]", VersionMeta.Version302a, "InputOutput", 0x7fL, [], ["admin", "ls-storage", "read-only"], [u'lstorageBackstorePool'], [], [None])

    prop_meta = {
        "array_name": MoPropertyMeta("array_name", "arrayName", "string", VersionMeta.Version302a, MoPropertyMeta.NAMING, 0x1L, 1, 32, None, [], []), 
        "assigned": MoPropertyMeta("assigned", "assigned", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["false", "no", "true", "yes"], []), 
        ...
        "partition_name": MoPropertyMeta("partition_name", "partitionName", "string", VersionMeta.Version302a, MoPropertyMeta.NAMING, 0x8L, None, None, """[\-\.:_a-zA-Z0-9]{1,16}""", [], []), 
        "poolable_dn": MoPropertyMeta("poolable_dn", "poolableDn", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        ...
        "volume_name": MoPropertyMeta("volume_name", "volumeName", "string", VersionMeta.Version302a, MoPropertyMeta.NAMING, 0x40L, None, None, """[\-\.:_a-zA-Z0-9]{1,32}""", [], []), 
    }
