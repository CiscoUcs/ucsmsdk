...
class LstorageProcessorFsm(ManagedObject):
    ...
    mo_meta = MoMeta("LstorageProcessorFsm", "lstorageProcessorFsm", "fsm", VersionMeta.Version302c, "OutputOnly", 0xfL, [], [""], [u'lstorageProcessor'], [u'lstorageProcessorFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version302c, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Configure", "nop"], []), 
