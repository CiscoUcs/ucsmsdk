"""This module contains the general information for LstorageProcessorFsm ManagedObject."""
import sys, os
...
class LstorageProcessorFsmConsts():
    COMPLETION_TIME_ = ""
...
class LstorageProcessorFsm(ManagedObject):
    """This is LstorageProcessorFsm class."""

    consts = LstorageProcessorFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("LstorageProcessorFsm", "lstorageProcessorFsm", "fsm", VersionMeta.Version302a, "OutputOnly", 0x7L, [], [""], [u'lstorageProcessor'], [u'lstorageProcessorFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Configure", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "LstorageProcessorFsm", parent_mo_or_dn, **kwargs)
