...
class LstorageRemote(ManagedObject):
    ...
    mo_meta = MoMeta("LstorageRemote", "lstorageRemote", "remote", VersionMeta.Version321d, "InputOutput", 0x7ff, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'computeBoard', u'lstorageDriveSecurity'], [u'lstorageLogin'], ["Get", "Set"])
