...
class LstoragePoolableBackstore(ManagedObject):
    ...
    mo_meta = MoMeta("LstoragePoolableBackstore", "lstoragePoolableBackstore", "pool-[id]", VersionMeta.Version302c, "InputOutput", 0x3fL, [], ["read-only"], [u'storageVolume'], [u'lstorageBackstorePoolPolicyRef'], [None])
    ...
    prop_meta = {
        ...
        "pool_dn": MoPropertyMeta("pool_dn", "poolDn", "string", VersionMeta.Version302c, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
