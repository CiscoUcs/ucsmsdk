...
class LstorageCtrlService(ManagedObject):
    ...
    mo_meta = MoMeta("LstorageCtrlService", "lstorageCtrlService", "services", VersionMeta.Version302a, "InputOutput", 0x3fL, [], ["admin", "ls-storage", "pn-equipment", "pn-maintenance", "pn-policy"], [u'lstorageProcessor'], [], [None])

    prop_meta = {
        "admin_state": MoPropertyMeta("admin_state", "adminState", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x1L, None, None, None, ["in-maintenance", "in-service"], []), 
        ...
        "fail_over_state": MoPropertyMeta("fail_over_state", "failOverState", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x8L, None, None, None, ["trigger", "triggered"], []), 
        "oper_maint_state": MoPropertyMeta("oper_maint_state", "operMaintState", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["entering-maintenance", "exiting-maintenance", "in-maintenance", "in-service", "not-applicable", "unknown"], []), 
