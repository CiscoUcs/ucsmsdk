...
class LstorageLocal(ManagedObject):
    ...
    mo_meta = MoMeta("LstorageLocal", "lstorageLocal", "local", None, "InputOutput", 0x7f, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'computeBoard', u'lstorageDriveSecurity'], [], [None])
    ...
    prop_meta = {
        ...
        "security_key": MoPropertyMeta("security_key", "securityKey", "string", None, MoPropertyMeta.READ_WRITE, 0x20, 32, 32, None, [], []), 
