"""This module contains the general information for LstorageProcessorFsmTask ManagedObject."""
import sys, os
...
class LstorageProcessorFsmTaskConsts():
...
class LstorageProcessorFsmTask(ManagedObject):
    """This is LstorageProcessorFsmTask class."""

    consts = LstorageProcessorFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("LstorageProcessorFsmTask", "lstorageProcessorFsmTask", "task-[item]", VersionMeta.Version302c, "OutputOnly", 0xfL, [], [""], [u'lstorageProcessor'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version302c, MoPropertyMeta.NAMING, None, None, None, None, ["Configure", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "LstorageProcessorFsmTask", parent_mo_or_dn, **kwargs)
