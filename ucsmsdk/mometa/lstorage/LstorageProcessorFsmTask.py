...
class LstorageProcessorFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("LstorageProcessorFsmTask", "lstorageProcessorFsmTask", "task-[item]", VersionMeta.Version302a, "OutputOnly", 0x7L, [], [""], [u'lstorageProcessor'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version302a, MoPropertyMeta.NAMING, None, None, None, None, ["Configure", "nop"], []), 
