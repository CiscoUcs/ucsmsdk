...
class LstorageDriveSecurity(ManagedObject):
    ...
    mo_meta = MoMeta("LstorageDriveSecurity", "lstorageDriveSecurity", "drive", None, "InputOutput", 0x1f, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'lstorageSecurity'], [u'lstorageLocal', u'lstorageRemote'], [None])
