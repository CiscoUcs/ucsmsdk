...
class LstorageDiskZoningConfigDefConsts:
    INT_ID_NONE = "none"
...
class LstorageDiskZoningConfigDef(ManagedObject):
    """This is LstorageDiskZoningConfigDef class."""

    consts = LstorageDiskZoningConfigDefConsts()
    naming_props = set([])

    mo_meta = MoMeta("LstorageDiskZoningConfigDef", "lstorageDiskZoningConfigDef", "disk-zoning-def", VersionMeta.Version312b, "InputOutput", 0x1ff, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'equipmentChassisProfile'], [u'lstorageDiskSlot'], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "preserve_config": MoPropertyMeta("preserve_config", "preserveConfig", "string", VersionMeta.Version312b, MoPropertyMeta.READ_WRITE, 0x40, None, None, None, ["false", "no", "true", "yes"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "LstorageDiskZoningConfigDef", parent_mo_or_dn, **kwargs)
