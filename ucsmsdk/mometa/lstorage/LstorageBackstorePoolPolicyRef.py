...
class LstorageBackstorePoolPolicyRef(ManagedObject):
    ...
    mo_meta = MoMeta("LstorageBackstorePoolPolicyRef", "lstorageBackstorePoolPolicyRef", "poolref-[id]", VersionMeta.Version302a, "InputOutput", 0x1fL, [], ["read-only"], [u'lstoragePoolableBackstore'], [], [None])
    ...
    prop_meta = {
        ...
        "policy_dn": MoPropertyMeta("policy_dn", "policyDn", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
