...
class LstorageInvictaReplicationExt(ManagedObject):
    ...
    mo_meta = MoMeta("LstorageInvictaReplicationExt", "lstorageInvictaReplicationExt", "extension-invicta", VersionMeta.Version302a, "InputOutput", 0x1fL, [], ["admin", "ls-storage", "ls-storage-policy"], [u'lstorageLunReplicationPolicy', u'storageReplicationProfile'], [], [None])
    ...
    prop_meta = {
        ...
        "max_rate": MoPropertyMeta("max_rate", "maxRate", "ushort", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x4L, None, None, None, [], []), 
