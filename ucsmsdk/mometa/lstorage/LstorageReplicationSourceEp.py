...
class LstorageReplicationSourceEp(ManagedObject):
    ...
    mo_meta = MoMeta("LstorageReplicationSourceEp", "lstorageReplicationSourceEp", "repl-source-ep[serial_number]", VersionMeta.Version302a, "InputOutput", 0x1fL, [], ["admin", "ls-storage", "ls-storage-policy"], [u'lstorageReplicationSources'], [], [None])
    ...
    prop_meta = {
        ...
        "serial_number": MoPropertyMeta("serial_number", "serialNumber", "string", VersionMeta.Version302a, MoPropertyMeta.NAMING, 0x8L, 1, 510, None, [], []), 
