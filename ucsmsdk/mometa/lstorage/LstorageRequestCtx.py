...
class LstorageRequestCtx(ManagedObject):
    ...
    mo_meta = MoMeta("LstorageRequestCtx", "lstorageRequestCtx", "", VersionMeta.Version302a, "InputOutput", 0xfL, [], ["read-only"], [], [], [None])

    prop_meta = {
        "assigned_volume": MoPropertyMeta("assigned_volume", "assignedVolume", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        ...
        "cons_dn": MoPropertyMeta("cons_dn", "consDn", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        "dn": MoPropertyMeta("dn", "dn", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, 0x2L, 0, 256, None, [], []), 
        "request_size": MoPropertyMeta("request_size", "requestSize", "ulong", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        ...
        "volume_pool_name": MoPropertyMeta("volume_pool_name", "volumePoolName", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
    }
