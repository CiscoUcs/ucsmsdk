...
class LstorageReplicationSources(ManagedObject):
    ...
    mo_meta = MoMeta("LstorageReplicationSources", "lstorageReplicationSources", "repl-sources", VersionMeta.Version302a, "InputOutput", 0x1fL, [], ["admin", "ls-storage", "ls-storage-policy"], [u'lstorageLunReplicationService'], [u'lstorageReplicationSourceEp'], [None])

    prop_meta = {
        "access_type": MoPropertyMeta("access_type", "accessType", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x1L, None, None, None, ["ALLOW_ALL", "ALLOW_NONE", "ALLOW_ONLY"], []), 
