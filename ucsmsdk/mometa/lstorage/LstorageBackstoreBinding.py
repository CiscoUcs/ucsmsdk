...
class LstorageBackstoreBinding(ManagedObject):
    ...
    mo_meta = MoMeta("LstorageBackstoreBinding", "lstorageBackstoreBinding", "backstore", VersionMeta.Version302a, "InputOutput", 0x7fL, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-storage", "ls-storage-policy", "read-only"], [u'lstorageSanScsiLun'], [], [None])

    prop_meta = {
        "array_name": MoPropertyMeta("array_name", "arrayName", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x1L, None, None, """[\-\.:_a-zA-Z0-9]{1,32}""", [], []), 
        ...
        "partition_name": MoPropertyMeta("partition_name", "partitionName", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x8L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        ...
        "volume_name": MoPropertyMeta("volume_name", "volumeName", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x40L, None, None, """[\-\.:_a-zA-Z0-9]{0,32}""", [], []), 
    }
