...
class LstorageTargetIdentity(ManagedObject):
    ...
    mo_meta = MoMeta("LstorageTargetIdentity", "lstorageTargetIdentity", "target-identity", VersionMeta.Version302c, "InputOutput", 0x3fL, [], ["admin", "ls-storage"], [u'lstorageArray'], [u'vnicIScsiNode'], ["Get"])
    ...
    prop_meta = {
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version302c, MoPropertyMeta.READ_ONLY, None, None, None, r"""((none|defaultValue|iqn-target|eui-target|naa-target),){0,4}(none|defaultValue|iqn-target|eui-target|naa-target){0,1}""", [], []), 
    }
