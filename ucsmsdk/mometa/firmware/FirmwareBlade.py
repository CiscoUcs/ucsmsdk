"""This module contains the general information for FirmwareBlade ManagedObject."""
import sys, os
...
class FirmwareBladeConsts():
    pass


class FirmwareBlade(ManagedObject):
    """This is FirmwareBlade class."""

    consts = FirmwareBladeConsts()
    naming_props = set([])

    mo_meta = MoMeta("FirmwareBlade", "firmwareBlade", "fw-blade", VersionMeta.Version211a, "InputOutput", 0x1fL, [], ["admin"], [u'firmwareHost'], [], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FirmwareBlade", parent_mo_or_dn, **kwargs)
