...
class FirmwareSecondControllerServerConstraint(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareSecondControllerServerConstraint", "firmwareSecondControllerServerConstraint", "second-controller-server-constraint", None, "InputOutput", 0x1f, [], ["read-only"], [u'firmwareConstraints'], [], [None])
