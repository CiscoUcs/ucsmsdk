...
class FirmwareDistributableConsts():
    ...
    FSM_PREV_DELETE_REMOTE = "DeleteRemote"
    ...
    FSM_STATUS_DELETE_REMOTE = "DeleteRemote"
...
class FirmwareDistributable(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareDistributable", "firmwareDistributable", "distrib-[name]", VersionMeta.Version101e, "InputOutput", 0x1ffL, [], ["admin"], [u'firmwareCatalogue'], [u'eventInst', u'faultInst', u'firmwareDistImage', u'firmwareDistributableFsm', u'firmwareDistributableFsmTask'], ["Get", "Set"])

    prop_meta = {
        "admin_state": MoPropertyMeta("admin_state", "adminState", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x2L, None, None, None, ["active", "deleted"], []), 
        ...
        "completeness": MoPropertyMeta("completeness", "completeness", "string", VersionMeta.Version101e, MoPropertyMeta.READ_ONLY, None, None, None, None, ["complete", "partial"], []), 
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version131c, MoPropertyMeta.INTERNAL, None, None, None, None, ["DeleteBegin", "DeleteFail", "DeleteLocal", "DeleteRemote", "DeleteSuccess", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version131c, MoPropertyMeta.INTERNAL, None, None, None, None, ["DeleteBegin", "DeleteFail", "DeleteLocal", "DeleteRemote", "DeleteSuccess", "nop"], []), 
        "fsm_try": MoPropertyMeta("fsm_try", "fsmTry", "byte", VersionMeta.Version131c, MoPropertyMeta.INTERNAL, None, None, None, None, [], []), 
        "image_presence": MoPropertyMeta("image_presence", "imagePresence", "string", VersionMeta.Version101e, MoPropertyMeta.READ_ONLY, None, None, None, r"""((defaultValue|unknown|A|B),){0,3}(defaultValue|unknown|A|B){0,1}""", [], []), 
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x20L, 1, 128, None, [], []), 
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version101e, MoPropertyMeta.READ_ONLY, None, None, None, None, ["b-series-bundle", "c-series-bundle", "catalog", "full-bundle", "image", "infrastructure-bundle", "m-series-bundle", "s-series-bundle", "unknown"], []), 
