...
class FirmwareChassisPackModImpact(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareChassisPackModImpact", "firmwareChassisPackModImpact", "fw-sys-ChassisPackModImpact-[key_dn]", None, "InputOutput", 0x3f, [], ["admin", "ls-config-policy", "ls-server-policy"], [], [], [None])

    prop_meta = {
        "chassis_profile_dn": MoPropertyMeta("chassis_profile_dn", "ChassisProfileDn", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        ...
        "key_dn": MoPropertyMeta("key_dn", "keyDn", "string", None, MoPropertyMeta.NAMING, 0x8, 1, 510, None, [], []), 
        "maint_policy_dn": MoPropertyMeta("maint_policy_dn", "maintPolicyDn", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        "pn_dn": MoPropertyMeta("pn_dn", "pnDn", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        "reboot_policy": MoPropertyMeta("reboot_policy", "rebootPolicy", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
