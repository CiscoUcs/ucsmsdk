"""This module contains the general information for FirmwareImageFsm ManagedObject."""
import sys, os
...
class FirmwareImageFsm(ManagedObject):
    """This is FirmwareImageFsm class."""

    consts = FirmwareImageFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("FirmwareImageFsm", "firmwareImageFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'firmwareImage'], [u'firmwareImageFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FirmwareImageFsm", parent_mo_or_dn, **kwargs)
