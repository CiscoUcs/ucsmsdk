...
class FirmwareBackupVersionHolder(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareBackupVersionHolder", "firmwareBackupVersionHolder", "update-backup-version-holder-[bundle_type]", None, "InputOutput", 0x7f, [], ["admin"], [u'firmwareCatalogPack', u'firmwareChassisPack', u'firmwareComputeHostPack', u'firmwareComputeMgmtPack', u'firmwareInfraPack'], [u'firmwarePackItem'], [None])

    prop_meta = {
        "bundle_name": MoPropertyMeta("bundle_name", "bundleName", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        "bundle_type": MoPropertyMeta("bundle_type", "bundleType", "string", None, MoPropertyMeta.NAMING, 0x2, None, None, None, ["blade", "chassis", "infra", "none", "rack"], []), 
        "bundle_version": MoPropertyMeta("bundle_version", "bundleVersion", "string", None, MoPropertyMeta.READ_WRITE, 0x4, 0, 510, None, [], []), 
        "child_action": MoPropertyMeta("child_action", "childAction", "string", None, MoPropertyMeta.INTERNAL, 0x8, None, None, r"""((deleteAll|ignore|deleteNonPresent),){0,2}(deleteAll|ignore|deleteNonPresent){0,1}""", [], []), 
