"""This module contains the general information for FirmwareImageFsmTask ManagedObject."""
import sys, os
...
class FirmwareImageFsmTaskConsts():
...
class FirmwareImageFsmTask(ManagedObject):
    """This is FirmwareImageFsmTask class."""

    consts = FirmwareImageFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("FirmwareImageFsmTask", "firmwareImageFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], [""], [u'firmwareImage'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, None, None, None, None, ["Delete", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "FirmwareImageFsmTask", parent_mo_or_dn, **kwargs)
