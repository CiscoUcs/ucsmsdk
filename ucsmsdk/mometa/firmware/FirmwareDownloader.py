...
class FirmwareDownloader(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareDownloader", "firmwareDownloader", "dnld-[file_name]", VersionMeta.Version101e, "InputOutput", 0x7ffL, [], ["admin"], [u'firmwareCatalogue'], [u'eventInst', u'faultInst', u'firmwareDownloaderFsm', u'firmwareDownloaderFsmTask'], ["Add", "Get", "Remove"])

    prop_meta = {
        "admin_state": MoPropertyMeta("admin_state", "adminState", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x1L, None, None, None, ["idle", "restart"], []), 
        ...
        "file_name": MoPropertyMeta("file_name", "fileName", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x8L, 1, 64, None, [], []), 
        ...
        "protocol": MoPropertyMeta("protocol", "protocol", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x10L, None, None, None, ["ftp", "local", "scp", "sftp", "tftp", "usbA", "usbB"], []), 
        "pwd": MoPropertyMeta("pwd", "pwd", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x20L, None, None, None, [], []), 
        "remote_path": MoPropertyMeta("remote_path", "remotePath", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x40L, None, None, None, [], []), 
        ...
        "server": MoPropertyMeta("server", "server", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x100L, 1, 64, None, [], []), 
        ...
        "user": MoPropertyMeta("user", "user", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x400L, 0, 510, None, [], []), 
    }
