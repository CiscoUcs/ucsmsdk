...
class FirmwareRunning(ManagedObject):
    ...
    prop_meta = {
        ...
        "deployment": MoPropertyMeta("deployment", "deployment", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x2L, None, None, None, ["boot-loader", "kernel", "system", "unspecified"], []), 
