...
class FirmwareDownloaderFsmTask(ManagedObject):
    """This is FirmwareDownloaderFsmTask class."""

    consts = FirmwareDownloaderFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("FirmwareDownloaderFsmTask", "firmwareDownloaderFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], [""], [u'firmwareDownloader'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, None, None, None, None, ["Download", "nop"], []), 
