"""This module contains the general information for FirmwareDownloaderFsm ManagedObject."""
import sys, os
...
class FirmwareDownloaderFsmConsts():
    COMPLETION_TIME_ = ""
...
class FirmwareDownloaderFsm(ManagedObject):
    """This is FirmwareDownloaderFsm class."""

    consts = FirmwareDownloaderFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("FirmwareDownloaderFsm", "firmwareDownloaderFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'firmwareDownloader'], [u'firmwareDownloaderFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Download", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FirmwareDownloaderFsm", parent_mo_or_dn, **kwargs)
