...
class FirmwareDownloaderFsm(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareDownloaderFsm", "firmwareDownloaderFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xf, [], [""], [u'firmwareDownloader'], [u'firmwareDownloaderFsmStage'], [None])
