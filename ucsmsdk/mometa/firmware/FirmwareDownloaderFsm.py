...
class FirmwareDownloaderFsm(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareDownloaderFsm", "firmwareDownloaderFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'firmwareDownloader'], [u'firmwareDownloaderFsmStage'], [None])
