...
class FirmwareDistributableFsm(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareDistributableFsm", "firmwareDistributableFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'firmwareDistributable'], [u'firmwareDistributableFsmStage'], [None])
