"""This module contains the general information for FirmwareDistributableFsm ManagedObject."""
import sys, os
...
class FirmwareDistributableFsm(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareDistributableFsm", "firmwareDistributableFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'firmwareDistributable'], [u'firmwareDistributableFsmStage'], [None])
