...
class FirmwareDistributableFsm(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareDistributableFsm", "firmwareDistributableFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xf, [], [""], ['firmwareDistributable'], ['firmwareDistributableFsmStage'], [None])
