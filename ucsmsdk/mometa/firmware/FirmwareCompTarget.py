...
class FirmwareCompTarget(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareCompTarget", "firmwareCompTarget", "target-[inv_tag]-ver-[version]", VersionMeta.Version101e, "InputOutput", 0x3ff, [], ["read-only"], [u'firmwareCompSource'], [], [None])
