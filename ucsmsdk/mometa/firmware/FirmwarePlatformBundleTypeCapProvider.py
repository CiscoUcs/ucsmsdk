...
class FirmwarePlatformBundleTypeCapProvider(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwarePlatformBundleTypeCapProvider", "firmwarePlatformBundleTypeCapProvider", "plat-bundle-type-cap-[platform_type]", VersionMeta.Version302a, "InputOutput", 0x1fL, [], [""], [u'capabilityCatalogue'], [u'firmwareBundleType'], [None])
    ...
    prop_meta = {
        ...
        "platform_type": MoPropertyMeta("platform_type", "platformType", "string", VersionMeta.Version302a, MoPropertyMeta.NAMING, 0x4L, None, None, None, ["UCS", "UCS-MINI"], []), 
