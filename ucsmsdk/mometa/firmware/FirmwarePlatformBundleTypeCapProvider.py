...
class FirmwarePlatformBundleTypeCapProvider(ManagedObject):
    ...
    prop_meta = {
        ...
        "platform_type": MoPropertyMeta("platform_type", "platformType", "string", VersionMeta.Version302c, MoPropertyMeta.NAMING, 0x8, None, None, None, ["UCS", "UCS-6300", "UCS-6400", "UCS-6500", "UCS-MINI", "UCSX-9100"], []),
