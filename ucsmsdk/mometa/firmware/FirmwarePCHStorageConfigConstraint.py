...
class FirmwarePCHStorageConfigConstraint(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwarePCHStorageConfigConstraint", "firmwarePCHStorageConfigConstraint", "constraint-pch-storage-config", None, "InputOutput", 0x1fL, [], [""], [u'firmwareConstraints'], [], [None])
