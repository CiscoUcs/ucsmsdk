...
class FirmwareBundleInfoDigest(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareBundleInfoDigest", "firmwareBundleInfoDigest", "bundleinfo-[type]-version-[version]", VersionMeta.Version211a, "InputOutput", 0x3fL, [], ["read-only"], [], [], [None])
    ...
    prop_meta = {
        ...
        "version": MoPropertyMeta("version", "version", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, 0x20L, 1, 510, None, [], []), 
    }
