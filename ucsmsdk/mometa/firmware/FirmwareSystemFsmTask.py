"""This module contains the general information for FirmwareSystemFsmTask ManagedObject."""
...
class FirmwareSystemFsmTaskConsts:
    ...
    ITEM_DEPLOY = "Deploy"
    ITEM_UPGRADE_SFP_FIRMWARE = "UpgradeSfpFirmware"
    ITEM_NOP = "nop"
...
class FirmwareSystemFsmTask(ManagedObject):
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["ApplyCatalogPack", "Deploy", "UpgradeSfpFirmware", "nop"], []),
