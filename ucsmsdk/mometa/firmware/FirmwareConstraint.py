...
class FirmwareConstraint(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareConstraint", "firmwareConstraint", "constraint-[feature]", VersionMeta.Version223a, "InputOutput", 0x3fL, [], [""], [u'firmwareConstraints'], [], [None])
    ...
    prop_meta = {
        ...
        "feature": MoPropertyMeta("feature", "feature", "string", VersionMeta.Version223a, MoPropertyMeta.NAMING, 0x8L, 1, 510, None, [], []), 
