...
class FirmwareUpdatable(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareUpdatable", "firmwareUpdatable", "fw-updatable", VersionMeta.Version101e, "InputOutput", 0x3fL, [], ["admin"], [u'biosUnit', u'equipmentPsu', u'mgmtController'], [u'faultInst', u'firmwareInstallable'], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "version": MoPropertyMeta("version", "version", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x20L, 0, 510, None, [], []), 
    }
