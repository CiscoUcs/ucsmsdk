...
class FirmwareDualVicServerConstraint(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareDualVicServerConstraint", "firmwareDualVicServerConstraint", "dual-vic-server-constraint", VersionMeta.Version321d, "InputOutput", 0x1f, [], ["read-only"], [u'firmwareConstraints'], [], [None])
