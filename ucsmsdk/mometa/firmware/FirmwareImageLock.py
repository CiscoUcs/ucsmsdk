...
class FirmwareImageLock(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareImageLock", "firmwareImageLock", "fw-imagelock[name]", VersionMeta.Version222c, "InputOutput", 0x3fL, [], ["admin"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit', u'osController'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version222c, MoPropertyMeta.NAMING, 0x8L, None, None, None, [], []), 
