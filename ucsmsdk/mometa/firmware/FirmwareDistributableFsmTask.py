...
class FirmwareDistributableFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareDistributableFsmTask", "firmwareDistributableFsmTask", "task-[item]", VersionMeta.Version131c, "OutputOnly", 0x7L, [], [""], [u'firmwareDistributable'], [], [None])
