...
class FirmwareVicSlotConstraint(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareVicSlotConstraint", "firmwareVicSlotConstraint", "constraint-vic-slot-[vic_slot]", VersionMeta.Version311e, "InputOutput", 0x3f, [], [""], [u'firmwareConstraints'], [], [None])
    ...
    prop_meta = {
        ...
        "vic_slot": MoPropertyMeta("vic_slot", "vicSlot", "string", VersionMeta.Version311e, MoPropertyMeta.NAMING, 0x20, 1, 510, None, [], []), 
    }
