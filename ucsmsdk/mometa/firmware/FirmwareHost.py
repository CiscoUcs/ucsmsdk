"""This module contains the general information for FirmwareHost ManagedObject."""
import sys, os
...
class FirmwareHostConsts():
    pass


class FirmwareHost(ManagedObject):
    """This is FirmwareHost class."""

    consts = FirmwareHostConsts()
    naming_props = set([])

    mo_meta = MoMeta("FirmwareHost", "firmwareHost", "fw-host", VersionMeta.Version211a, "InputOutput", 0x1fL, [], ["admin"], [u'firmwareSystem'], [u'firmwareBlade', u'firmwareRack'], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FirmwareHost", parent_mo_or_dn, **kwargs)
