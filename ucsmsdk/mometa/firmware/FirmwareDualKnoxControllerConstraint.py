"""This module contains the general information for FirmwareDualKnoxControllerConstraint ManagedObject."""
...
class FirmwareDualKnoxControllerConstraintConsts:
...
class FirmwareDualKnoxControllerConstraint(ManagedObject):
    """This is FirmwareDualKnoxControllerConstraint class."""

    consts = FirmwareDualKnoxControllerConstraintConsts()
    naming_props = set([])

    mo_meta = MoMeta("FirmwareDualKnoxControllerConstraint", "firmwareDualKnoxControllerConstraint", "constraint-dual-knox-controller", VersionMeta.Version601b, "InputOutput", 0x1f, [], [""], ['firmwareConstraints'], [], [None])

    prop_meta = {
        "check_running_ver": MoPropertyMeta("check_running_ver", "checkRunningVer", "string", VersionMeta.Version601b, MoPropertyMeta.READ_ONLY, None, None, None, None, ["false", "no", "true", "yes"], []),
        ...
        "min_bios_version": MoPropertyMeta("min_bios_version", "minBiosVersion", "string", VersionMeta.Version601b, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []),
        "min_cimc_version": MoPropertyMeta("min_cimc_version", "minCimcVersion", "string", VersionMeta.Version601b, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []),
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FirmwareDualKnoxControllerConstraint", parent_mo_or_dn, **kwargs)
