...
class FirmwareDualKnoxControllerConstraint(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareDualKnoxControllerConstraint", "firmwareDualKnoxControllerConstraint", "constraint-dual-knox-controller", VersionMeta.Version601a, "InputOutput", 0x1f, [], [""], ['firmwareConstraints'], [], [None])

    prop_meta = {
        "check_running_ver": MoPropertyMeta("check_running_ver", "checkRunningVer", "string", VersionMeta.Version601a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["false", "no", "true", "yes"], []),
        ...
        "min_bios_version": MoPropertyMeta("min_bios_version", "minBiosVersion", "string", VersionMeta.Version601a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []),
        "min_cimc_version": MoPropertyMeta("min_cimc_version", "minCimcVersion", "string", VersionMeta.Version601a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []),
