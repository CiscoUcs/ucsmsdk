...
class FirmwareAck(ManagedObject):
    ...
    prop_meta = {
        ...
        "extd_change_details": MoPropertyMeta("extd_change_details", "extdChangeDetails", "string", VersionMeta.Version404a, MoPropertyMeta.READ_ONLY, None, None, None, r"""((defaultValue|persistent-memory-policy|persistent-memory-dimm-fw|host-pack-have-backup-set|adaptor-swm-reset),){0,4}(defaultValue|persistent-memory-policy|persistent-memory-dimm-fw|host-pack-have-backup-set|adaptor-swm-reset){0,1}""", [], []),
