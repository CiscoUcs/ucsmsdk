...
class FirmwareProcessorTypeConstraint(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareProcessorTypeConstraint", "firmwareProcessorTypeConstraint", "constraint-processor-type-[type]", VersionMeta.Version224a, "InputOutput", 0x3f, [], [""], [u'firmwareConstraints'], [], [None])
    ...
    prop_meta = {
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version224a, MoPropertyMeta.NAMING, 0x20, 1, 510, None, [], []), 
    }
