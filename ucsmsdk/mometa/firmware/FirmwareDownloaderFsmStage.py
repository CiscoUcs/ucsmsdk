...
class FirmwareDownloaderFsmStageConsts():
    ...
    NAME_DOWNLOAD_UNPACK_LOCAL = "DownloadUnpackLocal"
    NAME_NOP = "nop"
...
class FirmwareDownloaderFsmStage(ManagedObject):
    """This is FirmwareDownloaderFsmStage class."""

    consts = FirmwareDownloaderFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("FirmwareDownloaderFsmStage", "firmwareDownloaderFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'firmwareDownloaderFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["DownloadBegin", "DownloadCopyRemote", "DownloadDeleteLocal", "DownloadFail", "DownloadLocal", "DownloadSuccess", "DownloadUnpackLocal", "nop"], []), 
