"""This module contains the general information for FirmwareBerninaPassConstraint ManagedObject."""
...
class FirmwareBerninaPassConstraintConsts:
...
class FirmwareBerninaPassConstraint(ManagedObject):
    """This is FirmwareBerninaPassConstraint class."""

    consts = FirmwareBerninaPassConstraintConsts()
    naming_props = set([])

    mo_meta = MoMeta("FirmwareBerninaPassConstraint", "firmwareBerninaPassConstraint", "constraint-bernina-pass", VersionMeta.Version602a, "InputOutput", 0x1f, [], [""], ['firmwareConstraints'], [], [None])

    prop_meta = {
        "check_running_ver": MoPropertyMeta("check_running_ver", "checkRunningVer", "string", VersionMeta.Version602a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["false", "no", "true", "yes"], []),
        ...
        "min_bios_version": MoPropertyMeta("min_bios_version", "minBiosVersion", "string", VersionMeta.Version602a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []),
        "min_cimc_version": MoPropertyMeta("min_cimc_version", "minCimcVersion", "string", VersionMeta.Version602a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []),
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FirmwareBerninaPassConstraint", parent_mo_or_dn, **kwargs)
