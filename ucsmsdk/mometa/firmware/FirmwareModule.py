...
class FirmwareModule(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareModule", "firmwareModule", "module-[name]|[type]", None, "InputOutput", 0x7f, [], ["admin"], [u'firmwareImage'], [], [None])
    ...
    prop_meta = {
        ...
        "description": MoPropertyMeta("description", "description", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        ...
        "type": MoPropertyMeta("type", "type", "string", None, MoPropertyMeta.NAMING, 0x40, 1, 510, None, [], []), 
        "vendor": MoPropertyMeta("vendor", "vendor", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        "version": MoPropertyMeta("version", "version", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
    }
