...
class FirmwareDriveSecurityConstraint(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareDriveSecurityConstraint", "firmwareDriveSecurityConstraint", "drive-security-constraint", None, "InputOutput", 0x1f, [], ["read-only"], [u'firmwareConstraints'], [], [None])
