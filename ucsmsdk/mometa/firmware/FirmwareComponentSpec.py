...
class FirmwareComponentSpec(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareComponentSpec", "firmwareComponentSpec", "component-spec-[type]", VersionMeta.Version227b, "InputOutput", 0x3f, [], [""], [u'firmwareBundleTypeCapProvider'], [], [None])
