"""This module contains the general information for FirmwareImageFsmStage ManagedObject."""
import sys, os
...
class FirmwareImageFsmStage(ManagedObject):
    """This is FirmwareImageFsmStage class."""

    consts = FirmwareImageFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("FirmwareImageFsmStage", "firmwareImageFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'firmwareImageFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["DeleteBegin", "DeleteFail", "DeleteLocal", "DeleteRemote", "DeleteSuccess", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "FirmwareImageFsmStage", parent_mo_or_dn, **kwargs)
