...
class FirmwareInfra(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareInfra", "firmwareInfra", "fw-infra", VersionMeta.Version211a, "InputOutput", 0x7ff, [], ["admin"], ['firmwareSystem'], ['faultInst', 'trigLocalSched'], ["Get"])
    ...
    prop_meta = {
        ...
        "back_up_version": MoPropertyMeta("back_up_version", "backUpVersion", "string", VersionMeta.Version323a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []),
