...
class FirmwareFileUnit(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareFileUnit", "firmwareFileUnit", "fileunit-[type]", VersionMeta.Version302a, "InputOutput", 0x1fL, [], ["read-only"], [u'osController'], [], [None])
    ...
    prop_meta = {
        ...
        "path_name": MoPropertyMeta("path_name", "pathName", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version302a, MoPropertyMeta.NAMING, 0x10L, None, None, """((defaultValue|unknown|init-config),){0,2}(defaultValue|unknown|init-config){0,1}""", [], []), 
        "version": MoPropertyMeta("version", "version", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
    }
