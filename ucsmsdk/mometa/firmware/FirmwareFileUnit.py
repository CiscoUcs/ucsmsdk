...
class FirmwareFileUnit(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareFileUnit", "firmwareFileUnit", "fileunit-[type]", VersionMeta.Version302a, "InputOutput", 0x3f, [], ["read-only"], [], [], [None])
    ...
    prop_meta = {
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version302a, MoPropertyMeta.NAMING, 0x20, None, None, r"""((defaultValue|unknown|init-config),){0,2}(defaultValue|unknown|init-config){0,1}""", [], []), 
