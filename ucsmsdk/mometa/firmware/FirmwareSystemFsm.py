...
class FirmwareSystemFsmConsts:
    ...
    CURRENT_FSM_UPGRADE_SFP_FIRMWARE = "UpgradeSfpFirmware"
    CURRENT_FSM_NOP = "nop"
...
class FirmwareSystemFsm(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareSystemFsm", "firmwareSystemFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xf, [], [""], ['firmwareSystem'], ['firmwareSystemFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["ApplyCatalogPack", "Deploy", "UpgradeSfpFirmware", "nop"], []),
