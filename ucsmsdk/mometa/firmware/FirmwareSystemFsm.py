"""This module contains the general information for FirmwareSystemFsm ManagedObject."""
import sys, os
...
class FirmwareSystemFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_APPLY_CATALOG_PACK = "ApplyCatalogPack"
...
class FirmwareSystemFsm(ManagedObject):
    """This is FirmwareSystemFsm class."""

    consts = FirmwareSystemFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("FirmwareSystemFsm", "firmwareSystemFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'firmwareSystem'], [u'firmwareSystemFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["ApplyCatalogPack", "Deploy", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FirmwareSystemFsm", parent_mo_or_dn, **kwargs)
