"""This module contains the general information for FirmwareCompSource ManagedObject."""
import sys, os
...
class FirmwareCompSourceConsts():
    INT_ID_NONE = "none"
...
class FirmwareCompSource(ManagedObject):
    """This is FirmwareCompSource class."""

    consts = FirmwareCompSourceConsts()
    naming_props = set([u'invTag', u'version'])

    mo_meta = MoMeta("FirmwareCompSource", "firmwareCompSource", "source-[inv_tag]-ver-[version]", VersionMeta.Version101e, "InputOutput", 0x3ffL, [], ["read-only"], [u'firmwareCatalogue'], [u'firmwareCompTarget'], [None])
    ...
    prop_meta = {
        ...
        "inv_tag": MoPropertyMeta("inv_tag", "invTag", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x10L, 1, 510, None, [], []), 
        ...
        "version": MoPropertyMeta("version", "version", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x200L, 1, 510, None, [], []), 
    }
    ...
    def __init__(self, parent_mo_or_dn, inv_tag, version, **kwargs):
        ...
        ManagedObject.__init__(self, "FirmwareCompSource", parent_mo_or_dn, **kwargs)
