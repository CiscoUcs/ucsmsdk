...
class FirmwareCompSource(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareCompSource", "firmwareCompSource", "source-[inv_tag]-ver-[version]", VersionMeta.Version101e, "InputOutput", 0x1ffL, [], ["read-only"], [u'firmwareCatalogue'], [u'firmwareCompTarget'], [None])
