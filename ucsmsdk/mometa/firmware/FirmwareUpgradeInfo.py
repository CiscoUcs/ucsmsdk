...
class FirmwareUpgradeInfo(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareUpgradeInfo", "firmwareUpgradeInfo", "validate-upgrade", VersionMeta.Version211a, "InputOutput", 0x1f, [], ["admin"], [u'topSystem'], [u'firmwareUpgradeDetail'], ["Get"])
