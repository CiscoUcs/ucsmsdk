"""This module contains the general information for FirmwareRack ManagedObject."""
...
class FirmwareRackConsts:
    pass


class FirmwareRack(ManagedObject):
    """This is FirmwareRack class."""

    consts = FirmwareRackConsts()
    naming_props = set([])

    mo_meta = MoMeta("FirmwareRack", "firmwareRack", "fw-rack", VersionMeta.Version211a, "InputOutput", 0x1f, [], ["admin"], [u'firmwareHost'], [], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FirmwareRack", parent_mo_or_dn, **kwargs)
