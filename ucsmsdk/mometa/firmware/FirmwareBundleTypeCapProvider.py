...
class FirmwareBundleTypeCapProvider(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareBundleTypeCapProvider", "firmwareBundleTypeCapProvider", "bundle-type-cap", VersionMeta.Version141i, "InputOutput", 0x1f, [], [""], [u'capabilityCatalogue'], [u'firmwareBundleType'], ["Get"])
