...
class FirmwareDualVicChassisConstraint(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareDualVicChassisConstraint", "firmwareDualVicChassisConstraint", "dual-vic-chassis-constraint", None, "InputOutput", 0x1f, [], ["read-only"], [u'firmwareConstraints'], [], [None])
