...
class FirmwareDistImage(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareDistImage", "firmwareDistImage", "distimage-[name]", VersionMeta.Version101e, "InputOutput", 0x1fL, [], ["read-only"], [u'firmwareDistributable'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "image_deleted": MoPropertyMeta("image_deleted", "imageDeleted", "string", VersionMeta.Version101e, MoPropertyMeta.READ_ONLY, None, None, None, """((defaultValue|none|A|B),){0,3}(defaultValue|none|A|B){0,1}""", [], []), 
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x4L, None, None, None, [], []), 
