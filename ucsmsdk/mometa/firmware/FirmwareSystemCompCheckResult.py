...
class FirmwareSystemCompCheckResult(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareSystemCompCheckResult", "firmwareSystemCompCheckResult", "fw-sys-CompCheckRes-[key_dn]", VersionMeta.Version211a, "InputOutput", 0x1fL, [], ["admin"], [u'firmwareSystem'], [], ["Get"])
