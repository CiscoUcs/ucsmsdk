...
class FirmwareHostPackModImpact(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareHostPackModImpact", "firmwareHostPackModImpact", "fw-sys-HostPackModImpact-[key_dn]", VersionMeta.Version211a, "InputOutput", 0x1fL, [], ["admin", "ls-config-policy", "ls-server-policy"], [], [], [None])
    ...
    prop_meta = {
        ...
        "key_dn": MoPropertyMeta("key_dn", "keyDn", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, 0x4L, 1, 510, None, [], []), 
