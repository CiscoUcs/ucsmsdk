...
class FirmwareHostPackModImpact(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareHostPackModImpact", "firmwareHostPackModImpact", "fw-sys-HostPackModImpact-[key_dn]", VersionMeta.Version211a, "InputOutput", 0x3fL, [], ["admin", "ls-config-policy", "ls-server-policy"], [], [], [None])
