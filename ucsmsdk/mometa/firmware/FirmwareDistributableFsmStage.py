...
class FirmwareDistributableFsmStage(ManagedObject):
    """This is FirmwareDistributableFsmStage class."""

    consts = FirmwareDistributableFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("FirmwareDistributableFsmStage", "firmwareDistributableFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'firmwareDistributableFsm'], [], [None])
