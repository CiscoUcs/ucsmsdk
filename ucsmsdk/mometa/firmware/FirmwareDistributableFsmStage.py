...
class FirmwareDistributableFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareDistributableFsmStage", "firmwareDistributableFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'firmwareDistributableFsm'], [], [None])
