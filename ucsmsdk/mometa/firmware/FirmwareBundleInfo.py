...
class FirmwareBundleInfo(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareBundleInfo", "firmwareBundleInfo", "bundle-[type]", VersionMeta.Version211a, "InputOutput", 0x7fL, [], ["admin", "ls-config-policy", "ls-server-policy"], [], [], [None])
    ...
    prop_meta = {
        ...
        "version": MoPropertyMeta("version", "version", "string", VersionMeta.Version211a, MoPropertyMeta.READ_WRITE, 0x40L, 0, 510, None, [], []), 
    }
