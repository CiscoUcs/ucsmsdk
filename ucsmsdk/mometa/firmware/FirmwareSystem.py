...
class FirmwareSystem(ManagedObject):
    ...
    prop_meta = {
        ...
        "service_pack_oper_state": MoPropertyMeta("service_pack_oper_state", "servicePackOperState", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["failed", "in-progress", "pending-user-ack", "ready", "scheduled", "start-pending-ext-permission"], []), 
        "service_pack_state": MoPropertyMeta("service_pack_state", "servicePackState", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["compatible", "incompatible", "multiple-releases", "same-release", "unknown"], []), 
