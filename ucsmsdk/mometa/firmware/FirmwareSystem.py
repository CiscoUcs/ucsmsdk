...
class FirmwareSystemConsts:
    ...
    FSM_PREV_APPLY_CATALOG_PACK_RESOLVE_DISTRIBUTABLE = "ApplyCatalogPackResolveDistributable"
    FSM_PREV_APPLY_CATALOG_PACK_RESOLVE_DISTRIBUTABLE_NAMES = "ApplyCatalogPackResolveDistributableNames"
    FSM_PREV_APPLY_CATALOG_PACK_RESOLVE_IMAGES = "ApplyCatalogPackResolveImages"
    FSM_PREV_APPLY_CATALOG_PACK_SUCCESS = "ApplyCatalogPackSuccess"
    FSM_PREV_DEPLOY_ACTIVATE_IOM = "DeployActivateIOM"
    FSM_PREV_DEPLOY_ACTIVATE_LOCAL_FI = "DeployActivateLocalFI"
    FSM_PREV_DEPLOY_ACTIVATE_REMOTE_FI = "DeployActivateRemoteFI"
    FSM_PREV_DEPLOY_ACTIVATE_UCSM = "DeployActivateUCSM"
    FSM_PREV_DEPLOY_ACTIVATE_UCSMSERVICE_PACK = "DeployActivateUCSMServicePack"
    FSM_PREV_DEPLOY_BEGIN = "DeployBegin"
    FSM_PREV_DEPLOY_COPY_ALL_IMAGES_TO_PEER = "DeployCopyAllImagesToPeer"
    FSM_PREV_DEPLOY_DOWNLOAD_IMAGES = "DeployDownloadImages"
    FSM_PREV_DEPLOY_FAB_EVAC_OFF_REMOTE_FI = "DeployFabEvacOffRemoteFI"
    FSM_PREV_DEPLOY_FAB_EVAC_ON_REMOTE_FI = "DeployFabEvacOnRemoteFI"
    FSM_PREV_DEPLOY_FAIL = "DeployFail"
    FSM_PREV_DEPLOY_FAIL_OVER_TO_REMOTE_FI = "DeployFailOverToRemoteFI"
    FSM_PREV_DEPLOY_INTERNAL_BACKUP = "DeployInternalBackup"
    FSM_PREV_DEPLOY_POLL_ACTIVATE_OF_IOM = "DeployPollActivateOfIOM"
    FSM_PREV_DEPLOY_POLL_ACTIVATE_OF_LOCAL_FI = "DeployPollActivateOfLocalFI"
    FSM_PREV_DEPLOY_POLL_ACTIVATE_OF_REMOTE_FI = "DeployPollActivateOfRemoteFI"
    FSM_PREV_DEPLOY_POLL_ACTIVATE_OF_UCSM = "DeployPollActivateOfUCSM"
    FSM_PREV_DEPLOY_POLL_ACTIVATE_OF_UCSMSERVICE_PACK = "DeployPollActivateOfUCSMServicePack"
    FSM_PREV_DEPLOY_POLL_FAB_EVAC_OFF_REMOTE_FI = "DeployPollFabEvacOffRemoteFI"
    FSM_PREV_DEPLOY_POLL_FAB_EVAC_ON_REMOTE_FI = "DeployPollFabEvacOnRemoteFI"
    FSM_PREV_DEPLOY_POLL_FAIL_OVER_TO_REMOTE_FI = "DeployPollFailOverToRemoteFI"
    FSM_PREV_DEPLOY_POLL_INTERNAL_BACKUP = "DeployPollInternalBackup"
    FSM_PREV_DEPLOY_POLL_UPDATE_OF_IOM = "DeployPollUpdateOfIOM"
    FSM_PREV_DEPLOY_POLL_WAIT_FOR_USER_ACK = "DeployPollWaitForUserAck"
    FSM_PREV_DEPLOY_RESOLVE_DISTRIBUTABLE = "DeployResolveDistributable"
    FSM_PREV_DEPLOY_RESOLVE_DISTRIBUTABLE_NAMES = "DeployResolveDistributableNames"
    FSM_PREV_DEPLOY_RESOLVE_IMAGES = "DeployResolveImages"
    FSM_PREV_DEPLOY_SUCCESS = "DeploySuccess"
    FSM_PREV_DEPLOY_UPDATE_IOM = "DeployUpdateIOM"
    FSM_PREV_DEPLOY_WAIT_FOR_DEPLOY = "DeployWaitForDeploy"
    FSM_PREV_DEPLOY_WAIT_FOR_USER_ACK = "DeployWaitForUserAck"
    FSM_PREV_UPGRADE_SFP_FIRMWARE_ACTIVATE_SFP_FW_LOCAL_FI = "UpgradeSfpFirmwareActivateSfpFwLocalFI"
    FSM_PREV_UPGRADE_SFP_FIRMWARE_ACTIVATE_SFP_FW_REMOTE_FI = "UpgradeSfpFirmwareActivateSfpFwRemoteFI"
    FSM_PREV_UPGRADE_SFP_FIRMWARE_ADMIN_DOWN_FC_PORTS_LOCAL_FI = "UpgradeSfpFirmwareAdminDownFcPortsLocalFI"
    FSM_PREV_UPGRADE_SFP_FIRMWARE_ADMIN_DOWN_FC_PORTS_REMOTE_FI = "UpgradeSfpFirmwareAdminDownFcPortsRemoteFI"
    FSM_PREV_UPGRADE_SFP_FIRMWARE_ADMIN_UP_FC_PORTS_LOCAL_FI = "UpgradeSfpFirmwareAdminUpFcPortsLocalFI"
    FSM_PREV_UPGRADE_SFP_FIRMWARE_ADMIN_UP_FC_PORTS_REMOTE_FI = "UpgradeSfpFirmwareAdminUpFcPortsRemoteFI"
    FSM_PREV_UPGRADE_SFP_FIRMWARE_BEGIN = "UpgradeSfpFirmwareBegin"
    FSM_PREV_UPGRADE_SFP_FIRMWARE_FAB_EVAC_OFF_REMOTE_FI = "UpgradeSfpFirmwareFabEvacOffRemoteFI"
    FSM_PREV_UPGRADE_SFP_FIRMWARE_FAB_EVAC_ON_REMOTE_FI = "UpgradeSfpFirmwareFabEvacOnRemoteFI"
    FSM_PREV_UPGRADE_SFP_FIRMWARE_FAIL = "UpgradeSfpFirmwareFail"
    FSM_PREV_UPGRADE_SFP_FIRMWARE_FAIL_OVER_TO_REMOTE_FI = "UpgradeSfpFirmwareFailOverToRemoteFI"
    FSM_PREV_UPGRADE_SFP_FIRMWARE_POLL_ACTIVATE_SFP_FW_LOCAL_FI = "UpgradeSfpFirmwarePollActivateSfpFwLocalFI"
    FSM_PREV_UPGRADE_SFP_FIRMWARE_POLL_ACTIVATE_SFP_FW_REMOTE_FI = "UpgradeSfpFirmwarePollActivateSfpFwRemoteFI"
    FSM_PREV_UPGRADE_SFP_FIRMWARE_POLL_FAB_EVAC_OFF_REMOTE_FI = "UpgradeSfpFirmwarePollFabEvacOffRemoteFI"
    FSM_PREV_UPGRADE_SFP_FIRMWARE_POLL_FAB_EVAC_ON_REMOTE_FI = "UpgradeSfpFirmwarePollFabEvacOnRemoteFI"
    FSM_PREV_UPGRADE_SFP_FIRMWARE_POLL_FAIL_OVER_TO_REMOTE_FI = "UpgradeSfpFirmwarePollFailOverToRemoteFI"
    FSM_PREV_UPGRADE_SFP_FIRMWARE_POLL_REBOOT_LOCAL_FI = "UpgradeSfpFirmwarePollRebootLocalFI"
    FSM_PREV_UPGRADE_SFP_FIRMWARE_POLL_REBOOT_REMOTE_FI = "UpgradeSfpFirmwarePollRebootRemoteFI"
    FSM_PREV_UPGRADE_SFP_FIRMWARE_POLL_WAIT_FOR_USER_ACK = "UpgradeSfpFirmwarePollWaitForUserAck"
    FSM_PREV_UPGRADE_SFP_FIRMWARE_REBOOT_LOCAL_FI = "UpgradeSfpFirmwareRebootLocalFI"
    FSM_PREV_UPGRADE_SFP_FIRMWARE_REBOOT_REMOTE_FI = "UpgradeSfpFirmwareRebootRemoteFI"
    FSM_PREV_UPGRADE_SFP_FIRMWARE_SUCCESS = "UpgradeSfpFirmwareSuccess"
    FSM_PREV_UPGRADE_SFP_FIRMWARE_WAIT_FOR_SFP_FW_UPGRADE = "UpgradeSfpFirmwareWaitForSfpFwUpgrade"
    FSM_PREV_UPGRADE_SFP_FIRMWARE_WAIT_FOR_USER_ACK = "UpgradeSfpFirmwareWaitForUserAck"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_APPLY_CATALOG_PACK_ACTIVATE_CATALOG = "ApplyCatalogPackActivateCatalog"
    FSM_STATUS_APPLY_CATALOG_PACK_BEGIN = "ApplyCatalogPackBegin"
    FSM_STATUS_APPLY_CATALOG_PACK_FAIL = "ApplyCatalogPackFail"
    FSM_STATUS_APPLY_CATALOG_PACK_RESOLVE_DISTRIBUTABLE = "ApplyCatalogPackResolveDistributable"
    FSM_STATUS_APPLY_CATALOG_PACK_RESOLVE_DISTRIBUTABLE_NAMES = "ApplyCatalogPackResolveDistributableNames"
    FSM_STATUS_APPLY_CATALOG_PACK_RESOLVE_IMAGES = "ApplyCatalogPackResolveImages"
    FSM_STATUS_APPLY_CATALOG_PACK_SUCCESS = "ApplyCatalogPackSuccess"
    FSM_STATUS_DEPLOY_ACTIVATE_IOM = "DeployActivateIOM"
    FSM_STATUS_DEPLOY_ACTIVATE_LOCAL_FI = "DeployActivateLocalFI"
    FSM_STATUS_DEPLOY_ACTIVATE_REMOTE_FI = "DeployActivateRemoteFI"
    FSM_STATUS_DEPLOY_ACTIVATE_UCSM = "DeployActivateUCSM"
    FSM_STATUS_DEPLOY_ACTIVATE_UCSMSERVICE_PACK = "DeployActivateUCSMServicePack"
    FSM_STATUS_DEPLOY_BEGIN = "DeployBegin"
    FSM_STATUS_DEPLOY_COPY_ALL_IMAGES_TO_PEER = "DeployCopyAllImagesToPeer"
    FSM_STATUS_DEPLOY_DOWNLOAD_IMAGES = "DeployDownloadImages"
    FSM_STATUS_DEPLOY_FAB_EVAC_OFF_REMOTE_FI = "DeployFabEvacOffRemoteFI"
    FSM_STATUS_DEPLOY_FAB_EVAC_ON_REMOTE_FI = "DeployFabEvacOnRemoteFI"
    FSM_STATUS_DEPLOY_FAIL = "DeployFail"
    FSM_STATUS_DEPLOY_FAIL_OVER_TO_REMOTE_FI = "DeployFailOverToRemoteFI"
    FSM_STATUS_DEPLOY_INTERNAL_BACKUP = "DeployInternalBackup"
    FSM_STATUS_DEPLOY_POLL_ACTIVATE_OF_IOM = "DeployPollActivateOfIOM"
    FSM_STATUS_DEPLOY_POLL_ACTIVATE_OF_LOCAL_FI = "DeployPollActivateOfLocalFI"
    FSM_STATUS_DEPLOY_POLL_ACTIVATE_OF_REMOTE_FI = "DeployPollActivateOfRemoteFI"
    FSM_STATUS_DEPLOY_POLL_ACTIVATE_OF_UCSM = "DeployPollActivateOfUCSM"
    FSM_STATUS_DEPLOY_POLL_ACTIVATE_OF_UCSMSERVICE_PACK = "DeployPollActivateOfUCSMServicePack"
    FSM_STATUS_DEPLOY_POLL_FAB_EVAC_OFF_REMOTE_FI = "DeployPollFabEvacOffRemoteFI"
    FSM_STATUS_DEPLOY_POLL_FAB_EVAC_ON_REMOTE_FI = "DeployPollFabEvacOnRemoteFI"
    FSM_STATUS_DEPLOY_POLL_FAIL_OVER_TO_REMOTE_FI = "DeployPollFailOverToRemoteFI"
    FSM_STATUS_DEPLOY_POLL_INTERNAL_BACKUP = "DeployPollInternalBackup"
    FSM_STATUS_DEPLOY_POLL_UPDATE_OF_IOM = "DeployPollUpdateOfIOM"
    FSM_STATUS_DEPLOY_POLL_WAIT_FOR_USER_ACK = "DeployPollWaitForUserAck"
    FSM_STATUS_DEPLOY_RESOLVE_DISTRIBUTABLE = "DeployResolveDistributable"
    FSM_STATUS_DEPLOY_RESOLVE_DISTRIBUTABLE_NAMES = "DeployResolveDistributableNames"
    FSM_STATUS_DEPLOY_RESOLVE_IMAGES = "DeployResolveImages"
    FSM_STATUS_DEPLOY_SUCCESS = "DeploySuccess"
    FSM_STATUS_DEPLOY_UPDATE_IOM = "DeployUpdateIOM"
    FSM_STATUS_DEPLOY_WAIT_FOR_DEPLOY = "DeployWaitForDeploy"
    FSM_STATUS_DEPLOY_WAIT_FOR_USER_ACK = "DeployWaitForUserAck"
    FSM_STATUS_UPGRADE_SFP_FIRMWARE_ACTIVATE_SFP_FW_LOCAL_FI = "UpgradeSfpFirmwareActivateSfpFwLocalFI"
    FSM_STATUS_UPGRADE_SFP_FIRMWARE_ACTIVATE_SFP_FW_REMOTE_FI = "UpgradeSfpFirmwareActivateSfpFwRemoteFI"
    FSM_STATUS_UPGRADE_SFP_FIRMWARE_ADMIN_DOWN_FC_PORTS_LOCAL_FI = "UpgradeSfpFirmwareAdminDownFcPortsLocalFI"
    FSM_STATUS_UPGRADE_SFP_FIRMWARE_ADMIN_DOWN_FC_PORTS_REMOTE_FI = "UpgradeSfpFirmwareAdminDownFcPortsRemoteFI"
    FSM_STATUS_UPGRADE_SFP_FIRMWARE_ADMIN_UP_FC_PORTS_LOCAL_FI = "UpgradeSfpFirmwareAdminUpFcPortsLocalFI"
    FSM_STATUS_UPGRADE_SFP_FIRMWARE_ADMIN_UP_FC_PORTS_REMOTE_FI = "UpgradeSfpFirmwareAdminUpFcPortsRemoteFI"
    FSM_STATUS_UPGRADE_SFP_FIRMWARE_BEGIN = "UpgradeSfpFirmwareBegin"
    FSM_STATUS_UPGRADE_SFP_FIRMWARE_FAB_EVAC_OFF_REMOTE_FI = "UpgradeSfpFirmwareFabEvacOffRemoteFI"
    FSM_STATUS_UPGRADE_SFP_FIRMWARE_FAB_EVAC_ON_REMOTE_FI = "UpgradeSfpFirmwareFabEvacOnRemoteFI"
    FSM_STATUS_UPGRADE_SFP_FIRMWARE_FAIL = "UpgradeSfpFirmwareFail"
    FSM_STATUS_UPGRADE_SFP_FIRMWARE_FAIL_OVER_TO_REMOTE_FI = "UpgradeSfpFirmwareFailOverToRemoteFI"
    FSM_STATUS_UPGRADE_SFP_FIRMWARE_POLL_ACTIVATE_SFP_FW_LOCAL_FI = "UpgradeSfpFirmwarePollActivateSfpFwLocalFI"
    FSM_STATUS_UPGRADE_SFP_FIRMWARE_POLL_ACTIVATE_SFP_FW_REMOTE_FI = "UpgradeSfpFirmwarePollActivateSfpFwRemoteFI"
    FSM_STATUS_UPGRADE_SFP_FIRMWARE_POLL_FAB_EVAC_OFF_REMOTE_FI = "UpgradeSfpFirmwarePollFabEvacOffRemoteFI"
    FSM_STATUS_UPGRADE_SFP_FIRMWARE_POLL_FAB_EVAC_ON_REMOTE_FI = "UpgradeSfpFirmwarePollFabEvacOnRemoteFI"
    FSM_STATUS_UPGRADE_SFP_FIRMWARE_POLL_FAIL_OVER_TO_REMOTE_FI = "UpgradeSfpFirmwarePollFailOverToRemoteFI"
    FSM_STATUS_UPGRADE_SFP_FIRMWARE_POLL_REBOOT_LOCAL_FI = "UpgradeSfpFirmwarePollRebootLocalFI"
    FSM_STATUS_UPGRADE_SFP_FIRMWARE_POLL_REBOOT_REMOTE_FI = "UpgradeSfpFirmwarePollRebootRemoteFI"
    FSM_STATUS_UPGRADE_SFP_FIRMWARE_POLL_WAIT_FOR_USER_ACK = "UpgradeSfpFirmwarePollWaitForUserAck"
    FSM_STATUS_UPGRADE_SFP_FIRMWARE_REBOOT_LOCAL_FI = "UpgradeSfpFirmwareRebootLocalFI"
    FSM_STATUS_UPGRADE_SFP_FIRMWARE_REBOOT_REMOTE_FI = "UpgradeSfpFirmwareRebootRemoteFI"
    FSM_STATUS_UPGRADE_SFP_FIRMWARE_SUCCESS = "UpgradeSfpFirmwareSuccess"
    FSM_STATUS_UPGRADE_SFP_FIRMWARE_WAIT_FOR_SFP_FW_UPGRADE = "UpgradeSfpFirmwareWaitForSfpFwUpgrade"
    FSM_STATUS_UPGRADE_SFP_FIRMWARE_WAIT_FOR_USER_ACK = "UpgradeSfpFirmwareWaitForUserAck"
    FSM_STATUS_NOP = "nop"
    ...
    SERVICE_PACK_OPER_STATE_IN_PROGRESS = "in-progress"
    SERVICE_PACK_OPER_STATE_PENDING_USER_ACK = "pending-user-ack"
    SERVICE_PACK_OPER_STATE_READY = "ready"
    SERVICE_PACK_OPER_STATE_SCHEDULED = "scheduled"
    SERVICE_PACK_OPER_STATE_START_PENDING_EXT_PERMISSION = "start-pending-ext-permission"
    SERVICE_PACK_STATE_COMPATIBLE = "compatible"
    SERVICE_PACK_STATE_INCOMPATIBLE = "incompatible"
    SERVICE_PACK_STATE_MULTIPLE_RELEASES = "multiple-releases"
    SERVICE_PACK_STATE_SAME_RELEASE = "same-release"
    SERVICE_PACK_STATE_UNKNOWN = "unknown"
...
class FirmwareSystem(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareSystem", "firmwareSystem", "fw-system", VersionMeta.Version211a, "InputOutput", 0x1f, [], ["admin", "ls-config-policy", "ls-server-policy"], ['topSystem'], ['eventInst', 'faultInst', 'firmwareAck', 'firmwareHost', 'firmwareInfra', 'firmwareSfpFwUpgrade', 'firmwareSystemCompCheckResult', 'firmwareSystemFsm', 'firmwareSystemFsmTask'], ["Get"])
    ...
    prop_meta = {
        ...
        "service_pack_oper_state": MoPropertyMeta("service_pack_oper_state", "servicePackOperState", "string", VersionMeta.Version321d, MoPropertyMeta.READ_ONLY, None, None, None, None, ["failed", "in-progress", "pending-user-ack", "ready", "scheduled", "start-pending-ext-permission"], []),
        "service_pack_state": MoPropertyMeta("service_pack_state", "servicePackState", "string", VersionMeta.Version321d, MoPropertyMeta.READ_ONLY, None, None, None, None, ["compatible", "incompatible", "multiple-releases", "same-release", "unknown"], []),
    ...
    prop_map = {
        ...
        "servicePackState": "service_pack_state", 
        "state": "state", 
        "status": "status", 
    }
