...
class FirmwareInstallImpact(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareInstallImpact", "firmwareInstallImpact", "fw-sys-InstallImpact-[key_dn]", VersionMeta.Version211a, "InputOutput", 0x1fL, [], ["admin", "ls-config-policy", "ls-server-policy"], [], [], ["Get"])
