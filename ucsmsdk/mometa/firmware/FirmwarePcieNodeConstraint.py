"""This module contains the general information for FirmwarePcieNodeConstraint ManagedObject."""
...
class FirmwarePcieNodeConstraintConsts:
...
class FirmwarePcieNodeConstraint(ManagedObject):
    """This is FirmwarePcieNodeConstraint class."""

    consts = FirmwarePcieNodeConstraintConsts()
    naming_props = set([])

    mo_meta = MoMeta("FirmwarePcieNodeConstraint", "firmwarePcieNodeConstraint", "constraint-pcie-node", VersionMeta.Version434a, "InputOutput", 0x1f, [], [""], ['firmwareConstraints'], [], [None])

    prop_meta = {
        "check_running_ver": MoPropertyMeta("check_running_ver", "checkRunningVer", "string", VersionMeta.Version434a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["false", "no", "true", "yes"], []),
        ...
        "min_bios_version": MoPropertyMeta("min_bios_version", "minBiosVersion", "string", VersionMeta.Version434a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []),
        "min_cimc_version": MoPropertyMeta("min_cimc_version", "minCimcVersion", "string", VersionMeta.Version434a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []),
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FirmwarePcieNodeConstraint", parent_mo_or_dn, **kwargs)
