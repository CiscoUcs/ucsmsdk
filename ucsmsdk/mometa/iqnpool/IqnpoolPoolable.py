...
class IqnpoolPoolable(ManagedObject):
    ...
    mo_meta = MoMeta("IqnpoolPoolable", "iqnpoolPoolable", "pool-[id]", VersionMeta.Version201m, "InputOutput", 0x1fL, [], ["read-only"], [u'iqnpoolAddr'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "id": MoPropertyMeta("id", "id", "ulong", VersionMeta.Version201m, MoPropertyMeta.NAMING, 0x4L, None, None, None, [], []), 
