...
class IqnpoolPool(ManagedObject):
    ...
    mo_meta = MoMeta("IqnpoolPool", "iqnpoolPool", "iqn-pool-[name]", VersionMeta.Version201m, "InputOutput", 0x1ffL, [], ["admin", "ls-storage-policy"], [u'orgOrg'], [u'faultInst', u'iqnpoolBlock', u'iqnpoolPooled'], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version201m, MoPropertyMeta.NAMING, 0x10L, None, None, """[\-\.:_a-zA-Z0-9]{1,32}""", [], []), 
        ...
        "prefix": MoPropertyMeta("prefix", "prefix", "string", VersionMeta.Version201m, MoPropertyMeta.READ_WRITE, 0x40L, None, None, """[0-9a-zA-Z\.:-]{1,150}$""", [], []), 
