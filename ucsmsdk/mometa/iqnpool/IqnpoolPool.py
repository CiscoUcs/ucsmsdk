...
class IqnpoolPool(ManagedObject):
    ...
    mo_meta = MoMeta("IqnpoolPool", "iqnpoolPool", "iqn-pool-[name]", VersionMeta.Version201m, "InputOutput", 0x3ffL, [], ["admin", "ls-storage-policy"], [u'orgOrg'], [u'faultInst', u'iqnpoolBlock', u'iqnpoolPooled'], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "descr": MoPropertyMeta("descr", "descr", "string", VersionMeta.Version201m, MoPropertyMeta.READ_WRITE, 0x8L, None, None, r"""[ !#$%&\(\)\*\+,\-\./:;\?@\[\]_\{\|\}~a-zA-Z0-9]{0,256}""", [], []), 
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version201m, MoPropertyMeta.NAMING, 0x20L, None, None, r"""[\-\.:_a-zA-Z0-9]{1,32}""", [], []), 
        ...
        "prefix": MoPropertyMeta("prefix", "prefix", "string", VersionMeta.Version201m, MoPropertyMeta.READ_WRITE, 0x80L, None, None, r"""[0-9a-zA-Z\.:-]{1,150}$""", [], []), 
