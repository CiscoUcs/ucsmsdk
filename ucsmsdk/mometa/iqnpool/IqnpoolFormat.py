"""This module contains the general information for IqnpoolFormat ManagedObject."""
import sys, os
...
class IqnpoolFormat(ManagedObject):
    ...
    mo_meta = MoMeta("IqnpoolFormat", "iqnpoolFormat", "format-[format]", VersionMeta.Version201m, "InputOutput", 0x3fL, [], ["admin"], [u'iqnpoolUniverse'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "format": MoPropertyMeta("format", "format", "string", VersionMeta.Version201m, MoPropertyMeta.NAMING, 0x8L, 1, 510, None, [], []), 
    ...
    def __init__(self, parent_mo_or_dn, format, **kwargs):
        self._dirty_mask = 0
        self.format = format
        ...
        ManagedObject.__init__(self, "IqnpoolFormat", parent_mo_or_dn, **kwargs)
