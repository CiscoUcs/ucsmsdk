...
class IqnpoolFormat(ManagedObject):
    ...
    mo_meta = MoMeta("IqnpoolFormat", "iqnpoolFormat", "format-[format]", VersionMeta.Version201m, "InputOutput", 0x1fL, [], ["admin"], [u'iqnpoolUniverse'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "format": MoPropertyMeta("format", "format", "string", VersionMeta.Version201m, MoPropertyMeta.NAMING, 0x4L, 1, 510, None, [], []), 
