...
class IqnpoolFormat(ManagedObject):
    ...
    mo_meta = MoMeta("IqnpoolFormat", "iqnpoolFormat", "format-[format]", VersionMeta.Version201m, "InputOutput", 0x3f, [], ["admin"], [u'iqnpoolUniverse'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "format": MoPropertyMeta("format", "format", "string", VersionMeta.Version201m, MoPropertyMeta.NAMING, 0x8, 1, 510, None, [], []), 
