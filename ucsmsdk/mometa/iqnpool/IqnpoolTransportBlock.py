...
class IqnpoolTransportBlock(ManagedObject):
    ...
    mo_meta = MoMeta("IqnpoolTransportBlock", "iqnpoolTransportBlock", "block-[suffix]-from-[r_from]-to-[to]", VersionMeta.Version222c, "InputOutput", 0xffL, [], ["admin", "ls-storage-policy"], [], [], [None])
    ...
    prop_meta = {
        ...
        "r_from": MoPropertyMeta("r_from", "from", "ushort", VersionMeta.Version222c, MoPropertyMeta.NAMING, 0x8L, None, None, None, [], ["0-65535"]), 
        ...
        "suffix": MoPropertyMeta("suffix", "suffix", "string", VersionMeta.Version222c, MoPropertyMeta.NAMING, 0x40L, None, None, r"""[0-9a-zA-Z\.:-]{0,64}$""", [], []), 
        "to": MoPropertyMeta("to", "to", "ushort", VersionMeta.Version222c, MoPropertyMeta.NAMING, 0x80L, None, None, None, [], ["0-65535"]), 
    }
