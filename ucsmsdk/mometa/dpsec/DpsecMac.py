"""This module contains the general information for DpsecMac ManagedObject."""
import sys, os
...
class DpsecMac(ManagedObject):
    """This is DpsecMac class."""

    consts = DpsecMacConsts()
    naming_props = set([])

    mo_meta = MoMeta("DpsecMac", "dpsecMac", "mac-sec", VersionMeta.Version101e, "InputOutput", 0x1ffL, [], ["admin", "ls-network", "ls-network-policy"], [u'nwctrlDefinition'], [], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "forge": MoPropertyMeta("forge", "forge", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x10L, None, None, None, ["allow", "deny"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "DpsecMac", parent_mo_or_dn, **kwargs)
