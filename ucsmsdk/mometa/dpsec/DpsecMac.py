...
class DpsecMac(ManagedObject):
    ...
    mo_meta = MoMeta("DpsecMac", "dpsecMac", "mac-sec", VersionMeta.Version101e, "InputOutput", 0x1ff, [], ["admin", "ls-network", "ls-network-policy"], [u'nwctrlDefinition'], [], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "forge": MoPropertyMeta("forge", "forge", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["allow", "deny"], []), 
