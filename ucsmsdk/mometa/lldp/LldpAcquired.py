...
class LldpAcquired(ManagedObject):
    ...
    mo_meta = MoMeta("LldpAcquired", "lldpAcquired", "lldp", VersionMeta.Version141i, "InputOutput", 0xfL, [], ["read-only"], [u'etherPIo', u'etherServerIntFIo', u'fcPIo'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "chassis_mac": MoPropertyMeta("chassis_mac", "chassisMac", "string", VersionMeta.Version141i, MoPropertyMeta.READ_ONLY, None, None, None, """(([0-9a-fA-F][0-9a-fA-F]:){5}([0-9a-fA-F][0-9a-fA-F]))|0""", [], []), 
        ...
        "port_mac": MoPropertyMeta("port_mac", "portMac", "string", VersionMeta.Version141i, MoPropertyMeta.READ_ONLY, None, None, None, """(([0-9a-fA-F][0-9a-fA-F]:){5}([0-9a-fA-F][0-9a-fA-F]))|0""", [], []), 
