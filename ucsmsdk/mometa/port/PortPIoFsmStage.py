...
class PortPIoFsmStage(ManagedObject):
    """This is PortPIoFsmStage class."""

    consts = PortPIoFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("PortPIoFsmStage", "portPIoFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'portPIoFsm'], [], [None])
