...
class PortSubGroup(ManagedObject):
    ...
    mo_meta = MoMeta("PortSubGroup", "portSubGroup", "aggr-port-[aggr_port_id]", VersionMeta.Version302a, "InputOutput", 0x7f, [], ["read-only"], [u'portGroup'], [u'etherPIo', u'fcPIo'], [None])

    prop_meta = {
        "aggr_port_id": MoPropertyMeta("aggr_port_id", "aggrPortId", "uint", VersionMeta.Version302a, MoPropertyMeta.NAMING, 0x2, None, None, None, [], []), 
