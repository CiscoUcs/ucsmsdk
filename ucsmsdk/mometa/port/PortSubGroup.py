...
class PortSubGroup(ManagedObject):
    """This is PortSubGroup class."""

    consts = PortSubGroupConsts()
    naming_props = set([u'aggrPortId'])

    mo_meta = MoMeta("PortSubGroup", "portSubGroup", "aggr-port-[aggr_port_id]", VersionMeta.Version302a, "InputOutput", 0x3fL, [], ["read-only"], [u'portGroup'], [u'etherPIo', u'fcPIo'], [None])

    prop_meta = {
        "aggr_port_id": MoPropertyMeta("aggr_port_id", "aggrPortId", "uint", VersionMeta.Version302a, MoPropertyMeta.NAMING, 0x1L, None, None, None, [], []), 
    ...
    def __init__(self, parent_mo_or_dn, aggr_port_id, **kwargs):
        self._dirty_mask = 0
