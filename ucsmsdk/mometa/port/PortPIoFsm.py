"""This module contains the general information for PortPIoFsm ManagedObject."""
import sys, os
...
class PortPIoFsm(ManagedObject):
    """This is PortPIoFsm class."""

    consts = PortPIoFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("PortPIoFsm", "portPIoFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'etherPIo', u'fcPIo'], [u'portPIoFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "PortPIoFsm", parent_mo_or_dn, **kwargs)
