...
class FabricLanCloudConsts:
    QIN_QFORWARDING_DISABLED = "disabled"
    QIN_QFORWARDING_ENABLED = "enabled"
    ENABLE_STPFAULTS_DISABLED = "disabled"
    ENABLE_STPFAULTS_ENABLED = "enabled"
    ...
    FSM_PREV_SWITCH_MODE_SW_CONFIG_LOCAL = "SwitchModeSwConfigLocal"
    FSM_PREV_SWITCH_MODE_SW_CONFIG_PEER = "SwitchModeSwConfigPeer"
    FSM_PREV_SWITCH_MODE_WAIT_FOR_USER_ACK = "SwitchModeWaitForUserAck"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_SWITCH_MODE_BEGIN = "SwitchModeBegin"
    FSM_STATUS_SWITCH_MODE_FAIL = "SwitchModeFail"
    FSM_STATUS_SWITCH_MODE_SUCCESS = "SwitchModeSuccess"
    FSM_STATUS_SWITCH_MODE_SW_CONFIG_LOCAL = "SwitchModeSwConfigLocal"
    FSM_STATUS_SWITCH_MODE_SW_CONFIG_PEER = "SwitchModeSwConfigPeer"
    FSM_STATUS_SWITCH_MODE_WAIT_FOR_USER_ACK = "SwitchModeWaitForUserAck"
    FSM_STATUS_NOP = "nop"
...
class FabricLanCloud(ManagedObject):
    ...
    prop_meta = {
        ...
        "enable_stp_faults": MoPropertyMeta("enable_stp_faults", "enableSTPFaults", "string", VersionMeta.Version602a, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["disabled", "enabled"], []),
        "fabric_pc_vhba_reset": MoPropertyMeta("fabric_pc_vhba_reset", "fabricPcVhbaReset", "string", VersionMeta.Version422d, MoPropertyMeta.READ_WRITE, 0x20, None, None, None, ["disabled", "enabled"], []),
        ...
        "mac_aging": MoPropertyMeta("mac_aging", "macAging", "string", VersionMeta.Version111j, MoPropertyMeta.READ_WRITE, 0x40, None, None, r"""[0-9]{1,6}|(([1-9]*[0-9]{2}:)|)([0-1][0-9]||[2][0-3]):([0-5][0-9]):([0-5][0-9])||(([0-5][0-9]):|)([0-5][0-9])""", ["mode-default", "never"], ["0-4294967295"]),
        "mode": MoPropertyMeta("mode", "mode", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x80, None, None, None, ["end-host", "switch"], []),
        ...
        "service_unsupported_transceiver": MoPropertyMeta("service_unsupported_transceiver", "serviceUnsupportedTransceiver", "string", VersionMeta.Version422d, MoPropertyMeta.READ_WRITE, 0x200, None, None, None, ["disabled", "enabled"], []),
        ...
        "vlan_compression": MoPropertyMeta("vlan_compression", "vlanCompression", "string", VersionMeta.Version211a, MoPropertyMeta.READ_WRITE, 0x800, None, None, None, ["disabled", "enabled"], []),
    }

    prop_map = {
        "QinQForwarding": "qin_q_forwarding", 
        "childAction": "child_action", 
        "dn": "dn", 
        "enableSTPFaults": "enable_stp_faults", 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        self._dirty_mask = 0
        self.qin_q_forwarding = None
        self.child_action = None
        self.enable_stp_faults = None
