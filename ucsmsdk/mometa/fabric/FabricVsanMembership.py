...
class FabricVsanMembership(ManagedObject):
    ...
    mo_meta = MoMeta("FabricVsanMembership", "fabricVsanMembership", "vsanmember-[vsan_id]", VersionMeta.Version211a, "InputOutput", 0x3fL, [], ["read-only"], [u'fabricFcSanEp', u'fabricFcSanPc', u'fabricFcoeEstcEp', u'fabricFcoeSanEp', u'fabricFcoeSanPc'], [u'faultInst'], [None])
    ...
    prop_meta = {
        ...
        "vsan_id": MoPropertyMeta("vsan_id", "vsanId", "uint", VersionMeta.Version211a, MoPropertyMeta.NAMING, 0x20L, None, None, None, [], ["1-4093"]), 
    }
