...
class FabricLastAckedSlot(ManagedObject):
    ...
    mo_meta = MoMeta("FabricLastAckedSlot", "fabricLastAckedSlot", "last-acked-slot", VersionMeta.Version101e, "InputOutput", 0xfL, [], ["read-only"], [u'fabricCartridgePhEp', u'fabricComputePhEp', u'fabricEnclosurePhEp'], [], ["Get"])
