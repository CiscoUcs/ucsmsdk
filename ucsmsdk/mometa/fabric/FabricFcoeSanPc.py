...
class FabricFcoeSanPcConsts:
    ...
    SPEED_10GBPS = "10gbps"
    SPEED_1GBPS = "1gbps"
    SPEED_200GBPS = "200gbps"
    SPEED_20GBPS = "20gbps"
    SPEED_25GBPS = "25gbps"
    SPEED_400GBPS = "400gbps"
    SPEED_40GBPS = "40gbps"
    SPEED_50GBPS = "50gbps"
    SPEED_AUTO = "auto"
...
class FabricFcoeSanPc(ManagedObject):
    ...
    prop_meta = {
        ...
        "speed": MoPropertyMeta("speed", "speed", "string", VersionMeta.Version311e, MoPropertyMeta.READ_ONLY, None, None, None, None, ["100gbps", "10gbps", "1gbps", "200gbps", "20gbps", "25gbps", "400gbps", "40gbps", "50gbps", "auto", "indeterminate"], []),
