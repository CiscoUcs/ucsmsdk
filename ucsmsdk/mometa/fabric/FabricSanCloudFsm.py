"""This module contains the general information for FabricSanCloudFsm ManagedObject."""
import sys, os
...
class FabricSanCloudFsm(ManagedObject):
    """This is FabricSanCloudFsm class."""

    consts = FabricSanCloudFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("FabricSanCloudFsm", "fabricSanCloudFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'fabricSanCloud'], [u'fabricSanCloudFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["SwitchMode", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricSanCloudFsm", parent_mo_or_dn, **kwargs)
