...
class FabricZoneIdUniverse(ManagedObject):
    """This is FabricZoneIdUniverse class."""

    consts = FabricZoneIdUniverseConsts()
    naming_props = set([])

    mo_meta = MoMeta("FabricZoneIdUniverse", "fabricZoneIdUniverse", "zone-id-universe", VersionMeta.Version211a, "InputOutput", 0x1fL, [], ["admin"], [u'fabricEp'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricZoneIdUniverse", parent_mo_or_dn, **kwargs)
