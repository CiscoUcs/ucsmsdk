"""This module contains the general information for FabricComputeSlotEpFsmTask ManagedObject."""
import sys, os
...
class FabricComputeSlotEpFsmTaskConsts():
...
class FabricComputeSlotEpFsmTask(ManagedObject):
    """This is FabricComputeSlotEpFsmTask class."""

    consts = FabricComputeSlotEpFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("FabricComputeSlotEpFsmTask", "fabricComputeSlotEpFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], [""], [u'fabricComputeSlotEp'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, None, None, None, None, ["Identify", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricComputeSlotEpFsmTask", parent_mo_or_dn, **kwargs)
