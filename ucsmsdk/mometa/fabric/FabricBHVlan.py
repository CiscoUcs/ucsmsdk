...
class FabricBHVlan(ManagedObject):
    """This is FabricBHVlan class."""

    consts = FabricBHVlanConsts()
    naming_props = set([])

    mo_meta = MoMeta("FabricBHVlan", "fabricBHVlan", "bhnet", VersionMeta.Version141i, "InputOutput", 0x1ffL, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricFcEstcCloud'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "id": MoPropertyMeta("id", "id", "uint", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x4L, None, None, None, [], ["1-3967", "1-4029", "4048-4091", "4048-4093"]), 
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141i, MoPropertyMeta.CREATE_ONLY, 0x8L, None, None, """[\-\.:_a-zA-Z0-9]{0,32}""", [], []), 
        ...
        "sharing": MoPropertyMeta("sharing", "sharing", "string", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x80L, None, None, None, ["community", "isolated", "none", "primary"], []), 
        ...
        "switch_id": MoPropertyMeta("switch_id", "switchId", "string", VersionMeta.Version141i, MoPropertyMeta.READ_ONLY, None, None, None, None, ["A", "B", "NONE", "dual"], []), 
