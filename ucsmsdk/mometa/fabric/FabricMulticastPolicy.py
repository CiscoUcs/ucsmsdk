...
class FabricMulticastPolicy(ManagedObject):
    ...
    prop_meta = {
        ...
        "source_ip_proxy_state": MoPropertyMeta("source_ip_proxy_state", "sourceIpProxyState", "string", VersionMeta.Version423b, MoPropertyMeta.READ_WRITE, 0x800, None, None, None, ["disabled", "enabled"], []),
