"""This module contains the general information for FabricComputeMSlotEpFsm ManagedObject."""
import sys, os
...
class FabricComputeMSlotEpFsmConsts():
    COMPLETION_TIME_ = ""
...
class FabricComputeMSlotEpFsm(ManagedObject):
    """This is FabricComputeMSlotEpFsm class."""

    consts = FabricComputeMSlotEpFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("FabricComputeMSlotEpFsm", "fabricComputeMSlotEpFsm", "fsm", VersionMeta.Version251a, "OutputOnly", 0x7L, [], [""], [u'fabricComputeMSlotEp'], [u'fabricComputeMSlotEpFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricComputeMSlotEpFsm", parent_mo_or_dn, **kwargs)
