...
class FabricComputeMSlotEpFsm(ManagedObject):
    ...
    mo_meta = MoMeta("FabricComputeMSlotEpFsm", "fabricComputeMSlotEpFsm", "fsm", VersionMeta.Version251a, "OutputOnly", 0xfL, [], [""], [u'fabricComputeMSlotEp'], [u'fabricComputeMSlotEpFsmStage'], [None])
