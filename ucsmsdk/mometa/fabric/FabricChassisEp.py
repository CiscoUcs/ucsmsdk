...
class FabricChassisEp(ManagedObject):
    ...
    mo_meta = MoMeta("FabricChassisEp", "fabricChassisEp", "chassis-[chassis_id]", VersionMeta.Version101e, "InputOutput", 0x7fL, [], ["read-only"], [u'fabricDceSrv'], [u'fabricCartridgeSlotEp', u'fabricComputeSlotEp', u'fabricEnclosureSlotEp', u'faultInst'], ["Get"])
    ...
    prop_meta = {
        ...
        "chassis_id": MoPropertyMeta("chassis_id", "chassisId", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x2L, None, None, None, ["N/A"], ["1-255"]), 
