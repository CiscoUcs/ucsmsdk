...
class FabricEpMgrConsts():
    ...
    CONF_MODE_NONE = "none"
    CONF_MODE_VALIDATING_CONF = "validating-conf"
    CONF_STATE_LOGICAL_CONFIG_INVALID = "logical-config-invalid"
    CONF_STATE_OK = "ok"
    FSM_PREV_CONFIGURE_APPLY_CONFIG = "ConfigureApplyConfig"
    FSM_PREV_CONFIGURE_APPLY_PHYSICAL = "ConfigureApplyPhysical"
    FSM_PREV_CONFIGURE_BEGIN = "ConfigureBegin"
    FSM_PREV_CONFIGURE_FAIL = "ConfigureFail"
    FSM_PREV_CONFIGURE_SUCCESS = "ConfigureSuccess"
    FSM_PREV_CONFIGURE_VALIDATE_CONFIGURATION = "ConfigureValidateConfiguration"
    FSM_PREV_CONFIGURE_WAIT_ON_PHYS = "ConfigureWaitOnPhys"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_CONFIGURE_APPLY_PHYSICAL = "ConfigureApplyPhysical"
    ...
    FSM_STATUS_CONFIGURE_VALIDATE_CONFIGURATION = "ConfigureValidateConfiguration"
    FSM_STATUS_CONFIGURE_WAIT_ON_PHYS = "ConfigureWaitOnPhys"
    FSM_STATUS_NOP = "nop"
    ID_A = "A"
    ID_B = "B"
    ID_NONE = "NONE"
...
class FabricEpMgr(ManagedObject):
    ...
    mo_meta = MoMeta("FabricEpMgr", "fabricEpMgr", "[id]", VersionMeta.Version201m, "InputOutput", 0x1fL, [], ["admin"], [u'fabricEp'], [u'eventInst', u'fabricEpMgrFsm', u'fabricEpMgrFsmTask', u'faultInst'], ["Get"])
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version201m, MoPropertyMeta.INTERNAL, None, None, None, None, ["ConfigureApplyConfig", "ConfigureApplyPhysical", "ConfigureBegin", "ConfigureFail", "ConfigureSuccess", "ConfigureValidateConfiguration", "ConfigureWaitOnPhys", "nop"], []), 
        ...
        "id": MoPropertyMeta("id", "id", "string", VersionMeta.Version201m, MoPropertyMeta.NAMING, 0x4L, None, None, None, ["A", "B", "NONE"], []), 
