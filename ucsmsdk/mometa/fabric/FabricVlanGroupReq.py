...
class FabricVlanGroupReq(ManagedObject):
    ...
    mo_meta = MoMeta("FabricVlanGroupReq", "fabricVlanGroupReq", "vlan-group-req-[name]", VersionMeta.Version211a, "InputOutput", 0x3f, [], ["admin", "ls-network"], ['orgOrg'], ['faultInst'], ["Add", "Get", "Remove"])
