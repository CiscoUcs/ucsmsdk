"""This module contains the general information for FabricFcSanEp ManagedObject."""
import sys, os
...
class FabricFcSanEp(ManagedObject):
    """This is FabricFcSanEp class."""

    consts = FabricFcSanEpConsts()
    naming_props = set([u'slotId', u'portId'])

    mo_meta = MoMeta("FabricFcSanEp", "fabricFcSanEp", "phys-slot-[slot_id]-port-[port_id]", VersionMeta.Version101e, "InputOutput", 0x3ffL, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricFcSan'], [u'fabricFcMonSrcEp', u'fabricVsanEp', u'fabricVsanMembership', u'faultInst'], ["Add", "Get", "Set"])
    ...
    prop_meta = {
        ...
        "port_id": MoPropertyMeta("port_id", "portId", "uint", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x20L, None, None, None, [], ["1-48"]), 
        ...
        "slot_id": MoPropertyMeta("slot_id", "slotId", "uint", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x80L, None, None, None, [], ["1-5"]), 
    ...
    def __init__(self, parent_mo_or_dn, slot_id, port_id, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricFcSanEp", parent_mo_or_dn, **kwargs)
