...
class FabricMacSec(ManagedObject):
    ...
    prop_meta = {
        ...
        "hide_key_hex_string_in_fi": MoPropertyMeta("hide_key_hex_string_in_fi", "hideKeyHexStringInFI", "string", VersionMeta.Version601a, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["no", "yes"], []),
