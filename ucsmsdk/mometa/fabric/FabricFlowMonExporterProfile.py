"""This module contains the general information for FabricFlowMonExporterProfile ManagedObject."""
import sys, os
...
class FabricFlowMonExporterProfileConsts():
    INT_ID_NONE = "none"
...
class FabricFlowMonExporterProfile(ManagedObject):
    ...
    mo_meta = MoMeta("FabricFlowMonExporterProfile", "fabricFlowMonExporterProfile", "flow-exporter-profile-[name]", VersionMeta.Version221b, "InputOutput", 0x7fL, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'fabricEthLanFlowMonitoring'], [u'vnicEtherIf'], [None])
    ...
    prop_meta = {
        ...
        "policy_owner": MoPropertyMeta("policy_owner", "policyOwner", "string", VersionMeta.Version221b, MoPropertyMeta.READ_WRITE, 0x10L, None, None, None, ["local", "pending-policy", "policy"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricFlowMonExporterProfile", parent_mo_or_dn, **kwargs)
