...
class FabricNetGroupRef(ManagedObject):
    ...
    mo_meta = MoMeta("FabricNetGroupRef", "fabricNetGroupRef", "net-group-ref-[name]", None, "InputOutput", 0x3f, [], ["admin", "ls-config", "ls-network", "ls-server"], [u'dcxVc', u'swCmclan', u'vnicEther', u'vnicLanConnTempl', u'vnicProfile', u'vnicSanConnTempl'], [u'faultInst'], [None])
