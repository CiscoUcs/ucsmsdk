...
class FabricComputeSlotEpFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("FabricComputeSlotEpFsmStage", "fabricComputeSlotEpFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'fabricComputeSlotEpFsm'], [], [None])
