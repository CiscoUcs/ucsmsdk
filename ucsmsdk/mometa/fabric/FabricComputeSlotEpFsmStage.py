"""This module contains the general information for FabricComputeSlotEpFsmStage ManagedObject."""
import sys, os
...
class FabricComputeSlotEpFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_IDENTIFY_BEGIN = "IdentifyBegin"
    NAME_IDENTIFY_EVALUATE_IDENTITY = "IdentifyEvaluateIdentity"
...
class FabricComputeSlotEpFsmStage(ManagedObject):
    """This is FabricComputeSlotEpFsmStage class."""

    consts = FabricComputeSlotEpFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("FabricComputeSlotEpFsmStage", "fabricComputeSlotEpFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'fabricComputeSlotEpFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["IdentifyBegin", "IdentifyEvaluateIdentity", "IdentifyExecuteLocal", "IdentifyExecutePeer", "IdentifyFail", "IdentifySuccess", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricComputeSlotEpFsmStage", parent_mo_or_dn, **kwargs)
