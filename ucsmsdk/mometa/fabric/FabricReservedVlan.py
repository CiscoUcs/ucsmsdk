"""This module contains the general information for FabricReservedVlan ManagedObject."""
...
class FabricReservedVlanConsts:
    FSM_PREV_DEPLOY_BEGIN = "DeployBegin"
    FSM_PREV_DEPLOY_CONFIG_SWITCH_LOCAL = "DeployConfigSwitchLocal"
    FSM_PREV_DEPLOY_CONFIG_SWITCH_PEER = "DeployConfigSwitchPeer"
    ...
    FSM_STATUS_DEPLOY_CONFIG_SWITCH_LOCAL = "DeployConfigSwitchLocal"
    FSM_STATUS_DEPLOY_CONFIG_SWITCH_PEER = "DeployConfigSwitchPeer"
...
class FabricReservedVlan(ManagedObject):
    """This is FabricReservedVlan class."""
    ...
    prop_meta = {
        ...
        "start_id": MoPropertyMeta("start_id", "startId", "uint", VersionMeta.Version401a, MoPropertyMeta.READ_WRITE, 0x20, None, None, None, [], ["2-3915"]),
        "status": MoPropertyMeta("status", "status", "string", VersionMeta.Version401a, MoPropertyMeta.READ_WRITE, 0x40, None, None, r"""((removed|created|modified|deleted),){0,3}(removed|created|modified|deleted){0,1}""", [], []),
    }
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricReservedVlan", parent_mo_or_dn, **kwargs)
