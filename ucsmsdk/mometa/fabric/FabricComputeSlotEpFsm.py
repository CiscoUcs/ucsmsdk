"""This module contains the general information for FabricComputeSlotEpFsm ManagedObject."""
import sys, os
...
class FabricComputeSlotEpFsmConsts():
    COMPLETION_TIME_ = ""
...
class FabricComputeSlotEpFsm(ManagedObject):
    """This is FabricComputeSlotEpFsm class."""

    consts = FabricComputeSlotEpFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("FabricComputeSlotEpFsm", "fabricComputeSlotEpFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'fabricComputeSlotEp'], [u'fabricComputeSlotEpFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Identify", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricComputeSlotEpFsm", parent_mo_or_dn, **kwargs)
