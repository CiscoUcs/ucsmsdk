...
class FabricComputeSlotEpFsm(ManagedObject):
    ...
    mo_meta = MoMeta("FabricComputeSlotEpFsm", "fabricComputeSlotEpFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'fabricComputeSlotEp'], [u'fabricComputeSlotEpFsmStage'], [None])
