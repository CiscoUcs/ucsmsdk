...
class FabricComputeSlotEpFsm(ManagedObject):
    ...
    mo_meta = MoMeta("FabricComputeSlotEpFsm", "fabricComputeSlotEpFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xf, [], [""], [u'fabricComputeSlotEp'], [u'fabricComputeSlotEpFsmStage'], [None])
