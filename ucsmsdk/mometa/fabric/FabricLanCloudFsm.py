...
class FabricLanCloudFsm(ManagedObject):
    """This is FabricLanCloudFsm class."""

    consts = FabricLanCloudFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("FabricLanCloudFsm", "fabricLanCloudFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'fabricLanCloud'], [u'fabricLanCloudFsmStage'], [None])
