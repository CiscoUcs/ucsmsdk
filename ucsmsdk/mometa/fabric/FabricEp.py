...
class FabricEp(ManagedObject):
    ...
    mo_meta = MoMeta("FabricEp", "fabricEp", "fabric", VersionMeta.Version101e, "InputOutput", 0x1fL, [], ["admin"], [u'topRoot'], [u'dcxUniverse', u'etherPortChanIdUniverse', u'fabricCabling', u'fabricDceSrv', u'fabricEpMgr', u'fabricEthEstcCloud', u'fabricFcEstcCloud', u'fabricLanAccessMgr', u'fabricLanCloud', u'fabricLanMonCloud', u'fabricSanCloud', u'fabricSanMonCloud', u'fabricZoneIdUniverse'], ["Get"])
    ...
    def __init__(self, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricEp", **kwargs)
