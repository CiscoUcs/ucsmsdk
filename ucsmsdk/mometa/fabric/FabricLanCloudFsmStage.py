"""This module contains the general information for FabricLanCloudFsmStage ManagedObject."""
import sys, os
...
class FabricLanCloudFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
...
class FabricLanCloudFsmStage(ManagedObject):
    """This is FabricLanCloudFsmStage class."""

    consts = FabricLanCloudFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("FabricLanCloudFsmStage", "fabricLanCloudFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'fabricLanCloudFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["SwitchModeBegin", "SwitchModeFail", "SwitchModeSuccess", "SwitchModeSwConfigLocal", "SwitchModeSwConfigPeer", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricLanCloudFsmStage", parent_mo_or_dn, **kwargs)
