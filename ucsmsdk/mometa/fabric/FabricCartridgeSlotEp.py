...
class FabricCartridgeSlotEp(ManagedObject):
    ...
    mo_meta = MoMeta("FabricCartridgeSlotEp", "fabricCartridgeSlotEp", "cart-slot-[slot_id]", VersionMeta.Version251a, "InputOutput", 0x1ffL, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'fabricChassisEp'], [u'eventInst', u'fabricCartridgeSlotEpFsm', u'fabricCartridgeSlotEpFsmTask', u'fabricComputeMSlotEp', u'fabricIf', u'faultInst'], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "slot_admin_state": MoPropertyMeta("slot_admin_state", "slotAdminState", "string", VersionMeta.Version251a, MoPropertyMeta.READ_WRITE, 0x40L, None, None, None, ["acknowledged", "reacknowledge"], []), 
        "slot_id": MoPropertyMeta("slot_id", "slotId", "uint", VersionMeta.Version251a, MoPropertyMeta.NAMING, 0x80L, None, None, None, [], ["1-8"]), 
