...
class FabricLanAccessMgr(ManagedObject):
    ...
    mo_meta = MoMeta("FabricLanAccessMgr", "fabricLanAccessMgr", "lan-access", VersionMeta.Version211a, "InputOutput", 0xfL, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'fabricEp'], [], [None])
