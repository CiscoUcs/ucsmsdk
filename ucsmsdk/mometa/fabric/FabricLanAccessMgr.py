"""This module contains the general information for FabricLanAccessMgr ManagedObject."""
import sys, os
...
class FabricLanAccessMgrConsts():
    pass


class FabricLanAccessMgr(ManagedObject):
    """This is FabricLanAccessMgr class."""

    consts = FabricLanAccessMgrConsts()
    naming_props = set([])

    mo_meta = MoMeta("FabricLanAccessMgr", "fabricLanAccessMgr", "lan-access", VersionMeta.Version211a, "InputOutput", 0x1fL, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'fabricEp'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricLanAccessMgr", parent_mo_or_dn, **kwargs)
