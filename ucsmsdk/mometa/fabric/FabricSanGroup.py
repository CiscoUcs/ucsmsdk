...
class FabricSanGroup(ManagedObject):
    ...
    mo_meta = MoMeta("FabricSanGroup", "fabricSanGroup", "san-group-[name]", None, "InputOutput", 0xff, [], ["read-only"], [], [], [None])

    prop_meta = {
        "assigned": MoPropertyMeta("assigned", "assigned", "uint", None, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        "assignment_order": MoPropertyMeta("assignment_order", "assignmentOrder", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["default", "sequential"], []), 
