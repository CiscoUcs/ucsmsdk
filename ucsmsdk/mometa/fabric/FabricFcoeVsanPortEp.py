"""This module contains the general information for FabricFcoeVsanPortEp ManagedObject."""
import sys, os
...
class FabricFcoeVsanPortEpConsts():
...
class FabricFcoeVsanPortEp(ManagedObject):
    """This is FabricFcoeVsanPortEp class."""

    consts = FabricFcoeVsanPortEpConsts()
    naming_props = set([u'switchId', u'slotId', u'portId'])

    mo_meta = MoMeta("FabricFcoeVsanPortEp", "fabricFcoeVsanPortEp", "phys-fcoe-switch-[switch_id]-slot-[slot_id]-port-[port_id]", VersionMeta.Version141i, "InputOutput", 0x1ffL, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricSwSubGroup', u'fabricVsan'], [u'faultInst'], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "port_id": MoPropertyMeta("port_id", "portId", "uint", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x10L, None, None, None, [], ["1-256"]), 
        ...
        "slot_id": MoPropertyMeta("slot_id", "slotId", "uint", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x40L, None, None, None, [], ["1-5"]), 
        ...
        "switch_id": MoPropertyMeta("switch_id", "switchId", "string", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x100L, None, None, None, ["A", "B", "NONE"], []), 
    ...
    def __init__(self, parent_mo_or_dn, switch_id, slot_id, port_id, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricFcoeVsanPortEp", parent_mo_or_dn, **kwargs)
