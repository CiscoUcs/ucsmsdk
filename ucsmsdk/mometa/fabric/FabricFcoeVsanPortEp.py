...
class FabricFcoeVsanPortEp(ManagedObject):
    ...
    mo_meta = MoMeta("FabricFcoeVsanPortEp", "fabricFcoeVsanPortEp", "phys-fcoe-switch-[switch_id]-slot-[slot_id]-port-[port_id]", VersionMeta.Version141i, "InputOutput", 0x7ffL, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricSwSubGroup', u'fabricVsan'], [u'faultInst'], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "port_id": MoPropertyMeta("port_id", "portId", "uint", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x40L, None, None, None, [], ["1-256"]), 
        ...
        "slot_id": MoPropertyMeta("slot_id", "slotId", "uint", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x100L, None, None, None, [], ["1-5"]), 
        ...
        "switch_id": MoPropertyMeta("switch_id", "switchId", "string", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x400L, None, None, None, ["A", "B", "NONE"], []), 
