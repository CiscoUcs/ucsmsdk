...
class FabricCabling(ManagedObject):
    ...
    mo_meta = MoMeta("FabricCabling", "fabricCabling", "Cabling", None, "InputOutput", 0x1fL, [], ["admin", "ext-lan-config", "ext-lan-policy", "ext-san-config", "ext-san-policy"], [u'fabricEp'], [u'fabricCablingSw', u'statsThresholdPolicy'], [None])
