...
class FabricComputeSlotEpConsts():
    ...
    FSM_PREV_IDENTIFY_BEGIN = "IdentifyBegin"
    FSM_PREV_IDENTIFY_EVALUATE_IDENTITY = "IdentifyEvaluateIdentity"
    FSM_PREV_IDENTIFY_EXECUTE_LOCAL = "IdentifyExecuteLocal"
    FSM_PREV_IDENTIFY_EXECUTE_PEER = "IdentifyExecutePeer"
    FSM_PREV_IDENTIFY_FAIL = "IdentifyFail"
    FSM_PREV_IDENTIFY_SUCCESS = "IdentifySuccess"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_IDENTIFY_BEGIN = "IdentifyBegin"
    FSM_STATUS_IDENTIFY_EVALUATE_IDENTITY = "IdentifyEvaluateIdentity"
    FSM_STATUS_IDENTIFY_EXECUTE_LOCAL = "IdentifyExecuteLocal"
    FSM_STATUS_IDENTIFY_EXECUTE_PEER = "IdentifyExecutePeer"
    FSM_STATUS_IDENTIFY_FAIL = "IdentifyFail"
    FSM_STATUS_IDENTIFY_SUCCESS = "IdentifySuccess"
    FSM_STATUS_NOP = "nop"
    IF_ROLE_DIAG = "diag"
...
class FabricComputeSlotEp(ManagedObject):
    ...
    mo_meta = MoMeta("FabricComputeSlotEp", "fabricComputeSlotEp", "slot-[slot_id]", VersionMeta.Version101e, "InputOutput", 0xffL, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'fabricChassisEp'], [u'eventInst', u'fabricComputeSlotEpFsm', u'fabricComputeSlotEpFsmTask', u'fabricIf', u'faultInst'], ["Get", "Set"])

    prop_meta = {
        "admin_state": MoPropertyMeta("admin_state", "adminState", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x1L, None, None, None, ["acknowledged", "reacknowledge"], []), 
        ...
        "conn_path": MoPropertyMeta("conn_path", "connPath", "string", VersionMeta.Version101e, MoPropertyMeta.READ_ONLY, None, None, None, """((defaultValue|unknown|A|B),){0,3}(defaultValue|unknown|A|B){0,1}""", [], []), 
        "conn_status": MoPropertyMeta("conn_status", "connStatus", "string", VersionMeta.Version101e, MoPropertyMeta.READ_ONLY, None, None, None, """((defaultValue|unknown|A|B),){0,3}(defaultValue|unknown|A|B){0,1}""", [], []), 
        "discovery": MoPropertyMeta("discovery", "discovery", "string", VersionMeta.Version101e, MoPropertyMeta.READ_ONLY, None, None, None, None, ["complete", "diagnostics-complete", "diagnostics-failed", "diagnostics-in-progress", "efidiagnostics-in-progress", "failed", "fru-identity-indeterminate", "fru-not-ready", "fru-state-indeterminate", "illegal-fru", "in-progress", "insufficiently-equipped", "invalid-adaptor-iocard", "malformed-fru-info", "retry", "throttled", "undiscovered", "user-acknowledged", "waiting-for-mgmt-ack", "waiting-for-user-ack"], []), 
        ...
        "fru_ident_trig_ts": MoPropertyMeta("fru_ident_trig_ts", "fruIdentTrigTs", "string", VersionMeta.Version201m, MoPropertyMeta.READ_ONLY, None, None, None, None, ["never"], ["0-4294967295"]), 
        "fsm_descr": MoPropertyMeta("fsm_descr", "fsmDescr", "string", VersionMeta.Version101e, MoPropertyMeta.INTERNAL, None, None, None, None, [], []), 
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version101e, MoPropertyMeta.INTERNAL, None, None, None, None, ["IdentifyBegin", "IdentifyEvaluateIdentity", "IdentifyExecuteLocal", "IdentifyExecutePeer", "IdentifyFail", "IdentifySuccess", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version101e, MoPropertyMeta.INTERNAL, None, None, None, None, ["IdentifyBegin", "IdentifyEvaluateIdentity", "IdentifyExecuteLocal", "IdentifyExecutePeer", "IdentifyFail", "IdentifySuccess", "nop"], []), 
        ...
        "peer_slot_ep_dn": MoPropertyMeta("peer_slot_ep_dn", "peerSlotEpDn", "string", VersionMeta.Version222c, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        ...
        "presence_path": MoPropertyMeta("presence_path", "presencePath", "string", VersionMeta.Version222c, MoPropertyMeta.READ_ONLY, None, None, None, """((defaultValue|unknown|A|B),){0,3}(defaultValue|unknown|A|B){0,1}""", [], []), 
        ...
        "slot_id": MoPropertyMeta("slot_id", "slotId", "uint", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x40L, None, None, None, [], ["1-8"]), 
    ...
    prop_map = {
        ...
        "peerSlotEpDn": "peer_slot_ep_dn", 
        "peerSlotId": "peer_slot_id", 
        "portId": "port_id", 
        "presence": "presence", 
        "presencePath": "presence_path", 
        "revision": "revision", 
        "rn": "rn", 
        "sacl": "sacl", 
        "serial": "serial", 
