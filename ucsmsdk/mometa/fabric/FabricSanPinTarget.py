...
class FabricSanPinTarget(ManagedObject):
    ...
    mo_meta = MoMeta("FabricSanPinTarget", "fabricSanPinTarget", "target-[fabric_id]", VersionMeta.Version101e, "InputOutput", 0x3ff, [], ["admin", "ext-san-config", "ext-san-policy"], ['fabricSanPinGroup'], ['faultInst'], ["Add", "Get", "Remove", "Set"])
