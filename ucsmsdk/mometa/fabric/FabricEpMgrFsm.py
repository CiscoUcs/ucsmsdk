...
class FabricEpMgrFsm(ManagedObject):
    """This is FabricEpMgrFsm class."""

    consts = FabricEpMgrFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("FabricEpMgrFsm", "fabricEpMgrFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'fabricEpMgr'], [u'fabricEpMgrFsmStage'], [None])
