"""This module contains the general information for FabricFcoeVsanPc ManagedObject."""
import sys, os
...
class FabricFcoeVsanPc(ManagedObject):
    """This is FabricFcoeVsanPc class."""

    consts = FabricFcoeVsanPcConsts()
    naming_props = set([u'switchId', u'portId'])

    mo_meta = MoMeta("FabricFcoeVsanPc", "fabricFcoeVsanPc", "fcoepc-switch-[switch_id]-fcoepc-[port_id]", VersionMeta.Version211a, "InputOutput", 0x1ffL, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricVsan'], [u'faultInst'], ["Add", "Get", "Set"])
    ...
    prop_meta = {
        ...
        "port_id": MoPropertyMeta("port_id", "portId", "uint", VersionMeta.Version211a, MoPropertyMeta.NAMING, 0x20L, None, None, None, [], ["1-256"]), 
        ...
        "switch_id": MoPropertyMeta("switch_id", "switchId", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, 0x100L, None, None, None, ["A", "B", "NONE"], []), 
    ...
    def __init__(self, parent_mo_or_dn, switch_id, port_id, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricFcoeVsanPc", parent_mo_or_dn, **kwargs)
