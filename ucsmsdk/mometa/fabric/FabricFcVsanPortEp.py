"""This module contains the general information for FabricFcVsanPortEp ManagedObject."""
import sys, os
...
class FabricFcVsanPortEpConsts():
...
class FabricFcVsanPortEp(ManagedObject):
    """This is FabricFcVsanPortEp class."""

    consts = FabricFcVsanPortEpConsts()
    naming_props = set([u'switchId', u'slotId', u'portId'])

    mo_meta = MoMeta("FabricFcVsanPortEp", "fabricFcVsanPortEp", "phys-switch-[switch_id]-slot-[slot_id]-port-[port_id]", VersionMeta.Version101e, "InputOutput", 0x1ffL, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricVsan'], [u'faultInst'], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "port_id": MoPropertyMeta("port_id", "portId", "uint", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x10L, None, None, None, [], ["1-256"]), 
        ...
        "slot_id": MoPropertyMeta("slot_id", "slotId", "uint", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x40L, None, None, None, [], ["1-5"]), 
