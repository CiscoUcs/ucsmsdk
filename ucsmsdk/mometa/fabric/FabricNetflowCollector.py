...
class FabricNetflowCollector(ManagedObject):
    ...
    mo_meta = MoMeta("FabricNetflowCollector", "fabricNetflowCollector", "flow-collector-[name]", VersionMeta.Version221b, "InputOutput", 0x3ffL, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'fabricEthLanFlowMonitoring'], [u'ipIpV4StaticTargetAddr'], [None])
    ...
    prop_meta = {
        ...
        "port": MoPropertyMeta("port", "port", "uint", VersionMeta.Version221b, MoPropertyMeta.READ_WRITE, 0x40L, None, None, None, [], ["1-65535"]), 
        ...
        "source_vlan": MoPropertyMeta("source_vlan", "sourceVlan", "string", VersionMeta.Version221b, MoPropertyMeta.READ_WRITE, 0x100L, 0, 510, None, [], []), 
