...
class FabricSanPinGroup(ManagedObject):
    ...
    mo_meta = MoMeta("FabricSanPinGroup", "fabricSanPinGroup", "san-pin-group-[name]", VersionMeta.Version101e, "InputOutput", 0x7fL, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricSanCloud'], [u'fabricSanPinTarget', u'faultInst'], ["Add", "Get", "Remove", "Set"])
