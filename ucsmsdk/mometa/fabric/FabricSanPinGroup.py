"""This module contains the general information for FabricSanPinGroup ManagedObject."""
import sys, os
...
class FabricSanPinGroup(ManagedObject):
    """This is FabricSanPinGroup class."""

    consts = FabricSanPinGroupConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("FabricSanPinGroup", "fabricSanPinGroup", "san-pin-group-[name]", VersionMeta.Version101e, "InputOutput", 0xffL, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricSanCloud'], [u'fabricSanPinTarget', u'faultInst'], ["Add", "Get", "Remove", "Set"])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricSanPinGroup", parent_mo_or_dn, **kwargs)
