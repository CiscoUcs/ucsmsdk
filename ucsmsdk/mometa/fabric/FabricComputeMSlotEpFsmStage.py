...
class FabricComputeMSlotEpFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("FabricComputeMSlotEpFsmStage", "fabricComputeMSlotEpFsmStage", "stage-[name]", VersionMeta.Version251a, "OutputOnly", 0x7L, [], [""], [u'fabricComputeMSlotEpFsm'], [], [None])
