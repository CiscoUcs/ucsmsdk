...
class FabricComputeMSlotEpFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("FabricComputeMSlotEpFsmStage", "fabricComputeMSlotEpFsmStage", "stage-[name]", VersionMeta.Version251a, "OutputOnly", 0xfL, [], [""], [u'fabricComputeMSlotEpFsm'], [], [None])
