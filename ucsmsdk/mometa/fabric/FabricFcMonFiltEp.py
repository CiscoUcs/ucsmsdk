"""This module contains the general information for FabricFcMonFiltEp ManagedObject."""
import sys, os
...
class FabricFcMonFiltEpConsts():
    pass


class FabricFcMonFiltEp(ManagedObject):
    """This is FabricFcMonFiltEp class."""

    consts = FabricFcMonFiltEpConsts()
    naming_props = set([])

    mo_meta = MoMeta("FabricFcMonFiltEp", "fabricFcMonFiltEp", "", VersionMeta.Version141i, "InputOutput", 0x3fL, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricVsan'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x4L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        ...
        "session": MoPropertyMeta("session", "session", "uint", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x10L, None, None, None, [], ["1-255"]), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricFcMonFiltEp", parent_mo_or_dn, **kwargs)
