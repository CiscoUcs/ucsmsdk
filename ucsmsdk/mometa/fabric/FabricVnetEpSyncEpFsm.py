...
class FabricVnetEpSyncEpFsm(ManagedObject):
    ...
    mo_meta = MoMeta("FabricVnetEpSyncEpFsm", "fabricVnetEpSyncEpFsm", "fsm", VersionMeta.Version212a, "OutputOnly", 0xf, [], [""], ['fabricVnetEpSyncEp'], ['fabricVnetEpSyncEpFsmStage'], [None])
