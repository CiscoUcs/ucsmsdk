"""This module contains the general information for FabricCartridgeSlotEpFsm ManagedObject."""
...
class FabricCartridgeSlotEpFsmConsts:
    COMPLETION_TIME_ = ""
    CURRENT_FSM_IDENTIFY = "Identify"
    CURRENT_FSM_NOP = "nop"
...
class FabricCartridgeSlotEpFsm(ManagedObject):
    """This is FabricCartridgeSlotEpFsm class."""

    consts = FabricCartridgeSlotEpFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("FabricCartridgeSlotEpFsm", "fabricCartridgeSlotEpFsm", "fsm", VersionMeta.Version251a, "OutputOnly", 0xf, [], [""], [u'fabricCartridgeSlotEp'], [u'fabricCartridgeSlotEpFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version251a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Identify", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricCartridgeSlotEpFsm", parent_mo_or_dn, **kwargs)
