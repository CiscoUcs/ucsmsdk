"""This module contains the general information for FabricReservedVlanFsmTask ManagedObject."""
...
class FabricReservedVlanFsmTaskConsts:
...
class FabricReservedVlanFsmTask(ManagedObject):
    ...
    prop_meta = {
        ...
        "completion": MoPropertyMeta("completion", "completion", "string", VersionMeta.Version401a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["cancelled", "completed", "processing", "scheduled"], []),
        "dn": MoPropertyMeta("dn", "dn", "string", VersionMeta.Version401a, MoPropertyMeta.READ_ONLY, 0x2, 0, 256, None, [], []),
        "flags": MoPropertyMeta("flags", "flags", "string", VersionMeta.Version401a, MoPropertyMeta.READ_ONLY, None, None, None, r"""(defaultValue){0,1}""", [], []),
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version401a, MoPropertyMeta.NAMING, None, None, None, None, ["Deploy", "nop"], []),
        ...
        "seq_id": MoPropertyMeta("seq_id", "seqId", "uint", VersionMeta.Version401a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []),
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricReservedVlanFsmTask", parent_mo_or_dn, **kwargs)
