...
class FabricEpMgrFsmStageConsts():
    ...
    NAME_CONFIGURE_VALIDATE_CONFIGURATION = "ConfigureValidateConfiguration"
    NAME_CONFIGURE_WAIT_ON_PHYS = "ConfigureWaitOnPhys"
    NAME_NOP = "nop"
...
class FabricEpMgrFsmStage(ManagedObject):
    """This is FabricEpMgrFsmStage class."""

    consts = FabricEpMgrFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("FabricEpMgrFsmStage", "fabricEpMgrFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'fabricEpMgrFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["ConfigureApplyConfig", "ConfigureApplyPhysical", "ConfigureBegin", "ConfigureFail", "ConfigureSuccess", "ConfigureValidateConfiguration", "ConfigureWaitOnPhys", "nop"], []), 
