...
class FabricPoolableVlan(ManagedObject):
    ...
    mo_meta = MoMeta("FabricPoolableVlan", "fabricPoolableVlan", "pool-[id]", VersionMeta.Version211a, "InputOutput", 0x3fL, [], ["read-only"], [u'fabricVlan'], [], [None])
    ...
    prop_meta = {
        ...
        "id": MoPropertyMeta("id", "id", "ulong", VersionMeta.Version211a, MoPropertyMeta.NAMING, 0x8L, None, None, None, [], []), 
    ...
    def __init__(self, parent_mo_or_dn, id, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricPoolableVlan", parent_mo_or_dn, **kwargs)
