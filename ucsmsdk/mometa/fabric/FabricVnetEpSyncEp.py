...
class FabricVnetEpSyncEp(ManagedObject):
    ...
    mo_meta = MoMeta("FabricVnetEpSyncEp", "fabricVnetEpSyncEp", "syncEp", VersionMeta.Version212a, "InputOutput", 0x1f, [], ["read-only"], ['extpolProvider'], ['eventInst', 'fabricChangedObjectRef', 'fabricVnetEpSyncEpFsm', 'fabricVnetEpSyncEpFsmTask', 'faultInst'], [None])
