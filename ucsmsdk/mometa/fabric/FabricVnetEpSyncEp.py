...
class FabricVnetEpSyncEpConsts():
    ...
    FSM_PREV_PUSH_VNET_EP_DELETION_SYNC = "PushVnetEpDeletionSync"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_PUSH_VNET_EP_DELETION_BEGIN = "PushVnetEpDeletionBegin"
    FSM_STATUS_PUSH_VNET_EP_DELETION_FAIL = "PushVnetEpDeletionFail"
    FSM_STATUS_PUSH_VNET_EP_DELETION_SUCCESS = "PushVnetEpDeletionSuccess"
    FSM_STATUS_PUSH_VNET_EP_DELETION_SYNC = "PushVnetEpDeletionSync"
    FSM_STATUS_NOP = "nop"
    IS_CHANGED_OBJECT_UPDATE_FALSE = "false"
    IS_CHANGED_OBJECT_UPDATE_NO = "no"
    IS_CHANGED_OBJECT_UPDATE_TRUE = "true"
    IS_CHANGED_OBJECT_UPDATE_YES = "yes"


class FabricVnetEpSyncEp(ManagedObject):
    """This is FabricVnetEpSyncEp class."""

    consts = FabricVnetEpSyncEpConsts()
    naming_props = set([])

    mo_meta = MoMeta("FabricVnetEpSyncEp", "fabricVnetEpSyncEp", "syncEp", VersionMeta.Version212a, "InputOutput", 0xfL, [], ["read-only"], [u'extpolProvider'], [u'eventInst', u'fabricChangedObjectRef', u'fabricVnetEpSyncEpFsm', u'fabricVnetEpSyncEpFsmTask', u'faultInst'], [None])
    ...
    prop_meta = {
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version212a, MoPropertyMeta.INTERNAL, None, None, None, None, ["PushVnetEpDeletionBegin", "PushVnetEpDeletionFail", "PushVnetEpDeletionSuccess", "PushVnetEpDeletionSync", "nop"], []), 
    ...
    prop_map = {
        ...
        "fsmTry": "fsm_try", 
        "genNumSync": "gen_num_sync", 
        "id": "id", 
        "isChangedObjectUpdate": "is_changed_object_update", 
        "rn": "rn", 
        "sacl": "sacl", 
        "status": "status", 
    }
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        self.fsm_try = None
        self.gen_num_sync = None
        self.id = None
        self.is_changed_object_update = None
        self.sacl = None
        self.status = None
