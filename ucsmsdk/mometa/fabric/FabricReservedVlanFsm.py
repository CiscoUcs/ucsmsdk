"""This module contains the general information for FabricReservedVlanFsm ManagedObject."""
...
class FabricReservedVlanFsmConsts:
    COMPLETION_TIME_ = ""
...
class FabricReservedVlanFsm(ManagedObject):
    """This is FabricReservedVlanFsm class."""

    consts = FabricReservedVlanFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("FabricReservedVlanFsm", "fabricReservedVlanFsm", "fsm", VersionMeta.Version401a, "OutputOnly", 0xf, [], [""], [u'fabricReservedVlan'], [u'fabricReservedVlanFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "completion_time": MoPropertyMeta("completion_time", "completionTime", "string", VersionMeta.Version401a, MoPropertyMeta.READ_ONLY, None, None, None, r"""([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", [""], []), 
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version401a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Deploy", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricReservedVlanFsm", parent_mo_or_dn, **kwargs)
