...
class FabricReservedVlanFsm(ManagedObject):
    ...
    mo_meta = MoMeta("FabricReservedVlanFsm", "fabricReservedVlanFsm", "fsm", VersionMeta.Version401a, "OutputOnly", 0xf, [], [""], ['fabricReservedVlan'], ['fabricReservedVlanFsmStage'], [None])
