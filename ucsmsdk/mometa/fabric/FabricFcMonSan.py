...
class FabricFcMonSan(ManagedObject):
    """This is FabricFcMonSan class."""

    consts = FabricFcMonSanConsts()
    naming_props = set([u'id'])

    mo_meta = MoMeta("FabricFcMonSan", "fabricFcMonSan", "[id]", VersionMeta.Version141i, "InputOutput", 0x7f, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricSanMonCloud'], [u'fabricFcMon'], ["Get"])
