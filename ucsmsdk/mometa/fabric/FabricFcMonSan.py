...
class FabricFcMonSan(ManagedObject):
    ...
    mo_meta = MoMeta("FabricFcMonSan", "fabricFcMonSan", "[id]", VersionMeta.Version141i, "InputOutput", 0x7f, [], ["admin", "ext-san-config", "ext-san-policy"], ['fabricSanMonCloud'], ['fabricFcMon'], ["Get"])
