...
class FabricLanCloudFsmTask(ManagedObject):
    """This is FabricLanCloudFsmTask class."""

    consts = FabricLanCloudFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("FabricLanCloudFsmTask", "fabricLanCloudFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], [""], [u'fabricLanCloud'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, None, None, None, None, ["SwitchMode", "nop"], []), 
