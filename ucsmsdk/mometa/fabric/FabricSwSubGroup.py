...
class FabricSwSubGroup(ManagedObject):
    ...
    mo_meta = MoMeta("FabricSwSubGroup", "fabricSwSubGroup", "sw-[switch_id]-slot-[slot_id]-aggr-port-[aggr_port_id]", VersionMeta.Version302a, "InputOutput", 0xffL, [], ["admin", "ls-network", "ls-network-policy"], [u'fabricVlan', u'fabricVsan'], [u'fabricEthVlanPortEp', u'fabricFcoeVsanPortEp'], [None])

    prop_meta = {
        "aggr_port_id": MoPropertyMeta("aggr_port_id", "aggrPortId", "uint", VersionMeta.Version302a, MoPropertyMeta.NAMING, 0x1L, None, None, None, [], ["1-48"]), 
        ...
        "config_state": MoPropertyMeta("config_state", "configState", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["disabled", "enabled"], []), 
        ...
        "slot_id": MoPropertyMeta("slot_id", "slotId", "uint", VersionMeta.Version302a, MoPropertyMeta.NAMING, 0x20L, None, None, None, [], ["1-4"]), 
        ...
        "switch_id": MoPropertyMeta("switch_id", "switchId", "string", VersionMeta.Version302a, MoPropertyMeta.NAMING, 0x80L, None, None, None, ["A", "B", "NONE"], []), 
