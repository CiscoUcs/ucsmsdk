...
class CpmaintAck(ManagedObject):
    ...
    mo_meta = MoMeta("CpmaintAck", "cpmaintAck", "ack", VersionMeta.Version312b, "InputOutput", 0x3ff, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'equipmentChassisProfile'], [u'faultInst', u'trigLocalSched'], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "disr": MoPropertyMeta("disr", "disr", "string", VersionMeta.Version312b, MoPropertyMeta.READ_ONLY, None, None, None, r"""((defaultValue|ac-power-cycle|up-time),){0,2}(defaultValue|ac-power-cycle|up-time){0,1}""", [], []), 
