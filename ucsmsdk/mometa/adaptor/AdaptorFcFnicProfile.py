...
class AdaptorFcFnicProfile(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorFcFnicProfile", "adaptorFcFnicProfile", "fc-fnic", VersionMeta.Version911z, "InputOutput", 0x7f, [], ["admin", "ls-config-policy", "ls-server-policy", "ls-storage"], [u'adaptorHostFcIf', u'adaptorHostFcIfProfile'], [], [None])
    ...
    prop_meta = {
        ...
        "io_retry_timeout": MoPropertyMeta("io_retry_timeout", "ioRetryTimeout", "uint", VersionMeta.Version911z, MoPropertyMeta.READ_WRITE, 0x8, None, None, None, [], ["1-59"]), 
        "lun_queue_depth": MoPropertyMeta("lun_queue_depth", "lunQueueDepth", "uint", VersionMeta.Version911z, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, [], ["1-254"]), 
