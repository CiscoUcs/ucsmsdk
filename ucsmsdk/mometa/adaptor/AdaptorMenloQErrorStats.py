...
class AdaptorMenloQErrorStats(ManagedObject):
    """This is AdaptorMenloQErrorStats class."""

    consts = AdaptorMenloQErrorStatsConsts()
    naming_props = set([u'menloQueueComponent', u'menloQueueIndex'])

    mo_meta = MoMeta("AdaptorMenloQErrorStats", "adaptorMenloQErrorStats", "menlo-q-error-stats-comp-[menlo_queue_component]index-[menlo_queue_index]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], ["admin", "operations", "read-only"], [u'adaptorUnit'], [u'adaptorMenloQErrorStatsHist'], ["Get"])
