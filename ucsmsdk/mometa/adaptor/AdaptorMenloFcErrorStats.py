...
class AdaptorMenloFcErrorStatsConsts():
    MENLO_FC_INDEX_0 = "0"
...
class AdaptorMenloFcErrorStats(ManagedObject):
    """This is AdaptorMenloFcErrorStats class."""

    consts = AdaptorMenloFcErrorStatsConsts()
    naming_props = set([u'menloFcIndex'])

    mo_meta = MoMeta("AdaptorMenloFcErrorStats", "adaptorMenloFcErrorStats", "menlo-fc-error-stats-[menlo_fc_index]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], ["admin", "operations", "read-only"], [u'adaptorUnit'], [u'adaptorMenloFcErrorStatsHist'], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, menlo_fc_index, **kwargs):
        ...
        ManagedObject.__init__(self, "AdaptorMenloFcErrorStats", parent_mo_or_dn, **kwargs)
