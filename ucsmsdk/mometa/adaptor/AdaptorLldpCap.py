...
class AdaptorLldpCap(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorLldpCap", "adaptorLldpCap", "lldp", VersionMeta.Version141i, "InputOutput", 0x3fL, [], ["read-only"], [u'adaptorFruCapProvider'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "support": MoPropertyMeta("support", "support", "string", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x20L, None, None, None, ["full", "none"], []), 
    }
