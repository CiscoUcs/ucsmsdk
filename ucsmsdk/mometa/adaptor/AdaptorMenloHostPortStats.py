"""This module contains the general information for AdaptorMenloHostPortStats ManagedObject."""
import sys, os
...
class AdaptorMenloHostPortStatsConsts():
...
class AdaptorMenloHostPortStats(ManagedObject):
    """This is AdaptorMenloHostPortStats class."""

    consts = AdaptorMenloHostPortStatsConsts()
    naming_props = set([u'menloPortIndex'])

    mo_meta = MoMeta("AdaptorMenloHostPortStats", "adaptorMenloHostPortStats", "menlo-host-port-stats-[menlo_port_index]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], ["admin", "operations", "read-only"], [u'adaptorUnit'], [u'adaptorMenloHostPortStatsHist'], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, menlo_port_index, **kwargs):
        ...
        ManagedObject.__init__(self, "AdaptorMenloHostPortStats", parent_mo_or_dn, **kwargs)
