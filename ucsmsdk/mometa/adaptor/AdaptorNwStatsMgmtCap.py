...
class AdaptorNwStatsMgmtCap(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorNwStatsMgmtCap", "adaptorNwStatsMgmtCap", "nw-stats-mgmt", VersionMeta.Version302c, "InputOutput", 0x1ff, [], ["read-only"], [u'adaptorFruCapProvider'], [], [None])
