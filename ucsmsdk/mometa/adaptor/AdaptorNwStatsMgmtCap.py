...
class AdaptorNwStatsMgmtCap(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorNwStatsMgmtCap", "adaptorNwStatsMgmtCap", "nw-stats-mgmt", VersionMeta.Version302a, "InputOutput", 0xffL, [], ["read-only"], [u'adaptorFruCapProvider'], [], [None])
    ...
    prop_meta = {
        ...
        "enable_nw_stats_collection": MoPropertyMeta("enable_nw_stats_collection", "enableNwStatsCollection", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x4L, None, None, None, ["false", "no", "true", "yes"], []), 
        "mode": MoPropertyMeta("mode", "mode", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x8L, None, None, None, ["full", "partial"], []), 
        "oper_power_requirement": MoPropertyMeta("oper_power_requirement", "operPowerRequirement", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x10L, None, None, None, ["full", "none", "standby"], []), 
        "reboot_action_on_destructive": MoPropertyMeta("reboot_action_on_destructive", "rebootActionOnDestructive", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x20L, None, None, None, ["adaptor", "host", "none"], []), 
