...
class AdaptorLanCap(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorLanCap", "adaptorLanCap", "lan", VersionMeta.Version101e, "InputOutput", 0x1fL, [], ["read-only"], [u'adaptorFruCapProvider'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "default_vlan": MoPropertyMeta("default_vlan", "defaultVlan", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x2L, None, None, None, ["default-vlan", "native-vlan"], []), 
