"""This module contains the general information for AdaptorMenloMcpuStatsHist ManagedObject."""
import sys, os
...
class AdaptorMenloMcpuStatsHistConsts():
...
class AdaptorMenloMcpuStatsHist(ManagedObject):
    """This is AdaptorMenloMcpuStatsHist class."""

    consts = AdaptorMenloMcpuStatsHistConsts()
    naming_props = set([u'id'])

    mo_meta = MoMeta("AdaptorMenloMcpuStatsHist", "adaptorMenloMcpuStatsHist", "[id]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], ["read-only"], [u'adaptorMenloMcpuStats'], [], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, id, **kwargs):
        ...
        ManagedObject.__init__(self, "AdaptorMenloMcpuStatsHist", parent_mo_or_dn, **kwargs)
