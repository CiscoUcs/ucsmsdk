...
class AdaptorMenloFcErrorStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorMenloFcErrorStatsHist", "adaptorMenloFcErrorStatsHist", "[id]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], ["read-only"], [u'adaptorMenloFcErrorStats'], [], ["Get"])
