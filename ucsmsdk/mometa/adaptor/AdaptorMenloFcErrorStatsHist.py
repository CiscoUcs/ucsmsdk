...
class AdaptorMenloFcErrorStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorMenloFcErrorStatsHist", "adaptorMenloFcErrorStatsHist", "[id]", VersionMeta.Version111j, "OutputOnly", 0x7L, [], ["read-only"], [u'adaptorMenloFcErrorStats'], [], ["Get"])
