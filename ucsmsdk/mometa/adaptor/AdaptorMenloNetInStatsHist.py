...
class AdaptorMenloNetInStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorMenloNetInStatsHist", "adaptorMenloNetInStatsHist", "[id]", VersionMeta.Version111j, "OutputOnly", 0x7L, [], ["read-only"], [u'adaptorMenloNetInStats'], [], ["Get"])
