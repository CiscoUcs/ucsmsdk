"""This module contains the general information for AdaptorHostEthIfFsm ManagedObject."""
import sys, os
...
class AdaptorHostEthIfFsmConsts():
    COMPLETION_TIME_ = ""
...
class AdaptorHostEthIfFsm(ManagedObject):
    """This is AdaptorHostEthIfFsm class."""

    consts = AdaptorHostEthIfFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("AdaptorHostEthIfFsm", "adaptorHostEthIfFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'adaptorHostEthIf'], [u'adaptorHostEthIfFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["CircuitReset", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "AdaptorHostEthIfFsm", parent_mo_or_dn, **kwargs)
