...
class AdaptorHostFcIfFsm(ManagedObject):
    """This is AdaptorHostFcIfFsm class."""

    consts = AdaptorHostFcIfFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("AdaptorHostFcIfFsm", "adaptorHostFcIfFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'adaptorHostFcIf'], [u'adaptorHostFcIfFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["CircuitReset", "ResetFcPersBinding", "nop"], []), 
