...
class AdaptorMenloEthErrorStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorMenloEthErrorStatsHist", "adaptorMenloEthErrorStatsHist", "[id]", VersionMeta.Version111j, "OutputOnly", 0x7L, [], ["read-only"], [u'adaptorMenloEthErrorStats'], [], ["Get"])
