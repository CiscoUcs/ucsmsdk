...
class AdaptorMenloEthErrorStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorMenloEthErrorStatsHist", "adaptorMenloEthErrorStatsHist", "[id]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], ["read-only"], [u'adaptorMenloEthErrorStats'], [], ["Get"])
