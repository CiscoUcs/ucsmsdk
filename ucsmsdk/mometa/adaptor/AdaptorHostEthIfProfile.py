...
class AdaptorHostEthIfProfile(ManagedObject):
    ...
    prop_meta = {
        ...
        "pooled_resources": MoPropertyMeta("pooled_resources", "pooledResources", "string", VersionMeta.Version323a, MoPropertyMeta.READ_WRITE, 0x40, None, None, None, ["disabled", "enabled"], []),
