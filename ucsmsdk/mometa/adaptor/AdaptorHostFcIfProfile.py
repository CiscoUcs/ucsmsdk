"""This module contains the general information for AdaptorHostFcIfProfile ManagedObject."""
...
class AdaptorHostFcIfProfileConsts:
    INT_ID_NONE = "none"
...
class AdaptorHostFcIfProfile(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorHostFcIfProfile", "adaptorHostFcIfProfile", "fc-profile-[name]", VersionMeta.Version101e, "InputOutput", 0xff, [], ["admin", "ls-config-policy", "ls-server-policy", "ls-storage"], [u'orgOrg'], [u'adaptorFcCdbWorkQueueProfile', u'adaptorFcErrorRecoveryProfile', u'adaptorFcFnicProfile', u'adaptorFcInterruptProfile', u'adaptorFcPortFLogiProfile', u'adaptorFcPortPLogiProfile', u'adaptorFcPortProfile', u'adaptorFcRecvQueueProfile', u'adaptorFcVhbaTypeProfile', u'adaptorFcWorkQueueProfile'], ["Add", "Get", "Remove", "Set"])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "AdaptorHostFcIfProfile", parent_mo_or_dn, **kwargs)
