...
class AdaptorUnitAssocCtx(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorUnitAssocCtx", "adaptorUnitAssocCtx", "adaptorunit-assoc-ctx-[id]", VersionMeta.Version141i, "InputOutput", 0x3f, [], ["read-only"], [u'lsServerAssocCtx'], [], ["Get"])
