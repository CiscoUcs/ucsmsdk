...
class AdaptorUnitAssocCtx(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorUnitAssocCtx", "adaptorUnitAssocCtx", "adaptorunit-assoc-ctx-[id]", VersionMeta.Version141i, "InputOutput", 0x3fL, [], ["read-only"], [u'lsServerAssocCtx'], [], ["Get"])
