...
class AdaptorMenloHostPortStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorMenloHostPortStatsHist", "adaptorMenloHostPortStatsHist", "[id]", VersionMeta.Version111j, "OutputOnly", 0x7L, [], ["read-only"], [u'adaptorMenloHostPortStats'], [], ["Get"])
