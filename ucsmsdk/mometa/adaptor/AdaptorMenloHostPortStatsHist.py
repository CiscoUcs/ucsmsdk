...
class AdaptorMenloHostPortStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorMenloHostPortStatsHist", "adaptorMenloHostPortStatsHist", "[id]", VersionMeta.Version111j, "OutputOnly", 0xf, [], ["read-only"], ['adaptorMenloHostPortStats'], [], ["Get"])
