...
class AdaptorMenloHostPortStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorMenloHostPortStatsHist", "adaptorMenloHostPortStatsHist", "[id]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], ["read-only"], [u'adaptorMenloHostPortStats'], [], ["Get"])
