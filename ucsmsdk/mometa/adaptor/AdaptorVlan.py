...
class AdaptorVlan(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorVlan", "adaptorVlan", "vlan-[id]", VersionMeta.Version101e, "InputOutput", 0x3ff, [], ["read-only"], ['adaptorHostEthIf', 'adaptorHostIscsiIf', 'adaptorHostServiceEthIf'], ['adaptorEtherIfStats', 'fabricMonOriginIP', 'fabricNetflowIPv4Addr', 'faultInst', 'vnicIPv4Dhcp', 'vnicIPv4Dns', 'vnicIPv4IscsiAddr', 'vnicIPv4PooledIscsiAddr', 'vnicIPv4StaticRoute', 'vnicIPv6Dhcp', 'vnicIPv6IScsiStaticTargetIf', 'vnicIPv6IscsiAddr', 'vnicIPv6PooledIscsiAddr', 'vnicIScsiAutoTargetIf', 'vnicIScsiStaticTargetIf', 'vnicIpV4MgmtPooledAddr', 'vnicIpV4PooledAddr', 'vnicIpV4ProfDerivedAddr', 'vnicIpV4StaticAddr', 'vnicIpV6MgmtPooledAddr', 'vnicIpV6StaticAddr'], ["Get"])
