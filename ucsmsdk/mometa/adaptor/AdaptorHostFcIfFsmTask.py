"""This module contains the general information for AdaptorHostFcIfFsmTask ManagedObject."""
import sys, os
...
class AdaptorHostFcIfFsmTaskConsts():
    COMPLETION_CANCELLED = "cancelled"
    COMPLETION_COMPLETED = "completed"
    COMPLETION_PROCESSING = "processing"
    COMPLETION_SCHEDULED = "scheduled"
    ITEM_CIRCUIT_RESET = "CircuitReset"
    ITEM_RESET_FC_PERS_BINDING = "ResetFcPersBinding"
    ITEM_NOP = "nop"


class AdaptorHostFcIfFsmTask(ManagedObject):
    """This is AdaptorHostFcIfFsmTask class."""

    consts = AdaptorHostFcIfFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("AdaptorHostFcIfFsmTask", "adaptorHostFcIfFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], [""], [u'adaptorHostFcIf'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, None, None, None, None, ["CircuitReset", "ResetFcPersBinding", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "AdaptorHostFcIfFsmTask", parent_mo_or_dn, **kwargs)
