...
class AdaptorHostFcIfFsmStageConsts():
    ...
    NAME_CIRCUIT_RESET_DISABLE_B = "CircuitResetDisableB"
    NAME_CIRCUIT_RESET_ENABLE_A = "CircuitResetEnableA"
    NAME_CIRCUIT_RESET_ENABLE_B = "CircuitResetEnableB"
    NAME_CIRCUIT_RESET_FAIL = "CircuitResetFail"
    NAME_CIRCUIT_RESET_SUCCESS = "CircuitResetSuccess"
    NAME_RESET_FC_PERS_BINDING_BEGIN = "ResetFcPersBindingBegin"
    NAME_RESET_FC_PERS_BINDING_EXECUTE_LOCAL = "ResetFcPersBindingExecuteLocal"
    NAME_RESET_FC_PERS_BINDING_EXECUTE_PEER = "ResetFcPersBindingExecutePeer"
    NAME_RESET_FC_PERS_BINDING_FAIL = "ResetFcPersBindingFail"
    NAME_RESET_FC_PERS_BINDING_SUCCESS = "ResetFcPersBindingSuccess"
    NAME_NOP = "nop"
...
class AdaptorHostFcIfFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorHostFcIfFsmStage", "adaptorHostFcIfFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'adaptorHostFcIfFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["CircuitResetBegin", "CircuitResetDisableA", "CircuitResetDisableB", "CircuitResetEnableA", "CircuitResetEnableB", "CircuitResetFail", "CircuitResetSuccess", "ResetFcPersBindingBegin", "ResetFcPersBindingExecuteLocal", "ResetFcPersBindingExecutePeer", "ResetFcPersBindingFail", "ResetFcPersBindingSuccess", "nop"], []), 
