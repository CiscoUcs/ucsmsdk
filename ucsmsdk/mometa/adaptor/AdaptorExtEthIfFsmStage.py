...
class AdaptorExtEthIfFsmStageConsts():
    ...
    NAME_PATH_RESET_ENABLE = "PathResetEnable"
    NAME_PATH_RESET_FAIL = "PathResetFail"
    NAME_PATH_RESET_SUCCESS = "PathResetSuccess"
    NAME_NOP = "nop"
...
class AdaptorExtEthIfFsmStage(ManagedObject):
    """This is AdaptorExtEthIfFsmStage class."""

    consts = AdaptorExtEthIfFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("AdaptorExtEthIfFsmStage", "adaptorExtEthIfFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'adaptorExtEthIfFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["PathResetBegin", "PathResetDisable", "PathResetEnable", "PathResetFail", "PathResetSuccess", "nop"], []), 
