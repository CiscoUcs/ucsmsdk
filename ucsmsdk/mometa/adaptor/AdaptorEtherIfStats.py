"""This module contains the general information for AdaptorEtherIfStats ManagedObject."""
import sys, os
...
class AdaptorEtherIfStatsConsts():
    SUSPECT_FALSE = "false"
    SUSPECT_NO = "no"
    SUSPECT_TRUE = "true"
    SUSPECT_YES = "yes"
...
class AdaptorEtherIfStats(ManagedObject):
    """This is AdaptorEtherIfStats class."""

    consts = AdaptorEtherIfStatsConsts()
    naming_props = set([])

    mo_meta = MoMeta("AdaptorEtherIfStats", "adaptorEtherIfStats", "ether-if-stats", VersionMeta.Version111j, "OutputOnly", 0xfL, [], ["admin", "operations", "read-only"], [u'adaptorVlan'], [u'adaptorEtherIfStatsHist'], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "AdaptorEtherIfStats", parent_mo_or_dn, **kwargs)
