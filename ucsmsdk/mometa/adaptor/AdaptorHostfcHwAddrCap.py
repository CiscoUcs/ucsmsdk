...
class AdaptorHostfcHwAddrCap(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorHostfcHwAddrCap", "adaptorHostfcHwAddrCap", "hwaddr-hostfc", VersionMeta.Version141i, "InputOutput", 0x3ffL, [], ["read-only"], [u'adaptorFruCapProvider'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "mac_offset1": MoPropertyMeta("mac_offset1", "macOffset1", "byte", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x4L, None, None, None, [], []), 
        "mac_offset2": MoPropertyMeta("mac_offset2", "macOffset2", "byte", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x8L, None, None, None, [], []), 
        ...
        "wwn_reverse_mask_a": MoPropertyMeta("wwn_reverse_mask_a", "wwnReverseMaskA", "ulong", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x40L, None, None, None, [], []), 
        "wwn_reverse_mask_b": MoPropertyMeta("wwn_reverse_mask_b", "wwnReverseMaskB", "ulong", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x80L, None, None, None, [], []), 
        "wwnn_reverse_mask_a": MoPropertyMeta("wwnn_reverse_mask_a", "wwnnReverseMaskA", "ulong", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x100L, None, None, None, [], []), 
        "wwnn_reverse_mask_b": MoPropertyMeta("wwnn_reverse_mask_b", "wwnnReverseMaskB", "ulong", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x200L, None, None, None, [], []), 
    }
