...
class AdaptorEthPortMcastStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorEthPortMcastStatsHist", "adaptorEthPortMcastStatsHist", "[id]", VersionMeta.Version111j, "OutputOnly", 0x7L, [], ["read-only"], [u'adaptorEthPortMcastStats'], [], ["Get"])
