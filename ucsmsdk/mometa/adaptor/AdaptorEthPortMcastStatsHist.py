...
class AdaptorEthPortMcastStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorEthPortMcastStatsHist", "adaptorEthPortMcastStatsHist", "[id]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], ["read-only"], [u'adaptorEthPortMcastStats'], [], ["Get"])
