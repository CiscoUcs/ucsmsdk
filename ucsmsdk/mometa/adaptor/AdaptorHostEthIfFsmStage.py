"""This module contains the general information for AdaptorHostEthIfFsmStage ManagedObject."""
import sys, os
...
class AdaptorHostEthIfFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
...
class AdaptorHostEthIfFsmStage(ManagedObject):
    """This is AdaptorHostEthIfFsmStage class."""

    consts = AdaptorHostEthIfFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("AdaptorHostEthIfFsmStage", "adaptorHostEthIfFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'adaptorHostEthIfFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["CircuitResetBegin", "CircuitResetDisableA", "CircuitResetDisableB", "CircuitResetEnableA", "CircuitResetEnableB", "CircuitResetFail", "CircuitResetSuccess", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "AdaptorHostEthIfFsmStage", parent_mo_or_dn, **kwargs)
