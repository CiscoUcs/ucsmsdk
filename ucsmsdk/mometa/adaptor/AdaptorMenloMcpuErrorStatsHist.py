"""This module contains the general information for AdaptorMenloMcpuErrorStatsHist ManagedObject."""
import sys, os
...
class AdaptorMenloMcpuErrorStatsHistConsts():
...
class AdaptorMenloMcpuErrorStatsHist(ManagedObject):
    """This is AdaptorMenloMcpuErrorStatsHist class."""

    consts = AdaptorMenloMcpuErrorStatsHistConsts()
    naming_props = set([u'id'])

    mo_meta = MoMeta("AdaptorMenloMcpuErrorStatsHist", "adaptorMenloMcpuErrorStatsHist", "[id]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], ["read-only"], [u'adaptorMenloMcpuErrorStats'], [], ["Get"])
