...
class AdaptorEthPortErrStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorEthPortErrStatsHist", "adaptorEthPortErrStatsHist", "[id]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], ["read-only"], [u'adaptorEthPortErrStats'], [], ["Get"])
