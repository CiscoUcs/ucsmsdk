...
class AdaptorEthPortErrStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorEthPortErrStatsHist", "adaptorEthPortErrStatsHist", "[id]", VersionMeta.Version111j, "OutputOnly", 0x7L, [], ["read-only"], [u'adaptorEthPortErrStats'], [], ["Get"])
