...
class AdaptorRnicCapSpec(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorRnicCapSpec", "adaptorRnicCapSpec", "cap-[type]", VersionMeta.Version224b, "InputOutput", 0x3fL, [], ["admin", "pn-policy"], [u'adaptorFruCapProvider'], [], ["Get"])
