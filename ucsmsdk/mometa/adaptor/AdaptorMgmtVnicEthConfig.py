...
class AdaptorMgmtVnicEthConfig(ManagedObject):
    ...
    prop_meta = {
        ...
        "host_port_id": MoPropertyMeta("host_port_id", "hostPortId", "byte", VersionMeta.Version224b, MoPropertyMeta.READ_WRITE, 0x8, None, None, None, [], []), 
        "mac_offset": MoPropertyMeta("mac_offset", "macOffset", "byte", VersionMeta.Version224b, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, [], []), 
        "pci_slot": MoPropertyMeta("pci_slot", "pciSlot", "byte", VersionMeta.Version224b, MoPropertyMeta.READ_WRITE, 0x20, None, None, None, [], []), 
