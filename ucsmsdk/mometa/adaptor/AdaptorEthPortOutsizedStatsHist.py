...
class AdaptorEthPortOutsizedStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorEthPortOutsizedStatsHist", "adaptorEthPortOutsizedStatsHist", "[id]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], ["read-only"], [u'adaptorEthPortOutsizedStats'], [], ["Get"])
