...
class AdaptorHostFcIfConsts():
    ...
    FSM_PREV_RESET_FC_PERS_BINDING_BEGIN = "ResetFcPersBindingBegin"
    FSM_PREV_RESET_FC_PERS_BINDING_EXECUTE_LOCAL = "ResetFcPersBindingExecuteLocal"
    FSM_PREV_RESET_FC_PERS_BINDING_EXECUTE_PEER = "ResetFcPersBindingExecutePeer"
    FSM_PREV_RESET_FC_PERS_BINDING_FAIL = "ResetFcPersBindingFail"
    FSM_PREV_RESET_FC_PERS_BINDING_SUCCESS = "ResetFcPersBindingSuccess"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_RESET_FC_PERS_BINDING_BEGIN = "ResetFcPersBindingBegin"
    FSM_STATUS_RESET_FC_PERS_BINDING_EXECUTE_LOCAL = "ResetFcPersBindingExecuteLocal"
    FSM_STATUS_RESET_FC_PERS_BINDING_EXECUTE_PEER = "ResetFcPersBindingExecutePeer"
    FSM_STATUS_RESET_FC_PERS_BINDING_FAIL = "ResetFcPersBindingFail"
    FSM_STATUS_RESET_FC_PERS_BINDING_SUCCESS = "ResetFcPersBindingSuccess"
    FSM_STATUS_NOP = "nop"
    HOST_PORT_1 = "1"
    HOST_PORT_2 = "2"
    HOST_PORT_ANY = "ANY"
...
class AdaptorHostFcIf(ManagedObject):
    ...
    prop_meta = {
        ...
        "discovery": MoPropertyMeta("discovery", "discovery", "string", VersionMeta.Version141i, MoPropertyMeta.READ_ONLY, None, None, None, None, ["absent", "mis-connect", "missing", "new", "present", "un-initialized"], []), 
        ...
        "id": MoPropertyMeta("id", "id", "uint", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x10L, None, None, None, [], []), 
        ...
        "link_state": MoPropertyMeta("link_state", "linkState", "string", VersionMeta.Version101e, MoPropertyMeta.READ_ONLY, None, None, None, None, ["admin-down", "down", "error", "unallocated", "unavailable", "unknown", "up"], []), 
        ...
        "max_data_field_size": MoPropertyMeta("max_data_field_size", "maxDataFieldSize", "uint", VersionMeta.Version111j, MoPropertyMeta.READ_ONLY, None, None, None, None, [], ["256-2112"]), 
        ...
        "node_wwn": MoPropertyMeta("node_wwn", "nodeWwn", "string", VersionMeta.Version101e, MoPropertyMeta.READ_ONLY, None, 0, 256, """(([A-Fa-f0-9][A-Fa-f0-9]:){7}[A-Fa-f0-9][A-Fa-f0-9])|0""", [], []), 
        ...
        "order": MoPropertyMeta("order", "order", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x20L, None, None, None, ["unspecified"], ["0-4294967295"]), 
        "original_node_wwn": MoPropertyMeta("original_node_wwn", "originalNodeWwn", "string", VersionMeta.Version101e, MoPropertyMeta.READ_ONLY, None, 0, 256, """(([A-Fa-f0-9][A-Fa-f0-9]:){7}[A-Fa-f0-9][A-Fa-f0-9])|0""", [], []), 
        "original_wwn": MoPropertyMeta("original_wwn", "originalWwn", "string", VersionMeta.Version101e, MoPropertyMeta.READ_ONLY, None, 0, 256, """(([A-Fa-f0-9][A-Fa-f0-9]:){7}[A-Fa-f0-9][A-Fa-f0-9])|0""", [], []), 
        ...
        "pers_bind": MoPropertyMeta("pers_bind", "persBind", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x40L, None, None, None, ["disabled", "enabled"], []), 
        ...
        "wwn": MoPropertyMeta("wwn", "wwn", "string", VersionMeta.Version101e, MoPropertyMeta.READ_ONLY, None, 0, 256, """(([A-Fa-f0-9][A-Fa-f0-9]:){7}[A-Fa-f0-9][A-Fa-f0-9])|0""", [], []), 
    }
