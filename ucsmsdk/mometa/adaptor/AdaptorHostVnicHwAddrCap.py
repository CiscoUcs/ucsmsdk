...
class AdaptorHostVnicHwAddrCap(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorHostVnicHwAddrCap", "adaptorHostVnicHwAddrCap", "hwaddr-hostvnic", VersionMeta.Version302a, "InputOutput", 0x1ff, [], ["read-only"], [u'adaptorFruCapProvider'], [], [None])
    ...
    prop_meta = {
        ...
        "mac_offset1": MoPropertyMeta("mac_offset1", "macOffset1", "byte", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x8, None, None, None, [], []), 
        "mac_offset2": MoPropertyMeta("mac_offset2", "macOffset2", "byte", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, [], []), 
        "mac_offset_vnic_from": MoPropertyMeta("mac_offset_vnic_from", "macOffsetVnicFrom", "byte", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x20, None, None, None, [], []), 
        "mac_offset_vnic_to": MoPropertyMeta("mac_offset_vnic_to", "macOffsetVnicTo", "byte", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x40, None, None, None, [], []), 
