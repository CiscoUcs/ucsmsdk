...
class AdaptorMenloNetEgStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorMenloNetEgStatsHist", "adaptorMenloNetEgStatsHist", "[id]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], ["read-only"], [u'adaptorMenloNetEgStats'], [], ["Get"])
