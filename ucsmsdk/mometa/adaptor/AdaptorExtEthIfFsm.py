"""This module contains the general information for AdaptorExtEthIfFsm ManagedObject."""
import sys, os
...
class AdaptorExtEthIfFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_PATH_RESET = "PathReset"
    CURRENT_FSM_NOP = "nop"
...
class AdaptorExtEthIfFsm(ManagedObject):
    """This is AdaptorExtEthIfFsm class."""

    consts = AdaptorExtEthIfFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("AdaptorExtEthIfFsm", "adaptorExtEthIfFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'adaptorExtEthIf'], [u'adaptorExtEthIfFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["PathReset", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "AdaptorExtEthIfFsm", parent_mo_or_dn, **kwargs)
