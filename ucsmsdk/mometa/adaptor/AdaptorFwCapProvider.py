"""This module contains the general information for AdaptorFwCapProvider ManagedObject."""
import sys, os
...
class AdaptorFwCapProviderConsts():
    DELETED_FALSE = "false"
    DELETED_NO = "no"
    DELETED_TRUE = "true"
    DELETED_YES = "yes"
...
class AdaptorFwCapProvider(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorFwCapProvider", "adaptorFwCapProvider", "fw-vendor-[vendor]-model-[model]-version-[version]", VersionMeta.Version101e, "InputOutput", 0x7fL, [], [""], [u'adaptorFruCapProvider'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "vendor": MoPropertyMeta("vendor", "vendor", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x20L, 1, 510, None, [], []), 
        "version": MoPropertyMeta("version", "version", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x40L, 1, 510, None, [], []), 
    }
    ...
    def __init__(self, parent_mo_or_dn, vendor, model, version, **kwargs):
        self._dirty_mask = 0
        self.vendor = vendor
        self.model = model
        ...
        ManagedObject.__init__(self, "AdaptorFwCapProvider", parent_mo_or_dn, **kwargs)
