...
class AdaptorSanCap(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorSanCap", "adaptorSanCap", "san", VersionMeta.Version101e, "InputOutput", 0x1fL, [], ["read-only"], [u'adaptorFruCapProvider'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "host_nvram": MoPropertyMeta("host_nvram", "hostNvram", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x4L, None, None, None, ["full", "none"], []), 
