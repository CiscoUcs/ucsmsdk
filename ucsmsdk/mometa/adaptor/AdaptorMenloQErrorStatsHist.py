...
class AdaptorMenloQErrorStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorMenloQErrorStatsHist", "adaptorMenloQErrorStatsHist", "[id]", VersionMeta.Version111j, "OutputOnly", 0x7L, [], ["read-only"], [u'adaptorMenloQErrorStats'], [], ["Get"])
