...
class AdaptorMenloQErrorStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorMenloQErrorStatsHist", "adaptorMenloQErrorStatsHist", "[id]", VersionMeta.Version111j, "OutputOnly", 0xf, [], ["read-only"], ['adaptorMenloQErrorStats'], [], ["Get"])
