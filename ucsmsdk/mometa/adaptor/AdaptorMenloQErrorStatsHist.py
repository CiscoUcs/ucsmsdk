"""This module contains the general information for AdaptorMenloQErrorStatsHist ManagedObject."""
import sys, os
...
class AdaptorMenloQErrorStatsHistConsts():
...
class AdaptorMenloQErrorStatsHist(ManagedObject):
    """This is AdaptorMenloQErrorStatsHist class."""

    consts = AdaptorMenloQErrorStatsHistConsts()
    naming_props = set([u'id'])

    mo_meta = MoMeta("AdaptorMenloQErrorStatsHist", "adaptorMenloQErrorStatsHist", "[id]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], ["read-only"], [u'adaptorMenloQErrorStats'], [], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, id, **kwargs):
        ...
        ManagedObject.__init__(self, "AdaptorMenloQErrorStatsHist", parent_mo_or_dn, **kwargs)
