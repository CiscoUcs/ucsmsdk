...
class AdaptorHostPort(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorHostPort", "adaptorHostPort", "host-port-[id]", VersionMeta.Version223a, "InputOutput", 0x3fL, [], ["read-only"], [u'adaptorUnit'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "id": MoPropertyMeta("id", "id", "uint", VersionMeta.Version223a, MoPropertyMeta.NAMING, 0x8L, None, None, None, [], ["1-5000"]), 
