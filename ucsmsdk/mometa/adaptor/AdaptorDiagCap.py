...
class AdaptorDiagCap(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorDiagCap", "adaptorDiagCap", "diag", VersionMeta.Version131c, "InputOutput", 0x3fL, [], ["read-only"], [u'adaptorFruCapProvider'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "enable_lldp_transmit": MoPropertyMeta("enable_lldp_transmit", "enableLldpTransmit", "string", VersionMeta.Version131c, MoPropertyMeta.READ_WRITE, 0x8L, None, None, None, ["false", "no", "true", "yes"], []), 
