...
class AdaptorMenloBaseErrorStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorMenloBaseErrorStatsHist", "adaptorMenloBaseErrorStatsHist", "[id]", VersionMeta.Version111j, "OutputOnly", 0x7L, [], ["read-only"], [u'adaptorMenloBaseErrorStats'], [], ["Get"])
