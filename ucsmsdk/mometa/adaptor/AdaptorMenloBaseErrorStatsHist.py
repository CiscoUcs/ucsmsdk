...
class AdaptorMenloBaseErrorStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorMenloBaseErrorStatsHist", "adaptorMenloBaseErrorStatsHist", "[id]", VersionMeta.Version111j, "OutputOnly", 0xf, [], ["read-only"], [u'adaptorMenloBaseErrorStats'], [], ["Get"])
