...
class AdaptorHostPortCap(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorHostPortCap", "adaptorHostPortCap", "max-host-port", VersionMeta.Version223a, "InputOutput", 0x3fL, [], ["read-only"], [u'adaptorFruCapProvider'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "max_ports": MoPropertyMeta("max_ports", "maxPorts", "ushort", VersionMeta.Version223a, MoPropertyMeta.READ_WRITE, 0x8L, None, None, None, [], []), 
