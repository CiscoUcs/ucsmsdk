...
class AdaptorExtEthIfConsts():
    ...
    FSM_PREV_PATH_RESET_BEGIN = "PathResetBegin"
    FSM_PREV_PATH_RESET_DISABLE = "PathResetDisable"
    FSM_PREV_PATH_RESET_ENABLE = "PathResetEnable"
    FSM_PREV_PATH_RESET_FAIL = "PathResetFail"
    FSM_PREV_PATH_RESET_SUCCESS = "PathResetSuccess"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_PATH_RESET_BEGIN = "PathResetBegin"
    FSM_STATUS_PATH_RESET_DISABLE = "PathResetDisable"
    FSM_STATUS_PATH_RESET_ENABLE = "PathResetEnable"
    FSM_STATUS_PATH_RESET_FAIL = "PathResetFail"
    FSM_STATUS_PATH_RESET_SUCCESS = "PathResetSuccess"
    FSM_STATUS_NOP = "nop"
    IF_ROLE_DIAG = "diag"
...
class AdaptorExtEthIf(ManagedObject):
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version101e, MoPropertyMeta.INTERNAL, None, None, None, None, ["PathResetBegin", "PathResetDisable", "PathResetEnable", "PathResetFail", "PathResetSuccess", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version101e, MoPropertyMeta.INTERNAL, None, None, None, None, ["PathResetBegin", "PathResetDisable", "PathResetEnable", "PathResetFail", "PathResetSuccess", "nop"], []), 
        ...
        "lldp_mac": MoPropertyMeta("lldp_mac", "lldpMac", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, """(([0-9a-fA-F][0-9a-fA-F]:){5}([0-9a-fA-F][0-9a-fA-F]))|0""", [], []), 
        ...
        "mac": MoPropertyMeta("mac", "mac", "string", VersionMeta.Version101e, MoPropertyMeta.READ_ONLY, None, None, None, """(([0-9a-fA-F][0-9a-fA-F]:){5}([0-9a-fA-F][0-9a-fA-F]))|0""", [], []), 
        "mac_addr_type": MoPropertyMeta("mac_addr_type", "macAddrType", "string", VersionMeta.Version201m, MoPropertyMeta.READ_ONLY, None, None, None, None, ["floating", "operational", "unknown"], []), 
        ...
        "oper_state_desc": MoPropertyMeta("oper_state_desc", "operStateDesc", "string", VersionMeta.Version101e, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
