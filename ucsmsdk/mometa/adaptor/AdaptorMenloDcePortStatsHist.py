...
class AdaptorMenloDcePortStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorMenloDcePortStatsHist", "adaptorMenloDcePortStatsHist", "[id]", VersionMeta.Version111j, "OutputOnly", 0x7L, [], ["read-only"], [u'adaptorMenloDcePortStats'], [], ["Get"])
