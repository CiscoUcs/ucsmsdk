...
class AdaptorMenloDcePortStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorMenloDcePortStatsHist", "adaptorMenloDcePortStatsHist", "[id]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], ["read-only"], [u'adaptorMenloDcePortStats'], [], ["Get"])
