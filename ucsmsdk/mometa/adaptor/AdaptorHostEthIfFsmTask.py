"""This module contains the general information for AdaptorHostEthIfFsmTask ManagedObject."""
import sys, os
...
class AdaptorHostEthIfFsmTaskConsts():
...
class AdaptorHostEthIfFsmTask(ManagedObject):
    """This is AdaptorHostEthIfFsmTask class."""

    consts = AdaptorHostEthIfFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("AdaptorHostEthIfFsmTask", "adaptorHostEthIfFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], [""], [u'adaptorHostEthIf'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, None, None, None, None, ["CircuitReset", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "AdaptorHostEthIfFsmTask", parent_mo_or_dn, **kwargs)
