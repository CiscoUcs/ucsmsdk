...
class AdaptorEthPortBySizeLargeStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorEthPortBySizeLargeStatsHist", "adaptorEthPortBySizeLargeStatsHist", "[id]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], ["read-only"], [u'adaptorEthPortBySizeLargeStats'], [], ["Get"])
