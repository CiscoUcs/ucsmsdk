...
class AdaptorEthPortBySizeLargeStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorEthPortBySizeLargeStatsHist", "adaptorEthPortBySizeLargeStatsHist", "[id]", VersionMeta.Version111j, "OutputOnly", 0x7L, [], ["read-only"], [u'adaptorEthPortBySizeLargeStats'], [], ["Get"])
