...
class AdaptorEthPortBySizeLargeStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorEthPortBySizeLargeStatsHist", "adaptorEthPortBySizeLargeStatsHist", "[id]", VersionMeta.Version111j, "OutputOnly", 0xf, [], ["read-only"], [u'adaptorEthPortBySizeLargeStats'], [], ["Get"])
