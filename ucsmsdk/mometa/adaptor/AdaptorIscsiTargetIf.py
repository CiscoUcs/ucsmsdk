...
class AdaptorIscsiTargetIf(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorIscsiTargetIf", "adaptorIscsiTargetIf", "iscsi-target[priority]", VersionMeta.Version201m, "InputOutput", 0x3fL, [], ["read-only"], [u'adaptorHostIscsiIf'], [], [None])
    ...
    prop_meta = {
        ...
        "priority": MoPropertyMeta("priority", "priority", "ushort", VersionMeta.Version201m, MoPropertyMeta.NAMING, 0x8L, None, None, None, [], []), 
