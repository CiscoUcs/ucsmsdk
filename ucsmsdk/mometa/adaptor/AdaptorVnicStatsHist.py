"""This module contains the general information for AdaptorVnicStatsHist ManagedObject."""
import sys, os
...
class AdaptorVnicStatsHistConsts():
...
class AdaptorVnicStatsHist(ManagedObject):
    """This is AdaptorVnicStatsHist class."""

    consts = AdaptorVnicStatsHistConsts()
    naming_props = set([u'id'])

    mo_meta = MoMeta("AdaptorVnicStatsHist", "adaptorVnicStatsHist", "[id]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], ["read-only"], [u'adaptorVnicStats'], [], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, id, **kwargs):
        ...
        ManagedObject.__init__(self, "AdaptorVnicStatsHist", parent_mo_or_dn, **kwargs)
