...
class AdaptorHostScsiLunRef(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorHostScsiLunRef", "adaptorHostScsiLunRef", "host-scsi-lun-[lun_order]", VersionMeta.Version251a, "InputOutput", 0x3fL, [], ["admin"], [u'adaptorHostScsiIf'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "lun_order": MoPropertyMeta("lun_order", "lunOrder", "string", VersionMeta.Version251a, MoPropertyMeta.NAMING, 0x8L, None, None, None, ["lowest-available", "not-applicable"], ["0-64", "1-64"]), 
        ...
        "oper_lun_order": MoPropertyMeta("oper_lun_order", "operLunOrder", "string", VersionMeta.Version251a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["lowest-available", "not-applicable"], ["0-64", "1-64"]), 
