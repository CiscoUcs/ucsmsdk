...
class AdaptorHostScsiLunRefConsts():
    ...
    LUN_ORDER_LOWEST_AVAILABLE = "lowest-available"
    OPER_LUN_ORDER_LOWEST_AVAILABLE = "lowest-available"
...
class AdaptorHostScsiLunRef(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorHostScsiLunRef", "adaptorHostScsiLunRef", "host-scsi-lun-[lun_order]", VersionMeta.Version251a, "InputOutput", 0x1fL, [], ["admin"], [u'adaptorHostScsiIf'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "lun_name": MoPropertyMeta("lun_name", "lunName", "string", VersionMeta.Version251a, MoPropertyMeta.READ_ONLY, None, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        "lun_order": MoPropertyMeta("lun_order", "lunOrder", "string", VersionMeta.Version251a, MoPropertyMeta.NAMING, 0x4L, None, None, None, ["lowest-available"], ["1-64"]), 
        ...
        "oper_lun_order": MoPropertyMeta("oper_lun_order", "operLunOrder", "string", VersionMeta.Version251a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["lowest-available"], ["1-64"]), 
