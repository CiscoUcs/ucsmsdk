"""This module contains the general information for AdaptorExtEthIfFsmTask ManagedObject."""
import sys, os
...
class AdaptorExtEthIfFsmTask(ManagedObject):
    ...
    consts = AdaptorExtEthIfFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("AdaptorExtEthIfFsmTask", "adaptorExtEthIfFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], [""], [u'adaptorExtEthIf'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, None, None, None, None, ["PathReset", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "AdaptorExtEthIfFsmTask", parent_mo_or_dn, **kwargs)
