...
class AdaptorQual(ManagedObject):
    """This is AdaptorQual class."""

    consts = AdaptorQualConsts()
    naming_props = set([])

    mo_meta = MoMeta("AdaptorQual", "adaptorQual", "adaptor", VersionMeta.Version101e, "InputOutput", 0x1fL, [], ["admin", "pn-policy"], [u'computeQual'], [u'adaptorCapQual'], ["Add", "Get", "Remove"])
