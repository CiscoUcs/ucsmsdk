...
class AdaptorMenloNetInStats(ManagedObject):
    ...
    naming_props = set([u'menloNetIndex'])

    mo_meta = MoMeta("AdaptorMenloNetInStats", "adaptorMenloNetInStats", "menlo-net-in-stats-[menlo_net_index]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], ["admin", "operations", "read-only"], [u'adaptorUnit'], [u'adaptorMenloNetInStatsHist'], ["Get"])
