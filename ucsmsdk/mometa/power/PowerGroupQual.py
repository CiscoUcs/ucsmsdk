...
class PowerGroupQual(ManagedObject):
    ...
    mo_meta = MoMeta("PowerGroupQual", "powerGroupQual", "power-group-[group_name]", VersionMeta.Version141i, "InputOutput", 0x1fL, [], ["admin", "pn-policy"], [u'computeQual'], [], ["Add", "Get", "Remove"])
    ...
    prop_meta = {
        ...
        "group_name": MoPropertyMeta("group_name", "groupName", "string", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x4L, None, None, """[\-\.:_a-zA-Z0-9]{1,16}""", [], []), 
