...
class PowerFIMember(ManagedObject):
    ...
    mo_meta = MoMeta("PowerFIMember", "powerFIMember", "fi-member-[id]", VersionMeta.Version911z, "InputOutput", 0x7f, [], ["admin", "power-mgmt", "read-only"], [u'powerGroup'], [], [None])
    ...
    prop_meta = {
        ...
        "fi_id": MoPropertyMeta("fi_id", "fiId", "string", VersionMeta.Version911z, MoPropertyMeta.READ_WRITE, 0x8, None, None, None, ["A", "B", "NONE"], []), 
        "id": MoPropertyMeta("id", "id", "uint", VersionMeta.Version911z, MoPropertyMeta.NAMING, 0x10, None, None, None, [], []), 
        "oper_state": MoPropertyMeta("oper_state", "operState", "string", VersionMeta.Version911z, MoPropertyMeta.READ_ONLY, None, None, None, None, ["cap-insufficient", "cap-ok", "fw-mismatch", "psu-insufficient", "psu-redundancy-failed", "uninitialized"], []), 
