...
class PowerBudget(ManagedObject):
    ...
    mo_meta = MoMeta("PowerBudget", "powerBudget", "budget", VersionMeta.Version111j, "InputOutput", 0x3fL, [], ["admin", "power-mgmt"], [u'computeBlade', u'computeExtBoard', u'computeRackUnit', u'computeServerUnit', u'equipmentChassis', u'storageBlade'], [u'faultInst', u'powerProfiledPower'], ["Get", "Set"])

    prop_meta = {
        "admin_committed": MoPropertyMeta("admin_committed", "adminCommitted", "string", VersionMeta.Version111j, MoPropertyMeta.READ_WRITE, 0x1L, None, None, None, ["unbounded"], ["0-10000000", "4294967295-4294967295"]), 
        "admin_fp_lock_state": MoPropertyMeta("admin_fp_lock_state", "adminFPLockState", "string", VersionMeta.Version224a, MoPropertyMeta.READ_WRITE, 0x2L, None, None, None, ["locked", "unknown", "unlocked"], []), 
        ...
        "admin_peak_new": MoPropertyMeta("admin_peak_new", "adminPeakNew", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["unbounded"], ["0-10000000", "4294967295-4294967295"]), 
        "boot_power": MoPropertyMeta("boot_power", "bootPower", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["unbounded"], ["0-10000000", "4294967295-4294967295"]), 
        ...
        "ch_rsrvd_power": MoPropertyMeta("ch_rsrvd_power", "chRsrvdPower", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["unbounded"], ["0-10000000", "4294967295-4294967295"]), 
        "child_action": MoPropertyMeta("child_action", "childAction", "string", VersionMeta.Version111j, MoPropertyMeta.INTERNAL, 0x4L, None, None, """((deleteAll|ignore|deleteNonPresent),){0,2}(deleteAll|ignore|deleteNonPresent){0,1}""", [], []), 
        ...
        "fan_speed": MoPropertyMeta("fan_speed", "fanSpeed", "string", VersionMeta.Version226a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["any", "balanced", "err", "high-power", "low-power", "max-power", "na", "no-update", "not-supported", "performance"], []), 
        "group_name": MoPropertyMeta("group_name", "groupName", "string", VersionMeta.Version141i, MoPropertyMeta.READ_ONLY, None, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        ...
        "oper_fp_lock_state": MoPropertyMeta("oper_fp_lock_state", "operFPLockState", "string", VersionMeta.Version224a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["locked", "unknown", "unlocked"], []), 
        ...
        "prof_method": MoPropertyMeta("prof_method", "profMethod", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["default", "nodemgr", "pnuos", "static", "unknown"], []), 
        "profiling": MoPropertyMeta("profiling", "profiling", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["false", "no", "true", "yes"], []), 
        ...
        "psu_line_mode": MoPropertyMeta("psu_line_mode", "psuLineMode", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["high-line", "low-line", "mixed-line", "undetermined", "unknown"], []), 
        ...
        "rn": MoPropertyMeta("rn", "rn", "string", VersionMeta.Version111j, MoPropertyMeta.READ_ONLY, 0x10L, 0, 256, None, [], []), 
        ...
        "update_time": MoPropertyMeta("update_time", "updateTime", "string", VersionMeta.Version141i, MoPropertyMeta.READ_ONLY, None, None, None, """([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", [], []), 
