...
class PowerBudget(ManagedObject):
    ...
    mo_meta = MoMeta("PowerBudget", "powerBudget", "budget", VersionMeta.Version111j, "InputOutput", 0x7fL, [], ["admin", "power-mgmt"], [u'computeBlade', u'computeExtBoard', u'computeRackUnit', u'computeServerUnit', u'equipmentChassis', u'storageBlade'], [u'faultInst', u'powerProfiledPower'], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "admin_fp_lock_state": MoPropertyMeta("admin_fp_lock_state", "adminFPLockState", "string", VersionMeta.Version224b, MoPropertyMeta.READ_WRITE, 0x4L, None, None, None, ["locked", "unknown", "unlocked"], []), 
