...
class PowerRackUnitMember(ManagedObject):
    ...
    mo_meta = MoMeta("PowerRackUnitMember", "powerRackUnitMember", "ru-member-[id]", VersionMeta.Version141i, "InputOutput", 0x3fL, [], ["admin", "power-mgmt", "read-only"], [u'powerGroup'], [], ["Get"])
