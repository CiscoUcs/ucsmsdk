...
class PowerPrioWght(ManagedObject):
    ...
    mo_meta = MoMeta("PowerPrioWght", "powerPrioWght", "weight-[prio]", VersionMeta.Version141i, "InputOutput", 0x3fL, [], ["admin", "power-mgmt"], [u'powerEp'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "prio": MoPropertyMeta("prio", "prio", "string", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x4L, None, None, None, ["no-cap", "utility"], ["1-10"]), 
        ...
        "weight": MoPropertyMeta("weight", "weight", "byte", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x20L, None, None, None, [], ["0-200"]), 
    }
