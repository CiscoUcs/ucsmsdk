...
class PowerChassisMember(ManagedObject):
    ...
    mo_meta = MoMeta("PowerChassisMember", "powerChassisMember", "ch-member-[id]", VersionMeta.Version141i, "InputOutput", 0x3fL, [], ["admin", "power-mgmt", "read-only"], [u'powerGroup'], [u'faultInst'], ["Add", "Get", "Remove"])
