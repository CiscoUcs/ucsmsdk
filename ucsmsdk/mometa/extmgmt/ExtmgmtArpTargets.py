...
class ExtmgmtArpTargets(ManagedObject):
    ...
    mo_meta = MoMeta("ExtmgmtArpTargets", "extmgmtArpTargets", "arp-target-policy", VersionMeta.Version141i, "InputOutput", 0x1ffL, [], ["admin", "ext-lan-config"], [u'extmgmtIfMonPolicy'], [u'faultInst'], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "max_deadline_timeout": MoPropertyMeta("max_deadline_timeout", "maxDeadlineTimeout", "uint", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x4L, None, None, None, [], ["5-15"]), 
        "number_of_arp_requests": MoPropertyMeta("number_of_arp_requests", "numberOfArpRequests", "uint", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x8L, None, None, None, [], ["1-5"]), 
        ...
        "target_ip1": MoPropertyMeta("target_ip1", "targetIp1", "string", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x40L, 0, 256, """((([0-9]){1,3}\.){3}[0-9]{1,3})""", [], []), 
        "target_ip2": MoPropertyMeta("target_ip2", "targetIp2", "string", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x80L, 0, 256, """((([0-9]){1,3}\.){3}[0-9]{1,3})""", [], []), 
        "target_ip3": MoPropertyMeta("target_ip3", "targetIp3", "string", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x100L, 0, 256, """((([0-9]){1,3}\.){3}[0-9]{1,3})""", [], []), 
    }
