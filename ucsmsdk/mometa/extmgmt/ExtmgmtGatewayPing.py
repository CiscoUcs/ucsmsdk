...
class ExtmgmtGatewayPing(ManagedObject):
    ...
    mo_meta = MoMeta("ExtmgmtGatewayPing", "extmgmtGatewayPing", "gw-ping-policy", VersionMeta.Version141i, "InputOutput", 0x3fL, [], ["admin", "ext-lan-config"], [u'extmgmtIfMonPolicy'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "number_of_ping_requests": MoPropertyMeta("number_of_ping_requests", "numberOfPingRequests", "uint", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x8L, None, None, None, [], ["1-5"]), 
