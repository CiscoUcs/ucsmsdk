...
class EpqosDefinitionDelTaskFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("EpqosDefinitionDelTaskFsmStage", "epqosDefinitionDelTaskFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xf, [], [""], [u'epqosDefinitionDelTaskFsm'], [], [None])
