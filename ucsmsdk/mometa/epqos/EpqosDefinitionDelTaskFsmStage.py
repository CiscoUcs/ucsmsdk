"""This module contains the general information for EpqosDefinitionDelTaskFsmStage ManagedObject."""
import sys, os
...
class EpqosDefinitionDelTaskFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_REMOVE_BEGIN = "RemoveBegin"
    NAME_REMOVE_FAIL = "RemoveFail"
    NAME_REMOVE_LOCAL = "RemoveLocal"
    NAME_REMOVE_PEER = "RemovePeer"
    NAME_REMOVE_SUCCESS = "RemoveSuccess"
    NAME_NOP = "nop"
...
class EpqosDefinitionDelTaskFsmStage(ManagedObject):
    """This is EpqosDefinitionDelTaskFsmStage class."""

    consts = EpqosDefinitionDelTaskFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("EpqosDefinitionDelTaskFsmStage", "epqosDefinitionDelTaskFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'epqosDefinitionDelTaskFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["RemoveBegin", "RemoveFail", "RemoveLocal", "RemovePeer", "RemoveSuccess", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "EpqosDefinitionDelTaskFsmStage", parent_mo_or_dn, **kwargs)
