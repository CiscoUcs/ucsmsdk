"""This module contains the general information for EpqosDefinitionFsmStage ManagedObject."""
import sys, os
...
class EpqosDefinitionFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
...
class EpqosDefinitionFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("EpqosDefinitionFsmStage", "epqosDefinitionFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'epqosDefinitionFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["DeployBegin", "DeployFail", "DeployLocal", "DeployPeer", "DeploySuccess", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "EpqosDefinitionFsmStage", parent_mo_or_dn, **kwargs)
