"""This module contains the general information for EpqosDefinitionFsm ManagedObject."""
import sys, os
...
class EpqosDefinitionFsmConsts():
    COMPLETION_TIME_ = ""
...
class EpqosDefinitionFsm(ManagedObject):
    """This is EpqosDefinitionFsm class."""

    consts = EpqosDefinitionFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("EpqosDefinitionFsm", "epqosDefinitionFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'epqosDefinition'], [u'epqosDefinitionFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Deploy", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "EpqosDefinitionFsm", parent_mo_or_dn, **kwargs)
