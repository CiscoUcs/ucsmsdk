...
class EpqosDefinition(ManagedObject):
    ...
    mo_meta = MoMeta("EpqosDefinition", "epqosDefinition", "ep-qos-[name]", VersionMeta.Version101e, "InputOutput", 0x7fL, [], ["admin", "ls-network", "ls-network-policy", "ls-qos-policy", "read-only"], [u'orgOrg'], [u'epqosDefinitionFsm', u'epqosDefinitionFsmTask', u'epqosEgress', u'eventInst', u'faultInst'], ["Add", "Get", "Remove", "Set"])
