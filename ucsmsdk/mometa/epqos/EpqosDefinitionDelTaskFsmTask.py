"""This module contains the general information for EpqosDefinitionDelTaskFsmTask ManagedObject."""
import sys, os
...
class EpqosDefinitionDelTaskFsmTaskConsts():
...
class EpqosDefinitionDelTaskFsmTask(ManagedObject):
    """This is EpqosDefinitionDelTaskFsmTask class."""

    consts = EpqosDefinitionDelTaskFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("EpqosDefinitionDelTaskFsmTask", "epqosDefinitionDelTaskFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], [""], [u'epqosDefinitionDelTask'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, None, None, None, None, ["Remove", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "EpqosDefinitionDelTaskFsmTask", parent_mo_or_dn, **kwargs)
