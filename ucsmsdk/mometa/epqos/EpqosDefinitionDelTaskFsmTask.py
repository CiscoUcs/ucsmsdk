...
class EpqosDefinitionDelTaskFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("EpqosDefinitionDelTaskFsmTask", "epqosDefinitionDelTaskFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0x7L, [], [""], [u'epqosDefinitionDelTask'], [], [None])
