...
class EpqosDefinitionDelTaskFsm(ManagedObject):
    """This is EpqosDefinitionDelTaskFsm class."""

    consts = EpqosDefinitionDelTaskFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("EpqosDefinitionDelTaskFsm", "epqosDefinitionDelTaskFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'epqosDefinitionDelTask'], [u'epqosDefinitionDelTaskFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Remove", "nop"], []), 
