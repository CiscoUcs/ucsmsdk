...
class EpqosDefinitionDelTaskFsm(ManagedObject):
    ...
    mo_meta = MoMeta("EpqosDefinitionDelTaskFsm", "epqosDefinitionDelTaskFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'epqosDefinitionDelTask'], [u'epqosDefinitionDelTaskFsmStage'], [None])
