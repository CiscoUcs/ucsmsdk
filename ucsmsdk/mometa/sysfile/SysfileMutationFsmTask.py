...
class SysfileMutationFsmTask(ManagedObject):
    """This is SysfileMutationFsmTask class."""

    consts = SysfileMutationFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("SysfileMutationFsmTask", "sysfileMutationFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], [""], [u'sysfileMutation'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, None, None, None, None, ["Global", "Single", "nop"], []), 
