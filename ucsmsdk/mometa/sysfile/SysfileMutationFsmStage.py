...
class SysfileMutationFsmStageConsts():
    ...
    NAME_GLOBAL_LOCAL = "GlobalLocal"
    NAME_GLOBAL_PEER = "GlobalPeer"
    NAME_GLOBAL_SUCCESS = "GlobalSuccess"
    NAME_SINGLE_BEGIN = "SingleBegin"
    NAME_SINGLE_EXECUTE = "SingleExecute"
    NAME_SINGLE_FAIL = "SingleFail"
    NAME_SINGLE_SUCCESS = "SingleSuccess"
    NAME_NOP = "nop"
...
class SysfileMutationFsmStage(ManagedObject):
    """This is SysfileMutationFsmStage class."""

    consts = SysfileMutationFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("SysfileMutationFsmStage", "sysfileMutationFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'sysfileMutationFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["GlobalBegin", "GlobalFail", "GlobalLocal", "GlobalPeer", "GlobalSuccess", "SingleBegin", "SingleExecute", "SingleFail", "SingleSuccess", "nop"], []), 
