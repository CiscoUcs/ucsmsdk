"""This module contains the general information for SysfileMutationFsm ManagedObject."""
import sys, os
...
class SysfileMutationFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_GLOBAL = "Global"
    CURRENT_FSM_SINGLE = "Single"
    CURRENT_FSM_NOP = "nop"
...
class SysfileMutationFsm(ManagedObject):
    """This is SysfileMutationFsm class."""

    consts = SysfileMutationFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("SysfileMutationFsm", "sysfileMutationFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'sysfileMutation'], [u'sysfileMutationFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Global", "Single", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "SysfileMutationFsm", parent_mo_or_dn, **kwargs)
