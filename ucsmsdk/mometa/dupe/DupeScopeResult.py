...
class DupeScopeResult(ManagedObject):
    ...
    mo_meta = MoMeta("DupeScopeResult", "dupeScopeResult", "result", VersionMeta.Version302a, "InputOutput", 0xfL, [], ["admin"], [], [], [None])
    ...
    prop_meta = {
        ...
        "update_time": MoPropertyMeta("update_time", "updateTime", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, """([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", [], []), 
    }
