...
class DupeScope(ManagedObject):
    ...
    mo_meta = MoMeta("DupeScope", "dupeScope", "scope-[id]", VersionMeta.Version302c, "InputOutput", 0xffL, [], ["admin"], [], [], [None])
    ...
    prop_meta = {
        ...
        "oper_code": MoPropertyMeta("oper_code", "operCode", "string", VersionMeta.Version302c, MoPropertyMeta.READ_WRITE, 0x10L, None, None, None, ["create", "delete"], []), 
        ...
        "source_mo_dn": MoPropertyMeta("source_mo_dn", "sourceMoDn", "string", VersionMeta.Version302c, MoPropertyMeta.READ_WRITE, 0x40L, 0, 256, None, [], []), 
