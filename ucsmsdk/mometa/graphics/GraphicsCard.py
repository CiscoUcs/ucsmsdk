...
class GraphicsCard(ManagedObject):
    ...
    mo_meta = MoMeta("GraphicsCard", "graphicsCard", "graphics-card-[id]", VersionMeta.Version213a, "InputOutput", 0x1fL, [], ["read-only"], [u'computeBoard'], [u'firmwareBootDefinition', u'firmwareRunning', u'graphicsController'], ["Get"])
