...
class IpServiceIf(ManagedObject):
    ...
    mo_meta = MoMeta("IpServiceIf", "ipServiceIf", "serv-ip-[addr]-port-[port]", VersionMeta.Version211a, "InputOutput", 0xffL, [], ["admin"], [u'storageEtherIf'], [], [None])
    ...
    prop_meta = {
        ...
        "port": MoPropertyMeta("port", "port", "uint", VersionMeta.Version211a, MoPropertyMeta.NAMING, 0x10L, None, None, None, [], ["1-65535"]), 
