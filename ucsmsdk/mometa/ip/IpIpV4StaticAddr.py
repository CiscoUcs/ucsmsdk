...
class IpIpV4StaticAddr(ManagedObject):
    ...
    mo_meta = MoMeta("IpIpV4StaticAddr", "ipIpV4StaticAddr", "addr-[addr]", VersionMeta.Version211a, "InputOutput", 0xffL, [], ["admin"], [], [], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "def_gw": MoPropertyMeta("def_gw", "defGw", "string", VersionMeta.Version211a, MoPropertyMeta.READ_WRITE, 0x4L, 0, 256, """((([0-9]){1,3}\.){3}[0-9]{1,3})""", [], []), 
        ...
        "subnet": MoPropertyMeta("subnet", "subnet", "string", VersionMeta.Version211a, MoPropertyMeta.READ_WRITE, 0x80L, 0, 256, """((([0-9]){1,3}\.){3}[0-9]{1,3})""", [], []), 
    }
