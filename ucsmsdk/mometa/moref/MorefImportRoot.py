"""This module contains the general information for MorefImportRoot ManagedObject."""
...
class MorefImportRootConsts:
    FSM_PREV_APPLY_MO_REFS_APPLY_MO_PROPS = "ApplyMoRefsApplyMoProps"
    FSM_PREV_APPLY_MO_REFS_BEGIN = "ApplyMoRefsBegin"
    FSM_PREV_APPLY_MO_REFS_DELETE_ALL_MO_REFS = "ApplyMoRefsDeleteAllMoRefs"
    FSM_PREV_APPLY_MO_REFS_FAIL = "ApplyMoRefsFail"
    FSM_PREV_APPLY_MO_REFS_SUCCESS = "ApplyMoRefsSuccess"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_APPLY_MO_REFS_APPLY_MO_PROPS = "ApplyMoRefsApplyMoProps"
    FSM_STATUS_APPLY_MO_REFS_BEGIN = "ApplyMoRefsBegin"
    FSM_STATUS_APPLY_MO_REFS_DELETE_ALL_MO_REFS = "ApplyMoRefsDeleteAllMoRefs"
    FSM_STATUS_APPLY_MO_REFS_FAIL = "ApplyMoRefsFail"
    FSM_STATUS_APPLY_MO_REFS_SUCCESS = "ApplyMoRefsSuccess"
    FSM_STATUS_NOP = "nop"


class MorefImportRoot(ManagedObject):
    """This is MorefImportRoot class."""

    consts = MorefImportRootConsts()
    naming_props = set([])

    mo_meta = MoMeta("MorefImportRoot", "morefImportRoot", "import-ref-root", VersionMeta.Version227b, "InputOutput", 0x1f, [], ["admin"], [u'topRoot'], [u'eventInst', u'faultInst', u'morefFruRef', u'morefImportRootFsm', u'morefImportRootFsmTask', u'morefRef'], [None])
    ...
    def __init__(self, **kwargs):
        ...
        ManagedObject.__init__(self, "MorefImportRoot", **kwargs)
