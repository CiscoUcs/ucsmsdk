"""This module contains the general information for MorefImportRootFsm ManagedObject."""
...
class MorefImportRootFsmConsts:
    COMPLETION_TIME_ = ""
    CURRENT_FSM_APPLY_MO_REFS = "ApplyMoRefs"
    CURRENT_FSM_NOP = "nop"
...
class MorefImportRootFsm(ManagedObject):
    """This is MorefImportRootFsm class."""

    consts = MorefImportRootFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("MorefImportRootFsm", "morefImportRootFsm", "fsm", VersionMeta.Version227b, "OutputOnly", 0xf, [], [""], [u'morefImportRoot'], [u'morefImportRootFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "MorefImportRootFsm", parent_mo_or_dn, **kwargs)
