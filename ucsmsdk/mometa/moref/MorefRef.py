...
class MorefRef(ManagedObject):
    ...
    mo_meta = MoMeta("MorefRef", "morefRef", "[mo_rn]", VersionMeta.Version227b, "InputOutput", 0x3f, [], ["admin"], [u'morefFruRef', u'morefImportRoot', u'morefRef'], [u'morefProp', u'morefRef'], [None])
    ...
    prop_meta = {
        ...
        "mo_rn": MoPropertyMeta("mo_rn", "moRn", "string", VersionMeta.Version227b, MoPropertyMeta.NAMING, 0x8, None, None, r"""[\-\.:_a-zA-Z0-9]{1,16}""", [], []), 
