...
class ObserveObservedConsts():
    FSM_PREV_RESOLVE_CONTROLLER_FSM_BEGIN = "ResolveControllerFsmBegin"
    FSM_PREV_RESOLVE_CONTROLLER_FSM_EXECUTE = "ResolveControllerFsmExecute"
    FSM_PREV_RESOLVE_CONTROLLER_FSM_FAIL = "ResolveControllerFsmFail"
    FSM_PREV_RESOLVE_CONTROLLER_FSM_SUCCESS = "ResolveControllerFsmSuccess"
    FSM_PREV_RESOLVE_POLICY_FSM_BEGIN = "ResolvePolicyFsmBegin"
    FSM_PREV_RESOLVE_POLICY_FSM_EXECUTE = "ResolvePolicyFsmExecute"
    FSM_PREV_RESOLVE_POLICY_FSM_FAIL = "ResolvePolicyFsmFail"
    FSM_PREV_RESOLVE_POLICY_FSM_SUCCESS = "ResolvePolicyFsmSuccess"
    FSM_PREV_RESOLVE_RESOURCE_FSM_BEGIN = "ResolveResourceFsmBegin"
    FSM_PREV_RESOLVE_RESOURCE_FSM_EXECUTE = "ResolveResourceFsmExecute"
    FSM_PREV_RESOLVE_RESOURCE_FSM_FAIL = "ResolveResourceFsmFail"
    FSM_PREV_RESOLVE_RESOURCE_FSM_SUCCESS = "ResolveResourceFsmSuccess"
    FSM_PREV_RESOLVE_VMFSM_BEGIN = "ResolveVMFsmBegin"
    FSM_PREV_RESOLVE_VMFSM_EXECUTE = "ResolveVMFsmExecute"
    FSM_PREV_RESOLVE_VMFSM_FAIL = "ResolveVMFsmFail"
    FSM_PREV_RESOLVE_VMFSM_SUCCESS = "ResolveVMFsmSuccess"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_RESOLVE_CONTROLLER_FSM_BEGIN = "ResolveControllerFsmBegin"
    FSM_STATUS_RESOLVE_CONTROLLER_FSM_EXECUTE = "ResolveControllerFsmExecute"
    FSM_STATUS_RESOLVE_CONTROLLER_FSM_FAIL = "ResolveControllerFsmFail"
    FSM_STATUS_RESOLVE_CONTROLLER_FSM_SUCCESS = "ResolveControllerFsmSuccess"
    FSM_STATUS_RESOLVE_POLICY_FSM_BEGIN = "ResolvePolicyFsmBegin"
    FSM_STATUS_RESOLVE_POLICY_FSM_EXECUTE = "ResolvePolicyFsmExecute"
    FSM_STATUS_RESOLVE_POLICY_FSM_FAIL = "ResolvePolicyFsmFail"
    FSM_STATUS_RESOLVE_POLICY_FSM_SUCCESS = "ResolvePolicyFsmSuccess"
    FSM_STATUS_RESOLVE_RESOURCE_FSM_BEGIN = "ResolveResourceFsmBegin"
    FSM_STATUS_RESOLVE_RESOURCE_FSM_EXECUTE = "ResolveResourceFsmExecute"
    FSM_STATUS_RESOLVE_RESOURCE_FSM_FAIL = "ResolveResourceFsmFail"
    FSM_STATUS_RESOLVE_RESOURCE_FSM_SUCCESS = "ResolveResourceFsmSuccess"
    FSM_STATUS_RESOLVE_VMFSM_BEGIN = "ResolveVMFsmBegin"
    FSM_STATUS_RESOLVE_VMFSM_EXECUTE = "ResolveVMFsmExecute"
    FSM_STATUS_RESOLVE_VMFSM_FAIL = "ResolveVMFsmFail"
    FSM_STATUS_RESOLVE_VMFSM_SUCCESS = "ResolveVMFsmSuccess"
    FSM_STATUS_NOP = "nop"
...
class ObserveObserved(ManagedObject):
    ...
    mo_meta = MoMeta("ObserveObserved", "observeObserved", "observed-[data_src_sys_id]-[id]", VersionMeta.Version211a, "InputOutput", 0x1ffL, [], ["admin"], [u'extpolClient', u'extpolController', u'extpolProvider', u'extpolRegistry', u'observeObservedCont'], [u'eventInst', u'faultInst', u'observeFilter', u'observeObservedFsm', u'observeObservedFsmTask'], [None])
    ...
    prop_meta = {
        ...
        "data_src_app_type": MoPropertyMeta("data_src_app_type", "dataSrcAppType", "string", VersionMeta.Version211a, MoPropertyMeta.CREATE_ONLY, 0x2L, 0, 510, None, [], []), 
        "data_src_sys_id": MoPropertyMeta("data_src_sys_id", "dataSrcSysId", "uint", VersionMeta.Version211a, MoPropertyMeta.NAMING, 0x4L, None, None, None, [], []), 
        ...
        "hierarchical": MoPropertyMeta("hierarchical", "hierarchical", "string", VersionMeta.Version211a, MoPropertyMeta.CREATE_ONLY, 0x10L, None, None, None, ["false", "no", "true", "yes"], []), 
        "id": MoPropertyMeta("id", "id", "uint", VersionMeta.Version211a, MoPropertyMeta.NAMING, 0x20L, None, None, None, [], []), 
        ...
        "observed_dn": MoPropertyMeta("observed_dn", "observedDn", "string", VersionMeta.Version211a, MoPropertyMeta.CREATE_ONLY, 0x40L, 0, 256, None, [], []), 
    ...
    prop_map = {
        ...
        "dataSrcAppType": "data_src_app_type", 
        "dataSrcSysId": "data_src_sys_id", 
        "dn": "dn", 
        "fsmDescr": "fsm_descr", 
        "fsmPrev": "fsm_prev", 
        "fsmProgr": "fsm_progr", 
        ...
        "observedDn": "observed_dn", 
        "rn": "rn", 
        "sacl": "sacl", 
        "status": "status", 
    }

    def __init__(self, parent_mo_or_dn, data_src_sys_id, id, **kwargs):
        self._dirty_mask = 0
        self.data_src_sys_id = data_src_sys_id
        self.id = id
        self.child_action = None
        self.data_src_app_type = None
        self.fsm_descr = None
        self.fsm_prev = None
        self.fsm_progr = None
        ...
        ManagedObject.__init__(self, "ObserveObserved", parent_mo_or_dn, **kwargs)
