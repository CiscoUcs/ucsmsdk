"""This module contains the general information for ObserveObservedFsmStage ManagedObject."""
import sys, os
...
class ObserveObservedFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_RESOLVE_CONTROLLER_FSM_BEGIN = "ResolveControllerFsmBegin"
    NAME_RESOLVE_CONTROLLER_FSM_EXECUTE = "ResolveControllerFsmExecute"
    NAME_RESOLVE_CONTROLLER_FSM_FAIL = "ResolveControllerFsmFail"
    NAME_RESOLVE_CONTROLLER_FSM_SUCCESS = "ResolveControllerFsmSuccess"
    NAME_RESOLVE_POLICY_FSM_BEGIN = "ResolvePolicyFsmBegin"
    NAME_RESOLVE_POLICY_FSM_EXECUTE = "ResolvePolicyFsmExecute"
    NAME_RESOLVE_POLICY_FSM_FAIL = "ResolvePolicyFsmFail"
    NAME_RESOLVE_POLICY_FSM_SUCCESS = "ResolvePolicyFsmSuccess"
    NAME_RESOLVE_RESOURCE_FSM_BEGIN = "ResolveResourceFsmBegin"
    NAME_RESOLVE_RESOURCE_FSM_EXECUTE = "ResolveResourceFsmExecute"
    NAME_RESOLVE_RESOURCE_FSM_FAIL = "ResolveResourceFsmFail"
    NAME_RESOLVE_RESOURCE_FSM_SUCCESS = "ResolveResourceFsmSuccess"
    NAME_RESOLVE_VMFSM_BEGIN = "ResolveVMFsmBegin"
    NAME_RESOLVE_VMFSM_EXECUTE = "ResolveVMFsmExecute"
    NAME_RESOLVE_VMFSM_FAIL = "ResolveVMFsmFail"
    NAME_RESOLVE_VMFSM_SUCCESS = "ResolveVMFsmSuccess"
    NAME_NOP = "nop"
...
class ObserveObservedFsmStage(ManagedObject):
    """This is ObserveObservedFsmStage class."""

    consts = ObserveObservedFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("ObserveObservedFsmStage", "observeObservedFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'observeObservedFsm'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "ObserveObservedFsmStage", parent_mo_or_dn, **kwargs)
