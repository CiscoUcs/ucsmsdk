...
class ObserveObservedFsmConsts():
    ...
    CURRENT_FSM_RESOLVE_RESOURCE_FSM = "ResolveResourceFsm"
    CURRENT_FSM_RESOLVE_VMFSM = "ResolveVMFsm"
    CURRENT_FSM_NOP = "nop"
...
class ObserveObservedFsm(ManagedObject):
    """This is ObserveObservedFsm class."""

    consts = ObserveObservedFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("ObserveObservedFsm", "observeObservedFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'observeObserved'], [u'observeObservedFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["ResolveControllerFsm", "ResolvePolicyFsm", "ResolveResourceFsm", "ResolveVMFsm", "nop"], []), 
