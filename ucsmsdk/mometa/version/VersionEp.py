...
class VersionEp(ManagedObject):
    """This is VersionEp class."""

    consts = VersionEpConsts()
    naming_props = set([])

    mo_meta = MoMeta("VersionEp", "versionEp", "version", VersionMeta.Version211a, "InputOutput", 0x1fL, [], ["read-only"], [u'topSystem'], [u'versionApplication'], [None])
