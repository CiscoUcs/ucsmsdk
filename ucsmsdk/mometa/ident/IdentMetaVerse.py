"""This module contains the general information for IdentMetaVerse ManagedObject."""
import sys, os
...
class IdentMetaVerseConsts():
    pass


class IdentMetaVerse(ManagedObject):
    """This is IdentMetaVerse class."""

    consts = IdentMetaVerseConsts()
    naming_props = set([])

    mo_meta = MoMeta("IdentMetaVerse", "identMetaVerse", "metaverse", VersionMeta.Version211a, "InputOutput", 0x1fL, [], ["read-only"], [u'topRoot'], [u'identMetaSystem'], [None])
    ...
    def __init__(self, **kwargs):
        ...
        ManagedObject.__init__(self, "IdentMetaVerse", **kwargs)
