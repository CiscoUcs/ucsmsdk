...
class IdentMetaSystemConsts():
    ...
    FSM_PREV_SYNC_PING = "syncPing"
    FSM_PREV_SYNC_SUCCESS = "syncSuccess"
    FSM_PREV_UCSC_UNIV_SYNC_BEGIN = "ucscUnivSyncBegin"
    FSM_PREV_UCSC_UNIV_SYNC_EXECUTE = "ucscUnivSyncExecute"
    FSM_PREV_UCSC_UNIV_SYNC_FAIL = "ucscUnivSyncFail"
    FSM_PREV_UCSC_UNIV_SYNC_SUCCESS = "ucscUnivSyncSuccess"
    ...
    FSM_STATUS_SYNC_PING = "syncPing"
    FSM_STATUS_SYNC_SUCCESS = "syncSuccess"
    FSM_STATUS_UCSC_UNIV_SYNC_BEGIN = "ucscUnivSyncBegin"
    FSM_STATUS_UCSC_UNIV_SYNC_EXECUTE = "ucscUnivSyncExecute"
    FSM_STATUS_UCSC_UNIV_SYNC_FAIL = "ucscUnivSyncFail"
    FSM_STATUS_UCSC_UNIV_SYNC_SUCCESS = "ucscUnivSyncSuccess"


class IdentMetaSystem(ManagedObject):
    """This is IdentMetaSystem class."""

    consts = IdentMetaSystemConsts()
    naming_props = set([])

    mo_meta = MoMeta("IdentMetaSystem", "identMetaSystem", "metasys", VersionMeta.Version211a, "InputOutput", 0xfL, [], ["read-only"], [u'identMetaVerse'], [u'eventInst', u'faultInst', u'identIdentRequest', u'identMetaSystemFsm', u'identMetaSystemFsmTask'], [None])
    ...
    prop_meta = {
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version211a, MoPropertyMeta.INTERNAL, None, None, None, None, ["nop", "syncBegin", "syncExecute", "syncFail", "syncPing", "syncSuccess", "ucscUnivSyncBegin", "ucscUnivSyncExecute", "ucscUnivSyncFail", "ucscUnivSyncSuccess"], []), 
