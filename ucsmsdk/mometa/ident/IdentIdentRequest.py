...
class IdentIdentRequest(ManagedObject):
    ...
    mo_meta = MoMeta("IdentIdentRequest", "identIdentRequest", "IdentQ-[id]", VersionMeta.Version211a, "InputOutput", 0x3f, [], ["read-only"], ['identMetaSystem'], ['eventInst', 'faultInst', 'identIdentCtx', 'identIdentRequestFsm', 'identIdentRequestFsmTask'], [None])
