...
class IdentIdentRequestConsts():
    ...
    FSM_PREV_UPDATE_IDENT_FAIL = "updateIdentFail"
    FSM_PREV_UPDATE_IDENT_SUCCESS = "updateIdentSuccess"
    ...
    FSM_STATUS_NOP = "nop"
    FSM_STATUS_UPDATE_IDENT_BEGIN = "updateIdentBegin"
    FSM_STATUS_UPDATE_IDENT_EXECUTE = "updateIdentExecute"
    FSM_STATUS_UPDATE_IDENT_FAIL = "updateIdentFail"
    FSM_STATUS_UPDATE_IDENT_SUCCESS = "updateIdentSuccess"
...
class IdentIdentRequest(ManagedObject):
    ...
    mo_meta = MoMeta("IdentIdentRequest", "identIdentRequest", "IdentQ-[id]", VersionMeta.Version211a, "InputOutput", 0x1fL, [], ["read-only"], [u'identMetaSystem'], [u'eventInst', u'faultInst', u'identIdentCtx', u'identIdentRequestFsm', u'identIdentRequestFsmTask'], [None])
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version211a, MoPropertyMeta.INTERNAL, None, None, None, None, ["nop", "updateIdentBegin", "updateIdentExecute", "updateIdentFail", "updateIdentSuccess"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version211a, MoPropertyMeta.INTERNAL, None, None, None, None, ["nop", "updateIdentBegin", "updateIdentExecute", "updateIdentFail", "updateIdentSuccess"], []), 
        ...
        "request_size": MoPropertyMeta("request_size", "requestSize", "uint", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        ...
        "seq_num": MoPropertyMeta("seq_num", "seqNum", "uint", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
