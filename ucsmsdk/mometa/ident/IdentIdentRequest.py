...
class IdentIdentRequest(ManagedObject):
    ...
    mo_meta = MoMeta("IdentIdentRequest", "identIdentRequest", "IdentQ-[id]", VersionMeta.Version211a, "InputOutput", 0x3f, [], ["read-only"], [u'identMetaSystem'], [u'eventInst', u'faultInst', u'identIdentCtx', u'identIdentRequestFsm', u'identIdentRequestFsmTask'], [None])
