"""This module contains the general information for IdentIdentRequestFsm ManagedObject."""
import sys, os
...
class IdentIdentRequestFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_NOP = "nop"
    CURRENT_FSM_UPDATE_IDENT = "updateIdent"
...
class IdentIdentRequestFsm(ManagedObject):
    """This is IdentIdentRequestFsm class."""

    consts = IdentIdentRequestFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("IdentIdentRequestFsm", "identIdentRequestFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'identIdentRequest'], [u'identIdentRequestFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["nop", "updateIdent"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "IdentIdentRequestFsm", parent_mo_or_dn, **kwargs)
