...
class IdentIdentRequestFsm(ManagedObject):
    ...
    mo_meta = MoMeta("IdentIdentRequestFsm", "identIdentRequestFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xf, [], [""], [u'identIdentRequest'], [u'identIdentRequestFsmStage'], [None])
