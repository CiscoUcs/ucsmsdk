"""This module contains the general information for IdentIdentRequestFsmStage ManagedObject."""
import sys, os
...
class IdentIdentRequestFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_NOP = "nop"
    NAME_UPDATE_IDENT_BEGIN = "updateIdentBegin"
    NAME_UPDATE_IDENT_EXECUTE = "updateIdentExecute"
    NAME_UPDATE_IDENT_FAIL = "updateIdentFail"
    NAME_UPDATE_IDENT_SUCCESS = "updateIdentSuccess"
...
class IdentIdentRequestFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("IdentIdentRequestFsmStage", "identIdentRequestFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'identIdentRequestFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["nop", "updateIdentBegin", "updateIdentExecute", "updateIdentFail", "updateIdentSuccess"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "IdentIdentRequestFsmStage", parent_mo_or_dn, **kwargs)
