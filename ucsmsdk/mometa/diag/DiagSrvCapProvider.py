...
class DiagSrvCapProvider(ManagedObject):
    ...
    mo_meta = MoMeta("DiagSrvCapProvider", "diagSrvCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version111j, "InputOutput", 0x1ff, [], [""], [u'capabilityCatalogue', u'equipmentHwCapDerivativeProvider'], [u'equipmentFruVariant', u'equipmentManufacturingDef', u'equipmentPhysicalDef', u'equipmentPicture', u'equipmentServiceDef', u'equipmentSlotArray', u'equipmentSlotArrayRef', u'equipmentStorageControllerConfig', u'firmwareConstraints', u'firmwareType', u'firmwareUpgradeConstraint'], ["Get"])
    ...
    prop_meta = {
        ...
        "model": MoPropertyMeta("model", "model", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, 0x8, 1, 510, None, [], []), 
        ...
        "revision": MoPropertyMeta("revision", "revision", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, 0x20, 1, 510, None, [], []), 
        ...
        "vendor": MoPropertyMeta("vendor", "vendor", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, 0x100, 1, 510, None, [], []), 
    }
