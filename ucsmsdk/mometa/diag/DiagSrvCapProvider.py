...
class DiagSrvCapProvider(ManagedObject):
    ...
    mo_meta = MoMeta("DiagSrvCapProvider", "diagSrvCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version111j, "InputOutput", 0xffL, [], [""], [u'capabilityCatalogue'], [u'equipmentManufacturingDef', u'equipmentPhysicalDef', u'equipmentPicture', u'equipmentServiceDef', u'equipmentSlotArray', u'equipmentSlotArrayRef', u'equipmentStorageControllerConfig', u'firmwareConstraints', u'firmwareType', u'firmwareUpgradeConstraint'], ["Get"])
    ...
    prop_meta = {
        ...
        "model": MoPropertyMeta("model", "model", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, 0x4L, 1, 510, None, [], []), 
        ...
        "revision": MoPropertyMeta("revision", "revision", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, 0x10L, 1, 510, None, [], []), 
        ...
        "vendor": MoPropertyMeta("vendor", "vendor", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, 0x80L, 1, 510, None, [], []), 
    }
