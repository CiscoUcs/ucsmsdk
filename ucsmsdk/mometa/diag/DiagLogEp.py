...
class DiagLogEp(ManagedObject):
    ...
    mo_meta = MoMeta("DiagLogEp", "diagLogEp", "logep-[switch_id]", None, "InputOutput", 0x3f, [], [""], [u'diagRslt'], [], [None])
    ...
    prop_meta = {
        ...
        "log_dn": MoPropertyMeta("log_dn", "logDn", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        ...
        "switch_id": MoPropertyMeta("switch_id", "switchId", "string", None, MoPropertyMeta.NAMING, 0x20, None, None, None, ["A", "B", "NONE"], []), 
    }
