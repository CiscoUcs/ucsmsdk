...
class DiagRunPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("DiagRunPolicy", "diagRunPolicy", "diag-policy-[name]", VersionMeta.Version131c, "InputOutput", 0x1ffL, [], ["admin", "pn-policy"], [u'diagSrvCtrl', u'orgOrg'], [u'diagBladeTest', u'diagNetworkTest'], ["Get"])
    ...
    prop_meta = {
        ...
        "descr": MoPropertyMeta("descr", "descr", "string", VersionMeta.Version131c, MoPropertyMeta.READ_WRITE, 0x2L, None, None, """[ !#$%&\(\)\*\+,\-\./:;\?@\[\]_\{\|\}~a-zA-Z0-9]{0,256}""", [], []), 
        "dn": MoPropertyMeta("dn", "dn", "string", VersionMeta.Version131c, MoPropertyMeta.READ_ONLY, 0x4L, 0, 256, None, [], []), 
        "failure_action": MoPropertyMeta("failure_action", "failureAction", "string", VersionMeta.Version131c, MoPropertyMeta.READ_WRITE, 0x8L, None, None, """((defaultValue|nothing|tech-support|wait-debug|skip-remaining),){0,4}(defaultValue|nothing|tech-support|wait-debug|skip-remaining){0,1}""", [], []), 
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version131c, MoPropertyMeta.NAMING, 0x10L, None, None, """[\-\.:_a-zA-Z0-9]{1,16}""", [], []), 
        ...
        "success_action": MoPropertyMeta("success_action", "successAction", "string", VersionMeta.Version131c, MoPropertyMeta.READ_WRITE, 0x100L, None, None, """((defaultValue|nothing|tech-support|wait-debug),){0,3}(defaultValue|nothing|tech-support|wait-debug){0,1}""", [], []), 
    }
