...
class DiagBladeTest(ManagedObject):
    ...
    mo_meta = MoMeta("DiagBladeTest", "diagBladeTest", "blade-test-[order]", VersionMeta.Version131c, "InputOutput", 0x7fL, [], ["admin", "pn-policy"], [u'diagRunPolicy'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version131c, MoPropertyMeta.READ_WRITE, 0x40L, None, None, None, ["disk", "memory", "memtest", "pci", "processor", "stress"], []), 
    }
