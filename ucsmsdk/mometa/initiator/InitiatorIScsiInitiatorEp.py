...
class InitiatorIScsiInitiatorEp(ManagedObject):
    ...
    mo_meta = MoMeta("InitiatorIScsiInitiatorEp", "initiatorIScsiInitiatorEp", "scsi-ini-[iqn]", VersionMeta.Version211a, "InputOutput", 0x3fL, [], ["read-only"], [u'initiatorGroupEp'], [u'storageEpUser'], [None])
    ...
    prop_meta = {
        ...
        "iqn": MoPropertyMeta("iqn", "iqn", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, 0x4L, None, None, """[0-9a-zA-Z\.:-]*$""", [], []), 
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.READ_WRITE, 0x8L, None, None, """[\-\.:_a-zA-Z0-9]{1,16}""", [], []), 
