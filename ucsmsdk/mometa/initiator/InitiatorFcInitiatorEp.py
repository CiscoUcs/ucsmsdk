...
class InitiatorFcInitiatorEp(ManagedObject):
    ...
    mo_meta = MoMeta("InitiatorFcInitiatorEp", "initiatorFcInitiatorEp", "fc-ini-[wwpn]", VersionMeta.Version211a, "InputOutput", 0x3fL, [], ["read-only"], [u'initiatorGroupEp'], [u'storageEpUser'], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.READ_WRITE, 0x4L, None, None, """[\-\.:_a-zA-Z0-9]{1,16}""", [], []), 
