...
class OrgSourceMask(ManagedObject):
    ...
    mo_meta = MoMeta("OrgSourceMask", "orgSourceMask", "src-mask", VersionMeta.Version212a, "InputOutput", 0xfL, [], ["read-only"], [u'orgOrg'], [], [None])
    ...
    prop_meta = {
        ...
        "mask": MoPropertyMeta("mask", "mask", "string", VersionMeta.Version212a, MoPropertyMeta.READ_ONLY, None, None, None, """((defaultValue|local|global),){0,2}(defaultValue|local|global){0,1}""", [], []), 
