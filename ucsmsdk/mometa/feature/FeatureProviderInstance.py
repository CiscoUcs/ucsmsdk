...
class FeatureProviderInstance(ManagedObject):
    ...
    mo_meta = MoMeta("FeatureProviderInstance", "featureProviderInstance", "inst-[name]", VersionMeta.Version302a, "InputOutput", 0x3f, [], [""], [u'featureContextEp'], [], [None])
    ...
    prop_meta = {
        ...
        "oper_provider_dn": MoPropertyMeta("oper_provider_dn", "operProviderDn", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
