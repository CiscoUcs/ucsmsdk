...
class FeatureFruCapProviderRef(ManagedObject):
    ...
    mo_meta = MoMeta("FeatureFruCapProviderRef", "featureFruCapProviderRef", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version302a, "InputOutput", 0xff, [], [""], [u'featureProvider'], [], [None])
