...
class FeatureFruCapProviderRef(ManagedObject):
    ...
    mo_meta = MoMeta("FeatureFruCapProviderRef", "featureFruCapProviderRef", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version302c, "InputOutput", 0xffL, [], [""], [u'featureProvider'], [], [None])
