...
class FeatureDefinitionInstance(ManagedObject):
    ...
    mo_meta = MoMeta("FeatureDefinitionInstance", "featureDefinitionInstance", "feature-[name]-revision-[revision]", VersionMeta.Version302a, "InputOutput", 0x3fL, [], [""], [u'featureContextEp'], [], [None])
