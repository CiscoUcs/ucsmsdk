...
class FeatureDefinitionInstance(ManagedObject):
    ...
    mo_meta = MoMeta("FeatureDefinitionInstance", "featureDefinitionInstance", "feature-[name]-revision-[revision]", VersionMeta.Version302c, "InputOutput", 0x7fL, [], [""], [u'featureContextEp'], [], [None])
