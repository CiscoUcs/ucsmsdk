...
class FeatureDefinition(ManagedObject):
    ...
    mo_meta = MoMeta("FeatureDefinition", "featureDefinition", "feature-[name]-revision-[revision]", VersionMeta.Version302a, "InputOutput", 0x3fL, [], [""], [u'capabilityCatalogue'], [], [None])
