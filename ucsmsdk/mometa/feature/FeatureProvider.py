...
class FeatureProvider(ManagedObject):
    ...
    mo_meta = MoMeta("FeatureProvider", "featureProvider", "prov-[name]", VersionMeta.Version302a, "InputOutput", 0x3f, [], [""], [u'capabilityCatalogue'], [u'featureDefinitionRef', u'featureFruCapProviderRef'], [None])
