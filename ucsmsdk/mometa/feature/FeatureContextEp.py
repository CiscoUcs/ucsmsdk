...
class FeatureContextEp(ManagedObject):
    ...
    mo_meta = MoMeta("FeatureContextEp", "featureContextEp", "contexts", VersionMeta.Version302a, "InputOutput", 0xfL, [], [""], [u'topSystem'], [u'featureDefinitionInstance', u'featureFruCapProviderInstance', u'featureProviderInstance'], [None])
