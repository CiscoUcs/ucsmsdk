...
class FeatureDefinitionRef(ManagedObject):
    ...
    mo_meta = MoMeta("FeatureDefinitionRef", "featureDefinitionRef", "feature-[name]-revision-[revision]", VersionMeta.Version302a, "InputOutput", 0x7f, [], [""], [u'featureProvider'], [], [None])
