...
class FeatureFruCapProviderInstance(ManagedObject):
    ...
    mo_meta = MoMeta("FeatureFruCapProviderInstance", "featureFruCapProviderInstance", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version302a, "InputOutput", 0xff, [], [""], [u'featureContextEp'], [], [None])
    ...
    prop_meta = {
        ...
        "revision": MoPropertyMeta("revision", "revision", "string", VersionMeta.Version302a, MoPropertyMeta.NAMING, 0x10, 1, 510, None, [], []), 
        ...
        "vendor": MoPropertyMeta("vendor", "vendor", "string", VersionMeta.Version302a, MoPropertyMeta.NAMING, 0x80, 1, 510, None, [], []), 
    }
