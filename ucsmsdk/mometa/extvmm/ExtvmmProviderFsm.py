"""This module contains the general information for ExtvmmProviderFsm ManagedObject."""
import sys, os
...
class ExtvmmProviderFsm(ManagedObject):
    """This is ExtvmmProviderFsm class."""

    consts = ExtvmmProviderFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("ExtvmmProviderFsm", "extvmmProviderFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'extvmmProvider'], [u'extvmmProviderFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "ExtvmmProviderFsm", parent_mo_or_dn, **kwargs)
