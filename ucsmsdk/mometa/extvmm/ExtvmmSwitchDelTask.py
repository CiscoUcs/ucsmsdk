...
class ExtvmmSwitchDelTaskConsts():
    ...
    FSM_PREV_REMOVE_PROVIDER_REMOVE_LOCAL = "removeProviderRemoveLocal"
    FSM_PREV_REMOVE_PROVIDER_SUCCESS = "removeProviderSuccess"
    ...
    FSM_STATUS_NOP = "nop"
    FSM_STATUS_REMOVE_PROVIDER_BEGIN = "removeProviderBegin"
    FSM_STATUS_REMOVE_PROVIDER_FAIL = "removeProviderFail"
    FSM_STATUS_REMOVE_PROVIDER_REMOVE_LOCAL = "removeProviderRemoveLocal"
    FSM_STATUS_REMOVE_PROVIDER_SUCCESS = "removeProviderSuccess"
    INT_ID_NONE = "none"
    POLICY_OWNER_LOCAL = "local"
    POLICY_OWNER_PENDING_POLICY = "pending-policy"
    POLICY_OWNER_POLICY = "policy"
    PORT_VALUE_DEFAULT = "default"
    PROV_INT_ID_NONE = "none"
    SW_INT_ID_NONE = "none"
...
class ExtvmmSwitchDelTask(ManagedObject):
    ...
    mo_meta = MoMeta("ExtvmmSwitchDelTask", "extvmmSwitchDelTask", "vsw-deltask-[sw_int_id]", VersionMeta.Version111j, "InputOutput", 0x7fffL, [], ["admin", "ls-config", "ls-config-policy", "ls-network", "pn-policy"], [u'extvmmEp'], [u'eventInst', u'extvmmSwitchDelTaskFsm', u'extvmmSwitchDelTaskFsmTask', u'faultInst'], ["Get", "Remove"])

    prop_meta = {
        "cert_file": MoPropertyMeta("cert_file", "certFile", "string", VersionMeta.Version111j, MoPropertyMeta.READ_WRITE, 0x1L, 0, 510, None, [], []), 
        ...
        "dc_name": MoPropertyMeta("dc_name", "dcName", "string", VersionMeta.Version111j, MoPropertyMeta.READ_WRITE, 0x4L, None, None, """[ !#$%&\(\)\*\+,\-\.:;=\?@\[\]_\{\|\}~a-zA-Z0-9]{0,16}""", [], []), 
        "dc_org": MoPropertyMeta("dc_org", "dcOrg", "string", VersionMeta.Version111j, MoPropertyMeta.READ_WRITE, 0x8L, None, None, """[ !#$%&\(\)\*\+,\-\.:;=\?@\[\]_\{\|\}~a-zA-Z0-9]{0,16}""", [], []), 
        "descr": MoPropertyMeta("descr", "descr", "string", VersionMeta.Version111j, MoPropertyMeta.READ_WRITE, 0x10L, None, None, """[ !#$%&\(\)\*\+,\-\./:;\?@\[\]_\{\|\}~a-zA-Z0-9]{0,256}""", [], []), 
        "dn": MoPropertyMeta("dn", "dn", "string", VersionMeta.Version111j, MoPropertyMeta.READ_ONLY, 0x20L, 0, 256, None, [], []), 
        ...
        "host": MoPropertyMeta("host", "host", "string", VersionMeta.Version111j, MoPropertyMeta.READ_WRITE, 0x40L, None, None, None, [], []), 
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version111j, MoPropertyMeta.READ_WRITE, 0x80L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        "org_path": MoPropertyMeta("org_path", "orgPath", "string", VersionMeta.Version111j, MoPropertyMeta.READ_WRITE, 0x100L, None, None, """[ !#$%&\(\)\*\+,\-\.:;=\?@\[\]_\{\|\}~a-zA-Z0-9]{0,16}""", [], []), 
        ...
        "port_value": MoPropertyMeta("port_value", "portValue", "string", VersionMeta.Version221b, MoPropertyMeta.READ_WRITE, 0x400L, None, None, None, ["default"], ["1-65355"]), 
        "prov_int_id": MoPropertyMeta("prov_int_id", "provIntId", "string", VersionMeta.Version111j, MoPropertyMeta.CREATE_ONLY, 0x800L, None, None, None, ["none"], ["0-4294967295"]), 
        "provider": MoPropertyMeta("provider", "provider", "string", VersionMeta.Version111j, MoPropertyMeta.READ_ONLY, None, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        "rn": MoPropertyMeta("rn", "rn", "string", VersionMeta.Version111j, MoPropertyMeta.READ_ONLY, 0x1000L, 0, 256, None, [], []), 
        "sacl": MoPropertyMeta("sacl", "sacl", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, """((none|del|mod|addchild|cascade),){0,4}(none|del|mod|addchild|cascade){0,1}""", [], []), 
        "status": MoPropertyMeta("status", "status", "string", VersionMeta.Version111j, MoPropertyMeta.READ_WRITE, 0x2000L, None, None, """((removed|created|modified|deleted),){0,3}(removed|created|modified|deleted){0,1}""", [], []), 
        "sw_int_id": MoPropertyMeta("sw_int_id", "swIntId", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, 0x4000L, None, None, None, ["none"], ["0-4294967295"]), 
        "sw_name": MoPropertyMeta("sw_name", "swName", "string", VersionMeta.Version111j, MoPropertyMeta.READ_ONLY, None, None, None, """[ !#$%&\(\)\*\+,\-\.:;=\?@\[\]_\{\|\}~a-zA-Z0-9]{0,16}""", [], []), 
    }
    ...
    def __init__(self, parent_mo_or_dn, sw_int_id, **kwargs):
        self._dirty_mask = 0
        self.sw_int_id = sw_int_id
        self.cert_file = None
