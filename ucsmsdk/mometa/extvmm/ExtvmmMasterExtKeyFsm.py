...
class ExtvmmMasterExtKeyFsm(ManagedObject):
    ...
    mo_meta = MoMeta("ExtvmmMasterExtKeyFsm", "extvmmMasterExtKeyFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xf, [], [""], [u'extvmmMasterExtKey'], [u'extvmmMasterExtKeyFsmStage'], [None])
