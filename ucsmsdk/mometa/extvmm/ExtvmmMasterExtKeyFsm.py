"""This module contains the general information for ExtvmmMasterExtKeyFsm ManagedObject."""
import sys, os
...
class ExtvmmMasterExtKeyFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_CONFIG = "config"
    CURRENT_FSM_NOP = "nop"
...
class ExtvmmMasterExtKeyFsm(ManagedObject):
    """This is ExtvmmMasterExtKeyFsm class."""

    consts = ExtvmmMasterExtKeyFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("ExtvmmMasterExtKeyFsm", "extvmmMasterExtKeyFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'extvmmMasterExtKey'], [u'extvmmMasterExtKeyFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["config", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "ExtvmmMasterExtKeyFsm", parent_mo_or_dn, **kwargs)
