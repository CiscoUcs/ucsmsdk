...
class ExtvmmMasterExtKeyFsm(ManagedObject):
    ...
    mo_meta = MoMeta("ExtvmmMasterExtKeyFsm", "extvmmMasterExtKeyFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'extvmmMasterExtKey'], [u'extvmmMasterExtKeyFsmStage'], [None])
