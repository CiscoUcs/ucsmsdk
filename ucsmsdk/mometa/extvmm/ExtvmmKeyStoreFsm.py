"""This module contains the general information for ExtvmmKeyStoreFsm ManagedObject."""
import sys, os
...
class ExtvmmKeyStoreFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_CERT_INSTALL = "certInstall"
    CURRENT_FSM_NOP = "nop"
...
class ExtvmmKeyStoreFsm(ManagedObject):
    """This is ExtvmmKeyStoreFsm class."""

    consts = ExtvmmKeyStoreFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("ExtvmmKeyStoreFsm", "extvmmKeyStoreFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'extvmmKeyStore'], [u'extvmmKeyStoreFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["certInstall", "nop"], []), 
