...
class ExtvmmEpConsts():
    ...
    FSM_PREV_CLUSTER_ROLE_SET_PEER = "clusterRoleSetPeer"
    FSM_PREV_CLUSTER_ROLE_SUCCESS = "clusterRoleSuccess"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_CLUSTER_ROLE_BEGIN = "clusterRoleBegin"
    FSM_STATUS_CLUSTER_ROLE_FAIL = "clusterRoleFail"
    FSM_STATUS_CLUSTER_ROLE_SET_LOCAL = "clusterRoleSetLocal"
    FSM_STATUS_CLUSTER_ROLE_SET_PEER = "clusterRoleSetPeer"
    FSM_STATUS_CLUSTER_ROLE_SUCCESS = "clusterRoleSuccess"
    FSM_STATUS_NOP = "nop"


class ExtvmmEp(ManagedObject):
    """This is ExtvmmEp class."""

    consts = ExtvmmEpConsts()
    naming_props = set([])

    mo_meta = MoMeta("ExtvmmEp", "extvmmEp", "extvm-mgmt", VersionMeta.Version101e, "InputOutput", 0x1fL, [], ["admin", "ls-config", "ls-config-policy", "pn-policy"], [u'topSystem'], [u'eventInst', u'extvmmEpFsm', u'extvmmEpFsmTask', u'extvmmKeyStore', u'extvmmMasterExtKey', u'extvmmProvider', u'extvmmSwitchDelTask', u'extvmmSwitchSet', u'faultInst'], ["Get"])
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version101e, MoPropertyMeta.INTERNAL, None, None, None, None, ["clusterRoleBegin", "clusterRoleFail", "clusterRoleSetLocal", "clusterRoleSetPeer", "clusterRoleSuccess", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version101e, MoPropertyMeta.INTERNAL, None, None, None, None, ["clusterRoleBegin", "clusterRoleFail", "clusterRoleSetLocal", "clusterRoleSetPeer", "clusterRoleSuccess", "nop"], []), 
