...
class ExtvmmEp(ManagedObject):
    ...
    mo_meta = MoMeta("ExtvmmEp", "extvmmEp", "extvm-mgmt", VersionMeta.Version101e, "InputOutput", 0xfL, [], ["admin", "ls-config", "ls-config-policy", "pn-policy"], [u'topSystem'], [u'eventInst', u'extvmmEpFsm', u'extvmmEpFsmTask', u'extvmmKeyStore', u'extvmmMasterExtKey', u'extvmmProvider', u'extvmmSwitchDelTask', u'extvmmSwitchSet', u'faultInst'], ["Get"])
