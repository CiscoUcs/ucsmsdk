...
class ExtvmmKeyInst(ManagedObject):
    ...
    mo_meta = MoMeta("ExtvmmKeyInst", "extvmmKeyInst", "key-[inst]", VersionMeta.Version111j, "InputOutput", 0x3fL, [], ["read-only"], [u'extvmmProvider'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "inst": MoPropertyMeta("inst", "inst", "ushort", VersionMeta.Version111j, MoPropertyMeta.NAMING, 0x8L, None, None, None, [], []), 
