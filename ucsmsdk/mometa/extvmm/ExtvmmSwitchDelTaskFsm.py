...
class ExtvmmSwitchDelTaskFsm(ManagedObject):
    ...
    mo_meta = MoMeta("ExtvmmSwitchDelTaskFsm", "extvmmSwitchDelTaskFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xf, [], [""], ['extvmmSwitchDelTask'], ['extvmmSwitchDelTaskFsmStage'], [None])
