"""This module contains the general information for ExtvmmSwitchDelTaskFsm ManagedObject."""
import sys, os
...
class ExtvmmSwitchDelTaskFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_NOP = "nop"
    CURRENT_FSM_REMOVE_PROVIDER = "removeProvider"
...
class ExtvmmSwitchDelTaskFsm(ManagedObject):
    """This is ExtvmmSwitchDelTaskFsm class."""

    consts = ExtvmmSwitchDelTaskFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("ExtvmmSwitchDelTaskFsm", "extvmmSwitchDelTaskFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'extvmmSwitchDelTask'], [u'extvmmSwitchDelTaskFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["nop", "removeProvider"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "ExtvmmSwitchDelTaskFsm", parent_mo_or_dn, **kwargs)
