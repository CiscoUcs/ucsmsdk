"""This module contains the general information for ExtvmmSwitchDelTaskFsmTask ManagedObject."""
import sys, os
...
class ExtvmmSwitchDelTaskFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("ExtvmmSwitchDelTaskFsmTask", "extvmmSwitchDelTaskFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], [""], [u'extvmmSwitchDelTask'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, None, None, None, None, ["nop", "removeProvider"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "ExtvmmSwitchDelTaskFsmTask", parent_mo_or_dn, **kwargs)
