...
class ExtvmmNetworkSetsFsm(ManagedObject):
    ...
    mo_meta = MoMeta("ExtvmmNetworkSetsFsm", "extvmmNetworkSetsFsm", "fsm", VersionMeta.Version221b, "OutputOnly", 0xfL, [], [""], [u'extvmmNetworkSets'], [u'extvmmNetworkSetsFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "completion_time": MoPropertyMeta("completion_time", "completionTime", "string", VersionMeta.Version221b, MoPropertyMeta.READ_ONLY, None, None, None, r"""([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", [""], []), 
        ...
        "status": MoPropertyMeta("status", "status", "string", VersionMeta.Version221b, MoPropertyMeta.READ_WRITE, 0x8L, None, None, r"""((removed|created|modified|deleted),){0,3}(removed|created|modified|deleted){0,1}""", [], []), 
    }
