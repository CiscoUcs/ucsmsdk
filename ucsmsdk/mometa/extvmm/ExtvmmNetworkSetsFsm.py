...
class ExtvmmNetworkSetsFsm(ManagedObject):
    ...
    mo_meta = MoMeta("ExtvmmNetworkSetsFsm", "extvmmNetworkSetsFsm", "fsm", VersionMeta.Version221b, "OutputOnly", 0xf, [], [""], [u'extvmmNetworkSets'], [u'extvmmNetworkSetsFsmStage'], [None])
