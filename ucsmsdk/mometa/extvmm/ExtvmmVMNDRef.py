...
class ExtvmmVMNDRef(ManagedObject):
    ...
    mo_meta = MoMeta("ExtvmmVMNDRef", "extvmmVMNDRef", "vm-network-def-ref[name]", VersionMeta.Version221b, "InputOutput", 0x3ffL, [], ["admin", "ls-network", "ls-network-policy"], [u'extvmmVMNetwork'], [u'faultInst'], ["Add", "Get", "Remove"])
    ...
    prop_meta = {
        ...
        "fn_name": MoPropertyMeta("fn_name", "fnName", "string", VersionMeta.Version221b, MoPropertyMeta.READ_WRITE, 0x10L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        ...
        "vm_network_def_name": MoPropertyMeta("vm_network_def_name", "vmNetworkDefName", "string", VersionMeta.Version221b, MoPropertyMeta.READ_WRITE, 0x200L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
    }
