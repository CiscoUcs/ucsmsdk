...
class ExtvmmKeyRing(ManagedObject):
    ...
    mo_meta = MoMeta("ExtvmmKeyRing", "extvmmKeyRing", "keyring-[name]", VersionMeta.Version111j, "InputOutput", 0x1ffL, [], ["admin", "ls-config", "ls-config-policy", "pn-policy"], [u'extvmmKeyStore'], [], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "location": MoPropertyMeta("location", "location", "string", VersionMeta.Version111j, MoPropertyMeta.READ_WRITE, 0x10L, None, None, None, ["ftp", "none", "scp", "sftp", "tftp", "usbA", "usbB", "usbdrive", "volatile", "workspace"], []), 
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, 0x20L, 1, 510, None, [], []), 
        "path": MoPropertyMeta("path", "path", "string", VersionMeta.Version111j, MoPropertyMeta.READ_WRITE, 0x40L, 0, 510, None, [], []), 
