"""This module contains the general information for ExtvmmMasterExtKeyFsmStage ManagedObject."""
import sys, os
...
class ExtvmmMasterExtKeyFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_CONFIG_BEGIN = "configBegin"
    NAME_CONFIG_FAIL = "configFail"
    NAME_CONFIG_SET_LOCAL = "configSetLocal"
    NAME_CONFIG_SET_PEER = "configSetPeer"
...
class ExtvmmMasterExtKeyFsmStage(ManagedObject):
    """This is ExtvmmMasterExtKeyFsmStage class."""

    consts = ExtvmmMasterExtKeyFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("ExtvmmMasterExtKeyFsmStage", "extvmmMasterExtKeyFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'extvmmMasterExtKeyFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["configBegin", "configFail", "configSetLocal", "configSetPeer", "configSuccess", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "ExtvmmMasterExtKeyFsmStage", parent_mo_or_dn, **kwargs)
