...
class ExtvmmEpFsm(ManagedObject):
    """This is ExtvmmEpFsm class."""

    consts = ExtvmmEpFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("ExtvmmEpFsm", "extvmmEpFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'extvmmEp'], [u'extvmmEpFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["clusterRole", "nop"], []), 
