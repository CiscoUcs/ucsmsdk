...
class ExtvmmVMNetworkSets(ManagedObject):
    ...
    mo_meta = MoMeta("ExtvmmVMNetworkSets", "extvmmVMNetworkSets", "vm-network-sets", VersionMeta.Version221b, "InputOutput", 0x1f, [], ["admin", "ls-network", "ls-network-policy"], ['fabricLanCloud'], ['extvmmVMNetwork'], ["Get"])
