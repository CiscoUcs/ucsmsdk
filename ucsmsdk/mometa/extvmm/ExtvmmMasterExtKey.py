...
class ExtvmmMasterExtKey(ManagedObject):
    """This is ExtvmmMasterExtKey class."""

    consts = ExtvmmMasterExtKeyConsts()
    naming_props = set([])

    mo_meta = MoMeta("ExtvmmMasterExtKey", "extvmmMasterExtKey", "ext-key", VersionMeta.Version111j, "InputOutput", 0x3fL, [], ["admin", "ls-config", "ls-config-policy", "pn-policy"], [u'extvmmEp'], [u'eventInst', u'extvmmMasterExtKeyFsm', u'extvmmMasterExtKeyFsmTask', u'faultInst'], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version111j, MoPropertyMeta.INTERNAL, None, None, None, None, ["configBegin", "configFail", "configSetLocal", "configSetPeer", "configSuccess", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version111j, MoPropertyMeta.INTERNAL, None, None, None, None, ["configBegin", "configFail", "configSetLocal", "configSetPeer", "configSuccess", "nop"], []), 
        "fsm_try": MoPropertyMeta("fsm_try", "fsmTry", "byte", VersionMeta.Version111j, MoPropertyMeta.INTERNAL, None, None, None, None, [], []), 
        "key": MoPropertyMeta("key", "key", "string", VersionMeta.Version111j, MoPropertyMeta.READ_WRITE, 0x8L, 1, 33, None, [], []), 
        ...
        "status": MoPropertyMeta("status", "status", "string", VersionMeta.Version111j, MoPropertyMeta.READ_WRITE, 0x20L, None, None, r"""((removed|created|modified|deleted),){0,3}(removed|created|modified|deleted){0,1}""", [], []), 
    }
