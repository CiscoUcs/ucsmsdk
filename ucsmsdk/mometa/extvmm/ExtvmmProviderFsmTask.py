"""This module contains the general information for ExtvmmProviderFsmTask ManagedObject."""
import sys, os
...
class ExtvmmProviderFsmTaskConsts():
...
class ExtvmmProviderFsmTask(ManagedObject):
    """This is ExtvmmProviderFsmTask class."""

    consts = ExtvmmProviderFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("ExtvmmProviderFsmTask", "extvmmProviderFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], [""], [u'extvmmProvider'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "ExtvmmProviderFsmTask", parent_mo_or_dn, **kwargs)
