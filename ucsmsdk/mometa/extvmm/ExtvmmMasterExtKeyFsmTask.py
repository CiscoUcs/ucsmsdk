"""This module contains the general information for ExtvmmMasterExtKeyFsmTask ManagedObject."""
import sys, os
...
class ExtvmmMasterExtKeyFsmTaskConsts():
...
class ExtvmmMasterExtKeyFsmTask(ManagedObject):
    """This is ExtvmmMasterExtKeyFsmTask class."""

    consts = ExtvmmMasterExtKeyFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("ExtvmmMasterExtKeyFsmTask", "extvmmMasterExtKeyFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], [""], [u'extvmmMasterExtKey'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, None, None, None, None, ["config", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "ExtvmmMasterExtKeyFsmTask", parent_mo_or_dn, **kwargs)
