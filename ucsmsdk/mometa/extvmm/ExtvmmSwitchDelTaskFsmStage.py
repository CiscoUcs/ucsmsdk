...
class ExtvmmSwitchDelTaskFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("ExtvmmSwitchDelTaskFsmStage", "extvmmSwitchDelTaskFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'extvmmSwitchDelTaskFsm'], [], [None])
