"""This module contains the general information for ExtvmmSwitchDelTaskFsmStage ManagedObject."""
import sys, os
...
class ExtvmmSwitchDelTaskFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_NOP = "nop"
    NAME_REMOVE_PROVIDER_BEGIN = "removeProviderBegin"
    NAME_REMOVE_PROVIDER_FAIL = "removeProviderFail"
    NAME_REMOVE_PROVIDER_REMOVE_LOCAL = "removeProviderRemoveLocal"
    NAME_REMOVE_PROVIDER_SUCCESS = "removeProviderSuccess"
...
class ExtvmmSwitchDelTaskFsmStage(ManagedObject):
    """This is ExtvmmSwitchDelTaskFsmStage class."""

    consts = ExtvmmSwitchDelTaskFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("ExtvmmSwitchDelTaskFsmStage", "extvmmSwitchDelTaskFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'extvmmSwitchDelTaskFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["nop", "removeProviderBegin", "removeProviderFail", "removeProviderRemoveLocal", "removeProviderSuccess"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "ExtvmmSwitchDelTaskFsmStage", parent_mo_or_dn, **kwargs)
