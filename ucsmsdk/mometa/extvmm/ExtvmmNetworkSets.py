...
class ExtvmmNetworkSetsConsts():
    ...
    FSM_PREV_DEPLOY_PEER = "DeployPeer"
    ...
    FSM_STATUS_DEPLOY_LOCAL = "DeployLocal"
    FSM_STATUS_DEPLOY_PEER = "DeployPeer"
...
class ExtvmmNetworkSets(ManagedObject):
    ...
    mo_meta = MoMeta("ExtvmmNetworkSets", "extvmmNetworkSets", "network-sets", VersionMeta.Version221b, "InputOutput", 0xfL, [], ["admin", "ls-network", "ls-network-policy"], [u'fabricLanCloud'], [u'eventInst', u'extvmmFabricNetwork', u'extvmmNetworkSetsFsm', u'extvmmNetworkSetsFsmTask', u'faultInst', u'ippoolPool'], ["Get"])
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version221b, MoPropertyMeta.INTERNAL, None, None, None, None, ["DeployBegin", "DeployFail", "DeployLocal", "DeployPeer", "DeploySuccess", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version221b, MoPropertyMeta.INTERNAL, None, None, None, None, ["DeployBegin", "DeployFail", "DeployLocal", "DeployPeer", "DeploySuccess", "nop"], []), 
