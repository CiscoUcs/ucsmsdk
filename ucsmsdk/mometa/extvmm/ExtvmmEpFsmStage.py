"""This module contains the general information for ExtvmmEpFsmStage ManagedObject."""
import sys, os
...
class ExtvmmEpFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_CLUSTER_ROLE_BEGIN = "clusterRoleBegin"
    NAME_CLUSTER_ROLE_FAIL = "clusterRoleFail"
    NAME_CLUSTER_ROLE_SET_LOCAL = "clusterRoleSetLocal"
    NAME_CLUSTER_ROLE_SET_PEER = "clusterRoleSetPeer"
    NAME_CLUSTER_ROLE_SUCCESS = "clusterRoleSuccess"
    NAME_NOP = "nop"
...
class ExtvmmEpFsmStage(ManagedObject):
    """This is ExtvmmEpFsmStage class."""

    consts = ExtvmmEpFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("ExtvmmEpFsmStage", "extvmmEpFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'extvmmEpFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["clusterRoleBegin", "clusterRoleFail", "clusterRoleSetLocal", "clusterRoleSetPeer", "clusterRoleSuccess", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "ExtvmmEpFsmStage", parent_mo_or_dn, **kwargs)
