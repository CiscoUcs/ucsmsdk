"""This module contains the general information for ExtvmmProviderFsmStage ManagedObject."""
import sys, os
...
class ExtvmmProviderFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_CONFIG_BEGIN = "configBegin"
    NAME_CONFIG_FAIL = "configFail"
    NAME_CONFIG_GET_VERSION = "configGetVersion"
...
class ExtvmmProviderFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("ExtvmmProviderFsmStage", "extvmmProviderFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'extvmmProviderFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["configBegin", "configFail", "configGetVersion", "configSetLocal", "configSetPeer", "configSuccess", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "ExtvmmProviderFsmStage", parent_mo_or_dn, **kwargs)
