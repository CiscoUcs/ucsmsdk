...
class ExtvmmKeyStoreConsts():
    ...
    FSM_PREV_CERT_INSTALL_SET_PEER = "certInstallSetPeer"
    FSM_PREV_CERT_INSTALL_SUCCESS = "certInstallSuccess"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_CERT_INSTALL_BEGIN = "certInstallBegin"
    FSM_STATUS_CERT_INSTALL_FAIL = "certInstallFail"
    FSM_STATUS_CERT_INSTALL_SET_LOCAL = "certInstallSetLocal"
    FSM_STATUS_CERT_INSTALL_SET_PEER = "certInstallSetPeer"
    FSM_STATUS_CERT_INSTALL_SUCCESS = "certInstallSuccess"
    FSM_STATUS_NOP = "nop"


class ExtvmmKeyStore(ManagedObject):
    """This is ExtvmmKeyStore class."""

    consts = ExtvmmKeyStoreConsts()
    naming_props = set([])

    mo_meta = MoMeta("ExtvmmKeyStore", "extvmmKeyStore", "key-store", VersionMeta.Version111j, "InputOutput", 0xfL, [], ["admin", "ls-config", "ls-config-policy", "pn-policy"], [u'extvmmEp'], [u'eventInst', u'extvmmKeyRing', u'extvmmKeyStoreFsm', u'extvmmKeyStoreFsmTask', u'faultInst'], ["Get"])
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version111j, MoPropertyMeta.INTERNAL, None, None, None, None, ["certInstallBegin", "certInstallFail", "certInstallSetLocal", "certInstallSetPeer", "certInstallSuccess", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version111j, MoPropertyMeta.INTERNAL, None, None, None, None, ["certInstallBegin", "certInstallFail", "certInstallSetLocal", "certInstallSetPeer", "certInstallSuccess", "nop"], []), 
