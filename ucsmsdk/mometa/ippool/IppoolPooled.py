...
class IppoolPooled(ManagedObject):
    ...
    mo_meta = MoMeta("IppoolPooled", "ippoolPooled", "[id]", VersionMeta.Version101e, "InputOutput", 0x1fL, [], ["read-only"], [u'ippoolPool'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "id": MoPropertyMeta("id", "id", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x4L, 0, 256, """((([0-9]){1,3}\.){3}[0-9]{1,3})""", [], []), 
