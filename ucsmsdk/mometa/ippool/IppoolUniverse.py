"""This module contains the general information for IppoolUniverse ManagedObject."""
import sys, os
...
class IppoolUniverseConsts():
    pass


class IppoolUniverse(ManagedObject):
    """This is IppoolUniverse class."""

    consts = IppoolUniverseConsts()
    naming_props = set([])

    mo_meta = MoMeta("IppoolUniverse", "ippoolUniverse", "ip", VersionMeta.Version101e, "InputOutput", 0x1fL, [], ["read-only"], [u'topRoot'], [u'ippoolAddr', u'ippoolIpV6Addr'], ["Get"])
    ...
    def __init__(self, **kwargs):
        ...
        ManagedObject.__init__(self, "IppoolUniverse", **kwargs)
