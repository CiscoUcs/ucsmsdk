"""This module contains the general information for IppoolPoolable ManagedObject."""
import sys, os
...
class IppoolPoolableConsts():
    pass


class IppoolPoolable(ManagedObject):
    """This is IppoolPoolable class."""

    consts = IppoolPoolableConsts()
    naming_props = set([u'id'])

    mo_meta = MoMeta("IppoolPoolable", "ippoolPoolable", "pool-[id]", VersionMeta.Version101e, "InputOutput", 0x3fL, [], ["read-only"], [u'ippoolAddr', u'ippoolIpV6Addr'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "id": MoPropertyMeta("id", "id", "ulong", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x8L, None, None, None, [], []), 
    ...
    def __init__(self, parent_mo_or_dn, id, **kwargs):
        ...
        ManagedObject.__init__(self, "IppoolPoolable", parent_mo_or_dn, **kwargs)
