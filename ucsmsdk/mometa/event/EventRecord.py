...
class EventRecord(ManagedObject):
    ...
    prop_meta = {
        ...
        "ind": MoPropertyMeta("ind", "ind", "string", VersionMeta.Version101e, MoPropertyMeta.CREATE_ONLY, 0x80L, None, None, None, ["creation", "deletion", "failure", "modification", "special", "state-transition"], []), 
        ...
        "tx_id": MoPropertyMeta("tx_id", "txId", "ulong", VersionMeta.Version101e, MoPropertyMeta.CREATE_ONLY, 0x400L, None, None, None, [], []), 
        "user": MoPropertyMeta("user", "user", "string", VersionMeta.Version101e, MoPropertyMeta.CREATE_ONLY, 0x800L, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
    }
