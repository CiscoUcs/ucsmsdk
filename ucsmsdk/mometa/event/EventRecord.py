...
class EventRecord(ManagedObject):
    ...
    prop_meta = {
        ...
        "ind": MoPropertyMeta("ind", "ind", "string", VersionMeta.Version101e, MoPropertyMeta.CREATE_ONLY, 0x40L, None, None, None, ["creation", "deletion", "failure", "modification", "special", "state-transition"], []), 
        ...
        "tx_id": MoPropertyMeta("tx_id", "txId", "ulong", VersionMeta.Version101e, MoPropertyMeta.CREATE_ONLY, 0x200L, None, None, None, [], []), 
        "user": MoPropertyMeta("user", "user", "string", VersionMeta.Version101e, MoPropertyMeta.CREATE_ONLY, 0x400L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
    }
