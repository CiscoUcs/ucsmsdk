...
class EventEpCtrl(ManagedObject):
    ...
    mo_meta = MoMeta("EventEpCtrl", "eventEpCtrl", "evctrl", VersionMeta.Version101e, "InputOutput", 0x7fL, [], ["admin", "fault", "operations"], [], [], ["Get"])
    ...
    prop_meta = {
        ...
        "level": MoPropertyMeta("level", "level", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x8L, None, None, None, ["cleared", "condition", "critical", "info", "major", "minor", "warning"], []), 
        "revert_timeout": MoPropertyMeta("revert_timeout", "revertTimeout", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x10L, None, None, r"""(([1-9]*[0-9]{2}:)|)([0-1][0-9]||[2][0-3]):([0-5][0-9]):([0-5][0-9])||(([0-5][0-9]):|)([0-5][0-9])""", ["forever"], []), 
