...
class ConfigImpact(ManagedObject):
    ...
    mo_meta = MoMeta("ConfigImpact", "configImpact", "impact-[name]", VersionMeta.Version212a, "InputOutput", 0x1fL, [], ["read-only"], [u'configManagedEpImpactResponse'], [], [None])
    ...
    prop_meta = {
        ...
        "changes": MoPropertyMeta("changes", "changes", "string", VersionMeta.Version212a, MoPropertyMeta.READ_ONLY, None, None, None, """((defaultValue|boot-order|server-assignment|operational-policies|storage-identity|server-identity|storage|networking|vnic-vhba-placement),){0,8}(defaultValue|boot-order|server-assignment|operational-policies|storage-identity|server-identity|storage|networking|vnic-vhba-placement){0,1}""", [], []), 
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version212a, MoPropertyMeta.NAMING, 0x4L, 1, 510, None, [], []), 
