...
class NetworkLldpNeighbors(ManagedObject):
    ...
    mo_meta = MoMeta("NetworkLldpNeighbors", "networkLldpNeighbors", "lldp-neighbors", VersionMeta.Version224b, "InputOutput", 0x1fL, [], ["read-only"], [u'networkElement'], [u'networkLldpNeighborEntry'], ["Get"])
