...
class NetworkLldpNeighbors(ManagedObject):
    ...
    mo_meta = MoMeta("NetworkLldpNeighbors", "networkLldpNeighbors", "lldp-neighbors", VersionMeta.Version224a, "InputOutput", 0x1f, [], ["read-only"], [u'networkElement'], [u'networkLldpNeighborEntry'], ["Get"])
