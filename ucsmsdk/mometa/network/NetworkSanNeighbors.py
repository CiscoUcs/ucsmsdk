"""This module contains the general information for NetworkSanNeighbors ManagedObject."""
import sys, os
...
class NetworkSanNeighborsConsts():
    pass


class NetworkSanNeighbors(ManagedObject):
    """This is NetworkSanNeighbors class."""

    consts = NetworkSanNeighborsConsts()
    naming_props = set([])

    mo_meta = MoMeta("NetworkSanNeighbors", "networkSanNeighbors", "san-neighbors", VersionMeta.Version223a, "InputOutput", 0x1fL, [], ["read-only"], [u'networkElement'], [u'networkSanNeighborEntry'], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "NetworkSanNeighbors", parent_mo_or_dn, **kwargs)
