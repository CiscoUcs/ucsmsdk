...
class NetworkSanNeighbors(ManagedObject):
    ...
    mo_meta = MoMeta("NetworkSanNeighbors", "networkSanNeighbors", "san-neighbors", VersionMeta.Version223a, "InputOutput", 0xfL, [], ["read-only"], [u'networkElement'], [u'networkSanNeighborEntry'], ["Get"])
