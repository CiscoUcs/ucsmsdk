...
class NetworkOperLevel(ManagedObject):
    ...
    mo_meta = MoMeta("NetworkOperLevel", "networkOperLevel", "oper-level", VersionMeta.Version212a, "InputOutput", 0x1fL, [], ["admin", "ext-lan-config"], [u'networkElement'], [u'faultInst'], [None])
    ...
    prop_meta = {
        ...
        "max_vif_count": MoPropertyMeta("max_vif_count", "maxVifCount", "uint", None, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        ...
        "vif_count": MoPropertyMeta("vif_count", "vifCount", "uint", None, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        "vif_count_status": MoPropertyMeta("vif_count_status", "vifCountStatus", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["above-limit", "within-limit"], []), 
    }
