...
class NetworkOperLevel(ManagedObject):
    ...
    mo_meta = MoMeta("NetworkOperLevel", "networkOperLevel", "oper-level", VersionMeta.Version212a, "InputOutput", 0xfL, [], ["admin", "ext-lan-config"], [u'networkElement'], [u'faultInst'], [None])
