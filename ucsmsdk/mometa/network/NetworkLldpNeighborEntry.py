...
class NetworkLldpNeighborEntry(ManagedObject):
    ...
    mo_meta = MoMeta("NetworkLldpNeighborEntry", "networkLldpNeighborEntry", "if-[local_interface]", VersionMeta.Version224a, "InputOutput", 0x3f, [], ["read-only"], [u'networkLldpNeighbors'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "local_interface": MoPropertyMeta("local_interface", "localInterface", "string", VersionMeta.Version224a, MoPropertyMeta.NAMING, 0x8, 1, 510, None, [], []), 
