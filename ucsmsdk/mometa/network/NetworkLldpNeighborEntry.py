...
class NetworkLldpNeighborEntry(ManagedObject):
    ...
    mo_meta = MoMeta("NetworkLldpNeighborEntry", "networkLldpNeighborEntry", "if-[local_interface]", VersionMeta.Version224b, "InputOutput", 0x3fL, [], ["read-only"], [u'networkLldpNeighbors'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "local_interface": MoPropertyMeta("local_interface", "localInterface", "string", VersionMeta.Version224b, MoPropertyMeta.NAMING, 0x8L, 1, 510, None, [], []), 
