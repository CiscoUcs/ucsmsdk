...
class NetworkLanNeighbors(ManagedObject):
    ...
    mo_meta = MoMeta("NetworkLanNeighbors", "networkLanNeighbors", "lan-neighbors", VersionMeta.Version223a, "InputOutput", 0x1fL, [], ["read-only"], [u'networkElement'], [u'networkLanNeighborEntry'], ["Get"])
