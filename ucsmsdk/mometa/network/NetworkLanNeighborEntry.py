...
class NetworkLanNeighborEntry(ManagedObject):
    ...
    mo_meta = MoMeta("NetworkLanNeighborEntry", "networkLanNeighborEntry", "if-[local_interface]", VersionMeta.Version223a, "InputOutput", 0x1fL, [], ["read-only"], [u'networkLanNeighbors'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "local_interface": MoPropertyMeta("local_interface", "localInterface", "string", VersionMeta.Version223a, MoPropertyMeta.NAMING, 0x4L, 1, 510, None, [], []), 
