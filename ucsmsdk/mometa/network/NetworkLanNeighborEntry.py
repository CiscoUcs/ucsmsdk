...
class NetworkLanNeighborEntry(ManagedObject):
    ...
    mo_meta = MoMeta("NetworkLanNeighborEntry", "networkLanNeighborEntry", "if-[local_interface]", VersionMeta.Version223a, "InputOutput", 0x3fL, [], ["read-only"], [u'networkLanNeighbors'], [], ["Get"])
