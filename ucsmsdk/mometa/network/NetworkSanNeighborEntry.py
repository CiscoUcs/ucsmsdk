...
class NetworkSanNeighborEntry(ManagedObject):
    ...
    mo_meta = MoMeta("NetworkSanNeighborEntry", "networkSanNeighborEntry", "if-[local_interface]", VersionMeta.Version223a, "InputOutput", 0x3fL, [], ["read-only"], [u'networkSanNeighbors'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "local_interface": MoPropertyMeta("local_interface", "localInterface", "string", VersionMeta.Version223a, MoPropertyMeta.NAMING, 0x8L, 1, 510, None, [], []), 
