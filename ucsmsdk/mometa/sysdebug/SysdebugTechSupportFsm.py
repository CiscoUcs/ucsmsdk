...
class SysdebugTechSupportFsm(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugTechSupportFsm", "sysdebugTechSupportFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'sysdebugTechSupport'], [u'sysdebugTechSupportFsmStage'], [None])
