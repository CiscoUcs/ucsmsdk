...
class SysdebugTechSupportFsm(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugTechSupportFsm", "sysdebugTechSupportFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xf, [], [""], ['sysdebugTechSupport'], ['sysdebugTechSupportFsmStage'], [None])
