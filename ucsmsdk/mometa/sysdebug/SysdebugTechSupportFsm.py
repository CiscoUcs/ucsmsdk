"""This module contains the general information for SysdebugTechSupportFsm ManagedObject."""
import sys, os
...
class SysdebugTechSupportFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_DELETE_TECH_SUP_FILE = "DeleteTechSupFile"
    CURRENT_FSM_DOWNLOAD = "Download"
    CURRENT_FSM_INITIATE = "Initiate"
    CURRENT_FSM_NOP = "nop"
...
class SysdebugTechSupportFsm(ManagedObject):
    """This is SysdebugTechSupportFsm class."""

    consts = SysdebugTechSupportFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("SysdebugTechSupportFsm", "sysdebugTechSupportFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'sysdebugTechSupport'], [u'sysdebugTechSupportFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["DeleteTechSupFile", "Download", "Initiate", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "SysdebugTechSupportFsm", parent_mo_or_dn, **kwargs)
