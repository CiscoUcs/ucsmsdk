"""This module contains the general information for SysdebugAutoCoreFileExportTargetFsm ManagedObject."""
import sys, os
...
class SysdebugAutoCoreFileExportTargetFsm(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugAutoCoreFileExportTargetFsm", "sysdebugAutoCoreFileExportTargetFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'sysdebugAutoCoreFileExportTarget'], [u'sysdebugAutoCoreFileExportTargetFsmStage'], [None])
