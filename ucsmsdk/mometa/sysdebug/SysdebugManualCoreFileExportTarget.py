"""This module contains the general information for SysdebugManualCoreFileExportTarget ManagedObject."""
import sys, os
...
class SysdebugManualCoreFileExportTargetConsts():
    ADMIN_STATE_DISABLED = "disabled"
    ADMIN_STATE_ENABLED = "enabled"
    EXPORT_STATUS_FAILURE = "failure"
    EXPORT_STATUS_SUCCESS = "success"
    FSM_PREV_EXPORT_BEGIN = "ExportBegin"
    FSM_PREV_EXPORT_EXECUTE = "ExportExecute"
    FSM_PREV_EXPORT_FAIL = "ExportFail"
    FSM_PREV_EXPORT_SUCCESS = "ExportSuccess"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_EXPORT_BEGIN = "ExportBegin"
    FSM_STATUS_EXPORT_EXECUTE = "ExportExecute"
    FSM_STATUS_EXPORT_FAIL = "ExportFail"
    FSM_STATUS_EXPORT_SUCCESS = "ExportSuccess"
    FSM_STATUS_NOP = "nop"
    INT_ID_NONE = "none"
...
class SysdebugManualCoreFileExportTarget(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugManualCoreFileExportTarget", "sysdebugManualCoreFileExportTarget", "export-to-[hostname]", VersionMeta.Version101e, "InputOutput", 0x7ffL, [], ["admin", "operations"], [u'sysdebugCore'], [u'eventInst', u'faultInst', u'sysdebugManualCoreFileExportTargetFsm', u'sysdebugManualCoreFileExportTargetFsmTask'], ["Get"])
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version101e, MoPropertyMeta.INTERNAL, None, None, None, None, ["ExportBegin", "ExportExecute", "ExportFail", "ExportSuccess", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version101e, MoPropertyMeta.INTERNAL, None, None, None, None, ["ExportBegin", "ExportExecute", "ExportFail", "ExportSuccess", "nop"], []), 
        "fsm_try": MoPropertyMeta("fsm_try", "fsmTry", "byte", VersionMeta.Version101e, MoPropertyMeta.INTERNAL, None, None, None, None, [], []), 
        "hostname": MoPropertyMeta("hostname", "hostname", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x8L, None, None, None, [], []), 
        "int_id": MoPropertyMeta("int_id", "intId", "string", VersionMeta.Version101e, MoPropertyMeta.INTERNAL, None, None, None, None, ["none"], ["0-4294967295"]), 
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version101e, MoPropertyMeta.CREATE_ONLY, 0x10L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        "path": MoPropertyMeta("path", "path", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x20L, 0, 510, None, [], []), 
        ...
        "port": MoPropertyMeta("port", "port", "uint", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x80L, None, None, None, [], ["0-65535"]), 
        "post_action": MoPropertyMeta("post_action", "postAction", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x100L, None, None, None, ["none", "remove"], []), 
    ...
    def __init__(self, parent_mo_or_dn, hostname, **kwargs):
        ...
        ManagedObject.__init__(self, "SysdebugManualCoreFileExportTarget", parent_mo_or_dn, **kwargs)
