...
class SysdebugAutoCoreFileExportTargetFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugAutoCoreFileExportTargetFsmStage", "sysdebugAutoCoreFileExportTargetFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'sysdebugAutoCoreFileExportTargetFsm'], [], [None])
