"""This module contains the general information for SysdebugAutoCoreFileExportTargetFsmStage ManagedObject."""
import sys, os
...
class SysdebugAutoCoreFileExportTargetFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
...
class SysdebugAutoCoreFileExportTargetFsmStage(ManagedObject):
    """This is SysdebugAutoCoreFileExportTargetFsmStage class."""

    consts = SysdebugAutoCoreFileExportTargetFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("SysdebugAutoCoreFileExportTargetFsmStage", "sysdebugAutoCoreFileExportTargetFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'sysdebugAutoCoreFileExportTargetFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["ConfigureBegin", "ConfigureFail", "ConfigureLocal", "ConfigurePeer", "ConfigureSuccess", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "SysdebugAutoCoreFileExportTargetFsmStage", parent_mo_or_dn, **kwargs)
