...
class SysdebugAutoCoreFileExportTargetFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugAutoCoreFileExportTargetFsmTask", "sysdebugAutoCoreFileExportTargetFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0x7L, [], [""], [u'sysdebugAutoCoreFileExportTarget'], [], [None])
