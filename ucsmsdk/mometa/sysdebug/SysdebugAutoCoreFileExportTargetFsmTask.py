"""This module contains the general information for SysdebugAutoCoreFileExportTargetFsmTask ManagedObject."""
import sys, os
...
class SysdebugAutoCoreFileExportTargetFsmTaskConsts():
...
class SysdebugAutoCoreFileExportTargetFsmTask(ManagedObject):
    """This is SysdebugAutoCoreFileExportTargetFsmTask class."""

    consts = SysdebugAutoCoreFileExportTargetFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("SysdebugAutoCoreFileExportTargetFsmTask", "sysdebugAutoCoreFileExportTargetFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], [""], [u'sysdebugAutoCoreFileExportTarget'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, None, None, None, None, ["Configure", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "SysdebugAutoCoreFileExportTargetFsmTask", parent_mo_or_dn, **kwargs)
