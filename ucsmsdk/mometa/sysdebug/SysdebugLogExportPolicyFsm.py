...
class SysdebugLogExportPolicyFsm(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugLogExportPolicyFsm", "sysdebugLogExportPolicyFsm", "fsm", VersionMeta.Version222c, "OutputOnly", 0xf, [], [""], ['sysdebugLogExportPolicy'], ['sysdebugLogExportPolicyFsmStage'], [None])
