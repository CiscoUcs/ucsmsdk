...
class SysdebugLogExportPolicyFsm(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugLogExportPolicyFsm", "sysdebugLogExportPolicyFsm", "fsm", VersionMeta.Version222c, "OutputOnly", 0xfL, [], [""], [u'sysdebugLogExportPolicy'], [u'sysdebugLogExportPolicyFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "status": MoPropertyMeta("status", "status", "string", VersionMeta.Version222c, MoPropertyMeta.READ_WRITE, 0x8L, None, None, r"""((removed|created|modified|deleted),){0,3}(removed|created|modified|deleted){0,1}""", [], []), 
    }
