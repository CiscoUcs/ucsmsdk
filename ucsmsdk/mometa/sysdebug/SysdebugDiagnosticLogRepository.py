...
class SysdebugDiagnosticLogRepository(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugDiagnosticLogRepository", "sysdebugDiagnosticLogRepository", "diag-log-files", None, "InputOutput", 0x1f, [], ["admin", "operations"], [u'topSystem'], [u'sysdebugDiagnosticLog'], [None])
