...
class SysdebugLogControlEpFsmStageConsts():
    ...
    NAME_LOG_CONTROL_PERSIST_LOCAL = "LogControlPersistLocal"
    NAME_LOG_CONTROL_PERSIST_PEER = "LogControlPersistPeer"
    NAME_LOG_CONTROL_PERSIST_SUCCESS = "LogControlPersistSuccess"
    NAME_NOP = "nop"
...
class SysdebugLogControlEpFsmStage(ManagedObject):
    """This is SysdebugLogControlEpFsmStage class."""

    consts = SysdebugLogControlEpFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("SysdebugLogControlEpFsmStage", "sysdebugLogControlEpFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'sysdebugLogControlEpFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["LogControlPersistBegin", "LogControlPersistFail", "LogControlPersistLocal", "LogControlPersistPeer", "LogControlPersistSuccess", "nop"], []), 
