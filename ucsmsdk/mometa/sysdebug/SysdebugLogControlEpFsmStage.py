...
class SysdebugLogControlEpFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugLogControlEpFsmStage", "sysdebugLogControlEpFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xf, [], [""], ['sysdebugLogControlEpFsm'], [], [None])
