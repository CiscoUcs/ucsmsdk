...
class SysdebugLogExportStatus(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugLogExportStatus", "sysdebugLogExportStatus", "log-export-status-[switch_id]", VersionMeta.Version222c, "InputOutput", 0x1fL, [], ["read-only"], [u'sysdebugLogExportPolicy'], [u'faultInst'], ["Get"])
    ...
    prop_meta = {
        ...
        "switch_id": MoPropertyMeta("switch_id", "switchId", "string", VersionMeta.Version222c, MoPropertyMeta.NAMING, 0x10L, None, None, None, ["A", "B", "NONE"], []), 
    }
