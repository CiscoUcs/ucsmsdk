...
class SysdebugMEpLog(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugMEpLog", "sysdebugMEpLog", "log-[type]-[id]", VersionMeta.Version101e, "InputOutput", 0xffL, [], ["admin", "operations"], [u'mgmtController'], [u'faultInst'], ["Get", "Set"])

    prop_meta = {
        "admin_state": MoPropertyMeta("admin_state", "adminState", "string", VersionMeta.Version111j, MoPropertyMeta.READ_WRITE, 0x2L, None, None, None, ["backup", "clear", "policy"], []), 
        ...
        "id": MoPropertyMeta("id", "id", "byte", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x10L, None, None, None, [], ["0-8"]), 
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x80L, None, None, None, ["OBFL", "SEL", "Syslog"], []), 
    }
