...
class SysdebugTechSupFileRepository(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugTechSupFileRepository", "sysdebugTechSupFileRepository", "tech-support-files", VersionMeta.Version141i, "InputOutput", 0xfL, [], ["admin", "operations"], [u'topSystem'], [u'sysdebugTechSupport'], ["Get"])
