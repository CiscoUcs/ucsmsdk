...
class SysdebugTechSupFileRepository(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugTechSupFileRepository", "sysdebugTechSupFileRepository", "tech-support-files", VersionMeta.Version141i, "InputOutput", 0x1fL, [], ["admin", "operations"], [u'topSystem'], [u'sysdebugTechSupport'], ["Get"])
