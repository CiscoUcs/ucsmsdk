...
class SysdebugLogControlEpFsm(ManagedObject):
    """This is SysdebugLogControlEpFsm class."""

    consts = SysdebugLogControlEpFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("SysdebugLogControlEpFsm", "sysdebugLogControlEpFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'sysdebugLogControlEp'], [u'sysdebugLogControlEpFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["LogControlPersist", "nop"], []), 
