...
class SysdebugManualCoreFileExportTargetFsm(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugManualCoreFileExportTargetFsm", "sysdebugManualCoreFileExportTargetFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xf, [], [""], ['sysdebugManualCoreFileExportTarget'], ['sysdebugManualCoreFileExportTargetFsmStage'], [None])
