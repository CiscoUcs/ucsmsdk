"""This module contains the general information for SysdebugManualCoreFileExportTargetFsm ManagedObject."""
import sys, os
...
class SysdebugManualCoreFileExportTargetFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_EXPORT = "Export"
    CURRENT_FSM_NOP = "nop"
...
class SysdebugManualCoreFileExportTargetFsm(ManagedObject):
    """This is SysdebugManualCoreFileExportTargetFsm class."""

    consts = SysdebugManualCoreFileExportTargetFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("SysdebugManualCoreFileExportTargetFsm", "sysdebugManualCoreFileExportTargetFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'sysdebugManualCoreFileExportTarget'], [u'sysdebugManualCoreFileExportTargetFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Export", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "SysdebugManualCoreFileExportTargetFsm", parent_mo_or_dn, **kwargs)
