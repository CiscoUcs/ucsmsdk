...
class SysdebugTechSupportFsmStageConsts():
    ...
    NAME_DELETE_TECH_SUP_FILE_LOCAL = "DeleteTechSupFileLocal"
    NAME_DELETE_TECH_SUP_FILE_PEER = "DeleteTechSupFilePeer"
    NAME_DELETE_TECH_SUP_FILE_SUCCESS = "DeleteTechSupFileSuccess"
    NAME_DOWNLOAD_BEGIN = "DownloadBegin"
    NAME_DOWNLOAD_COPY_PRIMARY = "DownloadCopyPrimary"
    NAME_DOWNLOAD_COPY_SUB = "DownloadCopySub"
    NAME_DOWNLOAD_DELETE_PRIMARY = "DownloadDeletePrimary"
    NAME_DOWNLOAD_DELETE_SUB = "DownloadDeleteSub"
    NAME_DOWNLOAD_FAIL = "DownloadFail"
    NAME_DOWNLOAD_SUCCESS = "DownloadSuccess"
    NAME_INITIATE_BEGIN = "InitiateBegin"
    NAME_INITIATE_FAIL = "InitiateFail"
    NAME_INITIATE_LOCAL = "InitiateLocal"
    NAME_INITIATE_SUCCESS = "InitiateSuccess"
    NAME_NOP = "nop"
...
class SysdebugTechSupportFsmStage(ManagedObject):
    """This is SysdebugTechSupportFsmStage class."""

    consts = SysdebugTechSupportFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("SysdebugTechSupportFsmStage", "sysdebugTechSupportFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'sysdebugTechSupportFsm'], [], [None])
