...
class SysdebugTechSupportFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugTechSupportFsmStage", "sysdebugTechSupportFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xf, [], [""], [u'sysdebugTechSupportFsm'], [], [None])
