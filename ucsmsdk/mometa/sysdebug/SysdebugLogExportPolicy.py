...
class SysdebugLogExportPolicy(ManagedObject):
    ...
    prop_meta = {
        ...
        "pwd": MoPropertyMeta("pwd", "pwd", "string", VersionMeta.Version222c, MoPropertyMeta.READ_WRITE, 0x1000, None, None, r"""[!""#%&'\(\)\*\+,\-\./:;<>@\[\\\]\^_`\{\|\}~a-zA-Z0-9]{0,127}""", [], []),
