...
class SysdebugLogExportPolicyConsts():
    ...
    FSM_STATUS_NOP = "nop"
    INT_ID_NONE = "none"
    PASSWORDLESS_SSH_FALSE = "false"
    PASSWORDLESS_SSH_NO = "no"
    PASSWORDLESS_SSH_TRUE = "true"
    PASSWORDLESS_SSH_YES = "yes"
...
class SysdebugLogExportPolicy(ManagedObject):
    """This is SysdebugLogExportPolicy class."""

    consts = SysdebugLogExportPolicyConsts()
    naming_props = set([])

    mo_meta = MoMeta("SysdebugLogExportPolicy", "sysdebugLogExportPolicy", "log-export-policy", VersionMeta.Version222c, "InputOutput", 0x7fffL, [], ["admin", "operations"], [u'sysdebugEp'], [u'eventInst', u'faultInst', u'sysdebugLogExportPolicyFsm', u'sysdebugLogExportPolicyFsmTask', u'sysdebugLogExportStatus'], ["Get", "Set"])

    prop_meta = {
        "admin_state": MoPropertyMeta("admin_state", "adminState", "string", VersionMeta.Version222c, MoPropertyMeta.READ_WRITE, 0x1L, None, None, None, ["disabled", "enabled"], []), 
        ...
        "hostname": MoPropertyMeta("hostname", "hostname", "string", VersionMeta.Version222c, MoPropertyMeta.READ_WRITE, 0x10L, None, None, None, [], []), 
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version222c, MoPropertyMeta.CREATE_ONLY, 0x20L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        "passwordless_ssh": MoPropertyMeta("passwordless_ssh", "passwordlessSsh", "string", VersionMeta.Version222c, MoPropertyMeta.READ_WRITE, 0x40L, None, None, None, ["false", "no", "true", "yes"], []), 
        "path": MoPropertyMeta("path", "path", "string", VersionMeta.Version222c, MoPropertyMeta.READ_WRITE, 0x80L, 1, 128, None, [], []), 
        ...
        "policy_owner": MoPropertyMeta("policy_owner", "policyOwner", "string", VersionMeta.Version222c, MoPropertyMeta.READ_WRITE, 0x100L, None, None, None, ["local", "pending-policy", "policy"], []), 
        "post_action": MoPropertyMeta("post_action", "postAction", "string", VersionMeta.Version222c, MoPropertyMeta.READ_WRITE, 0x200L, None, None, None, ["none", "remove"], []), 
        "proto": MoPropertyMeta("proto", "proto", "string", VersionMeta.Version222c, MoPropertyMeta.READ_WRITE, 0x400L, None, None, None, ["ftp", "http", "nfs-copy", "none", "scp", "sftp", "tftp"], []), 
        "pwd": MoPropertyMeta("pwd", "pwd", "string", VersionMeta.Version222c, MoPropertyMeta.READ_WRITE, 0x800L, None, None, """[!""#%&'\(\)\*\+,\-\./:;<>@\[\\\]\^_`\{\|\}~a-zA-Z0-9]{0,80}""", [], []), 
        "rn": MoPropertyMeta("rn", "rn", "string", VersionMeta.Version222c, MoPropertyMeta.READ_ONLY, 0x1000L, 0, 256, None, [], []), 
        "sacl": MoPropertyMeta("sacl", "sacl", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, """((none|del|mod|addchild|cascade),){0,4}(none|del|mod|addchild|cascade){0,1}""", [], []), 
        "status": MoPropertyMeta("status", "status", "string", VersionMeta.Version222c, MoPropertyMeta.READ_WRITE, 0x2000L, None, None, """((removed|created|modified|deleted),){0,3}(removed|created|modified|deleted){0,1}""", [], []), 
        "user": MoPropertyMeta("user", "user", "string", VersionMeta.Version222c, MoPropertyMeta.READ_WRITE, 0x4000L, 0, 510, None, [], []), 
    }
