"""This module contains the general information for SysdebugCoreFsm ManagedObject."""
import sys, os
...
class SysdebugCoreFsm(ManagedObject):
    """This is SysdebugCoreFsm class."""

    consts = SysdebugCoreFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("SysdebugCoreFsm", "sysdebugCoreFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'sysdebugCore'], [u'sysdebugCoreFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "SysdebugCoreFsm", parent_mo_or_dn, **kwargs)
