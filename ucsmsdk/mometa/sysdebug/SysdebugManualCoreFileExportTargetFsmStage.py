...
class SysdebugManualCoreFileExportTargetFsmStageConsts():
    ...
    NAME_EXPORT_FAIL = "ExportFail"
    NAME_EXPORT_SUCCESS = "ExportSuccess"
    NAME_NOP = "nop"
...
class SysdebugManualCoreFileExportTargetFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugManualCoreFileExportTargetFsmStage", "sysdebugManualCoreFileExportTargetFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'sysdebugManualCoreFileExportTargetFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["ExportBegin", "ExportExecute", "ExportFail", "ExportSuccess", "nop"], []), 
