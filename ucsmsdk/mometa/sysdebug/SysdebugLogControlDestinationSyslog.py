...
class SysdebugLogControlDestinationSyslog(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugLogControlDestinationSyslog", "sysdebugLogControlDestinationSyslog", "syslog", VersionMeta.Version101e, "InputOutput", 0x7fL, [], ["admin", "operations"], [u'sysdebugLogControlDomain'], [], ["Get"])
