"""This module contains the general information for SysdebugCoreFsmTask ManagedObject."""
import sys, os
...
class SysdebugCoreFsmTaskConsts():
...
class SysdebugCoreFsmTask(ManagedObject):
    """This is SysdebugCoreFsmTask class."""

    consts = SysdebugCoreFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("SysdebugCoreFsmTask", "sysdebugCoreFsmTask", "task-[item]", VersionMeta.Version141i, "OutputOnly", 0xfL, [], [""], [u'sysdebugCore'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "SysdebugCoreFsmTask", parent_mo_or_dn, **kwargs)
