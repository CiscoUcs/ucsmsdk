...
class SysdebugManualCoreFileExportTargetFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugManualCoreFileExportTargetFsmTask", "sysdebugManualCoreFileExportTargetFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0x7L, [], [""], [u'sysdebugManualCoreFileExportTarget'], [], [None])
