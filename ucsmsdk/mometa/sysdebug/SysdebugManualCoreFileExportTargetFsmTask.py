"""This module contains the general information for SysdebugManualCoreFileExportTargetFsmTask ManagedObject."""
import sys, os
...
class SysdebugManualCoreFileExportTargetFsmTaskConsts():
...
class SysdebugManualCoreFileExportTargetFsmTask(ManagedObject):
    """This is SysdebugManualCoreFileExportTargetFsmTask class."""

    consts = SysdebugManualCoreFileExportTargetFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("SysdebugManualCoreFileExportTargetFsmTask", "sysdebugManualCoreFileExportTargetFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], [""], [u'sysdebugManualCoreFileExportTarget'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, None, None, None, None, ["Export", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "SysdebugManualCoreFileExportTargetFsmTask", parent_mo_or_dn, **kwargs)
