...
class SysdebugLogControlEpConsts():
    ...
    FSM_PREV_LOG_CONTROL_PERSIST_PEER = "LogControlPersistPeer"
    FSM_PREV_LOG_CONTROL_PERSIST_SUCCESS = "LogControlPersistSuccess"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_LOG_CONTROL_PERSIST_BEGIN = "LogControlPersistBegin"
    FSM_STATUS_LOG_CONTROL_PERSIST_FAIL = "LogControlPersistFail"
    FSM_STATUS_LOG_CONTROL_PERSIST_LOCAL = "LogControlPersistLocal"
    FSM_STATUS_LOG_CONTROL_PERSIST_PEER = "LogControlPersistPeer"
    FSM_STATUS_LOG_CONTROL_PERSIST_SUCCESS = "LogControlPersistSuccess"
    FSM_STATUS_NOP = "nop"
    LEVEL_CRIT = "crit"
    LEVEL_DEBUG0 = "debug0"
    LEVEL_DEBUG1 = "debug1"
...
class SysdebugLogControlEp(ManagedObject):
    """This is SysdebugLogControlEp class."""

    consts = SysdebugLogControlEpConsts()
    naming_props = set([])

    mo_meta = MoMeta("SysdebugLogControlEp", "sysdebugLogControlEp", "logcontrol", VersionMeta.Version101e, "InputOutput", 0x1ffL, [], ["admin", "operations"], [u'sysdebugEp'], [u'eventInst', u'faultInst', u'sysdebugLogControlDomain', u'sysdebugLogControlEpFsm', u'sysdebugLogControlEpFsmTask'], ["Get"])
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version101e, MoPropertyMeta.INTERNAL, None, None, None, None, ["LogControlPersistBegin", "LogControlPersistFail", "LogControlPersistLocal", "LogControlPersistPeer", "LogControlPersistSuccess", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version101e, MoPropertyMeta.INTERNAL, None, None, None, None, ["LogControlPersistBegin", "LogControlPersistFail", "LogControlPersistLocal", "LogControlPersistPeer", "LogControlPersistSuccess", "nop"], []), 
        "fsm_try": MoPropertyMeta("fsm_try", "fsmTry", "byte", VersionMeta.Version101e, MoPropertyMeta.INTERNAL, None, None, None, None, [], []), 
        "level": MoPropertyMeta("level", "level", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x8L, None, None, None, ["crit", "debug0", "debug1", "debug2", "debug3", "debug4", "info", "major", "minor", "warn"], []), 
        "level_flag": MoPropertyMeta("level_flag", "levelFlag", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x10L, None, None, None, ["false", "no", "true", "yes"], []), 
