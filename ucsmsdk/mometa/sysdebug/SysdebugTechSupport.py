...
class SysdebugTechSupportConsts():
    ...
    FSM_PREV_DELETE_TECH_SUP_FILE_BEGIN = "DeleteTechSupFileBegin"
    FSM_PREV_DELETE_TECH_SUP_FILE_FAIL = "DeleteTechSupFileFail"
    FSM_PREV_DELETE_TECH_SUP_FILE_LOCAL = "DeleteTechSupFileLocal"
    FSM_PREV_DELETE_TECH_SUP_FILE_PEER = "DeleteTechSupFilePeer"
    FSM_PREV_DELETE_TECH_SUP_FILE_SUCCESS = "DeleteTechSupFileSuccess"
    FSM_PREV_DOWNLOAD_BEGIN = "DownloadBegin"
    FSM_PREV_DOWNLOAD_COPY_PRIMARY = "DownloadCopyPrimary"
    FSM_PREV_DOWNLOAD_COPY_SUB = "DownloadCopySub"
    FSM_PREV_DOWNLOAD_DELETE_PRIMARY = "DownloadDeletePrimary"
    FSM_PREV_DOWNLOAD_DELETE_SUB = "DownloadDeleteSub"
    FSM_PREV_DOWNLOAD_FAIL = "DownloadFail"
    FSM_PREV_DOWNLOAD_SUCCESS = "DownloadSuccess"
    FSM_PREV_INITIATE_BEGIN = "InitiateBegin"
    FSM_PREV_INITIATE_FAIL = "InitiateFail"
    FSM_PREV_INITIATE_LOCAL = "InitiateLocal"
    FSM_PREV_INITIATE_SUCCESS = "InitiateSuccess"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_DELETE_TECH_SUP_FILE_BEGIN = "DeleteTechSupFileBegin"
    FSM_STATUS_DELETE_TECH_SUP_FILE_FAIL = "DeleteTechSupFileFail"
    FSM_STATUS_DELETE_TECH_SUP_FILE_LOCAL = "DeleteTechSupFileLocal"
    FSM_STATUS_DELETE_TECH_SUP_FILE_PEER = "DeleteTechSupFilePeer"
    FSM_STATUS_DELETE_TECH_SUP_FILE_SUCCESS = "DeleteTechSupFileSuccess"
    FSM_STATUS_DOWNLOAD_BEGIN = "DownloadBegin"
    FSM_STATUS_DOWNLOAD_COPY_PRIMARY = "DownloadCopyPrimary"
    FSM_STATUS_DOWNLOAD_COPY_SUB = "DownloadCopySub"
    FSM_STATUS_DOWNLOAD_DELETE_PRIMARY = "DownloadDeletePrimary"
    FSM_STATUS_DOWNLOAD_DELETE_SUB = "DownloadDeleteSub"
    FSM_STATUS_DOWNLOAD_FAIL = "DownloadFail"
    FSM_STATUS_DOWNLOAD_SUCCESS = "DownloadSuccess"
    FSM_STATUS_INITIATE_BEGIN = "InitiateBegin"
    FSM_STATUS_INITIATE_FAIL = "InitiateFail"
    FSM_STATUS_INITIATE_LOCAL = "InitiateLocal"
    FSM_STATUS_INITIATE_SUCCESS = "InitiateSuccess"
    FSM_STATUS_NOP = "nop"
    OPER_STATE_AVAILABLE = "available"
    OPER_STATE_AVAILABLE_ON_SUBORDINATE = "available-on-subordinate"
    OPER_STATE_FAILED = "failed"
    OPER_STATE_IN_PROGRESS = "in-progress"
    OPER_STATE_UNAVAILABLE = "unavailable"
    SWITCH_ID_A = "A"
    SWITCH_ID_B = "B"
    SWITCH_ID_NONE = "NONE"
...
class SysdebugTechSupport(ManagedObject):
    """This is SysdebugTechSupport class."""

    consts = SysdebugTechSupportConsts()
    naming_props = set([u'creationTS'])

    mo_meta = MoMeta("SysdebugTechSupport", "sysdebugTechSupport", "tech-support-[creation_ts]", VersionMeta.Version141i, "InputOutput", 0xffL, [], ["admin", "operations"], [u'sysdebugTechSupFileRepository'], [u'eventInst', u'faultInst', u'sysdebugTechSupportCmdOpt', u'sysdebugTechSupportFsm', u'sysdebugTechSupportFsmTask'], ["Add", "Get", "Set"])

    prop_meta = {
        "admin_state": MoPropertyMeta("admin_state", "adminState", "string", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x1L, None, None, None, ["created", "delete", "init", "prepare-download", "start"], []), 
        ...
        "creation_ts": MoPropertyMeta("creation_ts", "creationTS", "ulong", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x4L, None, None, None, [], []), 
        "descr": MoPropertyMeta("descr", "descr", "string", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x8L, None, None, """[ !#$%&\(\)\*\+,\-\./:;\?@\[\]_\{\|\}~a-zA-Z0-9]{0,256}""", [], []), 
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x20L, 1, 128, None, [], []), 
        ...
        "ts": MoPropertyMeta("ts", "ts", "string", VersionMeta.Version141i, MoPropertyMeta.READ_ONLY, None, None, None, """([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", [], []), 
    ...
    def __init__(self, parent_mo_or_dn, creation_ts, **kwargs):
        ...
        ManagedObject.__init__(self, "SysdebugTechSupport", parent_mo_or_dn, **kwargs)
