"""This module contains the general information for SysdebugLogControlEpFsmTask ManagedObject."""
import sys, os
...
class SysdebugLogControlEpFsmTaskConsts():
    COMPLETION_CANCELLED = "cancelled"
    COMPLETION_COMPLETED = "completed"
    COMPLETION_PROCESSING = "processing"
    COMPLETION_SCHEDULED = "scheduled"
    ITEM_LOG_CONTROL_PERSIST = "LogControlPersist"
    ITEM_NOP = "nop"


class SysdebugLogControlEpFsmTask(ManagedObject):
    """This is SysdebugLogControlEpFsmTask class."""

    consts = SysdebugLogControlEpFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("SysdebugLogControlEpFsmTask", "sysdebugLogControlEpFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], [""], [u'sysdebugLogControlEp'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, None, None, None, None, ["LogControlPersist", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "SysdebugLogControlEpFsmTask", parent_mo_or_dn, **kwargs)
