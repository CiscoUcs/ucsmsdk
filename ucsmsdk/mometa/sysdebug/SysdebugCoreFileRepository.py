"""This module contains the general information for SysdebugCoreFileRepository ManagedObject."""
import sys, os
...
class SysdebugCoreFileRepository(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugCoreFileRepository", "sysdebugCoreFileRepository", "corefiles", VersionMeta.Version101e, "InputOutput", 0x1fL, [], ["admin", "operations"], [u'topSystem'], [u'sysdebugCore', u'sysfileMutation'], ["Get"])
