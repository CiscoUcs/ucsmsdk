...
class SysdebugMEpLogPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugMEpLogPolicy", "sysdebugMEpLogPolicy", "log-[type]", VersionMeta.Version111j, "InputOutput", 0xff, [], ["admin", "operations"], ['orgOrg'], ['sysdebugBackupBehavior'], ["Get"])
