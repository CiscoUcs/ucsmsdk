...
class ProcStimulusCounts(ManagedObject):
    ...
    mo_meta = MoMeta("ProcStimulusCounts", "procStimulusCounts", "stim", VersionMeta.Version101e, "InputOutput", 0x3fL, [], ["admin", "read-only"], [u'procManager', u'procSvc'], [], ["Get"])

    prop_meta = {
        "admin_state": MoPropertyMeta("admin_state", "adminState", "string", VersionMeta.Version211a, MoPropertyMeta.READ_WRITE, 0x2L, None, None, None, ["clear-stats", "log-stats", "on"], []), 
