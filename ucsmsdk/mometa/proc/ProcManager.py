...
class ProcManager(ManagedObject):
    ...
    mo_meta = MoMeta("ProcManager", "procManager", "proc-info", VersionMeta.Version101e, "InputOutput", 0xfL, [], ["read-only"], [u'topRoot'], [u'procDoer', u'procPrt', u'procPrtCounts', u'procStimulusCounts', u'procSvc', u'procTxCounts'], ["Get"])
