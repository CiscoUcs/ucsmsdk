"""This module contains the general information for ProcManager ManagedObject."""
import sys, os
...
class ProcManagerConsts():
    pass


class ProcManager(ManagedObject):
    """This is ProcManager class."""

    consts = ProcManagerConsts()
    naming_props = set([])

    mo_meta = MoMeta("ProcManager", "procManager", "proc-info", VersionMeta.Version101e, "InputOutput", 0x1fL, [], ["read-only"], [u'topRoot'], [u'procDoer', u'procPrt', u'procPrtCounts', u'procStimulusCounts', u'procSvc', u'procTxCounts'], ["Get"])
    ...
    def __init__(self, **kwargs):
        ...
        ManagedObject.__init__(self, "ProcManager", **kwargs)
