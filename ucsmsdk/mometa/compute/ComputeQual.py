"""This module contains the general information for ComputeQual ManagedObject."""
import sys, os
...
class ComputeQual(ManagedObject):
    """This is ComputeQual class."""

    consts = ComputeQualConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("ComputeQual", "computeQual", "blade-qualifier-[name]", VersionMeta.Version101e, "InputOutput", 0xffL, [], ["admin", "pn-policy"], [u'orgOrg'], [u'adaptorQual', u'computeChassisQual', u'computePhysicalQual', u'computeRackQual', u'memoryQual', u'powerGroupQual', u'processorQual', u'storageQual'], ["Add", "Get", "Remove", "Set"])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "ComputeQual", parent_mo_or_dn, **kwargs)
