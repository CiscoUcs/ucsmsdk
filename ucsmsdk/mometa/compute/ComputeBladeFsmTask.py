"""This module contains the general information for ComputeBladeFsmTask ManagedObject."""
import sys, os
...
class ComputeBladeFsmTaskConsts():
...
class ComputeBladeFsmTask(ManagedObject):
    """This is ComputeBladeFsmTask class."""

    consts = ComputeBladeFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("ComputeBladeFsmTask", "computeBladeFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], [""], [u'computeBlade'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, None, None, None, None, ["Diag", "Discover", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "ComputeBladeFsmTask", parent_mo_or_dn, **kwargs)
