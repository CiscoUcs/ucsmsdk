...
class ComputeRackQual(ManagedObject):
    ...
    mo_meta = MoMeta("ComputeRackQual", "computeRackQual", "rack-from-[min_id]-to-[max_id]", VersionMeta.Version141i, "InputOutput", 0x3fL, [], ["admin", "pn-policy"], [u'computeQual'], [], ["Add", "Get", "Remove"])
    ...
    prop_meta = {
        ...
        "max_id": MoPropertyMeta("max_id", "maxId", "uint", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x4L, None, None, None, [], ["1-255"]), 
        "min_id": MoPropertyMeta("min_id", "minId", "uint", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x8L, None, None, None, [], ["1-255"]), 
