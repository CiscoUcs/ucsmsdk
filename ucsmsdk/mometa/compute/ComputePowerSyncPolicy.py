...
class ComputePowerSyncPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("ComputePowerSyncPolicy", "computePowerSyncPolicy", "power-sync-[name]", VersionMeta.Version911z, "InputOutput", 0x1ff, [], ["admin", "ls-compute", "ls-config-policy", "ls-server", "ls-server-policy"], [u'orgOrg'], [], [None])
    ...
    prop_meta = {
        ...
        "sync_option": MoPropertyMeta("sync_option", "syncOption", "string", VersionMeta.Version911z, MoPropertyMeta.READ_WRITE, 0x100, None, None, None, ["always-sync", "default", "initial-only-sync"], []), 
    }
