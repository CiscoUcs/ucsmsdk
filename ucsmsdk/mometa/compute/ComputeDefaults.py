...
class ComputeDefaults(ManagedObject):
    ...
    mo_meta = MoMeta("ComputeDefaults", "computeDefaults", "compute-defaults", VersionMeta.Version131c, "InputOutput", 0x1f, [], [""], [u'topRoot'], [u'biosSettings', u'computePlatform'], ["Get"])
