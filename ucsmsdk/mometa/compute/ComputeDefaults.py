"""This module contains the general information for ComputeDefaults ManagedObject."""
import sys, os
...
class ComputeDefaultsConsts():
    pass


class ComputeDefaults(ManagedObject):
    """This is ComputeDefaults class."""

    consts = ComputeDefaultsConsts()
    naming_props = set([])

    mo_meta = MoMeta("ComputeDefaults", "computeDefaults", "compute-defaults", VersionMeta.Version131c, "InputOutput", 0x1fL, [], [""], [u'topRoot'], [u'biosSettings', u'computePlatform'], ["Get"])
    ...
    def __init__(self, **kwargs):
        ...
        ManagedObject.__init__(self, "ComputeDefaults", **kwargs)
