...
class ComputeDefaults(ManagedObject):
    ...
    mo_meta = MoMeta("ComputeDefaults", "computeDefaults", "compute-defaults", VersionMeta.Version131c, "InputOutput", 0xfL, [], [""], [u'topRoot'], [u'biosSettings', u'computePlatform'], ["Get"])
