...
class ComputePhysicalAssocCtx(ManagedObject):
    ...
    mo_meta = MoMeta("ComputePhysicalAssocCtx", "computePhysicalAssocCtx", "pn-assoc-ctx", VersionMeta.Version141i, "InputOutput", 0x1fL, [], ["read-only"], [u'lsServerAssocCtx'], [], ["Get"])
