...
class ComputeServerUnitFsm(ManagedObject):
    ...
    mo_meta = MoMeta("ComputeServerUnitFsm", "computeServerUnitFsm", "fsm", VersionMeta.Version251a, "OutputOnly", 0xfL, [], [""], [u'computeServerUnit'], [u'computeServerUnitFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "status": MoPropertyMeta("status", "status", "string", VersionMeta.Version251a, MoPropertyMeta.READ_WRITE, 0x8L, None, None, r"""((removed|created|modified|deleted),){0,3}(removed|created|modified|deleted){0,1}""", [], []), 
    }
