"""This module contains the general information for ComputeServerUnitFsm ManagedObject."""
...
class ComputeServerUnitFsmConsts:
    COMPLETION_TIME_ = ""
    ...
    CURRENT_FSM_CONFIG_SO_L = "ConfigSoL"
    CURRENT_FSM_CONFIGURE_SERVER_PERSONALITY = "ConfigureServerPersonality"
    CURRENT_FSM_DATA_SANITIZATION = "DataSanitization"
    CURRENT_FSM_DECOMMISSION = "Decommission"
    CURRENT_FSM_DIAG = "Diag"
    CURRENT_FSM_DIAGNOSTIC_INTERRUPT = "DiagnosticInterrupt"
    CURRENT_FSM_DISASSOCIATE = "Disassociate"
    CURRENT_FSM_DISCOVER = "Discover"
    CURRENT_FSM_DISK_ZONING_INVENTORY = "DiskZoningInventory"
    CURRENT_FSM_ENABLE_CIMC_SECURE_BOOT = "EnableCimcSecureBoot"
    CURRENT_FSM_EXECUTE_ACTIONS = "ExecuteActions"
    CURRENT_FSM_FLASH_CONTROLLER = "FlashController"
    CURRENT_FSM_FW_UPGRADE = "FwUpgrade"
    CURRENT_FSM_HARD_SHUTDOWN = "HardShutdown"
    CURRENT_FSM_HARDRESET = "Hardreset"
    CURRENT_FSM_NVME_SWITCH_RECOVERY = "NvmeSwitchRecovery"
    CURRENT_FSM_OOB_STORAGE_ADMIN_CONFIG = "OobStorageAdminConfig"
    CURRENT_FSM_POWER_CAP = "PowerCap"
    CURRENT_FSM_POWERCYCLE = "Powercycle"
    CURRENT_FSM_REINITIALIZE_VIRTUAL_DRIVE = "ReinitializeVirtualDrive"
    CURRENT_FSM_RESET_BMC = "ResetBmc"
    CURRENT_FSM_RESET_IPMI = "ResetIpmi"
    CURRENT_FSM_RESET_KVM = "ResetKvm"
    CURRENT_FSM_RESET_MEMORY_ERRORS = "ResetMemoryErrors"
    CURRENT_FSM_SERVICE_INFRA_DEPLOY = "ServiceInfraDeploy"
    CURRENT_FSM_SERVICE_INFRA_WITHDRAW = "ServiceInfraWithdraw"
    CURRENT_FSM_SOFT_SHUTDOWN = "SoftShutdown"
    CURRENT_FSM_SOFTRESET = "Softreset"
    CURRENT_FSM_SW_CONN_UPD = "SwConnUpd"
    CURRENT_FSM_TURNUP = "Turnup"
    CURRENT_FSM_UNCONFIG_SO_L = "UnconfigSoL"
    CURRENT_FSM_UPDATE_ADAPTOR = "UpdateAdaptor"
    CURRENT_FSM_UPDATE_BIOS = "UpdateBIOS"
    CURRENT_FSM_UPDATE_BOARD_CONTROLLER = "UpdateBoardController"
    CURRENT_FSM_CLEAR_TPM = "clearTPM"
    CURRENT_FSM_NOP = "nop"
    CURRENT_FSM_UPDATE_EXT_USERS = "updateExtUsers"
...
class ComputeServerUnitFsm(ManagedObject):
    """This is ComputeServerUnitFsm class."""
    ...
    prop_meta = {
        ...
        "completion_time": MoPropertyMeta("completion_time", "completionTime", "string", VersionMeta.Version251a, MoPropertyMeta.READ_ONLY, None, None, None, r"""([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", [""], []),
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version251a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["ActivateAdaptor", "ActivateBIOS", "Associate", "BiosPasswordReset", "BiosRecovery", "CimcSecurityConfig", "CimcSecurityUnconfig", "CimcSessionDelete", "CmosReset", "ConfigBoard", "ConfigSoL", "ConfigureServerPersonality", "DataSanitization", "Decommission", "Diag", "DiagnosticInterrupt", "Disassociate", "Discover", "DiskZoningInventory", "EnableCimcSecureBoot", "ExecuteActions", "FlashController", "FwUpgrade", "HardShutdown", "Hardreset", "NvmeSwitchRecovery", "OobStorageAdminConfig", "PowerCap", "Powercycle", "ReinitializeVirtualDrive", "ResetBmc", "ResetIpmi", "ResetKvm", "ResetMemoryErrors", "ServiceInfraDeploy", "ServiceInfraWithdraw", "SoftShutdown", "Softreset", "SwConnUpd", "Turnup", "UnconfigSoL", "UpdateAdaptor", "UpdateBIOS", "UpdateBoardController", "clearTPM", "nop", "updateExtUsers"], []),
        "descr": MoPropertyMeta("descr", "descr", "string", VersionMeta.Version251a, MoPropertyMeta.READ_ONLY, None, None, None, r"""[ !#$%&\(\)\*\+,\-\./:;\?@\[\]_\{\|\}~a-zA-Z0-9]{0,256}""", [], []),
        "dn": MoPropertyMeta("dn", "dn", "string", VersionMeta.Version251a, MoPropertyMeta.READ_ONLY, 0x2, 0, 256, None, [], []),
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version251a, MoPropertyMeta.INTERNAL, None, None, None, None, ["fail", "inProgress", "nop", "pending", "skip", "success", "throttled"], []),
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "ComputeServerUnitFsm", parent_mo_or_dn, **kwargs)
