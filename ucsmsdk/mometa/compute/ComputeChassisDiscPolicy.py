...
class ComputeChassisDiscPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("ComputeChassisDiscPolicy", "computeChassisDiscPolicy", "chassis-discovery", VersionMeta.Version101e, "InputOutput", 0x1fff, [], ["admin", "pn-policy"], [u'orgOrg'], [], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "backplane_speed_pref": MoPropertyMeta("backplane_speed_pref", "backplaneSpeedPref", "string", VersionMeta.Version911z, MoPropertyMeta.READ_WRITE, 0x4, None, None, None, ["40G", "4x10G"], []), 
