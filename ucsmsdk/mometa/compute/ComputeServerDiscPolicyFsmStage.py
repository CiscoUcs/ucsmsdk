...
class ComputeServerDiscPolicyFsmStageConsts():
    ...
    NAME_RESOLVE_SCRUB_POLICY_RESOLVE = "ResolveScrubPolicyResolve"
    NAME_RESOLVE_SCRUB_POLICY_SUCCESS = "ResolveScrubPolicySuccess"
    NAME_NOP = "nop"
...
class ComputeServerDiscPolicyFsmStage(ManagedObject):
    """This is ComputeServerDiscPolicyFsmStage class."""

    consts = ComputeServerDiscPolicyFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("ComputeServerDiscPolicyFsmStage", "computeServerDiscPolicyFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'computeServerDiscPolicyFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["ResolveScrubPolicyBegin", "ResolveScrubPolicyFail", "ResolveScrubPolicyResolve", "ResolveScrubPolicySuccess", "nop"], []), 
