...
class ComputePhysicalQual(ManagedObject):
    ...
    mo_meta = MoMeta("ComputePhysicalQual", "computePhysicalQual", "physical", VersionMeta.Version131c, "InputOutput", 0x1fL, [], ["admin", "pn-policy"], [u'computeQual', u'lstorageArrayQual', u'lstorageBackstoreQual'], [], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "model": MoPropertyMeta("model", "model", "string", VersionMeta.Version131c, MoPropertyMeta.READ_WRITE, 0x4L, None, None, """[ !#$%\(\)\*\+,\-\./:;\?@\[\\\]\^_\{\|\}~a-zA-Z0-9]{0,256}""", [], []), 
