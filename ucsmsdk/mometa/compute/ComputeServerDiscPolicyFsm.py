"""This module contains the general information for ComputeServerDiscPolicyFsm ManagedObject."""
import sys, os
...
class ComputeServerDiscPolicyFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_RESOLVE_SCRUB_POLICY = "ResolveScrubPolicy"
    CURRENT_FSM_NOP = "nop"
...
class ComputeServerDiscPolicyFsm(ManagedObject):
    """This is ComputeServerDiscPolicyFsm class."""

    consts = ComputeServerDiscPolicyFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("ComputeServerDiscPolicyFsm", "computeServerDiscPolicyFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'computeServerDiscPolicy'], [u'computeServerDiscPolicyFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["ResolveScrubPolicy", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "ComputeServerDiscPolicyFsm", parent_mo_or_dn, **kwargs)
