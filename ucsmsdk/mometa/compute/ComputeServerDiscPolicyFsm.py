...
class ComputeServerDiscPolicyFsm(ManagedObject):
    ...
    mo_meta = MoMeta("ComputeServerDiscPolicyFsm", "computeServerDiscPolicyFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xf, [], [""], ['computeServerDiscPolicy'], ['computeServerDiscPolicyFsmStage'], [None])
