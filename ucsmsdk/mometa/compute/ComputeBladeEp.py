...
class ComputeBladeEp(ManagedObject):
    ...
    mo_meta = MoMeta("ComputeBladeEp", "computeBladeEp", "blade-ep-[id]", VersionMeta.Version302a, "InputOutput", 0x3f, [], ["read-only"], [], [], [None])
    ...
    prop_meta = {
        ...
        "id": MoPropertyMeta("id", "id", "uint", VersionMeta.Version302a, MoPropertyMeta.NAMING, 0x8, None, None, None, [], ["1-2"]), 
