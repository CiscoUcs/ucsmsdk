...
class ComputePooledRackUnit(ManagedObject):
    ...
    mo_meta = MoMeta("ComputePooledRackUnit", "computePooledRackUnit", "rack-[id]", VersionMeta.Version141i, "InputOutput", 0x3fL, [], ["admin", "pn-policy"], [u'computePool'], [], ["Add", "Get", "Remove"])
    ...
    prop_meta = {
        ...
        "id": MoPropertyMeta("id", "id", "uint", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x8L, None, None, None, [], ["1-255"]), 
