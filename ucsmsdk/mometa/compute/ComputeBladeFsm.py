"""This module contains the general information for ComputeBladeFsm ManagedObject."""
import sys, os
...
class ComputeBladeFsm(ManagedObject):
    """This is ComputeBladeFsm class."""

    consts = ComputeBladeFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("ComputeBladeFsm", "computeBladeFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'computeBlade'], [u'computeBladeFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["ActivateAdaptor", "ActivateBIOS", "Associate", "BiosRecovery", "CimcSessionDelete", "CmosReset", "ConfigBoard", "ConfigSoL", "Decommission", "Diag", "DiagnosticInterrupt", "Disassociate", "Discover", "EnableCimcSecureBoot", "FlashController", "FwUpgrade", "HardShutdown", "Hardreset", "OobStorageAdminConfig", "PowerCap", "Powercycle", "ResetBmc", "ResetIpmi", "ResetKvm", "ResetMemoryErrors", "ServiceInfraDeploy", "ServiceInfraWithdraw", "SoftShutdown", "Softreset", "SwConnUpd", "Turnup", "UnconfigSoL", "UpdateAdaptor", "UpdateBIOS", "UpdateBoardController", "clearTPM", "nop", "updateExtUsers"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "ComputeBladeFsm", parent_mo_or_dn, **kwargs)
