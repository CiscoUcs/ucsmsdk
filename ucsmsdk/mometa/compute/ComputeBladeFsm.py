...
class ComputeBladeFsm(ManagedObject):
    ...
    mo_meta = MoMeta("ComputeBladeFsm", "computeBladeFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xf, [], [""], ['computeBlade'], ['computeBladeFsmStage'], [None])
