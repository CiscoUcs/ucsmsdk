...
class ComputePowerSyncDef(ManagedObject):
    ...
    mo_meta = MoMeta("ComputePowerSyncDef", "computePowerSyncDef", "power-sync-def", VersionMeta.Version911z, "InputOutput", 0xff, [], ["admin", "ls-compute", "ls-config-policy", "ls-server", "ls-server-policy"], [u'lsServer'], [], [None])
    ...
    prop_meta = {
        ...
        "policy_owner": MoPropertyMeta("policy_owner", "policyOwner", "string", VersionMeta.Version911z, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["local", "pending-policy", "policy"], []), 
        ...
        "sync_option": MoPropertyMeta("sync_option", "syncOption", "string", VersionMeta.Version911z, MoPropertyMeta.READ_WRITE, 0x80, None, None, None, ["always-sync", "default", "initial-only-sync"], []), 
    }
