...
class ComputeBoardController(ManagedObject):
    ...
    mo_meta = MoMeta("ComputeBoardController", "computeBoardController", "boardController", VersionMeta.Version131c, "InputOutput", 0x3fL, [], ["read-only"], [u'computeBlade', u'computeExtBoard', u'computeRackUnit', u'computeServerUnit', u'equipmentChassis'], [u'mgmtController'], ["Get"])
