...
class ComputePCIeFatalProtocolStats(ManagedObject):
    ...
    mo_meta = MoMeta("ComputePCIeFatalProtocolStats", "computePCIeFatalProtocolStats", "pciefat-protocol-stats", VersionMeta.Version111j, "OutputOnly", 0x7L, [], ["admin", "operations", "read-only"], [u'computeBoard'], [], ["Get"])
