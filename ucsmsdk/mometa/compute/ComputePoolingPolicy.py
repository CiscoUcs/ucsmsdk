...
class ComputePoolingPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("ComputePoolingPolicy", "computePoolingPolicy", "pooling-policy-[name]", VersionMeta.Version101e, "InputOutput", 0x3ff, [], ["admin", "pn-policy"], ['orgOrg'], [], ["Add", "Get", "Remove", "Set"])
