...
class ComputeRackConnLinkPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("ComputeRackConnLinkPolicy", "computeRackConnLinkPolicy", "rack-conn-link-policy-rack-unit-[rack_id]-fabric-[switch_id]", None, "InputOutput", 0x7ff, [], ["admin", "pn-policy"], [u'orgOrg'], [], [None])
    ...
    prop_meta = {
        ...
        "link_grouping": MoPropertyMeta("link_grouping", "linkGrouping", "string", None, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["none", "port-channel"], []), 
        ...
        "qualifier": MoPropertyMeta("qualifier", "qualifier", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        "rack_id": MoPropertyMeta("rack_id", "rackId", "uint", None, MoPropertyMeta.NAMING, 0x80, None, None, None, [], ["1-255"]), 
        ...
        "switch_id": MoPropertyMeta("switch_id", "switchId", "string", None, MoPropertyMeta.NAMING, 0x400, None, None, None, ["A", "B", "NONE"], []), 
    }
