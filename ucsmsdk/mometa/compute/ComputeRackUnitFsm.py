"""This module contains the general information for ComputeRackUnitFsm ManagedObject."""
import sys, os
...
class ComputeRackUnitFsmConsts():
    COMPLETION_TIME_ = ""
    ...
    CURRENT_FSM_CREATE_DHCP_ENTRY = "CreateDhcpEntry"
...
class ComputeRackUnitFsm(ManagedObject):
    """This is ComputeRackUnitFsm class."""

    consts = ComputeRackUnitFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("ComputeRackUnitFsm", "computeRackUnitFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'computeRackUnit'], [u'computeRackUnitFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "completion_time": MoPropertyMeta("completion_time", "completionTime", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, """([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", [""], []), 
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["ActivateAdaptor", "ActivateBIOS", "AdapterReset", "Associate", "BiosRecovery", "CimcSessionDelete", "CmosReset", "ConfigBoard", "ConfigSoL", "CreateDhcpEntry", "Decommission", "DiagnosticInterrupt", "Disassociate", "Discover", "EnableCimcSecureBoot", "FlashController", "FwUpgrade", "HardShutdown", "Hardreset", "Offline", "OobStorageAdminConfig", "PowerCap", "Powercycle", "ResetBmc", "ResetIpmi", "ResetKvm", "ResetMemoryErrors", "ServiceInfraDeploy", "ServiceInfraWithdraw", "SoftShutdown", "Softreset", "SwConnUpd", "Turnup", "UnconfigSoL", "UpdateAdaptor", "UpdateBIOS", "UpdateBoardController", "clearTPM", "nop", "updateExtUsers"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "ComputeRackUnitFsm", parent_mo_or_dn, **kwargs)
