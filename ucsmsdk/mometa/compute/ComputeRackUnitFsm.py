...
class ComputeRackUnitFsm(ManagedObject):
    ...
    mo_meta = MoMeta("ComputeRackUnitFsm", "computeRackUnitFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xf, [], [""], ['computeRackUnit'], ['computeRackUnitFsmStage'], [None])
