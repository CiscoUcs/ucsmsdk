...
class ComputePortDiscPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("ComputePortDiscPolicy", "computePortDiscPolicy", "port-discovery", None, "InputOutput", 0x7ff, [], ["admin", "pn-policy"], [u'orgOrg'], [], [None])
    ...
    prop_meta = {
        ...
        "eth_breakout_auto_discovery": MoPropertyMeta("eth_breakout_auto_discovery", "ethBreakoutAutoDiscovery", "string", None, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["disabled", "enabled"], []), 
        "eth_svr_auto_discovery": MoPropertyMeta("eth_svr_auto_discovery", "ethSvrAutoDiscovery", "string", None, MoPropertyMeta.READ_WRITE, 0x20, None, None, None, ["disabled", "enabled"], []), 
        ...
        "qualifier": MoPropertyMeta("qualifier", "qualifier", "string", None, MoPropertyMeta.READ_WRITE, 0x100, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
