...
class ComputeServerMgmtPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("ComputeServerMgmtPolicy", "computeServerMgmtPolicy", "server-mgmt-policy", VersionMeta.Version211a, "InputOutput", 0x7ff, [], ["admin", "pn-policy"], [u'orgOrg'], [], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "link_grouping": MoPropertyMeta("link_grouping", "linkGrouping", "string", None, MoPropertyMeta.READ_WRITE, 0x20, None, None, None, ["none", "port-channel"], []), 
