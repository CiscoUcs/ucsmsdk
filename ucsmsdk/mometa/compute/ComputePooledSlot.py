...
class ComputePooledSlot(ManagedObject):
    ...
    mo_meta = MoMeta("ComputePooledSlot", "computePooledSlot", "blade-[chassis_id]-[slot_id]", VersionMeta.Version101e, "InputOutput", 0x7fL, [], ["admin", "pn-policy"], [u'computePool'], [], ["Add", "Get", "Remove"])
    ...
    prop_meta = {
        ...
        "slot_id": MoPropertyMeta("slot_id", "slotId", "uint", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x20L, None, None, None, [], ["1-8"]), 
