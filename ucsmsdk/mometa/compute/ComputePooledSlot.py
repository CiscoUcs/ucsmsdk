...
class ComputePooledSlot(ManagedObject):
    ...
    mo_meta = MoMeta("ComputePooledSlot", "computePooledSlot", "blade-[chassis_id]-[slot_id]", VersionMeta.Version101e, "InputOutput", 0x3fL, [], ["admin", "pn-policy"], [u'computePool'], [], ["Add", "Get", "Remove"])
    ...
    prop_meta = {
        ...
        "chassis_id": MoPropertyMeta("chassis_id", "chassisId", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x1L, None, None, None, ["N/A"], ["1-255"]), 
        ...
        "slot_id": MoPropertyMeta("slot_id", "slotId", "uint", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x10L, None, None, None, [], ["1-8"]), 
