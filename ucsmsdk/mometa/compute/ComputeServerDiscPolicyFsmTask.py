...
class ComputeServerDiscPolicyFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("ComputeServerDiscPolicyFsmTask", "computeServerDiscPolicyFsmTask", "task-[item]", VersionMeta.Version211a, "OutputOnly", 0xf, [], [""], ['computeServerDiscPolicy'], [], [None])
