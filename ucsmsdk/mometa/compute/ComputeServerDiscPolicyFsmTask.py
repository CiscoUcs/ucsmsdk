"""This module contains the general information for ComputeServerDiscPolicyFsmTask ManagedObject."""
import sys, os
...
class ComputeServerDiscPolicyFsmTaskConsts():
    COMPLETION_CANCELLED = "cancelled"
    COMPLETION_COMPLETED = "completed"
    COMPLETION_PROCESSING = "processing"
    COMPLETION_SCHEDULED = "scheduled"
    ITEM_RESOLVE_SCRUB_POLICY = "ResolveScrubPolicy"
    ITEM_NOP = "nop"


class ComputeServerDiscPolicyFsmTask(ManagedObject):
    """This is ComputeServerDiscPolicyFsmTask class."""

    consts = ComputeServerDiscPolicyFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("ComputeServerDiscPolicyFsmTask", "computeServerDiscPolicyFsmTask", "task-[item]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'computeServerDiscPolicy'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["ResolveScrubPolicy", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "ComputeServerDiscPolicyFsmTask", parent_mo_or_dn, **kwargs)
