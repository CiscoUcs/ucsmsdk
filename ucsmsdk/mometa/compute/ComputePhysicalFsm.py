...
class ComputePhysicalFsm(ManagedObject):
    ...
    mo_meta = MoMeta("ComputePhysicalFsm", "computePhysicalFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xf, [], [""], [u'computeBlade', u'computeRackUnit', u'computeServerUnit'], [u'computePhysicalFsmStage'], [None])
