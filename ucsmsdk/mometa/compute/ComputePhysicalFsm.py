...
class ComputePhysicalFsm(ManagedObject):
    """This is ComputePhysicalFsm class."""

    consts = ComputePhysicalFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("ComputePhysicalFsm", "computePhysicalFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xf, [], [""], ['computeBlade', 'computeRackUnit', 'computeServerUnit'], ['computePhysicalFsmStage'], [None])
