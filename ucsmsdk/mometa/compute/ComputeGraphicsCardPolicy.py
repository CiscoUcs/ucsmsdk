...
class ComputeGraphicsCardPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("ComputeGraphicsCardPolicy", "computeGraphicsCardPolicy", "graphics-card-policy-[name]", None, "InputOutput", 0x1ff, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-equipment", "pn-maintenance", "pn-policy"], [u'orgOrg'], [], [None])
    ...
    prop_meta = {
        ...
        "graphics_card_mode": MoPropertyMeta("graphics_card_mode", "graphicsCardMode", "string", None, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["any-configuration", "compute", "graphics"], []), 
