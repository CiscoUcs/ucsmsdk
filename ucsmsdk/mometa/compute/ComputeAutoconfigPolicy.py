...
class ComputeAutoconfigPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("ComputeAutoconfigPolicy", "computeAutoconfigPolicy", "autoconfig-[name]", VersionMeta.Version101e, "InputOutput", 0x7ff, [], ["admin", "pn-policy"], ['orgOrg'], ['faultInst'], ["Add", "Get", "Remove", "Set"])
