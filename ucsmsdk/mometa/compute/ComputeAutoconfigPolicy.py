...
class ComputeAutoconfigPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("ComputeAutoconfigPolicy", "computeAutoconfigPolicy", "autoconfig-[name]", VersionMeta.Version101e, "InputOutput", 0x7ffL, [], ["admin", "pn-policy"], [u'orgOrg'], [u'faultInst'], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "src_templ_name": MoPropertyMeta("src_templ_name", "srcTemplName", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x200L, None, None, None, [], []), 
