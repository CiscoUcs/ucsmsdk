...
class ComputeAutoconfigPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("ComputeAutoconfigPolicy", "computeAutoconfigPolicy", "autoconfig-[name]", VersionMeta.Version101e, "InputOutput", 0x3ffL, [], ["admin", "pn-policy"], [u'orgOrg'], [u'faultInst'], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "dst_dn": MoPropertyMeta("dst_dn", "dstDn", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x8L, 0, 256, None, [], []), 
        ...
        "src_templ_name": MoPropertyMeta("src_templ_name", "srcTemplName", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x100L, None, None, None, [], []), 
