...
class ComputeServerDiscPolicyConsts():
    ...
    FSM_PREV_RESOLVE_SCRUB_POLICY_BEGIN = "ResolveScrubPolicyBegin"
    FSM_PREV_RESOLVE_SCRUB_POLICY_FAIL = "ResolveScrubPolicyFail"
    FSM_PREV_RESOLVE_SCRUB_POLICY_RESOLVE = "ResolveScrubPolicyResolve"
    FSM_PREV_RESOLVE_SCRUB_POLICY_SUCCESS = "ResolveScrubPolicySuccess"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_RESOLVE_SCRUB_POLICY_BEGIN = "ResolveScrubPolicyBegin"
    FSM_STATUS_RESOLVE_SCRUB_POLICY_FAIL = "ResolveScrubPolicyFail"
    FSM_STATUS_RESOLVE_SCRUB_POLICY_RESOLVE = "ResolveScrubPolicyResolve"
    FSM_STATUS_RESOLVE_SCRUB_POLICY_SUCCESS = "ResolveScrubPolicySuccess"
    FSM_STATUS_NOP = "nop"
    INT_ID_NONE = "none"
...
class ComputeServerDiscPolicy(ManagedObject):
    """This is ComputeServerDiscPolicy class."""

    consts = ComputeServerDiscPolicyConsts()
    naming_props = set([])

    mo_meta = MoMeta("ComputeServerDiscPolicy", "computeServerDiscPolicy", "server-discovery", VersionMeta.Version141i, "InputOutput", 0x3ffL, [], ["admin", "pn-policy"], [u'orgOrg'], [u'computeServerDiscPolicyFsm', u'computeServerDiscPolicyFsmTask', u'eventInst', u'faultInst'], ["Get", "Set"])

    prop_meta = {
        "action": MoPropertyMeta("action", "action", "string", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x1L, None, None, None, ["diag", "immediate", "user-acknowledged"], []), 
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version211a, MoPropertyMeta.INTERNAL, None, None, None, None, ["ResolveScrubPolicyBegin", "ResolveScrubPolicyFail", "ResolveScrubPolicyResolve", "ResolveScrubPolicySuccess", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version211a, MoPropertyMeta.INTERNAL, None, None, None, None, ["ResolveScrubPolicyBegin", "ResolveScrubPolicyFail", "ResolveScrubPolicyResolve", "ResolveScrubPolicySuccess", "nop"], []), 
        ...
        "qualifier": MoPropertyMeta("qualifier", "qualifier", "string", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x40L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        ...
        "scrub_policy_name": MoPropertyMeta("scrub_policy_name", "scrubPolicyName", "string", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x100L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
