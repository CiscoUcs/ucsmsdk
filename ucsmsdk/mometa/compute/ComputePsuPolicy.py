...
class ComputePsuPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("ComputePsuPolicy", "computePsuPolicy", "psu-policy", VersionMeta.Version101e, "InputOutput", 0x3ff, [], ["admin", "pn-equipment", "pn-policy"], ['orgOrg'], [], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "redundancy": MoPropertyMeta("redundancy", "redundancy", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x80, None, None, None, ["grid", "n+1", "n+2", "non-redundant"], []),
