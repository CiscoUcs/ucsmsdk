...
class ComputeInstanceIdQual(ManagedObject):
    ...
    mo_meta = MoMeta("ComputeInstanceIdQual", "computeInstanceIdQual", "inst-from-[min_id]-to-[max_id]", VersionMeta.Version251a, "InputOutput", 0x7fL, [], ["admin", "pn-policy"], [u'computeSlotQual'], [], ["Add", "Get", "Remove"])
    ...
    prop_meta = {
        ...
        "max_id": MoPropertyMeta("max_id", "maxId", "uint", VersionMeta.Version251a, MoPropertyMeta.NAMING, 0x8L, None, None, None, [], ["1-8"]), 
        "min_id": MoPropertyMeta("min_id", "minId", "uint", VersionMeta.Version251a, MoPropertyMeta.NAMING, 0x10L, None, None, None, [], ["1-8"]), 
