...
class ComputeAdminAck(ManagedObject):
    ...
    prop_meta = {
        ...
        "extd_change_details": MoPropertyMeta("extd_change_details", "extdChangeDetails", "string", VersionMeta.Version404a, MoPropertyMeta.READ_ONLY, None, None, None, r"""((defaultValue|persistent-memory-policy|persistent-memory-dimm-fw|host-pack-have-backup-set),){0,3}(defaultValue|persistent-memory-policy|persistent-memory-dimm-fw|host-pack-have-backup-set){0,1}""", [], []),
