...
class ComputePciSlotScanDef(ManagedObject):
    ...
    mo_meta = MoMeta("ComputePciSlotScanDef", "computePciSlotScanDef", "slot-[slot_id]", VersionMeta.Version211a, "InputOutput", 0x1ffL, [], ["read-only"], [u'computePciCap'], [], [None])
    ...
    prop_meta = {
        ...
        "scan_order": MoPropertyMeta("scan_order", "scanOrder", "byte", VersionMeta.Version211a, MoPropertyMeta.READ_WRITE, 0x40L, None, None, None, [], []), 
