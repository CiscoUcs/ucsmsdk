...
class ComputeExtBoard(ManagedObject):
    ...
    prop_meta = {
        ...
        "id": MoPropertyMeta("id", "id", "uint", VersionMeta.Version222c, MoPropertyMeta.NAMING, 0x8L, None, None, None, [], []), 
