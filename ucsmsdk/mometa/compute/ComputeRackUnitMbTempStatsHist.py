...
class ComputeRackUnitMbTempStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("ComputeRackUnitMbTempStatsHist", "computeRackUnitMbTempStatsHist", "[id]", VersionMeta.Version141i, "OutputOnly", 0xfL, [], ["read-only"], [u'computeRackUnitMbTempStats'], [], ["Get"])
