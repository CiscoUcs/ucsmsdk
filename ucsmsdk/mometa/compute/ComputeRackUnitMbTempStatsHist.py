...
class ComputeRackUnitMbTempStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("ComputeRackUnitMbTempStatsHist", "computeRackUnitMbTempStatsHist", "[id]", VersionMeta.Version141i, "OutputOnly", 0xf, [], ["read-only"], ['computeRackUnitMbTempStats'], [], ["Get"])
