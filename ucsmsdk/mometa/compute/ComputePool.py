...
class ComputePool(ManagedObject):
    ...
    mo_meta = MoMeta("ComputePool", "computePool", "compute-pool-[name]", VersionMeta.Version101e, "InputOutput", 0x7fL, [], ["admin", "pn-policy"], [u'orgOrg'], [u'computePooledEnclosureComputeSlot', u'computePooledRackUnit', u'computePooledSlot', u'faultInst'], ["Add", "Get", "Remove", "Set"])
