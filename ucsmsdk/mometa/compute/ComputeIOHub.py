...
class ComputeIOHub(ManagedObject):
    ...
    mo_meta = MoMeta("ComputeIOHub", "computeIOHub", "iohub", VersionMeta.Version131c, "InputOutput", 0x1fL, [], ["read-only"], [u'computeBoard'], [u'computeIOHubEnvStats', u'faultInst'], ["Get"])
