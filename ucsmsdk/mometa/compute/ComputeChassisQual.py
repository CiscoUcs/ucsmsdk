"""This module contains the general information for ComputeChassisQual ManagedObject."""
import sys, os
...
class ComputeChassisQualConsts():
    pass


class ComputeChassisQual(ManagedObject):
    """This is ComputeChassisQual class."""

    consts = ComputeChassisQualConsts()
    naming_props = set([u'minId', u'maxId'])

    mo_meta = MoMeta("ComputeChassisQual", "computeChassisQual", "chassis-from-[min_id]-to-[max_id]", VersionMeta.Version101e, "InputOutput", 0x7fL, [], ["admin", "pn-policy"], [u'computeQual', u'lstorageArrayQual', u'lstorageBackstoreQual'], [u'computeSlotQual'], ["Add", "Get", "Remove"])
    ...
    prop_meta = {
        ...
        "max_id": MoPropertyMeta("max_id", "maxId", "uint", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x8L, None, None, None, [], ["1-255"]), 
        "min_id": MoPropertyMeta("min_id", "minId", "uint", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x10L, None, None, None, [], ["1-255"]), 
    ...
    def __init__(self, parent_mo_or_dn, min_id, max_id, **kwargs):
        ...
        ManagedObject.__init__(self, "ComputeChassisQual", parent_mo_or_dn, **kwargs)
