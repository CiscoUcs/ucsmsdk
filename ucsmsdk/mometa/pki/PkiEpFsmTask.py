"""This module contains the general information for PkiEpFsmTask ManagedObject."""
import sys, os
...
class PkiEpFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("PkiEpFsmTask", "pkiEpFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], [""], [u'pkiEp'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "PkiEpFsmTask", parent_mo_or_dn, **kwargs)
