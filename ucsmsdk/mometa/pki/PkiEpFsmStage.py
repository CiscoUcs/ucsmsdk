...
class PkiEpFsmStageConsts():
    ...
    NAME_UPDATE_EP_POST_SET_KEY_RING_LOCAL = "updateEpPostSetKeyRingLocal"
    NAME_UPDATE_EP_POST_SET_KEY_RING_PEER = "updateEpPostSetKeyRingPeer"
    NAME_UPDATE_EP_SET_KEY_RING_LOCAL = "updateEpSetKeyRingLocal"
    NAME_UPDATE_EP_SET_KEY_RING_PEER = "updateEpSetKeyRingPeer"
...
class PkiEpFsmStage(ManagedObject):
    """This is PkiEpFsmStage class."""

    consts = PkiEpFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("PkiEpFsmStage", "pkiEpFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'pkiEpFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["nop", "updateEpBegin", "updateEpFail", "updateEpPostSetKeyRingLocal", "updateEpPostSetKeyRingPeer", "updateEpSetKeyRingLocal", "updateEpSetKeyRingPeer", "updateEpSuccess"], []), 
