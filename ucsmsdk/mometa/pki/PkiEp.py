...
class PkiEpConsts:
    ...
    FSM_PREV_UPDATE_EP_POST_SET_KEY_RING_LOCAL = "updateEpPostSetKeyRingLocal"
    FSM_PREV_UPDATE_EP_POST_SET_KEY_RING_PEER = "updateEpPostSetKeyRingPeer"
    FSM_PREV_UPDATE_EP_SET_KEY_RING_LOCAL = "updateEpSetKeyRingLocal"
    FSM_PREV_UPDATE_EP_SET_KEY_RING_PEER = "updateEpSetKeyRingPeer"
    ...
    FSM_STATUS_UPDATE_EP_POST_SET_KEY_RING_LOCAL = "updateEpPostSetKeyRingLocal"
    FSM_STATUS_UPDATE_EP_POST_SET_KEY_RING_PEER = "updateEpPostSetKeyRingPeer"
    FSM_STATUS_UPDATE_EP_SET_KEY_RING_LOCAL = "updateEpSetKeyRingLocal"
    FSM_STATUS_UPDATE_EP_SET_KEY_RING_PEER = "updateEpSetKeyRingPeer"
...
class PkiEp(ManagedObject):
    ...
    mo_meta = MoMeta("PkiEp", "pkiEp", "pki-ext", VersionMeta.Version101e, "InputOutput", 0xff, [], ["read-only"], ['topSystem'], ['eventInst', 'faultInst', 'mgmtKmipCertPolicy', 'pkiEpFsm', 'pkiEpFsmTask', 'pkiKeyRing', 'pkiNXOSTpDeletion', 'pkiTP'], ["Get"])
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version101e, MoPropertyMeta.INTERNAL, None, None, None, None, ["nop", "updateEpBegin", "updateEpFail", "updateEpPostSetKeyRingLocal", "updateEpPostSetKeyRingPeer", "updateEpSetKeyRingLocal", "updateEpSetKeyRingPeer", "updateEpSuccess"], []),
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version101e, MoPropertyMeta.INTERNAL, None, None, None, None, ["nop", "updateEpBegin", "updateEpFail", "updateEpPostSetKeyRingLocal", "updateEpPostSetKeyRingPeer", "updateEpSetKeyRingLocal", "updateEpSetKeyRingPeer", "updateEpSuccess"], []),
