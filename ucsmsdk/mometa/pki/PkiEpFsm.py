"""This module contains the general information for PkiEpFsm ManagedObject."""
import sys, os
...
class PkiEpFsm(ManagedObject):
    """This is PkiEpFsm class."""

    consts = PkiEpFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("PkiEpFsm", "pkiEpFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'pkiEp'], [u'pkiEpFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "PkiEpFsm", parent_mo_or_dn, **kwargs)
