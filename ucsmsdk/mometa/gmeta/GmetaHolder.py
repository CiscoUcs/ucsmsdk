...
class GmetaHolder(ManagedObject):
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version212a, MoPropertyMeta.INTERNAL, None, None, None, None, ["InventoryBegin", "InventoryBeginInventory", "InventoryCheckInventoryStatus", "InventoryEndInventory", "InventoryFail", "InventoryFullInventory", "InventoryReportFaultInventory", "InventoryReportOrgInventory", "InventoryReportPhysicalInventory", "InventoryReportStorageInventory", "InventorySuccess", "nop"], []),
