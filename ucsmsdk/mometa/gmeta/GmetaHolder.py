...
class GmetaHolderConsts():
    ...
    FSM_PREV_INVENTORY_BEGIN_INVENTORY = "InventoryBeginInventory"
    FSM_PREV_INVENTORY_CHECK_INVENTORY_STATUS = "InventoryCheckInventoryStatus"
    FSM_PREV_INVENTORY_END_INVENTORY = "InventoryEndInventory"
    FSM_PREV_INVENTORY_FAIL = "InventoryFail"
    FSM_PREV_INVENTORY_FULL_INVENTORY = "InventoryFullInventory"
    FSM_PREV_INVENTORY_REPORT_FAULT_INVENTORY = "InventoryReportFaultInventory"
    FSM_PREV_INVENTORY_REPORT_FULL_INVENTORY = "InventoryReportFullInventory"
    FSM_PREV_INVENTORY_REPORT_ORG_INVENTORY = "InventoryReportOrgInventory"
    FSM_PREV_INVENTORY_REPORT_PHYSICAL_INVENTORY = "InventoryReportPhysicalInventory"
    FSM_PREV_INVENTORY_REPORT_STORAGE_INVENTORY = "InventoryReportStorageInventory"
    FSM_PREV_INVENTORY_SUCCESS = "InventorySuccess"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_INVENTORY_BEGIN = "InventoryBegin"
    FSM_STATUS_INVENTORY_BEGIN_INVENTORY = "InventoryBeginInventory"
    FSM_STATUS_INVENTORY_CHECK_INVENTORY_STATUS = "InventoryCheckInventoryStatus"
    FSM_STATUS_INVENTORY_END_INVENTORY = "InventoryEndInventory"
    FSM_STATUS_INVENTORY_FAIL = "InventoryFail"
    FSM_STATUS_INVENTORY_FULL_INVENTORY = "InventoryFullInventory"
    FSM_STATUS_INVENTORY_REPORT_FAULT_INVENTORY = "InventoryReportFaultInventory"
    FSM_STATUS_INVENTORY_REPORT_FULL_INVENTORY = "InventoryReportFullInventory"
    FSM_STATUS_INVENTORY_REPORT_ORG_INVENTORY = "InventoryReportOrgInventory"
    FSM_STATUS_INVENTORY_REPORT_PHYSICAL_INVENTORY = "InventoryReportPhysicalInventory"
    FSM_STATUS_INVENTORY_REPORT_STORAGE_INVENTORY = "InventoryReportStorageInventory"
    FSM_STATUS_INVENTORY_SUCCESS = "InventorySuccess"
    FSM_STATUS_NOP = "nop"
    INVENTORY_STATUS_INV_DISABLE = "INV_DISABLE"
    INVENTORY_STATUS_INV_ENABLE = "INV_ENABLE"
    INVENTORY_STATUS_INV_STOP = "INV_STOP"
    INVENTORY_STATUS_INV_THROTTLED = "INV_THROTTLED"
    INVENTORY_VERSION_NEXTGEN = "nextgen"
    INVENTORY_VERSION_UNKNOWN = "unknown"
    POLL_INTERVAL_10MIN = "10min"
    POLL_INTERVAL_15MIN = "15min"
    POLL_INTERVAL_1MIN = "1min"
    POLL_INTERVAL_2MIN = "2min"
    POLL_INTERVAL_30MIN = "30min"
    POLL_INTERVAL_5MIN = "5min"
    POLL_INTERVAL_NEVER = "never"
    PROVIDER_APE = "ape"
    PROVIDER_BOOT_MGR = "boot-mgr"
    PROVIDER_CENTRAL_MGR = "central-mgr"
    PROVIDER_IDENTIFIER_MGR = "identifier-mgr"
    PROVIDER_MANAGED_ENDPOINT = "managed-endpoint"
    PROVIDER_MGMT_CONTROLLER = "mgmt-controller"
    PROVIDER_OPERATION_MGR = "operation-mgr"
    PROVIDER_POLICY_MGR = "policy-mgr"
    PROVIDER_RESOURCE_AGGR = "resource-aggr"
    PROVIDER_RESOURCE_MGR = "resource-mgr"
    PROVIDER_SERVICE_REG = "service-reg"
    PROVIDER_STATS_MGR = "stats-mgr"
    PROVIDER_STORAGE_BROKER = "storage-broker"
    PROVIDER_VIRTUAL_SWITCHING_MGR = "virtual-switching-mgr"
    PROVIDER_VM_MGR = "vm-mgr"
...
class GmetaHolder(ManagedObject):
    ...
    mo_meta = MoMeta("GmetaHolder", "gmetaHolder", "category-[category]-provider-[provider]", VersionMeta.Version212a, "InputOutput", 0x7fL, [], ["admin"], [u'gmetaEp'], [u'eventInst', u'faultInst', u'gmetaClass', u'gmetaHolderFsm', u'gmetaHolderFsmTask'], [None])

    prop_meta = {
        "category": MoPropertyMeta("category", "category", "string", VersionMeta.Version212a, MoPropertyMeta.NAMING, 0x1L, None, None, None, ["inventory", "unknown"], []), 
        ...
        "fsm_flags": MoPropertyMeta("fsm_flags", "fsmFlags", "string", VersionMeta.Version212a, MoPropertyMeta.INTERNAL, None, None, None, None, [], ["0-4294967295"]), 
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version212a, MoPropertyMeta.INTERNAL, None, None, None, None, ["InventoryBegin", "InventoryBeginInventory", "InventoryCheckInventoryStatus", "InventoryEndInventory", "InventoryFail", "InventoryFullInventory", "InventoryReportFaultInventory", "InventoryReportFullInventory", "InventoryReportOrgInventory", "InventoryReportPhysicalInventory", "InventoryReportStorageInventory", "InventorySuccess", "nop"], []), 
        ...
        "inventory_status": MoPropertyMeta("inventory_status", "inventoryStatus", "string", VersionMeta.Version212a, MoPropertyMeta.READ_WRITE, 0x8L, None, None, None, ["INV_DISABLE", "INV_ENABLE", "INV_STOP", "INV_THROTTLED"], []), 
        ...
        "provider": MoPropertyMeta("provider", "provider", "string", VersionMeta.Version212a, MoPropertyMeta.NAMING, 0x10L, None, None, None, ["ape", "boot-mgr", "central-mgr", "identifier-mgr", "managed-endpoint", "mgmt-controller", "operation-mgr", "policy-mgr", "resource-aggr", "resource-mgr", "service-reg", "stats-mgr", "storage-broker", "virtual-switching-mgr", "vm-mgr"], []), 
        "rn": MoPropertyMeta("rn", "rn", "string", VersionMeta.Version212a, MoPropertyMeta.READ_ONLY, 0x20L, 0, 256, None, [], []), 
        "sacl": MoPropertyMeta("sacl", "sacl", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, """((none|del|mod|addchild|cascade),){0,4}(none|del|mod|addchild|cascade){0,1}""", [], []), 
        "status": MoPropertyMeta("status", "status", "string", VersionMeta.Version212a, MoPropertyMeta.READ_WRITE, 0x40L, None, None, """((removed|created|modified|deleted),){0,3}(removed|created|modified|deleted){0,1}""", [], []), 
    }
    ...
    def __init__(self, parent_mo_or_dn, category, provider, **kwargs):
        self._dirty_mask = 0
