...
class GmetaPolicyMapHolder(ManagedObject):
    ...
    mo_meta = MoMeta("GmetaPolicyMapHolder", "gmetaPolicyMapHolder", "policymapholder", VersionMeta.Version212a, "InputOutput", 0xfL, [], ["read-only"], [u'gmetaEp'], [u'gmetaPolicyMapElement'], [None])
