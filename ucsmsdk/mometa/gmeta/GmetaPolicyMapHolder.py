...
class GmetaPolicyMapHolder(ManagedObject):
    ...
    mo_meta = MoMeta("GmetaPolicyMapHolder", "gmetaPolicyMapHolder", "policymapholder", VersionMeta.Version212a, "InputOutput", 0x1f, [], ["read-only"], ['gmetaEp'], ['gmetaPolicyMapElement'], [None])
