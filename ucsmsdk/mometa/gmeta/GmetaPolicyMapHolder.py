"""This module contains the general information for GmetaPolicyMapHolder ManagedObject."""
import sys, os
...
class GmetaPolicyMapHolderConsts():
    pass


class GmetaPolicyMapHolder(ManagedObject):
    """This is GmetaPolicyMapHolder class."""

    consts = GmetaPolicyMapHolderConsts()
    naming_props = set([])

    mo_meta = MoMeta("GmetaPolicyMapHolder", "gmetaPolicyMapHolder", "policymapholder", VersionMeta.Version212a, "InputOutput", 0x1fL, [], ["read-only"], [u'gmetaEp'], [u'gmetaPolicyMapElement'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "GmetaPolicyMapHolder", parent_mo_or_dn, **kwargs)
