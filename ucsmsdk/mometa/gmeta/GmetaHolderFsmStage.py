...
class GmetaHolderFsmStageConsts():
    ...
    NAME_INVENTORY_REPORT_FULL_INVENTORY = "InventoryReportFullInventory"
...
class GmetaHolderFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("GmetaHolderFsmStage", "gmetaHolderFsmStage", "stage-[name]", VersionMeta.Version212a, "OutputOnly", 0x7L, [], [""], [u'gmetaHolderFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version212a, MoPropertyMeta.NAMING, None, None, None, None, ["InventoryBegin", "InventoryBeginInventory", "InventoryCheckInventoryStatus", "InventoryEndInventory", "InventoryFail", "InventoryFullInventory", "InventoryReportFaultInventory", "InventoryReportFullInventory", "InventoryReportOrgInventory", "InventoryReportPhysicalInventory", "InventoryReportStorageInventory", "InventorySuccess", "nop"], []), 
