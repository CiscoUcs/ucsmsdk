...
class GmetaClassConsts():
    ...
    EP_CLASS_ID_EQUIPMENT_AUTO_NEGOTIATE_CAP = "equipmentAutoNegotiateCap"
...
class GmetaClass(ManagedObject):
    ...
    mo_meta = MoMeta("GmetaClass", "gmetaClass", "class-[id]", VersionMeta.Version212a, "InputOutput", 0x7fL, [], ["admin"], [u'gmetaHolder'], [u'gmetaProp'], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version212a, MoPropertyMeta.CREATE_ONLY, 0x10L, 0, 510, None, [], []), 
