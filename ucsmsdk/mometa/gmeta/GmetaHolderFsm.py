"""This module contains the general information for GmetaHolderFsm ManagedObject."""
import sys, os
...
class GmetaHolderFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_INVENTORY = "Inventory"
    CURRENT_FSM_NOP = "nop"
...
class GmetaHolderFsm(ManagedObject):
    """This is GmetaHolderFsm class."""

    consts = GmetaHolderFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("GmetaHolderFsm", "gmetaHolderFsm", "fsm", VersionMeta.Version212a, "OutputOnly", 0x7L, [], [""], [u'gmetaHolder'], [u'gmetaHolderFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version212a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Inventory", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "GmetaHolderFsm", parent_mo_or_dn, **kwargs)
