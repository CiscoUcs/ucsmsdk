"""This module contains the general information for EquipmentBeaconLedFsm ManagedObject."""
import sys, os
...
class EquipmentBeaconLedFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_ILLUMINATE = "Illuminate"
    CURRENT_FSM_NOP = "nop"
...
class EquipmentBeaconLedFsm(ManagedObject):
    """This is EquipmentBeaconLedFsm class."""

    consts = EquipmentBeaconLedFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("EquipmentBeaconLedFsm", "equipmentBeaconLedFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'equipmentBeaconLed'], [u'equipmentBeaconLedFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Illuminate", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentBeaconLedFsm", parent_mo_or_dn, **kwargs)
