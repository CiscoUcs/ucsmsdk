...
class EquipmentBeaconLedFsm(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentBeaconLedFsm", "equipmentBeaconLedFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'equipmentBeaconLed'], [u'equipmentBeaconLedFsmStage'], [None])
