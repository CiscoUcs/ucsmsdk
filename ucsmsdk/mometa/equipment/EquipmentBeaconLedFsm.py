...
class EquipmentBeaconLedFsm(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentBeaconLedFsm", "equipmentBeaconLedFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xf, [], [""], [u'equipmentBeaconLed'], [u'equipmentBeaconLedFsmStage'], [None])
