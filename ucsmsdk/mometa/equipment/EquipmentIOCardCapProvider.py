"""This module contains the general information for EquipmentIOCardCapProvider ManagedObject."""
import sys, os
...
class EquipmentIOCardCapProviderConsts():
    DELETED_FALSE = "false"
    DELETED_NO = "no"
    DELETED_TRUE = "true"
    DELETED_YES = "yes"
...
class EquipmentIOCardCapProvider(ManagedObject):
    """This is EquipmentIOCardCapProvider class."""

    consts = EquipmentIOCardCapProviderConsts()
    naming_props = set([u'vendor', u'model', u'revision'])

    mo_meta = MoMeta("EquipmentIOCardCapProvider", "equipmentIOCardCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version101e, "InputOutput", 0xffL, [], [""], [u'capabilityCatalogue'], [u'equipmentIOCardTypeDef', u'equipmentManufacturingDef', u'equipmentPhysicalDef', u'equipmentPicture', u'equipmentPortGroupAggregationDef', u'equipmentPortGroupDef', u'equipmentServiceDef', u'equipmentSlotArrayRef', u'firmwareType', u'firmwareUpgradeConstraint'], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, vendor, model, revision, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentIOCardCapProvider", parent_mo_or_dn, **kwargs)
