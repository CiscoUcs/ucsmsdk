...
class EquipmentFexCapProvider(ManagedObject):
    ...
    prop_meta = {
        ...
        "role": MoPropertyMeta("role", "role", "string", VersionMeta.Version201m, MoPropertyMeta.READ_WRITE, 0x80L, None, None, None, ["data", "full", "mgmt"], []), 
        ...
        "vendor": MoPropertyMeta("vendor", "vendor", "string", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x200L, 1, 510, None, [], []), 
    }
