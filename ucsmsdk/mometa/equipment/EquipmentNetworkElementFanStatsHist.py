...
class EquipmentNetworkElementFanStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentNetworkElementFanStatsHist", "equipmentNetworkElementFanStatsHist", "[id]", VersionMeta.Version201m, "OutputOnly", 0xfL, [], ["read-only"], [u'equipmentNetworkElementFanStats'], [], ["Get"])
