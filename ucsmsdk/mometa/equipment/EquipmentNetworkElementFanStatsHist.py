...
class EquipmentNetworkElementFanStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentNetworkElementFanStatsHist", "equipmentNetworkElementFanStatsHist", "[id]", VersionMeta.Version201m, "OutputOnly", 0x7L, [], ["read-only"], [u'equipmentNetworkElementFanStats'], [], ["Get"])
