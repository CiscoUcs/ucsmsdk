"""This module contains the general information for EquipmentSwitchTypeDef ManagedObject."""
...
class EquipmentSwitchTypeDefConsts:
    INT_ID_NONE = "none"
...
class EquipmentSwitchTypeDef(ManagedObject):
    """This is EquipmentSwitchTypeDef class."""

    consts = EquipmentSwitchTypeDefConsts()
    naming_props = set([])

    mo_meta = MoMeta("EquipmentSwitchTypeDef", "equipmentSwitchTypeDef", "type", VersionMeta.Version302a, "InputOutput", 0xff, [], [""], [], [], [None])
    ...
    prop_meta = {
        ...
        "policy_owner": MoPropertyMeta("policy_owner", "policyOwner", "string", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x20, None, None, None, ["local", "pending-policy", "policy"], []), 
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
    }
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentSwitchTypeDef", parent_mo_or_dn, **kwargs)
