...
class EquipmentSwitchTypeDef(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentSwitchTypeDef", "equipmentSwitchTypeDef", "type", VersionMeta.Version302c, "InputOutput", 0xffL, [], [""], [], [], [None])
    ...
    prop_meta = {
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version302c, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
    }
