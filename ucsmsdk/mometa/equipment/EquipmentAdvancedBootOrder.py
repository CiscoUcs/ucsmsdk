...
class EquipmentAdvancedBootOrder(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentAdvancedBootOrder", "equipmentAdvancedBootOrder", "advbootordsupp-[is_supported]", VersionMeta.Version221b, "InputOutput", 0x1ffL, [], [""], [u'equipmentBladeCapProvider', u'equipmentRackUnitCapProvider'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "is_supported": MoPropertyMeta("is_supported", "isSupported", "string", VersionMeta.Version221b, MoPropertyMeta.NAMING, 0x10L, None, None, None, ["false", "no", "true", "yes"], []), 
