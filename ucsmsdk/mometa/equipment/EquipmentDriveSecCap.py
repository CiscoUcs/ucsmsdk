...
class EquipmentDriveSecCap(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentDriveSecCap", "equipmentDriveSecCap", "drive-sec-cap", None, "InputOutput", 0x1f, [], ["read-only"], [u'equipmentBladeCapProvider', u'equipmentLocalDiskCapProvider', u'equipmentLocalDiskControllerCapProvider', u'equipmentRackUnitCapProvider'], [], [None])
    ...
    prop_meta = {
        ...
        "min_version": MoPropertyMeta("min_version", "minVersion", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
