...
class EquipmentBiosDef(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentBiosDef", "equipmentBiosDef", "bios-def", VersionMeta.Version202m, "InputOutput", 0x7fL, [], [""], [u'equipmentBladeCapProvider', u'equipmentRackUnitCapProvider', u'equipmentServerUnitCapProvider'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "tpm_config_support": MoPropertyMeta("tpm_config_support", "tpmConfigSupport", "string", VersionMeta.Version224a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Supported", "Unsupported"], []), 
