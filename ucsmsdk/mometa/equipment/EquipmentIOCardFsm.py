...
class EquipmentIOCardFsmConsts():
    ...
    CURRENT_FSM_RESET_PEER_CMC = "ResetPeerCmc"
...
class EquipmentIOCardFsm(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentIOCardFsm", "equipmentIOCardFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'equipmentIOCard'], [u'equipmentIOCardFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Evacuate", "FeConn", "FePresence", "ResetCmc", "ResetEvacuate", "ResetIom", "ResetPeerCmc", "muxOffline", "nop"], []), 
