"""This module contains the general information for EquipmentIOCardFsm ManagedObject."""
import sys, os
...
class EquipmentIOCardFsmConsts():
    COMPLETION_TIME_ = ""
    ...
    CURRENT_FSM_RESET_IOM = "ResetIom"
    CURRENT_FSM_MUX_OFFLINE = "muxOffline"
    CURRENT_FSM_NOP = "nop"
...
class EquipmentIOCardFsm(ManagedObject):
    """This is EquipmentIOCardFsm class."""

    consts = EquipmentIOCardFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("EquipmentIOCardFsm", "equipmentIOCardFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'equipmentIOCard'], [u'equipmentIOCardFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Evacuate", "FeConn", "FePresence", "ResetCmc", "ResetEvacuate", "ResetIom", "muxOffline", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentIOCardFsm", parent_mo_or_dn, **kwargs)
