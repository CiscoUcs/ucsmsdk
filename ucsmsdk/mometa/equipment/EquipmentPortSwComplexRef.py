...
class EquipmentPortSwComplexRef(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentPortSwComplexRef", "equipmentPortSwComplexRef", "port-sw-complex-ref-[sw_complex_id]", VersionMeta.Version201m, "InputOutput", 0x1ffL, [], [""], [u'equipmentPortGroupSwComplexDef'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "sw_complex_id": MoPropertyMeta("sw_complex_id", "swComplexId", "ushort", VersionMeta.Version201m, MoPropertyMeta.NAMING, 0x100L, None, None, None, [], []), 
    }
