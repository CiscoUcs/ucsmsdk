...
class EquipmentHwRevisionModifier(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentHwRevisionModifier", "equipmentHwRevisionModifier", "hw-rev-modifier-[hw_type]", VersionMeta.Version911z, "InputOutput", 0x3f, [], [""], [u'equipmentBladeCapProvider', u'equipmentRackUnitCapProvider'], [], [None])
    ...
    prop_meta = {
        ...
        "hw_type": MoPropertyMeta("hw_type", "hwType", "string", VersionMeta.Version911z, MoPropertyMeta.NAMING, 0x8, None, None, None, ["local-disk", "storage-controller"], []), 
