...
class EquipmentChassisFsm(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentChassisFsm", "equipmentChassisFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'equipmentChassis'], [u'equipmentChassisFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["DynamicReallocation", "OobStorageAdminCfg", "PowerCap", "PsuPolicyConfig", "RemoveChassis", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentChassisFsm", parent_mo_or_dn, **kwargs)
