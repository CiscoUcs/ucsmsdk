...
class EquipmentComputeConnPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentComputeConnPolicy", "equipmentComputeConnPolicy", "compute-conn-policy-[name]", None, "InputOutput", 0x1ff, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'orgOrg'], [], [None])
    ...
    prop_meta = {
        ...
        "server_sioc_connectivity": MoPropertyMeta("server_sioc_connectivity", "serverSiocConnectivity", "string", None, MoPropertyMeta.READ_WRITE, 0x80, None, None, None, ["single-server-dual-sioc", "single-server-single-sioc"], []), 
