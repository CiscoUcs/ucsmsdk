...
class EquipmentSwitchIOCardFsm(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentSwitchIOCardFsm", "equipmentSwitchIOCardFsm", "fsm", VersionMeta.Version302a, "OutputOnly", 0x7L, [], [""], [u'equipmentSwitchIOCard'], [u'equipmentSwitchIOCardFsmStage'], [None])
