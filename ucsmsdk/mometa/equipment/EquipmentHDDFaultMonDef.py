...
class EquipmentHDDFaultMonDef(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentHDDFaultMonDef", "equipmentHDDFaultMonDef", "[controller_fw_version][hdd_mon_support]", VersionMeta.Version201m, "InputOutput", 0x3ffL, [], [""], [u'equipmentBladeCapProvider', u'equipmentServerUnitCapProvider'], [], ["Get"])

    prop_meta = {
        "controller_fw_version": MoPropertyMeta("controller_fw_version", "ControllerFwVersion", "string", VersionMeta.Version201m, MoPropertyMeta.NAMING, 0x2L, 1, 510, None, [], []), 
        ...
        "hdd_mon_support": MoPropertyMeta("hdd_mon_support", "HDDMonSupport", "string", VersionMeta.Version201m, MoPropertyMeta.NAMING, 0x4L, 1, 510, None, [], []), 
