...
class EquipmentPciSlotIdEntry(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentPciSlotIdEntry", "equipmentPciSlotIdEntry", "pci-slotid-entry-[name]", VersionMeta.Version312b, "InputOutput", 0x3f, [], [""], ['equipmentPciSlotIdMapping'], [], ["Get"])
