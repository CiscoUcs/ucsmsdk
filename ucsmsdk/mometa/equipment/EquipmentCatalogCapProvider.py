...
class EquipmentCatalogCapProvider(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentCatalogCapProvider", "equipmentCatalogCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version131c, "InputOutput", 0x1ffL, [], [""], [u'capabilityCatalogue'], [u'equipmentManufacturingDef', u'equipmentPhysicalDef', u'equipmentPicture', u'equipmentServiceDef', u'equipmentSlotArray', u'equipmentSlotArrayRef', u'equipmentStorageControllerConfig', u'firmwareConstraints', u'firmwareType', u'firmwareUpgradeConstraint'], ["Get"])
    ...
    prop_meta = {
        ...
        "revision": MoPropertyMeta("revision", "revision", "string", VersionMeta.Version131c, MoPropertyMeta.NAMING, 0x20L, 1, 510, None, [], []), 
        ...
        "vendor": MoPropertyMeta("vendor", "vendor", "string", VersionMeta.Version131c, MoPropertyMeta.NAMING, 0x100L, 1, 510, None, [], []), 
    }
