...
class EquipmentSwitchCapProvider(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentSwitchCapProvider", "equipmentSwitchCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version101e, "InputOutput", 0x1ff, [], [""], ['capabilityCatalogue', 'equipmentHwCapDerivativeProvider'], ['equipmentBeaconCapProvider', 'equipmentBreakoutCap', 'equipmentEmbeddedControllerConfig', 'equipmentFirmwareUpdateRestriction', 'equipmentFruVariant', 'equipmentMacSecCap', 'equipmentManufacturingDef', 'equipmentNonCopperPassiveCap', 'equipmentPfcMmuCap', 'equipmentPhysicalDef', 'equipmentPicture', 'equipmentPortGroupAggregationDef', 'equipmentPortGroupSwComplexDef', 'equipmentServiceDef', 'equipmentSlotArray', 'equipmentSlotArrayRef', 'equipmentSpeedCompatibility', 'equipmentStorageControllerConfig', 'equipmentSwitchCap', 'equipmentUnifiedPortCapProvider', 'firmwareConstraints', 'firmwareType', 'firmwareUpgradeConstraint'], ["Get"])
