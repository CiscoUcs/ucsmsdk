"""This module contains the general information for EquipmentGemCapProvider ManagedObject."""
import sys, os
...
class EquipmentGemCapProviderConsts():
    DELETED_FALSE = "false"
    DELETED_NO = "no"
    DELETED_TRUE = "true"
    DELETED_YES = "yes"
...
class EquipmentGemCapProvider(ManagedObject):
    ...
    def __init__(self, parent_mo_or_dn, vendor, model, revision, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentGemCapProvider", parent_mo_or_dn, **kwargs)
