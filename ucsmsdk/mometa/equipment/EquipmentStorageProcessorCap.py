...
class EquipmentStorageProcessorCap(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentStorageProcessorCap", "equipmentStorageProcessorCap", "storage-proc-cap", VersionMeta.Version302a, "InputOutput", 0xfL, [], ["read-only"], [u'equipmentBladeCapProvider', u'equipmentRackUnitCapProvider'], [u'equipmentImpliedStorageEnclosureDef', u'equipmentStorageProviderDriverLibrary'], [None])
    ...
    prop_meta = {
        ...
        "virtualized_ce_supported": MoPropertyMeta("virtualized_ce_supported", "virtualizedCESupported", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["false", "no", "true", "yes"], []), 
    }
