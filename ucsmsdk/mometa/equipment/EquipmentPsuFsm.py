...
class EquipmentPsuFsm(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentPsuFsm", "equipmentPsuFsm", "fsm", VersionMeta.Version302c, "OutputOnly", 0xfL, [], [""], [u'equipmentPsu'], [u'equipmentPsuFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version302c, MoPropertyMeta.READ_ONLY, None, None, None, None, ["UpdatePSU", "nop"], []), 
