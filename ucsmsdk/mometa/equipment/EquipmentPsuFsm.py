"""This module contains the general information for EquipmentPsuFsm ManagedObject."""
...
class EquipmentPsuFsmConsts:
    COMPLETION_TIME_ = ""
    CURRENT_FSM_UPDATE_PSU = "UpdatePSU"
    CURRENT_FSM_NOP = "nop"
...
class EquipmentPsuFsm(ManagedObject):
    """This is EquipmentPsuFsm class."""

    consts = EquipmentPsuFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("EquipmentPsuFsm", "equipmentPsuFsm", "fsm", VersionMeta.Version302a, "OutputOnly", 0xf, [], [""], [u'equipmentPsu'], [u'equipmentPsuFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["UpdatePSU", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentPsuFsm", parent_mo_or_dn, **kwargs)
