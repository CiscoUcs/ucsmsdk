"""This module contains the general information for EquipmentLocalDiskCapProvider ManagedObject."""
import sys, os
...
class EquipmentLocalDiskCapProviderConsts():
    DELETED_FALSE = "false"
    DELETED_NO = "no"
    DELETED_TRUE = "true"
    DELETED_YES = "yes"
...
class EquipmentLocalDiskCapProvider(ManagedObject):
    """This is EquipmentLocalDiskCapProvider class."""

    consts = EquipmentLocalDiskCapProviderConsts()
    naming_props = set([u'vendor', u'model', u'revision'])

    mo_meta = MoMeta("EquipmentLocalDiskCapProvider", "equipmentLocalDiskCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version101e, "InputOutput", 0xffL, [], [""], [u'capabilityCatalogue'], [u'equipmentLocalDiskDef', u'equipmentManufacturingDef', u'equipmentPhysicalDef', u'equipmentPicture', u'equipmentServiceDef', u'equipmentSlotArrayRef', u'firmwareType', u'firmwareUpgradeConstraint'], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, vendor, model, revision, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentLocalDiskCapProvider", parent_mo_or_dn, **kwargs)
