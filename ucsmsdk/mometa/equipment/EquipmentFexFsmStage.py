"""This module contains the general information for EquipmentFexFsmStage ManagedObject."""
import sys, os
...
class EquipmentFexFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_REMOVE_FEX_BEGIN = "RemoveFexBegin"
    NAME_REMOVE_FEX_CLEAN_UP_VIFS = "RemoveFexCleanUpVIfs"
    NAME_REMOVE_FEX_CLEANUP_ENTRIES = "RemoveFexCleanupEntries"
    NAME_REMOVE_FEX_DECOMISSION = "RemoveFexDecomission"
    NAME_REMOVE_FEX_FAIL = "RemoveFexFail"
    NAME_REMOVE_FEX_SUCCESS = "RemoveFexSuccess"
    NAME_REMOVE_FEX_UN_IDENTIFY_LOCAL = "RemoveFexUnIdentifyLocal"
    NAME_REMOVE_FEX_WAIT = "RemoveFexWait"
    NAME_NOP = "nop"
...
class EquipmentFexFsmStage(ManagedObject):
    """This is EquipmentFexFsmStage class."""

    consts = EquipmentFexFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("EquipmentFexFsmStage", "equipmentFexFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'equipmentFexFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["RemoveFexBegin", "RemoveFexCleanUpVIfs", "RemoveFexCleanupEntries", "RemoveFexDecomission", "RemoveFexFail", "RemoveFexSuccess", "RemoveFexUnIdentifyLocal", "RemoveFexWait", "nop"], []), 
