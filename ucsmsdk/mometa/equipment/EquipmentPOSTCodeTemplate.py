...
class EquipmentPOSTCodeTemplate(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentPOSTCodeTemplate", "equipmentPOSTCodeTemplate", "POST-[name]", VersionMeta.Version141i, "InputOutput", 0x1fL, [], ["read-only"], [u'capabilityCatalogue'], [u'equipmentPOSTCode'], ["Get"])
