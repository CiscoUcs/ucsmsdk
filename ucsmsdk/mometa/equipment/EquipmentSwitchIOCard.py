...
class EquipmentSwitchIOCard(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentSwitchIOCard", "equipmentSwitchIOCard", "sw-slot-[id]", VersionMeta.Version302c, "InputOutput", 0x3ffL, [], ["admin", "ls-network", "ls-network-policy", "pn-equipment", "pn-maintenance", "pn-policy"], [u'equipmentChassis'], [u'equipmentIOCardBaseFsm', u'equipmentIOCardBaseFsmTask', u'equipmentIOCardStats', u'equipmentSwitchIOCardFsm', u'equipmentSwitchIOCardFsmTask', u'eventInst', u'faultInst', u'mgmtController', u'portGroup'], [None])

    prop_meta = {
        "admin_peer_power_state": MoPropertyMeta("admin_peer_power_state", "adminPeerPowerState", "string", None, MoPropertyMeta.READ_WRITE, 0x2L, None, None, None, ["cycle-immediate", "cycle-wait", "policy"], []), 
        "admin_power_state": MoPropertyMeta("admin_power_state", "adminPowerState", "string", VersionMeta.Version302c, MoPropertyMeta.READ_WRITE, 0x4L, None, None, None, ["cycle-immediate", "cycle-wait", "policy"], []), 
        "admin_state": MoPropertyMeta("admin_state", "adminState", "string", None, MoPropertyMeta.READ_WRITE, 0x8L, None, None, None, ["acknowledged", "auto-acknowledge", "decommission", "disable-port-channel", "enable-port-channel", "re-acknowledge", "remove"], []), 
        ...
        "id": MoPropertyMeta("id", "id", "uint", VersionMeta.Version302c, MoPropertyMeta.NAMING, 0x40L, None, None, None, [], ["1-2"]), 
        ...
        "oper_evac_state": MoPropertyMeta("oper_evac_state", "operEvacState", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["drain", "fill", "unknown"], []), 
        ...
        "part_number": MoPropertyMeta("part_number", "partNumber", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        ...
        "usr_lbl": MoPropertyMeta("usr_lbl", "usrLbl", "string", VersionMeta.Version302c, MoPropertyMeta.READ_WRITE, 0x200L, None, None, r"""[ !#$%&\(\)\*\+,\-\./:;\?@\[\]_\{\|\}~a-zA-Z0-9]{0,32}""", [], []), 
        "vendor": MoPropertyMeta("vendor", "vendor", "string", VersionMeta.Version302c, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        "vid": MoPropertyMeta("vid", "vid", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
