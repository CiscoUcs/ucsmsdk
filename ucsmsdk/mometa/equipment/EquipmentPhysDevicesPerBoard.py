...
class EquipmentPhysDevicesPerBoard(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentPhysDevicesPerBoard", "equipmentPhysDevicesPerBoard", "phys-dev-per-board", VersionMeta.Version222c, "InputOutput", 0x3ff, [], [""], [u'equipmentBladeAggregationCapRef'], [], ["Get"])
