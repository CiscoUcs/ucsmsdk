...
class EquipmentGraphicsCardCapProvider(ManagedObject):
    ...
    prop_meta = {
        ...
        "prom_card_type": MoPropertyMeta("prom_card_type", "promCardType", "ushort", VersionMeta.Version213a, MoPropertyMeta.READ_WRITE, 0x8L, None, None, None, [], []), 
        ...
        "status": MoPropertyMeta("status", "status", "string", VersionMeta.Version213a, MoPropertyMeta.READ_WRITE, 0x40L, None, None, """((removed|created|modified|deleted),){0,3}(removed|created|modified|deleted){0,1}""", [], []), 
