...
class EquipmentPicture(ManagedObject):
    ...
    prop_meta = {
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x10L, None, None, None, ["back", "bottom", "front", "front-bottom-scaled", "front-top-scaled", "left", "right", "top", "top-scaled", "unknown"], []), 
    }
