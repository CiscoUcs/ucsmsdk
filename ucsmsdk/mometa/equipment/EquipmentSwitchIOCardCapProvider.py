...
class EquipmentSwitchIOCardCapProvider(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentSwitchIOCardCapProvider", "equipmentSwitchIOCardCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version302a, "InputOutput", 0xffL, [], [""], [u'capabilityCatalogue'], [u'equipmentBeaconCapProvider', u'equipmentIOCardTypeDef', u'equipmentManufacturingDef', u'equipmentPhysicalDef', u'equipmentPicture', u'equipmentPortCap', u'equipmentPortGroupAggregationDef', u'equipmentPortGroupDef', u'equipmentServiceDef', u'equipmentSlotArrayRef', u'equipmentSwitchCap', u'equipmentUnifiedPortCapProvider', u'firmwareType', u'firmwareUpgradeConstraint'], [None])
    ...
    prop_meta = {
        ...
        "prom_card_type": MoPropertyMeta("prom_card_type", "promCardType", "ushort", VersionMeta.Version302a, MoPropertyMeta.READ_WRITE, 0x8L, None, None, None, [], []), 
        "revision": MoPropertyMeta("revision", "revision", "string", VersionMeta.Version302a, MoPropertyMeta.NAMING, 0x10L, 1, 510, None, [], []), 
        ...
        "vendor": MoPropertyMeta("vendor", "vendor", "string", VersionMeta.Version302a, MoPropertyMeta.NAMING, 0x80L, 1, 510, None, [], []), 
    }
