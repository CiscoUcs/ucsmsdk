...
class EquipmentSwitchIOCardCapProvider(ManagedObject):
    ...
    prop_meta = {
        ...
        "gencount": MoPropertyMeta("gencount", "gencount", "uint", VersionMeta.Version302c, MoPropertyMeta.READ_ONLY, None, None, None, None, [], ["0-4294967295"]),
