"""This module contains the general information for EquipmentIOCardFanModuleStatsHist ManagedObject."""
...
class EquipmentIOCardFanModuleStatsHistConsts:
...
class EquipmentIOCardFanModuleStatsHist(ManagedObject):
    """This is EquipmentIOCardFanModuleStatsHist class."""

    consts = EquipmentIOCardFanModuleStatsHistConsts()
    naming_props = set(['id'])

    mo_meta = MoMeta("EquipmentIOCardFanModuleStatsHist", "equipmentIOCardFanModuleStatsHist", "[id]", VersionMeta.Version432b, "OutputOnly", 0xf, [], ["read-only"], ['equipmentIOCardFanModuleStats'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, id, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentIOCardFanModuleStatsHist", parent_mo_or_dn, **kwargs)
