"""This module contains the general information for EquipmentLocatorLedFsmTask ManagedObject."""
import sys, os
...
class EquipmentLocatorLedFsmTaskConsts():
    COMPLETION_CANCELLED = "cancelled"
    COMPLETION_COMPLETED = "completed"
    COMPLETION_PROCESSING = "processing"
    COMPLETION_SCHEDULED = "scheduled"
    ITEM_SET_DISK_LOCATOR_LED = "SetDiskLocatorLed"
    ITEM_SET_FE_LOCATOR_LED = "SetFeLocatorLed"
    ITEM_SET_FI_LOCATOR_LED = "SetFiLocatorLed"
    ITEM_SET_LOCATOR_LED = "SetLocatorLed"
    ITEM_NOP = "nop"
...
class EquipmentLocatorLedFsmTask(ManagedObject):
    ...
    consts = EquipmentLocatorLedFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("EquipmentLocatorLedFsmTask", "equipmentLocatorLedFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], [""], [u'equipmentLocatorLed'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, None, None, None, None, ["SetDiskLocatorLed", "SetFeLocatorLed", "SetFiLocatorLed", "SetLocatorLed", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentLocatorLedFsmTask", parent_mo_or_dn, **kwargs)
