...
class EquipmentFanModuleCapProvider(ManagedObject):
    """This is EquipmentFanModuleCapProvider class."""

    consts = EquipmentFanModuleCapProviderConsts()
    naming_props = set([u'vendor', u'model', u'revision'])

    mo_meta = MoMeta("EquipmentFanModuleCapProvider", "equipmentFanModuleCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version101e, "InputOutput", 0xffL, [], [""], [u'capabilityCatalogue'], [u'equipmentFanModuleDef', u'equipmentManufacturingDef', u'equipmentPhysicalDef', u'equipmentPicture', u'equipmentServiceDef', u'equipmentSlotArrayRef', u'firmwareType', u'firmwareUpgradeConstraint'], ["Get"])
