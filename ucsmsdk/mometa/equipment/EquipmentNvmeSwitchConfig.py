...
class EquipmentNvmeSwitchConfig(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentNvmeSwitchConfig", "equipmentNvmeSwitchConfig", "nvme-switch-config", None, "InputOutput", 0xff, [], [""], [u'equipmentStorageNvmeSwitchCapProvider'], [], [None])
    ...
    prop_meta = {
        ...
        "max_drive_per_cage": MoPropertyMeta("max_drive_per_cage", "maxDrivePerCage", "uint", None, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
