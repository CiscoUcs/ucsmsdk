"""This module contains the general information for EquipmentNvmeSwitchConfig ManagedObject."""
...
class EquipmentNvmeSwitchConfigConsts:
    INT_ID_NONE = "none"
...
class EquipmentNvmeSwitchConfig(ManagedObject):
    """This is EquipmentNvmeSwitchConfig class."""

    consts = EquipmentNvmeSwitchConfigConsts()
    naming_props = set([])

    mo_meta = MoMeta("EquipmentNvmeSwitchConfig", "equipmentNvmeSwitchConfig", "nvme-switch-config", VersionMeta.Version323a, "InputOutput", 0xff, [], [""], [u'equipmentStorageNvmeSwitchCapProvider'], [], [None])
    ...
    prop_meta = {
        ...
        "max_drive_per_cage": MoPropertyMeta("max_drive_per_cage", "maxDrivePerCage", "uint", VersionMeta.Version323a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
    ...
    prop_map = {
        ...
        "dn": "dn", 
        "intId": "int_id", 
        "maxDrivePerCage": "max_drive_per_cage", 
        "name": "name", 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentNvmeSwitchConfig", parent_mo_or_dn, **kwargs)
