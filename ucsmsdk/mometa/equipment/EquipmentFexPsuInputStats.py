...
class EquipmentFexPsuInputStats(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentFexPsuInputStats", "equipmentFexPsuInputStats", "fex-psu-input-stats", VersionMeta.Version141i, "OutputOnly", 0xf, [], ["admin", "operations", "read-only"], [u'equipmentFex', u'equipmentPsu'], [u'equipmentFexPsuInputStatsHist'], ["Get"])
