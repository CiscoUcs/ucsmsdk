"""This module contains the general information for EquipmentIOCardFanStatsHist ManagedObject."""
...
class EquipmentIOCardFanStatsHistConsts:
...
class EquipmentIOCardFanStatsHist(ManagedObject):
    """This is EquipmentIOCardFanStatsHist class."""

    consts = EquipmentIOCardFanStatsHistConsts()
    naming_props = set(['id'])

    mo_meta = MoMeta("EquipmentIOCardFanStatsHist", "equipmentIOCardFanStatsHist", "[id]", VersionMeta.Version432b, "OutputOnly", 0xf, [], ["read-only"], ['equipmentIOCardFanStats'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, id, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentIOCardFanStatsHist", parent_mo_or_dn, **kwargs)
