...
class EquipmentPhysicalQual(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentPhysicalQual", "equipmentPhysicalQual", "physicalqual", VersionMeta.Version911z, "InputOutput", 0x3f, [], ["admin", "pn-policy"], [u'equipmentQual'], [], [None])
    ...
    prop_meta = {
        ...
        "model": MoPropertyMeta("model", "model", "string", VersionMeta.Version911z, MoPropertyMeta.READ_WRITE, 0x8, None, None, r"""[ !#$%\(\)\*\+,\-\./:;\?@\[\\\]\^_\{\|\}~a-zA-Z0-9]{0,256}""", [], []), 
