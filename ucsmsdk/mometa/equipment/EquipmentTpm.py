...
class EquipmentTpm(ManagedObject):
    ...
    prop_meta = {
        ...
        "admin_action": MoPropertyMeta("admin_action", "adminAction", "string", VersionMeta.Version224a, MoPropertyMeta.READ_WRITE, 0x2, None, None, None, ["clear-config", "unspecified"], []), 
