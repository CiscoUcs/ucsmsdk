...
class EquipmentLocalDiskControllerCapProvider(ManagedObject):
    ...
    prop_meta = {
        ...
        "containment_method": MoPropertyMeta("containment_method", "containmentMethod", "string", VersionMeta.Version302c, MoPropertyMeta.READ_ONLY, None, None, None, None, ["chassis-enclosure", "compute-enclosure", "controller", "storage-blade"], []), 
        "controller_type": MoPropertyMeta("controller_type", "controllerType", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["external", "internal"], []), 
