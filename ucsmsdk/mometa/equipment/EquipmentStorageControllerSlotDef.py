...
class EquipmentStorageControllerSlotDef(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentStorageControllerSlotDef", "equipmentStorageControllerSlotDef", "controller-slot-def-[slot_num]", VersionMeta.Version224a, "InputOutput", 0x1fL, [], ["read-only"], [u'equipmentRackUnitCapProvider'], [], [None])
    ...
    prop_meta = {
        ...
        "num_slots": MoPropertyMeta("num_slots", "numSlots", "ushort", VersionMeta.Version224a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        "order": MoPropertyMeta("order", "order", "ushort", VersionMeta.Version224a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        ...
        "slot_num": MoPropertyMeta("slot_num", "slotNum", "ushort", VersionMeta.Version224a, MoPropertyMeta.NAMING, 0x8L, None, None, None, [], []), 
