...
class EquipmentFlexFlashNonRemovable(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentFlexFlashNonRemovable", "equipmentFlexFlashNonRemovable", "ff-non-removable", VersionMeta.Version323a, "InputOutput", 0xff, [], [""], ['equipmentBladeCapProvider', 'equipmentRackUnitCapProvider'], [], [None])
