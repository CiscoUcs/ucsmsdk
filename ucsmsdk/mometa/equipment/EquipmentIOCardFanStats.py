"""This module contains the general information for EquipmentIOCardFanStats ManagedObject."""
...
class EquipmentIOCardFanStatsConsts:
    SUSPECT_FALSE = "false"
    SUSPECT_NO = "no"
    SUSPECT_TRUE = "true"
    SUSPECT_YES = "yes"
...
class EquipmentIOCardFanStats(ManagedObject):
    """This is EquipmentIOCardFanStats class."""

    consts = EquipmentIOCardFanStatsConsts()
    naming_props = set([])

    mo_meta = MoMeta("EquipmentIOCardFanStats", "equipmentIOCardFanStats", "", VersionMeta.Version432b, "OutputOnly", 0xf, [], ["admin", "operations", "read-only"], ['equipmentFan'], ['equipmentIOCardFanStatsHist'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentIOCardFanStats", parent_mo_or_dn, **kwargs)
