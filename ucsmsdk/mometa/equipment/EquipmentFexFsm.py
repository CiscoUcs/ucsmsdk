"""This module contains the general information for EquipmentFexFsm ManagedObject."""
import sys, os
...
class EquipmentFexFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_REMOVE_FEX = "RemoveFex"
    CURRENT_FSM_NOP = "nop"
...
class EquipmentFexFsm(ManagedObject):
    """This is EquipmentFexFsm class."""

    consts = EquipmentFexFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("EquipmentFexFsm", "equipmentFexFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'equipmentFex'], [u'equipmentFexFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["RemoveFex", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentFexFsm", parent_mo_or_dn, **kwargs)
