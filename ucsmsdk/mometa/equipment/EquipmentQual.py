"""This module contains the general information for EquipmentQual ManagedObject."""
...
class EquipmentQual(ManagedObject):
    """This is EquipmentQual class."""

    consts = EquipmentQualConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("EquipmentQual", "equipmentQual", "chassis-qualifier-[name]", VersionMeta.Version911z, "InputOutput", 0xff, [], ["admin", "pn-policy"], [u'orgOrg'], [u'equipmentChassisQual', u'equipmentPhysicalQual'], [None])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentQual", parent_mo_or_dn, **kwargs)
