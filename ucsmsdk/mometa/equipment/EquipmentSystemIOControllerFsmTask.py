...
class EquipmentSystemIOControllerFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentSystemIOControllerFsmTask", "equipmentSystemIOControllerFsmTask", "task-[item]", VersionMeta.Version911z, "OutputOnly", 0xf, [], [""], [u'equipmentSystemIOController'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version911z, MoPropertyMeta.NAMING, None, None, None, None, ["ResetCmc", "nop"], []), 
