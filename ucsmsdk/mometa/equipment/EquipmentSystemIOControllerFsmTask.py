"""This module contains the general information for EquipmentSystemIOControllerFsmTask ManagedObject."""
...
class EquipmentSystemIOControllerFsmTaskConsts:
    COMPLETION_CANCELLED = "cancelled"
    COMPLETION_COMPLETED = "completed"
    COMPLETION_PROCESSING = "processing"
    COMPLETION_SCHEDULED = "scheduled"
    ITEM_RESET_CMC = "ResetCmc"
    ITEM_NOP = "nop"


class EquipmentSystemIOControllerFsmTask(ManagedObject):
    ...
    prop_meta = {
        ...
        "completion": MoPropertyMeta("completion", "completion", "string", VersionMeta.Version312b, MoPropertyMeta.READ_ONLY, None, None, None, None, ["cancelled", "completed", "processing", "scheduled"], []),
        "dn": MoPropertyMeta("dn", "dn", "string", VersionMeta.Version312b, MoPropertyMeta.READ_ONLY, 0x2, 0, 256, None, [], []),
        "flags": MoPropertyMeta("flags", "flags", "string", VersionMeta.Version312b, MoPropertyMeta.READ_ONLY, None, None, None, r"""(defaultValue){0,1}""", [], []),
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version312b, MoPropertyMeta.NAMING, None, None, None, None, ["ResetCmc", "nop"], []),
        ...
        "seq_id": MoPropertyMeta("seq_id", "seqId", "uint", VersionMeta.Version312b, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []),
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentSystemIOControllerFsmTask", parent_mo_or_dn, **kwargs)
