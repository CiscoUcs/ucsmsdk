"""This module contains the general information for EquipmentSystemIOControllerFsm ManagedObject."""
...
class EquipmentSystemIOControllerFsmConsts:
    COMPLETION_TIME_ = ""
    CURRENT_FSM_RESET_CMC = "ResetCmc"
    CURRENT_FSM_NOP = "nop"
...
class EquipmentSystemIOControllerFsm(ManagedObject):
    """This is EquipmentSystemIOControllerFsm class."""

    consts = EquipmentSystemIOControllerFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("EquipmentSystemIOControllerFsm", "equipmentSystemIOControllerFsm", "fsm", VersionMeta.Version911z, "OutputOnly", 0xf, [], [""], [u'equipmentSystemIOController'], [u'equipmentSystemIOControllerFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentSystemIOControllerFsm", parent_mo_or_dn, **kwargs)
