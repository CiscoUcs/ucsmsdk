"""This module contains the general information for EquipmentFexFsmTask ManagedObject."""
import sys, os
...
class EquipmentFexFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentFexFsmTask", "equipmentFexFsmTask", "task-[item]", VersionMeta.Version141i, "OutputOnly", 0xfL, [], [""], [u'equipmentFex'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version141i, MoPropertyMeta.NAMING, None, None, None, None, ["RemoveFex", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentFexFsmTask", parent_mo_or_dn, **kwargs)
