...
class EquipmentFexPsuInputStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentFexPsuInputStatsHist", "equipmentFexPsuInputStatsHist", "[id]", VersionMeta.Version141i, "OutputOnly", 0xf, [], ["read-only"], [u'equipmentFexPsuInputStats'], [], ["Get"])
