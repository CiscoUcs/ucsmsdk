...
class EquipmentLocatorLed(ManagedObject):
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version101e, MoPropertyMeta.INTERNAL, None, None, None, None, ["SetFeLocatorLedBegin", "SetFeLocatorLedExecute", "SetFeLocatorLedFail", "SetFeLocatorLedSuccess", "SetFiLocatorLedBegin", "SetFiLocatorLedExecute", "SetFiLocatorLedFail", "SetFiLocatorLedSuccess", "SetLocatorLedBegin", "SetLocatorLedExecute", "SetLocatorLedFail", "SetLocatorLedSuccess", "nop"], []),
        ...
        "id": MoPropertyMeta("id", "id", "uint", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x20, None, None, None, [], []),
