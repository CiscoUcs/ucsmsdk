...
class EquipmentLocatorLedConsts():
    ...
    ADMIN_STATE_OFF = "off"
    ADMIN_STATE_ON = "on"
    BOARD_TYPE_MULTI_MASTER = "multi-master"
    BOARD_TYPE_MULTI_SLAVE = "multi-slave"
    BOARD_TYPE_NONE = "none"
    BOARD_TYPE_SINGLE = "single"
    COLOR_AMBER = "amber"
    COLOR_BLUE = "blue"
    COLOR_GREEN = "green"
    COLOR_RED = "red"
    COLOR_UNKNOWN = "unknown"
    FSM_PREV_SET_DISK_LOCATOR_LED_BEGIN = "SetDiskLocatorLedBegin"
    FSM_PREV_SET_DISK_LOCATOR_LED_FAIL = "SetDiskLocatorLedFail"
    FSM_PREV_SET_DISK_LOCATOR_LED_SET_LOCATOR_LED_LOCAL = "SetDiskLocatorLedSetLocatorLedLocal"
    FSM_PREV_SET_DISK_LOCATOR_LED_SET_LOCATOR_LED_PEER = "SetDiskLocatorLedSetLocatorLedPeer"
    FSM_PREV_SET_DISK_LOCATOR_LED_SUCCESS = "SetDiskLocatorLedSuccess"
    FSM_PREV_SET_FE_LOCATOR_LED_BEGIN = "SetFeLocatorLedBegin"
    FSM_PREV_SET_FE_LOCATOR_LED_EXECUTE = "SetFeLocatorLedExecute"
    FSM_PREV_SET_FE_LOCATOR_LED_FAIL = "SetFeLocatorLedFail"
    FSM_PREV_SET_FE_LOCATOR_LED_SUCCESS = "SetFeLocatorLedSuccess"
    FSM_PREV_SET_FI_LOCATOR_LED_BEGIN = "SetFiLocatorLedBegin"
    FSM_PREV_SET_FI_LOCATOR_LED_EXECUTE = "SetFiLocatorLedExecute"
    FSM_PREV_SET_FI_LOCATOR_LED_FAIL = "SetFiLocatorLedFail"
    FSM_PREV_SET_FI_LOCATOR_LED_SUCCESS = "SetFiLocatorLedSuccess"
    FSM_PREV_SET_LOCATOR_LED_BEGIN = "SetLocatorLedBegin"
    FSM_PREV_SET_LOCATOR_LED_EXECUTE = "SetLocatorLedExecute"
    FSM_PREV_SET_LOCATOR_LED_FAIL = "SetLocatorLedFail"
    FSM_PREV_SET_LOCATOR_LED_SUCCESS = "SetLocatorLedSuccess"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_SET_DISK_LOCATOR_LED_BEGIN = "SetDiskLocatorLedBegin"
    FSM_STATUS_SET_DISK_LOCATOR_LED_FAIL = "SetDiskLocatorLedFail"
    FSM_STATUS_SET_DISK_LOCATOR_LED_SET_LOCATOR_LED_LOCAL = "SetDiskLocatorLedSetLocatorLedLocal"
    FSM_STATUS_SET_DISK_LOCATOR_LED_SET_LOCATOR_LED_PEER = "SetDiskLocatorLedSetLocatorLedPeer"
    FSM_STATUS_SET_DISK_LOCATOR_LED_SUCCESS = "SetDiskLocatorLedSuccess"
    FSM_STATUS_SET_FE_LOCATOR_LED_BEGIN = "SetFeLocatorLedBegin"
    FSM_STATUS_SET_FE_LOCATOR_LED_EXECUTE = "SetFeLocatorLedExecute"
    FSM_STATUS_SET_FE_LOCATOR_LED_FAIL = "SetFeLocatorLedFail"
    FSM_STATUS_SET_FE_LOCATOR_LED_SUCCESS = "SetFeLocatorLedSuccess"
    FSM_STATUS_SET_FI_LOCATOR_LED_BEGIN = "SetFiLocatorLedBegin"
    FSM_STATUS_SET_FI_LOCATOR_LED_EXECUTE = "SetFiLocatorLedExecute"
    FSM_STATUS_SET_FI_LOCATOR_LED_FAIL = "SetFiLocatorLedFail"
    FSM_STATUS_SET_FI_LOCATOR_LED_SUCCESS = "SetFiLocatorLedSuccess"
    FSM_STATUS_SET_LOCATOR_LED_BEGIN = "SetLocatorLedBegin"
    FSM_STATUS_SET_LOCATOR_LED_EXECUTE = "SetLocatorLedExecute"
    FSM_STATUS_SET_LOCATOR_LED_FAIL = "SetLocatorLedFail"
    FSM_STATUS_SET_LOCATOR_LED_SUCCESS = "SetLocatorLedSuccess"
    FSM_STATUS_NOP = "nop"
...
class EquipmentLocatorLed(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentLocatorLed", "equipmentLocatorLed", "locator-led", VersionMeta.Version101e, "InputOutput", 0xffL, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy", "read-only"], [u'computeBlade', u'computeExtBoard', u'computeRackUnit', u'computeServerUnit', u'equipmentChassis', u'equipmentFanModule', u'equipmentFex', u'equipmentIOCard', u'equipmentPsu', u'networkElement', u'storageLocalDisk'], [u'equipmentLocatorLedFsm', u'equipmentLocatorLedFsmTask', u'eventInst', u'faultInst'], ["Get", "Set"])

    prop_meta = {
        "admin_state": MoPropertyMeta("admin_state", "adminState", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x1L, None, None, None, ["inactive", "off", "on"], []), 
        "board_type": MoPropertyMeta("board_type", "boardType", "string", VersionMeta.Version222c, MoPropertyMeta.READ_WRITE, 0x2L, None, None, None, ["multi-master", "multi-slave", "none", "single"], []), 
        ...
        "id": MoPropertyMeta("id", "id", "uint", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x10L, None, None, None, [], []), 
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x20L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        "oper_state": MoPropertyMeta("oper_state", "operState", "string", VersionMeta.Version101e, MoPropertyMeta.READ_ONLY, None, None, None, None, ["blinking", "eth", "fc", "off", "on", "unknown"], []), 
