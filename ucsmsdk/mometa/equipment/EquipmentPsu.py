...
class EquipmentPsu(ManagedObject):
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version302a, MoPropertyMeta.INTERNAL, None, None, None, None, ["UpdatePSUActivatePsu", "UpdatePSUBegin", "UpdatePSUFail", "UpdatePSUPollActivateStatus", "UpdatePSUPollUpdateStatus", "UpdatePSUSuccess", "UpdatePSUUpdateRequest", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version302a, MoPropertyMeta.INTERNAL, None, None, None, None, ["UpdatePSUActivatePsu", "UpdatePSUBegin", "UpdatePSUFail", "UpdatePSUPollActivateStatus", "UpdatePSUPollUpdateStatus", "UpdatePSUSuccess", "UpdatePSUUpdateRequest", "nop"], []), 
        "fsm_try": MoPropertyMeta("fsm_try", "fsmTry", "byte", VersionMeta.Version302a, MoPropertyMeta.INTERNAL, None, None, None, None, [], []), 
        "id": MoPropertyMeta("id", "id", "uint", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x8, None, None, None, [], ["1-4"]), 
        ...
        "psu_input_src": MoPropertyMeta("psu_input_src", "psuInputSrc", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["110AC", "210AC_50_380DC", "N/A", "undetermined", "unknown"], []), 
        "psu_type": MoPropertyMeta("psu_type", "psuType", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["AC", "DC", "DV", "HVDC", "N/A", "unknown"], []), 
        "psu_wattage": MoPropertyMeta("psu_wattage", "psuWattage", "uint", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], ["0-20000"]), 
