...
class EquipmentPsu(ManagedObject):
    ...
    prop_meta = {
        ...
        "id": MoPropertyMeta("id", "id", "uint", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x4L, None, None, None, [], ["1-4"]), 
        ...
        "psu_input_src": MoPropertyMeta("psu_input_src", "psuInputSrc", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["110AC", "210AC_50_380DC", "undetermined", "unknown"], []), 
        "psu_type": MoPropertyMeta("psu_type", "psuType", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["AC", "DC", "DV", "HVDC", "unknown"], []), 
