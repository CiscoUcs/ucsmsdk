...
class EquipmentPsuOutputStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentPsuOutputStatsHist", "equipmentPsuOutputStatsHist", "[id]", VersionMeta.Version201m, "OutputOnly", 0x7L, [], ["read-only"], [u'equipmentPsuOutputStats'], [], ["Get"])
