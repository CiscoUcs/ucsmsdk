"""This module contains the general information for EquipmentChassisTypeCap ManagedObject."""
...
class EquipmentChassisTypeCapConsts:
    INT_ID_NONE = "none"
...
class EquipmentChassisTypeCap(ManagedObject):
    """This is EquipmentChassisTypeCap class."""

    consts = EquipmentChassisTypeCapConsts()
    naming_props = set([])

    mo_meta = MoMeta("EquipmentChassisTypeCap", "equipmentChassisTypeCap", "chassistype", VersionMeta.Version432b, "InputOutput", 0xff, [], ["read-only"], ['equipmentChassisCapProvider'], [], [None])
    ...
    prop_meta = {
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version432b, MoPropertyMeta.READ_ONLY, None, None, None, None, ["general-purpose", "x-series"], []),
    }
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentChassisTypeCap", parent_mo_or_dn, **kwargs)
