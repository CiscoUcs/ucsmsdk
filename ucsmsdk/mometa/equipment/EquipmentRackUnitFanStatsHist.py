...
class EquipmentRackUnitFanStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentRackUnitFanStatsHist", "equipmentRackUnitFanStatsHist", "[id]", VersionMeta.Version141i, "OutputOnly", 0xf, [], ["read-only"], [u'equipmentRackUnitFanStats'], [], ["Get"])
