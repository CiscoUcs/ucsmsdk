...
class EquipmentRackUnitFanStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentRackUnitFanStatsHist", "equipmentRackUnitFanStatsHist", "[id]", VersionMeta.Version141i, "OutputOnly", 0x7L, [], ["read-only"], [u'equipmentRackUnitFanStats'], [], ["Get"])
