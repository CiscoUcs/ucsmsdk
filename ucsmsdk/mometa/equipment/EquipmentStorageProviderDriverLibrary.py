...
class EquipmentStorageProviderDriverLibrary(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentStorageProviderDriverLibrary", "equipmentStorageProviderDriverLibrary", "lib-[name]", VersionMeta.Version302c, "InputOutput", 0xffL, [], [""], [u'equipmentStorageProcessorCap'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version302c, MoPropertyMeta.NAMING, 0x10L, 1, 512, None, [], []), 
