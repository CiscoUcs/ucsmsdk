...
class EquipmentSlotArrayRef(ManagedObject):
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x8L, 1, 512, None, [], []), 
