"""This module contains the general information for EquipmentCrossFabricModuleStatsHist ManagedObject."""
...
class EquipmentCrossFabricModuleStatsHistConsts:
...
class EquipmentCrossFabricModuleStatsHist(ManagedObject):
    """This is EquipmentCrossFabricModuleStatsHist class."""

    consts = EquipmentCrossFabricModuleStatsHistConsts()
    naming_props = set(['id'])

    mo_meta = MoMeta("EquipmentCrossFabricModuleStatsHist", "equipmentCrossFabricModuleStatsHist", "[id]", VersionMeta.Version432b, "OutputOnly", 0xf, [], ["read-only"], ['equipmentCrossFabricModuleStats'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, id, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentCrossFabricModuleStatsHist", parent_mo_or_dn, **kwargs)
