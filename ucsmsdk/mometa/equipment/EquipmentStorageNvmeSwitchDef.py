...
class EquipmentStorageNvmeSwitchDef(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentStorageNvmeSwitchDef", "equipmentStorageNvmeSwitchDef", "mswitch-def", VersionMeta.Version323a, "InputOutput", 0xff, [], [""], ['equipmentStorageNvmeSwitchCapProvider'], [], [None])
