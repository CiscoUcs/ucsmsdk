...
class EquipmentIOCardBaseFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentIOCardBaseFsmStage", "equipmentIOCardBaseFsmStage", "stage-[name]", VersionMeta.Version302a, "OutputOnly", 0x7L, [], [""], [u'equipmentIOCardBaseFsm'], [], [None])
