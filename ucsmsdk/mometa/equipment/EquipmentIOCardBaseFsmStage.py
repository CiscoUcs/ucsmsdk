...
class EquipmentIOCardBaseFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentIOCardBaseFsmStage", "equipmentIOCardBaseFsmStage", "stage-[name]", VersionMeta.Version302c, "OutputOnly", 0xfL, [], [""], [u'equipmentIOCardBaseFsm'], [], [None])
