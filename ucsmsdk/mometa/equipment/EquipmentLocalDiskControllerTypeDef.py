...
class EquipmentLocalDiskControllerTypeDef(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentLocalDiskControllerTypeDef", "equipmentLocalDiskControllerTypeDef", "controller-type", VersionMeta.Version224a, "InputOutput", 0x3f, [], [""], [u'equipmentLocalDiskControllerCapProvider'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "is_flash_life_left_supported": MoPropertyMeta("is_flash_life_left_supported", "isFlashLifeLeftSupported", "string", VersionMeta.Version224a, MoPropertyMeta.READ_WRITE, 0x8, None, None, None, ["false", "no", "true", "yes"], []), 
