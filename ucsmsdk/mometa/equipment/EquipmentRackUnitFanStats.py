...
class EquipmentRackUnitFanStats(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentRackUnitFanStats", "equipmentRackUnitFanStats", "stats", VersionMeta.Version141i, "OutputOnly", 0x7L, [], ["admin", "operations", "read-only"], [u'equipmentFan'], [u'equipmentRackUnitFanStatsHist'], ["Get"])
