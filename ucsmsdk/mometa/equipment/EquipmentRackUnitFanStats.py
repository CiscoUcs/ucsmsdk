...
class EquipmentRackUnitFanStats(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentRackUnitFanStats", "equipmentRackUnitFanStats", "stats", VersionMeta.Version141i, "OutputOnly", 0xf, [], ["admin", "operations", "read-only"], [u'equipmentFan'], [u'equipmentRackUnitFanStatsHist'], ["Get"])
