...
class EquipmentFan(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentFan", "equipmentFan", "fan-[id]", VersionMeta.Version101e, "InputOutput", 0x7fL, [], ["read-only"], [u'equipmentFanModule', u'equipmentFex', u'networkElement'], [u'equipmentFanStats', u'equipmentNetworkElementFanStats', u'equipmentRackUnitFanStats', u'faultInst'], ["Get"])
    ...
    prop_meta = {
        ...
        "id": MoPropertyMeta("id", "id", "uint", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x4L, None, None, None, [], ["1-8"]), 
        ...
        "module": MoPropertyMeta("module", "module", "uint", VersionMeta.Version101e, MoPropertyMeta.CREATE_ONLY, 0x8L, None, None, None, [], ["1-8"]), 
        ...
        "tray": MoPropertyMeta("tray", "tray", "uint", VersionMeta.Version101e, MoPropertyMeta.CREATE_ONLY, 0x40L, None, None, None, [], ["1-8"]), 
