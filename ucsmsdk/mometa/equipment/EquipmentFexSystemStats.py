...
class EquipmentFexSystemStats(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentFexSystemStats", "equipmentFexSystemStats", "sys-stats", None, "OutputOnly", 0xfL, [], ["admin", "operations", "read-only"], [u'equipmentFex'], [u'equipmentFexSystemStatsHist'], [None])
