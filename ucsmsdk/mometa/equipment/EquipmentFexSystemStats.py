"""This module contains the general information for EquipmentFexSystemStats ManagedObject."""
...
class EquipmentFexSystemStatsConsts:
    SUSPECT_FALSE = "false"
    SUSPECT_NO = "no"
    SUSPECT_TRUE = "true"
    SUSPECT_YES = "yes"
...
class EquipmentFexSystemStats(ManagedObject):
    """This is EquipmentFexSystemStats class."""
    ...
    prop_meta = {
        ...
        "intervals": MoPropertyMeta("intervals", "intervals", "uint", VersionMeta.Version311e, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []),
        ...
        "update": MoPropertyMeta("update", "update", "uint", VersionMeta.Version311e, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []),
    }
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentFexSystemStats", parent_mo_or_dn, **kwargs)
