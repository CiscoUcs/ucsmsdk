...
class EquipmentLocatorLedFsmStageConsts():
    ...
    NAME_SET_FE_LOCATOR_LED_SUCCESS = "SetFeLocatorLedSuccess"
    NAME_SET_FI_LOCATOR_LED_BEGIN = "SetFiLocatorLedBegin"
    NAME_SET_FI_LOCATOR_LED_EXECUTE = "SetFiLocatorLedExecute"
    NAME_SET_FI_LOCATOR_LED_FAIL = "SetFiLocatorLedFail"
    NAME_SET_FI_LOCATOR_LED_SUCCESS = "SetFiLocatorLedSuccess"
    NAME_SET_LOCATOR_LED_BEGIN = "SetLocatorLedBegin"
    NAME_SET_LOCATOR_LED_EXECUTE = "SetLocatorLedExecute"
    NAME_SET_LOCATOR_LED_FAIL = "SetLocatorLedFail"
    NAME_SET_LOCATOR_LED_SUCCESS = "SetLocatorLedSuccess"
    NAME_NOP = "nop"
...
class EquipmentLocatorLedFsmStage(ManagedObject):
    """This is EquipmentLocatorLedFsmStage class."""

    consts = EquipmentLocatorLedFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("EquipmentLocatorLedFsmStage", "equipmentLocatorLedFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'equipmentLocatorLedFsm'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentLocatorLedFsmStage", parent_mo_or_dn, **kwargs)
