"""This module contains the general information for EquipmentFirmwareConstraint ManagedObject."""
import sys, os
...
class EquipmentFirmwareConstraintConsts():
    pass


class EquipmentFirmwareConstraint(ManagedObject):
    """This is EquipmentFirmwareConstraint class."""

    consts = EquipmentFirmwareConstraintConsts()
    naming_props = set([])

    mo_meta = MoMeta("EquipmentFirmwareConstraint", "equipmentFirmwareConstraint", "fw-constr", VersionMeta.Version212a, "InputOutput", 0x1fL, [], [""], [u'equipmentBoardControllerDef'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "min_ver1": MoPropertyMeta("min_ver1", "minVer1", "string", VersionMeta.Version212a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        "min_ver2": MoPropertyMeta("min_ver2", "minVer2", "string", VersionMeta.Version212a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentFirmwareConstraint", parent_mo_or_dn, **kwargs)
