...
class EquipmentFirmwareConstraint(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentFirmwareConstraint", "equipmentFirmwareConstraint", "fw-constr", VersionMeta.Version212a, "InputOutput", 0xfL, [], [""], [u'equipmentBoardControllerDef'], [], ["Get"])
