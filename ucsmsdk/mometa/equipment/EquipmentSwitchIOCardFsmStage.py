...
class EquipmentSwitchIOCardFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentSwitchIOCardFsmStage", "equipmentSwitchIOCardFsmStage", "stage-[name]", VersionMeta.Version302c, "OutputOnly", 0xfL, [], [""], [u'equipmentSwitchIOCardFsm'], [], [None])
