...
class EquipmentSwitchIOCardFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentSwitchIOCardFsmStage", "equipmentSwitchIOCardFsmStage", "stage-[name]", VersionMeta.Version302a, "OutputOnly", 0x7L, [], [""], [u'equipmentSwitchIOCardFsm'], [], [None])
