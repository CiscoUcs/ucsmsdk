"""This module contains the general information for EquipmentOnboardDeviceDef ManagedObject."""
...
class EquipmentOnboardDeviceDefConsts:
    INT_ID_NONE = "none"
...
class EquipmentOnboardDeviceDef(ManagedObject):
    ...
    prop_meta = {
        ...
        "device": MoPropertyMeta("device", "device", "string", VersionMeta.Version227b, MoPropertyMeta.NAMING, 0x8, 1, 510, None, [], []),
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version227b, MoPropertyMeta.READ_WRITE, 0x20, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []),
        ...
        "policy_owner": MoPropertyMeta("policy_owner", "policyOwner", "string", VersionMeta.Version227b, MoPropertyMeta.READ_WRITE, 0x40, None, None, None, ["local", "pending-policy", "policy"], []),
    ...
    def __init__(self, parent_mo_or_dn, device, **kwargs):
        self._dirty_mask = 0
        self.device = device
        ...
        ManagedObject.__init__(self, "EquipmentOnboardDeviceDef", parent_mo_or_dn, **kwargs)
