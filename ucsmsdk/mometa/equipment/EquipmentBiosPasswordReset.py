...
class EquipmentBiosPasswordReset(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentBiosPasswordReset", "equipmentBiosPasswordReset", "biospasswordreset", None, "InputOutput", 0x1f, [], ["read-only"], ['equipmentBladeCapProvider', 'equipmentRackUnitCapProvider'], [], [None])
