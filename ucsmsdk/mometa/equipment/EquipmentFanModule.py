...
class EquipmentFanModule(ManagedObject):
    ...
    prop_meta = {
        ...
        "tray": MoPropertyMeta("tray", "tray", "uint", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x40L, None, None, None, [], ["1-1"]), 
