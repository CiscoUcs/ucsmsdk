"""This module contains the general information for EquipmentMemoryUnitCapProvider ManagedObject."""
import sys, os
...
class EquipmentMemoryUnitCapProviderConsts():
    DELETED_FALSE = "false"
    DELETED_NO = "no"
    DELETED_TRUE = "true"
    DELETED_YES = "yes"
...
class EquipmentMemoryUnitCapProvider(ManagedObject):
    """This is EquipmentMemoryUnitCapProvider class."""

    consts = EquipmentMemoryUnitCapProviderConsts()
    naming_props = set([u'vendor', u'model', u'revision'])

    mo_meta = MoMeta("EquipmentMemoryUnitCapProvider", "equipmentMemoryUnitCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version101e, "InputOutput", 0xffL, [], [""], [u'capabilityCatalogue'], [u'equipmentManufacturingDef', u'equipmentMemoryUnitDiscoveryModifierDef', u'equipmentPhysicalDef', u'equipmentPicture', u'equipmentServiceDef', u'equipmentSlotArrayRef', u'firmwareType', u'firmwareUpgradeConstraint'], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, vendor, model, revision, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentMemoryUnitCapProvider", parent_mo_or_dn, **kwargs)
