"""This module contains the general information for EquipmentPoolingPolicy ManagedObject."""
...
class EquipmentPoolingPolicyConsts:
    INT_ID_NONE = "none"
...
class EquipmentPoolingPolicy(ManagedObject):
    """This is EquipmentPoolingPolicy class."""

    consts = EquipmentPoolingPolicyConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("EquipmentPoolingPolicy", "equipmentPoolingPolicy", "chassis-pooling-policy-[name]", VersionMeta.Version911z, "InputOutput", 0x3ff, [], ["admin", "pn-policy"], [u'orgOrg'], [], [None])
    ...
    prop_meta = {
        ...
        "pool_dn": MoPropertyMeta("pool_dn", "poolDn", "string", VersionMeta.Version911z, MoPropertyMeta.READ_WRITE, 0x40, 0, 256, None, [], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentPoolingPolicy", parent_mo_or_dn, **kwargs)
