...
class EquipmentProcessorUnitDef(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentProcessorUnitDef", "equipmentProcessorUnitDef", "cpu", VersionMeta.Version101e, "InputOutput", 0x7fL, [], [""], [u'equipmentProcessorUnitCapProvider'], [], ["Get"])
