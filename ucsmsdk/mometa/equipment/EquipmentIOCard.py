...
class EquipmentIOCardConsts:
    ...
    RESET_REQUIRED_FALSE = "false"
    RESET_REQUIRED_NO = "no"
    RESET_REQUIRED_TRUE = "true"
    RESET_REQUIRED_YES = "yes"
    SIDE_LEFT = "left"
    SIDE_RIGHT = "right"
...
class EquipmentIOCard(ManagedObject):
    ...
    prop_meta = {
        "actual_reset_time": MoPropertyMeta("actual_reset_time", "actualResetTime", "string", VersionMeta.Version601a, MoPropertyMeta.READ_ONLY, None, None, None, r"""([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", [], []),
        ...
        "discovery": MoPropertyMeta("discovery", "discovery", "string", VersionMeta.Version101e, MoPropertyMeta.READ_ONLY, None, None, None, None, ["auto-upgrading", "discovered", "offline", "online", "pinglost", "unknown", "unsecure", "unsupported-connectivity"], []),
        ...
        "num_of_active_fabric_ports": MoPropertyMeta("num_of_active_fabric_ports", "numOfActiveFabricPorts", "uint", VersionMeta.Version422d, MoPropertyMeta.READ_ONLY, None, None, None, None, [], ["0-4294967295"]),
        ...
        "reset_required": MoPropertyMeta("reset_required", "resetRequired", "string", VersionMeta.Version422d, MoPropertyMeta.READ_ONLY, None, None, None, None, ["false", "no", "true", "yes"], []),
        ...
        "trigger_reset_time": MoPropertyMeta("trigger_reset_time", "triggerResetTime", "string", VersionMeta.Version601a, MoPropertyMeta.READ_ONLY, None, None, None, r"""([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", [], []),
    ...
    prop_map = {
        ...
        "mfgTime": "mfg_time", 
        "model": "model", 
        "numOfActiveFabricPorts": "num_of_active_fabric_ports", 
    ...
    def __init__(self, parent_mo_or_dn, id, **kwargs):
        ...
        self.mfg_time = None
        self.model = None
        self.num_of_active_fabric_ports = None
