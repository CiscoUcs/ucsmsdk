...
class EquipmentIOCard(ManagedObject):
    ...
    prop_meta = {
        ...
        "admin_state": MoPropertyMeta("admin_state", "adminState", "string", VersionMeta.Version224a, MoPropertyMeta.READ_WRITE, 0x8, None, None, None, ["acknowledged", "auto-acknowledge", "decommission", "disable-port-channel", "enable-port-channel", "re-acknowledge", "remove"], []), 
