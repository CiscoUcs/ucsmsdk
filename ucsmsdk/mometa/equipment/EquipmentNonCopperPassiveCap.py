...
class EquipmentNonCopperPassiveCap(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentNonCopperPassiveCap", "equipmentNonCopperPassiveCap", "non-copper-passive-cap", None, "InputOutput", 0xffL, [], [""], [u'equipmentSwitchCapProvider'], [], [None])
