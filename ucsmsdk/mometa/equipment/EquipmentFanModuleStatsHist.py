...
class EquipmentFanModuleStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentFanModuleStatsHist", "equipmentFanModuleStatsHist", "[id]", VersionMeta.Version111j, "OutputOnly", 0x7L, [], ["read-only"], [u'equipmentFanModuleStats'], [], ["Get"])
