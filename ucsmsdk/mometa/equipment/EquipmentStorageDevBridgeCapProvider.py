"""This module contains the general information for EquipmentStorageDevBridgeCapProvider ManagedObject."""
import sys, os
...
class EquipmentStorageDevBridgeCapProviderConsts():
    DELETED_FALSE = "false"
    DELETED_NO = "no"
    DELETED_TRUE = "true"
    DELETED_YES = "yes"
...
class EquipmentStorageDevBridgeCapProvider(ManagedObject):
    """This is EquipmentStorageDevBridgeCapProvider class."""

    consts = EquipmentStorageDevBridgeCapProviderConsts()
    naming_props = set([u'vendor', u'model', u'revision'])

    mo_meta = MoMeta("EquipmentStorageDevBridgeCapProvider", "equipmentStorageDevBridgeCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version302a, "InputOutput", 0xffL, [], [""], [u'capabilityCatalogue'], [u'equipmentManufacturingDef', u'equipmentPhysicalDef', u'equipmentPicture', u'equipmentServiceDef', u'equipmentSlotArrayRef', u'firmwareType', u'firmwareUpgradeConstraint'], [None])
    ...
    def __init__(self, parent_mo_or_dn, vendor, model, revision, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentStorageDevBridgeCapProvider", parent_mo_or_dn, **kwargs)
