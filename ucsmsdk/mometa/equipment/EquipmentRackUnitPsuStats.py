...
class EquipmentRackUnitPsuStats(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentRackUnitPsuStats", "equipmentRackUnitPsuStats", "rackunit-power-stats", VersionMeta.Version141i, "OutputOnly", 0xf, [], ["admin", "operations", "read-only"], [u'equipmentPsu'], [u'equipmentRackUnitPsuStatsHist'], ["Get"])
    ...
    prop_meta = {
        ...
        "input_voltage": MoPropertyMeta("input_voltage", "inputVoltage", "string", VersionMeta.Version141i, MoPropertyMeta.READ_ONLY, None, None, None, r"""^([\-]?)([123]?[1234]?)([0-9]{0,36})(([.])([0-9]{1,10}))?$""", ["Not-Applicable"], ["0-4294967295"]), 
        ...
        "output_voltage": MoPropertyMeta("output_voltage", "outputVoltage", "string", VersionMeta.Version141i, MoPropertyMeta.READ_ONLY, None, None, None, r"""^([\-]?)([123]?[1234]?)([0-9]{0,36})(([.])([0-9]{1,10}))?$""", ["Not-Applicable"], ["0-4294967295"]), 
