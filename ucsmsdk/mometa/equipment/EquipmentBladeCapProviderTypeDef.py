...
class EquipmentBladeCapProviderTypeDef(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentBladeCapProviderTypeDef", "equipmentBladeCapProviderTypeDef", "blade-provider-type", VersionMeta.Version224a, "InputOutput", 0x7f, [], [""], [u'equipmentBladeCapProvider'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "num_adapter_slots": MoPropertyMeta("num_adapter_slots", "numAdapterSlots", "ushort", VersionMeta.Version224a, MoPropertyMeta.READ_WRITE, 0x8, None, None, None, [], []), 
        "num_slots": MoPropertyMeta("num_slots", "numSlots", "ushort", VersionMeta.Version224a, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, [], []), 
