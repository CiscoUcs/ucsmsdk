...
class EquipmentRackUnitPsuStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentRackUnitPsuStatsHist", "equipmentRackUnitPsuStatsHist", "[id]", VersionMeta.Version141i, "OutputOnly", 0x7L, [], ["read-only"], [u'equipmentRackUnitPsuStats'], [], ["Get"])
