...
class EquipmentRackUnitPsuStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentRackUnitPsuStatsHist", "equipmentRackUnitPsuStatsHist", "[id]", VersionMeta.Version141i, "OutputOnly", 0xfL, [], ["read-only"], [u'equipmentRackUnitPsuStats'], [], ["Get"])
