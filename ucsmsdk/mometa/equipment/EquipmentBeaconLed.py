...
class EquipmentBeaconLedConsts():
    ...
    FSM_PREV_ILLUMINATE_BEGIN = "IlluminateBegin"
    FSM_PREV_ILLUMINATE_EXECUTE_A = "IlluminateExecuteA"
    FSM_PREV_ILLUMINATE_EXECUTE_B = "IlluminateExecuteB"
    FSM_PREV_ILLUMINATE_FAIL = "IlluminateFail"
    FSM_PREV_ILLUMINATE_SUCCESS = "IlluminateSuccess"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_ILLUMINATE_BEGIN = "IlluminateBegin"
    FSM_STATUS_ILLUMINATE_EXECUTE_A = "IlluminateExecuteA"
    FSM_STATUS_ILLUMINATE_EXECUTE_B = "IlluminateExecuteB"
    FSM_STATUS_ILLUMINATE_FAIL = "IlluminateFail"
    FSM_STATUS_ILLUMINATE_SUCCESS = "IlluminateSuccess"
    FSM_STATUS_NOP = "nop"
...
class EquipmentBeaconLed(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentBeaconLed", "equipmentBeaconLed", "beacon", VersionMeta.Version201m, "InputOutput", 0x7fL, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit', u'equipmentChassis', u'equipmentFanModule', u'equipmentFex', u'equipmentIOCard', u'equipmentPsu', u'equipmentSwitchCard'], [u'equipmentBeaconLedFsm', u'equipmentBeaconLedFsmTask', u'eventInst', u'faultInst'], ["Get"])

    prop_meta = {
        "admin_state": MoPropertyMeta("admin_state", "adminState", "string", VersionMeta.Version201m, MoPropertyMeta.READ_WRITE, 0x1L, None, None, None, ["blinking", "eth", "fc", "off", "on"], []), 
        ...
        "color": MoPropertyMeta("color", "color", "string", VersionMeta.Version201m, MoPropertyMeta.READ_ONLY, None, None, None, None, ["amber", "blue", "green", "red", "unknown"], []), 
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version201m, MoPropertyMeta.INTERNAL, None, None, None, None, ["IlluminateBegin", "IlluminateExecuteA", "IlluminateExecuteB", "IlluminateFail", "IlluminateSuccess", "nop"], []), 
        ...
        "fsm_stamp": MoPropertyMeta("fsm_stamp", "fsmStamp", "string", VersionMeta.Version201m, MoPropertyMeta.INTERNAL, None, None, None, """([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", ["never"], []), 
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version201m, MoPropertyMeta.INTERNAL, None, None, None, None, ["IlluminateBegin", "IlluminateExecuteA", "IlluminateExecuteB", "IlluminateFail", "IlluminateSuccess", "nop"], []), 
        "fsm_try": MoPropertyMeta("fsm_try", "fsmTry", "byte", VersionMeta.Version201m, MoPropertyMeta.INTERNAL, None, None, None, None, [], []), 
        "id": MoPropertyMeta("id", "id", "uint", VersionMeta.Version201m, MoPropertyMeta.READ_WRITE, 0x8L, None, None, None, [], []), 
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version201m, MoPropertyMeta.READ_WRITE, 0x10L, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        "oper_state": MoPropertyMeta("oper_state", "operState", "string", VersionMeta.Version201m, MoPropertyMeta.READ_ONLY, None, None, None, None, ["blinking", "eth", "fc", "off", "on", "unknown"], []), 
        ...
        "status": MoPropertyMeta("status", "status", "string", VersionMeta.Version201m, MoPropertyMeta.READ_WRITE, 0x40L, None, None, """((removed|created|modified|deleted),){0,3}(removed|created|modified|deleted){0,1}""", [], []), 
    }
