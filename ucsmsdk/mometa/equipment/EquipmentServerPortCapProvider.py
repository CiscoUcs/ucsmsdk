...
class EquipmentServerPortCapProvider(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentServerPortCapProvider", "equipmentServerPortCapProvider", "server-port-cap", VersionMeta.Version311e, "InputOutput", 0xff, [], [""], [u'equipmentGemCapProvider', u'equipmentSwitchIOCardCapProvider'], [], [None])
