...
class EquipmentChassisFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentChassisFsmTask", "equipmentChassisFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], [""], [u'equipmentChassis'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, None, None, None, None, ["DynamicReallocation", "OobStorageAdminCfg", "PowerCap", "PsuPolicyConfig", "RemoveChassis", "nop"], []), 
