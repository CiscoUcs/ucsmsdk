...
class EquipmentPoolable(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentPoolable", "equipmentPoolable", "chassis-pool-[id]", VersionMeta.Version312b, "InputOutput", 0x3f, [], ["read-only"], [u'equipmentChassis'], [u'equipmentPoolPolicyRef'], [None])
