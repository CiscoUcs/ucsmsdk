...
class EquipmentPoolable(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentPoolable", "equipmentPoolable", "chassis-pool-[id]", VersionMeta.Version911z, "InputOutput", 0x3f, [], ["read-only"], [u'equipmentChassis'], [u'equipmentPoolPolicyRef'], [None])
    ...
    prop_meta = {
        ...
        "id": MoPropertyMeta("id", "id", "ulong", VersionMeta.Version911z, MoPropertyMeta.NAMING, 0x8, None, None, None, [], []), 
        "pool_dn": MoPropertyMeta("pool_dn", "poolDn", "string", VersionMeta.Version911z, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
