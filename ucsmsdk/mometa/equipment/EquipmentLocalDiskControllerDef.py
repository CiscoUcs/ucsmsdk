...
class EquipmentLocalDiskControllerDef(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentLocalDiskControllerDef", "equipmentLocalDiskControllerDef", "disk-controller", VersionMeta.Version131c, "InputOutput", 0x7fL, [], [""], [u'equipmentLocalDiskControllerCapProvider'], [], ["Get"])
