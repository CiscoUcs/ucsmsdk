...
class EquipmentNvmeDef(ManagedObject):
    ...
    prop_meta = {
        ...
        "m_switch_drive_index": MoPropertyMeta("m_switch_drive_index", "mSwitchDriveIndex", "ushort", None, MoPropertyMeta.READ_ONLY, None, None, None, None, [], ["0-65535"]), 
        "m_switch_sas_mixing_supported": MoPropertyMeta("m_switch_sas_mixing_supported", "mSwitchSasMixingSupported", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["false", "no", "true", "yes"], []), 
        "max_number_of_m_switch": MoPropertyMeta("max_number_of_m_switch", "maxNumberOfMSwitch", "ushort", None, MoPropertyMeta.READ_ONLY, None, None, None, None, [], ["0-65535"]), 
