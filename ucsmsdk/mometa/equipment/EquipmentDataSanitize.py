"""This module contains the general information for EquipmentDataSanitize ManagedObject."""
...
class EquipmentDataSanitizeConsts:
    pass


class EquipmentDataSanitize(ManagedObject):
    """This is EquipmentDataSanitize class."""

    consts = EquipmentDataSanitizeConsts()
    naming_props = set([])

    mo_meta = MoMeta("EquipmentDataSanitize", "equipmentDataSanitize", "datasanitize", VersionMeta.Version434a, "InputOutput", 0x1f, [], ["read-only"], ['equipmentBladeCapProvider', 'equipmentRackUnitCapProvider'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentDataSanitize", parent_mo_or_dn, **kwargs)
