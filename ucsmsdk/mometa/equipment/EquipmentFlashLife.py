...
class EquipmentFlashLife(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentFlashLife", "equipmentFlashLife", "[suport_type][card_param_type]", VersionMeta.Version222c, "InputOutput", 0x3ffL, [], [""], [u'equipmentLocalDiskControllerCapProvider'], [], ["Get"])

    prop_meta = {
        "card_param_type": MoPropertyMeta("card_param_type", "cardParamType", "uint", VersionMeta.Version222c, MoPropertyMeta.NAMING, 0x2L, None, None, None, [], []), 
        ...
        "suport_type": MoPropertyMeta("suport_type", "suportType", "uint", VersionMeta.Version222c, MoPropertyMeta.NAMING, 0x200L, None, None, None, [], []), 
    }
