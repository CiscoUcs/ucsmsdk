...
class EquipmentRackFanModuleDef(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentRackFanModuleDef", "equipmentRackFanModuleDef", "rack-fan-module", VersionMeta.Version212a, "InputOutput", 0xff, [], [""], ['equipmentRackUnitCapProvider'], ['equipmentFanPresenceDef'], [None])
