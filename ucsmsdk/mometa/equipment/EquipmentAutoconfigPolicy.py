...
class EquipmentAutoconfigPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentAutoconfigPolicy", "equipmentAutoconfigPolicy", "chassis-autoconfig-[name]", VersionMeta.Version911z, "InputOutput", 0x7ff, [], ["admin", "pn-policy"], [u'orgOrg'], [u'faultInst'], [None])
    ...
    prop_meta = {
        ...
        "src_templ_name": MoPropertyMeta("src_templ_name", "srcTemplName", "string", VersionMeta.Version911z, MoPropertyMeta.READ_WRITE, 0x200, None, None, None, [], []), 
        "status": MoPropertyMeta("status", "status", "string", VersionMeta.Version911z, MoPropertyMeta.READ_WRITE, 0x400, None, None, r"""((removed|created|modified|deleted),){0,3}(removed|created|modified|deleted){0,1}""", [], []), 
    }
