...
class EquipmentUnifiedPortCapProvider(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentUnifiedPortCapProvider", "equipmentUnifiedPortCapProvider", "unified-port-cap", VersionMeta.Version201m, "InputOutput", 0xff, [], [""], [u'equipmentGemCapProvider', u'equipmentSwitchCapProvider', u'equipmentSwitchIOCardCapProvider'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "fc_speed_cap": MoPropertyMeta("fc_speed_cap", "fcSpeedCap", "string", VersionMeta.Version311e, MoPropertyMeta.READ_ONLY, None, None, None, r"""((indeterminate|auto|defaultValue|1gbps|2gbps|16gbps|4gbps|8gbps),){0,7}(indeterminate|auto|defaultValue|1gbps|2gbps|16gbps|4gbps|8gbps){0,1}""", [], []), 
