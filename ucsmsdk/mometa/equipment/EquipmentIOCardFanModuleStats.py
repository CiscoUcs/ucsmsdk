"""This module contains the general information for EquipmentIOCardFanModuleStats ManagedObject."""
...
class EquipmentIOCardFanModuleStatsConsts:
...
class EquipmentIOCardFanModuleStats(ManagedObject):
    """This is EquipmentIOCardFanModuleStats class."""

    consts = EquipmentIOCardFanModuleStatsConsts()
    naming_props = set([])

    mo_meta = MoMeta("EquipmentIOCardFanModuleStats", "equipmentIOCardFanModuleStats", "", VersionMeta.Version432b, "OutputOnly", 0xf, [], ["admin", "operations", "read-only"], ['equipmentFanModule'], ['equipmentIOCardFanModuleStatsHist'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentIOCardFanModuleStats", parent_mo_or_dn, **kwargs)
