...
class EquipmentBladeSwitchConnDef(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentBladeSwitchConnDef", "equipmentBladeSwitchConnDef", "-switch-type-[switch_type]", VersionMeta.Version302c, "InputOutput", 0x1ffL, [], [""], [u'equipmentBladeConnDef'], [u'equipmentAdaptorConnDef'], [None])
    ...
    prop_meta = {
        ...
        "port_bandwidth": MoPropertyMeta("port_bandwidth", "portBandwidth", "string", VersionMeta.Version302c, MoPropertyMeta.READ_ONLY, None, None, None, None, ["10gbps", "1gbps", "20gbps", "40gbps", "indeterminate"], []), 
        ...
        "switch_type": MoPropertyMeta("switch_type", "switchType", "string", VersionMeta.Version302c, MoPropertyMeta.NAMING, 0x100L, 1, 510, None, [], []), 
    }
