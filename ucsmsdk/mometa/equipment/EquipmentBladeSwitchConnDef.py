...
class EquipmentBladeSwitchConnDef(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentBladeSwitchConnDef", "equipmentBladeSwitchConnDef", "-switch-type-[switch_type]", VersionMeta.Version302a, "InputOutput", 0x1ff, [], [""], [u'equipmentBladeConnDef'], [u'equipmentAdaptorConnDef'], [None])
    ...
    prop_meta = {
        ...
        "switch_type": MoPropertyMeta("switch_type", "switchType", "string", VersionMeta.Version302a, MoPropertyMeta.NAMING, 0x100, 1, 510, None, [], []), 
    }
