...
class EquipmentChassisProfileFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentChassisProfileFsmTask", "equipmentChassisProfileFsmTask", "task-[item]", VersionMeta.Version312b, "OutputOnly", 0xf, [], [""], [u'equipmentChassisProfile'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version312b, MoPropertyMeta.NAMING, None, None, None, None, ["Configure", "nop"], []), 
