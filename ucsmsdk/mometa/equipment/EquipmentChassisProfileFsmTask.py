...
class EquipmentChassisProfileFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentChassisProfileFsmTask", "equipmentChassisProfileFsmTask", "task-[item]", VersionMeta.Version911z, "OutputOnly", 0xf, [], [""], [u'equipmentChassisProfile'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version911z, MoPropertyMeta.NAMING, None, None, None, None, ["Configure", "nop"], []), 
