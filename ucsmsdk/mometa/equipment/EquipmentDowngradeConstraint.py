...
class EquipmentDowngradeConstraint(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentDowngradeConstraint", "equipmentDowngradeConstraint", "fw-dngrd-constr", VersionMeta.Version213a, "InputOutput", 0x1fL, [], [""], [u'equipmentBoardControllerDef'], [], ["Get"])
