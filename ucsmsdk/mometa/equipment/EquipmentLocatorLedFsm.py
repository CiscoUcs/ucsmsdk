...
class EquipmentLocatorLedFsm(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentLocatorLedFsm", "equipmentLocatorLedFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'equipmentLocatorLed'], [u'equipmentLocatorLedFsmStage'], [None])
