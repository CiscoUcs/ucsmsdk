"""This module contains the general information for EquipmentLocatorLedFsm ManagedObject."""
import sys, os
...
class EquipmentLocatorLedFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_SET_DISK_LOCATOR_LED = "SetDiskLocatorLed"
    CURRENT_FSM_SET_FE_LOCATOR_LED = "SetFeLocatorLed"
    CURRENT_FSM_SET_FI_LOCATOR_LED = "SetFiLocatorLed"
    CURRENT_FSM_SET_LOCATOR_LED = "SetLocatorLed"
    CURRENT_FSM_NOP = "nop"
...
class EquipmentLocatorLedFsm(ManagedObject):
    """This is EquipmentLocatorLedFsm class."""

    consts = EquipmentLocatorLedFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("EquipmentLocatorLedFsm", "equipmentLocatorLedFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'equipmentLocatorLed'], [u'equipmentLocatorLedFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["SetDiskLocatorLed", "SetFeLocatorLed", "SetFiLocatorLed", "SetLocatorLed", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentLocatorLedFsm", parent_mo_or_dn, **kwargs)
