...
class EquipmentIOCardStats(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentIOCardStats", "equipmentIOCardStats", "stats", VersionMeta.Version111j, "OutputOnly", 0x7L, [], ["admin", "operations", "read-only"], [u'equipmentIOCard', u'equipmentSwitchIOCard'], [u'equipmentIOCardStatsHist'], ["Get"])
    ...
    prop_meta = {
        ...
        "temp_max": MoPropertyMeta("temp_max", "tempMax", "string", VersionMeta.Version131c, MoPropertyMeta.READ_ONLY, None, None, None, None, ["not-applicable"], ["0-4294967295"]), 
        "temp_min": MoPropertyMeta("temp_min", "tempMin", "string", VersionMeta.Version131c, MoPropertyMeta.READ_ONLY, None, None, None, None, ["not-applicable"], ["0-4294967295"]), 
