...
class EquipmentIOCardBaseFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentIOCardBaseFsmTask", "equipmentIOCardBaseFsmTask", "task-[item]", VersionMeta.Version302a, "OutputOnly", 0x7L, [], [""], [u'equipmentIOCard', u'equipmentSwitchIOCard'], [], [None])
