...
class EquipmentIOCardBaseFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentIOCardBaseFsmTask", "equipmentIOCardBaseFsmTask", "task-[item]", VersionMeta.Version302c, "OutputOnly", 0xfL, [], [""], [u'equipmentIOCard', u'equipmentSwitchIOCard'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version302c, MoPropertyMeta.NAMING, None, None, None, None, ["FeConn", "FePresence", "nop"], []), 
