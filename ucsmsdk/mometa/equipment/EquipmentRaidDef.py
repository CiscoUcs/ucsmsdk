...
class EquipmentRaidDef(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentRaidDef", "equipmentRaidDef", "[level]", VersionMeta.Version141i, "InputOutput", 0xffL, [], [""], [u'equipmentLocalDiskControllerCapProvider'], [], ["Get"])
