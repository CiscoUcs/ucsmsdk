...
class EquipmentRaidDef(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentRaidDef", "equipmentRaidDef", "[level]", VersionMeta.Version141i, "InputOutput", 0x1ffL, [], [""], [u'equipmentLocalDiskControllerCapProvider'], [], ["Get"])
