"""This module contains the general information for EquipmentChassisProfileFsm ManagedObject."""
...
class EquipmentChassisProfileFsmConsts:
    COMPLETION_TIME_ = ""
...
class EquipmentChassisProfileFsm(ManagedObject):
    """This is EquipmentChassisProfileFsm class."""

    consts = EquipmentChassisProfileFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("EquipmentChassisProfileFsm", "equipmentChassisProfileFsm", "fsm", VersionMeta.Version911z, "OutputOnly", 0xf, [], [""], [u'equipmentChassisProfile'], [u'equipmentChassisProfileFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version911z, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Configure", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentChassisProfileFsm", parent_mo_or_dn, **kwargs)
