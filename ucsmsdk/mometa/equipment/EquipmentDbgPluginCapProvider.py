"""This module contains the general information for EquipmentDbgPluginCapProvider ManagedObject."""
...
class EquipmentDbgPluginCapProviderConsts:
    DELETED_FALSE = "false"
    DELETED_NO = "no"
    DELETED_TRUE = "true"
    DELETED_YES = "yes"
...
class EquipmentDbgPluginCapProvider(ManagedObject):
    """This is EquipmentDbgPluginCapProvider class."""

    consts = EquipmentDbgPluginCapProviderConsts()
    naming_props = set([u'vendor', u'model', u'revision'])

    mo_meta = MoMeta("EquipmentDbgPluginCapProvider", "equipmentDbgPluginCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version141i, "InputOutput", 0x1ff, [], [""], [u'capabilityCatalogue', u'equipmentHwCapDerivativeProvider'], [u'equipmentFruVariant', u'equipmentManufacturingDef', u'equipmentPhysicalDef', u'equipmentPicture', u'equipmentServiceDef', u'equipmentSlotArray', u'equipmentSlotArrayRef', u'equipmentStorageControllerConfig', u'firmwareConstraints', u'firmwareType', u'firmwareUpgradeConstraint'], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, vendor, model, revision, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentDbgPluginCapProvider", parent_mo_or_dn, **kwargs)
