"""This module contains the general information for EquipmentAutoNegotiateCap ManagedObject."""
...
class EquipmentAutoNegotiateCapConsts:
    INT_ID_NONE = "none"
...
class EquipmentAutoNegotiateCap(ManagedObject):
    """This is EquipmentAutoNegotiateCap class."""

    consts = EquipmentAutoNegotiateCapConsts()
    naming_props = set([])

    mo_meta = MoMeta("EquipmentAutoNegotiateCap", "equipmentAutoNegotiateCap", "auto-negotiate-cap", VersionMeta.Version311e, "InputOutput", 0xff, [], [""], [u'equipmentSwitchCapProvider'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentAutoNegotiateCap", parent_mo_or_dn, **kwargs)
