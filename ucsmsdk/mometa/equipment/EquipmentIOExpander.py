"""This module contains the general information for EquipmentIOExpander ManagedObject."""
...
class EquipmentIOExpanderConsts:
...
class EquipmentIOExpander(ManagedObject):
    """This is EquipmentIOExpander class."""

    consts = EquipmentIOExpanderConsts()
    naming_props = set([u'id'])

    mo_meta = MoMeta("EquipmentIOExpander", "equipmentIOExpander", "io-expander-[id]", VersionMeta.Version911z, "InputOutput", 0x3f, [], ["read-only"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit'], [], [None])
    ...
    prop_meta = {
        ...
        "location_dn": MoPropertyMeta("location_dn", "locationDn", "string", VersionMeta.Version911z, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
    ...
    def __init__(self, parent_mo_or_dn, id, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentIOExpander", parent_mo_or_dn, **kwargs)
