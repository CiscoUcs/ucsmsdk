...
class EquipmentIOCardBaseFsm(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentIOCardBaseFsm", "equipmentIOCardBaseFsm", "fsm", VersionMeta.Version302a, "OutputOnly", 0x7L, [], [""], [u'equipmentIOCard', u'equipmentSwitchIOCard'], [u'equipmentIOCardBaseFsmStage'], [None])
