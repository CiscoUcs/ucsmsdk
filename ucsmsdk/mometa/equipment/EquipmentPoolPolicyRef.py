...
class EquipmentPoolPolicyRef(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentPoolPolicyRef", "equipmentPoolPolicyRef", "chassis-poolref-[id]", VersionMeta.Version312b, "InputOutput", 0x3f, [], ["read-only"], [u'equipmentPoolable'], [], [None])
