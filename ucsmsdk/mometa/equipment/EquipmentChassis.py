...
class EquipmentChassis(ManagedObject):
    ...
    prop_meta = {
        ...
        "fan_speed_config_state": MoPropertyMeta("fan_speed_config_state", "fanSpeedConfigState", "string", VersionMeta.Version411a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Balanced", "Low Power"], []),
