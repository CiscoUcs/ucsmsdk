...
class EquipmentIOCardFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentIOCardFsmTask", "equipmentIOCardFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0x7L, [], [""], [u'equipmentIOCard'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, None, None, None, None, ["Evacuate", "FeConn", "FePresence", "ResetCmc", "ResetEvacuate", "ResetIom", "muxOffline", "nop"], []), 
