...
class EquipmentPsuInputStatsHist(ManagedObject):
    """This is EquipmentPsuInputStatsHist class."""

    consts = EquipmentPsuInputStatsHistConsts()
    naming_props = set([u'id'])

    mo_meta = MoMeta("EquipmentPsuInputStatsHist", "equipmentPsuInputStatsHist", "[id]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], ["read-only"], [u'equipmentPsuInputStats'], [], ["Get"])
