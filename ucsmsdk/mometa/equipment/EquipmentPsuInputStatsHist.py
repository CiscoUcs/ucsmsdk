...
class EquipmentPsuInputStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentPsuInputStatsHist", "equipmentPsuInputStatsHist", "[id]", VersionMeta.Version111j, "OutputOnly", 0x7L, [], ["read-only"], [u'equipmentPsuInputStats'], [], ["Get"])
