...
class EquipmentChassisAssocCtx(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentChassisAssocCtx", "equipmentChassisAssocCtx", "cp-assoc-ctx", VersionMeta.Version911z, "InputOutput", 0x1f, [], ["read-only"], [u'equipmentChassisProfileAssocCtx'], [], [None])
    ...
    prop_meta = {
        ...
        "fru_cap_dn": MoPropertyMeta("fru_cap_dn", "fruCapDn", "string", VersionMeta.Version911z, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
