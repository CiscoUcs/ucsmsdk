...
class EquipmentDiagFeatureSupport(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentDiagFeatureSupport", "equipmentDiagFeatureSupport", "diag-feature-support", VersionMeta.Version323a, "InputOutput", 0xff, [], ["read-only"], [u'equipmentRackUnitCapProvider'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "is_supported": MoPropertyMeta("is_supported", "isSupported", "string", VersionMeta.Version323a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["no", "yes"], []), 
