...
class EquipmentDiagFeatureSupport(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentDiagFeatureSupport", "equipmentDiagFeatureSupport", "diag-feature-support", VersionMeta.Version323a, "InputOutput", 0xff, [], ["read-only"], ['equipmentRackUnitCapProvider'], [], ["Get"])
