"""This module contains the general information for EquipmentBladeAGLibrary ManagedObject."""
import sys, os
...
class EquipmentBladeAGLibraryConsts():
    INT_ID_NONE = "none"
...
class EquipmentBladeAGLibrary(ManagedObject):
    """This is EquipmentBladeAGLibrary class."""

    consts = EquipmentBladeAGLibraryConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("EquipmentBladeAGLibrary", "equipmentBladeAGLibrary", "library-[name]", VersionMeta.Version141i, "InputOutput", 0xffL, [], [""], [u'equipmentBladeCapProvider', u'equipmentRackUnitCapProvider', u'equipmentServerUnitCapProvider'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x10L, 1, 256, None, [], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentBladeAGLibrary", parent_mo_or_dn, **kwargs)
