...
class EquipmentFexPowerSummaryHist(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentFexPowerSummaryHist", "equipmentFexPowerSummaryHist", "[id]", VersionMeta.Version141i, "OutputOnly", 0x7L, [], ["read-only"], [u'equipmentFexPowerSummary'], [], ["Get"])
