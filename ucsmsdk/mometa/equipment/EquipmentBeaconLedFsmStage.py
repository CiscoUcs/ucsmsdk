"""This module contains the general information for EquipmentBeaconLedFsmStage ManagedObject."""
import sys, os
...
class EquipmentBeaconLedFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_ILLUMINATE_BEGIN = "IlluminateBegin"
    NAME_ILLUMINATE_EXECUTE_A = "IlluminateExecuteA"
    NAME_ILLUMINATE_EXECUTE_B = "IlluminateExecuteB"
    NAME_ILLUMINATE_FAIL = "IlluminateFail"
    NAME_ILLUMINATE_SUCCESS = "IlluminateSuccess"
    NAME_NOP = "nop"
...
class EquipmentBeaconLedFsmStage(ManagedObject):
    """This is EquipmentBeaconLedFsmStage class."""

    consts = EquipmentBeaconLedFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("EquipmentBeaconLedFsmStage", "equipmentBeaconLedFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'equipmentBeaconLedFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["IlluminateBegin", "IlluminateExecuteA", "IlluminateExecuteB", "IlluminateFail", "IlluminateSuccess", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentBeaconLedFsmStage", parent_mo_or_dn, **kwargs)
