...
class EquipmentPsuFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentPsuFsmStage", "equipmentPsuFsmStage", "stage-[name]", VersionMeta.Version302c, "OutputOnly", 0xfL, [], [""], [u'equipmentPsuFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version302c, MoPropertyMeta.NAMING, None, None, None, None, ["UpdatePSUActivatePsu", "UpdatePSUBegin", "UpdatePSUFail", "UpdatePSUPollActivateStatus", "UpdatePSUPollUpdateStatus", "UpdatePSUSuccess", "UpdatePSUUpdateRequest", "nop"], []), 
