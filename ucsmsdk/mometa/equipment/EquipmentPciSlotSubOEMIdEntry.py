...
class EquipmentPciSlotSubOEMIdEntry(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentPciSlotSubOEMIdEntry", "equipmentPciSlotSubOEMIdEntry", "pci-slot-suboemid-entry-[name]", VersionMeta.Version911z, "InputOutput", 0x3f, [], [""], [u'equipmentStorageControllerConfig'], [], [None])
    ...
    prop_meta = {
        ...
        "sub_oem_id": MoPropertyMeta("sub_oem_id", "subOemId", "string", VersionMeta.Version911z, MoPropertyMeta.READ_ONLY, None, None, None, None, ["undefined"], ["0-4294967295"]), 
    }
