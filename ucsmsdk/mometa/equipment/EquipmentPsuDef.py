...
class EquipmentPsuDef(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentPsuDef", "equipmentPsuDef", "[psu_type]", VersionMeta.Version201m, "InputOutput", 0xffL, [], [""], [u'equipmentPsuCapProvider'], [], ["Get"])

    prop_meta = {
        "psu_type": MoPropertyMeta("psu_type", "PsuType", "string", VersionMeta.Version201m, MoPropertyMeta.NAMING, 0x1L, 1, 510, None, [], []), 
