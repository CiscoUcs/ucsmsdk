...
class EquipmentBiosTokenOverride(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentBiosTokenOverride", "equipmentBiosTokenOverride", "bios-token-override-[bios_token_id]", None, "InputOutput", 0x1ff, [], ["read-only"], [u'equipmentRackUnitCapProvider'], [], [None])

    prop_meta = {
        "bios_token_id": MoPropertyMeta("bios_token_id", "biosTokenId", "string", None, MoPropertyMeta.NAMING, 0x2, None, None, None, ["bios-vftpm", "memory-mapped-above-4gb", "none", "option-rom"], []), 
        "bios_token_name": MoPropertyMeta("bios_token_name", "biosTokenName", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        "bios_token_value": MoPropertyMeta("bios_token_value", "biosTokenValue", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
