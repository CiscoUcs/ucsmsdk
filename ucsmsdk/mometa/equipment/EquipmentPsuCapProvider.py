"""This module contains the general information for EquipmentPsuCapProvider ManagedObject."""
import sys, os
...
class EquipmentPsuCapProviderConsts():
    DELETED_FALSE = "false"
    DELETED_NO = "no"
    DELETED_TRUE = "true"
    DELETED_YES = "yes"
...
class EquipmentPsuCapProvider(ManagedObject):
    ...
    def __init__(self, parent_mo_or_dn, vendor, model, revision, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentPsuCapProvider", parent_mo_or_dn, **kwargs)
