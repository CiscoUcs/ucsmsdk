...
class EquipmentComputeConn(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentComputeConn", "equipmentComputeConn", "compute-conn", None, "InputOutput", 0x1f, [], ["read-only"], [u'equipmentChassis'], [u'faultInst'], [None])
    ...
    prop_meta = {
        ...
        "server_sioc_connectivity": MoPropertyMeta("server_sioc_connectivity", "serverSiocConnectivity", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["single-server-dual-sioc", "single-server-single-sioc"], []), 
