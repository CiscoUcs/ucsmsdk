"""This module contains the general information for EquipmentPciSlotIdMapping ManagedObject."""
...
class EquipmentPciSlotIdMappingConsts:
    INT_ID_NONE = "none"
...
class EquipmentPciSlotIdMapping(ManagedObject):
    """This is EquipmentPciSlotIdMapping class."""

    consts = EquipmentPciSlotIdMappingConsts()
    naming_props = set([])

    mo_meta = MoMeta("EquipmentPciSlotIdMapping", "equipmentPciSlotIdMapping", "pci-slotid-mapping", VersionMeta.Version911z, "InputOutput", 0xff, [], [""], [u'equipmentBladeCapProvider', u'equipmentRackUnitCapProvider'], [u'equipmentPciSlotIdEntry'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentPciSlotIdMapping", parent_mo_or_dn, **kwargs)
