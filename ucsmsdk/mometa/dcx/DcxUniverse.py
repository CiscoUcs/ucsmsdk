...
class DcxUniverse(ManagedObject):
    ...
    consts = DcxUniverseConsts()
    naming_props = set([])

    mo_meta = MoMeta("DcxUniverse", "dcxUniverse", "dcxns", VersionMeta.Version101e, "InputOutput", 0x1fL, [], ["read-only"], [u'fabricEp'], [u'dcxVifEp'], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "DcxUniverse", parent_mo_or_dn, **kwargs)
