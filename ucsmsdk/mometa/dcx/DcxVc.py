...
class DcxVc(ManagedObject):
    ...
    mo_meta = MoMeta("DcxVc", "dcxVc", "vc-[id]", VersionMeta.Version101e, "InputOutput", 0x3fL, [], ["read-only"], [u'fabricLocale', u'fabricPath', u'swEthLanFlowMon', u'swEthMon', u'swFcMon'], [u'faultInst', u'swCmclan', u'swNetflowMonitorRef', u'swUlan', u'swVlan', u'swVsan'], ["Get"])
    ...
    prop_meta = {
        ...
        "vnic": MoPropertyMeta("vnic", "vnic", "string", VersionMeta.Version101e, MoPropertyMeta.READ_ONLY, None, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
    }
