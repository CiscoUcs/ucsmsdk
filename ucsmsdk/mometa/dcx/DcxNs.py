...
class DcxNs(ManagedObject):
    ...
    mo_meta = MoMeta("DcxNs", "dcxNs", "dcxns-[switch_id]", VersionMeta.Version101e, "InputOutput", 0x1fL, [], ["read-only"], [u'adaptorUnit'], [u'faultInst'], ["Get"])
    ...
    prop_meta = {
        ...
        "switch_id": MoPropertyMeta("switch_id", "switchId", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x10L, None, None, None, ["A", "B", "NONE"], []), 
