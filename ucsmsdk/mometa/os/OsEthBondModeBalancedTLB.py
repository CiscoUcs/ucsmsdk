...
class OsEthBondModeBalancedTLB(ManagedObject):
    ...
    mo_meta = MoMeta("OsEthBondModeBalancedTLB", "osEthBondModeBalancedTLB", "eth-bond-mode", VersionMeta.Version302c, "InputOutput", 0x3fL, [], ["read-only"], [u'osEthBondIntf'], [u'osPrimarySlave'], [None])
    ...
    prop_meta = {
        ...
        "lp_interval": MoPropertyMeta("lp_interval", "lpInterval", "uint", VersionMeta.Version302c, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
