...
class OsControllerFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("OsControllerFsmTask", "osControllerFsmTask", "task-[item]", VersionMeta.Version302a, "OutputOnly", 0x7L, [], [""], [u'osController'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version302a, MoPropertyMeta.NAMING, None, None, None, None, ["DeployOS", "nop"], []), 
