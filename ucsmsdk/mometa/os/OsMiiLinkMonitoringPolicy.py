...
class OsMiiLinkMonitoringPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("OsMiiLinkMonitoringPolicy", "osMiiLinkMonitoringPolicy", "link-mon-pol", VersionMeta.Version302c, "InputOutput", 0x3fL, [], ["read-only"], [u'osEthBondIntf'], [], [None])
    ...
    prop_meta = {
        ...
        "link_down_delay": MoPropertyMeta("link_down_delay", "linkDownDelay", "uint", VersionMeta.Version302c, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        ...
        "link_up_delay": MoPropertyMeta("link_up_delay", "linkUpDelay", "uint", VersionMeta.Version302c, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
