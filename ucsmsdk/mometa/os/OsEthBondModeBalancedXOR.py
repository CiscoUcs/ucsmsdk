...
class OsEthBondModeBalancedXOR(ManagedObject):
    ...
    mo_meta = MoMeta("OsEthBondModeBalancedXOR", "osEthBondModeBalancedXOR", "eth-bond-mode", VersionMeta.Version302c, "InputOutput", 0x3fL, [], ["read-only"], [u'osEthBondIntf'], [u'osPrimarySlave'], [None])
