...
class OsEthBondModeBalancedXOR(ManagedObject):
    ...
    mo_meta = MoMeta("OsEthBondModeBalancedXOR", "osEthBondModeBalancedXOR", "eth-bond-mode", VersionMeta.Version302a, "InputOutput", 0x1fL, [], ["read-only"], [u'osEthBondIntf'], [u'osPrimarySlave'], [None])
