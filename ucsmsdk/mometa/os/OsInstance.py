...
class OsInstance(ManagedObject):
    ...
    mo_meta = MoMeta("OsInstance", "osInstance", "os", VersionMeta.Version101e, "InputOutput", 0x1fL, [], ["read-only"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit'], [u'osEthBondIntf', u'osEthIntf', u'storageEthLif'], ["Get"])
    ...
    prop_meta = {
        ...
        "sme_version": MoPropertyMeta("sme_version", "smeVersion", "string", VersionMeta.Version302c, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
