...
class OsControllerConsts():
    ...
    FSM_PREV_DEPLOY_OSBEGIN = "DeployOSBegin"
    FSM_PREV_DEPLOY_OSCOPY_REMOTE = "DeployOSCopyRemote"
    FSM_PREV_DEPLOY_OSDELETE_CURL_DOWNLOADED_IMAGES = "DeployOSDeleteCurlDownloadedImages"
    FSM_PREV_DEPLOY_OSDOWNLOAD_IMAGES = "DeployOSDownloadImages"
    FSM_PREV_DEPLOY_OSFAIL = "DeployOSFail"
    FSM_PREV_DEPLOY_OSHOST_BIOS_POST_COMPLETION = "DeployOSHostBiosPostCompletion"
    FSM_PREV_DEPLOY_OSHOST_BMC_PRE_CONFIG_LOCAL = "DeployOSHostBmcPreConfigLocal"
    FSM_PREV_DEPLOY_OSHOST_BMC_PRE_CONFIG_PEER = "DeployOSHostBmcPreConfigPeer"
    FSM_PREV_DEPLOY_OSHOST_BOOT = "DeployOSHostBoot"
    FSM_PREV_DEPLOY_OSHOST_BOOT_FOR_UPGRADE = "DeployOSHostBootForUpgrade"
    FSM_PREV_DEPLOY_OSHOST_BOOT_WAIT = "DeployOSHostBootWait"
    FSM_PREV_DEPLOY_OSHOST_CLEAR_OS_INSTALL_STATUS = "DeployOSHostClearOsInstallStatus"
    FSM_PREV_DEPLOY_OSHOST_POST_FIRST_BOOT = "DeployOSHostPostFirstBoot"
    FSM_PREV_DEPLOY_OSHOST_POST_INSTALL = "DeployOSHostPostInstall"
    FSM_PREV_DEPLOY_OSHOST_POST_UPGRADE = "DeployOSHostPostUpgrade"
    FSM_PREV_DEPLOY_OSHOST_PRE_FIRST_BOOT = "DeployOSHostPreFirstBoot"
    FSM_PREV_DEPLOY_OSHOST_PRE_INSTALL = "DeployOSHostPreInstall"
    FSM_PREV_DEPLOY_OSHOST_READ_SMBIOS = "DeployOSHostReadSmbios"
    FSM_PREV_DEPLOY_OSHOST_SERIAL_DEBUG_CONNECT = "DeployOSHostSerialDebugConnect"
    FSM_PREV_DEPLOY_OSHOST_SERIAL_DEBUG_DISCONNECT = "DeployOSHostSerialDebugDisconnect"
    FSM_PREV_DEPLOY_OSHOST_SETUP_VMEDIA_LOCAL = "DeployOSHostSetupVmediaLocal"
    FSM_PREV_DEPLOY_OSHOST_SETUP_VMEDIA_PEER = "DeployOSHostSetupVmediaPeer"
    FSM_PREV_DEPLOY_OSHOST_SOL_REDIRECT_DISABLE = "DeployOSHostSolRedirectDisable"
    FSM_PREV_DEPLOY_OSHOST_SOL_REDIRECT_ENABLE = "DeployOSHostSolRedirectEnable"
    FSM_PREV_DEPLOY_OSHOST_TEARDOWN_VMEDIA_LOCAL = "DeployOSHostTeardownVmediaLocal"
    FSM_PREV_DEPLOY_OSHOST_TEARDOWN_VMEDIA_PEER = "DeployOSHostTeardownVmediaPeer"
    FSM_PREV_DEPLOY_OSSUCCESS = "DeployOSSuccess"
    FSM_PREV_DEPLOY_OSWAIT_FOR_SMECONNECTION = "DeployOSWaitForSMEConnection"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_DEPLOY_OSBEGIN = "DeployOSBegin"
    FSM_STATUS_DEPLOY_OSCOPY_REMOTE = "DeployOSCopyRemote"
    FSM_STATUS_DEPLOY_OSDELETE_CURL_DOWNLOADED_IMAGES = "DeployOSDeleteCurlDownloadedImages"
    FSM_STATUS_DEPLOY_OSDOWNLOAD_IMAGES = "DeployOSDownloadImages"
    FSM_STATUS_DEPLOY_OSFAIL = "DeployOSFail"
    FSM_STATUS_DEPLOY_OSHOST_BIOS_POST_COMPLETION = "DeployOSHostBiosPostCompletion"
    FSM_STATUS_DEPLOY_OSHOST_BMC_PRE_CONFIG_LOCAL = "DeployOSHostBmcPreConfigLocal"
    FSM_STATUS_DEPLOY_OSHOST_BMC_PRE_CONFIG_PEER = "DeployOSHostBmcPreConfigPeer"
    FSM_STATUS_DEPLOY_OSHOST_BOOT = "DeployOSHostBoot"
    FSM_STATUS_DEPLOY_OSHOST_BOOT_FOR_UPGRADE = "DeployOSHostBootForUpgrade"
    FSM_STATUS_DEPLOY_OSHOST_BOOT_WAIT = "DeployOSHostBootWait"
    FSM_STATUS_DEPLOY_OSHOST_CLEAR_OS_INSTALL_STATUS = "DeployOSHostClearOsInstallStatus"
    FSM_STATUS_DEPLOY_OSHOST_POST_FIRST_BOOT = "DeployOSHostPostFirstBoot"
    FSM_STATUS_DEPLOY_OSHOST_POST_INSTALL = "DeployOSHostPostInstall"
    FSM_STATUS_DEPLOY_OSHOST_POST_UPGRADE = "DeployOSHostPostUpgrade"
    FSM_STATUS_DEPLOY_OSHOST_PRE_FIRST_BOOT = "DeployOSHostPreFirstBoot"
    FSM_STATUS_DEPLOY_OSHOST_PRE_INSTALL = "DeployOSHostPreInstall"
    FSM_STATUS_DEPLOY_OSHOST_READ_SMBIOS = "DeployOSHostReadSmbios"
    FSM_STATUS_DEPLOY_OSHOST_SERIAL_DEBUG_CONNECT = "DeployOSHostSerialDebugConnect"
    FSM_STATUS_DEPLOY_OSHOST_SERIAL_DEBUG_DISCONNECT = "DeployOSHostSerialDebugDisconnect"
    FSM_STATUS_DEPLOY_OSHOST_SETUP_VMEDIA_LOCAL = "DeployOSHostSetupVmediaLocal"
    FSM_STATUS_DEPLOY_OSHOST_SETUP_VMEDIA_PEER = "DeployOSHostSetupVmediaPeer"
    FSM_STATUS_DEPLOY_OSHOST_SOL_REDIRECT_DISABLE = "DeployOSHostSolRedirectDisable"
    FSM_STATUS_DEPLOY_OSHOST_SOL_REDIRECT_ENABLE = "DeployOSHostSolRedirectEnable"
    FSM_STATUS_DEPLOY_OSHOST_TEARDOWN_VMEDIA_LOCAL = "DeployOSHostTeardownVmediaLocal"
    FSM_STATUS_DEPLOY_OSHOST_TEARDOWN_VMEDIA_PEER = "DeployOSHostTeardownVmediaPeer"
    FSM_STATUS_DEPLOY_OSSUCCESS = "DeployOSSuccess"
    FSM_STATUS_DEPLOY_OSWAIT_FOR_SMECONNECTION = "DeployOSWaitForSMEConnection"
    FSM_STATUS_NOP = "nop"
    TYPE_LINUX = "Linux"
    TYPE_PNU_OS = "PnuOS"
...
class OsController(ManagedObject):
    ...
    mo_meta = MoMeta("OsController", "osController", "os-ctrl", VersionMeta.Version302a, "InputOutput", 0xfL, [], ["read-only"], [u'storageProcessor'], [u'eventInst', u'faultInst', u'firmwareBootDefinition', u'firmwareFileUnit', u'firmwareImageLock', u'firmwareRunning', u'osControllerFsm', u'osControllerFsmTask'], [None])
    ...
    prop_meta = {
        ...
        "deploy_state": MoPropertyMeta("deploy_state", "deployState", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["complete", "failed", "in-progress", "retry", "throttled", "undefined", "undeployed"], []), 
        ...
        "hostname": MoPropertyMeta("hostname", "hostname", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        "pn_dn": MoPropertyMeta("pn_dn", "pnDn", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Linux", "PnuOS", "Solaris", "VMWareESX", "Windows", "unspecified"], []), 
    }
