...
class OsController(ManagedObject):
    ...
    mo_meta = MoMeta("OsController", "osController", "os-ctrl", VersionMeta.Version302c, "InputOutput", 0x1fL, [], ["read-only"], [u'storageProcessor'], [u'eventInst', u'faultInst', u'firmwareBootDefinition', u'firmwareFileUnit', u'firmwareImageLock', u'firmwareRunning', u'osControllerFsm', u'osControllerFsmTask'], [None])
    ...
    prop_meta = {
        ...
        "deploy_state": MoPropertyMeta("deploy_state", "deployState", "string", VersionMeta.Version302c, MoPropertyMeta.READ_ONLY, None, None, None, None, ["complete", "failed", "in-progress", "retry", "throttled", "undefined", "undeployed"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version302c, MoPropertyMeta.INTERNAL, None, None, None, None, ["DeployOSBegin", "DeployOSCopyRemote", "DeployOSDeleteCurlDownloadedImages", "DeployOSDownloadImages", "DeployOSFail", "DeployOSHostBiosPostCompletion", "DeployOSHostBmcPreConfigLocal", "DeployOSHostBmcPreConfigPeer", "DeployOSHostBoot", "DeployOSHostBootForUpgrade", "DeployOSHostBootWait", "DeployOSHostClearOsInstallStatus", "DeployOSHostPostFirstBoot", "DeployOSHostPostInstall", "DeployOSHostPostUpgrade", "DeployOSHostPreFirstBoot", "DeployOSHostPreInstall", "DeployOSHostReadSmbios", "DeployOSHostSerialDebugConnect", "DeployOSHostSerialDebugDisconnect", "DeployOSHostSetupVmediaLocal", "DeployOSHostSetupVmediaPeer", "DeployOSHostSolRedirectDisable", "DeployOSHostSolRedirectEnable", "DeployOSHostTeardownVmediaLocal", "DeployOSHostTeardownVmediaPeer", "DeployOSSuccess", "DeployOSWaitForSMEConnection", "nop"], []), 
        "fsm_try": MoPropertyMeta("fsm_try", "fsmTry", "byte", VersionMeta.Version302c, MoPropertyMeta.INTERNAL, None, None, None, None, [], []), 
        "hostname": MoPropertyMeta("hostname", "hostname", "string", VersionMeta.Version302c, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version302c, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version302c, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Linux", "PnuOS", "Solaris", "VMWareESX", "Windows", "unspecified"], []), 
    }
