...
class OsEthBondModeBalancedALB(ManagedObject):
    ...
    mo_meta = MoMeta("OsEthBondModeBalancedALB", "osEthBondModeBalancedALB", "eth-bond-mode", VersionMeta.Version302c, "InputOutput", 0x3f, [], ["read-only"], ['osEthBondIntf'], ['osPrimarySlave'], [None])
