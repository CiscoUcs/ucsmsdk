...
class OsEthBondModeBalancedALB(ManagedObject):
    ...
    mo_meta = MoMeta("OsEthBondModeBalancedALB", "osEthBondModeBalancedALB", "eth-bond-mode", VersionMeta.Version302a, "InputOutput", 0x1fL, [], ["read-only"], [u'osEthBondIntf'], [u'osPrimarySlave'], [None])
