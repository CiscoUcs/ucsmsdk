...
class OsARPTarget(ManagedObject):
    ...
    mo_meta = MoMeta("OsARPTarget", "osARPTarget", "arp-target-[name]", VersionMeta.Version302a, "InputOutput", 0x1fL, [], ["read-only"], [u'osARPLinkMonitoringPolicy'], [], [None])
    ...
    prop_meta = {
        ...
        "host_name": MoPropertyMeta("host_name", "hostName", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
