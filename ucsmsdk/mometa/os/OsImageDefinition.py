"""This module contains the general information for OsImageDefinition ManagedObject."""
import sys, os
...
class OsImageDefinitionConsts():
    pass


class OsImageDefinition(ManagedObject):
    """This is OsImageDefinition class."""

    consts = OsImageDefinitionConsts()
    naming_props = set([])

    mo_meta = MoMeta("OsImageDefinition", "osImageDefinition", "imagedef", VersionMeta.Version302c, "InputOutput", 0x1fL, [], ["read-only"], [u'computeBlade', u'computeRackUnit'], [u'firmwareBootDefinition'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "OsImageDefinition", parent_mo_or_dn, **kwargs)
