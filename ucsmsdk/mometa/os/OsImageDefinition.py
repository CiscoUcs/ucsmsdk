...
class OsImageDefinition(ManagedObject):
    ...
    mo_meta = MoMeta("OsImageDefinition", "osImageDefinition", "imagedef", VersionMeta.Version302a, "InputOutput", 0xfL, [], ["read-only"], [u'computeBlade', u'computeRackUnit'], [u'firmwareBootDefinition'], [None])
