...
class OsEthIntf(ManagedObject):
    ...
    mo_meta = MoMeta("OsEthIntf", "osEthIntf", "intf-[name]", VersionMeta.Version302c, "InputOutput", 0x3f, [], ["read-only"], ['osEthBondIntf', 'osInstance'], [], [None])
    ...
    prop_meta = {
        ...
        "mtu": MoPropertyMeta("mtu", "mtu", "uint", VersionMeta.Version302c, MoPropertyMeta.READ_ONLY, None, None, None, None, [], ["1500-9158"]),
