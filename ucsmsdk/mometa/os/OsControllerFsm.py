...
class OsControllerFsm(ManagedObject):
    ...
    mo_meta = MoMeta("OsControllerFsm", "osControllerFsm", "fsm", VersionMeta.Version302c, "OutputOnly", 0xfL, [], [""], [u'osController'], [u'osControllerFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version302c, MoPropertyMeta.READ_ONLY, None, None, None, None, ["DeployOS", "nop"], []), 
