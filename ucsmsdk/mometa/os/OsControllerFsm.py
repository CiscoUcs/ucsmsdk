"""This module contains the general information for OsControllerFsm ManagedObject."""
import sys, os
...
class OsControllerFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_DEPLOY_OS = "DeployOS"
    CURRENT_FSM_NOP = "nop"
...
class OsControllerFsm(ManagedObject):
    """This is OsControllerFsm class."""

    consts = OsControllerFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("OsControllerFsm", "osControllerFsm", "fsm", VersionMeta.Version302a, "OutputOnly", 0x7L, [], [""], [u'osController'], [u'osControllerFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["DeployOS", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "OsControllerFsm", parent_mo_or_dn, **kwargs)
