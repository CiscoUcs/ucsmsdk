...
class ControllerOperationalVersionHolder(ManagedObject):
    ...
    mo_meta = MoMeta("ControllerOperationalVersionHolder", "controllerOperationalVersionHolder", "OpVersHolder-[serial]", VersionMeta.Version312b, "InputOutput", 0x3f, [], ["read-only"], [u'controllerHaController'], [], ["Get"])
