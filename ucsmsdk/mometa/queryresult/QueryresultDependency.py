...
class QueryresultDependency(ManagedObject):
    ...
    mo_meta = MoMeta("QueryresultDependency", "queryresultDependency", "dependency-[ref_converted_dn]", VersionMeta.Version221b, "InputOutput", 0x3fL, [], ["admin"], [], [], [None])
    ...
    prop_meta = {
        ...
        "ref_converted_dn": MoPropertyMeta("ref_converted_dn", "refConvertedDn", "string", VersionMeta.Version221b, MoPropertyMeta.NAMING, 0x8L, 1, 510, None, [], []), 
