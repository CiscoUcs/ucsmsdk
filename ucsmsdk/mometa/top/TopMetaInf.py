...
class TopMetaInf(ManagedObject):
    ...
    mo_meta = MoMeta("TopMetaInf", "topMetaInf", "meta", VersionMeta.Version111j, "InputOutput", 0x3fL, [], ["read-only"], [u'topRoot'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "ecode": MoPropertyMeta("ecode", "ecode", "string", VersionMeta.Version111j, MoPropertyMeta.READ_WRITE, 0x4L, 0, 8, None, [], []), 
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version111j, MoPropertyMeta.READ_WRITE, 0x8L, None, None, """[a-zA-Z][a-zA-Z0-9-]{0,29}""", [], []), 
