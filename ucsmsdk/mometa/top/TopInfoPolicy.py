...
class TopInfoPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("TopInfoPolicy", "topInfoPolicy", "info-policy", VersionMeta.Version223a, "InputOutput", 0x3fL, [], ["admin", "ext-lan-config", "ext-san-config"], [u'topSystem'], [], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "state": MoPropertyMeta("state", "state", "string", VersionMeta.Version223a, MoPropertyMeta.READ_WRITE, 0x10L, None, None, None, ["disabled", "enabled"], []), 
