...
class TopInfoSyncPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("TopInfoSyncPolicy", "topInfoSyncPolicy", "info-sync-policy", VersionMeta.Version227b, "InputOutput", 0x1ff, [], ["admin", "ext-lan-config", "ext-san-config"], [u'orgOrg'], [], ["Get"])
