"""This module contains the general information for ExtpolProviderFsmTask ManagedObject."""
import sys, os
...
class ExtpolProviderFsmTaskConsts():
    COMPLETION_CANCELLED = "cancelled"
    COMPLETION_COMPLETED = "completed"
    COMPLETION_PROCESSING = "processing"
    COMPLETION_SCHEDULED = "scheduled"
    ITEM_REPORT_CONFIG_IMPORT = "ReportConfigImport"
    ITEM_NOP = "nop"


class ExtpolProviderFsmTask(ManagedObject):
    """This is ExtpolProviderFsmTask class."""

    consts = ExtpolProviderFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("ExtpolProviderFsmTask", "extpolProviderFsmTask", "task-[item]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'extpolProvider'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["ReportConfigImport", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "ExtpolProviderFsmTask", parent_mo_or_dn, **kwargs)
