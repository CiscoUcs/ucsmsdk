...
class ExtpolRegistryConsts():
    ...
    FSM_PREV_CROSS_DOMAIN_CONFIG_BEGIN = "crossDomainConfigBegin"
    FSM_PREV_CROSS_DOMAIN_CONFIG_FAIL = "crossDomainConfigFail"
    FSM_PREV_CROSS_DOMAIN_CONFIG_SET_LOCAL = "crossDomainConfigSetLocal"
    FSM_PREV_CROSS_DOMAIN_CONFIG_SET_PEER = "crossDomainConfigSetPeer"
    FSM_PREV_CROSS_DOMAIN_CONFIG_SUCCESS = "crossDomainConfigSuccess"
    FSM_PREV_CROSS_DOMAIN_DELETE_BEGIN = "crossDomainDeleteBegin"
    FSM_PREV_CROSS_DOMAIN_DELETE_FAIL = "crossDomainDeleteFail"
    FSM_PREV_CROSS_DOMAIN_DELETE_SET_LOCAL = "crossDomainDeleteSetLocal"
    FSM_PREV_CROSS_DOMAIN_DELETE_SET_PEER = "crossDomainDeleteSetPeer"
    FSM_PREV_CROSS_DOMAIN_DELETE_SUCCESS = "crossDomainDeleteSuccess"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_CROSS_DOMAIN_CONFIG_BEGIN = "crossDomainConfigBegin"
    FSM_STATUS_CROSS_DOMAIN_CONFIG_FAIL = "crossDomainConfigFail"
    FSM_STATUS_CROSS_DOMAIN_CONFIG_SET_LOCAL = "crossDomainConfigSetLocal"
    FSM_STATUS_CROSS_DOMAIN_CONFIG_SET_PEER = "crossDomainConfigSetPeer"
    FSM_STATUS_CROSS_DOMAIN_CONFIG_SUCCESS = "crossDomainConfigSuccess"
    FSM_STATUS_CROSS_DOMAIN_DELETE_BEGIN = "crossDomainDeleteBegin"
    FSM_STATUS_CROSS_DOMAIN_DELETE_FAIL = "crossDomainDeleteFail"
    FSM_STATUS_CROSS_DOMAIN_DELETE_SET_LOCAL = "crossDomainDeleteSetLocal"
    FSM_STATUS_CROSS_DOMAIN_DELETE_SET_PEER = "crossDomainDeleteSetPeer"
    FSM_STATUS_CROSS_DOMAIN_DELETE_SUCCESS = "crossDomainDeleteSuccess"
    FSM_STATUS_NOP = "nop"
...
class ExtpolRegistry(ManagedObject):
    ...
    mo_meta = MoMeta("ExtpolRegistry", "extpolRegistry", "reg", VersionMeta.Version211a, "InputOutput", 0xfL, [], ["admin"], [u'extpolEp'], [u'eventInst', u'extpolClientCont', u'extpolControllerCont', u'extpolProviderCont', u'extpolRegistryFsm', u'extpolRegistryFsmTask', u'faultInst', u'observeObserved', u'policyPolicyScopeCont'], ["Get"])

    prop_meta = {
        "capability": MoPropertyMeta("capability", "capability", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, """((defaultValue|unspecified|vmm|infra-waf|vm-mgr|pcm|infra-fw|org-mgr|virtual-switching-mgr|service-reg|vm-vasw|infra-pasw|vm-admin|infra-aggr|identifier-mgr|infra-slb|policy-mgr|stats-mgr|vm-fw|infra-pdsw|operation-mgr|infra-crypto-offloa|infra-was|boot-mgr|ipam|central-mgr|vm-slb|storage-broker|resource-mgr),){0,28}(defaultValue|unspecified|vmm|infra-waf|vm-mgr|pcm|infra-fw|org-mgr|virtual-switching-mgr|service-reg|vm-vasw|infra-pasw|vm-admin|infra-aggr|identifier-mgr|infra-slb|policy-mgr|stats-mgr|vm-fw|infra-pdsw|operation-mgr|infra-crypto-offloa|infra-was|boot-mgr|ipam|central-mgr|vm-slb|storage-broker|resource-mgr){0,1}""", [], []), 
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version211a, MoPropertyMeta.INTERNAL, None, None, None, None, ["crossDomainConfigBegin", "crossDomainConfigFail", "crossDomainConfigSetLocal", "crossDomainConfigSetPeer", "crossDomainConfigSuccess", "crossDomainDeleteBegin", "crossDomainDeleteFail", "crossDomainDeleteSetLocal", "crossDomainDeleteSetPeer", "crossDomainDeleteSuccess", "nop"], []), 
        ...
        "host": MoPropertyMeta("host", "host", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, """^[A-Za-z]([A-Za-z0-9-]*[A-Za-z0-9])?$|^[A-Za-z0-9]([A-Za-z0-9-]*[A-Za-z0-9])?(\.[A-Za-z0-9]([A-Za-z0-9-]*[A-Za-z0-9])?)*(\.[A-Za-z]([A-Za-z0-9-]*[A-Za-z0-9])?)$|^([1-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\.([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\.([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\.([1-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])$""", [], []), 
        ...
        "ip": MoPropertyMeta("ip", "ip", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, 0, 256, """((([0-9]){1,3}\.){3}[0-9]{1,3})""", [], []), 
        "ipv6": MoPropertyMeta("ipv6", "ipv6", "string", VersionMeta.Version221b, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        "last_poll_ts": MoPropertyMeta("last_poll_ts", "lastPollTs", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, """([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", [], []), 
