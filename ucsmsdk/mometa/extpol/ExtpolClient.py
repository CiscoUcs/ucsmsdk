...
class ExtpolClient(ManagedObject):
    ...
    mo_meta = MoMeta("ExtpolClient", "extpolClient", "client-[id]", VersionMeta.Version211a, "InputOutput", 0x3f, [], ["admin"], [u'extpolClientCont'], [u'faultInst', u'observeObserved', u'policyPolicyScopeCont'], ["Get"])
