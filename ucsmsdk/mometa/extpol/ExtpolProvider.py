"""This module contains the general information for ExtpolProvider ManagedObject."""
import sys, os
...
class ExtpolProviderConsts():
    CONN_PROTOCOL_IPV4 = "ipv4"
    CONN_PROTOCOL_IPV6 = "ipv6"
    CONN_PROTOCOL_UNKNOWN = "unknown"
    FSM_PREV_REPORT_CONFIG_IMPORT_BEGIN = "ReportConfigImportBegin"
    FSM_PREV_REPORT_CONFIG_IMPORT_FAIL = "ReportConfigImportFail"
    FSM_PREV_REPORT_CONFIG_IMPORT_REPORT = "ReportConfigImportReport"
    FSM_PREV_REPORT_CONFIG_IMPORT_SUCCESS = "ReportConfigImportSuccess"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_REPORT_CONFIG_IMPORT_BEGIN = "ReportConfigImportBegin"
    FSM_STATUS_REPORT_CONFIG_IMPORT_FAIL = "ReportConfigImportFail"
    FSM_STATUS_REPORT_CONFIG_IMPORT_REPORT = "ReportConfigImportReport"
    FSM_STATUS_REPORT_CONFIG_IMPORT_SUCCESS = "ReportConfigImportSuccess"
    FSM_STATUS_NOP = "nop"
...
class ExtpolProvider(ManagedObject):
    ...
    mo_meta = MoMeta("ExtpolProvider", "extpolProvider", "prov-[type]", VersionMeta.Version211a, "InputOutput", 0x1fL, [], ["admin"], [u'extpolProviderCont'], [u'eventInst', u'extpolProviderFsm', u'extpolProviderFsmTask', u'fabricVnetEpSyncEp', u'faultInst', u'observeObserved', u'policyPolicyScopeCont'], ["Get"])
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version211a, MoPropertyMeta.INTERNAL, None, None, None, None, ["ReportConfigImportBegin", "ReportConfigImportFail", "ReportConfigImportReport", "ReportConfigImportSuccess", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version211a, MoPropertyMeta.INTERNAL, None, None, None, None, ["ReportConfigImportBegin", "ReportConfigImportFail", "ReportConfigImportReport", "ReportConfigImportSuccess", "nop"], []), 
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, 0x10L, None, None, None, ["ape", "boot-mgr", "central-mgr", "identifier-mgr", "managed-endpoint", "mgmt-controller", "operation-mgr", "policy-mgr", "resource-aggr", "resource-mgr", "service-reg", "stats-mgr", "storage-broker", "virtual-switching-mgr", "vm-mgr"], []), 
    ...
    def __init__(self, parent_mo_or_dn, type, **kwargs):
        ...
        ManagedObject.__init__(self, "ExtpolProvider", parent_mo_or_dn, **kwargs)
