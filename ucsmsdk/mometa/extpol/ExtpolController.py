...
class ExtpolController(ManagedObject):
    ...
    mo_meta = MoMeta("ExtpolController", "extpolController", "contro-[id]", VersionMeta.Version211a, "InputOutput", 0x3fL, [], ["admin"], [u'extpolControllerCont'], [u'observeObserved', u'policyPolicyScopeCont'], ["Get"])
