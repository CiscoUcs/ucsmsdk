...
class ExtpolEpConsts():
    ...
    FSM_PREV_REGISTER_FSM_SUCCESS = "RegisterFsmSuccess"
    FSM_PREV_NOP = "nop"
    FSM_PREV_REPAIR_CERT_BEGIN = "repairCertBegin"
    FSM_PREV_REPAIR_CERT_CLEAN_OLD_DATA = "repairCertCleanOldData"
    FSM_PREV_REPAIR_CERT_FAIL = "repairCertFail"
    FSM_PREV_REPAIR_CERT_REQUEST = "repairCertRequest"
    FSM_PREV_REPAIR_CERT_SUCCESS = "repairCertSuccess"
    FSM_PREV_REPAIR_CERT_UNREGISTER = "repairCertUnregister"
    FSM_PREV_REPAIR_CERT_VERIFY = "repairCertVerify"
    FSM_PREV_REPAIR_CERT_VERIFY_GUID = "repairCertVerifyGuid"
    ...
    FSM_STATUS_REGISTER_FSM_BEGIN = "RegisterFsmBegin"
    FSM_STATUS_REGISTER_FSM_EXECUTE = "RegisterFsmExecute"
    FSM_STATUS_REGISTER_FSM_FAIL = "RegisterFsmFail"
    FSM_STATUS_REGISTER_FSM_SUCCESS = "RegisterFsmSuccess"
    FSM_STATUS_NOP = "nop"
    FSM_STATUS_REPAIR_CERT_BEGIN = "repairCertBegin"
    FSM_STATUS_REPAIR_CERT_CLEAN_OLD_DATA = "repairCertCleanOldData"
    FSM_STATUS_REPAIR_CERT_FAIL = "repairCertFail"
    FSM_STATUS_REPAIR_CERT_REQUEST = "repairCertRequest"
    FSM_STATUS_REPAIR_CERT_SUCCESS = "repairCertSuccess"
    FSM_STATUS_REPAIR_CERT_UNREGISTER = "repairCertUnregister"
    FSM_STATUS_REPAIR_CERT_VERIFY = "repairCertVerify"
    FSM_STATUS_REPAIR_CERT_VERIFY_GUID = "repairCertVerifyGuid"


class ExtpolEp(ManagedObject):
    """This is ExtpolEp class."""

    consts = ExtpolEpConsts()
    naming_props = set([])

    mo_meta = MoMeta("ExtpolEp", "extpolEp", "extpol", VersionMeta.Version211a, "InputOutput", 0xfL, [], ["admin"], [u'topRoot'], [u'eventInst', u'extpolEpFsm', u'extpolEpFsmTask', u'extpolRegistry', u'faultInst'], ["Get"])
