"""This module contains the general information for ExtpolEpFsm ManagedObject."""
import sys, os
...
class ExtpolEpFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_REGISTER_FSM = "RegisterFsm"
    CURRENT_FSM_NOP = "nop"
    CURRENT_FSM_REPAIR_CERT = "repairCert"
...
class ExtpolEpFsm(ManagedObject):
    """This is ExtpolEpFsm class."""

    consts = ExtpolEpFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("ExtpolEpFsm", "extpolEpFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'extpolEp'], [u'extpolEpFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["RegisterFsm", "nop", "repairCert"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "ExtpolEpFsm", parent_mo_or_dn, **kwargs)
