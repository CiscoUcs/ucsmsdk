...
class ExtpolControllerCont(ManagedObject):
    ...
    mo_meta = MoMeta("ExtpolControllerCont", "extpolControllerCont", "controllers", VersionMeta.Version211a, "InputOutput", 0xfL, [], ["admin"], [u'extpolRegistry'], [u'extpolController'], ["Get"])
