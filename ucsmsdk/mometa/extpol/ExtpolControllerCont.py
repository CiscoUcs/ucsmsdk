...
class ExtpolControllerCont(ManagedObject):
    ...
    mo_meta = MoMeta("ExtpolControllerCont", "extpolControllerCont", "controllers", VersionMeta.Version211a, "InputOutput", 0x1f, [], ["admin"], ['extpolRegistry'], ['extpolController'], ["Get"])
