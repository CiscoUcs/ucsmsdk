...
class ExtpolProviderFsm(ManagedObject):
    """This is ExtpolProviderFsm class."""

    consts = ExtpolProviderFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("ExtpolProviderFsm", "extpolProviderFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'extpolProvider'], [u'extpolProviderFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["ReportConfigImport", "nop"], []), 
