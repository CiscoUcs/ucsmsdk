"""This module contains the general information for ExtpolRegistryFsmTask ManagedObject."""
import sys, os
...
class ExtpolRegistryFsmTaskConsts():
    COMPLETION_CANCELLED = "cancelled"
    COMPLETION_COMPLETED = "completed"
    COMPLETION_PROCESSING = "processing"
    COMPLETION_SCHEDULED = "scheduled"
    ITEM_CROSS_DOMAIN_CONFIG = "crossDomainConfig"
    ITEM_CROSS_DOMAIN_DELETE = "crossDomainDelete"
    ITEM_NOP = "nop"


class ExtpolRegistryFsmTask(ManagedObject):
    """This is ExtpolRegistryFsmTask class."""

    consts = ExtpolRegistryFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("ExtpolRegistryFsmTask", "extpolRegistryFsmTask", "task-[item]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'extpolRegistry'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["crossDomainConfig", "crossDomainDelete", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "ExtpolRegistryFsmTask", parent_mo_or_dn, **kwargs)
