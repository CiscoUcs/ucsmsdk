"""This module contains the general information for ExtpolEpFsmTask ManagedObject."""
import sys, os
...
class ExtpolEpFsmTaskConsts():
    COMPLETION_CANCELLED = "cancelled"
    COMPLETION_COMPLETED = "completed"
    COMPLETION_PROCESSING = "processing"
    COMPLETION_SCHEDULED = "scheduled"
    ITEM_REGISTER_FSM = "RegisterFsm"
    ITEM_NOP = "nop"
    ITEM_REPAIR_CERT = "repairCert"


class ExtpolEpFsmTask(ManagedObject):
    """This is ExtpolEpFsmTask class."""

    consts = ExtpolEpFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("ExtpolEpFsmTask", "extpolEpFsmTask", "task-[item]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'extpolEp'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["RegisterFsm", "nop", "repairCert"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "ExtpolEpFsmTask", parent_mo_or_dn, **kwargs)
