"""This module contains the general information for ExtpolProviderFsmStage ManagedObject."""
import sys, os
...
class ExtpolProviderFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_REPORT_CONFIG_IMPORT_BEGIN = "ReportConfigImportBegin"
    NAME_REPORT_CONFIG_IMPORT_FAIL = "ReportConfigImportFail"
    NAME_REPORT_CONFIG_IMPORT_REPORT = "ReportConfigImportReport"
    NAME_REPORT_CONFIG_IMPORT_SUCCESS = "ReportConfigImportSuccess"
    NAME_NOP = "nop"
...
class ExtpolProviderFsmStage(ManagedObject):
    """This is ExtpolProviderFsmStage class."""

    consts = ExtpolProviderFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("ExtpolProviderFsmStage", "extpolProviderFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'extpolProviderFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["ReportConfigImportBegin", "ReportConfigImportFail", "ReportConfigImportReport", "ReportConfigImportSuccess", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "ExtpolProviderFsmStage", parent_mo_or_dn, **kwargs)
