...
class ExtpolRegistryFsm(ManagedObject):
    """This is ExtpolRegistryFsm class."""

    consts = ExtpolRegistryFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("ExtpolRegistryFsm", "extpolRegistryFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'extpolRegistry'], [u'extpolRegistryFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["crossDomainConfig", "crossDomainDelete", "nop"], []), 
