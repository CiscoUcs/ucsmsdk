...
class FsmStatus(ManagedObject):
    ...
    mo_meta = MoMeta("FsmStatus", "fsmStatus", "status-[converted_ep_ref]", VersionMeta.Version211a, "InputOutput", 0x7fL, [], ["read-only"], [u'topSystem'], [], [None])
    ...
    prop_meta = {
        ...
        "converted_ep_ref": MoPropertyMeta("converted_ep_ref", "convertedEpRef", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, 0x2L, 1, 510, None, [], []), 
