"""This module contains the general information for MgmtAccessPolicy ManagedObject."""
import sys, os
...
class MgmtAccessPolicyConsts():
    pass


class MgmtAccessPolicy(ManagedObject):
    """This is MgmtAccessPolicy class."""

    consts = MgmtAccessPolicyConsts()
    naming_props = set([])

    mo_meta = MoMeta("MgmtAccessPolicy", "mgmtAccessPolicy", "ext-access-policy", VersionMeta.Version101e, "InputOutput", 0x1fL, [], ["read-only"], [u'topSystem'], [u'mgmtAccessPolicyItem'], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "MgmtAccessPolicy", parent_mo_or_dn, **kwargs)
