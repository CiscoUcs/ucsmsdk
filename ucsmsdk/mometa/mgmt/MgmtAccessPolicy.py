...
class MgmtAccessPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("MgmtAccessPolicy", "mgmtAccessPolicy", "ext-access-policy", VersionMeta.Version101e, "InputOutput", 0xfL, [], ["read-only"], [u'topSystem'], [u'mgmtAccessPolicyItem'], ["Get"])
