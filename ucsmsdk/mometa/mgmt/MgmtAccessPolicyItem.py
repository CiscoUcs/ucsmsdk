...
class MgmtAccessPolicyItem(ManagedObject):
    ...
    naming_props = set([u'subject'])

    mo_meta = MoMeta("MgmtAccessPolicyItem", "mgmtAccessPolicyItem", "item-[subject]", VersionMeta.Version101e, "InputOutput", 0xffL, [], ["read-only"], [u'mgmtAccessPolicy'], [u'mgmtAccessPort'], ["Get"])
    ...
    prop_meta = {
        ...
        "ip_pool_name": MoPropertyMeta("ip_pool_name", "ipPoolName", "string", VersionMeta.Version101e, MoPropertyMeta.READ_ONLY, None, None, None, """[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        ...
        "subject": MoPropertyMeta("subject", "subject", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x80L, None, None, None, ["adaptor", "blade", "board-controller", "chassis", "cmc", "iocard", "sas-expander", "server-unit", "switch", "system", "unknown"], []), 
    }
