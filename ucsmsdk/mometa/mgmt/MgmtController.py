...
class MgmtController(ManagedObject):
    ...
    prop_meta = {
        ...
        "id": MoPropertyMeta("id", "id", "string", VersionMeta.Version251a, MoPropertyMeta.NAMING, 0x4L, None, None, None, ["A", "B", "NONE"], []), 
        ...
        "subject": MoPropertyMeta("subject", "subject", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x20L, None, None, None, ["adaptor", "blade", "board-controller", "chassis", "cmc", "iocard", "sas-expander", "server-unit", "switch", "system", "unknown"], []), 
