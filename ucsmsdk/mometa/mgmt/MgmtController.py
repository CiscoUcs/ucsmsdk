...
class MgmtControllerConsts:
    ...
    FSM_PREV_UPDATE_COLUSA_BOARD_CONTROLLER_BEGIN = "UpdateColusaBoardControllerBegin"
    FSM_PREV_UPDATE_COLUSA_BOARD_CONTROLLER_FAIL = "UpdateColusaBoardControllerFail"
    FSM_PREV_UPDATE_COLUSA_BOARD_CONTROLLER_POLL_UPDATE_STATUS = "UpdateColusaBoardControllerPollUpdateStatus"
    FSM_PREV_UPDATE_COLUSA_BOARD_CONTROLLER_POWER_OFF_SERVERS = "UpdateColusaBoardControllerPowerOffServers"
    FSM_PREV_UPDATE_COLUSA_BOARD_CONTROLLER_POWER_ON_SERVERS = "UpdateColusaBoardControllerPowerOnServers"
    FSM_PREV_UPDATE_COLUSA_BOARD_CONTROLLER_PREPARE_FOR_UPDATE = "UpdateColusaBoardControllerPrepareForUpdate"
    FSM_PREV_UPDATE_COLUSA_BOARD_CONTROLLER_SERVERS_POWER_OFF_COMPLETION = "UpdateColusaBoardControllerServersPowerOffCompletion"
    FSM_PREV_UPDATE_COLUSA_BOARD_CONTROLLER_SUCCESS = "UpdateColusaBoardControllerSuccess"
    FSM_PREV_UPDATE_COLUSA_BOARD_CONTROLLER_UPDATE_REQUEST = "UpdateColusaBoardControllerUpdateRequest"
    ...
    FSM_STATUS_UPDATE_COLUSA_BOARD_CONTROLLER_BEGIN = "UpdateColusaBoardControllerBegin"
    FSM_STATUS_UPDATE_COLUSA_BOARD_CONTROLLER_FAIL = "UpdateColusaBoardControllerFail"
    FSM_STATUS_UPDATE_COLUSA_BOARD_CONTROLLER_POLL_UPDATE_STATUS = "UpdateColusaBoardControllerPollUpdateStatus"
    FSM_STATUS_UPDATE_COLUSA_BOARD_CONTROLLER_POWER_OFF_SERVERS = "UpdateColusaBoardControllerPowerOffServers"
    FSM_STATUS_UPDATE_COLUSA_BOARD_CONTROLLER_POWER_ON_SERVERS = "UpdateColusaBoardControllerPowerOnServers"
    FSM_STATUS_UPDATE_COLUSA_BOARD_CONTROLLER_PREPARE_FOR_UPDATE = "UpdateColusaBoardControllerPrepareForUpdate"
    FSM_STATUS_UPDATE_COLUSA_BOARD_CONTROLLER_SERVERS_POWER_OFF_COMPLETION = "UpdateColusaBoardControllerServersPowerOffCompletion"
    FSM_STATUS_UPDATE_COLUSA_BOARD_CONTROLLER_SUCCESS = "UpdateColusaBoardControllerSuccess"
    FSM_STATUS_UPDATE_COLUSA_BOARD_CONTROLLER_UPDATE_REQUEST = "UpdateColusaBoardControllerUpdateRequest"
...
class MgmtController(ManagedObject):
    ...
    mo_meta = MoMeta("MgmtController", "mgmtController", "mgmt", VersionMeta.Version101e, "InputOutput", 0xff, [], ["admin", "ls-compute", "ls-config", "ls-network", "ls-server"], [u'adaptorUnit', u'computeBlade', u'computeBoardController', u'computeExtBoard', u'computeRackUnit', u'computeServerUnit', u'equipmentChassis', u'equipmentFex', u'equipmentIOCard', u'equipmentSharedIOModule', u'equipmentSwitchIOCard', u'equipmentSystemIOController', u'networkElement', u'storageController', u'storageLocalDisk', u'storageSasExpander', u'topSystem'], [u'cimcvmediaActualMountList', u'eventInst', u'fabricLocale', u'faultInst', u'firmwareBootDefinition', u'firmwareRunning', u'firmwareUpdatable', u'mgmtCimcSecureBoot', u'mgmtCmcSecureBoot', u'mgmtConnection', u'mgmtControllerFsm', u'mgmtControllerFsmTask', u'mgmtHealthStatus', u'mgmtIf', u'mgmtInterface', u'mgmtKvmCertificate', u'mgmtProfDerivedInterface', u'mgmtUsbNicMgmtIf', u'sysdebugMEpLog', u'vnicIpV4PooledAddr', u'vnicIpV4ProfDerivedAddr', u'vnicIpV4StaticAddr'], ["Get"])

    prop_meta = {
        "admin_operation": MoPropertyMeta("admin_operation", "adminOperation", "string", None, MoPropertyMeta.READ_WRITE, 0x2, None, None, None, ["cancel-all", "clear-kvm-cert", "none"], []), 
        "child_action": MoPropertyMeta("child_action", "childAction", "string", VersionMeta.Version101e, MoPropertyMeta.INTERNAL, 0x4, None, None, r"""((deleteAll|ignore|deleteNonPresent),){0,2}(deleteAll|ignore|deleteNonPresent){0,1}""", [], []), 
        "cmc_supported_storage_features": MoPropertyMeta("cmc_supported_storage_features", "cmcSupportedStorageFeatures", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, r"""((feature-unknown|feature-connection-management|feature-single-path),){0,2}(feature-unknown|feature-connection-management|feature-single-path){0,1}""", [], []), 
        "cmc_supported_storage_ops": MoPropertyMeta("cmc_supported_storage_ops", "cmcSupportedStorageOps", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, r"""((operation-unknown|operation-connection-management|operation-single-path),){0,2}(operation-unknown|operation-connection-management|operation-single-path){0,1}""", [], []), 
