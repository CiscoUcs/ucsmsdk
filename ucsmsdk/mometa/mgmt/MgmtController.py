...
class MgmtController(ManagedObject):
    ...
    prop_meta = {
        ...
        "desired_maintenance_mode": MoPropertyMeta("desired_maintenance_mode", "desiredMaintenanceMode", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["lpc-reset", "normal"], []), 
        ...
        "id": MoPropertyMeta("id", "id", "string", VersionMeta.Version251a, MoPropertyMeta.NAMING, 0x8L, None, None, None, ["A", "B", "NONE"], []), 
        ...
        "subject": MoPropertyMeta("subject", "subject", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x40L, None, None, None, ["adaptor", "blade", "board-controller", "chassis", "cmc", "iocard", "sas-expander", "server-unit", "switch", "system", "unknown"], []), 
        "supported_capability": MoPropertyMeta("supported_capability", "supportedCapability", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, r"""((defaultValue|none|modify-maintenance-mode),){0,2}(defaultValue|none|modify-maintenance-mode){0,1}""", [], []), 
