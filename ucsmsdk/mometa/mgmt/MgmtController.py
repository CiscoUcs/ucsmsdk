...
class MgmtController(ManagedObject):
    ...
    prop_meta = {
        ...
        "hostag_comm_method": MoPropertyMeta("hostag_comm_method", "hostagCommMethod", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["serial", "unknown", "usb-nic"], []), 
        ...
        "web_ui_kvm_console_supported": MoPropertyMeta("web_ui_kvm_console_supported", "webUIKvmConsoleSupported", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["false", "no", "true", "yes"], []), 
    }
