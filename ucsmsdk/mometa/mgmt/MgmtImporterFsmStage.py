...
class MgmtImporterFsmStageConsts():
    ...
    NAME_IMPORT_DOWNLOAD_LOCAL = "importDownloadLocal"
...
class MgmtImporterFsmStage(ManagedObject):
    """This is MgmtImporterFsmStage class."""

    consts = MgmtImporterFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("MgmtImporterFsmStage", "mgmtImporterFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'mgmtImporterFsm'], [], [None])
