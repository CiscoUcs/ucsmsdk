...
class MgmtAccessPort(ManagedObject):
    ...
    mo_meta = MoMeta("MgmtAccessPort", "mgmtAccessPort", "[protocol]-port-[port]", VersionMeta.Version101e, "InputOutput", 0x3fL, [], ["read-only"], [u'mgmtAccessPolicyItem'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "port": MoPropertyMeta("port", "port", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x4L, None, None, None, ["none"], ["0-65536"]), 
        "protocol": MoPropertyMeta("protocol", "protocol", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x8L, None, None, None, ["TCP", "UDP"], []), 
