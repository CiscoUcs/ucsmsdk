"""This module contains the general information for MgmtBackupPolicyFsm ManagedObject."""
import sys, os
...
class MgmtBackupPolicyFsmConsts():
    COMPLETION_TIME_ = ""
...
class MgmtBackupPolicyFsm(ManagedObject):
    """This is MgmtBackupPolicyFsm class."""

    consts = MgmtBackupPolicyFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("MgmtBackupPolicyFsm", "mgmtBackupPolicyFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'mgmtBackupPolicy'], [u'mgmtBackupPolicyFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "MgmtBackupPolicyFsm", parent_mo_or_dn, **kwargs)
