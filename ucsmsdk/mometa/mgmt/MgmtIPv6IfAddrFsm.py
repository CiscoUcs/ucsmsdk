...
class MgmtIPv6IfAddrFsm(ManagedObject):
    """This is MgmtIPv6IfAddrFsm class."""

    consts = MgmtIPv6IfAddrFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("MgmtIPv6IfAddrFsm", "mgmtIPv6IfAddrFsm", "fsm", VersionMeta.Version221b, "OutputOnly", 0x7L, [], [""], [u'mgmtIPv6IfAddr'], [u'mgmtIPv6IfAddrFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version221b, MoPropertyMeta.READ_ONLY, None, None, None, None, ["SwMgmtOobIpv6IfConfig", "nop"], []), 
