"""This module contains the general information for MgmtSwPersonalitiesInventory ManagedObject."""
...
class MgmtSwPersonalitiesInventoryConsts:
    pass


class MgmtSwPersonalitiesInventory(ManagedObject):
    """This is MgmtSwPersonalitiesInventory class."""

    consts = MgmtSwPersonalitiesInventoryConsts()
    naming_props = set([])

    mo_meta = MoMeta("MgmtSwPersonalitiesInventory", "mgmtSwPersonalitiesInventory", "sw-personalities-inventory", VersionMeta.Version421a, "InputOutput", 0x1f, [], ["admin"], ['mgmtController'], ['mgmtSwPersonality'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "MgmtSwPersonalitiesInventory", parent_mo_or_dn, **kwargs)
