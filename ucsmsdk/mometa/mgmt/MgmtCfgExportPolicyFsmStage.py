...
class MgmtCfgExportPolicyFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("MgmtCfgExportPolicyFsmStage", "mgmtCfgExportPolicyFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'mgmtCfgExportPolicyFsm'], [], [None])
