...
class MgmtCfgExportPolicyFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("MgmtCfgExportPolicyFsmStage", "mgmtCfgExportPolicyFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xf, [], [""], [u'mgmtCfgExportPolicyFsm'], [], [None])
