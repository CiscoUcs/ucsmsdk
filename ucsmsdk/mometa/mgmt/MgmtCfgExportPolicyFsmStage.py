"""This module contains the general information for MgmtCfgExportPolicyFsmStage ManagedObject."""
import sys, os
...
class MgmtCfgExportPolicyFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_REPORT_CONFIG_COPY_BEGIN = "ReportConfigCopyBegin"
    NAME_REPORT_CONFIG_COPY_FAIL = "ReportConfigCopyFail"
    NAME_REPORT_CONFIG_COPY_REPORT = "ReportConfigCopyReport"
    NAME_REPORT_CONFIG_COPY_SUCCESS = "ReportConfigCopySuccess"
    NAME_NOP = "nop"
...
class MgmtCfgExportPolicyFsmStage(ManagedObject):
    """This is MgmtCfgExportPolicyFsmStage class."""

    consts = MgmtCfgExportPolicyFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("MgmtCfgExportPolicyFsmStage", "mgmtCfgExportPolicyFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'mgmtCfgExportPolicyFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["ReportConfigCopyBegin", "ReportConfigCopyFail", "ReportConfigCopyReport", "ReportConfigCopySuccess", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "MgmtCfgExportPolicyFsmStage", parent_mo_or_dn, **kwargs)
