...
class MgmtExportPolicyFsm(ManagedObject):
    ...
    mo_meta = MoMeta("MgmtExportPolicyFsm", "mgmtExportPolicyFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'mgmtBackupPolicy', u'mgmtCfgExportPolicy'], [u'mgmtExportPolicyFsmStage'], [None])
