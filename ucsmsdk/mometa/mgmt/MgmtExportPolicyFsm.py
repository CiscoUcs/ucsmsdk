"""This module contains the general information for MgmtExportPolicyFsm ManagedObject."""
import sys, os
...
class MgmtExportPolicyFsmConsts():
    COMPLETION_TIME_ = ""
...
class MgmtExportPolicyFsm(ManagedObject):
    """This is MgmtExportPolicyFsm class."""

    consts = MgmtExportPolicyFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("MgmtExportPolicyFsm", "mgmtExportPolicyFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'mgmtBackupPolicy', u'mgmtCfgExportPolicy'], [u'mgmtExportPolicyFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "MgmtExportPolicyFsm", parent_mo_or_dn, **kwargs)
