...
class MgmtBackupPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("MgmtBackupPolicy", "mgmtBackupPolicy", "db-backup-policy-[name]", VersionMeta.Version211a, "InputOutput", 0xffff, [], ["admin"], ['orgOrg'], ['eventInst', 'faultInst', 'mgmtBackupPolicyFsm', 'mgmtExportPolicyFsm', 'mgmtExportPolicyFsmTask'], ["Get", "Set"])
