...
class MgmtBackupExportExtPolicy(ManagedObject):
    ...
    prop_meta = {
        ...
        "frequency": MoPropertyMeta("frequency", "frequency", "ushort", VersionMeta.Version222c, MoPropertyMeta.READ_WRITE, 0x20, None, None, None, [], ["1-365"]),
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version222c, MoPropertyMeta.READ_WRITE, 0x40, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []),
        ...
        "policy_owner": MoPropertyMeta("policy_owner", "policyOwner", "string", VersionMeta.Version222c, MoPropertyMeta.READ_WRITE, 0x80, None, None, None, ["local", "pending-policy", "policy"], []),
