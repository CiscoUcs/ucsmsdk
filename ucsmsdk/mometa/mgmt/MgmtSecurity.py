...
class MgmtSecurity(ManagedObject):
    ...
    mo_meta = MoMeta("MgmtSecurity", "mgmtSecurity", "sec", VersionMeta.Version321d, "InputOutput", 0x1f, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], ['computeBlade', 'computeRackUnit', 'computeServerUnit'], ['mgmtKmip'], ["Get"])
