...
class MgmtSecurity(ManagedObject):
    ...
    mo_meta = MoMeta("MgmtSecurity", "mgmtSecurity", "sec", None, "InputOutput", 0x1f, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit'], [u'mgmtKmip'], [None])
