...
class MgmtControllerFsmConsts:
    ...
    CURRENT_FSM_CONFIGURE_SW_PERSONALITIES = "ConfigureSwPersonalities"
    ...
    CURRENT_FSM_UPDATE_SECURE_FPGA = "UpdateSecureFPGA"
