"""This module contains the general information for MgmtControllerFsm ManagedObject."""
import sys, os
...
class MgmtControllerFsmConsts():
    ...
    CURRENT_FSM_LOCK_CONFIG = "LockConfig"
    CURRENT_FSM_ONLINE = "Online"
    CURRENT_FSM_POWER_BUDGET_RECLAIM_CONFIG = "PowerBudgetReclaimConfig"
    CURRENT_FSM_REGISTRY_CONFIG = "RegistryConfig"
    CURRENT_FSM_SYS_CONFIG = "SysConfig"
...
class MgmtControllerFsm(ManagedObject):
    """This is MgmtControllerFsm class."""

    consts = MgmtControllerFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("MgmtControllerFsm", "mgmtControllerFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'mgmtController'], [u'mgmtControllerFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "MgmtControllerFsm", parent_mo_or_dn, **kwargs)
