...
class MgmtBackupConsts():
    ...
    BACKUPSTATUS_SUCCESS = "success"
    FSM_PREV_BACKUP_BACKUP_LOCAL = "backupBackupLocal"
    FSM_PREV_BACKUP_BEGIN = "backupBegin"
    FSM_PREV_BACKUP_FAIL = "backupFail"
    FSM_PREV_BACKUP_SUCCESS = "backupSuccess"
    FSM_PREV_BACKUP_UPLOAD = "backupUpload"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_BACKUP_BACKUP_LOCAL = "backupBackupLocal"
    FSM_STATUS_BACKUP_BEGIN = "backupBegin"
    FSM_STATUS_BACKUP_FAIL = "backupFail"
    FSM_STATUS_BACKUP_SUCCESS = "backupSuccess"
    FSM_STATUS_BACKUP_UPLOAD = "backupUpload"
    FSM_STATUS_NOP = "nop"
    INT_ID_NONE = "none"
...
class MgmtBackup(ManagedObject):
    ...
    mo_meta = MoMeta("MgmtBackup", "mgmtBackup", "backup-[hostname]", VersionMeta.Version101e, "InputOutput", 0xffffL, [], ["admin"], [u'topSystem'], [u'eventInst', u'faultInst', u'mgmtBackupFsm', u'mgmtBackupFsmTask'], ["Add", "Get", "Remove"])
    ...
    prop_meta = {
        ...
        "backupstatus": MoPropertyMeta("backupstatus", "backupstatus", "string", VersionMeta.Version224a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["fail", "in-progress", "none", "success"], []), 
        ...
        "hostname": MoPropertyMeta("hostname", "hostname", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x10L, None, None, None, [], []), 
        "int_id": MoPropertyMeta("int_id", "intId", "string", VersionMeta.Version101e, MoPropertyMeta.INTERNAL, None, None, None, None, ["none"], ["0-4294967295"]), 
        "job": MoPropertyMeta("job", "job", "string", VersionMeta.Version101e, MoPropertyMeta.CREATE_ONLY, 0x20L, None, None, None, ["immediate"], []), 
        ...
        "preserve_pooled_values": MoPropertyMeta("preserve_pooled_values", "preservePooledValues", "string", VersionMeta.Version102d, MoPropertyMeta.READ_WRITE, 0x100L, None, None, None, ["false", "no", "true", "yes"], []), 
        "proto": MoPropertyMeta("proto", "proto", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x200L, None, None, None, ["ftp", "http", "nfs-copy", "none", "scp", "sftp", "tftp"], []), 
        "pwd": MoPropertyMeta("pwd", "pwd", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x400L, 0, 64, None, [], []), 
        "remote_file": MoPropertyMeta("remote_file", "remoteFile", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x800L, 1, 128, None, [], []), 
        ...
        "status": MoPropertyMeta("status", "status", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x2000L, None, None, """((removed|created|modified|deleted),){0,3}(removed|created|modified|deleted){0,1}""", [], []), 
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x4000L, None, None, None, ["config-all", "config-logical", "config-system", "full-state"], []), 
        "user": MoPropertyMeta("user", "user", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x8000L, 0, 510, None, [], []), 
    }
