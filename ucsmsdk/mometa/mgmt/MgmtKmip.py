...
class MgmtKmip(ManagedObject):
    ...
    mo_meta = MoMeta("MgmtKmip", "mgmtKmip", "kmip", None, "InputOutput", 0x3f, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'mgmtSecurity'], [], [None])

    prop_meta = {
        "ca_certificate": MoPropertyMeta("ca_certificate", "caCertificate", "string", None, MoPropertyMeta.READ_WRITE, 0x2, None, None, None, [], []), 
        "cert_sign_request": MoPropertyMeta("cert_sign_request", "certSignRequest", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        "cert_status": MoPropertyMeta("cert_status", "certStatus", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["certChainTooLong", "emptyCert", "expired", "failedToVerifyWithPrivateKey", "failedToVerifyWithTp", "notYetValid", "revoked", "selfSignedCertificate", "unknown", "valid"], []), 
        "certificate": MoPropertyMeta("certificate", "certificate", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
