"""This module contains the general information for MgmtBackupFsmTask ManagedObject."""
import sys, os
...
class MgmtBackupFsmTask(ManagedObject):
    """This is MgmtBackupFsmTask class."""

    consts = MgmtBackupFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("MgmtBackupFsmTask", "mgmtBackupFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], [""], [u'mgmtBackup'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, None, None, None, None, ["backup", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "MgmtBackupFsmTask", parent_mo_or_dn, **kwargs)
