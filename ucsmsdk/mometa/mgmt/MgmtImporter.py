...
class MgmtImporter(ManagedObject):
    ...
    mo_meta = MoMeta("MgmtImporter", "mgmtImporter", "import-config-[hostname]", VersionMeta.Version101e, "InputOutput", 0x1fffL, [], ["admin"], [u'topSystem'], [u'eventInst', u'faultInst', u'mgmtImporterFsm', u'mgmtImporterFsmTask'], ["Add", "Get", "Remove", "Set"])

    prop_meta = {
        "action": MoPropertyMeta("action", "action", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x1L, None, None, None, ["merge", "replace"], []), 
        ...
        "hostname": MoPropertyMeta("hostname", "hostname", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x20L, None, None, None, [], []), 
        ...
        "oper_status": MoPropertyMeta("oper_status", "operStatus", "string", VersionMeta.Version212a, MoPropertyMeta.READ_ONLY, None, None, None, """((defaultValue|nop|download-success|config-success),){0,3}(defaultValue|nop|download-success|config-success){0,1}""", [], []), 
        ...
        "proto": MoPropertyMeta("proto", "proto", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x80L, None, None, None, ["ftp", "http", "nfs-copy", "none", "scp", "sftp", "tftp"], []), 
        "pwd": MoPropertyMeta("pwd", "pwd", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x100L, 0, 64, None, [], []), 
        "remote_file": MoPropertyMeta("remote_file", "remoteFile", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x200L, 1, 128, None, [], []), 
        ...
        "user": MoPropertyMeta("user", "user", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x1000L, 0, 510, None, [], []), 
    }
