...
class MgmtImporterConsts:
    ...
    FSM_PREV_IMPORT_VERIFY_KEY = "importVerifyKey"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_IMPORT_VERIFY_KEY = "importVerifyKey"
    FSM_STATUS_NOP = "nop"
    INT_ID_NONE = "none"
...
class MgmtImporter(ManagedObject):
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version101e, MoPropertyMeta.INTERNAL, None, None, None, None, ["importBegin", "importConfig", "importDownloadLocal", "importFail", "importReportResults", "importSuccess", "importVerifyKey", "nop"], []),
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version101e, MoPropertyMeta.INTERNAL, None, None, None, None, ["importBegin", "importConfig", "importDownloadLocal", "importFail", "importReportResults", "importSuccess", "importVerifyKey", "nop"], []),
