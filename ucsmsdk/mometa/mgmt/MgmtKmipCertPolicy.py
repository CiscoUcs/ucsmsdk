...
class MgmtKmipCertPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("MgmtKmipCertPolicy", "mgmtKmipCertPolicy", "kmip-cert", VersionMeta.Version321d, "InputOutput", 0x7fff, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-oper", "ls-server-policy", "read-only"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit', u'pkiEp'], [], ["Get", "Set"])
