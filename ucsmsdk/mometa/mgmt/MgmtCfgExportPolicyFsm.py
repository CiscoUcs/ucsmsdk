"""This module contains the general information for MgmtCfgExportPolicyFsm ManagedObject."""
import sys, os
...
class MgmtCfgExportPolicyFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_REPORT_CONFIG_COPY = "ReportConfigCopy"
    CURRENT_FSM_NOP = "nop"
...
class MgmtCfgExportPolicyFsm(ManagedObject):
    """This is MgmtCfgExportPolicyFsm class."""

    consts = MgmtCfgExportPolicyFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("MgmtCfgExportPolicyFsm", "mgmtCfgExportPolicyFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'mgmtCfgExportPolicy'], [u'mgmtCfgExportPolicyFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["ReportConfigCopy", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "MgmtCfgExportPolicyFsm", parent_mo_or_dn, **kwargs)
