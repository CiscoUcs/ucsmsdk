...
class MgmtIPv6IfAddrConsts():
    FSM_PREV_SW_MGMT_OOB_IPV6_IF_CONFIG_BEGIN = "SwMgmtOobIpv6IfConfigBegin"
    FSM_PREV_SW_MGMT_OOB_IPV6_IF_CONFIG_FAIL = "SwMgmtOobIpv6IfConfigFail"
    FSM_PREV_SW_MGMT_OOB_IPV6_IF_CONFIG_SUCCESS = "SwMgmtOobIpv6IfConfigSuccess"
    FSM_PREV_SW_MGMT_OOB_IPV6_IF_CONFIG_SWITCH = "SwMgmtOobIpv6IfConfigSwitch"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_SW_MGMT_OOB_IPV6_IF_CONFIG_BEGIN = "SwMgmtOobIpv6IfConfigBegin"
    FSM_STATUS_SW_MGMT_OOB_IPV6_IF_CONFIG_FAIL = "SwMgmtOobIpv6IfConfigFail"
    FSM_STATUS_SW_MGMT_OOB_IPV6_IF_CONFIG_SUCCESS = "SwMgmtOobIpv6IfConfigSuccess"
    FSM_STATUS_SW_MGMT_OOB_IPV6_IF_CONFIG_SWITCH = "SwMgmtOobIpv6IfConfigSwitch"
    FSM_STATUS_NOP = "nop"
...
class MgmtIPv6IfAddr(ManagedObject):
    ...
    mo_meta = MoMeta("MgmtIPv6IfAddr", "mgmtIPv6IfAddr", "if-ipv6", VersionMeta.Version221b, "InputOutput", 0xffL, [], ["admin", "ext-lan-config"], [u'mgmtIPv6IfConfig'], [u'eventInst', u'faultInst', u'mgmtIPv6IfAddrFsm', u'mgmtIPv6IfAddrFsmTask'], ["Get", "Set"])

    prop_meta = {
        "addr": MoPropertyMeta("addr", "addr", "string", VersionMeta.Version221b, MoPropertyMeta.READ_WRITE, 0x2L, 0, 256, None, [], []), 
