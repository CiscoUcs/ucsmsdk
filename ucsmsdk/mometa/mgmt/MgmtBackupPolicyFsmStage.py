...
class MgmtBackupPolicyFsmStage(ManagedObject):
    """This is MgmtBackupPolicyFsmStage class."""

    consts = MgmtBackupPolicyFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("MgmtBackupPolicyFsmStage", "mgmtBackupPolicyFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'mgmtBackupPolicyFsm'], [], [None])
