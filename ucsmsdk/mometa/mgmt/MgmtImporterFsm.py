...
class MgmtImporterFsm(ManagedObject):
    """This is MgmtImporterFsm class."""

    consts = MgmtImporterFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("MgmtImporterFsm", "mgmtImporterFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'mgmtImporter'], [u'mgmtImporterFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["import", "nop"], []), 
