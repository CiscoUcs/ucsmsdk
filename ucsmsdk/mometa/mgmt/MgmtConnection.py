...
class MgmtConnection(ManagedObject):
    ...
    mo_meta = MoMeta("MgmtConnection", "mgmtConnection", "mgmt-connection-[type]", VersionMeta.Version211a, "InputOutput", 0x3fL, [], ["admin"], [u'mgmtController'], [u'faultInst'], ["Get", "Set"])

    prop_meta = {
        "ack": MoPropertyMeta("ack", "ack", "string", VersionMeta.Version211a, MoPropertyMeta.READ_WRITE, 0x1L, None, None, None, ["acknowledged", "un-initialized", "unsupported-connectivity"], []), 
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, 0x20L, None, None, None, ["shared-lom", "sideband", "unspecified"], []), 
    }
