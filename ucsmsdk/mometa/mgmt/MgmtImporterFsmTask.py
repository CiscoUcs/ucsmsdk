"""This module contains the general information for MgmtImporterFsmTask ManagedObject."""
import sys, os
...
class MgmtImporterFsmTaskConsts():
...
class MgmtImporterFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("MgmtImporterFsmTask", "mgmtImporterFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], [""], [u'mgmtImporter'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, None, None, None, None, ["import", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "MgmtImporterFsmTask", parent_mo_or_dn, **kwargs)
