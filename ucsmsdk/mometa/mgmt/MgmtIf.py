...
class MgmtIf(ManagedObject):
    ...
    prop_meta = {
        ...
        "last_oper_gw": MoPropertyMeta("last_oper_gw", "lastOperGw", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []),
        "last_oper_prefix": MoPropertyMeta("last_oper_prefix", "lastOperPrefix", "byte", None, MoPropertyMeta.READ_WRITE, 0x20, None, None, None, [], ["1-127"]),
