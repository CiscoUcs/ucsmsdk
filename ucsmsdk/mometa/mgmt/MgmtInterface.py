...
class MgmtInterface(ManagedObject):
    ...
    mo_meta = MoMeta("MgmtInterface", "mgmtInterface", "iface-[mode]", VersionMeta.Version221b, "InputOutput", 0xffL, [], ["admin", "ls-compute", "ls-config", "ls-network", "ls-server"], [u'lsServer', u'lstorageProcessor', u'mgmtController'], [u'faultInst', u'mgmtVnet'], ["Add", "Get", "Remove", "Set"])
