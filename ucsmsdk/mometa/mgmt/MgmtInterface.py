...
class MgmtInterface(ManagedObject):
    ...
    mo_meta = MoMeta("MgmtInterface", "mgmtInterface", "iface-[mode]", VersionMeta.Version221b, "InputOutput", 0x7fL, [], ["admin", "ls-compute", "ls-config", "ls-network", "ls-server"], [u'lsServer', u'lstorageProcessor', u'mgmtController'], [u'faultInst', u'mgmtVnet'], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "ip_v4_state": MoPropertyMeta("ip_v4_state", "ipV4State", "string", VersionMeta.Version221b, MoPropertyMeta.READ_WRITE, 0x4L, None, None, None, ["none", "pooled", "static"], []), 
        "ip_v6_state": MoPropertyMeta("ip_v6_state", "ipV6State", "string", VersionMeta.Version221b, MoPropertyMeta.READ_WRITE, 0x8L, None, None, None, ["none", "pooled", "static"], []), 
        ...
        "mode": MoPropertyMeta("mode", "mode", "string", VersionMeta.Version221b, MoPropertyMeta.NAMING, 0x10L, None, None, None, ["in-band"], []), 
