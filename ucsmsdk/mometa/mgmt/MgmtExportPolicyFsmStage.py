"""This module contains the general information for MgmtExportPolicyFsmStage ManagedObject."""
import sys, os
...
class MgmtExportPolicyFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
...
class MgmtExportPolicyFsmStage(ManagedObject):
    """This is MgmtExportPolicyFsmStage class."""

    consts = MgmtExportPolicyFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("MgmtExportPolicyFsmStage", "mgmtExportPolicyFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'mgmtExportPolicyFsm'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "MgmtExportPolicyFsmStage", parent_mo_or_dn, **kwargs)
