...
class MgmtCimcSecureBoot(ManagedObject):
    ...
    mo_meta = MoMeta("MgmtCimcSecureBoot", "mgmtCimcSecureBoot", "mgmt-secure-boot", VersionMeta.Version223a, "InputOutput", 0x1fL, [], ["admin", "ls-compute"], [u'mgmtController'], [], ["Get", "Set"])

    prop_meta = {
        "admin_state": MoPropertyMeta("admin_state", "adminState", "string", VersionMeta.Version223a, MoPropertyMeta.READ_WRITE, 0x1L, None, None, None, ["disable", "enable"], []), 
