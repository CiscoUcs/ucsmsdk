"""This module contains the general information for MgmtBackupFsm ManagedObject."""
import sys, os
...
class MgmtBackupFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_BACKUP = "backup"
    CURRENT_FSM_NOP = "nop"
...
class MgmtBackupFsm(ManagedObject):
    """This is MgmtBackupFsm class."""

    consts = MgmtBackupFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("MgmtBackupFsm", "mgmtBackupFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'mgmtBackup'], [u'mgmtBackupFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["backup", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "MgmtBackupFsm", parent_mo_or_dn, **kwargs)
