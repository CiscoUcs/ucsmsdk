...
class MgmtBackupFsmStageConsts():
    ...
    NAME_BACKUP_FAIL = "backupFail"
    NAME_BACKUP_SUCCESS = "backupSuccess"
    NAME_BACKUP_UPLOAD = "backupUpload"
    NAME_NOP = "nop"
...
class MgmtBackupFsmStage(ManagedObject):
    """This is MgmtBackupFsmStage class."""

    consts = MgmtBackupFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("MgmtBackupFsmStage", "mgmtBackupFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'mgmtBackupFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["backupBackupLocal", "backupBegin", "backupFail", "backupSuccess", "backupUpload", "nop"], []), 
