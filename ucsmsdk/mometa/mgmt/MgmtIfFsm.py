...
class MgmtIfFsmConsts():
    ...
    CURRENT_FSM_ENABLE_VIP = "EnableVip"
    CURRENT_FSM_FA_CONN = "FaConn"
    CURRENT_FSM_FA_PRESENCE = "FaPresence"
    CURRENT_FSM_SW_MGMT_INBAND_IF_CONFIG = "SwMgmtInbandIfConfig"
    CURRENT_FSM_SW_MGMT_OOB_IF_CONFIG = "SwMgmtOobIfConfig"
    CURRENT_FSM_VIRTUAL_IF_CONFIG = "VirtualIfConfig"
    CURRENT_FSM_NOP = "nop"
...
class MgmtIfFsm(ManagedObject):
    """This is MgmtIfFsm class."""

    consts = MgmtIfFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("MgmtIfFsm", "mgmtIfFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'mgmtIf'], [u'mgmtIfFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["DisableVip", "EnableHA", "EnableVip", "FaConn", "FaPresence", "SwMgmtInbandIfConfig", "SwMgmtOobIfConfig", "VirtualIfConfig", "nop"], []), 
