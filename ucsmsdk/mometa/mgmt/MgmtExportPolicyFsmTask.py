...
class MgmtExportPolicyFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("MgmtExportPolicyFsmTask", "mgmtExportPolicyFsmTask", "task-[item]", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'mgmtBackupPolicy', u'mgmtCfgExportPolicy'], [], [None])
