"""This module contains the general information for MgmtExportPolicyFsmTask ManagedObject."""
import sys, os
...
class MgmtExportPolicyFsmTaskConsts():
    COMPLETION_CANCELLED = "cancelled"
    COMPLETION_COMPLETED = "completed"
    COMPLETION_PROCESSING = "processing"
    COMPLETION_SCHEDULED = "scheduled"
    ITEM_REPORT_CONFIG_COPY = "ReportConfigCopy"
    ITEM_NOP = "nop"
...
class MgmtExportPolicyFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("MgmtExportPolicyFsmTask", "mgmtExportPolicyFsmTask", "task-[item]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'mgmtBackupPolicy', u'mgmtCfgExportPolicy'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["ReportConfigCopy", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "MgmtExportPolicyFsmTask", parent_mo_or_dn, **kwargs)
