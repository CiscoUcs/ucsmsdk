...
class StatsCollectionPolicyFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("StatsCollectionPolicyFsmTask", "statsCollectionPolicyFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], [""], [u'statsCollectionPolicy'], [], [None])
