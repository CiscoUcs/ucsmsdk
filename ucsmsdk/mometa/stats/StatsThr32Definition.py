...
class StatsThr32Definition(ManagedObject):
    ...
    mo_meta = MoMeta("StatsThr32Definition", "statsThr32Definition", "[prop_id]", VersionMeta.Version101e, "InputOutput", 0x1fffL, [], ["admin", "operations"], [u'statsThresholdClass'], [u'statsThr32Value', u'statsThr64Value', u'statsThrFloatValue'], ["Add", "Get", "Set"])
    ...
    prop_meta = {
        ...
        "normal_value": MoPropertyMeta("normal_value", "normalValue", "uint", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x100L, None, None, None, [], []), 
