...
class StatsThr32Value(ManagedObject):
    ...
    mo_meta = MoMeta("StatsThr32Value", "statsThr32Value", "[direction]-[severity]", VersionMeta.Version101e, "InputOutput", 0xfffL, [], ["admin", "operations"], [u'statsThr32Definition', u'statsThr64Definition', u'statsThrFloatDefinition'], [], ["Add", "Get", "Set"])
    ...
    prop_meta = {
        ...
        "deescalating": MoPropertyMeta("deescalating", "deescalating", "uint", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x4L, None, None, None, [], []), 
        ...
        "escalating": MoPropertyMeta("escalating", "escalating", "uint", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x40L, None, None, None, [], []), 
