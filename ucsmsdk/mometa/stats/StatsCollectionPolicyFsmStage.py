...
class StatsCollectionPolicyFsmStageConsts():
    ...
    NAME_UPDATE_EP_SET_EP_A = "updateEpSetEpA"
    NAME_UPDATE_EP_SET_EP_B = "updateEpSetEpB"
...
class StatsCollectionPolicyFsmStage(ManagedObject):
    """This is StatsCollectionPolicyFsmStage class."""

    consts = StatsCollectionPolicyFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("StatsCollectionPolicyFsmStage", "statsCollectionPolicyFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'statsCollectionPolicyFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["nop", "updateEpBegin", "updateEpFail", "updateEpSetEpA", "updateEpSetEpB", "updateEpSuccess"], []), 
