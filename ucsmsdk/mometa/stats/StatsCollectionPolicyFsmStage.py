...
class StatsCollectionPolicyFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("StatsCollectionPolicyFsmStage", "statsCollectionPolicyFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'statsCollectionPolicyFsm'], [], [None])
