...
class StatsCollectionPolicyFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("StatsCollectionPolicyFsmStage", "statsCollectionPolicyFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xf, [], [""], [u'statsCollectionPolicyFsm'], [], [None])
