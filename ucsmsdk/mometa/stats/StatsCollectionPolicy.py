...
class StatsCollectionPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("StatsCollectionPolicy", "statsCollectionPolicy", "coll-policy-[name]", VersionMeta.Version102d, "InputOutput", 0x1ff, [], ["admin", "operations"], ['statsHolder'], ['eventInst', 'faultInst', 'statsCollectionPolicyFsm', 'statsCollectionPolicyFsmTask'], ["Get", "Set"])
