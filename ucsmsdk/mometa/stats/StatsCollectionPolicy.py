...
class StatsCollectionPolicyConsts():
    ...
    FSM_PREV_UPDATE_EP_SET_EP_A = "updateEpSetEpA"
    FSM_PREV_UPDATE_EP_SET_EP_B = "updateEpSetEpB"
    FSM_PREV_UPDATE_EP_SUCCESS = "updateEpSuccess"
    ...
    FSM_STATUS_NOP = "nop"
    FSM_STATUS_UPDATE_EP_BEGIN = "updateEpBegin"
    FSM_STATUS_UPDATE_EP_FAIL = "updateEpFail"
    FSM_STATUS_UPDATE_EP_SET_EP_A = "updateEpSetEpA"
    FSM_STATUS_UPDATE_EP_SET_EP_B = "updateEpSetEpB"
    FSM_STATUS_UPDATE_EP_SUCCESS = "updateEpSuccess"
...
class StatsCollectionPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("StatsCollectionPolicy", "statsCollectionPolicy", "coll-policy-[name]", VersionMeta.Version102d, "InputOutput", 0xffL, [], ["admin", "operations"], [u'statsHolder'], [u'eventInst', u'faultInst', u'statsCollectionPolicyFsm', u'statsCollectionPolicyFsmTask'], ["Get", "Set"])

    prop_meta = {
        "child_action": MoPropertyMeta("child_action", "childAction", "string", VersionMeta.Version102d, MoPropertyMeta.INTERNAL, 0x1L, None, None, """((deleteAll|ignore|deleteNonPresent),){0,2}(deleteAll|ignore|deleteNonPresent){0,1}""", [], []), 
        "collection_interval": MoPropertyMeta("collection_interval", "collectionInterval", "string", VersionMeta.Version102d, MoPropertyMeta.READ_WRITE, 0x2L, None, None, None, ["1minute", "2minutes", "30seconds", "5minutes"], []), 
        "dn": MoPropertyMeta("dn", "dn", "string", VersionMeta.Version102d, MoPropertyMeta.READ_ONLY, 0x4L, 0, 256, None, [], []), 
        ...
        "fsm_stage_descr": MoPropertyMeta("fsm_stage_descr", "fsmStageDescr", "string", VersionMeta.Version102d, MoPropertyMeta.INTERNAL, None, None, None, None, [], []), 
        "fsm_stamp": MoPropertyMeta("fsm_stamp", "fsmStamp", "string", VersionMeta.Version102d, MoPropertyMeta.INTERNAL, None, None, None, """([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", ["never"], []), 
        ...
        "id": MoPropertyMeta("id", "id", "ushort", VersionMeta.Version102d, MoPropertyMeta.CREATE_ONLY, 0x8L, None, None, None, [], []), 
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version102d, MoPropertyMeta.NAMING, 0x10L, None, None, None, ["adapter", "chassis", "fex", "host", "port", "server", "unknown"], []), 
        "reporting_interval": MoPropertyMeta("reporting_interval", "reportingInterval", "string", VersionMeta.Version102d, MoPropertyMeta.READ_WRITE, 0x20L, None, None, None, ["15minutes", "2hours", "2minutes", "30minutes", "4hours", "60minutes", "8hours"], []), 
        "rn": MoPropertyMeta("rn", "rn", "string", VersionMeta.Version102d, MoPropertyMeta.READ_ONLY, 0x40L, 0, 256, None, [], []), 
        "sacl": MoPropertyMeta("sacl", "sacl", "string", VersionMeta.Version302a, MoPropertyMeta.READ_ONLY, None, None, None, """((none|del|mod|addchild|cascade),){0,4}(none|del|mod|addchild|cascade){0,1}""", [], []), 
        "status": MoPropertyMeta("status", "status", "string", VersionMeta.Version102d, MoPropertyMeta.READ_WRITE, 0x80L, None, None, """((removed|created|modified|deleted),){0,3}(removed|created|modified|deleted){0,1}""", [], []), 
    }
