...
class StatsThrFloatDefinition(ManagedObject):
    ...
    mo_meta = MoMeta("StatsThrFloatDefinition", "statsThrFloatDefinition", "[prop_id]", VersionMeta.Version101e, "InputOutput", 0x1fffL, [], ["admin", "operations"], [u'statsThresholdClass'], [u'statsThr32Value', u'statsThr64Value', u'statsThrFloatValue'], ["Get"])
    ...
    prop_meta = {
        ...
        "normal_value": MoPropertyMeta("normal_value", "normalValue", "float", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x100L, None, None, None, [], []), 
