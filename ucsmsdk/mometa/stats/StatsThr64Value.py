...
class StatsThr64Value(ManagedObject):
    ...
    mo_meta = MoMeta("StatsThr64Value", "statsThr64Value", "[direction]-[severity]", VersionMeta.Version101e, "InputOutput", 0xfffL, [], ["admin", "operations"], [u'statsThr32Definition', u'statsThr64Definition', u'statsThrFloatDefinition'], [], ["Add", "Get", "Set"])
    ...
    prop_meta = {
        ...
        "deescalating": MoPropertyMeta("deescalating", "deescalating", "ulong", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x4L, None, None, None, [], []), 
        ...
        "direction": MoPropertyMeta("direction", "direction", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x10L, None, None, None, ["aboveNormal", "belowNormal"], []), 
        "dn": MoPropertyMeta("dn", "dn", "string", VersionMeta.Version101e, MoPropertyMeta.READ_ONLY, 0x20L, 0, 256, None, [], []), 
        "escalating": MoPropertyMeta("escalating", "escalating", "ulong", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x40L, None, None, None, [], []), 
        ...
        "severity": MoPropertyMeta("severity", "severity", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x400L, None, None, None, ["cleared", "condition", "critical", "info", "major", "minor", "warning"], []), 
