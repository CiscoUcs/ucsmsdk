...
class StatsThr64Value(ManagedObject):
    """This is StatsThr64Value class."""

    consts = StatsThr64ValueConsts()
    naming_props = set([u'direction', u'severity'])

    mo_meta = MoMeta("StatsThr64Value", "statsThr64Value", "[direction]-[severity]", VersionMeta.Version101e, "InputOutput", 0x7ffL, [], ["admin", "operations"], [u'statsThr32Definition', u'statsThr64Definition', u'statsThrFloatDefinition'], [], ["Add", "Get", "Set"])
    ...
    prop_meta = {
        ...
        "deescalating": MoPropertyMeta("deescalating", "deescalating", "ulong", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x2L, None, None, None, [], []), 
        ...
        "direction": MoPropertyMeta("direction", "direction", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x8L, None, None, None, ["aboveNormal", "belowNormal"], []), 
        "dn": MoPropertyMeta("dn", "dn", "string", VersionMeta.Version101e, MoPropertyMeta.READ_ONLY, 0x10L, 0, 256, None, [], []), 
        "escalating": MoPropertyMeta("escalating", "escalating", "ulong", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x20L, None, None, None, [], []), 
        ...
        "severity": MoPropertyMeta("severity", "severity", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x200L, None, None, None, ["cleared", "condition", "critical", "info", "major", "minor", "warning"], []), 
