...
class StatsThr64DefinitionConsts():
    ...
    PROP_ID_COMPUTE_STORAGE_BLADE_MB_TEMP_STATSFRONT_TEMP = "computeStorageBladeMbTempStatsfrontTemp"
    PROP_ID_COMPUTE_STORAGE_BLADE_MB_TEMP_STATSFRONT_TEMP_AVG = "computeStorageBladeMbTempStatsfrontTempAvg"
    PROP_ID_COMPUTE_STORAGE_BLADE_MB_TEMP_STATSFRONT_TEMP_MAX = "computeStorageBladeMbTempStatsfrontTempMax"
    PROP_ID_COMPUTE_STORAGE_BLADE_MB_TEMP_STATSFRONT_TEMP_MIN = "computeStorageBladeMbTempStatsfrontTempMin"
    PROP_ID_COMPUTE_STORAGE_BLADE_MB_TEMP_STATSLEFT_REAR_TEMP = "computeStorageBladeMbTempStatsleftRearTemp"
    PROP_ID_COMPUTE_STORAGE_BLADE_MB_TEMP_STATSLEFT_REAR_TEMP_AVG = "computeStorageBladeMbTempStatsleftRearTempAvg"
    PROP_ID_COMPUTE_STORAGE_BLADE_MB_TEMP_STATSLEFT_REAR_TEMP_MAX = "computeStorageBladeMbTempStatsleftRearTempMax"
    PROP_ID_COMPUTE_STORAGE_BLADE_MB_TEMP_STATSLEFT_REAR_TEMP_MIN = "computeStorageBladeMbTempStatsleftRearTempMin"
    PROP_ID_COMPUTE_STORAGE_BLADE_MB_TEMP_STATSRIGHT_REAR_TEMP = "computeStorageBladeMbTempStatsrightRearTemp"
    PROP_ID_COMPUTE_STORAGE_BLADE_MB_TEMP_STATSRIGHT_REAR_TEMP_AVG = "computeStorageBladeMbTempStatsrightRearTempAvg"
    PROP_ID_COMPUTE_STORAGE_BLADE_MB_TEMP_STATSRIGHT_REAR_TEMP_MAX = "computeStorageBladeMbTempStatsrightRearTempMax"
    PROP_ID_COMPUTE_STORAGE_BLADE_MB_TEMP_STATSRIGHT_REAR_TEMP_MIN = "computeStorageBladeMbTempStatsrightRearTempMin"
    PROP_ID_EQUIPMENT_CHASSIS_STATS_CHASSIS_I2_CERRORS_DELTA = "equipmentChassisStatsChassisI2CErrorsDelta"
    PROP_ID_EQUIPMENT_CHASSIS_STATS_CHASSIS_I2_CERRORS_DELTA_AVG = "equipmentChassisStatsChassisI2CErrorsDeltaAvg"
    PROP_ID_EQUIPMENT_CHASSIS_STATS_CHASSIS_I2_CERRORS_DELTA_MAX = "equipmentChassisStatsChassisI2CErrorsDeltaMax"
    PROP_ID_EQUIPMENT_CHASSIS_STATS_CHASSIS_I2_CERRORS_DELTA_MIN = "equipmentChassisStatsChassisI2CErrorsDeltaMin"
    ...
    PROP_ID_EQUIPMENT_IOCARD_STATS_IOM_I2_CERRORS_DELTA = "equipmentIOCardStatsIomI2CErrorsDelta"
    PROP_ID_EQUIPMENT_IOCARD_STATS_IOM_I2_CERRORS_DELTA_AVG = "equipmentIOCardStatsIomI2CErrorsDeltaAvg"
    PROP_ID_EQUIPMENT_IOCARD_STATS_IOM_I2_CERRORS_DELTA_MAX = "equipmentIOCardStatsIomI2CErrorsDeltaMax"
    PROP_ID_EQUIPMENT_IOCARD_STATS_IOM_I2_CERRORS_DELTA_MIN = "equipmentIOCardStatsIomI2CErrorsDeltaMin"
    ...
    PROP_ID_EQUIPMENT_PSU_STATS_PSU_I2_CERRORS_DELTA = "equipmentPsuStatsPsuI2CErrorsDelta"
    PROP_ID_EQUIPMENT_PSU_STATS_PSU_I2_CERRORS_DELTA_AVG = "equipmentPsuStatsPsuI2CErrorsDeltaAvg"
    PROP_ID_EQUIPMENT_PSU_STATS_PSU_I2_CERRORS_DELTA_MAX = "equipmentPsuStatsPsuI2CErrorsDeltaMax"
    PROP_ID_EQUIPMENT_PSU_STATS_PSU_I2_CERRORS_DELTA_MIN = "equipmentPsuStatsPsuI2CErrorsDeltaMin"
    ...
    PROP_ID_MEMORY_NV_DIMM_ENV_STATSTEMPERATURE = "memoryNvDimmEnvStatstemperature"
    PROP_ID_MEMORY_NV_DIMM_ENV_STATSTEMPERATURE_AVG = "memoryNvDimmEnvStatstemperatureAvg"
    PROP_ID_MEMORY_NV_DIMM_ENV_STATSTEMPERATURE_MAX = "memoryNvDimmEnvStatstemperatureMax"
    PROP_ID_MEMORY_NV_DIMM_ENV_STATSTEMPERATURE_MIN = "memoryNvDimmEnvStatstemperatureMin"
    PROP_ID_MEMORY_NV_DIMM_ENV_STATSVOLTAGE = "memoryNvDimmEnvStatsvoltage"
    PROP_ID_MEMORY_NV_DIMM_ENV_STATSVOLTAGE_AVG = "memoryNvDimmEnvStatsvoltageAvg"
    PROP_ID_MEMORY_NV_DIMM_ENV_STATSVOLTAGE_MAX = "memoryNvDimmEnvStatsvoltageMax"
    PROP_ID_MEMORY_NV_DIMM_ENV_STATSVOLTAGE_MIN = "memoryNvDimmEnvStatsvoltageMin"
    ...
    PROP_ID_STORAGE_CTRL_STORAGE_STATSCPU_LOAD = "storageCtrlStorageStatscpuLoad"
    PROP_ID_STORAGE_CTRL_STORAGE_STATSCPU_LOAD_AVG = "storageCtrlStorageStatscpuLoadAvg"
    PROP_ID_STORAGE_CTRL_STORAGE_STATSCPU_LOAD_MAX = "storageCtrlStorageStatscpuLoadMax"
    PROP_ID_STORAGE_CTRL_STORAGE_STATSCPU_LOAD_MIN = "storageCtrlStorageStatscpuLoadMin"
    PROP_ID_STORAGE_CTRL_STORAGE_STATSMEMORY_USAGE = "storageCtrlStorageStatsmemoryUsage"
    PROP_ID_STORAGE_CTRL_STORAGE_STATSMEMORY_USAGE_AVG = "storageCtrlStorageStatsmemoryUsageAvg"
    PROP_ID_STORAGE_CTRL_STORAGE_STATSMEMORY_USAGE_MAX = "storageCtrlStorageStatsmemoryUsageMax"
    PROP_ID_STORAGE_CTRL_STORAGE_STATSMEMORY_USAGE_MIN = "storageCtrlStorageStatsmemoryUsageMin"
    ...
    PROP_ID_STORAGE_STORAGE_STATSIOPS = "storageStorageStatsiops"
    PROP_ID_STORAGE_STORAGE_STATSIOPS_AVG = "storageStorageStatsiopsAvg"
    PROP_ID_STORAGE_STORAGE_STATSIOPS_MAX = "storageStorageStatsiopsMax"
    PROP_ID_STORAGE_STORAGE_STATSIOPS_MIN = "storageStorageStatsiopsMin"
    PROP_ID_STORAGE_STORAGE_STATSLATENCY = "storageStorageStatslatency"
    PROP_ID_STORAGE_STORAGE_STATSLATENCY_AVG = "storageStorageStatslatencyAvg"
    PROP_ID_STORAGE_STORAGE_STATSLATENCY_MAX = "storageStorageStatslatencyMax"
    PROP_ID_STORAGE_STORAGE_STATSLATENCY_MIN = "storageStorageStatslatencyMin"
    PROP_ID_STORAGE_STORAGE_STATSMBPS = "storageStorageStatsmbps"
    PROP_ID_STORAGE_STORAGE_STATSMBPS_AVG = "storageStorageStatsmbpsAvg"
    PROP_ID_STORAGE_STORAGE_STATSMBPS_MAX = "storageStorageStatsmbpsMax"
    PROP_ID_STORAGE_STORAGE_STATSMBPS_MIN = "storageStorageStatsmbpsMin"
    PROP_ID_STORAGE_STORAGE_STATSREAD_IOPS = "storageStorageStatsreadIops"
    PROP_ID_STORAGE_STORAGE_STATSREAD_IOPS_AVG = "storageStorageStatsreadIopsAvg"
    PROP_ID_STORAGE_STORAGE_STATSREAD_IOPS_MAX = "storageStorageStatsreadIopsMax"
    PROP_ID_STORAGE_STORAGE_STATSREAD_IOPS_MIN = "storageStorageStatsreadIopsMin"
    PROP_ID_STORAGE_STORAGE_STATSREAD_MBPS = "storageStorageStatsreadMbps"
    PROP_ID_STORAGE_STORAGE_STATSREAD_MBPS_AVG = "storageStorageStatsreadMbpsAvg"
    PROP_ID_STORAGE_STORAGE_STATSREAD_MBPS_MAX = "storageStorageStatsreadMbpsMax"
    PROP_ID_STORAGE_STORAGE_STATSREAD_MBPS_MIN = "storageStorageStatsreadMbpsMin"
    PROP_ID_STORAGE_STORAGE_STATSWRITE_IOPS = "storageStorageStatswriteIops"
    PROP_ID_STORAGE_STORAGE_STATSWRITE_IOPS_AVG = "storageStorageStatswriteIopsAvg"
    PROP_ID_STORAGE_STORAGE_STATSWRITE_IOPS_MAX = "storageStorageStatswriteIopsMax"
    PROP_ID_STORAGE_STORAGE_STATSWRITE_IOPS_MIN = "storageStorageStatswriteIopsMin"
    PROP_ID_STORAGE_STORAGE_STATSWRITE_MBPS = "storageStorageStatswriteMbps"
    PROP_ID_STORAGE_STORAGE_STATSWRITE_MBPS_AVG = "storageStorageStatswriteMbpsAvg"
    PROP_ID_STORAGE_STORAGE_STATSWRITE_MBPS_MAX = "storageStorageStatswriteMbpsMax"
    PROP_ID_STORAGE_STORAGE_STATSWRITE_MBPS_MIN = "storageStorageStatswriteMbpsMin"
...
class StatsThr64Definition(ManagedObject):
    ...
    mo_meta = MoMeta("StatsThr64Definition", "statsThr64Definition", "[prop_id]", VersionMeta.Version101e, "InputOutput", 0xfffL, [], ["admin", "operations"], [u'statsThresholdClass'], [u'statsThr32Value', u'statsThr64Value', u'statsThrFloatValue'], ["Add", "Get", "Set"])

    prop_meta = {
        "auto_recovery": MoPropertyMeta("auto_recovery", "autoRecovery", "string", VersionMeta.Version224a, MoPropertyMeta.READ_WRITE, 0x1L, None, None, None, ["disabled", "enabled"], []), 
        "auto_recovery_time": MoPropertyMeta("auto_recovery_time", "autoRecoveryTime", "ushort", VersionMeta.Version224a, MoPropertyMeta.READ_WRITE, 0x2L, None, None, None, [], []), 
        ...
        "error_disable_fi_port": MoPropertyMeta("error_disable_fi_port", "errorDisableFiPort", "string", VersionMeta.Version224a, MoPropertyMeta.READ_WRITE, 0x20L, None, None, None, ["false", "no", "true", "yes"], []), 
        ...
        "normal_value": MoPropertyMeta("normal_value", "normalValue", "ulong", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x80L, None, None, None, [], []), 
