...
class StatsThr64Definition(ManagedObject):
    ...
    mo_meta = MoMeta("StatsThr64Definition", "statsThr64Definition", "[prop_id]", VersionMeta.Version101e, "InputOutput", 0x1fffL, [], ["admin", "operations"], [u'statsThresholdClass'], [u'statsThr32Value', u'statsThr64Value', u'statsThrFloatValue'], ["Add", "Get", "Set"])

    prop_meta = {
        "auto_recovery": MoPropertyMeta("auto_recovery", "autoRecovery", "string", VersionMeta.Version224b, MoPropertyMeta.READ_WRITE, 0x2L, None, None, None, ["disabled", "enabled"], []), 
        "auto_recovery_time": MoPropertyMeta("auto_recovery_time", "autoRecoveryTime", "ushort", VersionMeta.Version224b, MoPropertyMeta.READ_WRITE, 0x4L, None, None, None, [], []), 
        ...
        "error_disable_fi_port": MoPropertyMeta("error_disable_fi_port", "errorDisableFiPort", "string", VersionMeta.Version224b, MoPropertyMeta.READ_WRITE, 0x40L, None, None, None, ["false", "no", "true", "yes"], []), 
        ...
        "normal_value": MoPropertyMeta("normal_value", "normalValue", "ulong", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x100L, None, None, None, [], []), 
