...
class StatsCollectionPolicyFsm(ManagedObject):
    ...
    mo_meta = MoMeta("StatsCollectionPolicyFsm", "statsCollectionPolicyFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'statsCollectionPolicy'], [u'statsCollectionPolicyFsmStage'], [None])
