"""This module contains the general information for StatsCollectionPolicyFsm ManagedObject."""
import sys, os
...
class StatsCollectionPolicyFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_NOP = "nop"
    CURRENT_FSM_UPDATE_EP = "updateEp"
...
class StatsCollectionPolicyFsm(ManagedObject):
    """This is StatsCollectionPolicyFsm class."""

    consts = StatsCollectionPolicyFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("StatsCollectionPolicyFsm", "statsCollectionPolicyFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'statsCollectionPolicy'], [u'statsCollectionPolicyFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["nop", "updateEp"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "StatsCollectionPolicyFsm", parent_mo_or_dn, **kwargs)
