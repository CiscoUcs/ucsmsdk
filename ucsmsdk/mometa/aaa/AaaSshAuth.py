...
class AaaSshAuth(ManagedObject):
    ...
    prop_meta = {
        ...
        "internal_key_status": MoPropertyMeta("internal_key_status", "internalKeyStatus", "string", VersionMeta.Version601a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["false", "no", "true", "yes"], []),
        ...
        "private_key": MoPropertyMeta("private_key", "privateKey", "string", VersionMeta.Version601a, MoPropertyMeta.READ_ONLY, None, None, None, r"""[\n\r \+\-\./=@_a-zA-Z0-9]{0,16384}""", [], []),
        "public_key": MoPropertyMeta("public_key", "publicKey", "string", VersionMeta.Version601a, MoPropertyMeta.READ_ONLY, None, None, None, r"""[\n\r \+\-\./=@_a-zA-Z0-9]{0,16384}""", [], []),
        "regen": MoPropertyMeta("regen", "regen", "string", VersionMeta.Version601a, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["false", "no", "true", "yes"], []),
