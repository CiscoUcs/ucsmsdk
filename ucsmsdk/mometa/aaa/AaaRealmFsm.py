"""This module contains the general information for AaaRealmFsm ManagedObject."""
import sys, os
...
class AaaRealmFsm(ManagedObject):
    """This is AaaRealmFsm class."""

    consts = AaaRealmFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("AaaRealmFsm", "aaaRealmFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'aaaAuthRealm'], [u'aaaRealmFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["nop", "updateRealm"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "AaaRealmFsm", parent_mo_or_dn, **kwargs)
