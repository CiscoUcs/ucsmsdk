...
class AaaExtMgmtCutThruTkn(ManagedObject):
    ...
    mo_meta = MoMeta("AaaExtMgmtCutThruTkn", "aaaExtMgmtCutThruTkn", "-[token]", VersionMeta.Version102d, "InputOutput", 0x1ffL, [], ["aaa", "admin"], [u'aaaUserEp'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version102d, MoPropertyMeta.CREATE_ONLY, 0x10L, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        ...
        "token": MoPropertyMeta("token", "token", "string", VersionMeta.Version102d, MoPropertyMeta.NAMING, 0x100L, 1, 510, None, [], []), 
