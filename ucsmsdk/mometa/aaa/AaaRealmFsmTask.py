"""This module contains the general information for AaaRealmFsmTask ManagedObject."""
import sys, os
...
class AaaRealmFsmTaskConsts():
    COMPLETION_CANCELLED = "cancelled"
    COMPLETION_COMPLETED = "completed"
    COMPLETION_PROCESSING = "processing"
    COMPLETION_SCHEDULED = "scheduled"
    ITEM_NOP = "nop"
    ITEM_UPDATE_REALM = "updateRealm"


class AaaRealmFsmTask(ManagedObject):
    """This is AaaRealmFsmTask class."""

    consts = AaaRealmFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("AaaRealmFsmTask", "aaaRealmFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], [""], [u'aaaAuthRealm'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, None, None, None, None, ["nop", "updateRealm"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "AaaRealmFsmTask", parent_mo_or_dn, **kwargs)
