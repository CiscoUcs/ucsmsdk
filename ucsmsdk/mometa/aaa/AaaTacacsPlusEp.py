"""This module contains the general information for AaaTacacsPlusEp ManagedObject."""
import sys, os
...
class AaaTacacsPlusEp(ManagedObject):
    """This is AaaTacacsPlusEp class."""

    consts = AaaTacacsPlusEpConsts()
    naming_props = set([])

    mo_meta = MoMeta("AaaTacacsPlusEp", "aaaTacacsPlusEp", "tacacs-ext", VersionMeta.Version101e, "InputOutput", 0x3ffL, [], ["aaa", "admin"], [u'topSystem'], [u'aaaEpFsm', u'aaaEpFsmTask', u'aaaProviderGroup', u'aaaTacacsPlusEpFsm', u'aaaTacacsPlusProvider', u'eventInst', u'faultInst'], ["Get", "Set"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "AaaTacacsPlusEp", parent_mo_or_dn, **kwargs)
