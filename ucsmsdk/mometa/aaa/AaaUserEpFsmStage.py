"""This module contains the general information for AaaUserEpFsmStage ManagedObject."""
import sys, os
...
class AaaUserEpFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_NOP = "nop"
    NAME_UPDATE_USER_EP_BEGIN = "updateUserEpBegin"
    NAME_UPDATE_USER_EP_FAIL = "updateUserEpFail"
    NAME_UPDATE_USER_EP_SET_USER_LOCAL = "updateUserEpSetUserLocal"
    NAME_UPDATE_USER_EP_SET_USER_PEER = "updateUserEpSetUserPeer"
    NAME_UPDATE_USER_EP_SUCCESS = "updateUserEpSuccess"
...
class AaaUserEpFsmStage(ManagedObject):
    """This is AaaUserEpFsmStage class."""

    consts = AaaUserEpFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("AaaUserEpFsmStage", "aaaUserEpFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'aaaUserEpFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["nop", "updateUserEpBegin", "updateUserEpFail", "updateUserEpSetUserLocal", "updateUserEpSetUserPeer", "updateUserEpSuccess"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "AaaUserEpFsmStage", parent_mo_or_dn, **kwargs)
