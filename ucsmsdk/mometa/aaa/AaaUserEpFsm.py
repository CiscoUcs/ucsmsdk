...
class AaaUserEpFsm(ManagedObject):
    """This is AaaUserEpFsm class."""

    consts = AaaUserEpFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("AaaUserEpFsm", "aaaUserEpFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'aaaUserEp'], [u'aaaUserEpFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["nop", "updateUserEp"], []), 
