...
class AaaWebLogin(ManagedObject):
    ...
    mo_meta = MoMeta("AaaWebLogin", "aaaWebLogin", "web-login-[name]-[id]", VersionMeta.Version101e, "InputOutput", 0xffL, [], ["read-only"], [u'aaaUserEp'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "id": MoPropertyMeta("id", "id", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x8L, 1, 32, None, [], []), 
