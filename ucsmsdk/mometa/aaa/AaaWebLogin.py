"""This module contains the general information for AaaWebLogin ManagedObject."""
import sys, os
...
class AaaWebLogin(ManagedObject):
    """This is AaaWebLogin class."""

    consts = AaaWebLoginConsts()
    naming_props = set([u'name', u'id'])

    mo_meta = MoMeta("AaaWebLogin", "aaaWebLogin", "web-login-[name]-[id]", VersionMeta.Version101e, "InputOutput", 0x1ffL, [], ["read-only"], [u'aaaUserEp'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "id": MoPropertyMeta("id", "id", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x10L, 1, 32, None, [], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, id, **kwargs):
        ...
        ManagedObject.__init__(self, "AaaWebLogin", parent_mo_or_dn, **kwargs)
