...
class AaaLdapEp(ManagedObject):
    ...
    mo_meta = MoMeta("AaaLdapEp", "aaaLdapEp", "ldap-ext", VersionMeta.Version101e, "InputOutput", 0xfffL, [], ["aaa", "admin"], [u'topSystem'], [u'aaaEpFsm', u'aaaEpFsmTask', u'aaaLdapEpFsm', u'aaaLdapGroup', u'aaaLdapGroupRule', u'aaaLdapProvider', u'aaaProviderGroup', u'eventInst', u'faultInst'], ["Get", "Set"])

    prop_meta = {
        "attribute": MoPropertyMeta("attribute", "attribute", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x1L, 0, 63, None, [], []), 
        "basedn": MoPropertyMeta("basedn", "basedn", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x2L, 0, 255, None, [], []), 
        ...
        "filter": MoPropertyMeta("filter", "filter", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x20L, 0, 127, None, [], []), 
        ...
        "retries": MoPropertyMeta("retries", "retries", "uint", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x100L, None, None, None, [], ["0-5"]), 
        ...
        "timeout": MoPropertyMeta("timeout", "timeout", "uint", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x800L, None, None, None, [], ["1-60"]), 
    }
