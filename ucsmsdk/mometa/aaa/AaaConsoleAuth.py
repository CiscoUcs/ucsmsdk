...
class AaaConsoleAuth(ManagedObject):
    ...
    mo_meta = MoMeta("AaaConsoleAuth", "aaaConsoleAuth", "console-auth", VersionMeta.Version141i, "InputOutput", 0x1ffL, [], ["aaa", "admin"], [u'aaaAuthRealm'], [u'faultInst'], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "use2_factor": MoPropertyMeta("use2_factor", "use2Factor", "string", VersionMeta.Version221b, MoPropertyMeta.READ_WRITE, 0x100L, None, None, None, ["false", "no", "true", "yes"], []), 
    }
