...
class AaaUserLocale(ManagedObject):
    ...
    mo_meta = MoMeta("AaaUserLocale", "aaaUserLocale", "locale-[name]", VersionMeta.Version101e, "InputOutput", 0x7f, [], ["aaa", "admin"], ['aaaLdapGroup', 'aaaRemoteUser', 'aaaUser'], ['faultInst'], ["Add", "Get", "Remove", "Set"])
