"""This module contains the general information for AaaRealmFsmStage ManagedObject."""
import sys, os
...
class AaaRealmFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_NOP = "nop"
    NAME_UPDATE_REALM_BEGIN = "updateRealmBegin"
    NAME_UPDATE_REALM_FAIL = "updateRealmFail"
    NAME_UPDATE_REALM_SET_REALM_LOCAL = "updateRealmSetRealmLocal"
    NAME_UPDATE_REALM_SET_REALM_PEER = "updateRealmSetRealmPeer"
    NAME_UPDATE_REALM_SUCCESS = "updateRealmSuccess"
...
class AaaRealmFsmStage(ManagedObject):
    """This is AaaRealmFsmStage class."""

    consts = AaaRealmFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("AaaRealmFsmStage", "aaaRealmFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'aaaRealmFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["nop", "updateRealmBegin", "updateRealmFail", "updateRealmSetRealmLocal", "updateRealmSetRealmPeer", "updateRealmSuccess"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "AaaRealmFsmStage", parent_mo_or_dn, **kwargs)
