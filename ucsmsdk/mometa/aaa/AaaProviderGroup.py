"""This module contains the general information for AaaProviderGroup ManagedObject."""
...
class AaaProviderGroup(ManagedObject):
    ...
    mo_meta = MoMeta("AaaProviderGroup", "aaaProviderGroup", "providergroup-[name]", VersionMeta.Version141i, "InputOutput", 0x7f, [], ["aaa", "admin"], ['aaaLdapEp', 'aaaRadiusEp', 'aaaTacacsPlusEp'], ['aaaProviderRef', 'faultInst'], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x10, None, None, r"""[ !#$%&\(\)\*\+,\-\.:;=\?@\[\]_\{\|\}~a-zA-Z0-9]{1,127}""", [], []),
        ...
        "size": MoPropertyMeta("size", "size", "uint", VersionMeta.Version221b, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []),
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "AaaProviderGroup", parent_mo_or_dn, **kwargs)
