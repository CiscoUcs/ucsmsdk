"""This module contains the general information for AaaUserEpFsmTask ManagedObject."""
import sys, os
...
class AaaUserEpFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("AaaUserEpFsmTask", "aaaUserEpFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], [""], [u'aaaUserEp'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, None, None, None, None, ["nop", "updateUserEp"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "AaaUserEpFsmTask", parent_mo_or_dn, **kwargs)
