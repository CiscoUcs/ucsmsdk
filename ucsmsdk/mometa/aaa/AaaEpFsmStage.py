"""This module contains the general information for AaaEpFsmStage ManagedObject."""
import sys, os
...
class AaaEpFsmStage(ManagedObject):
    """This is AaaEpFsmStage class."""

    consts = AaaEpFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("AaaEpFsmStage", "aaaEpFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'aaaEpFsm'], [], [None])
