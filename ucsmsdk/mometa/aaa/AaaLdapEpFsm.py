"""This module contains the general information for AaaLdapEpFsm ManagedObject."""
import sys, os
...
class AaaLdapEpFsm(ManagedObject):
    """This is AaaLdapEpFsm class."""

    consts = AaaLdapEpFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("AaaLdapEpFsm", "aaaLdapEpFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'aaaLdapEp'], [u'aaaLdapEpFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "AaaLdapEpFsm", parent_mo_or_dn, **kwargs)
