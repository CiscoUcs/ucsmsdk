"""This module contains the general information for AaaEpFsm ManagedObject."""
import sys, os
...
class AaaEpFsm(ManagedObject):
    """This is AaaEpFsm class."""

    consts = AaaEpFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("AaaEpFsm", "aaaEpFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'aaaLdapEp', u'aaaRadiusEp', u'aaaTacacsPlusEp'], [u'aaaEpFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "AaaEpFsm", parent_mo_or_dn, **kwargs)
