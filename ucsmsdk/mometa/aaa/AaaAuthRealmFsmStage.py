"""This module contains the general information for AaaAuthRealmFsmStage ManagedObject."""
import sys, os
...
class AaaAuthRealmFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_NOP = "nop"
...
class AaaAuthRealmFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("AaaAuthRealmFsmStage", "aaaAuthRealmFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'aaaAuthRealmFsm'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "AaaAuthRealmFsmStage", parent_mo_or_dn, **kwargs)
