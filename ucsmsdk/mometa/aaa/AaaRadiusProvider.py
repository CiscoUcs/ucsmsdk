...
class AaaRadiusProvider(ManagedObject):
    ...
    mo_meta = MoMeta("AaaRadiusProvider", "aaaRadiusProvider", "provider-[name]", VersionMeta.Version101e, "InputOutput", 0x3fff, [], ["aaa", "admin"], ['aaaRadiusEp'], [], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "enc_key_type": MoPropertyMeta("enc_key_type", "encKeyType", "string", VersionMeta.Version601b, MoPropertyMeta.READ_WRITE, 0x40, 0, 8, None, [], []),
        ...
        "retries": MoPropertyMeta("retries", "retries", "uint", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x400, None, None, None, [], ["0-5"]),
        ...
        "timeout": MoPropertyMeta("timeout", "timeout", "uint", VersionMeta.Version141i, MoPropertyMeta.READ_WRITE, 0x2000, None, None, None, [], ["0-60"]),
    }
