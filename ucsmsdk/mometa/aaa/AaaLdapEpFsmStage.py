"""This module contains the general information for AaaLdapEpFsmStage ManagedObject."""
import sys, os
...
class AaaLdapEpFsmStage(ManagedObject):
    """This is AaaLdapEpFsmStage class."""

    consts = AaaLdapEpFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("AaaLdapEpFsmStage", "aaaLdapEpFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'aaaLdapEpFsm'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "AaaLdapEpFsmStage", parent_mo_or_dn, **kwargs)
