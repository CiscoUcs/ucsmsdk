"""This module contains the general information for AaaLog ManagedObject."""
import sys, os
...
class AaaLog(ManagedObject):
    """This is AaaLog class."""

    consts = AaaLogConsts()
    naming_props = set([])

    mo_meta = MoMeta("AaaLog", "aaaLog", "aaa-log", VersionMeta.Version101e, "InputOutput", 0x1fL, [], ["aaa", "admin", "operations"], [u'topRoot'], [u'aaaModLR', u'aaaSessionLR'], ["Get"])
    ...
    def __init__(self, **kwargs):
        ...
        ManagedObject.__init__(self, "AaaLog", **kwargs)
