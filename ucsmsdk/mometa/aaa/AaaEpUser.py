...
class AaaEpUser(ManagedObject):
    ...
    prop_meta = {
        ...
        "ecode": MoPropertyMeta("ecode", "ecode", "string", VersionMeta.Version601a, MoPropertyMeta.READ_WRITE, 0x10, 0, 8, None, [], []),
        "enc_key": MoPropertyMeta("enc_key", "encKey", "string", VersionMeta.Version601a, MoPropertyMeta.READ_WRITE, 0x20, 0, 256, None, [], []),
