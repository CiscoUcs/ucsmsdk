...
class AaaAuthRealm(ManagedObject):
    ...
    mo_meta = MoMeta("AaaAuthRealm", "aaaAuthRealm", "auth-realm", VersionMeta.Version101e, "InputOutput", 0x3ffL, [], ["aaa", "admin"], [u'topSystem'], [u'aaaAuthRealmFsm', u'aaaConsoleAuth', u'aaaDefaultAuth', u'aaaDomain', u'aaaRealmFsm', u'aaaRealmFsmTask', u'eventInst', u'faultInst'], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "con_login": MoPropertyMeta("con_login", "conLogin", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x2L, None, None, None, ["ldap", "local", "none", "radius", "tacacs"], []), 
        "def_login": MoPropertyMeta("def_login", "defLogin", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x4L, None, None, None, ["ldap", "local", "none", "radius", "tacacs"], []), 
        "def_role_policy": MoPropertyMeta("def_role_policy", "defRolePolicy", "string", VersionMeta.Version111j, MoPropertyMeta.READ_WRITE, 0x8L, None, None, None, ["assign-default-role", "no-login"], []), 
