...
class AaaAuthRealmConsts():
    ...
    CON_LOGIN_NONE = "none"
    CON_LOGIN_RADIUS = "radius"
    CON_LOGIN_TACACS = "tacacs"
    DEF_LOGIN_LDAP = "ldap"
    DEF_LOGIN_LOCAL = "local"
    DEF_LOGIN_NONE = "none"
    DEF_LOGIN_RADIUS = "radius"
    DEF_LOGIN_TACACS = "tacacs"
    DEF_ROLE_POLICY_ASSIGN_DEFAULT_ROLE = "assign-default-role"
    DEF_ROLE_POLICY_NO_LOGIN = "no-login"
    FSM_PREV_NOP = "nop"
    FSM_PREV_UPDATE_REALM_BEGIN = "updateRealmBegin"
    FSM_PREV_UPDATE_REALM_FAIL = "updateRealmFail"
    FSM_PREV_UPDATE_REALM_SET_REALM_LOCAL = "updateRealmSetRealmLocal"
    FSM_PREV_UPDATE_REALM_SET_REALM_PEER = "updateRealmSetRealmPeer"
    FSM_PREV_UPDATE_REALM_SUCCESS = "updateRealmSuccess"
    ...
    FSM_STATUS_NOP = "nop"
    FSM_STATUS_UPDATE_REALM_BEGIN = "updateRealmBegin"
    FSM_STATUS_UPDATE_REALM_FAIL = "updateRealmFail"
    FSM_STATUS_UPDATE_REALM_SET_REALM_LOCAL = "updateRealmSetRealmLocal"
    FSM_STATUS_UPDATE_REALM_SET_REALM_PEER = "updateRealmSetRealmPeer"
    FSM_STATUS_UPDATE_REALM_SUCCESS = "updateRealmSuccess"
    INT_ID_NONE = "none"
...
class AaaAuthRealm(ManagedObject):
    """This is AaaAuthRealm class."""

    consts = AaaAuthRealmConsts()
    naming_props = set([])

    mo_meta = MoMeta("AaaAuthRealm", "aaaAuthRealm", "auth-realm", VersionMeta.Version101e, "InputOutput", 0x7ffL, [], ["aaa", "admin"], [u'topSystem'], [u'aaaAuthRealmFsm', u'aaaConsoleAuth', u'aaaDefaultAuth', u'aaaDomain', u'aaaRealmFsm', u'aaaRealmFsmTask', u'eventInst', u'faultInst'], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "con_login": MoPropertyMeta("con_login", "conLogin", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x4L, None, None, None, ["ldap", "local", "none", "radius", "tacacs"], []), 
        "def_login": MoPropertyMeta("def_login", "defLogin", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x8L, None, None, None, ["ldap", "local", "none", "radius", "tacacs"], []), 
        "def_role_policy": MoPropertyMeta("def_role_policy", "defRolePolicy", "string", VersionMeta.Version111j, MoPropertyMeta.READ_WRITE, 0x10L, None, None, None, ["assign-default-role", "no-login"], []), 
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version101e, MoPropertyMeta.INTERNAL, None, None, None, None, ["nop", "updateRealmBegin", "updateRealmFail", "updateRealmSetRealmLocal", "updateRealmSetRealmPeer", "updateRealmSuccess"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version101e, MoPropertyMeta.INTERNAL, None, None, None, None, ["nop", "updateRealmBegin", "updateRealmFail", "updateRealmSetRealmLocal", "updateRealmSetRealmPeer", "updateRealmSuccess"], []), 
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version101e, MoPropertyMeta.CREATE_ONLY, 0x80L, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
