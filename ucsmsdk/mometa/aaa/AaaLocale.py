"""This module contains the general information for AaaLocale ManagedObject."""
import sys, os
...
class AaaLocale(ManagedObject):
    ...
    mo_meta = MoMeta("AaaLocale", "aaaLocale", "locale-[name]", VersionMeta.Version101e, "InputOutput", 0xffL, [], ["aaa", "admin"], [u'aaaUserEp'], [u'aaaOrg', u'faultInst'], ["Add", "Get", "Remove", "Set"])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "AaaLocale", parent_mo_or_dn, **kwargs)
