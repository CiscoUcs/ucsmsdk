...
class AaaUserEpConsts():
    ...
    FSM_PREV_UPDATE_USER_EP_SET_USER_LOCAL = "updateUserEpSetUserLocal"
    FSM_PREV_UPDATE_USER_EP_SET_USER_PEER = "updateUserEpSetUserPeer"
    FSM_PREV_UPDATE_USER_EP_SUCCESS = "updateUserEpSuccess"
    ...
    FSM_STATUS_NOP = "nop"
    FSM_STATUS_UPDATE_USER_EP_BEGIN = "updateUserEpBegin"
    FSM_STATUS_UPDATE_USER_EP_FAIL = "updateUserEpFail"
    FSM_STATUS_UPDATE_USER_EP_SET_USER_LOCAL = "updateUserEpSetUserLocal"
...
class AaaUserEp(ManagedObject):
    ...
    mo_meta = MoMeta("AaaUserEp", "aaaUserEp", "user-ext", VersionMeta.Version101e, "InputOutput", 0x1ffL, [], ["aaa", "admin"], [u'topSystem'], [u'aaaEpLogin', u'aaaExtMgmtCutThruTkn', u'aaaLocale', u'aaaPreLoginBanner', u'aaaPwdProfile', u'aaaRemoteUser', u'aaaRole', u'aaaShellLogin', u'aaaUser', u'aaaUserEpFsm', u'aaaUserEpFsmTask', u'aaaWebLogin', u'eventInst', u'faultInst'], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version101e, MoPropertyMeta.INTERNAL, None, None, None, None, ["nop", "updateUserEpBegin", "updateUserEpFail", "updateUserEpSetUserLocal", "updateUserEpSetUserPeer", "updateUserEpSuccess"], []), 
        ...
        "pwd_strength_check": MoPropertyMeta("pwd_strength_check", "pwdStrengthCheck", "string", VersionMeta.Version131c, MoPropertyMeta.READ_WRITE, 0x40L, None, None, None, ["false", "no", "true", "yes"], []), 
