"""This module contains the general information for AaaRadiusEpFsm ManagedObject."""
import sys, os
...
class AaaRadiusEpFsm(ManagedObject):
    """This is AaaRadiusEpFsm class."""

    consts = AaaRadiusEpFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("AaaRadiusEpFsm", "aaaRadiusEpFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'aaaRadiusEp'], [u'aaaRadiusEpFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "AaaRadiusEpFsm", parent_mo_or_dn, **kwargs)
