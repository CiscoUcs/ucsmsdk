...
class AaaSessionInfoTable(ManagedObject):
    ...
    mo_meta = MoMeta("AaaSessionInfoTable", "aaaSessionInfoTable", "session-table", VersionMeta.Version212a, "InputOutput", 0xfL, [], ["aaa", "admin"], [u'topSystem'], [u'aaaSessionInfo'], [None])
