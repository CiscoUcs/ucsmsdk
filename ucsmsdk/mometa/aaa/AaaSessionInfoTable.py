...
class AaaSessionInfoTable(ManagedObject):
    ...
    mo_meta = MoMeta("AaaSessionInfoTable", "aaaSessionInfoTable", "session-table", VersionMeta.Version212a, "InputOutput", 0x1f, [], ["aaa", "admin"], [u'topSystem'], [u'aaaSessionInfo'], [None])
