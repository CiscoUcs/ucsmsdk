...
class AaaSessionInfoTable(ManagedObject):
    """This is AaaSessionInfoTable class."""

    consts = AaaSessionInfoTableConsts()
    naming_props = set([])

    mo_meta = MoMeta("AaaSessionInfoTable", "aaaSessionInfoTable", "session-table", VersionMeta.Version212a, "InputOutput", 0x1fL, [], ["aaa", "admin"], [u'topSystem'], [u'aaaSessionInfo'], [None])
