...
class AaaOrg(ManagedObject):
    ...
    mo_meta = MoMeta("AaaOrg", "aaaOrg", "org-[name]", VersionMeta.Version101e, "InputOutput", 0x7fL, [], ["aaa", "admin"], [u'aaaLocale'], [u'faultInst'], ["Add", "Get", "Remove"])
    ...
    prop_meta = {
        ...
        "org_dn": MoPropertyMeta("org_dn", "orgDn", "string", VersionMeta.Version101e, MoPropertyMeta.CREATE_ONLY, 0x10L, 0, 256, None, [], []), 
