...
class AaaOrg(ManagedObject):
    ...
    mo_meta = MoMeta("AaaOrg", "aaaOrg", "org-[name]", VersionMeta.Version101e, "InputOutput", 0xffL, [], ["aaa", "admin"], [u'aaaLocale'], [u'faultInst'], ["Add", "Get", "Remove"])
    ...
    prop_meta = {
        ...
        "config_state": MoPropertyMeta("config_state", "configState", "string", VersionMeta.Version212a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["not-applied", "ok"], []), 
        "config_status_message": MoPropertyMeta("config_status_message", "configStatusMessage", "string", VersionMeta.Version212a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        ...
        "org_dn": MoPropertyMeta("org_dn", "orgDn", "string", VersionMeta.Version101e, MoPropertyMeta.CREATE_ONLY, 0x20L, 0, 256, None, [], []), 
