...
class AaaRole(ManagedObject):
    ...
    mo_meta = MoMeta("AaaRole", "aaaRole", "role-[name]", VersionMeta.Version101e, "InputOutput", 0xffL, [], ["aaa", "admin"], [u'aaaUserEp'], [u'faultInst'], ["Add", "Get", "Remove", "Set"])
