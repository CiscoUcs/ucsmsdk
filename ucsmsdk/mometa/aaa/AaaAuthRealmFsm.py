...
class AaaAuthRealmFsm(ManagedObject):
    """This is AaaAuthRealmFsm class."""

    consts = AaaAuthRealmFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("AaaAuthRealmFsm", "aaaAuthRealmFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'aaaAuthRealm'], [u'aaaAuthRealmFsmStage'], [None])
