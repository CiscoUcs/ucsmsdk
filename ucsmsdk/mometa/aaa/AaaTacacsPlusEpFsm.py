"""This module contains the general information for AaaTacacsPlusEpFsm ManagedObject."""
import sys, os
...
class AaaTacacsPlusEpFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_NOP = "nop"
...
class AaaTacacsPlusEpFsm(ManagedObject):
    """This is AaaTacacsPlusEpFsm class."""

    consts = AaaTacacsPlusEpFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("AaaTacacsPlusEpFsm", "aaaTacacsPlusEpFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'aaaTacacsPlusEp'], [u'aaaTacacsPlusEpFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "AaaTacacsPlusEpFsm", parent_mo_or_dn, **kwargs)
