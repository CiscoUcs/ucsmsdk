...
class AaaEpAuthProfile(ManagedObject):
    ...
    mo_meta = MoMeta("AaaEpAuthProfile", "aaaEpAuthProfile", "auth-profile-[name]", VersionMeta.Version101e, "InputOutput", 0xffL, [], ["aaa", "admin", "ls-security", "ls-security-policy"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit', u'orgOrg'], [u'aaaEpUser'], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "ipmi_over_lan": MoPropertyMeta("ipmi_over_lan", "ipmiOverLan", "string", VersionMeta.Version222c, MoPropertyMeta.READ_WRITE, 0x8L, None, None, None, ["disable", "enable"], []), 
