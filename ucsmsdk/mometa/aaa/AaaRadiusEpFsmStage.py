"""This module contains the general information for AaaRadiusEpFsmStage ManagedObject."""
import sys, os
...
class AaaRadiusEpFsmStage(ManagedObject):
    """This is AaaRadiusEpFsmStage class."""

    consts = AaaRadiusEpFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("AaaRadiusEpFsmStage", "aaaRadiusEpFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'aaaRadiusEpFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["nop", "updateEpBegin", "updateEpFail", "updateEpSetEpLocal", "updateEpSetEpPeer", "updateEpSuccess"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "AaaRadiusEpFsmStage", parent_mo_or_dn, **kwargs)
