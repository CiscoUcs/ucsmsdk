"""This module contains the general information for AaaRadiusEp ManagedObject."""
import sys, os
...
class AaaRadiusEp(ManagedObject):
    """This is AaaRadiusEp class."""

    consts = AaaRadiusEpConsts()
    naming_props = set([])

    mo_meta = MoMeta("AaaRadiusEp", "aaaRadiusEp", "radius-ext", VersionMeta.Version101e, "InputOutput", 0x3ffL, [], ["aaa", "admin"], [u'topSystem'], [u'aaaEpFsm', u'aaaEpFsmTask', u'aaaProviderGroup', u'aaaRadiusEpFsm', u'aaaRadiusProvider', u'eventInst', u'faultInst'], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "retries": MoPropertyMeta("retries", "retries", "uint", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x40L, None, None, None, [], ["0-5"]), 
        ...
        "timeout": MoPropertyMeta("timeout", "timeout", "uint", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x200L, None, None, None, [], ["1-60"]), 
    }
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "AaaRadiusEp", parent_mo_or_dn, **kwargs)
