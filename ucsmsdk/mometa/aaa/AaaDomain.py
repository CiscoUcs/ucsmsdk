...
class AaaDomain(ManagedObject):
    ...
    mo_meta = MoMeta("AaaDomain", "aaaDomain", "domain-[name]", VersionMeta.Version141i, "InputOutput", 0xffL, [], ["aaa", "admin"], [u'aaaAuthRealm'], [u'aaaDomainAuth', u'faultInst'], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141i, MoPropertyMeta.NAMING, 0x8L, None, None, """[a-zA-Z0-9_.-]{1,16}""", [], []), 
        "refresh_period": MoPropertyMeta("refresh_period", "refreshPeriod", "uint", VersionMeta.Version203a, MoPropertyMeta.READ_WRITE, 0x10L, None, None, None, [], ["60-172800"]), 
        ...
        "session_timeout": MoPropertyMeta("session_timeout", "sessionTimeout", "uint", VersionMeta.Version203a, MoPropertyMeta.READ_WRITE, 0x40L, None, None, None, [], ["300-172800", "60-172800"]), 
