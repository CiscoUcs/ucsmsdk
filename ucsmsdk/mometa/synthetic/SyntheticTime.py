...
class SyntheticTime(ManagedObject):
    ...
    mo_meta = MoMeta("SyntheticTime", "syntheticTime", "time-[ts]", VersionMeta.Version101e, "InputOutput", 0x3fL, [], ["admin"], [], [], ["Get"])
    ...
    prop_meta = {
        ...
        "ts": MoPropertyMeta("ts", "ts", "ulong", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x20L, None, None, None, [], []), 
    }
