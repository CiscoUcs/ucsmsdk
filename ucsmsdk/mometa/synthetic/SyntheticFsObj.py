...
class SyntheticFsObj(ManagedObject):
    ...
    mo_meta = MoMeta("SyntheticFsObj", "syntheticFsObj", "file-[name]", VersionMeta.Version101e, "InputOutput", 0x7f, [], ["admin"], [u'topSystem'], [u'eventInst', u'faultInst', u'syntheticFsObjFsm', u'syntheticFsObjFsmTask'], ["Get"])
    ...
    prop_meta = {
        ...
        "path": MoPropertyMeta("path", "path", "string", VersionMeta.Version101e, MoPropertyMeta.READ_WRITE, 0x10, 0, 510, None, [], []), 
