...
class SyntheticFsObj(ManagedObject):
    ...
    mo_meta = MoMeta("SyntheticFsObj", "syntheticFsObj", "file-[name]", VersionMeta.Version101e, "InputOutput", 0x7f, [], ["admin"], ['topSystem'], ['eventInst', 'faultInst', 'syntheticFsObjFsm', 'syntheticFsObjFsmTask'], ["Get"])
