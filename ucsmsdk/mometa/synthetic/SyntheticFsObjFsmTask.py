"""This module contains the general information for SyntheticFsObjFsmTask ManagedObject."""
import sys, os
...
class SyntheticFsObjFsmTaskConsts():
...
class SyntheticFsObjFsmTask(ManagedObject):
    """This is SyntheticFsObjFsmTask class."""

    consts = SyntheticFsObjFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("SyntheticFsObjFsmTask", "syntheticFsObjFsmTask", "task-[item]", VersionMeta.Version111j, "OutputOnly", 0xfL, [], [""], [u'syntheticFsObj'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version111j, MoPropertyMeta.NAMING, None, None, None, None, ["create", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "SyntheticFsObjFsmTask", parent_mo_or_dn, **kwargs)
