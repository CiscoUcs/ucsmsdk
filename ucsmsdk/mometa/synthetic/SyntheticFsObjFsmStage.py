"""This module contains the general information for SyntheticFsObjFsmStage ManagedObject."""
import sys, os
...
class SyntheticFsObjFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_CREATE_BEGIN = "createBegin"
    NAME_CREATE_CREATE_LOCAL = "createCreateLocal"
    NAME_CREATE_CREATE_REMOTE = "createCreateRemote"
    NAME_CREATE_FAIL = "createFail"
    NAME_CREATE_SUCCESS = "createSuccess"
    NAME_NOP = "nop"
...
class SyntheticFsObjFsmStage(ManagedObject):
    """This is SyntheticFsObjFsmStage class."""

    consts = SyntheticFsObjFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("SyntheticFsObjFsmStage", "syntheticFsObjFsmStage", "stage-[name]", VersionMeta.Version211a, "OutputOnly", 0xfL, [], [""], [u'syntheticFsObjFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version211a, MoPropertyMeta.NAMING, None, None, None, None, ["createBegin", "createCreateLocal", "createCreateRemote", "createFail", "createSuccess", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "SyntheticFsObjFsmStage", parent_mo_or_dn, **kwargs)
