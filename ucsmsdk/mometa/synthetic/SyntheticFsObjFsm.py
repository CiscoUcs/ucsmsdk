"""This module contains the general information for SyntheticFsObjFsm ManagedObject."""
import sys, os
...
class SyntheticFsObjFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_CREATE = "create"
    CURRENT_FSM_NOP = "nop"
...
class SyntheticFsObjFsm(ManagedObject):
    """This is SyntheticFsObjFsm class."""

    consts = SyntheticFsObjFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("SyntheticFsObjFsm", "syntheticFsObjFsm", "fsm", VersionMeta.Version211a, "OutputOnly", 0x7L, [], [""], [u'syntheticFsObj'], [u'syntheticFsObjFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version211a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["create", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "SyntheticFsObjFsm", parent_mo_or_dn, **kwargs)
