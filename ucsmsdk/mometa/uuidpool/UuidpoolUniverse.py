"""This module contains the general information for UuidpoolUniverse ManagedObject."""
import sys, os
...
class UuidpoolUniverseConsts():
    pass


class UuidpoolUniverse(ManagedObject):
    """This is UuidpoolUniverse class."""

    consts = UuidpoolUniverseConsts()
    naming_props = set([])

    mo_meta = MoMeta("UuidpoolUniverse", "uuidpoolUniverse", "uuid", VersionMeta.Version101e, "InputOutput", 0x1fL, [], ["read-only"], [u'topRoot'], [u'uuidpoolAddr', u'uuidpoolFormat'], ["Get"])
    ...
    def __init__(self, **kwargs):
        ...
        ManagedObject.__init__(self, "UuidpoolUniverse", **kwargs)
