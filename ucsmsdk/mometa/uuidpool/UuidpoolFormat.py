...
class UuidpoolFormat(ManagedObject):
    ...
    mo_meta = MoMeta("UuidpoolFormat", "uuidpoolFormat", "format-[format]-[mask]", VersionMeta.Version101e, "InputOutput", 0x3fL, [], ["admin", "ls-storage", "ls-storage-policy"], [u'uuidpoolUniverse'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "format": MoPropertyMeta("format", "format", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x4L, None, None, """(([0-9a-fA-F]){4}\-([0-9a-fA-F]){12})|0""", [], []), 
