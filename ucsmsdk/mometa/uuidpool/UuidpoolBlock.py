"""This module contains the general information for UuidpoolBlock ManagedObject."""
import sys, os
...
class UuidpoolBlockConsts():
    pass


class UuidpoolBlock(ManagedObject):
    """This is UuidpoolBlock class."""

    consts = UuidpoolBlockConsts()
    naming_props = set([u'from', u'to'])

    mo_meta = MoMeta("UuidpoolBlock", "uuidpoolBlock", "block-from-[r_from]-to-[to]", VersionMeta.Version101e, "InputOutput", 0x7fL, [], ["admin", "pn-policy"], [u'uuidpoolPool'], [], ["Add", "Get", "Remove"])
    ...
    prop_meta = {
        ...
        "r_from": MoPropertyMeta("r_from", "from", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x8L, None, None, r"""(([0-9a-fA-F]){4}\-([0-9a-fA-F]){12})|0""", [], []), 
        ...
        "to": MoPropertyMeta("to", "to", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x40L, None, None, r"""(([0-9a-fA-F]){4}\-([0-9a-fA-F]){12})|0""", [], []), 
    }
    ...
    def __init__(self, parent_mo_or_dn, r_from, to, **kwargs):
        ...
        ManagedObject.__init__(self, "UuidpoolBlock", parent_mo_or_dn, **kwargs)
