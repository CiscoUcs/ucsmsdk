...
class UuidpoolBlock(ManagedObject):
    ...
    mo_meta = MoMeta("UuidpoolBlock", "uuidpoolBlock", "block-from-[r_from]-to-[to]", VersionMeta.Version101e, "InputOutput", 0x3fL, [], ["admin", "pn-policy"], [u'uuidpoolPool'], [], ["Add", "Get", "Remove"])
    ...
    prop_meta = {
        ...
        "r_from": MoPropertyMeta("r_from", "from", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x4L, None, None, """(([0-9a-fA-F]){4}\-([0-9a-fA-F]){12})|0""", [], []), 
        ...
        "to": MoPropertyMeta("to", "to", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x20L, None, None, """(([0-9a-fA-F]){4}\-([0-9a-fA-F]){12})|0""", [], []), 
    }
