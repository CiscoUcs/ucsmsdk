...
class UuidpoolPooled(ManagedObject):
    ...
    mo_meta = MoMeta("UuidpoolPooled", "uuidpoolPooled", "[id]", VersionMeta.Version101e, "InputOutput", 0x1fL, [], ["read-only"], [u'uuidpoolPool'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "id": MoPropertyMeta("id", "id", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x4L, None, None, """(([0-9a-fA-F]){4}\-([0-9a-fA-F]){12})|0""", [], []), 
