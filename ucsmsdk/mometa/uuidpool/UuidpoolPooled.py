"""This module contains the general information for UuidpoolPooled ManagedObject."""
import sys, os
...
class UuidpoolPooled(ManagedObject):
    """This is UuidpoolPooled class."""

    consts = UuidpoolPooledConsts()
    naming_props = set([u'id'])

    mo_meta = MoMeta("UuidpoolPooled", "uuidpoolPooled", "[id]", VersionMeta.Version101e, "InputOutput", 0x3fL, [], ["read-only"], [u'uuidpoolPool'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "id": MoPropertyMeta("id", "id", "string", VersionMeta.Version101e, MoPropertyMeta.NAMING, 0x8L, None, None, r"""(([0-9a-fA-F]){4}\-([0-9a-fA-F]){12})|0""", [], []), 
    ...
    def __init__(self, parent_mo_or_dn, id, **kwargs):
        ...
        ManagedObject.__init__(self, "UuidpoolPooled", parent_mo_or_dn, **kwargs)
