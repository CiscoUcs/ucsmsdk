"""This module contains the general information for ImgsecPolicy ManagedObject."""
import sys, os
...
class ImgsecPolicy(ManagedObject):
    """This is ImgsecPolicy class."""

    consts = ImgsecPolicyConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("ImgsecPolicy", "imgsecPolicy", "img-sec-policy-[name]", VersionMeta.Version141i, "InputOutput", 0xffL, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server"], [u'orgOrg'], [u'imgsecKey'], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "ImgsecPolicy", parent_mo_or_dn, **kwargs)
