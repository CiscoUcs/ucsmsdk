...
class PciSwitch(ManagedObject):
    ...
    mo_meta = MoMeta("PciSwitch", "pciSwitch", "pci-switch-[id]", VersionMeta.Version402a, "InputOutput", 0x3f, [], ["read-only"], ['computeBoard'], ['faultInst', 'firmwareBootDefinition', 'firmwareRunning', 'pciLink'], [None])
