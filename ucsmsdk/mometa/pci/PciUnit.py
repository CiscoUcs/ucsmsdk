"""This module contains the general information for PciUnit ManagedObject."""
import sys, os
...
class PciUnit(ManagedObject):
    """This is PciUnit class."""

    consts = PciUnitConsts()
    naming_props = set([u'id'])

    mo_meta = MoMeta("PciUnit", "pciUnit", "unit-[id]", VersionMeta.Version141i, "InputOutput", 0x3fL, [], ["read-only"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit'], [], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, id, **kwargs):
        ...
        ManagedObject.__init__(self, "PciUnit", parent_mo_or_dn, **kwargs)
