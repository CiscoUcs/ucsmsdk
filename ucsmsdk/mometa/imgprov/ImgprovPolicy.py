"""This module contains the general information for ImgprovPolicy ManagedObject."""
import sys, os
...
class ImgprovPolicy(ManagedObject):
    """This is ImgprovPolicy class."""

    consts = ImgprovPolicyConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("ImgprovPolicy", "imgprovPolicy", "img-prov-policy-[name]", VersionMeta.Version141i, "InputOutput", 0xffL, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server"], [u'orgOrg'], [u'imgprovTarget'], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "ImgprovPolicy", parent_mo_or_dn, **kwargs)
