...
class ImgprovPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("ImgprovPolicy", "imgprovPolicy", "img-prov-policy-[name]", VersionMeta.Version141i, "InputOutput", 0x7fL, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server"], [u'orgOrg'], [u'imgprovTarget'], ["Get"])
