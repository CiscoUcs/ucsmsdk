...
MO_CLASS_META = {
    ...
    "BiosVfCPUPowerManagement": MoMeta("BiosVfCPUPowerManagement", "biosVfCPUPowerManagement", "CPU-Power-Management", VersionMeta.Version302c, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get"]),
    ...
    "BiosVfEnhancedPowerCappingSupport": MoMeta("BiosVfEnhancedPowerCappingSupport", "biosVfEnhancedPowerCappingSupport", "Enhanced-PowerCapping-Support", VersionMeta.Version302c, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"]),
    ...
    "ComputeGraphicsCardPolicy": MoMeta("ComputeGraphicsCardPolicy", "computeGraphicsCardPolicy", "graphics-card-policy-[name]", None, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-equipment", "pn-maintenance", "pn-policy"], [u'orgOrg'], [], [None]),
    ...
    "ComputeHwChangeDiscPolicy": MoMeta("ComputeHwChangeDiscPolicy", "computeHwChangeDiscPolicy", "hw-change-disc-policy", None, "InputOutput", 0x1, [], ["admin", "pn-policy"], [u'orgOrg'], [], [None]),
    ...
    "ComputePhysicalExtension": MoMeta("ComputePhysicalExtension", "computePhysicalExtension", "phys-extension", None, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit'], [u'faultInst'], [None]),
    ...
    "ComputePortDiscPolicy": MoMeta("ComputePortDiscPolicy", "computePortDiscPolicy", "port-discovery", None, "InputOutput", 0x1, [], ["admin", "pn-policy"], [u'orgOrg'], [], [None]),
    ...
    "ComputeRebootLog": MoMeta("ComputeRebootLog", "computeRebootLog", "reboot-log-[id]", None, "InputOutput", 0x1, [], ["read-only"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit'], [], [None]),
    ...
    "ControllerMgmtDbCheckPol": MoMeta("ControllerMgmtDbCheckPol", "controllerMgmtDbCheckPol", "MgmtDbCheckPol", None, "InputOutput", 0x1, [], ["admin"], [u'topSystem'], [], [None]),
    ...
    "DiagLogEp": MoMeta("DiagLogEp", "diagLogEp", "logep-[switch_id]", None, "InputOutput", 0x1, [], [""], [u'diagRslt'], [], [None]),
    "DiagMemoryTest": MoMeta("DiagMemoryTest", "diagMemoryTest", "test-[order]", None, "InputOutput", 0x1, [], ["admin", "pn-policy"], [u'diagRunPolicy'], [], [None]),
    ...
    "DomainChassisFeature": MoMeta("DomainChassisFeature", "domainChassisFeature", "chassis-feature-[name]", None, "InputOutput", 0x1, [], ["admin"], [u'domainChassisFeatureCont', u'domainEnvironmentFeatureCont', u'domainNetworkFeatureCont', u'domainServerFeatureCont', u'domainStorageFeatureCont'], [u'domainChassisParam', u'domainEnvironmentParam', u'domainNetworkParam', u'domainServerParam', u'domainStorageParam'], [None]),
    "DomainChassisFeatureCont": MoMeta("DomainChassisFeatureCont", "domainChassisFeatureCont", "chassis-feature-cont", None, "InputOutput", 0x1, [], ["admin"], [u'topSystem'], [u'domainChassisFeature', u'domainEnvironmentFeature', u'domainNetworkFeature', u'domainServerFeature', u'domainStorageFeature'], [None]),
    "DomainChassisParam": MoMeta("DomainChassisParam", "domainChassisParam", "chassis-param-[name]", None, "InputOutput", 0x1, [], ["admin"], [u'domainChassisFeature', u'domainEnvironmentFeature', u'domainNetworkFeature', u'domainServerFeature', u'domainStorageFeature'], [], [None]),
    ...
    "EquipmentBiosTokenOverride": MoMeta("EquipmentBiosTokenOverride", "equipmentBiosTokenOverride", "bios-token-override-[bios_token_id]", None, "InputOutput", 0x1, [], ["read-only"], [u'equipmentRackUnitCapProvider'], [], [None]),
    ...
    "EquipmentComputeConn": MoMeta("EquipmentComputeConn", "equipmentComputeConn", "compute-conn", None, "InputOutput", 0x1, [], ["read-only"], [u'equipmentChassis'], [u'faultInst'], [None]),
    "EquipmentComputeConnPolicy": MoMeta("EquipmentComputeConnPolicy", "equipmentComputeConnPolicy", "compute-conn-policy-[name]", None, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'orgOrg'], [], [None]),
    ...
    "EquipmentDriveSecCap": MoMeta("EquipmentDriveSecCap", "equipmentDriveSecCap", "drive-sec-cap", None, "InputOutput", 0x1, [], ["read-only"], [u'equipmentBladeCapProvider', u'equipmentLocalDiskCapProvider', u'equipmentLocalDiskControllerCapProvider', u'equipmentRackUnitCapProvider'], [], [None]),
    ...
    "EquipmentHostMgmtControllerCap": MoMeta("EquipmentHostMgmtControllerCap", "equipmentHostMgmtControllerCap", "host-mgmt-controller-cap", None, "InputOutput", 0x1, [], ["read-only"], [u'equipmentBladeCapProvider', u'equipmentRackUnitCapProvider'], [], [None]),
    ...
    "EquipmentHxCap": MoMeta("EquipmentHxCap", "equipmentHxCap", "hx-cap", None, "InputOutput", 0x1, [], ["read-only"], [u'equipmentRackUnitCapProvider'], [], [None]),
    ...
    "EquipmentInventoryStatus": MoMeta("EquipmentInventoryStatus", "equipmentInventoryStatus", "inv-status", None, "InputOutput", 0x1, [], ["read-only"], [u'adaptorUnit', u'adaptorUnitExtn', u'computeBlade', u'computeRackUnit', u'computeServerUnit', u'graphicsCard', u'memoryUnit', u'processorUnit', u'securityUnit', u'storageController'], [u'faultInst'], [None]),
    ...
    "EquipmentServerUnitCapProvider": MoMeta("EquipmentServerUnitCapProvider", "equipmentServerUnitCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version251a, "InputOutput", 0x1, [], [""], [u'capabilityCatalogue', u'equipmentHwCapDerivativeProvider'], [u'computePciCap', u'equipmentBiosDef', u'equipmentBladeAGLibrary', u'equipmentBladeConnDef', u'equipmentBoardControllerDef', u'equipmentDimmMapping', u'equipmentFruVariant', u'equipmentHDDFaultMonDef', u'equipmentManufacturingDef', u'equipmentPhysicalDef', u'equipmentPicture', u'equipmentServerFeatureCap', u'equipmentServiceDef', u'equipmentSlotArray', u'equipmentSlotArrayRef', u'equipmentStorageControllerConfig', u'firmwareConstraints', u'firmwareType', u'firmwareUpgradeConstraint'], ["Get"]),
    ...
    "EquipmentSwitchCapProvider": MoMeta("EquipmentSwitchCapProvider", "equipmentSwitchCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version101e, "InputOutput", 0x1, [], [""], [u'capabilityCatalogue', u'equipmentHwCapDerivativeProvider'], [u'equipmentBeaconCapProvider', u'equipmentBreakoutCap', u'equipmentFruVariant', u'equipmentManufacturingDef', u'equipmentNonCopperPassiveCap', u'equipmentPfcMmuCap', u'equipmentPhysicalDef', u'equipmentPicture', u'equipmentPortGroupAggregationDef', u'equipmentPortGroupSwComplexDef', u'equipmentServiceDef', u'equipmentSlotArray', u'equipmentSlotArrayRef', u'equipmentStorageControllerConfig', u'equipmentSwitchCap', u'equipmentUnifiedPortCapProvider', u'firmwareConstraints', u'firmwareType', u'firmwareUpgradeConstraint'], ["Get"]),
    ...
    "FabricNetGroupRef": MoMeta("FabricNetGroupRef", "fabricNetGroupRef", "net-group-ref-[name]", None, "InputOutput", 0x1, [], ["admin", "ls-config", "ls-network", "ls-server"], [u'dcxVc', u'swCmclan', u'vnicEther', u'vnicLanConnTempl', u'vnicProfile', u'vnicSanConnTempl'], [u'faultInst'], [None]),
    ...
    "FabricSanGroup": MoMeta("FabricSanGroup", "fabricSanGroup", "san-group-[name]", None, "InputOutput", 0x1, [], ["read-only"], [], [], [None]),
    "FabricSanGroupRef": MoMeta("FabricSanGroupRef", "fabricSanGroupRef", "san-group-ref-[name]", None, "InputOutput", 0x1, [], ["admin", "ls-config", "ls-network", "ls-server"], [u'dcxVc', u'vnicFc', u'vnicLanConnTempl', u'vnicSanConnTempl'], [u'faultInst'], [None]),
    ...
    "FabricVlanGroupPermit": MoMeta("FabricVlanGroupPermit", "fabricVlanGroupPermit", "vgperm-[cloud]sw-[switch_id]net-[name]", None, "InputOutput", 0x1, [], [""], [u'orgOrg'], [], [None]),
    ...
    "FirmwareChassisPack": MoMeta("FirmwareChassisPack", "firmwareChassisPack", "fw-chassis-pack-[name]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'orgOrg'], [u'firmwareExcludeChassisComponent', u'firmwarePackItem'], ["Add", "Get", "Remove", "Set"]),
    ...
    "FirmwareDriveSecurityConstraint": MoMeta("FirmwareDriveSecurityConstraint", "firmwareDriveSecurityConstraint", "drive-security-constraint", None, "InputOutput", 0x1, [], ["read-only"], [u'firmwareConstraints'], [], [None]),
    "FirmwareDualVicChassisConstraint": MoMeta("FirmwareDualVicChassisConstraint", "firmwareDualVicChassisConstraint", "dual-vic-chassis-constraint", None, "InputOutput", 0x1, [], ["read-only"], [u'firmwareConstraints'], [], [None]),
    "FirmwareDualVicServerConstraint": MoMeta("FirmwareDualVicServerConstraint", "firmwareDualVicServerConstraint", "dual-vic-server-constraint", None, "InputOutput", 0x1, [], ["read-only"], [u'firmwareConstraints'], [], [None]),
    ...
    "FirmwareModule": MoMeta("FirmwareModule", "firmwareModule", "module-[name]|[type]", None, "InputOutput", 0x1, [], ["admin"], [u'firmwareImage'], [], [None]),
    ...
    "FirmwareSecondControllerChassisConstraint": MoMeta("FirmwareSecondControllerChassisConstraint", "firmwareSecondControllerChassisConstraint", "second-controller-chassis-constraint", None, "InputOutput", 0x1, [], ["read-only"], [u'firmwareConstraints'], [], [None]),
    "FirmwareSecondControllerServerConstraint": MoMeta("FirmwareSecondControllerServerConstraint", "firmwareSecondControllerServerConstraint", "second-controller-server-constraint", None, "InputOutput", 0x1, [], ["read-only"], [u'firmwareConstraints'], [], [None]),
    ...
    "FirmwareServicePack": MoMeta("FirmwareServicePack", "firmwareServicePack", "servicepack", None, "InputOutput", 0x1, [], ["admin"], [u'firmwareBootUnit', u'firmwareRunning'], [], [None]),
    ...
    "LsbootEmbeddedLocalLunImage": MoMeta("LsbootEmbeddedLocalLunImage", "lsbootEmbeddedLocalLunImage", "embedded-local-lun", VersionMeta.Version227b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"], [u'lsbootLocalStorage'], [], ["Add", "Get", "Remove", "Set"]),
    ...
    "LsbootLocalDiskImage": MoMeta("LsbootLocalDiskImage", "lsbootLocalDiskImage", "local-jbod", VersionMeta.Version224b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"], [u'lsbootLocalStorage'], [u'lsbootLocalDiskImagePath'], ["Add", "Get", "Remove", "Set"]),
    "LsbootLocalDiskImagePath": MoMeta("LsbootLocalDiskImagePath", "lsbootLocalDiskImagePath", "diskimgpath-[type]", VersionMeta.Version224b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"], [u'lsbootLocalDiskImage'], [], ["Add", "Get", "Remove", "Set"]),
    ...
    "LstorageDriveSecurity": MoMeta("LstorageDriveSecurity", "lstorageDriveSecurity", "drive", None, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'lstorageSecurity'], [u'lstorageLocal', u'lstorageRemote'], [None]),
    "LstorageLocal": MoMeta("LstorageLocal", "lstorageLocal", "local", None, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'computeBoard', u'lstorageDriveSecurity'], [], [None]),
    "LstorageLocalDef": MoMeta("LstorageLocalDef", "lstorageLocalDef", "local-def", None, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'computeBoard'], [], [None]),
    ...
    "LstorageLogin": MoMeta("LstorageLogin", "lstorageLogin", "login", None, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'lstorageRemote', u'lstorageRemoteDef'], [], [None]),
    ...
    "LstorageRemote": MoMeta("LstorageRemote", "lstorageRemote", "remote", None, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'computeBoard', u'lstorageDriveSecurity'], [u'lstorageLogin'], [None]),
    "LstorageRemoteDef": MoMeta("LstorageRemoteDef", "lstorageRemoteDef", "remote-def", None, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'computeBoard'], [u'lstorageLogin'], [None]),
    "LstorageSecurity": MoMeta("LstorageSecurity", "lstorageSecurity", "security", None, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'lstorageProfile', u'lstorageProfileDef', u'storageLocalDiskConfigDef', u'storageLocalDiskConfigPolicy'], [u'lstorageDriveSecurity'], [None]),
    ...
    "MgmtDbState": MoMeta("MgmtDbState", "mgmtDbState", "mgmt-db-state", None, "InputOutput", 0x1, [], ["read-only"], [u'networkElement'], [u'faultInst'], [None]),
    ...
    "MgmtKmip": MoMeta("MgmtKmip", "mgmtKmip", "kmip", None, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'mgmtSecurity'], [], [None]),
    "MgmtKmipCertPolicy": MoMeta("MgmtKmipCertPolicy", "mgmtKmipCertPolicy", "kmip-cert", None, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-oper", "ls-server-policy", "read-only"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit', u'pkiEp'], [], [None]),
    ...
    "MgmtSecurity": MoMeta("MgmtSecurity", "mgmtSecurity", "sec", None, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit'], [u'mgmtKmip'], [None]),
    ...
    "MoInvKv": MoMeta("MoInvKv", "moInvKv", "kv-[key]", None, "InputOutput", 0x1, [], ["admin", "read-only"], [u'moKvInvHolder'], [], [None]),
    "MoIpV4AddrKv": MoMeta("MoIpV4AddrKv", "moIpV4AddrKv", "kv-[key]", None, "InputOutput", 0x1, [], ["admin", "read-only"], [u'moKvCfgHolder'], [u'faultInst'], [None]),
    "MoIpV6AddrKv": MoMeta("MoIpV6AddrKv", "moIpV6AddrKv", "kv-[key]", None, "InputOutput", 0x1, [], ["admin", "read-only"], [u'moKvCfgHolder'], [u'faultInst'], [None]),
    "MoKv": MoMeta("MoKv", "moKv", "kv-[key]", None, "InputOutput", 0x1, [], ["admin", "read-only"], [u'moKvCfgHolder'], [], [None]),
    "MoKvCfgHolder": MoMeta("MoKvCfgHolder", "moKvCfgHolder", "cfg-kv", None, "InputOutput", 0x1, [], ["admin"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit', u'lsServer', u'orgOrg'], [u'moIpV4AddrKv', u'moIpV6AddrKv', u'moKv', u'moVnicKv'], [None]),
    "MoKvInvHolder": MoMeta("MoKvInvHolder", "moKvInvHolder", "inv-kv-[endpoint]", None, "InputOutput", 0x1, [], ["read-only"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit'], [u'moInvKv'], [None]),
    "MoVnicKv": MoMeta("MoVnicKv", "moVnicKv", "kv-[key]", None, "InputOutput", 0x1, [], ["admin", "read-only"], [u'moKvCfgHolder'], [], [None]),
    ...
    "NetworkLimit": MoMeta("NetworkLimit", "networkLimit", "limit-type-[type]-asic-[asic_number]", None, "InputOutput", 0x1, [], ["admin"], [u'networkElement'], [u'faultInst'], [None]),
    ...
    "PolicyChildClass": MoMeta("PolicyChildClass", "policyChildClass", "child-[name]", None, "InputOutput", 0x1, [], ["read-only"], [u'policyDestClass'], [], [None]),
    ...
    "PolicyConfigError": MoMeta("PolicyConfigError", "policyConfigError", "policy-error", None, "InputOutput", 0x1, [], ["read-only"], [u'policyPolicyScopeCont'], [], [None]),
    "PolicyContext": MoMeta("PolicyContext", "policyContext", "context-[name]", None, "InputOutput", 0x1, [], ["read-only"], [u'policySourceApp'], [u'policyScope'], [None]),
    ...
    "PolicyDestClass": MoMeta("PolicyDestClass", "policyDestClass", "dest-[name]", None, "InputOutput", 0x1, [], ["read-only"], [u'policyDestEp', u'policyPolicyDestClass'], [u'policyChildClass'], [None]),
    "PolicyDestEp": MoMeta("PolicyDestEp", "policyDestEp", "dest-ep", None, "InputOutput", 0x1, [], ["read-only"], [u'policyControlEp'], [u'policyDestClass'], [None]),
    ...
    "PolicyPolicyDestClass": MoMeta("PolicyPolicyDestClass", "policyPolicyDestClass", "destclass", None, "InputOutput", 0x1, [], ["read-only"], [u'policyScope'], [u'policyDestClass'], [None]),
    ...
    "PolicyPolicyScopeContFsm": MoMeta("PolicyPolicyScopeContFsm", "policyPolicyScopeContFsm", "fsm", None, "OutputOnly", 0x1, [], [""], [u'policyPolicyScopeCont'], [u'policyPolicyScopeContFsmStage'], [None]),
    "PolicyPolicyScopeContFsmStage": MoMeta("PolicyPolicyScopeContFsmStage", "policyPolicyScopeContFsmStage", "stage-[name]", None, "OutputOnly", 0x1, [], [""], [u'policyPolicyScopeContFsm'], [], [None]),
    "PolicyPolicyScopeContFsmTask": MoMeta("PolicyPolicyScopeContFsmTask", "policyPolicyScopeContFsmTask", "task-[item]", None, "OutputOnly", 0x1, [], [""], [u'policyPolicyScopeCont'], [], [None]),
    ...
    "PolicyRequestor": MoMeta("PolicyRequestor", "policyRequestor", "requestor-[name]", None, "InputOutput", 0x1, [], ["read-only"], [u'policyScope'], [u'eventInst', u'faultInst', u'policyRequestorFsm', u'policyRequestorFsmTask'], [None]),
    "PolicyRequestorFsm": MoMeta("PolicyRequestorFsm", "policyRequestorFsm", "fsm", None, "OutputOnly", 0x1, [], [""], [u'policyRequestor'], [u'policyRequestorFsmStage'], [None]),
    "PolicyRequestorFsmStage": MoMeta("PolicyRequestorFsmStage", "policyRequestorFsmStage", "stage-[name]", None, "OutputOnly", 0x1, [], [""], [u'policyRequestorFsm'], [], [None]),
    "PolicyRequestorFsmTask": MoMeta("PolicyRequestorFsmTask", "policyRequestorFsmTask", "task-[item]", None, "OutputOnly", 0x1, [], [""], [u'policyRequestor'], [], [None]),
    "PolicyScope": MoMeta("PolicyScope", "policyScope", "scope-[policy_type]-[resolve_type]-[policy_name]", None, "InputOutput", 0x1, [], ["read-only"], [u'policyContext'], [u'policyPolicyDestClass', u'policyRequestor'], [None]),
    ...
    "PolicySourceApp": MoMeta("PolicySourceApp", "policySourceApp", "source-[source_dme]", None, "InputOutput", 0x1, [], ["read-only"], [u'policyControlEp'], [u'policyContext'], [None]),
    ...
    "StorageNvmeStorage": MoMeta("StorageNvmeStorage", "storageNvmeStorage", "nvme-storage", None, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-storage"], [u'storageController'], [], [None]),
    ...
    "StorageSsdHealthStats": MoMeta("StorageSsdHealthStats", "storageSsdHealthStats", "ssd-health-stats-[id]", None, "OutputOnly", 0x1, [], ["admin", "operations", "read-only"], [u'storageLocalDisk'], [u'storageSsdHealthStatsHist'], [None]),
    "StorageSsdHealthStatsHist": MoMeta("StorageSsdHealthStatsHist", "storageSsdHealthStatsHist", "[id]", None, "OutputOnly", 0x1, [], ["read-only"], [u'storageSsdHealthStats'], [], [None]),
    ...
    "SwEtherPort": MoMeta("SwEtherPort", "swEtherPort", "slot-[slot_id]-aggrport-[aggr_port_id]-port-[port_id]", None, "InputOutput", 0x1, [], ["admin"], [u'swPortDiscover'], [], [None]),
    ...
    "SwPortDiscover": MoMeta("SwPortDiscover", "swPortDiscover", "discover", None, "InputOutput", 0x1, [], ["read-only"], [u'networkElement'], [u'eventInst', u'faultInst', u'swEtherPort', u'swPortDiscoverFsm', u'swPortDiscoverFsmTask'], [None]),
    "SwPortDiscoverFsm": MoMeta("SwPortDiscoverFsm", "swPortDiscoverFsm", "fsm", None, "OutputOnly", 0x1, [], [""], [u'swPortDiscover'], [u'swPortDiscoverFsmStage'], [None]),
    "SwPortDiscoverFsmStage": MoMeta("SwPortDiscoverFsmStage", "swPortDiscoverFsmStage", "stage-[name]", None, "OutputOnly", 0x1, [], [""], [u'swPortDiscoverFsm'], [], [None]),
    "SwPortDiscoverFsmTask": MoMeta("SwPortDiscoverFsmTask", "swPortDiscoverFsmTask", "task-[item]", None, "OutputOnly", 0x1, [], [""], [u'swPortDiscover'], [], [None]),
    ...
    "SysdebugDiagnosticLog": MoMeta("SysdebugDiagnosticLog", "sysdebugDiagnosticLog", "diag-log-[name]-[switch_id]", None, "InputOutput", 0x1, [], ["admin", "operations"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit', u'sysdebugDiagnosticLogRepository'], [], [None]),
    "SysdebugDiagnosticLogRepository": MoMeta("SysdebugDiagnosticLogRepository", "sysdebugDiagnosticLogRepository", "diag-log-files", None, "InputOutput", 0x1, [], ["admin", "operations"], [u'topSystem'], [u'sysdebugDiagnosticLog'], [None]),
