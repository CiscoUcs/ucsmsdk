...
MO_CLASS_META = {
    ...
    "AaaLoginProfile": MoMeta("AaaLoginProfile", "aaaLoginProfile", "login-profile", VersionMeta.Version401a, "InputOutput", 0x1, [], ["aaa", "admin"], [u'aaaUserEp'], [], [None]),
    ...
    "AaaUserEp": MoMeta("AaaUserEp", "aaaUserEp", "user-ext", VersionMeta.Version101e, "InputOutput", 0x1, [], ["aaa", "admin"], [u'topSystem'], [u'aaaEpLogin', u'aaaExtMgmtCutThruTkn', u'aaaLocale', u'aaaLoginProfile', u'aaaPreLoginBanner', u'aaaPwdProfile', u'aaaRemoteUser', u'aaaRole', u'aaaShellLogin', u'aaaUser', u'aaaUserEpFsm', u'aaaUserEpFsmTask', u'aaaWebLogin', u'eventInst', u'faultInst'], ["Get", "Set"]),
    ...
    "AdaptorDynamicConfigCap": MoMeta("AdaptorDynamicConfigCap", "adaptorDynamicConfigCap", "cap-dynamic-config", VersionMeta.Version302c, "InputOutput", 0x1, [], ["admin", "pn-policy", "read-only"], [u'adaptorFruCapProvider'], [], [None]),
    "AdaptorEthAdvFilterProfile": MoMeta("AdaptorEthAdvFilterProfile", "adaptorEthAdvFilterProfile", "eth-adv-filter", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "ls-config-policy", "ls-network", "ls-server-policy"], [u'adaptorHostEthIf', u'adaptorHostEthIfProfile'], [], ["Add", "Get", "Remove", "Set"]),
    ...
    "AdaptorEthCompQueueProfile": MoMeta("AdaptorEthCompQueueProfile", "adaptorEthCompQueueProfile", "eth-comp-q", VersionMeta.Version101e, "InputOutput", 0x1, [], ["admin", "ls-config-policy", "ls-network", "ls-server-policy"], [u'adaptorHostEthIf', u'adaptorHostEthIfProfile', u'adaptorUsnicConnDef', u'adaptorVmmqConnDef'], [], ["Get", "Set"]),
    ...
    "AdaptorEthInterruptProfile": MoMeta("AdaptorEthInterruptProfile", "adaptorEthInterruptProfile", "eth-int", VersionMeta.Version101e, "InputOutput", 0x1, [], ["admin", "ls-config-policy", "ls-network", "ls-server-policy"], [u'adaptorHostEthIf', u'adaptorHostEthIfProfile', u'adaptorUsnicConnDef', u'adaptorVmmqConnDef'], [], ["Get", "Set"]),
    "AdaptorEthInterruptScalingProfile": MoMeta("AdaptorEthInterruptScalingProfile", "adaptorEthInterruptScalingProfile", "eth-interrupt-scaling", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "ls-config-policy", "ls-network", "ls-server-policy"], [u'adaptorHostEthIf', u'adaptorHostEthIfProfile', u'adaptorUsnicConnDef'], [], ["Add", "Get", "Remove", "Set"]),
    ...
    "AdaptorEthRecvQueueProfile": MoMeta("AdaptorEthRecvQueueProfile", "adaptorEthRecvQueueProfile", "eth-rcv-q", VersionMeta.Version101e, "InputOutput", 0x1, [], ["admin", "ls-config-policy", "ls-network", "ls-server-policy"], [u'adaptorHostEthIf', u'adaptorHostEthIfProfile', u'adaptorUsnicConnDef', u'adaptorVmmqConnDef'], [], ["Get", "Set"]),
    "AdaptorEthRoCEProfile": MoMeta("AdaptorEthRoCEProfile", "adaptorEthRoCEProfile", "eth-roce", VersionMeta.Version223a, "InputOutput", 0x1, [], ["admin", "ls-config-policy", "ls-network", "ls-server-policy"], [u'adaptorHostEthIf', u'adaptorHostEthIfProfile', u'adaptorVmmqConnDef'], [], ["Get", "Set"]),
    ...
    "AdaptorEthWorkQueueProfile": MoMeta("AdaptorEthWorkQueueProfile", "adaptorEthWorkQueueProfile", "eth-work-q", VersionMeta.Version101e, "InputOutput", 0x1, [], ["admin", "ls-config-policy", "ls-network", "ls-server-policy"], [u'adaptorHostEthIf', u'adaptorHostEthIfProfile', u'adaptorUsnicConnDef', u'adaptorVmmqConnDef'], [], ["Get", "Set"]),
    ...
    "AdaptorExtEthIfPc": MoMeta("AdaptorExtEthIfPc", "adaptorExtEthIfPc", "pc-[port_id]", VersionMeta.Version201m, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy", "pn-equipment", "pn-maintenance"], [u'adaptorUnit', u'fabricLocale'], [u'adaptorExtEthIfPcEp', u'dcxVIf'], ["Get"]),
    ...
    "AdaptorFcFnicProfile": MoMeta("AdaptorFcFnicProfile", "adaptorFcFnicProfile", "fc-fnic", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "ls-config-policy", "ls-server-policy", "ls-storage"], [u'adaptorHostFcIf', u'adaptorHostFcIfProfile'], [], ["Add", "Get", "Remove", "Set"]),
    ...
    "AdaptorFcVhbaTypeProfile": MoMeta("AdaptorFcVhbaTypeProfile", "adaptorFcVhbaTypeProfile", "fc-vhbatype", VersionMeta.Version402a, "InputOutput", 0x1, [], ["admin", "ls-config-policy", "ls-server-policy", "ls-storage"], [u'adaptorHostFcIf', u'adaptorHostFcIfProfile'], [], [None]),
    ...
    "AdaptorHostIfConfig": MoMeta("AdaptorHostIfConfig", "adaptorHostIfConfig", "host-if-config-[id]", VersionMeta.Version227b, "InputOutput", 0x1, [], ["read-only"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit'], [], ["Get"]),
    ...
    "AdaptorHostVnicHwAddrCap": MoMeta("AdaptorHostVnicHwAddrCap", "adaptorHostVnicHwAddrCap", "hwaddr-hostvnic", VersionMeta.Version302c, "InputOutput", 0x1, [], ["read-only"], [u'adaptorFruCapProvider'], [], [None]),
    ...
    "AdaptorMgmtVnicEthConfig": MoMeta("AdaptorMgmtVnicEthConfig", "adaptorMgmtVnicEthConfig", "mgmt-vnic", VersionMeta.Version224b, "InputOutput", 0x1, [], ["read-only"], [u'adaptorFruCapProvider'], [], [None]),
    ...
    "AdaptorNwStatsMgmtCap": MoMeta("AdaptorNwStatsMgmtCap", "adaptorNwStatsMgmtCap", "nw-stats-mgmt", VersionMeta.Version302c, "InputOutput", 0x1, [], ["read-only"], [u'adaptorFruCapProvider'], [], [None]),
    ...
    "AdaptorRnicCapSpec": MoMeta("AdaptorRnicCapSpec", "adaptorRnicCapSpec", "cap-[type]", VersionMeta.Version224b, "InputOutput", 0x1, [], ["admin", "pn-policy"], [u'adaptorFruCapProvider'], [], ["Get"]),
    "AdaptorRssProfile": MoMeta("AdaptorRssProfile", "adaptorRssProfile", "rss", VersionMeta.Version101e, "InputOutput", 0x1, [], ["admin", "ls-config-policy", "ls-network", "ls-server-policy"], [u'adaptorHostEthIf', u'adaptorHostEthIfProfile', u'adaptorUsnicConnDef', u'adaptorVmmqConnDef'], [], ["Get", "Set"]),
    ...
    "AdaptorUnitExtn": MoMeta("AdaptorUnitExtn", "adaptorUnitExtn", "adaptor-extn-[id]", VersionMeta.Version202m, "InputOutput", 0x1, [], ["read-only"], [u'adaptorUnit'], [u'equipmentInventoryStatus', u'faultInst'], ["Get"]),
    ...
    "ApeAttribute": MoMeta("ApeAttribute", "apeAttribute", "attribute-[id]", VersionMeta.Version224b, "InputOutput", 0x1, [], ["read-only"], [u'apeMcTable'], [], [None]),
    ...
    "BiosRef": MoMeta("BiosRef", "biosRef", "bios-ref", VersionMeta.Version131c, "InputOutput", 0x1, [], [""], [u'equipmentBladeBiosCapProvider'], [u'biosFeatureRef', u'biosTokenParam'], ["Get"]),
    ...
    "BiosVProfile": MoMeta("BiosVProfile", "biosVProfile", "bios-prof-[name]", VersionMeta.Version111j, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'orgOrg'], [u'biosTokenFeatureGroup', u'biosVfACPI10Support', u'biosVfASPMSupport', u'biosVfAllUSBDevices', u'biosVfAltitude', u'biosVfAssertNMIOnPERR', u'biosVfAssertNMIOnSERR', u'biosVfBMEDMAMitigation', u'biosVfBootOptionRetry', u'biosVfCPUHardwarePowerManagement', u'biosVfCPUPerformance', u'biosVfConsistentDeviceNameControl', u'biosVfConsoleRedirection', u'biosVfCoreMultiProcessing', u'biosVfDDR3VoltageSelection', u'biosVfDRAMClockThrottling', u'biosVfDirectCacheAccess', u'biosVfDramRefreshRate', u'biosVfEnergyPerformanceTuning', u'biosVfEnhancedIntelSpeedStepTech', u'biosVfEnhancedPowerCappingSupport', u'biosVfExecuteDisableBit', u'biosVfFRB2Timer', u'biosVfFrequencyFloorOverride', u'biosVfFrontPanelLockout', u'biosVfIOEMezz1OptionROM', u'biosVfIOENVMe1OptionROM', u'biosVfIOENVMe2OptionROM', u'biosVfIOESlot1OptionROM', u'biosVfIOESlot2OptionROM', u'biosVfIntegratedGraphics', u'biosVfIntegratedGraphicsApertureSize', u'biosVfIntelEntrySASRAIDModule', u'biosVfIntelHyperThreadingTech', u'biosVfIntelTrustedExecutionTechnology', u'biosVfIntelTurboBoostTech', u'biosVfIntelVTForDirectedIO', u'biosVfIntelVirtualizationTechnology', u'biosVfInterleaveConfiguration', u'biosVfLocalX2Apic', u'biosVfLvDIMMSupport', u'biosVfMaxVariableMTRRSetting', u'biosVfMaximumMemoryBelow4GB', u'biosVfMemoryMappedIOAbove4GB', u'biosVfMirroringMode', u'biosVfNUMAOptimized', u'biosVfOSBootWatchdogTimer', u'biosVfOSBootWatchdogTimerPolicy', u'biosVfOSBootWatchdogTimerTimeout', u'biosVfOnboardGraphics', u'biosVfOnboardSATAController', u'biosVfOnboardStorage', u'biosVfOptionROMEnable', u'biosVfOptionROMLoad', u'biosVfOutOfBandManagement', u'biosVfPCHSATAMode', u'biosVfPCILOMPortsConfiguration', u'biosVfPCIROMCLP', u'biosVfPCISlotLinkSpeed', u'biosVfPCISlotOptionROMEnable', u'biosVfPOSTErrorPause', u'biosVfPSTATECoordination', u'biosVfPackageCStateLimit', u'biosVfProcessorC1E', u'biosVfProcessorC3Report', u'biosVfProcessorC6Report', u'biosVfProcessorC7Report', u'biosVfProcessorCMCI', u'biosVfProcessorCState', u'biosVfProcessorEnergyConfiguration', u'biosVfProcessorPrefetchConfig', u'biosVfQPILinkFrequencySelect', u'biosVfQPISnoopMode', u'biosVfQuietBoot', u'biosVfRedirectionAfterBIOSPOST', u'biosVfResumeOnACPowerLoss', u'biosVfSBMezz1OptionROM', u'biosVfSBNVMe1OptionROM', u'biosVfSIOC1OptionROM', u'biosVfSIOC2OptionROM', u'biosVfScrubPolicies', u'biosVfSelectMemoryRASConfiguration', u'biosVfSerialPortAEnable', u'biosVfSparingMode', u'biosVfSriovConfig', u'biosVfTPMPendingOperation', u'biosVfTPMSupport', u'biosVfTrustedPlatformModule', u'biosVfUCSMBootModeControl', u'biosVfUCSMBootOrderRuleControl', u'biosVfUEFIOSUseLegacyVideo', u'biosVfUSBBootConfig', u'biosVfUSBConfiguration', u'biosVfUSBFrontPanelAccessLock', u'biosVfUSBPortConfiguration', u'biosVfUSBSystemIdlePowerOptimizingSetting', u'biosVfVGAPriority', u'biosVfWorkloadConfiguration'], ["Add", "Get", "Remove", "Set"]),
    ...
    "BiosVfBMEDMAMitigation": MoMeta("BiosVfBMEDMAMitigation", "biosVfBMEDMAMitigation", "BME-DMA-Mitigation", VersionMeta.Version401a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], [None]),
    ...
    "BiosVfCPUHardwarePowerManagement": MoMeta("BiosVfCPUHardwarePowerManagement", "biosVfCPUHardwarePowerManagement", "CPU-Hardware-Power-Management", VersionMeta.Version311e, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"]),
    ...
    "BiosVfConsistentDeviceNameControl": MoMeta("BiosVfConsistentDeviceNameControl", "biosVfConsistentDeviceNameControl", "Consistent-Device-Name-Control", VersionMeta.Version224b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"]),
    ...
    "BiosVfEnergyPerformanceTuning": MoMeta("BiosVfEnergyPerformanceTuning", "biosVfEnergyPerformanceTuning", "Energy-Performance-Tuning", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"]),
    ...
    "BiosVfEnhancedPowerCappingSupport": MoMeta("BiosVfEnhancedPowerCappingSupport", "biosVfEnhancedPowerCappingSupport", "Enhanced-PowerCapping-Support", VersionMeta.Version302c, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get"]),
    ...
    "BiosVfIOEMezz1OptionROM": MoMeta("BiosVfIOEMezz1OptionROM", "biosVfIOEMezz1OptionROM", "IOEMezz1-OptionROM", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"]),
    "BiosVfIOENVMe1OptionROM": MoMeta("BiosVfIOENVMe1OptionROM", "biosVfIOENVMe1OptionROM", "IOENVMe1-OptionROM", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"]),
    "BiosVfIOENVMe2OptionROM": MoMeta("BiosVfIOENVMe2OptionROM", "biosVfIOENVMe2OptionROM", "IOENVMe2-OptionROM", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"]),
    "BiosVfIOESlot1OptionROM": MoMeta("BiosVfIOESlot1OptionROM", "biosVfIOESlot1OptionROM", "IOESlot1-OptionROM", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"]),
    "BiosVfIOESlot2OptionROM": MoMeta("BiosVfIOESlot2OptionROM", "biosVfIOESlot2OptionROM", "IOESlot2-OptionROM", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"]),
    "BiosVfIntegratedGraphics": MoMeta("BiosVfIntegratedGraphics", "biosVfIntegratedGraphics", "Integrated-Graphics", VersionMeta.Version311e, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"]),
    "BiosVfIntegratedGraphicsApertureSize": MoMeta("BiosVfIntegratedGraphicsApertureSize", "biosVfIntegratedGraphicsApertureSize", "Integrated-Graphics-Aperture-Size", VersionMeta.Version311e, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"]),
    ...
    "BiosVfIntelTrustedExecutionTechnology": MoMeta("BiosVfIntelTrustedExecutionTechnology", "biosVfIntelTrustedExecutionTechnology", "Intel-Trusted-Execution-Technology", VersionMeta.Version224b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"]),
    ...
    "BiosVfOnboardGraphics": MoMeta("BiosVfOnboardGraphics", "biosVfOnboardGraphics", "Onboard-Graphics", VersionMeta.Version311e, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"]),
    ...
    "BiosVfOutOfBandManagement": MoMeta("BiosVfOutOfBandManagement", "biosVfOutOfBandManagement", "Out-of-Band-Management", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"]),
    "BiosVfPCHSATAMode": MoMeta("BiosVfPCHSATAMode", "biosVfPCHSATAMode", "PCH-SATA-Mode", VersionMeta.Version224b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get"]),
    "BiosVfPCILOMPortsConfiguration": MoMeta("BiosVfPCILOMPortsConfiguration", "biosVfPCILOMPortsConfiguration", "PCI-LOM-Ports-Configuration", VersionMeta.Version224b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"]),
    "BiosVfPCIROMCLP": MoMeta("BiosVfPCIROMCLP", "biosVfPCIROMCLP", "PCI-ROM-CLP", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"]),
    ...
    "BiosVfPCISlotOptionROMEnable": MoMeta("BiosVfPCISlotOptionROMEnable", "biosVfPCISlotOptionROMEnable", "PCI-Slot-OptionROM-Enable", VersionMeta.Version202m, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"]),
    ...
    "BiosVfProcessorCMCI": MoMeta("BiosVfProcessorCMCI", "biosVfProcessorCMCI", "Processor-CMCI", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"]),
    ...
    "BiosVfQPISnoopMode": MoMeta("BiosVfQPISnoopMode", "biosVfQPISnoopMode", "QPI-Snoop-Mode", VersionMeta.Version224b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"]),
    ...
    "BiosVfRedirectionAfterBIOSPOST": MoMeta("BiosVfRedirectionAfterBIOSPOST", "biosVfRedirectionAfterBIOSPOST", "Redirection-After-BIOS-POST", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"]),
    ...
    "BiosVfSBMezz1OptionROM": MoMeta("BiosVfSBMezz1OptionROM", "biosVfSBMezz1OptionROM", "SBMezz1-OptionROM", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"]),
    "BiosVfSBNVMe1OptionROM": MoMeta("BiosVfSBNVMe1OptionROM", "biosVfSBNVMe1OptionROM", "SBNVMe1-OptionROM", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"]),
    "BiosVfSIOC1OptionROM": MoMeta("BiosVfSIOC1OptionROM", "biosVfSIOC1OptionROM", "SIOC1-OptionROM", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"]),
    "BiosVfSIOC2OptionROM": MoMeta("BiosVfSIOC2OptionROM", "biosVfSIOC2OptionROM", "SIOC2-OptionROM", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"]),
    ...
    "BiosVfTPMPendingOperation": MoMeta("BiosVfTPMPendingOperation", "biosVfTPMPendingOperation", "TPM-Pending-Operation", VersionMeta.Version224b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get"]),
    "BiosVfTPMSupport": MoMeta("BiosVfTPMSupport", "biosVfTPMSupport", "TPM-Support", VersionMeta.Version223a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get"]),
    "BiosVfTrustedPlatformModule": MoMeta("BiosVfTrustedPlatformModule", "biosVfTrustedPlatformModule", "Trusted-Platform-Module", VersionMeta.Version224b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"]),
    ...
    "BiosVfWorkloadConfiguration": MoMeta("BiosVfWorkloadConfiguration", "biosVfWorkloadConfiguration", "Workload-Configuration", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'biosSettings', u'biosVProfile'], [], ["Get", "Set"]),
    ...
    "CallhomeAnonymousReporting": MoMeta("CallhomeAnonymousReporting", "callhomeAnonymousReporting", "anonymousreporting", VersionMeta.Version223a, "InputOutput", 0x1, [], ["admin"], [u'callhomeEp'], [], ["Get", "Set"]),
    ...
    "CloudDeviceConnectorEp": MoMeta("CloudDeviceConnectorEp", "cloudDeviceConnectorEp", "device-connector", VersionMeta.Version402a, "InputOutput", 0x1, [], ["aaa", "admin"], [u'cloudMgmtSvc'], [u'faultInst'], [None]),
    "CloudMgmtSvc": MoMeta("CloudMgmtSvc", "cloudMgmtSvc", "cloud-mgmt", VersionMeta.Version402a, "InputOutput", 0x1, [], ["aaa", "admin"], [u'topSystem'], [u'cloudDeviceConnectorEp'], [None]),
    "CommCimcWebService": MoMeta("CommCimcWebService", "commCimcWebService", "cimc-web-svc", VersionMeta.Version221b, "InputOutput", 0x1, [], ["aaa", "admin"], [u'commSvcEp'], [], ["Get", "Set"]),
    ...
    "CommLocale": MoMeta("CommLocale", "commLocale", "locale-[name]", VersionMeta.Version302c, "InputOutput", 0x1, [], ["read-only"], [], [u'commDateTime', u'commDns', u'commSyslog'], [None]),
    ...
    "CommSsh": MoMeta("CommSsh", "commSsh", "ssh-svc", VersionMeta.Version101e, "InputOutput", 0x1, [], ["aaa", "admin"], [u'commSvcEp'], [], ["Get", "Set"]),
    ...
    "CommSvcPolicy": MoMeta("CommSvcPolicy", "commSvcPolicy", "comm-pol-[name]", VersionMeta.Version302c, "InputOutput", 0x1, [], ["read-only"], [u'orgOrg'], [u'commDateTime', u'commDns', u'commSyslog'], [None]),
    ...
    "ComputeAdminAck": MoMeta("ComputeAdminAck", "computeAdminAck", "admin-ack", VersionMeta.Version404a, "InputOutput", 0x1, [], ["admin"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit'], [u'faultInst', u'trigLocalSched'], [None]),
    "ComputeAutoconfigPolicy": MoMeta("ComputeAutoconfigPolicy", "computeAutoconfigPolicy", "autoconfig-[name]", VersionMeta.Version101e, "InputOutput", 0x1, [], ["admin", "pn-policy"], [u'orgOrg'], [u'faultInst'], ["Add", "Get", "Remove", "Set"]),
    "ComputeBlade": MoMeta("ComputeBlade", "computeBlade", "blade-[slot_id]", VersionMeta.Version101e, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'equipmentChassis'], [u'aaaEpAuthProfile', u'aaaEpUser', u'adaptorHostIfConfig', u'adaptorUnit', u'biosUnit', u'biosVIdentityParams', u'cimcvmediaMountConfigDef', u'computeAdminAck', u'computeBladeFsm', u'computeBladeFsmTask', u'computeBoard', u'computeBoardConnector', u'computeBoardController', u'computeExtBoard', u'computeFactoryResetOperation', u'computeFwSyncAck', u'computeHostUtilityOs', u'computeKvmMgmtPolicy', u'computeMemoryConfiguration', u'computePhysicalExtension', u'computePhysicalFsm', u'computePhysicalFsmTask', u'computePnuOSImage', u'computePoolable', u'computeRebootLog', u'computeScrubPolicy', u'diagSrvCtrl', u'equipmentBeaconLed', u'equipmentHealthLed', u'equipmentIOExpander', u'equipmentIndicatorLed', u'equipmentInventoryStatus', u'equipmentLocatorLed', u'equipmentPOST', u'eventInst', u'fabricLocale', u'faultInst', u'faultSuppressTask', u'firmwareImageLock', u'firmwareStatus', u'lsIdentityInfo', u'lsbootDef', u'memoryRuntime', u'mgmtController', u'mgmtKmipCertPolicy', u'mgmtSecurity', u'moKvCfgHolder', u'moKvInvHolder', u'osAgent', u'osInstance', u'pciEquipSlot', u'pciUnit', u'powerBudget', u'processorRuntime', u'solIf', u'storageEnclosure', u'storageVirtualDriveContainer', u'swUlan', u'sysdebugDiagnosticLog'], ["Get", "Set"]),
    ...
    "ComputeBoardController": MoMeta("ComputeBoardController", "computeBoardController", "boardController", VersionMeta.Version131c, "InputOutput", 0x1, [], ["read-only"], [u'computeBlade', u'computeExtBoard', u'computeRackUnit', u'computeServerUnit', u'equipmentChassis', u'equipmentSystemIOController'], [u'mgmtController'], ["Get"]),
    ...
    "ComputeConstraintDef": MoMeta("ComputeConstraintDef", "computeConstraintDef", "cons-def-[name]", VersionMeta.Version302c, "InputOutput", 0x1, [], [""], [u'equipmentBladeCapProvider', u'equipmentRackUnitCapProvider'], [], [None]),
    ...
    "ComputeFactoryResetOperation": MoMeta("ComputeFactoryResetOperation", "computeFactoryResetOperation", "factory-reset", VersionMeta.Version227b, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit'], [], ["Add", "Get", "Remove", "Set"]),
    ...
    "ComputeGraphicsCardPolicy": MoMeta("ComputeGraphicsCardPolicy", "computeGraphicsCardPolicy", "graphics-card-policy-[name]", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-equipment", "pn-maintenance", "pn-policy"], [u'orgOrg'], [], ["Get", "Set"]),
    ...
    "ComputeHostUtilityOs": MoMeta("ComputeHostUtilityOs", "computeHostUtilityOs", "host-util-os-", VersionMeta.Version323a, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit'], [u'mgmtUsbNicMgmtIf'], ["Get"]),
    "ComputeHwChangeDiscPolicy": MoMeta("ComputeHwChangeDiscPolicy", "computeHwChangeDiscPolicy", "hw-change-disc-policy", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin", "pn-policy"], [u'orgOrg'], [], ["Get", "Set"]),
    ...
    "ComputePhysicalExtension": MoMeta("ComputePhysicalExtension", "computePhysicalExtension", "phys-extension", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit'], [u'faultInst'], [None]),
    ...
    "ComputePortDiscPolicy": MoMeta("ComputePortDiscPolicy", "computePortDiscPolicy", "port-discovery", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin", "pn-policy"], [u'orgOrg'], [], ["Get", "Set"]),
    "ComputePowerSyncDef": MoMeta("ComputePowerSyncDef", "computePowerSyncDef", "power-sync-def", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config-policy", "ls-server", "ls-server-policy"], [u'lsServer'], [], ["Get", "Set"]),
    "ComputePowerSyncPolicy": MoMeta("ComputePowerSyncPolicy", "computePowerSyncPolicy", "power-sync-[name]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config-policy", "ls-server", "ls-server-policy"], [u'orgOrg'], [], ["Add", "Get", "Remove", "Set"]),
    ...
    "ComputeRackConnLinkPolicy": MoMeta("ComputeRackConnLinkPolicy", "computeRackConnLinkPolicy", "rack-conn-link-policy-rack-unit-[rack_id]-fabric-[switch_id]", VersionMeta.Version323a, "InputOutput", 0x1, [], ["admin", "pn-policy"], [u'orgOrg'], [], [None]),
    ...
    "ComputeRackUnit": MoMeta("ComputeRackUnit", "computeRackUnit", "rack-unit-[id]", VersionMeta.Version141i, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'topSystem'], [u'aaaEpAuthProfile', u'aaaEpUser', u'adaptorHostIfConfig', u'adaptorUnit', u'biosUnit', u'biosVIdentityParams', u'cimcvmediaMountConfigDef', u'computeAdminAck', u'computeBoard', u'computeBoardController', u'computeExtBoard', u'computeFactoryResetOperation', u'computeFwSyncAck', u'computeHostUtilityOs', u'computeKvmMgmtPolicy', u'computeMemoryConfiguration', u'computePhysicalExtension', u'computePhysicalFsm', u'computePhysicalFsmTask', u'computePnuOSImage', u'computePoolable', u'computeRackUnitFsm', u'computeRackUnitFsmTask', u'computeRebootLog', u'computeScrubPolicy', u'diagSrvCtrl', u'equipmentBeaconLed', u'equipmentFanModule', u'equipmentHealthLed', u'equipmentIOExpander', u'equipmentIndicatorLed', u'equipmentInventoryStatus', u'equipmentLocatorLed', u'equipmentPOST', u'equipmentPsu', u'eventInst', u'fabricLocale', u'faultInst', u'faultSuppressTask', u'firmwareImageLock', u'firmwareStatus', u'lsIdentityInfo', u'lsbootDef', u'mgmtController', u'mgmtKmipCertPolicy', u'mgmtSecurity', u'moKvCfgHolder', u'moKvInvHolder', u'osAgent', u'osInstance', u'pciEquipSlot', u'pciUnit', u'powerBudget', u'solIf', u'storageEnclosure', u'storageVirtualDriveContainer', u'swUlan', u'sysdebugDiagnosticLog'], ["Get", "Set"]),
    ...
    "ComputeRebootLog": MoMeta("ComputeRebootLog", "computeRebootLog", "reboot-log-[id]", VersionMeta.Version321d, "InputOutput", 0x1, [], ["read-only"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit'], [], [None]),
    ...
    "ComputeServerTypeCap": MoMeta("ComputeServerTypeCap", "computeServerTypeCap", "server-type", VersionMeta.Version302c, "InputOutput", 0x1, [], ["read-only"], [u'equipmentBladeCapProvider', u'equipmentRackUnitCapProvider'], [], [None]),
    "ComputeServerUnit": MoMeta("ComputeServerUnit", "computeServerUnit", "server-[server_instance_id]", VersionMeta.Version251a, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'computeCartridge'], [u'aaaEpAuthProfile', u'aaaEpUser', u'adaptorHostIfConfig', u'adaptorUnit', u'biosUnit', u'biosVIdentityParams', u'cimcvmediaMountConfigDef', u'computeAdminAck', u'computeBoard', u'computeBoardController', u'computeExtBoard', u'computeFactoryResetOperation', u'computeFwSyncAck', u'computeHostUtilityOs', u'computeKvmMgmtPolicy', u'computeMemoryConfiguration', u'computePhysicalExtension', u'computePhysicalFsm', u'computePhysicalFsmTask', u'computePnuOSImage', u'computePoolable', u'computeRebootLog', u'computeScrubPolicy', u'computeServerUnitFsm', u'computeServerUnitFsmTask', u'diagSrvCtrl', u'equipmentBeaconLed', u'equipmentHealthLed', u'equipmentIOExpander', u'equipmentIndicatorLed', u'equipmentInventoryStatus', u'equipmentLocatorLed', u'equipmentPOST', u'eventInst', u'fabricLocale', u'faultInst', u'faultSuppressTask', u'firmwareImageLock', u'firmwareStatus', u'lsIdentityInfo', u'lsbootDef', u'mgmtController', u'mgmtKmipCertPolicy', u'mgmtSecurity', u'moKvCfgHolder', u'moKvInvHolder', u'osAgent', u'osInstance', u'pciEquipSlot', u'pciUnit', u'powerBudget', u'solIf', u'storageEnclosure', u'storageVirtualDriveContainer', u'swUlan', u'sysdebugDiagnosticLog'], ["Get", "Set"]),
    ...
    "ControllerHaController": MoMeta("ControllerHaController", "controllerHaController", "HaController", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin"], [u'topSystem'], [u'controllerOperationalVersionHolder', u'controllerPreferedVersionHolder'], ["Get", "Set"]),
    "ControllerMgmtDbCheckPol": MoMeta("ControllerMgmtDbCheckPol", "controllerMgmtDbCheckPol", "MgmtDbCheckPol", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin"], [u'topSystem'], [], ["Get", "Set"]),
    "ControllerOperationalVersionHolder": MoMeta("ControllerOperationalVersionHolder", "controllerOperationalVersionHolder", "OpVersHolder-[serial]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["read-only"], [u'controllerHaController'], [], ["Get"]),
    "ControllerPreferedVersionHolder": MoMeta("ControllerPreferedVersionHolder", "controllerPreferedVersionHolder", "PrefVersHolder-[serial]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin"], [u'controllerHaController'], [], ["Get"]),
    "CoprocessorCard": MoMeta("CoprocessorCard", "coprocessorCard", "coprocessor-card-[id]", VersionMeta.Version401a, "InputOutput", 0x1, [], ["read-only"], [u'computeBoard'], [], [None]),
    "CpmaintAck": MoMeta("CpmaintAck", "cpmaintAck", "ack", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'equipmentChassisProfile'], [u'faultInst', u'trigLocalSched'], ["Get", "Set"]),
    "CpmaintMaintPolicy": MoMeta("CpmaintMaintPolicy", "cpmaintMaintPolicy", "chassis-profile-maint-[name]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'orgOrg'], [], ["Add", "Get", "Remove", "Set"]),
    ...
    "DcxVIf": MoMeta("DcxVIf", "dcxVIf", "vif-[id]", VersionMeta.Version101e, "InputOutput", 0x1, [], ["read-only"], [u'adaptorExtEthIf', u'adaptorExtEthIfPc', u'adaptorFcOEIf', u'adaptorHostEthIf', u'adaptorHostFcIf', u'adaptorHostServiceEthIf'], [u'faultInst'], ["Get"]),
    "DcxVc": MoMeta("DcxVc", "dcxVc", "vc-[id]", VersionMeta.Version101e, "InputOutput", 0x1, [], ["read-only"], [u'fabricLocale', u'fabricPath', u'swEthLanFlowMon', u'swEthMon', u'swFcMon'], [u'fabricNetGroupRef', u'fabricSanGroupRef', u'faultInst', u'swCmclan', u'swNetflowMonitorRef', u'swUlan', u'swVlan', u'swVsan'], ["Get"]),
    ...
    "DiagLogEp": MoMeta("DiagLogEp", "diagLogEp", "logep-[switch_id]", VersionMeta.Version321d, "InputOutput", 0x1, [], [""], [u'diagRslt'], [], [None]),
    "DiagMemoryTest": MoMeta("DiagMemoryTest", "diagMemoryTest", "test-[order]", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin", "pn-policy"], [u'diagRunPolicy'], [], ["Get", "Set"]),
    "DiagRslt": MoMeta("DiagRslt", "diagRslt", "rslt-[id]", VersionMeta.Version111j, "InputOutput", 0x1, [], [""], [u'diagSrvCtrl'], [u'diagLogEp'], ["Get"]),
    "DiagRunPolicy": MoMeta("DiagRunPolicy", "diagRunPolicy", "diag-policy-[name]", VersionMeta.Version131c, "InputOutput", 0x1, [], ["admin", "pn-policy"], [u'diagSrvCtrl', u'orgOrg'], [u'diagMemoryTest'], ["Get"]),
    "DiagSrvCapProvider": MoMeta("DiagSrvCapProvider", "diagSrvCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version111j, "InputOutput", 0x1, [], [""], [u'capabilityCatalogue', u'equipmentHwCapDerivativeProvider'], [u'equipmentEmbeddedControllerConfig', u'equipmentFruVariant', u'equipmentManufacturingDef', u'equipmentPhysicalDef', u'equipmentPicture', u'equipmentServiceDef', u'equipmentSlotArray', u'equipmentSlotArrayRef', u'equipmentStorageControllerConfig', u'firmwareConstraints', u'firmwareType', u'firmwareUpgradeConstraint'], ["Get"]),
    ...
    "DomainChassisFeature": MoMeta("DomainChassisFeature", "domainChassisFeature", "chassis-feature-[name]", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin"], [u'domainChassisFeatureCont', u'domainEnvironmentFeatureCont', u'domainNetworkFeatureCont', u'domainServerFeatureCont', u'domainStorageFeatureCont'], [u'domainChassisParam', u'domainEnvironmentParam', u'domainNetworkParam', u'domainServerParam', u'domainStorageParam'], ["Get", "Set"]),
    "DomainChassisFeatureCont": MoMeta("DomainChassisFeatureCont", "domainChassisFeatureCont", "chassis-feature-cont", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin"], [u'topSystem'], [u'domainChassisFeature', u'domainEnvironmentFeature', u'domainNetworkFeature', u'domainServerFeature', u'domainStorageFeature'], [None]),
    "DomainChassisParam": MoMeta("DomainChassisParam", "domainChassisParam", "chassis-param-[name]", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin"], [u'domainChassisFeature', u'domainEnvironmentFeature', u'domainNetworkFeature', u'domainServerFeature', u'domainStorageFeature'], [], ["Get", "Set"]),
    ...
    "DomainEnvironmentFeatureCont": MoMeta("DomainEnvironmentFeatureCont", "domainEnvironmentFeatureCont", "env-feature-cont", VersionMeta.Version221b, "InputOutput", 0x1, [], ["admin"], [u'topSystem'], [u'domainChassisFeature', u'domainEnvironmentFeature', u'domainNetworkFeature', u'domainServerFeature', u'domainStorageFeature'], [None]),
    "DomainEnvironmentParam": MoMeta("DomainEnvironmentParam", "domainEnvironmentParam", "env-param-[name]", VersionMeta.Version221b, "InputOutput", 0x1, [], ["admin"], [u'domainChassisFeature', u'domainEnvironmentFeature', u'domainNetworkFeature', u'domainServerFeature', u'domainStorageFeature'], [], [None]),
    "DomainNetworkFeature": MoMeta("DomainNetworkFeature", "domainNetworkFeature", "network-feature-[name]", VersionMeta.Version221b, "InputOutput", 0x1, [], ["admin"], [u'domainChassisFeatureCont', u'domainEnvironmentFeatureCont', u'domainNetworkFeatureCont', u'domainServerFeatureCont', u'domainStorageFeatureCont'], [u'domainChassisParam', u'domainEnvironmentParam', u'domainNetworkParam', u'domainServerParam', u'domainStorageParam'], [None]),
    "DomainNetworkFeatureCont": MoMeta("DomainNetworkFeatureCont", "domainNetworkFeatureCont", "network-feature-cont", VersionMeta.Version221b, "InputOutput", 0x1, [], ["admin"], [u'topSystem'], [u'domainChassisFeature', u'domainEnvironmentFeature', u'domainNetworkFeature', u'domainServerFeature', u'domainStorageFeature'], [None]),
    "DomainNetworkParam": MoMeta("DomainNetworkParam", "domainNetworkParam", "network-param-[name]", VersionMeta.Version221b, "InputOutput", 0x1, [], ["admin"], [u'domainChassisFeature', u'domainEnvironmentFeature', u'domainNetworkFeature', u'domainServerFeature', u'domainStorageFeature'], [], [None]),
    "DomainServerFeature": MoMeta("DomainServerFeature", "domainServerFeature", "server-feature-[name]", VersionMeta.Version221b, "InputOutput", 0x1, [], ["admin"], [u'domainChassisFeatureCont', u'domainEnvironmentFeatureCont', u'domainNetworkFeatureCont', u'domainServerFeatureCont', u'domainStorageFeatureCont'], [u'domainChassisParam', u'domainEnvironmentParam', u'domainNetworkParam', u'domainServerParam', u'domainStorageParam'], [None]),
    "DomainServerFeatureCont": MoMeta("DomainServerFeatureCont", "domainServerFeatureCont", "server-feature-cont", VersionMeta.Version221b, "InputOutput", 0x1, [], ["admin"], [u'topSystem'], [u'domainChassisFeature', u'domainEnvironmentFeature', u'domainNetworkFeature', u'domainServerFeature', u'domainStorageFeature'], [None]),
    "DomainServerParam": MoMeta("DomainServerParam", "domainServerParam", "server-param-[name]", VersionMeta.Version221b, "InputOutput", 0x1, [], ["admin"], [u'domainChassisFeature', u'domainEnvironmentFeature', u'domainNetworkFeature', u'domainServerFeature', u'domainStorageFeature'], [], [None]),
    "DomainStorageFeature": MoMeta("DomainStorageFeature", "domainStorageFeature", "storage-feature-[name]", VersionMeta.Version221b, "InputOutput", 0x1, [], ["admin"], [u'domainChassisFeatureCont', u'domainEnvironmentFeatureCont', u'domainNetworkFeatureCont', u'domainServerFeatureCont', u'domainStorageFeatureCont'], [u'domainChassisParam', u'domainEnvironmentParam', u'domainNetworkParam', u'domainServerParam', u'domainStorageParam'], [None]),
    "DomainStorageFeatureCont": MoMeta("DomainStorageFeatureCont", "domainStorageFeatureCont", "storage-feature-cont", VersionMeta.Version221b, "InputOutput", 0x1, [], ["admin"], [u'topSystem'], [u'domainChassisFeature', u'domainEnvironmentFeature', u'domainNetworkFeature', u'domainServerFeature', u'domainStorageFeature'], [None]),
    "DomainStorageParam": MoMeta("DomainStorageParam", "domainStorageParam", "storage-param-[name]", VersionMeta.Version221b, "InputOutput", 0x1, [], ["admin"], [u'domainChassisFeature', u'domainEnvironmentFeature', u'domainNetworkFeature', u'domainServerFeature', u'domainStorageFeature'], [], [None]),
    ...
    "EquipmentAutoconfigPolicy": MoMeta("EquipmentAutoconfigPolicy", "equipmentAutoconfigPolicy", "chassis-autoconfig-[name]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "pn-policy"], [u'orgOrg'], [u'faultInst'], [None]),
    "EquipmentBaseBoardCapProvider": MoMeta("EquipmentBaseBoardCapProvider", "equipmentBaseBoardCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version101e, "InputOutput", 0x1, [], [""], [u'capabilityCatalogue', u'equipmentHwCapDerivativeProvider'], [u'equipmentFruVariant', u'equipmentManufacturingDef', u'equipmentPhysicalDef', u'equipmentPicture', u'equipmentServiceDef', u'equipmentSlotArrayRef', u'firmwareType', u'firmwareUpgradeConstraint'], ["Get"]),
    ...
    "EquipmentBinding": MoMeta("EquipmentBinding", "equipmentBinding", "chassis", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy", "read-only"], [u'equipmentChassisProfile'], [], ["Get", "Set"]),
    ...
    "EquipmentBiosTokenOverride": MoMeta("EquipmentBiosTokenOverride", "equipmentBiosTokenOverride", "bios-token-override-[bios_token_id]", VersionMeta.Version321d, "InputOutput", 0x1, [], ["read-only"], [u'equipmentBladeCapProvider', u'equipmentRackUnitCapProvider'], [], ["Get", "Set"]),
    ...
    "EquipmentBladeSwitchConnDef": MoMeta("EquipmentBladeSwitchConnDef", "equipmentBladeSwitchConnDef", "-switch-type-[switch_type]", VersionMeta.Version302c, "InputOutput", 0x1, [], [""], [u'equipmentBladeConnDef'], [u'equipmentAdaptorConnDef'], [None]),
    ...
    "EquipmentBootDeviceConstraints": MoMeta("EquipmentBootDeviceConstraints", "equipmentBootDeviceConstraints", "bootdevconstr-[boot_dev_type]", VersionMeta.Version312b, "InputOutput", 0x1, [], [""], [u'equipmentBladeCapProvider', u'equipmentRackUnitCapProvider'], [], [None]),
    ...
    "EquipmentCapModSpec": MoMeta("EquipmentCapModSpec", "equipmentCapModSpec", "modspec-[path]", VersionMeta.Version227b, "InputOutput", 0x1, [], [""], [u'equipmentHwCapDerivativeProvider'], [], ["Get"]),
    ...
    "EquipmentChassisAssocCtx": MoMeta("EquipmentChassisAssocCtx", "equipmentChassisAssocCtx", "cp-assoc-ctx", VersionMeta.Version312b, "InputOutput", 0x1, [], ["read-only"], [u'equipmentChassisProfileAssocCtx'], [], [None]),
    ...
    "EquipmentChassisInheritPolicy": MoMeta("EquipmentChassisInheritPolicy", "equipmentChassisInheritPolicy", "chassis-inherit-[name]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "pn-policy"], [u'orgOrg'], [u'faultInst'], [None]),
    "EquipmentChassisIssues": MoMeta("EquipmentChassisIssues", "equipmentChassisIssues", "config-issue", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'equipmentChassisProfile'], [u'faultInst'], ["Get"]),
    ...
    "EquipmentChassisProfileAssocCtx": MoMeta("EquipmentChassisProfileAssocCtx", "equipmentChassisProfileAssocCtx", "cp-assoc-ctx", VersionMeta.Version312b, "InputOutput", 0x1, [], ["read-only"], [u'equipmentChassisProfile'], [u'equipmentChassisAssocCtx'], ["Get"]),
    "EquipmentChassisProfileFsm": MoMeta("EquipmentChassisProfileFsm", "equipmentChassisProfileFsm", "fsm", VersionMeta.Version312b, "OutputOnly", 0x1, [], [""], [u'equipmentChassisProfile'], [u'equipmentChassisProfileFsmStage'], [None]),
    "EquipmentChassisProfileFsmStage": MoMeta("EquipmentChassisProfileFsmStage", "equipmentChassisProfileFsmStage", "stage-[name]", VersionMeta.Version312b, "OutputOnly", 0x1, [], [""], [u'equipmentChassisProfileFsm'], [], [None]),
    "EquipmentChassisProfileFsmTask": MoMeta("EquipmentChassisProfileFsmTask", "equipmentChassisProfileFsmTask", "task-[item]", VersionMeta.Version312b, "OutputOnly", 0x1, [], [""], [u'equipmentChassisProfile'], [], [None]),
    "EquipmentChassisQual": MoMeta("EquipmentChassisQual", "equipmentChassisQual", "chassis-from-[min_id]-to-[max_id]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "pn-policy"], [u'equipmentQual'], [], [None]),
    ...
    "EquipmentCiscoOsOpenGate": MoMeta("EquipmentCiscoOsOpenGate", "equipmentCiscoOsOpenGate", "ciscoosopengate-[is_supported]", VersionMeta.Version312b, "InputOutput", 0x1, [], [""], [u'equipmentBladeCapProvider', u'equipmentRackUnitCapProvider'], [], [None]),
    "EquipmentComputeConn": MoMeta("EquipmentComputeConn", "equipmentComputeConn", "compute-conn", VersionMeta.Version321d, "InputOutput", 0x1, [], ["read-only"], [u'equipmentChassis'], [u'faultInst'], [None]),
    "EquipmentComputeConnPolicy": MoMeta("EquipmentComputeConnPolicy", "equipmentComputeConnPolicy", "compute-conn-policy-[name]", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'orgOrg'], [], ["Get", "Set"]),
    "EquipmentCoprocessorUnitCapProvider": MoMeta("EquipmentCoprocessorUnitCapProvider", "equipmentCoprocessorUnitCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version401a, "InputOutput", 0x1, [], [""], [u'capabilityCatalogue', u'equipmentHwCapDerivativeProvider'], [u'equipmentFruVariant', u'equipmentManufacturingDef', u'equipmentPciDef', u'equipmentPhysicalDef', u'equipmentPicture', u'equipmentServiceDef', u'equipmentSlotArrayRef', u'firmwareType', u'firmwareUpgradeConstraint'], [None]),
    ...
    "EquipmentDiagFeatureSupport": MoMeta("EquipmentDiagFeatureSupport", "equipmentDiagFeatureSupport", "diag-feature-support", VersionMeta.Version323a, "InputOutput", 0x1, [], ["read-only"], [u'equipmentRackUnitCapProvider'], [], ["Get"]),
    ...
    "EquipmentDriveSecCap": MoMeta("EquipmentDriveSecCap", "equipmentDriveSecCap", "drive-sec-cap", VersionMeta.Version321d, "InputOutput", 0x1, [], ["read-only"], [u'equipmentBladeCapProvider', u'equipmentLocalDiskCapProvider', u'equipmentLocalDiskControllerCapProvider', u'equipmentRackUnitCapProvider'], [], ["Get"]),
    ...
    "EquipmentEmbeddedStorageDef": MoMeta("EquipmentEmbeddedStorageDef", "equipmentEmbeddedStorageDef", "embedded-storage", VersionMeta.Version312b, "InputOutput", 0x1, [], [""], [u'equipmentLocalDiskControllerCapProvider'], [], [None]),
    ...
    "EquipmentFanPresenceDef": MoMeta("EquipmentFanPresenceDef", "equipmentFanPresenceDef", "fan-presence-[fan_module_number]", VersionMeta.Version323a, "InputOutput", 0x1, [], [""], [u'equipmentRackFanModuleDef'], [], [None]),
    ...
    "EquipmentFexPsuInputStats": MoMeta("EquipmentFexPsuInputStats", "equipmentFexPsuInputStats", "fex-psu-input-stats", VersionMeta.Version141i, "OutputOnly", 0x1, [], ["admin", "operations", "read-only"], [u'equipmentFex', u'equipmentPsu'], [u'equipmentFexPsuInputStatsHist'], ["Get"]),
    ...
    "EquipmentFlexFlashNonRemovable": MoMeta("EquipmentFlexFlashNonRemovable", "equipmentFlexFlashNonRemovable", "ff-non-removable", VersionMeta.Version323a, "InputOutput", 0x1, [], [""], [u'equipmentBladeCapProvider', u'equipmentRackUnitCapProvider'], [], [None]),
    ...
    "EquipmentHostMgmtControllerCap": MoMeta("EquipmentHostMgmtControllerCap", "equipmentHostMgmtControllerCap", "host-mgmt-controller-cap", VersionMeta.Version321d, "InputOutput", 0x1, [], ["read-only"], [u'equipmentBladeCapProvider', u'equipmentRackUnitCapProvider'], [], [None]),
    ...
    "EquipmentHwRevisionModifier": MoMeta("EquipmentHwRevisionModifier", "equipmentHwRevisionModifier", "hw-rev-modifier-[hw_type]", VersionMeta.Version312b, "InputOutput", 0x1, [], [""], [u'equipmentBladeCapProvider', u'equipmentRackUnitCapProvider'], [], ["Get"]),
    "EquipmentHxCap": MoMeta("EquipmentHxCap", "equipmentHxCap", "hx-cap", VersionMeta.Version321d, "InputOutput", 0x1, [], ["read-only"], [u'equipmentRackUnitCapProvider'], [], ["Get"]),
    ...
    "EquipmentIOCardBaseFsm": MoMeta("EquipmentIOCardBaseFsm", "equipmentIOCardBaseFsm", "fsm", VersionMeta.Version302c, "OutputOnly", 0x1, [], [""], [u'equipmentIOCard', u'equipmentSwitchIOCard'], [u'equipmentIOCardBaseFsmStage'], [None]),
    "EquipmentIOCardBaseFsmStage": MoMeta("EquipmentIOCardBaseFsmStage", "equipmentIOCardBaseFsmStage", "stage-[name]", VersionMeta.Version302c, "OutputOnly", 0x1, [], [""], [u'equipmentIOCardBaseFsm'], [], [None]),
    "EquipmentIOCardBaseFsmTask": MoMeta("EquipmentIOCardBaseFsmTask", "equipmentIOCardBaseFsmTask", "task-[item]", VersionMeta.Version302c, "OutputOnly", 0x1, [], [""], [u'equipmentIOCard', u'equipmentSwitchIOCard'], [], [None]),
    "EquipmentIOCardCapProvider": MoMeta("EquipmentIOCardCapProvider", "equipmentIOCardCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version101e, "InputOutput", 0x1, [], [""], [u'capabilityCatalogue', u'equipmentHwCapDerivativeProvider'], [u'equipmentFruVariant', u'equipmentIOCardTypeDef', u'equipmentManufacturingDef', u'equipmentPhysicalDef', u'equipmentPicture', u'equipmentPortGroupAggregationDef', u'equipmentPortGroupDef', u'equipmentServiceDef', u'equipmentSlotArrayRef', u'firmwareType', u'firmwareUpgradeConstraint'], ["Get"]),
    ...
    "EquipmentIOExpander": MoMeta("EquipmentIOExpander", "equipmentIOExpander", "io-expander-[id]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["read-only"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit'], [], ["Get"]),
    ...
    "EquipmentLocalDiskControllerTypeDef": MoMeta("EquipmentLocalDiskControllerTypeDef", "equipmentLocalDiskControllerTypeDef", "controller-type", VersionMeta.Version224b, "InputOutput", 0x1, [], [""], [u'equipmentLocalDiskControllerCapProvider'], [], ["Get"]),
    ...
    "EquipmentNvmeDef": MoMeta("EquipmentNvmeDef", "equipmentNvmeDef", "nvme-def", VersionMeta.Version321d, "InputOutput", 0x1, [], [""], [u'equipmentBladeCapProvider', u'equipmentRackUnitCapProvider'], [], ["Get"]),
    "EquipmentNvmeSwitchConfig": MoMeta("EquipmentNvmeSwitchConfig", "equipmentNvmeSwitchConfig", "nvme-switch-config", VersionMeta.Version323a, "InputOutput", 0x1, [], [""], [u'equipmentStorageNvmeSwitchCapProvider'], [], [None]),
    ...
    "EquipmentPciDef": MoMeta("EquipmentPciDef", "equipmentPciDef", "pci-[name]", VersionMeta.Version141i, "InputOutput", 0x1, [], [""], [u'adaptorFruCapProvider', u'adaptorUnit', u'equipmentCoprocessorUnitCapProvider', u'equipmentGraphicsCardCapProvider', u'equipmentLocalDiskControllerCapProvider', u'equipmentPciSwitchCapProvider'], [], ["Get"]),
    "EquipmentPciSlotIdEntry": MoMeta("EquipmentPciSlotIdEntry", "equipmentPciSlotIdEntry", "pci-slotid-entry-[name]", VersionMeta.Version312b, "InputOutput", 0x1, [], [""], [u'equipmentPciSlotIdMapping'], [], ["Get"]),
    "EquipmentPciSlotIdMapping": MoMeta("EquipmentPciSlotIdMapping", "equipmentPciSlotIdMapping", "pci-slotid-mapping", VersionMeta.Version312b, "InputOutput", 0x1, [], [""], [u'equipmentBladeCapProvider', u'equipmentRackUnitCapProvider'], [u'equipmentPciSlotIdEntry'], ["Get"]),
    "EquipmentPciSlotSubOEMIdEntry": MoMeta("EquipmentPciSlotSubOEMIdEntry", "equipmentPciSlotSubOEMIdEntry", "pci-slot-suboemid-entry-[name]", VersionMeta.Version312b, "InputOutput", 0x1, [], [""], [u'equipmentStorageControllerConfig'], [], ["Get"]),
    ...
    "EquipmentPcieSlotOrientation": MoMeta("EquipmentPcieSlotOrientation", "equipmentPcieSlotOrientation", "pcie-slot-orientation-[slot_number]", VersionMeta.Version323a, "InputOutput", 0x1, [], [""], [u'equipmentRackUnitCapProvider'], [], ["Get"]),
    ...
    "EquipmentPhysicalQual": MoMeta("EquipmentPhysicalQual", "equipmentPhysicalQual", "physicalqual", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "pn-policy"], [u'equipmentQual'], [], [None]),
    "EquipmentPicture": MoMeta("EquipmentPicture", "equipmentPicture", "picture-[type]", VersionMeta.Version141i, "InputOutput", 0x1, [], [""], [u'adaptorFruCapProvider', u'diagSrvCapProvider', u'equipmentBaseBoardCapProvider', u'equipmentBladeBiosCapProvider', u'equipmentBladeCapProvider', u'equipmentCatalogCapProvider', u'equipmentChassisCapProvider', u'equipmentCoprocessorUnitCapProvider', u'equipmentDbgPluginCapProvider', u'equipmentFanModuleCapProvider', u'equipmentFexCapProvider', u'equipmentGemCapProvider', u'equipmentGraphicsCardCapProvider', u'equipmentHostIfCapProvider', u'equipmentIOCardCapProvider', u'equipmentIOExpanderCapProvider', u'equipmentLocalDiskCapProvider', u'equipmentLocalDiskControllerCapProvider', u'equipmentMemoryUnitCapProvider', u'equipmentMgmtCapProvider', u'equipmentMgmtExtCapProvider', u'equipmentMiniStorageCapProvider', u'equipmentPciSwitchCapProvider', u'equipmentPersistentMemoryUnitCapProvider', u'equipmentProcessorUnitCapProvider', u'equipmentPsuCapProvider', u'equipmentRackEnclosureCapProvider', u'equipmentRackUnitCapProvider', u'equipmentSecurityUnitCapProvider', u'equipmentServerUnitCapProvider', u'equipmentSiocCapProvider', u'equipmentStorageEncCapProvider', u'equipmentStorageNvmeSwitchCapProvider', u'equipmentStorageSasExpanderCapProvider', u'equipmentSwitchCapProvider', u'equipmentSwitchIOCardCapProvider', u'equipmentTpmCapProvider'], [], ["Get"]),
    "EquipmentPnuosBootMode": MoMeta("EquipmentPnuosBootMode", "equipmentPnuosBootMode", "pnuosBootMode", VersionMeta.Version323a, "InputOutput", 0x1, [], [""], [u'equipmentBladeCapProvider', u'equipmentRackUnitCapProvider'], [], ["Get"]),
    "EquipmentPool": MoMeta("EquipmentPool", "equipmentPool", "equipment-pool-[name]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "pn-policy"], [u'orgOrg'], [u'equipmentPooledChassis'], [None]),
    "EquipmentPoolPolicyRef": MoMeta("EquipmentPoolPolicyRef", "equipmentPoolPolicyRef", "chassis-poolref-[id]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["read-only"], [u'equipmentPoolable'], [], [None]),
    "EquipmentPoolable": MoMeta("EquipmentPoolable", "equipmentPoolable", "chassis-pool-[id]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["read-only"], [u'equipmentChassis'], [u'equipmentPoolPolicyRef'], [None]),
    "EquipmentPooledChassis": MoMeta("EquipmentPooledChassis", "equipmentPooledChassis", "chassis-[chassis_id]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "pn-policy"], [u'equipmentPool'], [], [None]),
    "EquipmentPoolingPolicy": MoMeta("EquipmentPoolingPolicy", "equipmentPoolingPolicy", "chassis-pooling-policy-[name]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "pn-policy"], [u'orgOrg'], [], [None]),
    "EquipmentPortCap": MoMeta("EquipmentPortCap", "equipmentPortCap", "port-cap-start-[start_port_id]-end-[end_port_id]", VersionMeta.Version302c, "InputOutput", 0x1, [], [""], [u'equipmentSwitchCap', u'equipmentSwitchIOCardCapProvider'], [], [None]),
    ...
    "EquipmentPowerCapDef": MoMeta("EquipmentPowerCapDef", "equipmentPowerCapDef", "powercap", VersionMeta.Version302c, "InputOutput", 0x1, [], [""], [u'equipmentBladeCapProvider', u'equipmentChassisCapProvider', u'equipmentRackUnitCapProvider'], [], ["Get"]),
    ...
    "EquipmentPsuFsm": MoMeta("EquipmentPsuFsm", "equipmentPsuFsm", "fsm", VersionMeta.Version302c, "OutputOnly", 0x1, [], [""], [u'equipmentPsu'], [u'equipmentPsuFsmStage'], [None]),
    "EquipmentPsuFsmStage": MoMeta("EquipmentPsuFsmStage", "equipmentPsuFsmStage", "stage-[name]", VersionMeta.Version302c, "OutputOnly", 0x1, [], [""], [u'equipmentPsuFsm'], [], [None]),
    "EquipmentPsuFsmTask": MoMeta("EquipmentPsuFsmTask", "equipmentPsuFsmTask", "task-[item]", VersionMeta.Version302c, "OutputOnly", 0x1, [], [""], [u'equipmentPsu'], [], [None]),
    ...
    "EquipmentQual": MoMeta("EquipmentQual", "equipmentQual", "chassis-qualifier-[name]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "pn-policy"], [u'orgOrg'], [u'equipmentChassisQual', u'equipmentPhysicalQual'], [None]),
    "EquipmentRackEnclosure": MoMeta("EquipmentRackEnclosure", "equipmentRackEnclosure", "rack-enclosure-[id]", VersionMeta.Version401a, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'topSystem'], [u'equipmentFanModule', u'equipmentPsu', u'equipmentSlotEp'], [None]),
    ...
    "EquipmentRequirement": MoMeta("EquipmentRequirement", "equipmentRequirement", "chassis-req", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy", "read-only"], [u'equipmentChassisProfile'], [u'faultInst'], [None]),
    ...
    "EquipmentSiocTempStats": MoMeta("EquipmentSiocTempStats", "equipmentSiocTempStats", "temp-stats", VersionMeta.Version312b, "OutputOnly", 0x1, [], ["admin", "operations", "read-only"], [u'equipmentSystemIOController'], [u'equipmentSiocTempStatsHist'], ["Get"]),
    "EquipmentSiocTempStatsHist": MoMeta("EquipmentSiocTempStatsHist", "equipmentSiocTempStatsHist", "[id]", VersionMeta.Version312b, "OutputOnly", 0x1, [], ["read-only"], [u'equipmentSiocTempStats'], [], ["Get"]),
    ...
    "EquipmentSlotEp": MoMeta("EquipmentSlotEp", "equipmentSlotEp", "slot-ep-[id]", VersionMeta.Version401a, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'equipmentRackEnclosure'], [], [None]),
    "EquipmentSpeedCompatibility": MoMeta("EquipmentSpeedCompatibility", "equipmentSpeedCompatibility", "speed-cap", VersionMeta.Version401a, "InputOutput", 0x1, [], [""], [u'equipmentSwitchCapProvider'], [], [None]),
    ...
    "EquipmentStorageControllerSlotDef": MoMeta("EquipmentStorageControllerSlotDef", "equipmentStorageControllerSlotDef", "controller-slot-def-[slot_num]", VersionMeta.Version224b, "InputOutput", 0x1, [], ["read-only"], [u'equipmentBladeCapProvider', u'equipmentRackUnitCapProvider'], [], [None]),
    ...
    "EquipmentStorageNvmeSwitchCapProvider": MoMeta("EquipmentStorageNvmeSwitchCapProvider", "equipmentStorageNvmeSwitchCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version323a, "InputOutput", 0x1, [], [""], [u'capabilityCatalogue', u'equipmentHwCapDerivativeProvider'], [u'equipmentFruVariant', u'equipmentManufacturingDef', u'equipmentNvmeSwitchConfig', u'equipmentPhysicalDef', u'equipmentPicture', u'equipmentServiceDef', u'equipmentSlotArrayRef', u'equipmentStorageNvmeSwitchDef', u'firmwareType', u'firmwareUpgradeConstraint'], [None]),
    "EquipmentStorageNvmeSwitchDef": MoMeta("EquipmentStorageNvmeSwitchDef", "equipmentStorageNvmeSwitchDef", "mswitch-def", VersionMeta.Version323a, "InputOutput", 0x1, [], [""], [u'equipmentStorageNvmeSwitchCapProvider'], [], [None]),
    "EquipmentStorageSasExpanderCapProvider": MoMeta("EquipmentStorageSasExpanderCapProvider", "equipmentStorageSasExpanderCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version226c, "InputOutput", 0x1, [], [""], [u'capabilityCatalogue', u'equipmentHwCapDerivativeProvider'], [u'equipmentFruVariant', u'equipmentManufacturingDef', u'equipmentOnboardDeviceDef', u'equipmentPhysicalDef', u'equipmentPicture', u'equipmentServiceDef', u'equipmentSlotArrayRef', u'equipmentStorageSasExpanderDef', u'firmwareType', u'firmwareUpgradeConstraint'], ["Get"]),
    "EquipmentStorageSasExpanderCapRef": MoMeta("EquipmentStorageSasExpanderCapRef", "equipmentStorageSasExpanderCapRef", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version226c, "InputOutput", 0x1, [], [""], [u'equipmentRackUnitCapProvider'], [], ["Get"]),
    "EquipmentStorageSasExpanderDef": MoMeta("EquipmentStorageSasExpanderDef", "equipmentStorageSasExpanderDef", "sas-expander-def", VersionMeta.Version312b, "InputOutput", 0x1, [], [""], [u'equipmentStorageSasExpanderCapProvider'], [], ["Get"]),
    ...
    "EquipmentSwitchIOCardCapProvider": MoMeta("EquipmentSwitchIOCardCapProvider", "equipmentSwitchIOCardCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version302c, "InputOutput", 0x1, [], [""], [u'capabilityCatalogue', u'equipmentHwCapDerivativeProvider'], [u'equipmentBeaconCapProvider', u'equipmentFruVariant', u'equipmentIOCardTypeDef', u'equipmentManufacturingDef', u'equipmentPhysicalDef', u'equipmentPicture', u'equipmentPortCap', u'equipmentPortGroupAggregationDef', u'equipmentPortGroupDef', u'equipmentServerPortCapProvider', u'equipmentServiceDef', u'equipmentSlotArrayRef', u'equipmentSwitchCap', u'equipmentUnifiedPortCapProvider', u'firmwareType', u'firmwareUpgradeConstraint'], [None]),
    "EquipmentSwitchIOCardFsm": MoMeta("EquipmentSwitchIOCardFsm", "equipmentSwitchIOCardFsm", "fsm", VersionMeta.Version302c, "OutputOnly", 0x1, [], [""], [u'equipmentSwitchIOCard'], [u'equipmentSwitchIOCardFsmStage'], [None]),
    "EquipmentSwitchIOCardFsmStage": MoMeta("EquipmentSwitchIOCardFsmStage", "equipmentSwitchIOCardFsmStage", "stage-[name]", VersionMeta.Version302c, "OutputOnly", 0x1, [], [""], [u'equipmentSwitchIOCardFsm'], [], [None]),
    ...
    "EquipmentSystemIOControllerFsm": MoMeta("EquipmentSystemIOControllerFsm", "equipmentSystemIOControllerFsm", "fsm", VersionMeta.Version312b, "OutputOnly", 0x1, [], [""], [u'equipmentSystemIOController'], [u'equipmentSystemIOControllerFsmStage'], [None]),
    "EquipmentSystemIOControllerFsmStage": MoMeta("EquipmentSystemIOControllerFsmStage", "equipmentSystemIOControllerFsmStage", "stage-[name]", VersionMeta.Version312b, "OutputOnly", 0x1, [], [""], [u'equipmentSystemIOControllerFsm'], [], [None]),
    "EquipmentSystemIOControllerFsmTask": MoMeta("EquipmentSystemIOControllerFsmTask", "equipmentSystemIOControllerFsmTask", "task-[item]", VersionMeta.Version312b, "OutputOnly", 0x1, [], [""], [u'equipmentSystemIOController'], [], [None]),
    "EquipmentTier": MoMeta("EquipmentTier", "equipmentTier", "cp-tier-[name]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-policy"], [u'orgOrg'], [u'equipmentChassisProfile'], [None]),
    ...
    "FabricBreakout": MoMeta("FabricBreakout", "fabricBreakout", "breakout-slot-[slot_id]-port-[port_id]", VersionMeta.Version311e, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy", "ext-san-config", "ext-san-policy"], [u'fabricCablingSw'], [], ["Add", "Get", "Remove"]),
    ...
    "FabricCablingSw": MoMeta("FabricCablingSw", "fabricCablingSw", "[id]", VersionMeta.Version311e, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy", "ext-san-config", "ext-san-policy"], [u'fabricCabling'], [u'fabricBreakout'], ["Get"]),
    ...
    "FabricDceSwSrv": MoMeta("FabricDceSwSrv", "fabricDceSwSrv", "sw-[id]", VersionMeta.Version101e, "InputOutput", 0x1, [], ["admin", "ls-network-policy"], [u'fabricDceSrv'], [u'fabricDceSwSrvEp', u'fabricDceSwSrvPc', u'fabricSubGroup'], ["Add", "Get", "Remove"]),
    ...
    "FabricDceSwSrvPcEp": MoMeta("FabricDceSwSrvPcEp", "fabricDceSwSrvPcEp", "ep-slot-[slot_id]-port-[port_id]", VersionMeta.Version201m, "InputOutput", 0x1, [], ["admin", "ls-network", "ls-network-policy"], [u'fabricDceSwSrvPc', u'fabricSubGroup'], [u'faultInst'], ["Get", "Set"]),
    ...
    "FabricFcEndpoint": MoMeta("FabricFcEndpoint", "fabricFcEndpoint", "endpoint-[wwpn]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricFcUserZone'], [], ["Add", "Get", "Remove", "Set"]),
    ...
    "FabricFcUserZone": MoMeta("FabricFcUserZone", "fabricFcUserZone", "zone-[name]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricFcZoneProfile'], [u'fabricFcEndpoint', u'faultInst', u'storageVsanRef'], ["Add", "Get", "Remove", "Set"]),
    ...
    "FabricFcZoneProfile": MoMeta("FabricFcZoneProfile", "fabricFcZoneProfile", "zone-profile-[name]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricFcEstcCloud'], [u'fabricFcUserZone', u'faultInst'], ["Add", "Get", "Remove", "Set"]),
    ...
    "FabricLanCloudPolicy": MoMeta("FabricLanCloudPolicy", "fabricLanCloudPolicy", "lan-policy", VersionMeta.Version227b, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'orgOrg'], [], ["Get"]),
    ...
    "FabricNetGroupRef": MoMeta("FabricNetGroupRef", "fabricNetGroupRef", "net-group-ref-[name]", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin", "ls-config", "ls-network", "ls-server"], [u'dcxVc', u'swCmclan', u'vnicEther', u'vnicLanConnTempl', u'vnicProfile', u'vnicSanConnTempl'], [u'faultInst'], [None]),
    ...
    "FabricReservedVlan": MoMeta("FabricReservedVlan", "fabricReservedVlan", "fab-reserved-vlans", VersionMeta.Version401a, "InputOutput", 0x1, [], ["admin"], [u'fabricLanCloud'], [u'eventInst', u'fabricReservedVlanFsm', u'fabricReservedVlanFsmTask', u'faultInst', u'firmwareAck'], [None]),
    "FabricReservedVlanFsm": MoMeta("FabricReservedVlanFsm", "fabricReservedVlanFsm", "fsm", VersionMeta.Version401a, "OutputOnly", 0x1, [], [""], [u'fabricReservedVlan'], [u'fabricReservedVlanFsmStage'], [None]),
    "FabricReservedVlanFsmStage": MoMeta("FabricReservedVlanFsmStage", "fabricReservedVlanFsmStage", "stage-[name]", VersionMeta.Version401a, "OutputOnly", 0x1, [], [""], [u'fabricReservedVlanFsm'], [], [None]),
    "FabricReservedVlanFsmTask": MoMeta("FabricReservedVlanFsmTask", "fabricReservedVlanFsmTask", "task-[item]", VersionMeta.Version401a, "OutputOnly", 0x1, [], [""], [u'fabricReservedVlan'], [], [None]),
    "FabricSanCloud": MoMeta("FabricSanCloud", "fabricSanCloud", "san", VersionMeta.Version101e, "InputOutput", 0x1, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricEp'], [u'eventInst', u'fabricFcSan', u'fabricSanCloudFsm', u'fabricSanCloudFsmTask', u'fabricSanPinGroup', u'fabricVsan', u'faultInst', u'firmwareAck', u'mgmtLeaderEntity', u'statsThresholdPolicy'], ["Get", "Set"]),
    ...
    "FabricSanGroupRef": MoMeta("FabricSanGroupRef", "fabricSanGroupRef", "san-group-ref-[name]", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin", "ls-config", "ls-network", "ls-server"], [u'dcxVc', u'vnicFc', u'vnicLanConnTempl', u'vnicSanConnTempl'], [u'faultInst'], [None]),
    ...
    "FabricSwSubGroup": MoMeta("FabricSwSubGroup", "fabricSwSubGroup", "sw-[switch_id]-slot-[slot_id]-aggr-port-[aggr_port_id]", VersionMeta.Version302c, "InputOutput", 0x1, [], ["admin", "ls-network", "ls-network-policy"], [u'fabricNetGroup', u'fabricVlan', u'fabricVsan'], [u'fabricEthVlanPortEp', u'fabricFcoeVsanPortEp'], [None]),
    ...
    "FabricVlanGroupPermit": MoMeta("FabricVlanGroupPermit", "fabricVlanGroupPermit", "vgperm-[cloud]sw-[switch_id]net-[name]", VersionMeta.Version321d, "InputOutput", 0x1, [], [""], [u'orgOrg'], [], [None]),
    ...
    "FeatureContextEp": MoMeta("FeatureContextEp", "featureContextEp", "contexts", VersionMeta.Version302c, "InputOutput", 0x1, [], [""], [u'topSystem'], [u'featureDefinitionInstance', u'featureFruCapProviderInstance', u'featureProviderInstance'], [None]),
    "FeatureDefinition": MoMeta("FeatureDefinition", "featureDefinition", "feature-[name]-revision-[revision]", VersionMeta.Version302c, "InputOutput", 0x1, [], [""], [u'capabilityCatalogue'], [], [None]),
    "FeatureDefinitionInstance": MoMeta("FeatureDefinitionInstance", "featureDefinitionInstance", "feature-[name]-revision-[revision]", VersionMeta.Version302c, "InputOutput", 0x1, [], [""], [u'featureContextEp'], [], [None]),
    "FeatureDefinitionRef": MoMeta("FeatureDefinitionRef", "featureDefinitionRef", "feature-[name]-revision-[revision]", VersionMeta.Version302c, "InputOutput", 0x1, [], [""], [u'featureProvider'], [], [None]),
    "FeatureFruCapProviderInstance": MoMeta("FeatureFruCapProviderInstance", "featureFruCapProviderInstance", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version302c, "InputOutput", 0x1, [], [""], [u'featureContextEp'], [], [None]),
    "FeatureFruCapProviderRef": MoMeta("FeatureFruCapProviderRef", "featureFruCapProviderRef", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version302c, "InputOutput", 0x1, [], [""], [u'featureProvider'], [], [None]),
    "FeatureProvider": MoMeta("FeatureProvider", "featureProvider", "prov-[name]", VersionMeta.Version302c, "InputOutput", 0x1, [], [""], [u'capabilityCatalogue'], [u'featureDefinitionRef', u'featureFruCapProviderRef'], [None]),
    "FeatureProviderInstance": MoMeta("FeatureProviderInstance", "featureProviderInstance", "inst-[name]", VersionMeta.Version302c, "InputOutput", 0x1, [], [""], [u'featureContextEp'], [], [None]),
    "FirmwareAck": MoMeta("FirmwareAck", "firmwareAck", "ack", VersionMeta.Version211a, "InputOutput", 0x1, [], ["admin"], [u'fabricLanCloud', u'fabricReservedVlan', u'fabricSanCloud', u'firmwareSystem', u'qosclassDefinition'], [u'faultInst', u'trigLocalSched'], ["Get", "Set"]),
    ...
    "FirmwareActivityTrigger": MoMeta("FirmwareActivityTrigger", "firmwareActivityTrigger", "fw-activity-trigger", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin"], [u'equipmentChassis'], [], ["Get"]),
    ...
    "FirmwareBackupVersionHolder": MoMeta("FirmwareBackupVersionHolder", "firmwareBackupVersionHolder", "update-backup-version-holder-[bundle_type]", VersionMeta.Version323a, "InputOutput", 0x1, [], ["admin"], [u'firmwareCatalogPack', u'firmwareChassisPack', u'firmwareComputeHostPack', u'firmwareComputeMgmtPack', u'firmwareInfraPack'], [u'firmwarePackItem'], ["Get", "Set"]),
    ...
    "FirmwareBootUnit": MoMeta("FirmwareBootUnit", "firmwareBootUnit", "bootunit-[type]", VersionMeta.Version101e, "InputOutput", 0x1, [], ["admin"], [u'firmwareBootDefinition'], [u'faultInst', u'firmwareInstallable', u'firmwareServicePack'], ["Get", "Set"]),
    ...
    "FirmwareCatalogPack": MoMeta("FirmwareCatalogPack", "firmwareCatalogPack", "fw-catalog-pack-[name]", VersionMeta.Version211a, "InputOutput", 0x1, [], ["admin", "operations"], [u'orgOrg'], [u'firmwareBackupVersionHolder', u'firmwarePackItem'], ["Get", "Set"]),
    ...
    "FirmwareChassisComponentSpec": MoMeta("FirmwareChassisComponentSpec", "firmwareChassisComponentSpec", "chassis-component-spec-[type]", VersionMeta.Version312b, "InputOutput", 0x1, [], [""], [u'firmwareBundleTypeCapProvider'], [], ["Get"]),
    "FirmwareChassisPack": MoMeta("FirmwareChassisPack", "firmwareChassisPack", "fw-chassis-pack-[name]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'orgOrg'], [u'firmwareBackupVersionHolder', u'firmwareExcludeChassisComponent', u'firmwarePackItem'], ["Add", "Get", "Remove", "Set"]),
    ...
    "FirmwareComputeHostPack": MoMeta("FirmwareComputeHostPack", "firmwareComputeHostPack", "fw-host-pack-[name]", VersionMeta.Version101e, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config-policy", "ls-server-policy"], [u'orgOrg'], [u'firmwareBackupVersionHolder', u'firmwareExcludeServerComponent', u'firmwarePackItem'], ["Add", "Get", "Remove", "Set"]),
    "FirmwareComputeMgmtPack": MoMeta("FirmwareComputeMgmtPack", "firmwareComputeMgmtPack", "fw-mgmt-pack-[name]", VersionMeta.Version101e, "InputOutput", 0x1, [], ["admin", "ls-config-policy", "ls-server-policy"], [u'orgOrg'], [u'firmwareBackupVersionHolder', u'firmwarePackItem'], ["Add", "Get", "Remove", "Set"]),
    "FirmwareConnectionManagementChassisConstraint": MoMeta("FirmwareConnectionManagementChassisConstraint", "firmwareConnectionManagementChassisConstraint", "connection-management-chassis-constraint", VersionMeta.Version323a, "InputOutput", 0x1, [], ["read-only"], [u'firmwareConstraints'], [], [None]),
    ...
    "FirmwareDriveSecurityConstraint": MoMeta("FirmwareDriveSecurityConstraint", "firmwareDriveSecurityConstraint", "drive-security-constraint", VersionMeta.Version321d, "InputOutput", 0x1, [], ["read-only"], [u'firmwareConstraints'], [], [None]),
    "FirmwareDualVicChassisConstraint": MoMeta("FirmwareDualVicChassisConstraint", "firmwareDualVicChassisConstraint", "dual-vic-chassis-constraint", VersionMeta.Version321d, "InputOutput", 0x1, [], ["read-only"], [u'firmwareConstraints'], [], [None]),
    "FirmwareDualVicServerConstraint": MoMeta("FirmwareDualVicServerConstraint", "firmwareDualVicServerConstraint", "dual-vic-server-constraint", VersionMeta.Version321d, "InputOutput", 0x1, [], ["read-only"], [u'firmwareConstraints'], [], [None]),
    "FirmwareExcludeChassisComponent": MoMeta("FirmwareExcludeChassisComponent", "firmwareExcludeChassisComponent", "exclude-chassis-component-[chassis_component]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'firmwareChassisPack'], [], ["Add", "Get", "Remove"]),
    "FirmwareExcludeServerComponent": MoMeta("FirmwareExcludeServerComponent", "firmwareExcludeServerComponent", "exclude-server-component-[server_component]", VersionMeta.Version227b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config-policy", "ls-server-policy"], [u'firmwareComputeHostPack'], [], ["Add", "Get", "Remove"]),
    ...
    "FirmwareImage": MoMeta("FirmwareImage", "firmwareImage", "image-[name]", VersionMeta.Version101e, "InputOutput", 0x1, [], ["admin"], [u'firmwareCatalogue'], [u'eventInst', u'faultInst', u'firmwareImageFsm', u'firmwareImageFsmTask', u'firmwareInstallable', u'firmwareModule'], ["Get", "Set"]),
    ...
    "FirmwareInfraPack": MoMeta("FirmwareInfraPack", "firmwareInfraPack", "fw-infra-pack-[name]", VersionMeta.Version211a, "InputOutput", 0x1, [], ["admin"], [u'orgOrg'], [u'firmwareBackupVersionHolder', u'firmwarePackItem'], ["Get", "Set"]),
    ...
    "FirmwareModule": MoMeta("FirmwareModule", "firmwareModule", "module-[name]|[type]", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin"], [u'firmwareImage'], [], [None]),
    "FirmwarePCHStorageConfigConstraint": MoMeta("FirmwarePCHStorageConfigConstraint", "firmwarePCHStorageConfigConstraint", "constraint-pch-storage-config", VersionMeta.Version227b, "InputOutput", 0x1, [], [""], [u'firmwareConstraints'], [], ["Get"]),
    "FirmwarePackItem": MoMeta("FirmwarePackItem", "firmwarePackItem", "pack-image-[hw_vendor]|[hw_model]|[type]", VersionMeta.Version101e, "InputOutput", 0x1, [], ["admin"], [u'firmwareBackupVersionHolder', u'firmwareCatalogPack', u'firmwareChassisPack', u'firmwareComputeHostPack', u'firmwareComputeMgmtPack', u'firmwareInfraPack'], [u'faultInst'], ["Add", "Get", "Remove", "Set"]),
    "FirmwarePlatformBundleTypeCapProvider": MoMeta("FirmwarePlatformBundleTypeCapProvider", "firmwarePlatformBundleTypeCapProvider", "plat-bundle-type-cap-[platform_type]", VersionMeta.Version302c, "InputOutput", 0x1, [], [""], [u'capabilityCatalogue'], [u'firmwareBundleType'], [None]),
    "FirmwareProcessorTypeConstraint": MoMeta("FirmwareProcessorTypeConstraint", "firmwareProcessorTypeConstraint", "constraint-processor-type-[type]", VersionMeta.Version224b, "InputOutput", 0x1, [], [""], [u'firmwareConstraints'], [], [None]),
    "FirmwareRack": MoMeta("FirmwareRack", "firmwareRack", "fw-rack", VersionMeta.Version211a, "InputOutput", 0x1, [], ["admin"], [u'firmwareHost'], [], ["Get"]),
    "FirmwareRackPowerCapConstraint": MoMeta("FirmwareRackPowerCapConstraint", "firmwareRackPowerCapConstraint", "constraint-rack-powercap-config", VersionMeta.Version312b, "InputOutput", 0x1, [], [""], [u'firmwareConstraints'], [], [None]),
    ...
    "FirmwareSecondControllerChassisConstraint": MoMeta("FirmwareSecondControllerChassisConstraint", "firmwareSecondControllerChassisConstraint", "second-controller-chassis-constraint", VersionMeta.Version321d, "InputOutput", 0x1, [], ["read-only"], [u'firmwareConstraints'], [], [None]),
    "FirmwareSecondControllerServerConstraint": MoMeta("FirmwareSecondControllerServerConstraint", "firmwareSecondControllerServerConstraint", "second-controller-server-constraint", VersionMeta.Version321d, "InputOutput", 0x1, [], ["read-only"], [u'firmwareConstraints'], [], [None]),
    "FirmwareServerChassisConstraint": MoMeta("FirmwareServerChassisConstraint", "firmwareServerChassisConstraint", "server-chassis-constraint-[server_model]", VersionMeta.Version323a, "InputOutput", 0x1, [], ["read-only"], [u'firmwareConstraints'], [], [None]),
    "FirmwareServerTypeConstraint": MoMeta("FirmwareServerTypeConstraint", "firmwareServerTypeConstraint", "constraint-server-type", VersionMeta.Version311e, "InputOutput", 0x1, [], [""], [u'firmwareConstraints'], [], ["Get"]),
    "FirmwareServicePack": MoMeta("FirmwareServicePack", "firmwareServicePack", "servicepack", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin"], [u'firmwareBootUnit', u'firmwareRunning'], [], ["Get", "Set"]),
    "FirmwareSinglePathChassisConstraint": MoMeta("FirmwareSinglePathChassisConstraint", "firmwareSinglePathChassisConstraint", "single-path-chassis-constraint", VersionMeta.Version323a, "InputOutput", 0x1, [], ["read-only"], [u'firmwareConstraints'], [], [None]),
    ...
    "FirmwareVnicCdnConstraint": MoMeta("FirmwareVnicCdnConstraint", "firmwareVnicCdnConstraint", "constraint-vnic-cdn-[type]", VersionMeta.Version224b, "InputOutput", 0x1, [], [""], [u'firmwareConstraints'], [], [None]),
    "FirmwareWaterbaySiocServerConstraint": MoMeta("FirmwareWaterbaySiocServerConstraint", "firmwareWaterbaySiocServerConstraint", "waterbay-sioc-server-constraint", VersionMeta.Version401a, "InputOutput", 0x1, [], ["read-only"], [u'firmwareConstraints'], [], [None]),
    ...
    "GraphicsCard": MoMeta("GraphicsCard", "graphicsCard", "graphics-card-[id]", VersionMeta.Version213a, "InputOutput", 0x1, [], ["read-only"], [u'computeBoard'], [u'equipmentInventoryStatus', u'firmwareBootDefinition', u'firmwareRunning', u'graphicsController'], ["Get"]),
    ...
    "LsIdentityInfo": MoMeta("LsIdentityInfo", "lsIdentityInfo", "ls-identity-info", VersionMeta.Version224b, "InputOutput", 0x1, [], ["admin", "ls-config", "ls-server"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit', u'lsServer'], [u'faultInst'], ["Get"]),
    ...
    "LsbootDefaultLocalImage": MoMeta("LsbootDefaultLocalImage", "lsbootDefaultLocalImage", "local-any", VersionMeta.Version221b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"], [u'lsbootLocalStorage'], [u'lsbootUEFIBootParam'], ["Add", "Get", "Remove", "Set"]),
    "LsbootEFIShell": MoMeta("LsbootEFIShell", "lsbootEFIShell", "efi-shell", VersionMeta.Version227b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"], [u'lsbootDef', u'lsbootPolicy'], [], ["Add", "Get", "Remove", "Set"]),
    ...
    "LsbootLocalLunImagePath": MoMeta("LsbootLocalLunImagePath", "lsbootLocalLunImagePath", "lunimgpath-[type]", VersionMeta.Version224b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"], [u'lsbootLocalHddImage'], [u'lsbootUEFIBootParam'], ["Add", "Get", "Remove", "Set"]),
    ...
    "LsbootNvme": MoMeta("LsbootNvme", "lsbootNvme", "nvme", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"], [u'lsbootLocalStorage'], [u'lsbootNvmeDiskSsd', u'lsbootNvmePciSsd', u'lsbootUEFIBootParam'], ["Get", "Set"]),
    "LsbootNvmeDiskSsd": MoMeta("LsbootNvmeDiskSsd", "lsbootNvmeDiskSsd", "nvme-disk-ssd", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"], [u'lsbootNvme'], [], ["Get", "Set"]),
    "LsbootNvmePciSsd": MoMeta("LsbootNvmePciSsd", "lsbootNvmePciSsd", "nvme-pci-ssd", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"], [u'lsbootNvme'], [], ["Get", "Set"]),
    ...
    "LsbootUsbExternalImage": MoMeta("LsbootUsbExternalImage", "lsbootUsbExternalImage", "usb-extern", VersionMeta.Version221b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"], [u'lsbootLocalStorage'], [u'lsbootUEFIBootParam'], ["Add", "Get", "Remove", "Set"]),
    "LsbootUsbFlashStorageImage": MoMeta("LsbootUsbFlashStorageImage", "lsbootUsbFlashStorageImage", "sd-card", VersionMeta.Version221b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"], [u'lsbootLocalStorage'], [u'lsbootUEFIBootParam'], ["Add", "Get", "Remove", "Set"]),
    "LsbootUsbInternalImage": MoMeta("LsbootUsbInternalImage", "lsbootUsbInternalImage", "usb-intern", VersionMeta.Version221b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"], [u'lsbootLocalStorage'], [u'lsbootUEFIBootParam'], ["Add", "Get", "Remove", "Set"]),
    ...
    "LstorageControllerDef": MoMeta("LstorageControllerDef", "lstorageControllerDef", "controller-def-[name]", VersionMeta.Version227b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'lstorageProfile', u'lstorageProfileDef', u'storageController'], [u'lstorageControllerModeConfig', u'lstorageControllerQualifier'], ["Add", "Get", "Remove"]),
    "LstorageControllerModeConfig": MoMeta("LstorageControllerModeConfig", "lstorageControllerModeConfig", "controller-mode-config", VersionMeta.Version227b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'lstorageControllerDef'], [], ["Add", "Get", "Remove", "Set"]),
    ...
    "LstorageControllerRef": MoMeta("LstorageControllerRef", "lstorageControllerRef", "server-[server_id]-controller-[controller_type]-[controller_id]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'lstorageDiskSlot'], [], ["Add", "Get", "Remove"]),
    "LstorageDasScsiLun": MoMeta("LstorageDasScsiLun", "lstorageDasScsiLun", "das-scsi-lun-[name]", VersionMeta.Version224b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-storage", "ls-storage-policy"], [u'lstorageProfile', u'lstorageProfileDef'], [u'faultInst', u'storageLocalDiskConfigDef'], ["Add", "Get", "Remove", "Set"]),
    ...
    "LstorageDiskSlot": MoMeta("LstorageDiskSlot", "lstorageDiskSlot", "disk-slot-[id]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'lstorageDiskZoningConfigDef', u'lstorageDiskZoningPolicy'], [u'lstorageControllerRef'], ["Add", "Get", "Remove", "Set"]),
    "LstorageDiskZoningConfigDef": MoMeta("LstorageDiskZoningConfigDef", "lstorageDiskZoningConfigDef", "disk-zoning-def", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'equipmentChassisProfile'], [u'lstorageDiskSlot'], ["Add", "Get", "Remove", "Set"]),
    "LstorageDiskZoningPolicy": MoMeta("LstorageDiskZoningPolicy", "lstorageDiskZoningPolicy", "disk-zoning-policy-[name]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'orgOrg'], [u'lstorageDiskSlot'], ["Add", "Get", "Remove", "Set"]),
    "LstorageDriveSecurity": MoMeta("LstorageDriveSecurity", "lstorageDriveSecurity", "drive", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'lstorageSecurity'], [u'lstorageLocal', u'lstorageRemote'], ["Get"]),
    "LstorageLocal": MoMeta("LstorageLocal", "lstorageLocal", "local", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'computeBoard', u'lstorageDriveSecurity'], [], ["Get", "Set"]),
    "LstorageLocalDef": MoMeta("LstorageLocalDef", "lstorageLocalDef", "local-def", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'computeBoard'], [], ["Get"]),
    "LstorageLocalDiskConfigRef": MoMeta("LstorageLocalDiskConfigRef", "lstorageLocalDiskConfigRef", "slot-[slot_num]", VersionMeta.Version224b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'lstorageDiskGroupConfigDef', u'lstorageDiskGroupConfigPolicy'], [], ["Add", "Get", "Remove", "Set"]),
    ...
    "LstorageLogin": MoMeta("LstorageLogin", "lstorageLogin", "login", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'lstorageRemote', u'lstorageRemoteDef'], [], ["Get", "Set"]),
    "LstorageLunSetConfig": MoMeta("LstorageLunSetConfig", "lstorageLunSetConfig", "lun-set-config-[name]", VersionMeta.Version402a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-storage", "ls-storage-policy"], [u'lstorageProfile', u'lstorageProfileDef'], [u'lstorageLunSetDiskSlot', u'lstorageVirtualDriveDef'], [None]),
    "LstorageLunSetDiskSlot": MoMeta("LstorageLunSetDiskSlot", "lstorageLunSetDiskSlot", "lun-set-disk-slot-[id]", VersionMeta.Version402a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-storage", "ls-storage-policy"], [u'lstorageLunSetConfig'], [], [None]),
    "LstorageProfile": MoMeta("LstorageProfile", "lstorageProfile", "profile-[name]", VersionMeta.Version224b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-storage", "ls-storage-policy"], [u'orgOrg'], [u'lstorageControllerDef', u'lstorageDasScsiLun', u'lstorageLunSetConfig', u'lstorageSecurity'], ["Add", "Get", "Remove", "Set"]),
    "LstorageProfileBinding": MoMeta("LstorageProfileBinding", "lstorageProfileBinding", "profile-binding", VersionMeta.Version224b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'lsServer'], [u'faultInst'], ["Add", "Get", "Remove", "Set"]),
    "LstorageProfileDef": MoMeta("LstorageProfileDef", "lstorageProfileDef", "profile-def", VersionMeta.Version224b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-storage", "ls-storage-policy"], [u'lsServer'], [u'lstorageControllerDef', u'lstorageDasScsiLun', u'lstorageLunSetConfig', u'lstorageSecurity'], ["Add", "Get", "Remove", "Set"]),
    "LstorageRemote": MoMeta("LstorageRemote", "lstorageRemote", "remote", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'computeBoard', u'lstorageDriveSecurity'], [u'lstorageLogin'], ["Get", "Set"]),
    "LstorageRemoteDef": MoMeta("LstorageRemoteDef", "lstorageRemoteDef", "remote-def", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'computeBoard'], [u'lstorageLogin'], ["Get"]),
    "LstorageSasExpanderConfigPolicy": MoMeta("LstorageSasExpanderConfigPolicy", "lstorageSasExpanderConfigPolicy", "sas-expander-config-policy-[name]", VersionMeta.Version323a, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'orgOrg'], [], [None]),
    "LstorageSecurity": MoMeta("LstorageSecurity", "lstorageSecurity", "security", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'lstorageProfile', u'lstorageProfileDef', u'storageLocalDiskConfigDef', u'storageLocalDiskConfigPolicy'], [u'lstorageDriveSecurity'], ["Get", "Set"]),
    "LstorageVirtualDriveDef": MoMeta("LstorageVirtualDriveDef", "lstorageVirtualDriveDef", "virtual-drive-def", VersionMeta.Version224b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'lstorageDiskGroupConfigDef', u'lstorageDiskGroupConfigPolicy', u'lstorageLunSetConfig'], [], ["Get", "Set"]),
    ...
    "MemoryArray": MoMeta("MemoryArray", "memoryArray", "memarray-[id]", VersionMeta.Version101e, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'computeBoard'], [u'faultInst', u'memoryArrayEnvStats', u'memoryPersistentMemoryUnit', u'memoryUnit'], ["Get"]),
    ...
    "MemoryErrorStats": MoMeta("MemoryErrorStats", "memoryErrorStats", "error-stats", VersionMeta.Version131c, "OutputOnly", 0x1, [], ["admin", "operations", "read-only"], [u'memoryPersistentMemoryUnit', u'memoryUnit'], [], ["Get"]),
    "MemoryPersistentMemoryConfigResult": MoMeta("MemoryPersistentMemoryConfigResult", "memoryPersistentMemoryConfigResult", "cfg-result", VersionMeta.Version404a, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'memoryPersistentMemoryConfiguration'], [u'faultInst', u'memoryPersistentMemoryNamespaceConfigResult'], [None]),
    "MemoryPersistentMemoryConfiguration": MoMeta("MemoryPersistentMemoryConfiguration", "memoryPersistentMemoryConfiguration", "pmemory-config", VersionMeta.Version404a, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'computeBoard', u'lsServer'], [u'faultInst', u'memoryPersistentMemoryConfigResult', u'memoryPersistentMemoryRegion'], [None]),
    "MemoryPersistentMemoryGoal": MoMeta("MemoryPersistentMemoryGoal", "memoryPersistentMemoryGoal", "goal-[socket_id]", VersionMeta.Version404a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-storage"], [u'memoryPersistentMemoryPolicy'], [], [None]),
    "MemoryPersistentMemoryLocalSecurity": MoMeta("MemoryPersistentMemoryLocalSecurity", "memoryPersistentMemoryLocalSecurity", "local", VersionMeta.Version404a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server"], [u'memoryPersistentMemorySecurity'], [], [None]),
    "MemoryPersistentMemoryLogicalNamespace": MoMeta("MemoryPersistentMemoryLogicalNamespace", "memoryPersistentMemoryLogicalNamespace", "lns-[name]", VersionMeta.Version404a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-storage"], [u'memoryPersistentMemoryPolicy'], [], [None]),
    "MemoryPersistentMemoryNamespace": MoMeta("MemoryPersistentMemoryNamespace", "memoryPersistentMemoryNamespace", "ns-[uuid]", VersionMeta.Version404a, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'memoryPersistentMemoryRegion'], [u'faultInst'], [None]),
    "MemoryPersistentMemoryNamespaceConfigResult": MoMeta("MemoryPersistentMemoryNamespaceConfigResult", "memoryPersistentMemoryNamespaceConfigResult", "nscr-[name]", VersionMeta.Version404a, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'memoryPersistentMemoryConfigResult'], [u'faultInst'], [None]),
    "MemoryPersistentMemoryPolicy": MoMeta("MemoryPersistentMemoryPolicy", "memoryPersistentMemoryPolicy", "pmemory-policy-[name]", VersionMeta.Version404a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-storage"], [u'orgOrg'], [u'memoryPersistentMemoryGoal', u'memoryPersistentMemoryLogicalNamespace', u'memoryPersistentMemorySecurity'], [None]),
    "MemoryPersistentMemoryRegion": MoMeta("MemoryPersistentMemoryRegion", "memoryPersistentMemoryRegion", "region-[id]", VersionMeta.Version404a, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'memoryPersistentMemoryConfiguration'], [u'memoryPersistentMemoryNamespace'], [None]),
    "MemoryPersistentMemorySecurity": MoMeta("MemoryPersistentMemorySecurity", "memoryPersistentMemorySecurity", "security", VersionMeta.Version404a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server"], [u'memoryPersistentMemoryPolicy'], [u'memoryPersistentMemoryLocalSecurity'], [None]),
    "MemoryPersistentMemoryUnit": MoMeta("MemoryPersistentMemoryUnit", "memoryPersistentMemoryUnit", "pmemory-[id]", VersionMeta.Version404a, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'memoryArray'], [u'faultInst', u'firmwareBootDefinition', u'firmwareRunning', u'memoryErrorStats', u'memoryUnitEnvStats'], [None]),
    ...
    "MemoryUnit": MoMeta("MemoryUnit", "memoryUnit", "mem-[id]", VersionMeta.Version101e, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'memoryArray'], [u'equipmentInventoryStatus', u'faultInst', u'memoryErrorStats', u'memoryUnitEnvStats'], ["Get"]),
    "MemoryUnitEnvStats": MoMeta("MemoryUnitEnvStats", "memoryUnitEnvStats", "dimm-env-stats", VersionMeta.Version111j, "OutputOnly", 0x1, [], ["admin", "operations", "read-only"], [u'memoryPersistentMemoryUnit', u'memoryUnit'], [u'memoryUnitEnvStatsHist'], ["Get"]),
    ...
    "MgmtCmcSecureBoot": MoMeta("MgmtCmcSecureBoot", "mgmtCmcSecureBoot", "mgmt-cmc-secure-boot", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "ls-compute"], [u'mgmtController'], [], ["Get", "Set"]),
    ...
    "MgmtDbState": MoMeta("MgmtDbState", "mgmtDbState", "mgmt-db-state", VersionMeta.Version321d, "InputOutput", 0x1, [], ["read-only"], [u'networkElement'], [u'faultInst'], ["Get", "Set"]),
    ...
    "MgmtHealthAttr": MoMeta("MgmtHealthAttr", "mgmtHealthAttr", "[name]", VersionMeta.Version311e, "InputOutput", 0x1, [], ["read-only"], [u'mgmtHealthStatus'], [], ["Get"]),
    "MgmtHealthStatus": MoMeta("MgmtHealthStatus", "mgmtHealthStatus", "health", VersionMeta.Version311e, "InputOutput", 0x1, [], ["read-only"], [u'mgmtController', u'networkElement'], [u'faultInst', u'mgmtHealthAttr'], ["Get"]),
    ...
    "MgmtKmip": MoMeta("MgmtKmip", "mgmtKmip", "kmip", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'mgmtSecurity'], [], ["Get", "Set"]),
    "MgmtKmipCertPolicy": MoMeta("MgmtKmipCertPolicy", "mgmtKmipCertPolicy", "kmip-cert", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-oper", "ls-server-policy", "read-only"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit', u'pkiEp'], [], ["Get", "Set"]),
    "MgmtKvmCertificate": MoMeta("MgmtKvmCertificate", "mgmtKvmCertificate", "cert", VersionMeta.Version323a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-network", "ls-server", "ls-server-oper"], [u'computeKvmMgmtPolicy', u'mgmtController'], [u'faultInst'], [None]),
    "MgmtLeaderEntity": MoMeta("MgmtLeaderEntity", "mgmtLeaderEntity", "leader-entity", VersionMeta.Version401a, "InputOutput", 0x1, [], ["read-only"], [u'fabricLanCloud', u'fabricSanCloud'], [], [None]),
    ...
    "MgmtSecurity": MoMeta("MgmtSecurity", "mgmtSecurity", "sec", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit'], [u'mgmtKmip'], ["Get"]),
    "MgmtUsbNicMgmtIf": MoMeta("MgmtUsbNicMgmtIf", "mgmtUsbNicMgmtIf", "usbnic-if-[usbnic_conn_side]-[switch_id]", VersionMeta.Version323a, "InputOutput", 0x1, [], ["admin"], [u'computeHostUtilityOs', u'mgmtController'], [], ["Get"]),
    ...
    "MoInvKv": MoMeta("MoInvKv", "moInvKv", "kv-[key]", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin", "read-only"], [u'moKvInvHolder'], [], ["Get", "Set"]),
    "MoIpV4AddrKv": MoMeta("MoIpV4AddrKv", "moIpV4AddrKv", "kv-[key]", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin", "read-only"], [u'moKvCfgHolder'], [u'faultInst'], ["Get", "Set"]),
    "MoIpV6AddrKv": MoMeta("MoIpV6AddrKv", "moIpV6AddrKv", "kv-[key]", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin", "read-only"], [u'moKvCfgHolder'], [u'faultInst'], ["Get", "Set"]),
    "MoKv": MoMeta("MoKv", "moKv", "kv-[key]", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin", "read-only"], [u'moKvCfgHolder'], [], ["Get", "Set"]),
    "MoKvCfgHolder": MoMeta("MoKvCfgHolder", "moKvCfgHolder", "cfg-kv", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit', u'lsServer', u'orgOrg'], [u'moIpV4AddrKv', u'moIpV6AddrKv', u'moKv', u'moVnicKv'], ["Get", "Set"]),
    "MoKvInvHolder": MoMeta("MoKvInvHolder", "moKvInvHolder", "inv-kv-[endpoint]", VersionMeta.Version321d, "InputOutput", 0x1, [], ["read-only"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit'], [u'moInvKv'], [None]),
    "MoVnicKv": MoMeta("MoVnicKv", "moVnicKv", "kv-[key]", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin", "read-only"], [u'moKvCfgHolder'], [], ["Get", "Set"]),
    "MorefFruRef": MoMeta("MorefFruRef", "morefFruRef", "[class_name]-vendor-[vendor]-model-[model]-serial-[serial]", VersionMeta.Version227b, "InputOutput", 0x1, [], ["admin"], [u'morefImportRoot'], [u'morefProp', u'morefRef'], ["Add", "Get", "Remove"]),
    "MorefImportRoot": MoMeta("MorefImportRoot", "morefImportRoot", "import-ref-root", VersionMeta.Version227b, "InputOutput", 0x1, [], ["admin"], [u'topRoot'], [u'eventInst', u'faultInst', u'morefFruRef', u'morefImportRootFsm', u'morefImportRootFsmTask', u'morefRef'], ["Add", "Get", "Remove"]),
    ...
    "MorefProp": MoMeta("MorefProp", "morefProp", "[name]", VersionMeta.Version227b, "InputOutput", 0x1, [], ["admin"], [u'morefFruRef', u'morefRef'], [], ["Add", "Get", "Remove", "Set"]),
    "MorefRef": MoMeta("MorefRef", "morefRef", "[mo_rn]", VersionMeta.Version227b, "InputOutput", 0x1, [], ["admin"], [u'morefFruRef', u'morefImportRoot', u'morefRef'], [u'morefProp', u'morefRef'], ["Add", "Get", "Remove"]),
    ...
    "NetworkLimit": MoMeta("NetworkLimit", "networkLimit", "limit-type-[type]-asic-[asic_number]", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin"], [u'networkElement'], [u'faultInst'], [None]),
    "NetworkLldpNeighborEntry": MoMeta("NetworkLldpNeighborEntry", "networkLldpNeighborEntry", "if-[local_interface]", VersionMeta.Version224b, "InputOutput", 0x1, [], ["read-only"], [u'networkLldpNeighbors'], [], ["Get"]),
    "NetworkLldpNeighbors": MoMeta("NetworkLldpNeighbors", "networkLldpNeighbors", "lldp-neighbors", VersionMeta.Version224b, "InputOutput", 0x1, [], ["read-only"], [u'networkElement'], [u'networkLldpNeighborEntry'], ["Get"]),
    ...
    "OsARPLinkMonitoringPolicy": MoMeta("OsARPLinkMonitoringPolicy", "osARPLinkMonitoringPolicy", "link-mon-pol", VersionMeta.Version302c, "InputOutput", 0x1, [], ["read-only"], [u'osEthBondIntf'], [u'osARPTarget'], [None]),
    "OsARPTarget": MoMeta("OsARPTarget", "osARPTarget", "arp-target-[name]", VersionMeta.Version302c, "InputOutput", 0x1, [], ["read-only"], [u'osARPLinkMonitoringPolicy'], [], [None]),
    ...
    "OsEthBondModeActiveBackup": MoMeta("OsEthBondModeActiveBackup", "osEthBondModeActiveBackup", "eth-bond-mode", VersionMeta.Version302c, "InputOutput", 0x1, [], ["read-only"], [u'osEthBondIntf'], [u'osPrimarySlave'], [None]),
    "OsEthBondModeBalancedALB": MoMeta("OsEthBondModeBalancedALB", "osEthBondModeBalancedALB", "eth-bond-mode", VersionMeta.Version302c, "InputOutput", 0x1, [], ["read-only"], [u'osEthBondIntf'], [u'osPrimarySlave'], [None]),
    "OsEthBondModeBalancedRR": MoMeta("OsEthBondModeBalancedRR", "osEthBondModeBalancedRR", "eth-bond-mode", VersionMeta.Version302c, "InputOutput", 0x1, [], ["read-only"], [u'osEthBondIntf'], [u'osPrimarySlave'], [None]),
    "OsEthBondModeBalancedTLB": MoMeta("OsEthBondModeBalancedTLB", "osEthBondModeBalancedTLB", "eth-bond-mode", VersionMeta.Version302c, "InputOutput", 0x1, [], ["read-only"], [u'osEthBondIntf'], [u'osPrimarySlave'], [None]),
    "OsEthBondModeBalancedXOR": MoMeta("OsEthBondModeBalancedXOR", "osEthBondModeBalancedXOR", "eth-bond-mode", VersionMeta.Version302c, "InputOutput", 0x1, [], ["read-only"], [u'osEthBondIntf'], [u'osPrimarySlave'], [None]),
    "OsEthBondModeBroadcast": MoMeta("OsEthBondModeBroadcast", "osEthBondModeBroadcast", "eth-bond-mode", VersionMeta.Version302c, "InputOutput", 0x1, [], ["read-only"], [u'osEthBondIntf'], [u'osPrimarySlave'], [None]),
    "OsEthIntf": MoMeta("OsEthIntf", "osEthIntf", "intf-[name]", VersionMeta.Version302c, "InputOutput", 0x1, [], ["read-only"], [u'osEthBondIntf', u'osInstance'], [], [None]),
    ...
    "OsMiiLinkMonitoringPolicy": MoMeta("OsMiiLinkMonitoringPolicy", "osMiiLinkMonitoringPolicy", "link-mon-pol", VersionMeta.Version302c, "InputOutput", 0x1, [], ["read-only"], [u'osEthBondIntf'], [], [None]),
    "OsPrimarySlave": MoMeta("OsPrimarySlave", "osPrimarySlave", "slave-intf-[name]", VersionMeta.Version302c, "InputOutput", 0x1, [], ["read-only"], [u'osEthBondModeActiveBackup', u'osEthBondModeBalancedALB', u'osEthBondModeBalancedRR', u'osEthBondModeBalancedTLB', u'osEthBondModeBalancedXOR', u'osEthBondModeBroadcast'], [], [None]),
    ...
    "PciLink": MoMeta("PciLink", "pciLink", "pci-link-[pci_slot]", VersionMeta.Version402a, "InputOutput", 0x1, [], ["read-only"], [u'pciSwitch'], [], [None]),
    "PciSwitch": MoMeta("PciSwitch", "pciSwitch", "pci-switch-[id]", VersionMeta.Version402a, "InputOutput", 0x1, [], ["read-only"], [u'computeBoard'], [u'faultInst', u'firmwareBootDefinition', u'firmwareRunning', u'pciLink'], [None]),
    ...
    "PkiEp": MoMeta("PkiEp", "pkiEp", "pki-ext", VersionMeta.Version101e, "InputOutput", 0x1, [], ["read-only"], [u'topSystem'], [u'eventInst', u'faultInst', u'mgmtKmipCertPolicy', u'pkiEpFsm', u'pkiEpFsmTask', u'pkiKeyRing', u'pkiTP'], ["Get"]),
    ...
    "PolicyChildClass": MoMeta("PolicyChildClass", "policyChildClass", "child-[name]", VersionMeta.Version321d, "InputOutput", 0x1, [], ["read-only"], [u'policyDestClass'], [], [None]),
    ...
    "PolicyConfigError": MoMeta("PolicyConfigError", "policyConfigError", "policy-error", VersionMeta.Version321d, "InputOutput", 0x1, [], ["read-only"], [u'policyPolicyScopeCont'], [], [None]),
    "PolicyContext": MoMeta("PolicyContext", "policyContext", "context-[name]", VersionMeta.Version321d, "InputOutput", 0x1, [], ["read-only"], [u'policySourceApp'], [u'policyScope'], [None]),
    ...
    "PolicyDestClass": MoMeta("PolicyDestClass", "policyDestClass", "dest-[name]", VersionMeta.Version321d, "InputOutput", 0x1, [], ["read-only"], [u'policyDestEp', u'policyPolicyDestClass'], [u'policyChildClass'], [None]),
    "PolicyDestEp": MoMeta("PolicyDestEp", "policyDestEp", "dest-ep", VersionMeta.Version321d, "InputOutput", 0x1, [], ["read-only"], [u'policyControlEp'], [u'policyDestClass'], [None]),
    ...
    "PolicyEquipment": MoMeta("PolicyEquipment", "policyEquipment", "equipment-ctrl", VersionMeta.Version227b, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-policy"], [u'policyControlEp'], [u'policyControlledInstance', u'policyControlledType'], ["Get", "Set"]),
    ...
    "PolicyPolicyDestClass": MoMeta("PolicyPolicyDestClass", "policyPolicyDestClass", "destclass", VersionMeta.Version321d, "InputOutput", 0x1, [], ["read-only"], [u'policyScope'], [u'policyDestClass'], [None]),
    ...
    "PolicyPolicyScopeCont": MoMeta("PolicyPolicyScopeCont", "policyPolicyScopeCont", "scope-cont-[app_type]", VersionMeta.Version211a, "InputOutput", 0x1, [], ["admin"], [u'extpolClient', u'extpolController', u'extpolProvider', u'extpolRegistry', u'policyPolicyEp'], [u'eventInst', u'faultInst', u'policyConfigError', u'policyPolicyScopeContFsm', u'policyPolicyScopeContFsmTask', u'policyPolicyScopeContext'], [None]),
    "PolicyPolicyScopeContFsm": MoMeta("PolicyPolicyScopeContFsm", "policyPolicyScopeContFsm", "fsm", VersionMeta.Version321d, "OutputOnly", 0x1, [], [""], [u'policyPolicyScopeCont'], [u'policyPolicyScopeContFsmStage'], [None]),
    "PolicyPolicyScopeContFsmStage": MoMeta("PolicyPolicyScopeContFsmStage", "policyPolicyScopeContFsmStage", "stage-[name]", VersionMeta.Version321d, "OutputOnly", 0x1, [], [""], [u'policyPolicyScopeContFsm'], [], [None]),
    "PolicyPolicyScopeContFsmTask": MoMeta("PolicyPolicyScopeContFsmTask", "policyPolicyScopeContFsmTask", "task-[item]", VersionMeta.Version321d, "OutputOnly", 0x1, [], [""], [u'policyPolicyScopeCont'], [], [None]),
    ...
    "PolicyPortConfig": MoMeta("PolicyPortConfig", "policyPortConfig", "portconfig-ctrl", VersionMeta.Version227b, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-policy"], [u'policyControlEp'], [u'policyControlledInstance', u'policyControlledType'], ["Get", "Set"]),
    ...
    "PolicyRequestor": MoMeta("PolicyRequestor", "policyRequestor", "requestor-[name]", VersionMeta.Version321d, "InputOutput", 0x1, [], ["read-only"], [u'policyScope'], [u'eventInst', u'faultInst', u'policyRequestorFsm', u'policyRequestorFsmTask'], [None]),
    "PolicyRequestorFsm": MoMeta("PolicyRequestorFsm", "policyRequestorFsm", "fsm", VersionMeta.Version321d, "OutputOnly", 0x1, [], [""], [u'policyRequestor'], [u'policyRequestorFsmStage'], [None]),
    "PolicyRequestorFsmStage": MoMeta("PolicyRequestorFsmStage", "policyRequestorFsmStage", "stage-[name]", VersionMeta.Version321d, "OutputOnly", 0x1, [], [""], [u'policyRequestorFsm'], [], [None]),
    "PolicyRequestorFsmTask": MoMeta("PolicyRequestorFsmTask", "policyRequestorFsmTask", "task-[item]", VersionMeta.Version321d, "OutputOnly", 0x1, [], [""], [u'policyRequestor'], [], [None]),
    "PolicyScope": MoMeta("PolicyScope", "policyScope", "scope-[policy_type]-[resolve_type]-[policy_name]", VersionMeta.Version321d, "InputOutput", 0x1, [], ["read-only"], [u'policyContext'], [u'policyPolicyDestClass', u'policyRequestor'], [None]),
    ...
    "PolicySourceApp": MoMeta("PolicySourceApp", "policySourceApp", "source-[source_dme]", VersionMeta.Version321d, "InputOutput", 0x1, [], ["read-only"], [u'policyControlEp'], [u'policyContext'], [None]),
    "PolicyStorageAutoConfig": MoMeta("PolicyStorageAutoConfig", "policyStorageAutoConfig", "storage-autoconfig-ctrl", VersionMeta.Version302c, "InputOutput", 0x1, [], ["admin", "ls-storage", "pn-policy"], [u'policyControlEp'], [u'policyControlledInstance', u'policyControlledType'], [None]),
    "PolicySystemEp": MoMeta("PolicySystemEp", "policySystemEp", "system-policies", VersionMeta.Version302c, "InputOutput", 0x1, [], ["read-only"], [u'policyPolicyEp'], [u'adaptorHostEthIfProfile', u'lsbootPolicy', u'nwctrlDefinition', u'powerPolicy', u'solPolicy'], [None]),
    ...
    "PortSubGroup": MoMeta("PortSubGroup", "portSubGroup", "aggr-port-[aggr_port_id]", VersionMeta.Version302c, "InputOutput", 0x1, [], ["read-only"], [u'portGroup'], [u'etherPIo', u'fcPIo'], [None]),
    ...
    "PowerFIMember": MoMeta("PowerFIMember", "powerFIMember", "fi-member-[id]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "power-mgmt", "read-only"], [u'powerGroup'], [], ["Add", "Get", "Remove", "Set"]),
    "PowerFexMember": MoMeta("PowerFexMember", "powerFexMember", "fex-member-[id]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "power-mgmt", "read-only"], [u'powerGroup'], [], ["Add", "Get", "Remove"]),
    ...
    "PowerProfiledPower": MoMeta("PowerProfiledPower", "powerProfiledPower", "prof-power", VersionMeta.Version302c, "InputOutput", 0x1, [], ["admin", "power-mgmt"], [u'powerBudget'], [], ["Get"]),
    ...
    "ProcessorUnit": MoMeta("ProcessorUnit", "processorUnit", "cpu-[id]", VersionMeta.Version101e, "InputOutput", 0x1, [], ["read-only"], [u'computeBoard'], [u'equipmentInventoryStatus', u'faultInst', u'processorCore', u'processorEnvStats', u'processorErrorStats'], ["Get"]),
    ...
    "QosclassSlowDrain": MoMeta("QosclassSlowDrain", "qosclassSlowDrain", "slow-drain", VersionMeta.Version402a, "InputOutput", 0x1, [], ["admin", "ext-lan-qos", "ext-san-qos"], [u'qosclassDefinition'], [u'eventInst', u'faultInst', u'qosclassSlowDrainFsm', u'qosclassSlowDrainFsmTask'], [None]),
    "QosclassSlowDrainFsm": MoMeta("QosclassSlowDrainFsm", "qosclassSlowDrainFsm", "fsm", VersionMeta.Version402a, "OutputOnly", 0x1, [], [""], [u'qosclassSlowDrain'], [u'qosclassSlowDrainFsmStage'], [None]),
    "QosclassSlowDrainFsmStage": MoMeta("QosclassSlowDrainFsmStage", "qosclassSlowDrainFsmStage", "stage-[name]", VersionMeta.Version402a, "OutputOnly", 0x1, [], [""], [u'qosclassSlowDrainFsm'], [], [None]),
    "QosclassSlowDrainFsmTask": MoMeta("QosclassSlowDrainFsmTask", "qosclassSlowDrainFsmTask", "task-[item]", VersionMeta.Version402a, "OutputOnly", 0x1, [], [""], [u'qosclassSlowDrain'], [], [None]),
    ...
    "SecurityUnit": MoMeta("SecurityUnit", "securityUnit", "security-unit-[id]", VersionMeta.Version227b, "InputOutput", 0x1, [], ["read-only"], [u'computeBoard'], [u'equipmentInventoryStatus'], ["Get"]),
    "SesDiskSlotEp": MoMeta("SesDiskSlotEp", "sesDiskSlotEp", "disk-slot-ep-[enc_id]-id-[id]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["read-only"], [u'sesEnclosure'], [], ["Get"]),
    "SesEnclosure": MoMeta("SesEnclosure", "sesEnclosure", "ses-enc-[id]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["read-only"], [u'equipmentChassis'], [u'sesDiskSlotEp'], ["Get"]),
    ...
    "StorageController": MoMeta("StorageController", "storageController", "storage-[type]-[id]", VersionMeta.Version101e, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-storage"], [u'computeBoard', u'equipmentChassis'], [u'equipmentInventoryStatus', u'faultInst', u'firmwareBootDefinition', u'firmwareRunning', u'lstorageControllerDef', u'mgmtController', u'storageDrive', u'storageEmbeddedStorage', u'storageEnclosure', u'storageLocalDisk', u'storageLocalDiskConfigDef', u'storageLocalDiskEp', u'storageLocalLun', u'storageMezzFlashLife', u'storageNvmeStats', u'storageNvmeStorage', u'storageOnboardDevice', u'storageOperation', u'storageRaidBattery', u'storageVirtualDrive', u'storageVirtualDriveEp'], ["Get"]),
    "StorageControllerEp": MoMeta("StorageControllerEp", "storageControllerEp", "controller-ep-[id]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["read-only"], [u'storageLocalDisk', u'storageVirtualDrive'], [], ["Get"]),
    "StorageControllerRef": MoMeta("StorageControllerRef", "storageControllerRef", "server-[server_id]-controller-[controller_type]-[controller_id]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["read-only"], [u'storageEnclosureDiskSlotEp'], [], ["Get"]),
    "StorageControllerReference": MoMeta("StorageControllerReference", "storageControllerReference", "controller-ref-[referenced_rn]", VersionMeta.Version321d, "InputOutput", 0x1, [], ["read-only"], [u'storageMiniStorage'], [], [None]),
    "StorageDiskEnvStats": MoMeta("StorageDiskEnvStats", "storageDiskEnvStats", "disk-env-stats", VersionMeta.Version302c, "OutputOnly", 0x1, [], ["admin", "operations", "read-only"], [u'storageLocalDisk'], [u'storageDiskEnvStatsHist'], [None]),
    "StorageDiskEnvStatsHist": MoMeta("StorageDiskEnvStatsHist", "storageDiskEnvStatsHist", "[id]", VersionMeta.Version302c, "OutputOnly", 0x1, [], ["read-only"], [u'storageDiskEnvStats'], [], [None]),
    ...
    "StorageEmbeddedStorage": MoMeta("StorageEmbeddedStorage", "storageEmbeddedStorage", "embedded-storage", VersionMeta.Version312b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-storage"], [u'storageController'], [], ["Get"]),
    ...
    "StorageEnclosureCap": MoMeta("StorageEnclosureCap", "storageEnclosureCap", "physical-holder-[type]", VersionMeta.Version312b, "InputOutput", 0x1, [], [""], [u'equipmentBladeCapProvider', u'equipmentChassisCapProvider', u'equipmentRackUnitCapProvider'], [], ["Get"]),
    "StorageEnclosureDiskSlotEp": MoMeta("StorageEnclosureDiskSlotEp", "storageEnclosureDiskSlotEp", "disk-slot-[id]", VersionMeta.Version302c, "InputOutput", 0x1, [], ["read-only"], [u'storageEnclosure'], [u'faultInst', u'storageControllerRef'], ["Get"]),
    "StorageEnclosureFsm": MoMeta("StorageEnclosureFsm", "storageEnclosureFsm", "fsm", VersionMeta.Version312b, "OutputOnly", 0x1, [], [""], [u'storageEnclosure'], [u'storageEnclosureFsmStage'], [None]),
    "StorageEnclosureFsmStage": MoMeta("StorageEnclosureFsmStage", "storageEnclosureFsmStage", "stage-[name]", VersionMeta.Version312b, "OutputOnly", 0x1, [], [""], [u'storageEnclosureFsm'], [], [None]),
    "StorageEnclosureFsmTask": MoMeta("StorageEnclosureFsmTask", "storageEnclosureFsmTask", "task-[item]", VersionMeta.Version312b, "OutputOnly", 0x1, [], [""], [u'storageEnclosure'], [], [None]),
    "StorageEnclosureLocalDiskConfig": MoMeta("StorageEnclosureLocalDiskConfig", "storageEnclosureLocalDiskConfig", "enc-disk-config-[id]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["read-only"], [], [u'storageSasPort'], [None]),
    ...
    "StorageHddMotherBoardTempStats": MoMeta("StorageHddMotherBoardTempStats", "storageHddMotherBoardTempStats", "hdd-mobo-temp-stats", VersionMeta.Version312b, "OutputOnly", 0x1, [], ["admin", "operations", "read-only"], [u'storageEnclosure'], [u'storageHddMotherBoardTempStatsHist'], ["Get"]),
    "StorageHddMotherBoardTempStatsHist": MoMeta("StorageHddMotherBoardTempStatsHist", "storageHddMotherBoardTempStatsHist", "[id]", VersionMeta.Version312b, "OutputOnly", 0x1, [], ["read-only"], [u'storageHddMotherBoardTempStats'], [], ["Get"]),
    ...
    "StorageLocalDiskConfigPolicy": MoMeta("StorageLocalDiskConfigPolicy", "storageLocalDiskConfigPolicy", "local-disk-config-[name]", VersionMeta.Version101e, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'orgOrg'], [u'lstorageSecurity', u'storageLocalDiskPartition'], ["Add", "Get", "Remove", "Set"]),
    "StorageLocalDiskEp": MoMeta("StorageLocalDiskEp", "storageLocalDiskEp", "disk-ep-[enc_id]-id-[id]", VersionMeta.Version302c, "InputOutput", 0x1, [], ["read-only"], [u'storageController'], [], ["Get"]),
    "StorageLocalDiskFsm": MoMeta("StorageLocalDiskFsm", "storageLocalDiskFsm", "fsm", VersionMeta.Version312b, "OutputOnly", 0x1, [], [""], [u'storageLocalDisk'], [u'storageLocalDiskFsmStage'], [None]),
    "StorageLocalDiskFsmStage": MoMeta("StorageLocalDiskFsmStage", "storageLocalDiskFsmStage", "stage-[name]", VersionMeta.Version312b, "OutputOnly", 0x1, [], [""], [u'storageLocalDiskFsm'], [], [None]),
    "StorageLocalDiskFsmTask": MoMeta("StorageLocalDiskFsmTask", "storageLocalDiskFsmTask", "task-[item]", VersionMeta.Version312b, "OutputOnly", 0x1, [], [""], [u'storageLocalDisk'], [], [None]),
    ...
    "StorageLunResourceSelectionLog": MoMeta("StorageLunResourceSelectionLog", "storageLunResourceSelectionLog", "selection-log-[order]", VersionMeta.Version224b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-storage"], [u'storageVirtualDriveRef'], [], [None]),
    ...
    "StorageMiniStorage": MoMeta("StorageMiniStorage", "storageMiniStorage", "mini-storage-[type]-[id]", VersionMeta.Version321d, "InputOutput", 0x1, [], ["read-only"], [u'computeBoard'], [u'equipmentInventoryStatus', u'storageControllerReference'], ["Get"]),
    ...
    "StorageNvmeStats": MoMeta("StorageNvmeStats", "storageNvmeStats", "nvme-stats", VersionMeta.Version312b, "OutputOnly", 0x1, [], ["admin", "operations", "read-only"], [u'storageController'], [u'storageNvmeStatsHist'], ["Get"]),
    "StorageNvmeStatsHist": MoMeta("StorageNvmeStatsHist", "storageNvmeStatsHist", "[id]", VersionMeta.Version312b, "OutputOnly", 0x1, [], ["read-only"], [u'storageNvmeStats'], [], ["Get"]),
    "StorageNvmeStorage": MoMeta("StorageNvmeStorage", "storageNvmeStorage", "nvme-storage", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-storage"], [u'storageController'], [], ["Get"]),
    "StorageNvmeSwitch": MoMeta("StorageNvmeSwitch", "storageNvmeSwitch", "nvme-switch-[id]", VersionMeta.Version323a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-storage"], [u'computeBoard'], [u'faultInst', u'firmwareBootDefinition', u'firmwareRunning'], [None]),
    ...
    "StorageSasExpander": MoMeta("StorageSasExpander", "storageSasExpander", "sas-expander-[id]", VersionMeta.Version226c, "InputOutput", 0x1, [], ["read-only"], [u'computeBoard', u'equipmentChassis'], [u'faultInst', u'firmwareBootDefinition', u'firmwareRunning', u'mgmtController', u'storageOnboardDevice', u'storageSasUpLink'], [None]),
    "StorageSasLinkDescriptor": MoMeta("StorageSasLinkDescriptor", "storageSasLinkDescriptor", "sas-link-desc-server-[server_id]-controller-[controller_type]-[controller_id]-id-[id]", VersionMeta.Version312b, "InputOutput", 0x1, [], [""], [u'equipmentChassisCapProvider'], [], ["Get"]),
    "StorageSasPort": MoMeta("StorageSasPort", "storageSasPort", "sas-port-[id]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["read-only"], [u'storageEnclosureLocalDiskConfig', u'storageLocalDisk'], [], ["Get"]),
    "StorageSasPortDescriptor": MoMeta("StorageSasPortDescriptor", "storageSasPortDescriptor", "sas-port-desc-[id]", VersionMeta.Version312b, "InputOutput", 0x1, [], [""], [u'equipmentChassisCapProvider'], [], ["Get"]),
    "StorageSasUpLink": MoMeta("StorageSasUpLink", "storageSasUpLink", "sas-uplink-server-[server_id]-controller-[controller_type]-[controller_id]-id-[id]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["read-only"], [u'storageSasExpander'], [], ["Get"]),
    "StorageScsiLunRef": MoMeta("StorageScsiLunRef", "storageScsiLunRef", "scsi-lun-ref-[id]", VersionMeta.Version224b, "InputOutput", 0x1, [], ["read-only"], [u'storageVirtualDrive'], [], [None]),
    "StorageSsdHealthStats": MoMeta("StorageSsdHealthStats", "storageSsdHealthStats", "ssd-health-stats-[id]", VersionMeta.Version321d, "OutputOnly", 0x1, [], ["admin", "operations", "read-only"], [u'storageLocalDisk'], [u'storageSsdHealthStatsHist'], ["Get"]),
    "StorageSsdHealthStatsHist": MoMeta("StorageSsdHealthStatsHist", "storageSsdHealthStatsHist", "[id]", VersionMeta.Version321d, "OutputOnly", 0x1, [], ["read-only"], [u'storageSsdHealthStats'], [], ["Get"]),
    ...
    "StorageVDMemberEp": MoMeta("StorageVDMemberEp", "storageVDMemberEp", "member-[id]", VersionMeta.Version224b, "InputOutput", 0x1, [], ["read-only"], [u'storageVirtualDrive'], [u'faultInst'], ["Get"]),
    ...
    "StorageVirtualDriveContainer": MoMeta("StorageVirtualDriveContainer", "storageVirtualDriveContainer", "vd-container-[id]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["read-only"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit', u'equipmentChassis'], [u'storageVirtualDrive'], ["Get"]),
    "StorageVirtualDriveEp": MoMeta("StorageVirtualDriveEp", "storageVirtualDriveEp", "vd-ep-[container_id]-id-[id]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["read-only"], [u'storageController'], [], ["Get"]),
    "StorageVirtualDriveRef": MoMeta("StorageVirtualDriveRef", "storageVirtualDriveRef", "vdrive-ref-[lun_item_name]", VersionMeta.Version224b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-storage"], [u'lsServer'], [u'lstorageDiskGroupConfigDef', u'storageLunResourceSelectionLog'], ["Get"]),
    ...
    "SwCmclan": MoMeta("SwCmclan", "swCmclan", "vlan-cmc[id]", VersionMeta.Version221b, "InputOutput", 0x1, [], ["read-only"], [u'dcxVc'], [u'fabricNetGroupRef'], [None]),
    ...
    "SwEtherPort": MoMeta("SwEtherPort", "swEtherPort", "slot-[slot_id]-aggrport-[aggr_port_id]-port-[port_id]", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin"], [u'swPortDiscover'], [], [None]),
    ...
    "SwFcEndpoint": MoMeta("SwFcEndpoint", "swFcEndpoint", "wwpn-[wwpn]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["read-only"], [u'swFcUserZone'], [], ["Get"]),
    ...
    "SwFcMon": MoMeta("SwFcMon", "swFcMon", "mon-[name]", VersionMeta.Version141i, "InputOutput", 0x1, [], ["read-only"], [u'swFcSanMon'], [u'dcxVc', u'eventInst', u'faultInst', u'swEthMonDestEp', u'swFcMonDestEp', u'swFcMonFsm', u'swFcMonFsmTask', u'swFcMonSrcEp', u'swFcSanPc', u'swFcoeSanPc', u'swSubGroup', u'swVlan', u'swVsan'], ["Get"]),
    ...
    "SwFcUserZone": MoMeta("SwFcUserZone", "swFcUserZone", "zone-[id]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["read-only"], [u'swFcUserZoneGroup'], [u'swFcEndpoint'], ["Get"]),
    "SwFcUserZoneGroup": MoMeta("SwFcUserZoneGroup", "swFcUserZoneGroup", "user-zone-group-[name]", VersionMeta.Version312b, "InputOutput", 0x1, [], ["read-only"], [u'swFcZoneSet'], [u'swFcUserZone'], ["Get"]),
    ...
    "SwPortDiscover": MoMeta("SwPortDiscover", "swPortDiscover", "discover", VersionMeta.Version321d, "InputOutput", 0x1, [], ["read-only"], [u'networkElement'], [u'eventInst', u'faultInst', u'swEtherPort', u'swPortDiscoverFsm', u'swPortDiscoverFsmTask'], [None]),
    "SwPortDiscoverFsm": MoMeta("SwPortDiscoverFsm", "swPortDiscoverFsm", "fsm", VersionMeta.Version321d, "OutputOnly", 0x1, [], [""], [u'swPortDiscover'], [u'swPortDiscoverFsmStage'], [None]),
    "SwPortDiscoverFsmStage": MoMeta("SwPortDiscoverFsmStage", "swPortDiscoverFsmStage", "stage-[name]", VersionMeta.Version321d, "OutputOnly", 0x1, [], [""], [u'swPortDiscoverFsm'], [], [None]),
    "SwPortDiscoverFsmTask": MoMeta("SwPortDiscoverFsmTask", "swPortDiscoverFsmTask", "task-[item]", VersionMeta.Version321d, "OutputOnly", 0x1, [], [""], [u'swPortDiscover'], [], [None]),
    ...
    "SwUlan": MoMeta("SwUlan", "swUlan", "vlan-[purpose]", VersionMeta.Version101e, "InputOutput", 0x1, [], ["read-only"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit', u'dcxVc', u'etherServerIntFIo', u'swAccessEp', u'swUtilityDomain'], [], ["Get"]),
    ...
    "SwVIFRef": MoMeta("SwVIFRef", "swVIFRef", "vifref-[id]", VersionMeta.Version311e, "InputOutput", 0x1, [], ["read-only"], [u'swVlanGroup'], [], ["Get"]),
    ...
    "SysdebugDiagnosticLog": MoMeta("SysdebugDiagnosticLog", "sysdebugDiagnosticLog", "diag-log-[name]-[switch_id]", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin", "operations"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit', u'sysdebugDiagnosticLogRepository'], [], ["Get", "Set"]),
    "SysdebugDiagnosticLogRepository": MoMeta("SysdebugDiagnosticLogRepository", "sysdebugDiagnosticLogRepository", "diag-log-files", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin", "operations"], [u'topSystem'], [u'sysdebugDiagnosticLog'], [None]),
    ...
    "TopInfoSyncPolicy": MoMeta("TopInfoSyncPolicy", "topInfoSyncPolicy", "info-sync-policy", VersionMeta.Version227b, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-san-config"], [u'orgOrg'], [], ["Get"]),
    ...
    "VnicEthConfig": MoMeta("VnicEthConfig", "vnicEthConfig", "eth-vnic", VersionMeta.Version302c, "InputOutput", 0x1, [], ["admin", "ls-config", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"], [u'vnicIScsiInitAutoConfigPolicy'], [u'faultInst'], [None]),
    ...
    "VnicFc": MoMeta("VnicFc", "vnicFc", "fc-[name]", VersionMeta.Version101e, "InputOutput", 0x1, [], ["admin", "ls-config", "ls-server", "ls-storage"], [u'lsServer', u'vnicSanConnPolicy'], [u'fabricEthMonSrcEp', u'fabricFcMonSrcEp', u'fabricNetflowMonSrcEp', u'fabricSanGroupRef', u'faultInst', u'vnicBootTarget', u'vnicFcIf', u'vnicWwpnHistory'], ["Add", "Get", "Remove", "Set"]),
    ...
    "VnicIPv6If": MoMeta("VnicIPv6If", "vnicIPv6If", "", VersionMeta.Version302c, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-network", "ls-server", "ls-storage"], [], [u'vnicIpV6StaticAddr'], [None]),
    ...
    "VnicIScsiConfig": MoMeta("VnicIScsiConfig", "vnicIScsiConfig", "iscsi-vnic", VersionMeta.Version302c, "InputOutput", 0x1, [], ["admin", "ls-config", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"], [u'vnicIScsiInitAutoConfigPolicy'], [u'faultInst'], [None]),
    "VnicIScsiInitAutoConfigPolicy": MoMeta("VnicIScsiInitAutoConfigPolicy", "vnicIScsiInitAutoConfigPolicy", "iscsi-init-autoconf-[name]", VersionMeta.Version302c, "InputOutput", 0x1, [], ["admin", "ls-config", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"], [u'orgOrg'], [u'vnicEthConfig', u'vnicIScsiConfig'], [None]),
    ...
    "VnicIpV4MgmtPooledAddr": MoMeta("VnicIpV4MgmtPooledAddr", "vnicIpV4MgmtPooledAddr", "ipv4-pooled-addr", VersionMeta.Version221b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-network", "ls-server"], [u'adaptorHostIscsiIf', u'adaptorVlan', u'lsServer', u'mgmtVnet', u'vnicIPv4If'], [u'faultInst', u'vnicIpV4History'], ["Add", "Get", "Remove", "Set"]),
    ...
    "VnicProfile": MoMeta("VnicProfile", "vnicProfile", "vnic-[name]", VersionMeta.Version101e, "InputOutput", 0x1, [], ["admin", "ls-network", "ls-network-policy"], [u'vnicProfileSet'], [u'fabricNetGroupRef', u'fabricNetflowMonSrcEp', u'faultInst', u'swNetflowMonitorRef', u'vmVnicProfCl', u'vnicEtherIf', u'vnicOProfileAlias', u'vnicProfileAlias'], ["Add", "Get", "Remove", "Set"]),
    ...
    "VnicSanConnTempl": MoMeta("VnicSanConnTempl", "vnicSanConnTempl", "san-conn-templ-[name]", VersionMeta.Version101e, "InputOutput", 0x1, [], ["admin", "ls-storage", "ls-storage-policy"], [u'orgOrg'], [u'fabricNetGroupRef', u'fabricSanGroupRef', u'faultInst', u'vnicFcIf'], ["Add", "Get", "Remove", "Set"]),
