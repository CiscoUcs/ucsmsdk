...
MO_CLASS_META = {
    ...
    "EquipmentFruComponent": MoMeta("EquipmentFruComponent", "equipmentFruComponent", "frucomp-[type]-[id]", VersionMeta.Version432b, "InputOutput", 0x1, [], ["read-only"], ['adaptorUnit', 'storageController'], ['mgmtController'], [None]),
    ...
    "SwFcMonSrcEp": MoMeta("SwFcMonSrcEp", "swFcMonSrcEp", "mon-src-[chassis_id]-[slot_id]-[port_id]", VersionMeta.Version141i, "InputOutput", 0x1, [], ["read-only"], ['swFcMon', 'swSubGroup'], [], ["Get"]),
