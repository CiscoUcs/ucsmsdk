...
MO_CLASS_META = {
    ...
    "AdaptorPTP": MoMeta("AdaptorPTP", "adaptorPTP", "ptp-flag", None, "InputOutput", 0x1, [], ["admin", "ls-config-policy", "ls-network", "ls-server-policy"], ['adaptorHostEthIf', 'adaptorHostEthIfProfile'], [], [None]),
    ...
    "EquipmentBiosPasswordReset": MoMeta("EquipmentBiosPasswordReset", "equipmentBiosPasswordReset", "biospasswordreset", None, "InputOutput", 0x1, [], ["read-only"], ['equipmentBladeCapProvider', 'equipmentRackUnitCapProvider'], [], [None]),
