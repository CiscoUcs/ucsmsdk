...
MO_CLASS_META = {
    ...
    "PciEquipSlot": MoMeta("PciEquipSlot", "pciEquipSlot", "equipped-slot-[id]", VersionMeta.Version141i, "InputOutput", 0x1, [], ["read-only"], ['computeBlade', 'computeRackUnit', 'computeServerUnit'], [], ["Get"]),
    ...
    "ProcessorUnit": MoMeta("ProcessorUnit", "processorUnit", "cpu-[id]", VersionMeta.Version101e, "InputOutput", 0x1, [], ["read-only"], ['computeBoard'], ['equipmentInventoryStatus', 'faultInst', 'processorCore', 'processorEnvStats', 'processorErrorStats'], ["Get"]),
