...
MO_CLASS_META = {
    ...
    "AdaptorAzureQosProfile": MoMeta("AdaptorAzureQosProfile", "adaptorAzureQosProfile", "azure-qos", VersionMeta.Version412b, "InputOutput", 0x1, [], ["admin", "ls-config-policy", "ls-network", "ls-server-policy"], ['adaptorHostEthIf', 'adaptorHostEthIfProfile'], [], [None]),
    ...
    "AdaptorEthGENEVEProfile": MoMeta("AdaptorEthGENEVEProfile", "adaptorEthGENEVEProfile", "eth-geneve", VersionMeta.Version412b, "InputOutput", 0x1, [], ["admin", "ls-config-policy", "ls-network", "ls-server-policy"], ['adaptorHostEthIf', 'adaptorHostEthIfProfile'], [], [None]),
    ...
    "LstorageProfile": MoMeta("LstorageProfile", "lstorageProfile", "profile-[name]", VersionMeta.Version224b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-storage", "ls-storage-policy"], ['orgOrg'], ['lstorageControllerDef', 'lstorageDasScsiLun', 'lstorageLunSetConfig', 'lstorageSecurity'], ["Add", "Get", "Remove", "Set"]),
    ...
    "ProcessorCacheMemStats": MoMeta("ProcessorCacheMemStats", "processorCacheMemStats", "cache-mem-stats", VersionMeta.Version412b, "OutputOnly", 0x1, [], ["admin", "operations", "read-only"], ['processorUnit'], [], [None]),
    ...
    "ProcessorExecStats": MoMeta("ProcessorExecStats", "processorExecStats", "exec-stats", VersionMeta.Version412b, "OutputOnly", 0x1, [], ["admin", "operations", "read-only"], ['processorUnit'], [], [None]),
    "ProcessorIOStats": MoMeta("ProcessorIOStats", "processorIOStats", "io-stats", VersionMeta.Version412b, "OutputOnly", 0x1, [], ["admin", "operations", "read-only"], ['processorUnit'], [], [None]),
    "ProcessorMiscStats": MoMeta("ProcessorMiscStats", "processorMiscStats", "misc-stats", VersionMeta.Version412b, "OutputOnly", 0x1, [], ["admin", "operations", "read-only"], ['processorUnit'], [], [None]),
    "ProcessorPCIBusStats": MoMeta("ProcessorPCIBusStats", "processorPCIBusStats", "pcibus-stats", VersionMeta.Version412b, "OutputOnly", 0x1, [], ["admin", "operations", "read-only"], ['processorUnit'], [], [None]),
    "ProcessorPMUStats": MoMeta("ProcessorPMUStats", "processorPMUStats", "pmu-stats", VersionMeta.Version412b, "OutputOnly", 0x1, [], ["admin", "operations", "read-only"], ['processorUnit'], [], [None]),
    ...
    "ProcessorSecurityStats": MoMeta("ProcessorSecurityStats", "processorSecurityStats", "security-stats", VersionMeta.Version412b, "OutputOnly", 0x1, [], ["admin", "operations", "read-only"], ['processorUnit'], [], [None]),
