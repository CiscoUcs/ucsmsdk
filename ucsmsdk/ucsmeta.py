...
MO_CLASS_META = {
    ...
    "CommFabricInterconnectAuditLogs": MoMeta("CommFabricInterconnectAuditLogs", "commFabricInterconnectAuditLogs", "fabric-interconnect-audit-logs", VersionMeta.Version601b, "InputOutput", 0x1, [], ["admin", "operations"], ['commSvcEp'], [], [None]),
    ...
    "EquipmentMacSecCap": MoMeta("EquipmentMacSecCap", "equipmentMacSecCap", "macsec-cap-start-[start_port_id]-end-[end_port_id]", VersionMeta.Version601b, "InputOutput", 0x1, [], [""], ['equipmentSwitchCapProvider'], [], [None]),
    ...
    "FirmwareDualKnoxControllerConstraint": MoMeta("FirmwareDualKnoxControllerConstraint", "firmwareDualKnoxControllerConstraint", "constraint-dual-knox-controller", VersionMeta.Version601b, "InputOutput", 0x1, [], [""], ['firmwareConstraints'], [], [None]),
    ...
    "SecurityDeployedAesEncryption": MoMeta("SecurityDeployedAesEncryption", "securityDeployedAesEncryption", "deployed-aes-[switch_id]", VersionMeta.Version435a, "InputOutput", 0x1, [], ["aaa", "admin"], ['securityEncryptionEp'], [], [None]),
    "SecurityEncryptionEp": MoMeta("SecurityEncryptionEp", "securityEncryptionEp", "encryption", VersionMeta.Version435a, "InputOutput", 0x1, [], ["aaa", "admin"], ['securityEp'], ['eventInst', 'faultInst', 'securityAesEncryption', 'securityDeployedAesEncryption', 'securityEncryptionEpFsm', 'securityEncryptionEpFsmTask'], [None]),
    ...
    "VnicIPv6Dhcp": MoMeta("VnicIPv6Dhcp", "vnicIPv6Dhcp", "ipv6-dhcp", VersionMeta.Version601b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-network", "ls-server", "ls-storage"], ['adaptorVlan', 'vnicIPv6If'], [], [None]),
    "VnicIPv6IScsiStaticTargetIf": MoMeta("VnicIPv6IScsiStaticTargetIf", "vnicIPv6IScsiStaticTargetIf", "ipv6-[priority]", VersionMeta.Version601b, "InputOutput", 0x1, [], ["admin", "ls-config", "ls-network", "ls-server", "ls-storage"], ['adaptorVlan', 'vnicIScsiBootVnic', 'vnicVlan'], ['faultInst', 'vnicLun'], [None]),
    ...
    "VnicIPv6IscsiAddr": MoMeta("VnicIPv6IscsiAddr", "vnicIPv6IscsiAddr", "ipv6iscsi", VersionMeta.Version601b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-network", "ls-server"], ['adaptorVlan', 'vnicIPv6If'], [], [None]),
    "VnicIPv6PooledIscsiAddr": MoMeta("VnicIPv6PooledIscsiAddr", "vnicIPv6PooledIscsiAddr", "ipv6-pooled-iscsiaddr", VersionMeta.Version601b, "InputOutput", 0x1, [], ["admin", "ls-config", "ls-network", "ls-server", "ls-storage"], ['adaptorVlan', 'vnicIPv6If'], ['faultInst', 'vnicIpV6History'], [None]),
