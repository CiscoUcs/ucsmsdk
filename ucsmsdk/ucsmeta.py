...
MO_CLASS_ID = frozenset([
    ...
    "CommDnsProvider",
    "CommEvtChannel",
    "CommFabricInterconnectAuditLogs",
    "CommHttp",
    "CommHttps",
    "CommLocale",
    "CommMonitor",
    ...
    "FirmwareServicePack",
    "FirmwareSfpFirmwareInfo",
    "FirmwareSfpFwUpgrade",
    ...
    "VnicIPv4StaticRoute",
    "VnicIPv6Dhcp",
    "VnicIPv6IScsiStaticTargetIf",
    "VnicIPv6If",
    "VnicIPv6IscsiAddr",
    "VnicIPv6PooledIscsiAddr",
    "VnicIScsi",
...
MO_CLASS_META = {
    ...
    "AaaLoginProfile": MoMeta("AaaLoginProfile", "aaaLoginProfile", "login-profile", VersionMeta.Version401a, "InputOutput", 0x1, [], ["aaa", "admin"], ['aaaUserEp'], ['faultInst'], [None]),
    ...
    "AdaptorTemperature": MoMeta("AdaptorTemperature", "adaptorTemperature", "temperature-[id]", VersionMeta.Version436a, "InputOutput", 0x1, [], ["read-only"], ['adaptorUnit'], [], [None]),
    ...
    "BiosVfPreBootDMAProtection": MoMeta("BiosVfPreBootDMAProtection", "biosVfPreBootDMAProtection", "PreBoot-DMA-Protection", VersionMeta.Version436a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], ['biosSettings', 'biosVProfile'], [], [None]),
    ...
    "CommFabricInterconnectAuditLogs": MoMeta("CommFabricInterconnectAuditLogs", "commFabricInterconnectAuditLogs", "fabric-interconnect-audit-logs", VersionMeta.Version601a, "InputOutput", 0x1, [], ["admin", "operations"], ['commSvcEp'], ['commMonitor'], [None]),
    "CommHttp": MoMeta("CommHttp", "commHttp", "http-svc", VersionMeta.Version101e, "InputOutput", 0x1, [], ["aaa", "admin"], ['commSvcEp'], ['faultInst'], ["Get", "Set"]),
    "CommHttps": MoMeta("CommHttps", "commHttps", "https-svc", VersionMeta.Version101e, "InputOutput", 0x1, [], ["aaa", "admin"], ['commSvcEp'], ['faultInst'], ["Get", "Set"]),
    ...
    "CommMonitor": MoMeta("CommMonitor", "commMonitor", "monitor", VersionMeta.Version602a, "InputOutput", 0x1, [], ["admin", "operations"], ['commFabricInterconnectAuditLogs'], [], [None]),
    ...
    "CommSnmpTrap": MoMeta("CommSnmpTrap", "commSnmpTrap", "snmp-trap[hostname]", VersionMeta.Version101e, "InputOutput", 0x1, [], ["aaa", "admin"], ['commSnmp'], ['faultInst'], ["Add", "Get", "Remove", "Set"]),
    ...
    "CommTelnet": MoMeta("CommTelnet", "commTelnet", "telnet-svc", VersionMeta.Version101e, "InputOutput", 0x1, [], ["aaa", "admin"], ['commSvcEp'], ['faultInst'], ["Get", "Set"]),
    ...
    "ComputeCompTaskInfo": MoMeta("ComputeCompTaskInfo", "computeCompTaskInfo", "task-[id]", VersionMeta.Version602a, "InputOutput", 0x1, [], ["admin"], ['computeBlade', 'computeRackUnit', 'computeServerUnit'], [], [None]),
    ...
    "EquipmentFanPolicyMaxCooling": MoMeta("EquipmentFanPolicyMaxCooling", "equipmentFanPolicyMaxCooling", "fanpolicymaxcooling", VersionMeta.Version436a, "InputOutput", 0x1, [], ["read-only"], ['equipmentRackUnitCapProvider'], [], [None]),
    ...
    "EquipmentMacSecCap": MoMeta("EquipmentMacSecCap", "equipmentMacSecCap", "macsec-cap-start-[start_port_id]-end-[end_port_id]", VersionMeta.Version601a, "InputOutput", 0x1, [], [""], ['equipmentSwitchCapProvider'], [], [None]),
    ...
    "EquipmentSwitchCapProvider": MoMeta("EquipmentSwitchCapProvider", "equipmentSwitchCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version101e, "InputOutput", 0x1, [], [""], ['capabilityCatalogue', 'equipmentHwCapDerivativeProvider'], ['equipmentBeaconCapProvider', 'equipmentBreakoutCap', 'equipmentEmbeddedControllerConfig', 'equipmentFirmwareUpdateRestriction', 'equipmentFruVariant', 'equipmentMacSecCap', 'equipmentManufacturingDef', 'equipmentNonCopperPassiveCap', 'equipmentPfcMmuCap', 'equipmentPhysicalDef', 'equipmentPicture', 'equipmentPortGroupAggregationDef', 'equipmentPortGroupSwComplexDef', 'equipmentServiceDef', 'equipmentSlotArray', 'equipmentSlotArrayRef', 'equipmentSpeedCompatibility', 'equipmentStorageControllerConfig', 'equipmentSwitchCap', 'equipmentUnifiedPortCapProvider', 'firmwareConstraints', 'firmwareType', 'firmwareUpgradeConstraint'], ["Get"]),
    ...
    "FcPIo": MoMeta("FcPIo", "fcPIo", "port-[port_id]", VersionMeta.Version101e, "InputOutput", 0x1, [], ["read-only"], ['portGroup', 'portSubGroup'], ['equipmentXcvr', 'eventInst', 'faultInst', 'fcErrStats', 'fcPIoFsm', 'fcStats', 'firmwareSfpFirmwareInfo', 'lldpAcquired', 'networkIfStats', 'portDomainEp', 'portPIoFsm', 'portPIoFsmTask'], ["Get"]),
    ...
    "FirmwareBerninaPassConstraint": MoMeta("FirmwareBerninaPassConstraint", "firmwareBerninaPassConstraint", "constraint-bernina-pass", VersionMeta.Version602a, "InputOutput", 0x1, [], [""], ['firmwareConstraints'], [], [None]),
    ...
    "FirmwareBundleType": MoMeta("FirmwareBundleType", "firmwareBundleType", "type-[type]-tag-[inv_tag]", VersionMeta.Version141i, "InputOutput", 0x1, [], [""], ['firmwareBundleTypeCapProvider', 'firmwarePlatformBundleTypeCapProvider'], [], ["Get"]),
    ...
    "FirmwareDualKnoxControllerConstraint": MoMeta("FirmwareDualKnoxControllerConstraint", "firmwareDualKnoxControllerConstraint", "constraint-dual-knox-controller", VersionMeta.Version601a, "InputOutput", 0x1, [], [""], ['firmwareConstraints'], [], [None]),
    ...
    "FirmwareSfpFirmwareInfo": MoMeta("FirmwareSfpFirmwareInfo", "firmwareSfpFirmwareInfo", "sfp-fw-info", VersionMeta.Version602a, "InputOutput", 0x1, [], ["admin"], ['fcPIo'], [], [None]),
    "FirmwareSfpFwUpgrade": MoMeta("FirmwareSfpFwUpgrade", "firmwareSfpFwUpgrade", "sfp-fw-upgrade", VersionMeta.Version602a, "InputOutput", 0x1, [], ["admin"], ['firmwareSystem'], ['faultInst', 'trigLocalSched'], [None]),
    ...
    "FirmwareSystem": MoMeta("FirmwareSystem", "firmwareSystem", "fw-system", VersionMeta.Version211a, "InputOutput", 0x1, [], ["admin", "ls-config-policy", "ls-server-policy"], ['topSystem'], ['eventInst', 'faultInst', 'firmwareAck', 'firmwareHost', 'firmwareInfra', 'firmwareSfpFwUpgrade', 'firmwareSystemCompCheckResult', 'firmwareSystemFsm', 'firmwareSystemFsmTask'], ["Get"]),
    ...
    "LsbootBootSecurity": MoMeta("LsbootBootSecurity", "lsbootBootSecurity", "boot-security", VersionMeta.Version221b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"], ['lsbootDef', 'lsbootPolicy'], ['faultInst'], ["Add", "Get", "Remove", "Set"]),
    ...
    "LsbootPolicy": MoMeta("LsbootPolicy", "lsbootPolicy", "boot-policy-[name]", VersionMeta.Version101e, "InputOutput", 0x1, [], ["admin", "ls-config-policy", "ls-server-policy", "ls-storage-policy"], ['orgOrg', 'policySystemEp'], ['faultInst', 'lsbootBootSecurity', 'lsbootEFIShell', 'lsbootIScsi', 'lsbootLan', 'lsbootSan', 'lsbootStorage', 'lsbootVirtualMedia'], ["Add", "Get", "Remove", "Set"]),
    ...
    "MgmtKmip": MoMeta("MgmtKmip", "mgmtKmip", "kmip", VersionMeta.Version321d, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], ['mgmtSecurity'], ['faultInst'], ["Get", "Set"]),
    ...
    "PkiEp": MoMeta("PkiEp", "pkiEp", "pki-ext", VersionMeta.Version101e, "InputOutput", 0x1, [], ["read-only"], ['topSystem'], ['eventInst', 'faultInst', 'mgmtKmipCertPolicy', 'pkiEpFsm', 'pkiEpFsmTask', 'pkiKeyRing', 'pkiNXOSTpDeletion', 'pkiTP'], ["Get"]),
    ...
    "PkiNXOSTpDeletion": MoMeta("PkiNXOSTpDeletion", "pkiNXOSTpDeletion", "nxosTpDel-[name]", VersionMeta.Version602a, "InputOutput", 0x1, [], ["aaa", "admin"], ['pkiEp'], [], [None]),
    ...
    "PowerBudget": MoMeta("PowerBudget", "powerBudget", "budget", VersionMeta.Version111j, "InputOutput", 0x1, [], ["admin", "power-mgmt"], ['computeBlade', 'computeExtBoard', 'computeRackUnit', 'computeServerUnit', 'equipmentChassis', 'equipmentFex', 'networkElement'], ['faultInst', 'powerPackagePowerLimit', 'powerProfiledPower'], ["Get", "Set"]),
    ...
    "PowerPackagePowerLimit": MoMeta("PowerPackagePowerLimit", "powerPackagePowerLimit", "ppl", VersionMeta.Version436a, "InputOutput", 0x1, [], ["admin", "power-mgmt"], ['powerBudget'], [], [None]),
    ...
    "SecurityEp": MoMeta("SecurityEp", "securityEp", "security", VersionMeta.Version435a, "InputOutput", 0x1, [], ["aaa", "admin"], ['topSystem'], ['securityEncryptionEp'], [None]),
    ...
    "VnicIPv6Dhcp": MoMeta("VnicIPv6Dhcp", "vnicIPv6Dhcp", "ipv6-dhcp", VersionMeta.Version601a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-network", "ls-server", "ls-storage"], ['adaptorVlan', 'vnicIPv6If'], [], [None]),
    "VnicIPv6IScsiStaticTargetIf": MoMeta("VnicIPv6IScsiStaticTargetIf", "vnicIPv6IScsiStaticTargetIf", "ipv6-[priority]", VersionMeta.Version601a, "InputOutput", 0x1, [], ["admin", "ls-config", "ls-network", "ls-server", "ls-storage"], ['adaptorVlan', 'vnicIScsiBootVnic', 'vnicVlan'], ['faultInst', 'vnicLun'], [None]),
    "VnicIPv6If": MoMeta("VnicIPv6If", "vnicIPv6If", "ipv6", VersionMeta.Version302c, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-network", "ls-server", "ls-storage"], ['vnicIScsiBootVnic', 'vnicVlan'], ['vnicIPv6Dhcp', 'vnicIPv6IscsiAddr', 'vnicIPv6PooledIscsiAddr', 'vnicIpV6MgmtPooledAddr', 'vnicIpV6StaticAddr'], [None]),
    "VnicIPv6IscsiAddr": MoMeta("VnicIPv6IscsiAddr", "vnicIPv6IscsiAddr", "ipv6iscsi", VersionMeta.Version601a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-network", "ls-server"], ['adaptorVlan', 'vnicIPv6If'], [], [None]),
    "VnicIPv6PooledIscsiAddr": MoMeta("VnicIPv6PooledIscsiAddr", "vnicIPv6PooledIscsiAddr", "ipv6-pooled-iscsiaddr", VersionMeta.Version601a, "InputOutput", 0x1, [], ["admin", "ls-config", "ls-network", "ls-server", "ls-storage"], ['adaptorVlan', 'vnicIPv6If'], ['faultInst', 'vnicIpV6History'], [None]),
    ...
    "VnicIpV6History": MoMeta("VnicIpV6History", "vnicIpV6History", "ipv6-history", VersionMeta.Version221b, "InputOutput", 0x1, [], ["read-only"], ['vnicIPv6PooledIscsiAddr', 'vnicIpV6MgmtPooledAddr'], [], [None]),
    "VnicIpV6MgmtPooledAddr": MoMeta("VnicIpV6MgmtPooledAddr", "vnicIpV6MgmtPooledAddr", "ipv6-pooled-addr", VersionMeta.Version221b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-network", "ls-server"], ['adaptorVlan', 'mgmtVnet', 'vnicIPv6If'], ['faultInst', 'vnicIpV6History'], ["Add", "Get", "Remove", "Set"]),
    "VnicIpV6StaticAddr": MoMeta("VnicIpV6StaticAddr", "vnicIpV6StaticAddr", "ipv6-static-addr", VersionMeta.Version221b, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-network", "ls-server"], ['adaptorVlan', 'mgmtVnet', 'vnicIPv6If'], [], ["Add", "Get", "Remove", "Set"]),
    ...
    "VnicLun": MoMeta("VnicLun", "vnicLun", "lun", VersionMeta.Version201m, "InputOutput", 0x1, [], ["admin", "ls-config", "ls-server", "ls-storage"], ['vnicIPv6IScsiStaticTargetIf', 'vnicIScsiStaticTargetIf'], [], ["Add", "Get", "Remove", "Set"]),
    ...
    "VnicVlan": MoMeta("VnicVlan", "vnicVlan", "vlan", VersionMeta.Version201m, "InputOutput", 0x1, [], ["admin", "ls-config", "ls-network", "ls-server", "ls-storage"], ['vnicIScsi', 'vnicIScsiLCP'], ['vnicIPv4If', 'vnicIPv6IScsiStaticTargetIf', 'vnicIPv6If', 'vnicIScsiAutoTargetIf', 'vnicIScsiStaticTargetIf'], ["Add", "Get", "Set"]),
