...
MO_CLASS_META = {
    ...
    "BiosVProfile": MoMeta("BiosVProfile", "biosVProfile", "bios-prof-[name]", VersionMeta.Version111j, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-policy"], [u'orgOrg'], [u'biosTokenFeatureGroup', u'biosVfACPI10Support', u'biosVfASPMSupport', u'biosVfAllUSBDevices', u'biosVfAltitude', u'biosVfAssertNMIOnPERR', u'biosVfAssertNMIOnSERR', u'biosVfBootOptionRetry', u'biosVfCPUHardwarePowerManagement', u'biosVfCPUPerformance', u'biosVfConsistentDeviceNameControl', u'biosVfConsoleRedirection', u'biosVfCoreMultiProcessing', u'biosVfDDR3VoltageSelection', u'biosVfDRAMClockThrottling', u'biosVfDirectCacheAccess', u'biosVfDramRefreshRate', u'biosVfEnergyPerformanceTuning', u'biosVfEnhancedIntelSpeedStepTech', u'biosVfEnhancedPowerCappingSupport', u'biosVfExecuteDisableBit', u'biosVfFRB2Timer', u'biosVfFrequencyFloorOverride', u'biosVfFrontPanelLockout', u'biosVfIOEMezz1OptionROM', u'biosVfIOENVMe1OptionROM', u'biosVfIOENVMe2OptionROM', u'biosVfIOESlot1OptionROM', u'biosVfIOESlot2OptionROM', u'biosVfIntegratedGraphics', u'biosVfIntegratedGraphicsApertureSize', u'biosVfIntelEntrySASRAIDModule', u'biosVfIntelHyperThreadingTech', u'biosVfIntelTrustedExecutionTechnology', u'biosVfIntelTurboBoostTech', u'biosVfIntelVTForDirectedIO', u'biosVfIntelVirtualizationTechnology', u'biosVfInterleaveConfiguration', u'biosVfLocalX2Apic', u'biosVfLvDIMMSupport', u'biosVfMaxVariableMTRRSetting', u'biosVfMaximumMemoryBelow4GB', u'biosVfMemoryMappedIOAbove4GB', u'biosVfMirroringMode', u'biosVfNUMAOptimized', u'biosVfOSBootWatchdogTimer', u'biosVfOSBootWatchdogTimerPolicy', u'biosVfOSBootWatchdogTimerTimeout', u'biosVfOnboardGraphics', u'biosVfOnboardSATAController', u'biosVfOnboardStorage', u'biosVfOptionROMEnable', u'biosVfOptionROMLoad', u'biosVfOutOfBandManagement', u'biosVfPCHSATAMode', u'biosVfPCILOMPortsConfiguration', u'biosVfPCIROMCLP', u'biosVfPCISlotLinkSpeed', u'biosVfPCISlotOptionROMEnable', u'biosVfPOSTErrorPause', u'biosVfPSTATECoordination', u'biosVfPackageCStateLimit', u'biosVfProcessorC1E', u'biosVfProcessorC3Report', u'biosVfProcessorC6Report', u'biosVfProcessorC7Report', u'biosVfProcessorCMCI', u'biosVfProcessorCState', u'biosVfProcessorEnergyConfiguration', u'biosVfProcessorPrefetchConfig', u'biosVfQPILinkFrequencySelect', u'biosVfQPISnoopMode', u'biosVfQuietBoot', u'biosVfRedirectionAfterBIOSPOST', u'biosVfResumeOnACPowerLoss', u'biosVfSBMezz1OptionROM', u'biosVfSBNVMe1OptionROM', u'biosVfSIOC1OptionROM', u'biosVfSIOC2OptionROM', u'biosVfScrubPolicies', u'biosVfSelectMemoryRASConfiguration', u'biosVfSerialPortAEnable', u'biosVfSparingMode', u'biosVfSriovConfig', u'biosVfTPMPendingOperation', u'biosVfTPMSupport', u'biosVfTrustedPlatformModule', u'biosVfUCSMBootModeControl', u'biosVfUCSMBootOrderRuleControl', u'biosVfUEFIOSUseLegacyVideo', u'biosVfUSBBootConfig', u'biosVfUSBConfiguration', u'biosVfUSBFrontPanelAccessLock', u'biosVfUSBPortConfiguration', u'biosVfUSBSystemIdlePowerOptimizingSetting', u'biosVfVGAPriority', u'biosVfWorkloadConfiguration'], ["Add", "Get", "Remove", "Set"]),
    ...
    "ComputeHostUtilityOs": MoMeta("ComputeHostUtilityOs", "computeHostUtilityOs", "host-util-os-", None, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit'], [u'mgmtUsbNicMgmtIf'], [None]),
    ...
    "ComputeRackConnLinkPolicy": MoMeta("ComputeRackConnLinkPolicy", "computeRackConnLinkPolicy", "rack-conn-link-policy-rack-unit-[rack_id]-fabric-[switch_id]", None, "InputOutput", 0x1, [], ["admin", "pn-policy"], [u'orgOrg'], [], [None]),
    ...
    "EquipmentBiosTokenOverride": MoMeta("EquipmentBiosTokenOverride", "equipmentBiosTokenOverride", "bios-token-override-[bios_token_id]", VersionMeta.Version321d, "InputOutput", 0x1, [], ["read-only"], [u'equipmentRackUnitCapProvider'], [], ["Get", "Set"]),
    ...
    "EquipmentDiagFeatureSupport": MoMeta("EquipmentDiagFeatureSupport", "equipmentDiagFeatureSupport", "diag-feature-support", None, "InputOutput", 0x1, [], ["read-only"], [u'equipmentRackUnitCapProvider'], [], [None]),
    ...
    "EquipmentFanPresenceDef": MoMeta("EquipmentFanPresenceDef", "equipmentFanPresenceDef", "fan-presence-[fan_module_number]", None, "InputOutput", 0x1, [], [""], [u'equipmentRackFanModuleDef'], [], [None]),
    ...
    "EquipmentFlexFlashNonRemovable": MoMeta("EquipmentFlexFlashNonRemovable", "equipmentFlexFlashNonRemovable", "ff-non-removable", None, "InputOutput", 0x1, [], [""], [u'equipmentBladeCapProvider', u'equipmentRackUnitCapProvider'], [], [None]),
    ...
    "EquipmentNvmeSwitchConfig": MoMeta("EquipmentNvmeSwitchConfig", "equipmentNvmeSwitchConfig", "nvme-switch-config", None, "InputOutput", 0x1, [], [""], [u'equipmentStorageNvmeSwitchCapProvider'], [], [None]),
    ...
    "EquipmentPcieSlotOrientation": MoMeta("EquipmentPcieSlotOrientation", "equipmentPcieSlotOrientation", "pcie-slot-orientation-[slot_number]", None, "InputOutput", 0x1, [], [""], [u'equipmentRackUnitCapProvider'], [], [None]),
    ...
    "EquipmentPnuosBootMode": MoMeta("EquipmentPnuosBootMode", "equipmentPnuosBootMode", "pnuosBootMode", None, "InputOutput", 0x1, [], [""], [u'equipmentBladeCapProvider', u'equipmentRackUnitCapProvider'], [], [None]),
    ...
    "EquipmentStorageNvmeSwitchCapProvider": MoMeta("EquipmentStorageNvmeSwitchCapProvider", "equipmentStorageNvmeSwitchCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", None, "InputOutput", 0x1, [], [""], [u'capabilityCatalogue', u'equipmentHwCapDerivativeProvider'], [u'equipmentFruVariant', u'equipmentManufacturingDef', u'equipmentNvmeSwitchConfig', u'equipmentPhysicalDef', u'equipmentPicture', u'equipmentServiceDef', u'equipmentSlotArrayRef', u'equipmentStorageNvmeSwitchDef', u'firmwareType', u'firmwareUpgradeConstraint'], [None]),
    "EquipmentStorageNvmeSwitchDef": MoMeta("EquipmentStorageNvmeSwitchDef", "equipmentStorageNvmeSwitchDef", "mswitch-def", None, "InputOutput", 0x1, [], [""], [u'equipmentStorageNvmeSwitchCapProvider'], [], [None]),
    ...
    "FabricDceSwSrv": MoMeta("FabricDceSwSrv", "fabricDceSwSrv", "sw-[id]", VersionMeta.Version101e, "InputOutput", 0x1, [], ["admin", "ls-network-policy"], [u'fabricDceSrv'], [u'fabricDceSwSrvEp', u'fabricDceSwSrvPc', u'fabricSubGroup'], ["Add", "Get", "Remove", "Set"]),
    ...
    "FabricSanCloud": MoMeta("FabricSanCloud", "fabricSanCloud", "san", VersionMeta.Version101e, "InputOutput", 0x1, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricEp'], [u'eventInst', u'fabricFcSan', u'fabricSanCloudFsm', u'fabricSanCloudFsmTask', u'fabricSanPinGroup', u'fabricVsan', u'faultInst', u'firmwareAck', u'statsThresholdPolicy'], ["Get", "Set"]),
    ...
    "FirmwareAck": MoMeta("FirmwareAck", "firmwareAck", "ack", VersionMeta.Version211a, "InputOutput", 0x1, [], ["admin"], [u'fabricLanCloud', u'fabricSanCloud', u'firmwareSystem', u'qosclassDefinition'], [u'faultInst', u'trigLocalSched'], ["Get", "Set"]),
    ...
    "FirmwareBackupVersionHolder": MoMeta("FirmwareBackupVersionHolder", "firmwareBackupVersionHolder", "update-backup-version-holder-[bundle_type]", None, "InputOutput", 0x1, [], ["admin"], [u'firmwareCatalogPack', u'firmwareChassisPack', u'firmwareComputeHostPack', u'firmwareComputeMgmtPack', u'firmwareInfraPack'], [u'firmwarePackItem'], [None]),
    ...
    "FirmwareChassisPackModImpact": MoMeta("FirmwareChassisPackModImpact", "firmwareChassisPackModImpact", "fw-sys-ChassisPackModImpact-[key_dn]", None, "InputOutput", 0x1, [], ["admin", "ls-config-policy", "ls-server-policy"], [], [], [None]),
    ...
    "FirmwareConnectionManagementChassisConstraint": MoMeta("FirmwareConnectionManagementChassisConstraint", "firmwareConnectionManagementChassisConstraint", "connection-management-chassis-constraint", None, "InputOutput", 0x1, [], ["read-only"], [u'firmwareConstraints'], [], [None]),
    ...
    "FirmwareServerChassisConstraint": MoMeta("FirmwareServerChassisConstraint", "firmwareServerChassisConstraint", "server-chassis-constraint-[server_model]", None, "InputOutput", 0x1, [], ["read-only"], [u'firmwareConstraints'], [], [None]),
    ...
    "FirmwareSinglePathChassisConstraint": MoMeta("FirmwareSinglePathChassisConstraint", "firmwareSinglePathChassisConstraint", "single-path-chassis-constraint", None, "InputOutput", 0x1, [], ["read-only"], [u'firmwareConstraints'], [], [None]),
    ...
    "LstorageSasExpanderConfigPolicy": MoMeta("LstorageSasExpanderConfigPolicy", "lstorageSasExpanderConfigPolicy", "sas-expander-config-policy-[name]", None, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'orgOrg'], [], [None]),
    ...
    "MgmtKvmCertificate": MoMeta("MgmtKvmCertificate", "mgmtKvmCertificate", "cert", None, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-network", "ls-server", "ls-server-oper"], [u'computeKvmMgmtPolicy', u'mgmtController'], [u'faultInst'], [None]),
    ...
    "MgmtUsbNicMgmtIf": MoMeta("MgmtUsbNicMgmtIf", "mgmtUsbNicMgmtIf", "usbnic-if-[usbnic_conn_side]-[switch_id]", None, "InputOutput", 0x1, [], ["admin"], [u'computeHostUtilityOs', u'mgmtController'], [], [None]),
    ...
    "StorageNvmeSwitch": MoMeta("StorageNvmeSwitch", "storageNvmeSwitch", "nvme-switch-[id]", None, "InputOutput", 0x1, [], ["read-only"], [u'computeBoard'], [u'faultInst', u'firmwareBootDefinition', u'firmwareRunning'], [None]),
